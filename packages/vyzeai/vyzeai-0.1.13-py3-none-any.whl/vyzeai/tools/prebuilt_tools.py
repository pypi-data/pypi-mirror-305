...
def execute_code():
    from vyzeai.tools.raw_functions import execute_code_parts as rf
    decorated_model = add_function(rf)(PythonCodeExecution)
    tool = Tool(decorated_model)()
    return tool
...
def install_library():
    from vyzeai.tools.raw_functions import install_library as rf
