    ...
    def wrapped(
        ...
        *,
        ...
        if p5_buttons:
            ...
            buttons = Html.div(
                  IdeManager.cls_create_button(env, 'p5_start', id=f"start-btn-{ div_id }", extra_btn_kls='p5-btn')
                + IdeManager.cls_create_button(env, 'p5_stop',  id=f"stop-btn-{ div_id }", extra_btn_kls='p5-btn'),
