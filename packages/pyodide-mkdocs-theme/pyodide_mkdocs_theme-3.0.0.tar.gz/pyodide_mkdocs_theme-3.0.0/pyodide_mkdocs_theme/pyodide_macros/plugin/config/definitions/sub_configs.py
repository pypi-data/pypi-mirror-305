...
TESTING_CONFIG = SubConfigSrc(
    ...
    ConfigOptionSrc(
        ...
        docs="""
            ...
            un IDE donné ne contient pas de code et que cette valeur est définie, c'est cette
            "stratégie" qui sera utilisée à la place.
        """,
        yaml_desc = "Fallback TEST behavior to use when the section to test is empty."
    ),
