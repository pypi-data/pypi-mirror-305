            ...
            with lock:
                with os.fdopen(
                    ...
                    cred_json = {
                        ...
                        "AccessTokenExpirationTime": access_token_expiration_time.strftime("%Y-%m-%d %H:%M:%S"),
                        "RefreshToken": refresh_token,
                        "RefreshTokenExpirationTime": refresh_token_expiration_time.strftime("%Y-%m-%d %H:%M:%S"),
                    }
        ...
        try:
            ...
            with lock:
                if not force:
                    ...
                    expiration_time = datetime.strptime(self._access_token_expiration_time, "%Y-%m-%d %H:%M:%S")
