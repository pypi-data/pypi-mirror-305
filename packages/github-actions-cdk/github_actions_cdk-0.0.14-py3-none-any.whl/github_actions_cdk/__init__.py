...
class Action(metaclass=jsii.JSIIAbstractClass, jsii_type="github-actions-cdk.Action"):
    '''(experimental) Abstract representation of a GitHub Action associated with a Job.
    ...
    def __init__(
        ...
        *,
        ...
        '''(experimental) Initializes a new ``Action`` instance with an identifier and configuration properties.
        ...
        props = ActionProps(version=version, name=name)

        jsii.create(self.__class__, self, [id, props])

    @jsii.member(jsii_name="bind")
    @abc.abstractmethod
    def bind(self, job: "Job") -> "RegularStep":
        '''(experimental) Associates the action with a specified Job within the workflow.

        :param job: - The ``Job`` to which this action is bound, enabling its execution within that job.

        :return: A ``RegularStep`` instance representing the action as a step within the job.
    ...
    def id(self) -> builtins.str:
        '''(experimental) Unique identifier for the action, required to be unique within a job's context.
    ...
    def version(self) -> builtins.str:
        '''(experimental) Version of the action, defining the specific variant to execute in the workflow.
    ...
    def name(self) -> typing.Optional[builtins.str]:
        '''(experimental) Optional display name used in workflow logs for readability.
...
class _ActionProxy(Action):
    ...
    def bind(self, job: "Job") -> "RegularStep":
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__248c74fec40098022456d69af388ef2f6b3ae1d3aebe3b790420bcff20621841)
            check_type(argname="argument job", value=job, expected_type=type_hints["job"])
        return typing.cast("RegularStep", jsii.invoke(self, "bind", [job]))
...
@jsii.data_type(
    ...
    jsii_struct_bases=[],
    name_mapping={"version": "version", "name": "name"},
)
class ActionProps:
    def __init__(
        self,
        *,
        ...
        '''(experimental) Configuration properties for a GitHub Action.
...
class Job(Component, metaclass=jsii.JSIIMeta, jsii_type="github-actions-cdk.Job"):
    ...
    def add_action(self, action: Action) -> None:
        '''(experimental) Binds an action to the job.
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__14666f0e16559875db8b555895bfc36563ba36305480f7bd9e1f3cf88ceeca66)
    ...
    def add_step(
        self,
        id: builtins.str,
        props: typing.Union[typing.Union["RunStepProps", typing.Dict[builtins.str, typing.Any]], typing.Union["RegularStepProps", typing.Dict[builtins.str, typing.Any]]],
    ) -> "StepBase":
        '''(experimental) Adds a generic step to the job, choosing between ``RunStep`` or ``RegularStep``.

        :param id: - ID of the step.
        :param props: - Step properties.

        :return: A ``StepBase`` instance, depending on the properties.

        :stability: experimental
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__77084fa240cf0938b5ba7ecabdd97e763b728b544776f87ea0b277d4ce0b8c4c)
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
        return typing.cast("StepBase", jsii.invoke(self, "addStep", [id, props]))
...
def _typecheckingstub__248c74fec40098022456d69af388ef2f6b3ae1d3aebe3b790420bcff20621841(
    job: Job,
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__14666f0e16559875db8b555895bfc36563ba36305480f7bd9e1f3cf88ceeca66(
    action: Action,
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__77084fa240cf0938b5ba7ecabdd97e763b728b544776f87ea0b277d4ce0b8c4c(
    id: builtins.str,
    props: typing.Union[typing.Union[RunStepProps, typing.Dict[builtins.str, typing.Any]], typing.Union[RegularStepProps, typing.Dict[builtins.str, typing.Any]]],
) -> None:
    """Type checking stubs"""
