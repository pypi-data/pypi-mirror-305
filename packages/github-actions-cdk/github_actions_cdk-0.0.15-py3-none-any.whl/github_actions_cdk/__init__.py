...
class Action(
    ...
    '''(experimental) Abstract base class representing a GitHub Action in a workflow.
    ...
    def __init__(
        ...
        *,
        ...
        :param action_identifier: (experimental) Identifier of the action, typically in the format of ``owner/repo`` (e.g., ``"actions/checkout"``).
        :param version: (experimental) Specifies the version of the action, allowing control over the specific release, branch, or commit SHA. If omitted, the action may use its latest default version.
        ...
        props = ActionProps(
            action_identifier=action_identifier, version=version, name=name
        )
    ...
    @abc.abstractmethod
    def _create_regular_step(self) -> "RegularStep":
        '''(experimental) Creates a ``RegularStep`` associated with this action.
    ...
    @builtins.property
    @jsii.member(jsii_name="actionIdentifier")
    def action_identifier(self) -> builtins.str:
        '''(experimental) Unique identifier for the action, specifying its source in GitHub workflows.

        :stability: experimental
        '''
        return typing.cast(builtins.str, jsii.get(self, "actionIdentifier"))

    @builtins.property
    @jsii.member(jsii_name="id")
    def id(self) -> builtins.str:
        '''(experimental) Retrieves the unique identifier of this action within the construct tree.

        :return: A string representing the action's unique ID.
    ...
    @builtins.property
    @jsii.member(jsii_name="regularStep")
    def regular_step(self) -> "RegularStep":
        '''(experimental) The regular step associated with this action, representing its execution in a workflow.

        :stability: experimental
        '''
        return typing.cast("RegularStep", jsii.get(self, "regularStep"))

    @builtins.property
    @jsii.member(jsii_name="uses")
    def uses(self) -> builtins.str:
        '''(experimental) Generates the ``uses`` string in GitHub Actions syntax, combining the action identifier and version.

        :return: A string in the format ``identifier@version``, used to specify the action in workflows.
    ...
    def version(self) -> builtins.str:
        '''(experimental) Version of the action, specifying the variant to execute in the workflow.
    ...
    def name(self) -> typing.Optional[builtins.str]:
        '''(experimental) Optional display name for the action, displayed in workflow logs for clarity.
...
class _ActionProxy(Action):
    ...
    def _create_regular_step(self) -> "RegularStep":
        ...
        executed by this action. The resulting ``RegularStep`` integrates the action's behavior in the workflow.
        '''
        return typing.cast("RegularStep", jsii.invoke(self, "createRegularStep", []))
...
class CommonActionProps:
    def __init__(self, *, name: typing.Optional[builtins.str] = None) -> None:
        '''(experimental) Base configuration properties shared by GitHub Actions.
...
class Project(
    ...
    def __init__(
        ...
        *,
        ...
        '''(experimental) Initializes a new ``Project`` instance.

        :param additional_checks: (experimental) Flag to enable additional workflow checks. When ``true``, additional checks, like the ``ExternalActionVersionCheck``, are applied to workflows. Default: false
        :param continue_on_error_annotations: (experimental) Continue synthesis despite error annotations. When ``true``, workflows with errors will not stop the synthesis process. Default: false
        :param outdir: (experimental) Directory for generated workflow YAML files. Defines the target directory where GitHub Actions workflow YAML files are outputted. Defaults to ``./.github/workflows`` if not specified. Default: "./.github/workflows"
        :param skip_validation: (experimental) Toggle for skipping validation during synthesis. When ``true``, skips validation of workflows. Useful for cases where validation can be safely ignored. Default: false
    ...
    def add_workflow(
        ...
        *,
        ...
        :return: A new ``Workflow`` instance added to this project.
    ...
    def synth(self) -> None:
        '''(experimental) Synthesizes workflows into YAML files in the specified output directory.
    ...
    @jsii.member(jsii_name="manifest")
    def manifest(self) -> Manifest:
        '''(experimental) Manifest object storing synthesized workflows for this project.
    ...
    @jsii.member(jsii_name="outdir")
    def outdir(self) -> builtins.str:
        '''(experimental) Output directory for synthesized workflow YAML files.
    ...
    def additional_checks(self) -> typing.Optional[builtins.bool]:
        '''(experimental) Flag indicating if additional checks are applied during synthesis.
    ...
    def continue_on_error_annotations(self) -> typing.Optional[builtins.bool]:
        '''(experimental) Flag to continue on error annotations, bypassing exit on errors.
    ...
    @jsii.member(jsii_name="skipValidation")
    def skip_validation(self) -> typing.Optional[builtins.bool]:
        '''(experimental) Flag to determine if validation is skipped during synthesis.
...
class ProjectProps:
    ...
    @builtins.property
    def additional_checks(self) -> typing.Optional[builtins.bool]:
        '''(experimental) Flag to enable additional workflow checks.
    ...
    @builtins.property
    def continue_on_error_annotations(self) -> typing.Optional[builtins.bool]:
        '''(experimental) Continue synthesis despite error annotations.
    ...
    def outdir(self) -> typing.Optional[builtins.str]:
        '''(experimental) Directory for generated workflow YAML files.
    ...
    @builtins.property
    def skip_validation(self) -> typing.Optional[builtins.bool]:
        '''(experimental) Toggle for skipping validation during synthesis.
...
class Validator(
    ...
    '''(experimental) Base class for all validators.
    ...
    @jsii.member(jsii_name="addErrors")
    def _add_errors(self, errors: typing.Sequence[builtins.str]) -> None:
        '''(experimental) Adds multiple error messages to the validator's error list.
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__44f13967055f964beef37cccb7350dd693d426653e21e9a8b9a1003cebdaee63)
            check_type(argname="argument errors", value=errors, expected_type=type_hints["errors"])
        return typing.cast(None, jsii.invoke(self, "addErrors", [errors]))

    @jsii.member(jsii_name="checkRequired")
    def _check_required(self, property: typing.Any, name: builtins.str) -> None:
        '''(experimental) Checks if a required property is set.
        ...
        if __debug__:
            ...
            check_type(argname="argument name", value=name, expected_type=type_hints["name"])
        return typing.cast(None, jsii.invoke(self, "checkRequired", [property, name]))

    @jsii.member(jsii_name="validate")
    @abc.abstractmethod
    def validate(self) -> None:
        '''(experimental) Validates the current instance.
    ...
    def errors(self) -> typing.List[builtins.str]:
        '''(experimental) Gets the list of validation errors collected during validation.
...
class WorkflowValidator(
    ...
    @jsii.member(jsii_name="validate")
    def validate(self) -> None:
        '''(experimental) Validates the workflow's environment variables.
...
class ActionProps(CommonActionProps):
    def __init__(
        ...
        *,
        ...
        '''(experimental) Comprehensive configuration for defining a GitHub Action.
    ...
    @builtins.property
    def action_identifier(self) -> builtins.str:
        '''(experimental) Identifier of the action, typically in the format of ``owner/repo`` (e.g., ``"actions/checkout"``).
    ...
    @builtins.property
    def version(self) -> builtins.str:
        '''(experimental) Specifies the version of the action, allowing control over the specific release, branch, or commit SHA.
...
class JobValidator(
    ...
    @jsii.member(jsii_name="validate")
    def validate(self) -> None:
        '''(experimental) Validates the job's ID format, environment variables, and checks if the job has steps defined.
...
class RegularStepValidator(
    ...
    @jsii.member(jsii_name="validate")
    def validate(self) -> None:
        '''(experimental) Validates the regular step's properties.
...
class RunStepValidator(
    ...
    @jsii.member(jsii_name="validate")
    def validate(self) -> None:
        '''(experimental) Validates the run step's properties.
...
class StepBaseValidator(
    ...
    @jsii.member(jsii_name="validate")
    def validate(self) -> None:
        '''(experimental) Validates the step's ID format and environment variables.
...
def _typecheckingstub__44f13967055f964beef37cccb7350dd693d426653e21e9a8b9a1003cebdaee63(
