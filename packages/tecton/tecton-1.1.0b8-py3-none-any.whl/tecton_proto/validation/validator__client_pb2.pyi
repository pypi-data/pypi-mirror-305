...
class ResourceProviderArgs(_message.Message):
    ...
    def __init__(self, args: Optional[Union[_resource_provider__client_pb2.ResourceProviderArgs, Mapping]] = ...) -> None: ...
