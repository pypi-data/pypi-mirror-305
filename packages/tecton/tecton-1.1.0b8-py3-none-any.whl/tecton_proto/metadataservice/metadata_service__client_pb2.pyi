...
class CreateServiceAccountRequest(_message.Message):
    ...
    CREDENTIALS_TYPE_FIELD_NUMBER: ClassVar[int]
    DESCRIPTION_FIELD_NUMBER: ClassVar[int]
    NAME_FIELD_NUMBER: ClassVar[int]
    credentials_type: _service_account__client_pb2.ServiceAccountCredentialsType
    description: str
    name: str
    def __init__(self, name: Optional[str] = ..., description: Optional[str] = ..., credentials_type: Optional[Union[_service_account__client_pb2.ServiceAccountCredentialsType, str]] = ...) -> None: ...
...
class CreateServiceAccountResponse(_message.Message):
    ...
    is_active: bool
    name: str
    def __init__(self, id: Optional[str] = ..., name: Optional[str] = ..., description: Optional[str] = ..., is_active: bool = ..., api_key: Optional[str] = ..., created_at: Optional[Union[_timestamp_pb2.Timestamp, Mapping]] = ..., credentials_type: Optional[Union[_service_account__client_pb2.ServiceAccountCredentialsType, str]] = ..., client_secret: Optional[str] = ...) -> None: ...
...
class GetJobsRequest(_message.Message):
    ...
    TASK_TYPE_FOR_DISPLAYS_FIELD_NUMBER: ClassVar[int]
...
class TaskAttemptDetails(_message.Message):
    ...
    TASK_TYPE_FIELD_NUMBER: ClassVar[int]
    TASK_TYPE_FOR_DISPLAY_FIELD_NUMBER: ClassVar[int]
    anyscale_url: str
    ...
    def __init__(self, task_id: Optional[Union[_id__client_pb2.Id, Mapping]] = ..., task_type: Optional[Union[_spark_cluster__client_pb2.TaskType, str]] = ..., task_type_for_display: Optional[Union[_spark_cluster__client_pb2.TaskTypeForDisplay, str]] = ..., task_state: Optional[Union[_materialization_status__client_pb2.MaterializationStatusState, str]] = ..., attempt_status: Optional[Union[_materialization_status__client_pb2.MaterializationAttemptStatus, Mapping]] = ..., run_details: Optional[Union[_job_metadata__client_pb2.TectonManagedInfo, Mapping]] = ..., cluster_config: Optional[Union[_feature_view__client_pb2.RiftClusterConfig, Mapping]] = ..., feature_start_time: Optional[Union[_timestamp_pb2.Timestamp, Mapping]] = ..., feature_end_time: Optional[Union[_timestamp_pb2.Timestamp, Mapping]] = ..., anyscale_url: Optional[str] = ...) -> None: ...
...
class TaskWithAttempts(_message.Message):
    ...
    task_type: _spark_cluster__client_pb2.TaskType
    task_type_for_display: _spark_cluster__client_pb2.TaskTypeForDisplay
    def __init__(self, fco_locator: Optional[Union[_fco_locator__client_pb2.FcoLocator, Mapping]] = ..., taskState: Optional[Union[_materialization_status__client_pb2.MaterializationStatusState, str]] = ..., materialization_status: Optional[Union[_materialization_status__client_pb2.MaterializationStatus, Mapping]] = ..., task_id: Optional[Union[_id__client_pb2.Id, Mapping]] = ..., task_type: Optional[Union[_spark_cluster__client_pb2.TaskType, str]] = ..., task_type_for_display: Optional[Union[_spark_cluster__client_pb2.TaskTypeForDisplay, str]] = ..., manually_triggered: bool = ..., last_task_state_change: Optional[Union[_timestamp_pb2.Timestamp, Mapping]] = ..., feature_view_name: Optional[str] = ..., feature_service_name: Optional[str] = ..., feature_start_time: Optional[Union[_timestamp_pb2.Timestamp, Mapping]] = ..., feature_end_time: Optional[Union[_timestamp_pb2.Timestamp, Mapping]] = ..., plan_id: Optional[Union[_id__client_pb2.Id, Mapping]] = ...) -> None: ...
