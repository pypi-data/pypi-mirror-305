...
class Acl(_message.Message):
    ...
    API_KEY_STR_IDS_FIELD_NUMBER: ClassVar[int]
    ...
    permission: str
    def __init__(self, permission: Optional[str] = ..., api_key_ids: Optional[Iterable[Union[_id__client_pb2.Id, Mapping]]] = ..., okta_ids: Optional[Iterable[str]] = ..., api_key_str_ids: Optional[Iterable[str]] = ...) -> None: ...
