...
class JoinInputsNode(_message.Message):
    ...
    def __init__(self, nodes: Optional[Iterable[Union[PipelineNode, Mapping]]] = ...) -> None: ...
...
class PipelineNode(_message.Message):
    ...
    JOIN_INPUTS_NODE_FIELD_NUMBER: ClassVar[int]
