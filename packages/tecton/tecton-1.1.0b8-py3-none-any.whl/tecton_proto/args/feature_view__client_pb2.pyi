...
class Calculation(_message.Message):
    ...
    class TagsEntry(_message.Message):
        ...
        value: str
        def __init__(self, key: Optional[str] = ..., value: Optional[str] = ...) -> None: ...
    ABSTRACT_SYNTAX_TREE_ROOT_FIELD_NUMBER: ClassVar[int]
    COLUMN_DTYPE_FIELD_NUMBER: ClassVar[int]
    DESCRIPTION_FIELD_NUMBER: ClassVar[int]
    ...
    name: str
    tags: _containers.ScalarMap[str, str]
    def __init__(self, name: Optional[str] = ..., expr: Optional[str] = ..., column_dtype: Optional[Union[_data_type__client_pb2.DataType, Mapping]] = ..., description: Optional[str] = ..., tags: Optional[Mapping[str, str]] = ..., abstract_syntax_tree_root: Optional[Union[_calculation_node__client_pb2.AbstractSyntaxTreeNode, Mapping]] = ...) -> None: ...
...
class FeatureViewArgs(_message.Message):
    ...
    class ResourceProvidersEntry(_message.Message):
        ...
        def __init__(self, key: Optional[str] = ..., value: Optional[Union[_id__client_pb2.Id, Mapping]] = ...) -> None: ...
    ...
    RESOURCE_PROVIDERS_FIELD_NUMBER: ClassVar[int]
