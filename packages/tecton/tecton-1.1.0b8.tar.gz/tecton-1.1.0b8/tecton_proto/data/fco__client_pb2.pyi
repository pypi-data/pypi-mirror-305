...
class Fco(_message.Message):
    ...
    RESOURCE_PROVIDER_FIELD_NUMBER: ClassVar[int]
    ...
    def __init__(self, virtual_data_source: Optional[Union[_virtual_data_source__client_pb2.VirtualDataSource, Mapping]] = ..., entity: Optional[Union[_entity__client_pb2.Entity, Mapping]] = ..., feature_view: Optional[Union[_feature_view__client_pb2.FeatureView, Mapping]] = ..., feature_service: Optional[Union[_feature_service__client_pb2.FeatureService, Mapping]] = ..., transformation: Optional[Union[_transformation__client_pb2.Transformation, Mapping]] = ..., server_group: Optional[Union[_server_group__client_pb2.ServerGroup, Mapping]] = ..., resource_provider: Optional[Union[_resource_provider__client_pb2.ResourceProvider, Mapping]] = ...) -> None: ...
