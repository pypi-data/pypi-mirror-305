...
class Calculation(_message.Message):
    ...
    name: str
    tags: _containers.ScalarMap[str, str]
    def __init__(self, name: Optional[str] = ..., description: Optional[str] = ..., tags: Optional[Mapping[str, str]] = ..., abstract_syntax_tree_root: Optional[Union[_calculation_node__client_pb2.AbstractSyntaxTreeNode, Mapping]] = ...) -> None: ...
