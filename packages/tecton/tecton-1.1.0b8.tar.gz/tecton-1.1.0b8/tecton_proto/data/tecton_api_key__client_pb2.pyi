...
class TectonApiKey(_message.Message):
    __slots__ = ["archived", "created_at", "created_by", "creator", "credentials_type", "description", "expires_at", "hashed_key", "id", "is_active", "is_admin", "is_system_managed", "is_temporary", "name", "obscured_key", "string_id"]
    ...
    STRING_ID_FIELD_NUMBER: ClassVar[int]
    archived: bool
