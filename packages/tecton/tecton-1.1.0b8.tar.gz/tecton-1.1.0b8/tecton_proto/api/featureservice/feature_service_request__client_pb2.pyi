...
class GetFeaturesBatchParametersV2(_message.Message):
    ...
    request_data: _containers.RepeatedCompositeFieldContainer[GetFeaturesBatchRequestData]
    workspace_name: str
    def __init__(self, feature_service_name: Optional[str] = ..., workspace_name: Optional[str] = ..., request_data: Optional[Iterable[Union[GetFeaturesBatchRequestData, Mapping]]] = ..., metadata_options: Optional[Union[MetadataOptions, Mapping]] = ...) -> None: ...
...
class GetFeaturesBatchRequestV2(_message.Message):
    ...
    def __init__(self, params: Optional[Union[GetFeaturesBatchParametersV2, Mapping]] = ...) -> None: ...
...
class GetFeaturesParametersV2(_message.Message):
    ...
    request_options: RequestOptions
    workspace_name: str
    def __init__(self, feature_service_name: Optional[str] = ..., workspace_name: Optional[str] = ..., join_key_map: Optional[Mapping[str, _struct_pb2.Value]] = ..., request_context_map: Optional[Mapping[str, _struct_pb2.Value]] = ..., metadata_options: Optional[Union[MetadataOptions, Mapping]] = ..., allow_partial_results: bool = ..., request_options: Optional[Union[RequestOptions, Mapping]] = ..., isCallerBatch: bool = ...) -> None: ...
...
class GetFeaturesRequestV2(_message.Message):
    ...
    def __init__(self, params: Optional[Union[GetFeaturesParametersV2, Mapping]] = ...) -> None: ...
