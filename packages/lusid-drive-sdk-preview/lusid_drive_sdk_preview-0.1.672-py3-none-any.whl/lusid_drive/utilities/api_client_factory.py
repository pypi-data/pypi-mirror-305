...
from lusid_drive import ApiClient
...
class ApiClientFactory:
    ...
    def __init__(self, **kwargs):
        ...
        :param str correlation_id: Correlation id for all calls made from the returned Drive API instances
    ...
    def build(self, metaclass):
        ...
        module = importlib.import_module("lusid_drive.api")
