...
class ApiClientBuilder:
    """
    The ApiClientBuilder is responsible for building a lusid_drive.ApiClient. This includes obtaining an access token from
    Okta or using the provided token.

    Any validation on the inputs required to build a lusid_drive.ApiClient is the responsibility of this ApiClientBuilder.
    """
