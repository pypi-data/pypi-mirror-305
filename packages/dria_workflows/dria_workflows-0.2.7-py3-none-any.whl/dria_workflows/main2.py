...
from dria_workflows import WorkflowBuilder, Operator, Write, Edge, Peek, Workflow, validate_workflow_json
...
wf = workflow(query="x", documents_info=["y"]).model_dump_json(exclude_none=True, exclude_unset=True)
