...
import os
import logging
from typing import Dict, Set, Optional  # Optional を追加
...
def auto_detect_template(data: Dict) -> str:
    ...
    if not best_match:
        logger.warning("No suitable template found with the required match score.")
        raise ValueError("No suitable template found. Please check the provided data fields.")
