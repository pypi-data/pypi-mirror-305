...
async def gerar_nosso_numero(task):
    '''
    ...
    try:
        ...
        pesquisar_button = pyautogui.locateOnScreen(ASSETS_BASE_PATH + 'gerar_nn_pesquisar.png', confidence=0.89)
        if pesquisar_button:
            console.log("Pesquisando titulos" , style="bold green")
            pyautogui.click(pesquisar_button)
            pyautogui.move(800,800)
        else:
            return {"sucesso": False, "retorno": "Botão Pesquisar não encontrado ou não habilitado!"}
        ...
        pesquisar_button = pyautogui.locateOnScreen(ASSETS_BASE_PATH + 'gerar_nn_marcar_todos.png', confidence=0.89)
        if pesquisar_button:
            console.print("Marcando todos titulos" , style="bold green")
            pyautogui.click(pesquisar_button)
        else:
            return {"sucesso": False, "retorno": "Botão Marcar Todos não encontrado!"}
        ...
        pesquisar_button = pyautogui.locateOnScreen(ASSETS_BASE_PATH + 'gerar_nn_imprimir.png', confidence=0.89)
        if pesquisar_button:
            console.log("Imprimindo titulos" , style="bold green")
            pyautogui.click(pesquisar_button)
        else:
            return {"sucesso": False, "retorno": "Botão Imprimir não encontrado!"}
        ...
        observacao = f"Erro Processo Gerar Nosso Número: {str(ex)}"
