    ...
    try:
        ...
        if "Confirm" in window_title:
            ...
            if main_window.exists():
                ...
                console.print(
                    "Verificando a existencia de tela do NCM divergente do XML...\n"
                )
                ncm_divergente = await is_window_open_by_class(
                    "TFrmAguarde", "TMessageForm"
                )
                if ncm_divergente["IsOpened"] == True:
                    console.print(
                        "Existe tela do NCM divergente do XML, interagindo com ela...\n"
                    )
                    app = Application().connect(class_name="TFrmAguarde")
                    main_window = app["TMessageForm"]
                    main_window.type_keys("%n")
                    console.print(
                        "Existe tela do NCM divergente do XML, Clicando em NO...\n"
                    )
