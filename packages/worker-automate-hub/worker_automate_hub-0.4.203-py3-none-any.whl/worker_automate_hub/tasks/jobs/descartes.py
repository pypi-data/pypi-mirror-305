    ...
    try:
        ...
        for item in itens:
            ...
            try:
                ...
                console.print("Verificando janela Confirm - Item já incluido nesta pré-venda, Deseja continuar?...\n")
                ...
                console.log(
                    "Nenhuma tela de Confirm - Item já incluido nesta pré-venda foi encontrada", style="bold green"
                )
        ...
        try:
            ...
            if btn_ok.exists():
                try:
                    btn_ok.click()
                    await worker_sleep(3)
                    console.print("O botão OK de pré-venda incluída foi clicado com sucesso.", style="green")
                except Exception as e:
                    console.print(f"Falha ao clicar no botão OK de pré-venda incluída: {e}", style="red")
                    return RpaRetornoProcessoDTO(
                        sucesso=False,
                ...
                console.print("O Botão OK de pré-venda incluída não foi encontrado.", style="red")
                return RpaRetornoProcessoDTO(
                    sucesso=False,
            ...
            console.print(f"O Botão OK de pré-venda incluída não foi encontrado: {e}", style="red")
            return RpaRetornoProcessoDTO(
                sucesso=False,
