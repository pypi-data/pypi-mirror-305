    ...
    try:
        ...
        while True:
            ...
            if itens_by_supplier["IsOpened"] == True:
                ...
                path_to_png = f"C:\\Users\\{username}\\Downloads\\{nota.get("nfe")}.png"
                ...
                match = re.search(r"Item da Nota:\s*(.*?)\s*\n", captured_text)
                ...
                if match:
                    ...
                    return RpaRetornoProcessoDTO(
                        sucesso=False,
                        retorno="Não foi possivel capturar o item da nota com multiplas referencias para andamento no processo",
                        status=RpaHistoricoStatusEnum.Falha,
                    )
