...
async def entrada_de_notas_36(task: RpaProcessoEntradaDTO) -> RpaRetornoProcessoDTO:
    ...
    try:
        ...
        if '0,00' in valores_informado or '0.00' in valores_informado:
            ...
            await worker_sleep(2)
            console.print(f"Inserindo o valor {valores_restantes}... \n")
            ...
            if '0,00' in valores_informado or '0.00' in valores_informado:
                return RpaRetornoProcessoDTO(
                    sucesso=False,
                    retorno=f"Erro ao adicionar o pagamento, valor informado {valores_informado}.",
                    status=RpaHistoricoStatusEnum.Falha,
                )
