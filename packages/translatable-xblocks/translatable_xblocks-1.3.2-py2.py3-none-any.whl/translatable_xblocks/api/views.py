...
class ConfigAPI(APIView):
    ...
    def get(self, request):
        ...
        available_translation_languages = self.ai_translations_service.get_course_translation_languages(course_id)
    ...
    def post(self, request):
        ...
        available_translation_languages = request.data.get("available_translation_languages")
        ...
        if available_translation_languages and len(available_translation_languages):
            ...
            available_translation_languages = self.ai_translations_service.post_course_translation_languages(post_data)
