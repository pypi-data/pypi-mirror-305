...
from ...models.fdyn_event import FdynEvent
...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/rest_api/fdyn_event{format_}",
    }
    ...
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == HTTPStatus.OK:
        ...
        for response_200_item_data in _response_200:
            response_200_item = FdynEvent.from_dict(response_200_item_data)
...
def sync_detailed(
    ...
    * mnemonics: a list of the names of the events mnemonics
    ...
    Returns:
        Response[Union[Any, List['FdynEvent']]]
    """
