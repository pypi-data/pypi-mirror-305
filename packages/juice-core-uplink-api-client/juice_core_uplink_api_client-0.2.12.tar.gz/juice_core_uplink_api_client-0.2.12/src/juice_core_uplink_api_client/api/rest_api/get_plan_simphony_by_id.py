...
from ...models.get_plan_simphony_by_id_mode import GetPlanSimphonyByIdMode
...
def _get_kwargs(
    ...
    *,
    ...
    mode: Unset | GetPlanSimphonyByIdMode = UNSET,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/rest_api/plan_simphony/{id}/",
        "params": params,
    }
...
def sync_detailed(
    ...
    * mode: \"strict\" | \"open\" optional: \"open\" Includes the segments partially included in the
    ...
    Args:
        ...
        mode (Union[Unset, GetPlanSimphonyByIdMode]):
