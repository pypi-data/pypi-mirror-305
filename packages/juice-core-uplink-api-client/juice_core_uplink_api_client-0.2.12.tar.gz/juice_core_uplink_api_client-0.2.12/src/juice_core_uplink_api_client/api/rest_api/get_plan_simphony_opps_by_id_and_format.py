...
from ...models.get_plan_simphony_opps_by_id_and_format_mode import (
...
def _get_kwargs(
    ...
    *,
    ...
    mode: Unset | GetPlanSimphonyOppsByIdAndFormatMode = UNSET,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/rest_api/plan_simphony/opps/{id}{format_}",
        "params": params,
    }
...
def sync_detailed(
    ...
    * mode: \"strict\" | \"open\" optional: \"open\" Includes the segments partially included in the
    ...
    Args:
        ...
        mode (Union[Unset, GetPlanSimphonyOppsByIdAndFormatMode]):
