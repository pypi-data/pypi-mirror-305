...
The two new events have listeners in the create.  If either is
triggered the ckeditor window will transition to the new state.
There is an option to hide the toolbar when in readonly,set using
`hideToolbar`.

closes #94 ([`08851e4`](https://github.com/Dunwright-dev/django-ckeditors/commit/08851e468a9b62090f3b8dcb6d40bc1276886c93))

### Unknown

* Merge pull request #95 from Dunwright-dev/issue-94

feat(mode): Add global readonly enable/disable events #94 ([`a55b16c`](https://github.com/Dunwright-dev/django-ckeditors/commit/a55b16cf79e411ddb37ae9626abb59a81e0bceeb))
