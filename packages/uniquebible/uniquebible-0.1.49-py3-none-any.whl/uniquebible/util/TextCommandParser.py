...
#            self.qtTtsEngine.stop()
    ...
    def getAllFavouriteBibles(self):
        return [i for i in sorted(set([config.mainText, config.favouriteBible, config.favouriteBible2, config.favouriteBible3, config.favouriteBiblePrivate, config.favouriteBiblePrivate2, config.favouriteBiblePrivate3])) if i in self.parent.textList]
