...
#            self.qtTtsEngine.stop()
    ...
    def getAllFavouriteBibles(self):
        favouriteVersions = [config.mainText, config.favouriteBible, config.favouriteBible2, config.favouriteBible3, config.favouriteBiblePrivate, config.favouriteBiblePrivate2, config.favouriteBiblePrivate3]
