...
# %% ../nbs/00_core.ipynb 4
# Need the streptofile for a few functions, this can be considered a static var

import importlib
import importlib.util
import os

PACKAGE_NAME: str = "streptofile"  # Make sure to adjust this to your package name
DEV_MODE: bool = (
