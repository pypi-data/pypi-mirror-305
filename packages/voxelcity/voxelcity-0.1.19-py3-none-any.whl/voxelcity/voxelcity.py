...
from .file.geojson import get_geojson_from_gpkg
...
def get_building_height_grid(rectangle_vertices, meshsize, source, output_dir, **kwargs):
    ...
    if source == 'Microsoft Building Footprints':
        ...
        geojson_data = load_geojson_from_eubucco(rectangle_vertices)
        building_height_grid, filtered_buildings = create_building_height_grid_from_geojson_polygon(geojson_data, meshsize, rectangle_vertices)
...
def create_3d_voxel(building_height_grid_ori, land_cover_grid_ori, dem_grid_ori, tree_grid_ori, voxel_size, land_cover_source, **kwargs):
...
def get_voxelcity(rectangle_vertices, building_source, land_cover_source, canopy_height_source, dem_source, meshsize, **kwargs):
    ...
    building_height_grid, building_geojson = get_building_height_grid(rectangle_vertices, meshsize, building_source, output_dir, **kwargs)
