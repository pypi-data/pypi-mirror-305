...
class StreamProcessor(
    ...
    def __init__(
        ...
        *,
        ...
        :param instance_name: Human-readable label that identifies the stream instance. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/1.21.4/docs/resources/stream_processor#instance_name StreamProcessor#instance_name}
        :param pipeline: Stream aggregation pipeline you want to apply to your streaming data. `MongoDB Atlas Docs <https://www.mongodb.com/docs/atlas/atlas-stream-processing/stream-aggregation/#std-label-stream-aggregation>`_ contain more information. Using `jsonencode <https://developer.hashicorp.com/terraform/language/functions/jsonencode>`_ is recommended when settig this attribute. For more details see `Aggregation Pipelines Documentation <https://www.mongodb.com/docs/atlas/atlas-stream-processing/stream-aggregation/>`_ Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/1.21.4/docs/resources/stream_processor#pipeline StreamProcessor#pipeline}
        :param processor_name: Human-readable label that identifies the stream processor. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/1.21.4/docs/resources/stream_processor#processor_name StreamProcessor#processor_name}
        :param project_id: Unique 24-hexadecimal digit string that identifies your project. Use the `/groups <#tag/Projects/operation/listProjects>`_ endpoint to retrieve all projects to which the authenticated user has access. **NOTE**: Groups and projects are synonymous terms. Your group id is the same as your project id. For existing groups, your group/project id remains the same. The resource and corresponding endpoints use the term groups. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/1.21.4/docs/resources/stream_processor#project_id StreamProcessor#project_id}
        :param options: Optional configuration for the stream processor. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/1.21.4/docs/resources/stream_processor#options StreamProcessor#options}
        :param state: The state of the stream processor. Commonly occurring states are 'CREATED', 'STARTED', 'STOPPED' and 'FAILED'. Used to start or stop the Stream Processor. Valid values are ``CREATED``, ``STARTED`` or ``STOPPED``. When a Stream Processor is created without specifying the state, it will default to ``CREATED`` state. **NOTE** When a stream processor is created, the only valid states are CREATED or STARTED. A stream processor can be automatically started when creating it if the state is set to STARTED. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/1.21.4/docs/resources/stream_processor#state StreamProcessor#state}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing StreamProcessor that should be imported. Refer to the {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/1.21.4/docs/resources/stream_processor#import import section} in the documentation of this resource for the id to use
    ...
    def put_options(
        ...
        *,
        ...
        '''
        :param dlq: Dead letter queue for the stream processor. Refer to the `MongoDB Atlas Docs <https://www.mongodb.com/docs/atlas/reference/glossary/#std-term-dead-letter-queue>`_ for more information. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/1.21.4/docs/resources/stream_processor#dlq StreamProcessor#dlq}
        '''
...
class StreamProcessorOptionsDlq:
    def __init__(
        ...
        *,
        ...
        '''
        :param coll: Name of the collection to use for the DLQ. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/1.21.4/docs/resources/stream_processor#coll StreamProcessor#coll}
        :param connection_name: Name of the connection to write DLQ messages to. Must be an Atlas connection. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/1.21.4/docs/resources/stream_processor#connection_name StreamProcessor#connection_name}
        :param db: Name of the database to use for the DLQ. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/1.21.4/docs/resources/stream_processor#db StreamProcessor#db}
        '''
        if __debug__:
