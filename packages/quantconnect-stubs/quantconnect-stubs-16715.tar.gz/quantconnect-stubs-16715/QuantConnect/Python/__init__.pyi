...
class PandasConverter(System.Object):
    ...
    @overload
    def get_data_frame(self, data: System.Collections.Generic.IEnumerable[QuantConnect_Python_PandasConverter_GetDataFrame_T], symbol_only_index: bool = False, force_multi_value_symbol: bool = False) -> pandas.DataFrame:
        """
