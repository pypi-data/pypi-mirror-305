...
from hygraph_core import HyGraph, HyGraphQuery
  # Initialize HyGraph
    ...
    # Creating nodes
    node1 = hygraph.add_pgnode(oid=1, label="Node1", start_time="2023-01-01")
    node2 = hygraph.add_pgnode(oid=2, label="Node2", start_time="2023-01-01")
    ...
    edge.add_temporal_property("traffic", [1, 3, 5], ["2023-01-01", "2023-01-02", "2023-01-03"], hygraph)
