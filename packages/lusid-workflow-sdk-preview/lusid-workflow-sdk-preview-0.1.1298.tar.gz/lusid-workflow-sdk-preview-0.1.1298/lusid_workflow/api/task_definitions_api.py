...
class TaskDefinitionsApi(object):
    ...
    def delete_task_definition_with_http_info(self, scope, code, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('scope' in local_var_params and  # noqa: E501
                                                        len(local_var_params['scope']) > 512):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `scope` when calling `delete_task_definition`, length must be less than or equal to `512`")  # noqa: E501
        if self.api_client.client_side_validation and ('scope' in local_var_params and  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('code' in local_var_params and  # noqa: E501
                                                        len(local_var_params['code']) > 512):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `code` when calling `delete_task_definition`, length must be less than or equal to `512`")  # noqa: E501
        if self.api_client.client_side_validation and ('code' in local_var_params and  # noqa: E501
