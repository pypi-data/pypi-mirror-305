...
class CreateChildTasksAction(object):
    ...
    def __init__(self, type=None, child_task_configurations=None, local_vars_configuration=None):  # noqa: E501
        ...
        :type type: str
        :param child_task_configurations:  The Child Task Configurations (required)
    ...
    @property
    def type(self):
        """Gets the type of this CreateChildTasksAction.  # noqa: E501

        Type name for this Action  # noqa: E501

        :return: The type of this CreateChildTasksAction.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this CreateChildTasksAction.

        Type name for this Action  # noqa: E501

        :param type: The type of this CreateChildTasksAction.  # noqa: E501
        :type type: str
        """
    ...
    def child_task_configurations(self, child_task_configurations):
        ...
        :type child_task_configurations: list[lusid_workflow.CreateChildTaskConfiguration]
        """
        if self.local_vars_configuration.client_side_validation and child_task_configurations is None:  # noqa: E501
            raise ValueError("Invalid value for `child_task_configurations`, must not be `None`")  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateChildTasksAction):
            return False
