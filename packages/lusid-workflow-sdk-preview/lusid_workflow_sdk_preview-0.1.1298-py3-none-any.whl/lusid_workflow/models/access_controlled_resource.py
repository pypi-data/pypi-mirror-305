...
class AccessControlledResource(object):
    ...
    def __init__(self, application=None, name=None, description=None, actions=None, identifier_parts=None, links=None, local_vars_configuration=None):  # noqa: E501
        ...
        :type actions: list[lusid_workflow.AccessControlledAction]
        :param identifier_parts: 
        :type identifier_parts: list[lusid_workflow.IdentifierPartSchema]
        :param links: 
    ...
    def actions(self):
        ...
        :rtype: list[lusid_workflow.AccessControlledAction]
        """
    ...
    def identifier_parts(self):
        ...
        :rtype: list[lusid_workflow.IdentifierPartSchema]
        """
