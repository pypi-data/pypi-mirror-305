...
class TaskActivity(object):
    ...
    def __init__(self, type=None, correlation_ids=None, task_fields=None, initial_trigger=None, filter=None, trigger=None, local_vars_configuration=None):  # noqa: E501
        """TaskActivity - a model defined in OpenAPI"
    ...
    @property
    def type(self):
        """Gets the type of this TaskActivity.  # noqa: E501

        The type of task activity  # noqa: E501

        :return: The type of this TaskActivity.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this TaskActivity.

        The type of task activity  # noqa: E501

        :param type: The type of this TaskActivity.  # noqa: E501
        :type type: str
        """
    ...
    def correlation_ids(self):
        """Gets the correlation_ids of this TaskActivity.  # noqa: E501

        The event to correlation ID mappings  # noqa: E501

        :return: The correlation_ids of this TaskActivity.  # noqa: E501
    ...
    def correlation_ids(self, correlation_ids):
        """Sets the correlation_ids of this TaskActivity.

        The event to correlation ID mappings  # noqa: E501

        :param correlation_ids: The correlation_ids of this TaskActivity.  # noqa: E501
        :type correlation_ids: list[lusid_workflow.EventHandlerMapping]
        """
    ...
    def task_fields(self):
        """Gets the task_fields of this TaskActivity.  # noqa: E501

        The event to task field mappings  # noqa: E501

        :return: The task_fields of this TaskActivity.  # noqa: E501
    ...
    def task_fields(self, task_fields):
        """Sets the task_fields of this TaskActivity.

        The event to task field mappings  # noqa: E501

        :param task_fields: The task_fields of this TaskActivity.  # noqa: E501
        :type task_fields: dict[str, lusid_workflow.FieldMapping]
        """
    ...
    def initial_trigger(self):
        """Gets the initial_trigger of this TaskActivity.  # noqa: E501

        Trigger to supply to all tasks to be made  # noqa: E501

        :return: The initial_trigger of this TaskActivity.  # noqa: E501
        :rtype: str
        """
    ...
    def initial_trigger(self, initial_trigger):
        """Sets the initial_trigger of this TaskActivity.

        Trigger to supply to all tasks to be made  # noqa: E501

        :param initial_trigger: The initial_trigger of this TaskActivity.  # noqa: E501
        :type initial_trigger: str
        """
    ...
    @property
    def filter(self):
        """Gets the filter of this TaskActivity.  # noqa: E501

        The filter that matches on existing tasks  # noqa: E501

        :return: The filter of this TaskActivity.  # noqa: E501
        :rtype: str
        """
        return self._filter
    ...
    def filter(self, filter):
        """Sets the filter of this TaskActivity.

        The filter that matches on existing tasks  # noqa: E501

        :param filter: The filter of this TaskActivity.  # noqa: E501
        :type filter: str
        """
    ...
    @property
    def trigger(self):
        """Gets the trigger of this TaskActivity.  # noqa: E501

        Trigger to supply to all tasks that have been matched  # noqa: E501

        :return: The trigger of this TaskActivity.  # noqa: E501
        :rtype: str
        """
    ...
    def trigger(self, trigger):
        """Sets the trigger of this TaskActivity.

        Trigger to supply to all tasks that have been matched  # noqa: E501

        :param trigger: The trigger of this TaskActivity.  # noqa: E501
        :type trigger: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TaskActivity):
            return False
