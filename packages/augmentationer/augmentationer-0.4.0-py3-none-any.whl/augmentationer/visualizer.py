...
def visualizer(image_path: Union[str, Path], label_path: Union[str, Path], target_class_id: int = None, text: bool = True):
    """
    ...
    target_class_id (int, optional): 시각화할 특정 클래스 ID (기본값: None, 모든 클래스 표시)
...
if __name__ == "__main__":  
    ...
    # 함수 사용 예시
    visualizer(f'output/images/{name}.jpg', f'output/labels/{name}.txt', target_class_id=1, text=False)
