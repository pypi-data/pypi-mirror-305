...
from lion_core.types import IDTypes, LnID
...
class Progression(Element, Ordering):
    ...
    order: list[IDTypes.IDOnly] = Field(
    ...
    def _validate_order(cls, value: IDTypes.RefSeq) -> list[LnID]:
        return validate_order(value)

    def __contains__(self, item: IDTypes.RefSeq | IDTypes.Ref) -> bool:
    ...
    def __getitem__(self, key: int | slice) -> IDTypes.IDSeq:
    ...
    def __setitem__(self, key: int | slice, value: IDTypes.RefSeq) -> None:
    ...
    def append(self, item: IDTypes.RefSeq, /) -> None:
    ...
    def include(self, item: IDTypes.RefSeq, /) -> None:
    ...
    def exclude(self, item: int | IDTypes.RefSeq, /) -> None:
    ...
    def remove(self, item: IDTypes.RefSeq, /) -> None:
    ...
    def count(self, item: IDTypes.Ref, /) -> int:
    ...
    def __add__(self, other: IDTypes.RefSeq) -> "Progression":
    ...
    def __radd__(self, other: IDTypes.RefSeq) -> "Progression":
        return self + other

    def __iadd__(self, other: IDTypes.RefSeq) -> Self:
        """Add an item to the end of the progression in-place."""
        self.append(other)
        return self

    def __isub__(self, other: IDTypes.RefSeq) -> Self:
        """Remove an item from the progression in-place."""
        self.remove(other)
        return self

    def __sub__(self, other: IDTypes.RefSeq) -> "Progression":
    ...
    def insert(self, index: int, item: IDTypes.RefSeq, /) -> None:
