...
from lionfuncs import to_df

from lion_core.protocols.adapters.adapter import Adapter, T
...
class ExcelFileAdapter(Adapter):
    ...
    @classmethod
    def to_obj(
        cls, subj: list[T] | Collective, /, fp: str | Path, **kwargs
    ) -> None:
        kwargs["index"] = False
