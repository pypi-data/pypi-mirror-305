...
from lion_core.protocols import Adapter, AdapterRegistry, PileAdapterRegistry
from lion_core.sys_utils import SysUtil
from lion_core.types import LN_UNDEFINED, IDTypes, LnID
...
class Pile(Element, Collective, Generic[T]):
    ...
    def __init__(
        self,
        items: IDTypes.ItemSeq = None,
        item_type: set[type[Observable]] = None,
        order: IDTypes.RefSeq | list[LnID] = None,
    ...
    def __setitem__(
        self,
        key: IDTypes.Ref | IDTypes.RefSeq | int | slice,
        item: IDTypes.ItemSeq | IDTypes.ItemOnly,
    ) -> None:
    ...
    def update(
        self,
        other: IDTypes.ItemOnly | IDTypes.ItemSeq,
        /,
    ) -> None:
    ...
    def __getitem__(
        self, key: IDTypes.Ref | IDTypes.RefSeq | int | slice
    ) -> Any | list | T:
    ...
    async def asetitem(
        self,
        key: IDTypes.Ref | IDTypes.RefSeq | int | slice,
        item: IDTypes.ItemOnly | IDTypes.ItemSeq,
        /,
    ) -> None:
    ...
    async def aremove(
        self,
        item: IDTypes.Ref | IDTypes.RefSeq,
        /,
    ) -> None:
    ...
    async def aupdate(
        self,
        other: IDTypes.ItemSeq | IDTypes.ItemOnly,
        /,
    ) -> None:
        self._update(other)
    ...
    def _remove(self, item: IDTypes.Ref | IDTypes.RefSeq):
        """
    ...
    def _include(self, item: IDTypes.ItemSeq | IDTypes.ItemOnly):
        """
    ...
    def _exclude(self, item: IDTypes.Ref | IDTypes.RefSeq):
        """
    ...
    def _update(self, other: IDTypes.ItemSeq | IDTypes.ItemOnly):
    ...
    def _insert(self, index: int, item: IDTypes.ItemOnly):
        item_dict = self._validate_pile(item)
