...
from mach_client import ChainId, Token, balances, client, utility as client_utility

from .. import config, transactions, utility
...
async def run(
    *,
    ...
    src_w3 = await client_utility.make_w3(src_token.chain)
    ...
    while True:
        ...
        dest_w3 = await client_utility.make_w3(dest_token.chain)
