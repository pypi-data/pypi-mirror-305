...
# %% auto 0
__all__ = ['DomoAccounts', 'Account_Accesslist_Share', 'Account_Accesslist']
    ...
    **kwargs
    ...
    if not is_use_default:
        new_class = DomoAccount_Types.get(
            obj.get("dataProviderType") or obj.get("dataProviderId")
        )
...
async def _get_accounts_queryapi(
    ...
    **kwargs
    ...
    return [
        DomoAccount._from_json(account_obj, auth=auth, **kwargs) for account_obj in res.response
    ]
...
async def upsert_account(
    ...
    **kwargs
    ...
    if account_id:
        acc = await DomoAccounts.get_accounts(account_id=account_id, auth=auth,debug_api = debug_api, session = session, **kwargs)
