...
class BedrockClient(BaseClient):
    ...
    def create_inference_profile(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/bedrock.html#Bedrock.Client.create_inference_profile)
    ...
    def delete_inference_profile(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/bedrock.html#Bedrock.Client.delete_inference_profile)
