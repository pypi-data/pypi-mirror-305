...
from langchain.tools import python as PythonTool
...
def main():
    ...
    shell_tool = ShellTool();python_tool = PythonTool()
    model = ChatOpenAI(model=model_name, temperature=0)
    tools = [get_weather, shell_tool, Tool(name="Python Interpreter", func=python_tool.run, description="Executes Python code.")]
    ...
    try:os.makedirs('.olca', exist_ok=True)
