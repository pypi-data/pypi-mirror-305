...
MODEL_PRICE = {
    ...
    # 虚拟换衣
    "api-kolors-virtual-try-on": 0.0001,

    # 语音克隆
    "official-api-fish-model": 0.0001,
    "official-api-fish-tts": 0.0001,
...
MODEL_RATIO = {
    ...
    "gemini-1.5-flash-002": 0.04,
    "gemini-1.5-flash-latest": 0.04,
    "gemini-1.5-flash-exp-0827": 0.1,

    "gemini-1.5-pro-002": 0.63,
