...
async def get_api_key_log(api_key: str):  # 日志查询会超时：为了获取 user_id, todo缓存 永久缓存 sk => user
    try:
...
if __name__ == '__main__':
    ...
    arun(get_api_key_log('sk-LPvniTTKdYSXzxMsAaBfEe531e0b48E19c35881d6684959c'))
