...
def get_yy(payload: dict, params: dict):
    if payload:
        base_path = "/api/multimodal/generate/video"
    else:
        base_path = "/api/multimodal/video/processing"
    ...
    original_url = f"{base_path}?{urlencode(params)}"
