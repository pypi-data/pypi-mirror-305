...
from gs_netsuite_api.api import CustomerAPI
...
if __name__ == "__main__":
    ...
    api = CustomerAPI(credential=cred, search_params=SearchParams(page_size=5, nb_pages=2))

    data_one = api.get_one(2173028)
    pprint(data_one)
