...
class Generate_Transcation:
    ...
    def replace_obj_actions(self, transaction_model,object_name):
        self.line_no = 1

        for sql_model in transaction_model['transaction']['sql_models']:
            actions_details = []    
    ...
    def replace_obj_links(self, transaction_model,object_name):
        line_no_link = 1
