...
class GuestController(BaseControllerFWDI, metaclass=MetaServiceFWDI):
    def __init__(self, composite:BaseComposit, base_path:str='/'):
        super().__init__(base_path)
        self.__composite:BaseComposit = composite
    
    def get(self, current_user: User = Security(JwtServiceFWDI.get_current_active_user, scopes=["guest"]),):
