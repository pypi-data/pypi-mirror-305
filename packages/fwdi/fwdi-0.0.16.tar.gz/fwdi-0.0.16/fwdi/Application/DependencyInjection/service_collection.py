...
class ServiceCollectionFWDI(BaseServiceCollectionFWDI):
    ...
    def AddImplementSingleton(self, implementation: TService):
        self._serviceDescriptor.add(ServiceDescriptorFWDI.create_implement(implementation, lifetime=ServiceLifetime.Singleton))
    ...
    def AddImplementTransient(self, implementation: TService):
        self._serviceDescriptor.add(ServiceDescriptorFWDI.create_implement(implementation, ServiceLifetime.Transient))
