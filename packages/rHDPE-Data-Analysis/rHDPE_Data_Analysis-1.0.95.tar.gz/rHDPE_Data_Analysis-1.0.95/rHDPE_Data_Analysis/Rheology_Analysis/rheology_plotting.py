...
def plot_data( ip, file_data, data, first_derivative_data, second_derivative_data, savefig = False ):
    ...
    x, y = 1, 3 # 0:af, 1:sm, 2:lm, 3:cv, 4:lf, 5-8 same but means.
                            ...
                            if file_data[j][2] in specimen_mask:
                                ...
                                if deriv0:
                                    ...
                                    if x == 0:
                                        ...
                                        # plt.plot( data[0][xaxis_mask], data[2][j][xaxis_mask], label = "Loss Modulus", color = colours[i + 1] )
                                        ...
                                        # data_extraction.append( data[1][j][xaxis_mask] )
