...
class GS:
    ...
    def upload_file(
        self, bucket_name, blob_name, p, content_type="application/octet-stream"
    ):
        """
    ...
    def upload_folder(self, local_folder_path, bucket_name, remote_folder_path=""):
        ...
        try:
            for root, dirs, files in os.walk(local_folder_path):
                for file in files:
                    ...
                    remote_file_path = os.path.join(
                        remote_folder_path, relative_path
                    ).replace(os.sep, "/")
                    # Upload the file
            ...
            print(
                f"Uploaded folder '{local_folder_path}' to '{bucket_name}/{remote_folder_path}'"
            )
        except Exception as exc:
    ...
    def download_folder(
        ...
        try:
            ...
            print(
                f"Downloaded folder '{bucket_name}/{remote_folder_path}' to '{local_folder_path}'"
            )
        except Exception as exc:
