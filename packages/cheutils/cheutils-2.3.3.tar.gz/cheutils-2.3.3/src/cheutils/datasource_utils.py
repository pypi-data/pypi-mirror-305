                ...
                try:
                    ...
                    if temp_table:
                        ...
                        try:
                            ...
                            LOGGER.debug('No dangling temporary table: {} {}', underlying_table, 'to clear')
                            try:
                    ...
                    try:
                        ...
                        LOGGER.warning('WARNING committing: {}', posMySQLEx) # this issue may only happen for MySQL, so ignore
                        try:
                            connection.commit()
                        except:
                            pass
