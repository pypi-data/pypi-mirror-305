...
class DBTool(object):
    ...
    def __init__(self, ds_config, verbose=False):
        ...
        try:
            ...
            connect_args["timeout"] = int(any_timeout) if any_timeout is not None else 10
