            ...
            with self.get_connection() as connection:
                ...
                try:
                    ...
                    try:
                        ...
                        LOGGER.warning('WARNING: Issues encountered committing with cursor: {}', posMySQLEx) # this issue may only happen for MySQL, so ignore
                        try:
                            connection.commit()
                        except Exception as comErr:
                            LOGGER.warning('WARNING: Issues encountered committing with connection: {}', comErr)
                    finally:
                        try:
                            cursor.close()
                            connection.close()
