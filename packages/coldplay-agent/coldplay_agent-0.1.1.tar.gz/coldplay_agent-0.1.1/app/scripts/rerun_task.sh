...
rerun_task() {
    ...
    nohup python $script_run_url_new --task=pointfoot_rough  --task_id=$task_id --headless --load_run $load_run --checkpoint $checkpoint > ./pointfoot_legged_gym_output.log 2>&1 &
