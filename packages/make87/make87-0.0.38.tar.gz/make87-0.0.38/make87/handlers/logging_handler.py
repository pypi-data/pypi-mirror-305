...
from make87.topics import TypedPublisherTopic, get_publisher_topic, resolve_topic_name
...
class _LogHandler(logging.Handler):
    ...
    def __init__(self, topic):
        super().__init__()
        self._topic: TypedPublisherTopic = topic
...
def setup():
    ...
    try:
        topic = get_publisher_topic(bname=resolve_topic_name("LOGS"), message_type=LogMessage)
