...
def parse_query_params(func):
    ...
    def wrapper(*args, **kwargs):
        query_params = incoming_request.args.to_dict()
        if incoming_request.is_json:
            request_json = incoming_request.get_json()
            if request_json is None:
                request_json = {}
            request_json.update(query_params)
            incoming_request._cached_json = request_json
        else:
            incoming_request._cached_json = query_params
