...
class Species18207___ToStringTag7331(Enum):
    SHARED_ARRAY_BUFFER = "SharedArrayBuffer"


@dataclass
class SharedArrayBuffer:
    species_18207: Optional['SharedArrayBuffer'] = None
    to_string_tag_7331: Optional[Species18207___ToStringTag7331] = None
    byte_length: Optional[float] = None

    @staticmethod
    def from_dict(obj: Any) -> 'SharedArrayBuffer':
        assert isinstance(obj, dict)
        species_18207 = from_union([SharedArrayBuffer.from_dict, from_none], obj.get("__@species@18207"))
        to_string_tag_7331 = from_union([Species18207___ToStringTag7331, from_none], obj.get("__@toStringTag@7331"))
        byte_length = from_union([from_float, from_none], obj.get("byteLength"))
        return SharedArrayBuffer(species_18207, to_string_tag_7331, byte_length)

    def to_dict(self) -> dict:
        result: dict = {}
        if self.species_18207 is not None:
            result["__@species@18207"] = from_union([lambda x: to_class(SharedArrayBuffer, x), from_none], self.species_18207)
        if self.to_string_tag_7331 is not None:
            result["__@toStringTag@7331"] = from_union([lambda x: to_enum(Species18207___ToStringTag7331, x), from_none], self.to_string_tag_7331)
...
class ArrayBufferLike:
    to_string_tag_7331: Optional[str] = None
    byte_length: Optional[float] = None
    species_18207: Optional[SharedArrayBuffer] = None
    ...
    def from_dict(obj: Any) -> 'ArrayBufferLike':
        assert isinstance(obj, dict)
        to_string_tag_7331 = from_union([from_str, from_none], obj.get("__@toStringTag@7331"))
        byte_length = from_union([from_float, from_none], obj.get("byteLength"))
        species_18207 = from_union([SharedArrayBuffer.from_dict, from_none], obj.get("__@species@18207"))
        return ArrayBufferLike(to_string_tag_7331, byte_length, species_18207)

    def to_dict(self) -> dict:
        result: dict = {}
        if self.to_string_tag_7331 is not None:
            result["__@toStringTag@7331"] = from_union([from_str, from_none], self.to_string_tag_7331)
        if self.byte_length is not None:
            result["byteLength"] = from_union([to_float, from_none], self.byte_length)
        if self.species_18207 is not None:
            result["__@species@18207"] = from_union([lambda x: to_class(SharedArrayBuffer, x), from_none], self.species_18207)
...
class ID:
    ...
    to_string_tag_7331: Optional[IDToStringTag7331] = None
    ...
    def from_dict(obj: Any) -> 'ID':
        assert isinstance(obj, dict)
        to_string_tag_7331 = from_union([IDToStringTag7331, from_none], obj.get("__@toStringTag@7331"))
        ...
        return ID(to_string_tag_7331, buffer, byte_length, byte_offset, bytes_per_element, length)

    def to_dict(self) -> dict:
        result: dict = {}
        if self.to_string_tag_7331 is not None:
            result["__@toStringTag@7331"] = from_union([lambda x: to_enum(IDToStringTag7331, x), from_none], self.to_string_tag_7331)
...
class OpenAPIMethod:
    ...
    def from_dict(obj: Any) -> 'OpenAPIMethod':
        ...
        return OpenAPIMethod(description, summary, type)
...
class OpenAPI:
    ...
    def from_dict(obj: Any) -> 'OpenAPI':
        ...
        return OpenAPI(created_at, aspect_type, open_api_created_at, entity_id, id, methods, path)
...
class MapStringString:
    ...
    def from_dict(obj: Any) -> 'MapStringString':
        ...
        to_string_tag_7331 = from_union([from_str, from_none], obj.get("__@toStringTag@7331"))
        size = from_union([from_float, from_none], obj.get("size"))
        return MapStringString(to_string_tag_7331, size)
