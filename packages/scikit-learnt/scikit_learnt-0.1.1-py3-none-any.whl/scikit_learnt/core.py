...
class random_forest:
    ...
    def random_forest(self, schema, question, generated_query):
        """
        ...
        try:
            response = openai.ChatCompletion.create(
                model="gpt-4",
                messages=[
                    {"role": "system", "content": "You are a helpful assistant specialized in SQL, MYSQL, POTGRESQL, ORACLE and SQLITE query refinement."},
