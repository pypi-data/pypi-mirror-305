...
def init_lib(app: Flask, logger: logging.Logger, redis_pool: ConnectionPool) -> None:
    """
    ...
    ct_redis = app.extensions['ct_redis']

    # Example usage of Redis caching with the decorator
    @ct_redis.redis_cache(template_cache_key='idle_time_value:$idle_time', field='$idle_time', is_global=True)
