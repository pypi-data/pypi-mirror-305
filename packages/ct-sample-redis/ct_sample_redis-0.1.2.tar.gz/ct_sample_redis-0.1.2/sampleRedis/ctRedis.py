...
class CtRedis:
    ...
    def redis_cache(self, template_cache_key, field, expire_time=None, is_global=False):
        def decorator(func):
            @wraps(func)
    ...
    def generate_cache_key_and_hash_field(self, template_cache_key, func, template_hash_field, is_global, *args):
