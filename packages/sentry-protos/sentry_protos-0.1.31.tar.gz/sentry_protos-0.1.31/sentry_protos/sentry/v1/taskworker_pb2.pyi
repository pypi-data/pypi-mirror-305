...
class TaskActivation(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["_deadline", b"_deadline", "deadline", b"deadline", "received_at", b"received_at", "retry_state", b"retry_state"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_deadline", b"_deadline", "deadline", b"deadline", "headers", b"headers", "id", b"id", "namespace", b"namespace", "parameters", b"parameters", "received_at", b"received_at", "retry_state", b"retry_state", "taskname", b"taskname"]) -> None: ...
