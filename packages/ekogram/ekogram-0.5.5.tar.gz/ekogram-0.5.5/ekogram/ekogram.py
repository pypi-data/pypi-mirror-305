...
class Bot:
    ...
    def reply_message(self, chat_id: Union[int, str], text: str, mode: str = "Markdown", disable_web_page_preview: bool = None, disable_notification: bool = None, reply_to_message_id: int = None, reply_markup: dict = None) -> Optional['Message']:
    ...
    def reply_photo(self, chat_id: Union[int, str], photo: Union[str, bytes], caption: str = None, mode: str = "Markdown", disable_notification: bool = None, reply_to_message_id: int = None, reply_markup: dict = None) -> Optional['Message']:
        '''Отправляет фото'''
        method = 'sendPhoto'
        if not chat_id:
            raise ValueError("chat_id не должен быть None")
    ...
    def reply_audio(self, chat_id: Union[int, str], audio: Union[str, bytes], caption: str = None, mode: str = "Markdown", duration: int = None, performer: str = None, title: str = None, thumb: Union[str, bytes] = None, disable_notification: bool = None, reply_to_message_id: int = None, reply_markup: dict = None) -> Optional['Message']:
        '''Отправляет аудио'''
        method = 'sendAudio'
        if not chat_id:
            raise ValueError("chat_id не должен быть None")
    ...
    def reply_document(self, chat_id: Union[int, str], document: Union[str, bytes], caption: str = None, mode: str = "Markdown", disable_notification: bool = None, reply_to_message_id: int = None, reply_markup: dict = None) -> Optional['Message']:
        '''Отправляет документ'''
        method = 'sendDocument'
        if not chat_id:
            raise ValueError("chat_id не должен быть None")
    ...
    def reply_video(self, chat_id: Union[int, str], video: Union[str, bytes], duration: int = None, width: int = None, height: int = None, caption: str = None, mode: str = "Markdown", supports_streaming: bool = None, disable_notification: bool = None, reply_to_message_id: int = None, reply_markup: dict = None) -> Optional['Message']:
        '''Отправляет видео'''
        method = 'sendVideo'
        if not chat_id:
            raise ValueError("chat_id не должен быть None")
    ...
    def reply_video_note(self, chat_id: Union[int, str], video_note: Union[str, bytes], duration: int = None, length: int = None, disable_notification: bool = None, reply_to_message_id: int = None, reply_markup: dict = None) -> Optional['Message']:
    ...
    def reply_animation(self, chat_id: Union[int, str], animation: Union[str, bytes], duration: int = None, width: int = None, height: int = None, caption: str = None, mode: str = "Markdown", disable_notification: bool = None, reply_to_message_id: int = None, reply_markup: dict = None) -> Optional['Message']:
        '''Отправляет анимацию'''
    ...
    def reply_voice(self, chat_id: Union[int, str], voice: Union[str, bytes], caption: str = None, mode: str = "Markdown", duration: int = None, disable_notification: bool = None, reply_to_message_id: int = None, reply_markup: dict = None) -> Optional['Message']:
    ...
    def reply_location(self, chat_id: Union[int, str], latitude: float, longitude: float, live_period: int = None, disable_notification: bool = None, reply_to_message_id: int = None, reply_markup: dict = None) -> Optional['Message']:
    ...
    def reply_venue(self, chat_id: Union[int, str], latitude: float, longitude: float, title: str, address: str, foursquare_id: str = None, disable_notification: bool = None, reply_to_message_id: int = None, reply_markup: dict = None) -> Optional['Message']:
    ...
    def reply_contact(self, chat_id: Union[int, str], phone_number: str, first_name: str, last_name: str = None, disable_notification: bool = None, reply_to_message_id: int = None, reply_markup: dict = None) -> Optional['Message']:
    ...
    def reply_sticker(self, chat_id: Union[int, str], sticker: Union[str, bytes], disable_notification: bool = None, reply_to_message_id: int = None, reply_markup: dict = None) -> Optional['Message']:
    ...
    def reply_dice(self, chat_id: Union[int, str], emoji: str, disable_notification: bool = None, reply_to_message_id: int = None, reply_markup: dict = None) -> Optional['Message']:
    ...
    def reply_message_reaction(self, chat_id: Union[int, str], message_id: int, reaction: list = ['👍'], is_big: bool = False) -> bool:
        '''Отправить реакцию'''
    ...
    def stop_poll(self, chat_id: Union[int, str], message_id: int, reply_markup: dict = None) -> bool:
    ...
    def copy_message(self, chat_id: Union[int, str], from_chat_id: Union[int, str], message_id: int, caption: str = None, disable_notification: bool = None, mode: str = "Markdown", reply_markup: dict = None) -> bool:
        '''Копирует сообщение'''
        method = 'copyMessage'
        if not chat_id:
            raise ValueError("chat_id не должен быть None")
...
#Редакт чего-то
    def edit_message_text(self, chat_id: Union[int, str], message_id: int, text: str, inline_message_id: str = None, mode="Markdown", reply_markup: dict = None) -> bool:
    ...
    def edit_message_caption(self, chat_id: Union[int, str], message_id: int, caption: str, inline_message_id: str = None, mode: str = "Markdown", show_caption_above_media: bool = False, reply_markup: dict = None) -> bool:
    ...
    def edit_message_media(self, chat_id: Union[int, str], message_id: int, media: Union[str, bytes, InputMediaPhoto, InputMediaAnimation, InputMediaVideo, InputMediaAudio, InputMediaDocument], inline_message_id: str = None, reply_markup: dict = None) -> bool:
    ...
    def edit_message_reply_markup(self, chat_id: Union[int, str], message_id: int, reply_markup: dict, inline_message_id: str = None) -> bool:
