...
class OAuthCapabilities(BaseModel):
    """
    OAuthCapabilities
    """ # noqa: E501
    get_authorization_url: Optional[StrictBool] = True
    handle_authorization_callback: Optional[StrictBool] = True
    refresh_access_token: Optional[StrictBool] = True
    __properties: ClassVar[List[str]] = ["get_authorization_url", "handle_authorization_callback", "refresh_access_token"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OAuthCapabilities from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OAuthCapabilities from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "get_authorization_url": obj.get("get_authorization_url") if obj.get("get_authorization_url") is not None else True,
            "handle_authorization_callback": obj.get("handle_authorization_callback") if obj.get("handle_authorization_callback") is not None else True,
            "refresh_access_token": obj.get("refresh_access_token") if obj.get("refresh_access_token") is not None else True
        })
        return _obj
