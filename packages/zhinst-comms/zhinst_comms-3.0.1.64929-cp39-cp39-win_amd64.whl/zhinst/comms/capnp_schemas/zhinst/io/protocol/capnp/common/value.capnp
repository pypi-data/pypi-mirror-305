...
# Important: a single "Data" field can't store more than 2^29-1 bytes. Thus, when sending extremely
# large vectors, the data should be split into multiple segments.
