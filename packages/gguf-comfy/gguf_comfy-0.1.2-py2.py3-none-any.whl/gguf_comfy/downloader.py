...
# print(f"https://github.com/calcuis/gguf-comfy/releases/download/{__version__}/ComfyUI_GGUF_windows_portable.7z")
# url = "https://github.com/calcuis/gguf-comfy/releases/download/0.0.6/ComfyUI_GGUF_windows_portable.7z" # replace it with dynamic -v

url = f"https://github.com/calcuis/gguf-comfy/releases/download/{__version__}/ComfyUI_GGUF_windows_portable.7z"
