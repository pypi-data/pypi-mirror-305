...
VERSION = "0.0.4.22"  # la version doit être supérieure à la précédente sinon la publication sera refusée
...
# Dépendances
INSTALL_REQUIRES = ["torch==2.2.2", "sentence-transformers", "gpt4all", "sacremoses", "transformers", "sentencepiece", "optuna", "spacy==3.7.6"]
