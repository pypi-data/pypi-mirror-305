...
class ProX(cns.sqlX, cns.SQLstrX):
    ...
    tmpl['on'] = { '模板': "{连接2} t1.`{值}`= t{计数x2}.`{值}`",  '连接':' AND '} # ok
    ...
    # 删索引 ALTER TABLE customers DROP INDEX idx_customer_name;
      #ADD INDEX
