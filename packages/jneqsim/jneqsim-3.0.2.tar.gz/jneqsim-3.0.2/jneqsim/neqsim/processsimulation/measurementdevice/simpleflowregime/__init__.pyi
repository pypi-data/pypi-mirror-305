...
class SevereSlugAnalyser(jneqsim.neqsim.processsimulation.measurementdevice.MeasurementDeviceBaseClass):
    ...
    @typing.overload
    def __init__(self, string: typing.Union[java.lang.String, str], stream: jneqsim.neqsim.processsimulation.processequipment.stream.Stream, double: float, double2: float, double3: float, double4: float): ...
    @typing.overload
    def __init__(self, string: typing.Union[java.lang.String, str], stream: jneqsim.neqsim.processsimulation.processequipment.stream.Stream, double: float, double2: float, double3: float, double4: float, double5: float, double6: float, double7: float, int: int): ...
    @typing.overload
    def __init__(self, string: typing.Union[java.lang.String, str], stream: jneqsim.neqsim.processsimulation.processequipment.stream.Stream, double: float, double2: float, double3: float, double4: float, double5: float, int: int): ...
    @typing.overload
