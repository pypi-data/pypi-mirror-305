...
class BuilderModel:
    ...
    def buildTFM(self, output_path: str = None,  local_library_path: str = None,  TFM_inputs = None, magnet_data = None,
        ...
        if self.circuit_data.TFM != None:
            if not self.circuit_data.TFM.skip_TFM:
                ...
                for key, m_TFM in magnets_TFM.items():
                    ...
                    print_nodes = BM_TFM.buildTFM(output_path=output_path_TFM, local_library_path=local_library_path, TFM_inputs=TFM_general, magnet_data=m_TFM,
