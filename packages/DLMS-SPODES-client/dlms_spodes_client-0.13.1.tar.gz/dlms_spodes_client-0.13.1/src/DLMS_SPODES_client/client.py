...
from DLMSCommunicationProfile.communication_profile import CommunicationProfile
from DLMSCommunicationProfile.HDLC.hdlc import HDLC
...
class Client:
    id: str | None
    name: str = "unknown"
    com_profile: CommunicationProfile
