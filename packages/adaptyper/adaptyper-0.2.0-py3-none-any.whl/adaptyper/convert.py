...
def convert_value(value, value_type: ValueType, additional_info=None):
    """
    Конвертация значения в нужный тип

    :param value: значение
    :param value_type: конвертировать в этот тип
    ...
    try:
        match value_type:
            ...
            case _:
                raise NotSupportedType((type(value), value_type, value))
