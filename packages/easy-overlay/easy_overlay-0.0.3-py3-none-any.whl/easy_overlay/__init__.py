...
class Overlay:
    ...
    def draw_circle_lines(self, center, radius, color=(255, 0, 0), line_count=12):
        ...
        for i in range(line_count):
            ...
            self.draw_line(start_pos, end_pos, color)
    ...
    def draw_filled_rectangle(self, start_pos, end_pos, color=(255, 0, 0), alpha=128):
        def _draw(dc):
            ...
            # Create transparent pen for border
    ...
    def draw_text_box(self, text, pos, color=(255, 255, 255), bg_color=(0, 0, 0), 
        ...
        def _draw(dc):
            ...
            # Get text extent using win32gui instead of direct GDI calls
            ...
            # Use win32gui for text output instead of direct GDI calls
