...
def activate_and_click(target_window_title, x, y):  
    """激活指定的窗口并单击指定坐标。  

    :param target_window_title: 要激活的窗口标题  
    :param x: 鼠标要移动到的 x 坐标  
    :param y: 鼠标要移动到的 y 坐标  
    """  
    # 获取所有窗口的列表  
    ...
    if target_window:  
        ...
        target_window.restore()  # 如果窗口被最小化，则恢复窗口  
    else:  
