...
async def relationship_create(request: web.Request, x_api_version=None, fields=None, body=None) -> web.Response:
    ...
    :type fields: str
    :param body: Request Body for Relationships
    :type body: dict | bytes

    """
    body = RelationshipCreateRequest.from_dict(body)
    return web.Response(status=200)


async def relationship_destroy(request: web.Request, id, x_api_version=None) -> web.Response:
...
async def relationship_index(request: web.Request, x_api_version=None, contact_id=None, created_since=None, fields=None, ids=None, limit=None, matter_id=None, page_token=None, updated_since=None) -> web.Response:
    ...
    :param x_api_version: The [API minor version](#section/Minor-Versions). Default: latest version.
    :type x_api_version: str
    :param contact_id: The unique identifier for a single Contact. The keyword &#x60;null&#x60; is not valid for this field. The list will be filtered to include only the Relationship records with the matching property.
    :type contact_id: int
    :param created_since: Filter Relationship records to those having the &#x60;created_at&#x60; field after a specific time. (Expects an ISO-8601 timestamp).
    :type created_since: str
    :param fields: The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).
    :type fields: str
    :param ids: Filter Relationship records to those having the specified unique identifiers.
    :type ids: int
    :param limit: A limit on the number of Relationship records to be returned. Limit can range between 1 and 200. Default: &#x60;200&#x60;.
    :type limit: int
    :param matter_id: The unique identifier for a single Matter. The keyword &#x60;null&#x60; is not valid for this field. The list will be filtered to include only the Relationship records with the matching property.
    :type matter_id: int
    :param page_token: A token specifying which page to return.
    :type page_token: str
    :param updated_since: Filter Relationship records to those having the &#x60;updated_at&#x60; field after a specific time. (Expects an ISO-8601 timestamp).
...
async def relationship_show(request: web.Request, id, if_modified_since=None, if_none_match=None, x_api_version=None, fields=None) -> web.Response:
...
async def relationship_update(request: web.Request, id, if_match=None, x_api_version=None, fields=None, body=None) -> web.Response:
