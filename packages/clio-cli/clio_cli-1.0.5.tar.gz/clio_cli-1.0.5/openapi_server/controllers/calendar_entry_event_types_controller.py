...
async def calendar_entry_event_type_create(request: web.Request, x_api_version=None, fields=None, body=None) -> web.Response:
    ...
    :type fields: str
    :param body: Request Body for Calendar Entry Event Types
    :type body: dict | bytes

    """
    body = CalendarEntryEventTypeCreateRequest.from_dict(body)
    return web.Response(status=200)


async def calendar_entry_event_type_destroy(request: web.Request, id, x_api_version=None) -> web.Response:
    ...
    :param id: The unique identifier for the CalendarEntryEventType.
    :type id: int
    :param x_api_version: The [API minor version](#section/Minor-Versions). Default: latest version.
    :type x_api_version: str
...
async def calendar_entry_event_type_index(request: web.Request, x_api_version=None, created_since=None, fields=None, ids=None, limit=None, page_token=None, updated_since=None) -> web.Response:
    ...
    :param x_api_version: The [API minor version](#section/Minor-Versions). Default: latest version.
    :type x_api_version: str
    :param created_since: Filter CalendarEntryEventType records to those having the &#x60;created_at&#x60; field after a specific time. (Expects an ISO-8601 timestamp).
    :type created_since: str
    :param fields: The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).
    :type fields: str
    :param ids: Filter CalendarEntryEventType records to those having the specified unique identifiers.
    :type ids: int
    :param limit: A limit on the number of CalendarEntryEventType records to be returned. Limit can range between 1 and 200. Default: &#x60;200&#x60;.
    :type limit: int
    :param page_token: A token specifying which page to return.
    :type page_token: str
    :param updated_since: Filter CalendarEntryEventType records to those having the &#x60;updated_at&#x60; field after a specific time. (Expects an ISO-8601 timestamp).
...
async def calendar_entry_event_type_show(request: web.Request, id, if_modified_since=None, if_none_match=None, x_api_version=None, fields=None) -> web.Response:
...
async def calendar_entry_event_type_update(request: web.Request, id, if_match=None, x_api_version=None, fields=None, body=None) -> web.Response:
    ...
    """
    body = CalendarEntryEventTypeUpdateRequest.from_dict(body)
    return web.Response(status=200)
