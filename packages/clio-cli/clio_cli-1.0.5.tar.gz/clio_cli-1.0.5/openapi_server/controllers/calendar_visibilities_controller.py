...
async def calendar_visibility_index(request: web.Request, x_api_version=None, created_since=None, fields=None, ids=None, limit=None, page_token=None, updated_since=None) -> web.Response:
...
async def calendar_visibility_show(request: web.Request, id, if_modified_since=None, if_none_match=None, x_api_version=None, fields=None) -> web.Response:
    ...
    :param id: The unique identifier for the CalendarVisibility.
    :type id: int
...
async def calendar_visibility_update(request: web.Request, id, if_match=None, x_api_version=None, fields=None, body=None) -> web.Response:
    ...
    :param fields: The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).
    :type fields: str
    :param body: Request Body for Task Calendars
    :type body: dict | bytes

    """
    body = CalendarVisibilityUpdateRequest.from_dict(body)
    return web.Response(status=200)
