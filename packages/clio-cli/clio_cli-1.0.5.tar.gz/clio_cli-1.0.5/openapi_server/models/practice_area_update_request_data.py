...
class PracticeAreaUpdateRequestData(Model):
    ...
    def __init__(self, category: str=None, code: str=None, name: str=None):
        """PracticeAreaUpdateRequestData - a model defined in OpenAPI

        :param category: The category of this PracticeAreaUpdateRequestData.
        :param code: The code of this PracticeAreaUpdateRequestData.
        :param name: The name of this PracticeAreaUpdateRequestData.
        """
        self.openapi_types = {
            'category': str,
            'code': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'PracticeAreaUpdateRequestData':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The PracticeArea_update_request_data of this PracticeAreaUpdateRequestData.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def category(self):
        """Gets the category of this PracticeAreaUpdateRequestData.
        ...
        :return: The category of this PracticeAreaUpdateRequestData.
        :rtype: str
        """
    ...
    def category(self, category):
        """Sets the category of this PracticeAreaUpdateRequestData.
    ...
    @property
    def code(self):
        """Gets the code of this PracticeAreaUpdateRequestData.

        The code attached to the PracticeArea.

        :return: The code of this PracticeAreaUpdateRequestData.
        :rtype: str
        """
        return self._code
    ...
    @code.setter
    def code(self, code):
        """Sets the code of this PracticeAreaUpdateRequestData.
    ...
    @property
    def name(self):
        """Gets the name of this PracticeAreaUpdateRequestData.

        Name of the PracticeArea.

        :return: The name of this PracticeAreaUpdateRequestData.
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this PracticeAreaUpdateRequestData.
