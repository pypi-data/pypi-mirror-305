...
class CustomFieldsApi:
    ...
    @validate_arguments
    def custom_field_create(self, x_api_version : Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None, fields : Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None, custom_field_create_request : Annotated[Optional[CustomFieldCreateRequest], Field(description="Request Body for Custom Fields")] = None, **kwargs) -> CustomFieldShow:  # noqa: E501
        """Create a new CustomField  # noqa: E501

        Outlines the parameters and data fields used when creating a new CustomField  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.custom_field_create(x_api_version, fields, custom_field_create_request, async_req=True)
        >>> result = thread.get()
        ...
        :type fields: str
        :param custom_field_create_request: Request Body for Custom Fields
        :type custom_field_create_request: CustomFieldCreateRequest
        ...
        :rtype: CustomFieldShow
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the custom_field_create_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.custom_field_create_with_http_info(x_api_version, fields, custom_field_create_request, **kwargs)  # noqa: E501

    @validate_arguments
    def custom_field_create_with_http_info(self, x_api_version : Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None, fields : Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None, custom_field_create_request : Annotated[Optional[CustomFieldCreateRequest], Field(description="Request Body for Custom Fields")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Create a new CustomField  # noqa: E501
        ...
        >>> thread = api.custom_field_create_with_http_info(x_api_version, fields, custom_field_create_request, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(CustomFieldShow, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method custom_field_create" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _body_params = None
        if _params['custom_field_create_request'] is not None:
            _body_params = _params['custom_field_create_request']
    ...
    @validate_arguments
    def custom_field_destroy(self, id : Annotated[StrictInt, Field(..., description="The unique identifier for the CustomField.")], x_api_version : Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None, **kwargs) -> None:  # noqa: E501
        """Delete a single CustomField  # noqa: E501

        Outlines the parameters, optional and required, used when deleting the record for a single CustomField  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.custom_field_destroy(id, x_api_version, async_req=True)
        >>> result = thread.get()

        :param id: The unique identifier for the CustomField. (required)
        :type id: int
        :param x_api_version: The [API minor version](#section/Minor-Versions). Default: latest version.
        :type x_api_version: str
        :param async_req: Whether to execute the request asynchronously.
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the custom_field_destroy_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.custom_field_destroy_with_http_info(id, x_api_version, **kwargs)  # noqa: E501

    @validate_arguments
    def custom_field_destroy_with_http_info(self, id : Annotated[StrictInt, Field(..., description="The unique identifier for the CustomField.")], x_api_version : Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Delete a single CustomField  # noqa: E501
        ...
        >>> thread = api.custom_field_destroy_with_http_info(id, x_api_version, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method custom_field_destroy" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    @validate_arguments
    def custom_field_index(self, x_api_version : Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None, created_since : Annotated[Optional[datetime], Field(description="Filter CustomField records to those having the `created_at` field after a specific time. (Expects an ISO-8601 timestamp).")] = None, deleted : Annotated[Optional[StrictBool], Field(description="Filter CustomField records to those that have been deleted for future use.")] = None, field_type : Annotated[Optional[StrictStr], Field(description="Field type of this custom field")] = None, fields : Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None, ids : Annotated[Optional[StrictInt], Field(description="Filter CustomField records to those having the specified unique identifiers.")] = None, limit : Annotated[Optional[StrictInt], Field(description="A limit on the number of CustomField records to be returned. Limit can range between 1 and 200. Default: `200`.")] = None, order : Annotated[Optional[StrictStr], Field(description="Orders the CustomField records by the given field. Default: `id(asc)`.")] = None, page_token : Annotated[Optional[StrictStr], Field(description="A token specifying which page to return.")] = None, parent_type : Annotated[Optional[StrictStr], Field(description="Filter CustomField records to those that have the specified `parent_type`.")] = None, query : Annotated[Optional[StrictStr], Field(description="Wildcard search for `name` matching a given string.")] = None, updated_since : Annotated[Optional[datetime], Field(description="Filter CustomField records to those having the `updated_at` field after a specific time. (Expects an ISO-8601 timestamp).")] = None, visible_and_required : Annotated[Optional[StrictBool], Field(description="Filter CustomField records to those that are visible and required.")] = None, **kwargs) -> CustomFieldList:  # noqa: E501
        """Return the data for all CustomFields  # noqa: E501

        Outlines the parameters, optional and required, used when requesting the data for all CustomFields  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.custom_field_index(x_api_version, created_since, deleted, field_type, fields, ids, limit, order, page_token, parent_type, query, updated_since, visible_and_required, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the custom_field_index_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.custom_field_index_with_http_info(x_api_version, created_since, deleted, field_type, fields, ids, limit, order, page_token, parent_type, query, updated_since, visible_and_required, **kwargs)  # noqa: E501

    @validate_arguments
    def custom_field_index_with_http_info(self, x_api_version : Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None, created_since : Annotated[Optional[datetime], Field(description="Filter CustomField records to those having the `created_at` field after a specific time. (Expects an ISO-8601 timestamp).")] = None, deleted : Annotated[Optional[StrictBool], Field(description="Filter CustomField records to those that have been deleted for future use.")] = None, field_type : Annotated[Optional[StrictStr], Field(description="Field type of this custom field")] = None, fields : Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None, ids : Annotated[Optional[StrictInt], Field(description="Filter CustomField records to those having the specified unique identifiers.")] = None, limit : Annotated[Optional[StrictInt], Field(description="A limit on the number of CustomField records to be returned. Limit can range between 1 and 200. Default: `200`.")] = None, order : Annotated[Optional[StrictStr], Field(description="Orders the CustomField records by the given field. Default: `id(asc)`.")] = None, page_token : Annotated[Optional[StrictStr], Field(description="A token specifying which page to return.")] = None, parent_type : Annotated[Optional[StrictStr], Field(description="Filter CustomField records to those that have the specified `parent_type`.")] = None, query : Annotated[Optional[StrictStr], Field(description="Wildcard search for `name` matching a given string.")] = None, updated_since : Annotated[Optional[datetime], Field(description="Filter CustomField records to those having the `updated_at` field after a specific time. (Expects an ISO-8601 timestamp).")] = None, visible_and_required : Annotated[Optional[StrictBool], Field(description="Filter CustomField records to those that are visible and required.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Return the data for all CustomFields  # noqa: E501
        ...
        >>> thread = api.custom_field_index_with_http_info(x_api_version, created_since, deleted, field_type, fields, ids, limit, order, page_token, parent_type, query, updated_since, visible_and_required, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(CustomFieldList, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method custom_field_index" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        if _params.get('field_type') is not None:  # noqa: E501
            _query_params.append(('field_type', _params['field_type']))
        ...
        if _params.get('parent_type') is not None:  # noqa: E501
            _query_params.append(('parent_type', _params['parent_type']))
        ...
        if _params.get('visible_and_required') is not None:  # noqa: E501
            _query_params.append(('visible_and_required', _params['visible_and_required']))
    ...
    def custom_field_show(self, id : Annotated[StrictInt, Field(..., description="The unique identifier for the CustomField.")], if_modified_since : Annotated[Optional[date], Field(description="The server will send the requested resource with a 200 status, but only if it has been modified after the given date. (Expects an RFC 2822 timestamp).")] = None, if_none_match : Annotated[Optional[StrictStr], Field(description="The server will send the requested resource with a 200 status, but only if the existing resource's [ETag](#section/ETags) doesn't match any of the values listed.")] = None, x_api_version : Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None, fields : Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None, **kwargs) -> CustomFieldShow:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the custom_field_show_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.custom_field_show_with_http_info(id, if_modified_since, if_none_match, x_api_version, fields, **kwargs)  # noqa: E501

    @validate_arguments
    def custom_field_show_with_http_info(self, id : Annotated[StrictInt, Field(..., description="The unique identifier for the CustomField.")], if_modified_since : Annotated[Optional[date], Field(description="The server will send the requested resource with a 200 status, but only if it has been modified after the given date. (Expects an RFC 2822 timestamp).")] = None, if_none_match : Annotated[Optional[StrictStr], Field(description="The server will send the requested resource with a 200 status, but only if the existing resource's [ETag](#section/ETags) doesn't match any of the values listed.")] = None, x_api_version : Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None, fields : Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Return the data for a single CustomField  # noqa: E501
        ...
        >>> thread = api.custom_field_show_with_http_info(id, if_modified_since, if_none_match, x_api_version, fields, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method custom_field_show" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    @validate_arguments
    def custom_field_update(self, id : Annotated[StrictInt, Field(..., description="The unique identifier for the CustomField.")], if_match : Annotated[Optional[StrictStr], Field(description="The server will update the requested resource and send back a 200 status, but only if value in the header matches the existing resource's [ETag](#section/ETags).")] = None, x_api_version : Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None, fields : Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None, custom_field_update_request : Annotated[Optional[CustomFieldUpdateRequest], Field(description="Request Body for Custom Fields")] = None, **kwargs) -> CustomFieldShow:  # noqa: E501
        """Update a single CustomField  # noqa: E501

        Outlines the parameters and data fields used when updating a single CustomField  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.custom_field_update(id, if_match, x_api_version, fields, custom_field_update_request, async_req=True)
        >>> result = thread.get()
        ...
        :param fields: The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).
        :type fields: str
        :param custom_field_update_request: Request Body for Custom Fields
        :type custom_field_update_request: CustomFieldUpdateRequest
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: timeout setting for this request.
               If one number provided, it will be total request
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the custom_field_update_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.custom_field_update_with_http_info(id, if_match, x_api_version, fields, custom_field_update_request, **kwargs)  # noqa: E501

    @validate_arguments
    def custom_field_update_with_http_info(self, id : Annotated[StrictInt, Field(..., description="The unique identifier for the CustomField.")], if_match : Annotated[Optional[StrictStr], Field(description="The server will update the requested resource and send back a 200 status, but only if value in the header matches the existing resource's [ETag](#section/ETags).")] = None, x_api_version : Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None, fields : Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None, custom_field_update_request : Annotated[Optional[CustomFieldUpdateRequest], Field(description="Request Body for Custom Fields")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Update a single CustomField  # noqa: E501
        ...
        >>> thread = api.custom_field_update_with_http_info(id, if_match, x_api_version, fields, custom_field_update_request, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method custom_field_update" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        # process the body parameter
        _body_params = None
        if _params['custom_field_update_request'] is not None:
            _body_params = _params['custom_field_update_request']
