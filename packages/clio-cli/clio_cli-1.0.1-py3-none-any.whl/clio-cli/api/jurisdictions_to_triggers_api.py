...
class JurisdictionsToTriggersApi:
    ...
    @validate_arguments
    def jurisdictions_to_trigger_index(self, jurisdiction_id : Annotated[StrictInt, Field(..., description="The unique identifier for the Jurisdiction.")], x_api_version : Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None, created_since : Annotated[Optional[datetime], Field(description="Filter JurisdictionsToTrigger records to those having the `created_at` field after a specific time. (Expects an ISO-8601 timestamp).")] = None, fields : Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None, ids : Annotated[Optional[StrictInt], Field(description="Filter JurisdictionsToTrigger records to those having the specified unique identifiers.")] = None, is_requirements_required : Annotated[Optional[StrictBool], Field(description="Filter JurisdictionsToTrigger records to those which require addition requirements to be checked (usually specifying trigger time).")] = None, is_served : Annotated[Optional[StrictBool], Field(description="Filter JurisdictionsToTrigger records to those which require a service type to be selected.")] = None, limit : Annotated[Optional[StrictInt], Field(description="A limit on the number of JurisdictionsToTrigger records to be returned. Limit can range between 1 and 1000. Default: `1000`.")] = None, order : Annotated[Optional[StrictStr], Field(description="Orders the JurisdictionsToTrigger records by the given field. Default: `id(asc)`.")] = None, page_token : Annotated[Optional[StrictStr], Field(description="A token specifying which page to return.")] = None, query : Annotated[Optional[StrictStr], Field(description="Wildcard search for `description` matching a given string.")] = None, updated_since : Annotated[Optional[datetime], Field(description="Filter JurisdictionsToTrigger records to those having the `updated_at` field after a specific time. (Expects an ISO-8601 timestamp).")] = None, **kwargs) -> JurisdictionsToTriggerList:  # noqa: E501
        """Return the data for all triggers  # noqa: E501

        Outlines the parameters, optional and required, used when requesting the data for all JurisdictionsToTriggers  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.jurisdictions_to_trigger_index(jurisdiction_id, x_api_version, created_since, fields, ids, is_requirements_required, is_served, limit, order, page_token, query, updated_since, async_req=True)
        >>> result = thread.get()

        :param jurisdiction_id: The unique identifier for the Jurisdiction. (required)
        ...
        :rtype: JurisdictionsToTriggerList
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the jurisdictions_to_trigger_index_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.jurisdictions_to_trigger_index_with_http_info(jurisdiction_id, x_api_version, created_since, fields, ids, is_requirements_required, is_served, limit, order, page_token, query, updated_since, **kwargs)  # noqa: E501

    @validate_arguments
    def jurisdictions_to_trigger_index_with_http_info(self, jurisdiction_id : Annotated[StrictInt, Field(..., description="The unique identifier for the Jurisdiction.")], x_api_version : Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None, created_since : Annotated[Optional[datetime], Field(description="Filter JurisdictionsToTrigger records to those having the `created_at` field after a specific time. (Expects an ISO-8601 timestamp).")] = None, fields : Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None, ids : Annotated[Optional[StrictInt], Field(description="Filter JurisdictionsToTrigger records to those having the specified unique identifiers.")] = None, is_requirements_required : Annotated[Optional[StrictBool], Field(description="Filter JurisdictionsToTrigger records to those which require addition requirements to be checked (usually specifying trigger time).")] = None, is_served : Annotated[Optional[StrictBool], Field(description="Filter JurisdictionsToTrigger records to those which require a service type to be selected.")] = None, limit : Annotated[Optional[StrictInt], Field(description="A limit on the number of JurisdictionsToTrigger records to be returned. Limit can range between 1 and 1000. Default: `1000`.")] = None, order : Annotated[Optional[StrictStr], Field(description="Orders the JurisdictionsToTrigger records by the given field. Default: `id(asc)`.")] = None, page_token : Annotated[Optional[StrictStr], Field(description="A token specifying which page to return.")] = None, query : Annotated[Optional[StrictStr], Field(description="Wildcard search for `description` matching a given string.")] = None, updated_since : Annotated[Optional[datetime], Field(description="Filter JurisdictionsToTrigger records to those having the `updated_at` field after a specific time. (Expects an ISO-8601 timestamp).")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Return the data for all triggers  # noqa: E501
        ...
        >>> thread = api.jurisdictions_to_trigger_index_with_http_info(jurisdiction_id, x_api_version, created_since, fields, ids, is_requirements_required, is_served, limit, order, page_token, query, updated_since, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(JurisdictionsToTriggerList, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method jurisdictions_to_trigger_index" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _path_params = {}
        if _params['jurisdiction_id'] is not None:
            _path_params['jurisdiction_id'] = _params['jurisdiction_id']
        ...
        if _params.get('is_requirements_required') is not None:  # noqa: E501
            _query_params.append(('is_requirements_required', _params['is_requirements_required']))

        if _params.get('is_served') is not None:  # noqa: E501
            _query_params.append(('is_served', _params['is_served']))
        ...
        _response_types_map = {
            '200': "JurisdictionsToTriggerList",
            '400': "Error",
            '401': "Error",
            '403': "Error",
            '429': "Error",
        ...
        return self.api_client.call_api(
            '/court_rules/jurisdictions/{jurisdiction_id}/triggers.json', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def jurisdictions_to_trigger_show(self, id : Annotated[StrictInt, Field(..., description="The unique identifier for the JurisdictionsToTrigger.")], jurisdiction_id : Annotated[StrictInt, Field(..., description="The unique identifier for the Jurisdiction.")], if_modified_since : Annotated[Optional[date], Field(description="The server will send the requested resource with a 200 status, but only if it has been modified after the given date. (Expects an RFC 2822 timestamp).")] = None, if_none_match : Annotated[Optional[StrictStr], Field(description="The server will send the requested resource with a 200 status, but only if the existing resource's [ETag](#section/ETags) doesn't match any of the values listed.")] = None, x_api_version : Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None, fields : Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None, **kwargs) -> JurisdictionsToTriggerShow:  # noqa: E501
        """Return the data for the trigger  # noqa: E501

        Outlines the parameters, optional and required, used when requesting the data for a single JurisdictionsToTrigger  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.jurisdictions_to_trigger_show(id, jurisdiction_id, if_modified_since, if_none_match, x_api_version, fields, async_req=True)
        >>> result = thread.get()

        :param id: The unique identifier for the JurisdictionsToTrigger. (required)
        :type id: int
        :param jurisdiction_id: The unique identifier for the Jurisdiction. (required)
        :type jurisdiction_id: int
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: JurisdictionsToTriggerShow
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the jurisdictions_to_trigger_show_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.jurisdictions_to_trigger_show_with_http_info(id, jurisdiction_id, if_modified_since, if_none_match, x_api_version, fields, **kwargs)  # noqa: E501

    @validate_arguments
    def jurisdictions_to_trigger_show_with_http_info(self, id : Annotated[StrictInt, Field(..., description="The unique identifier for the JurisdictionsToTrigger.")], jurisdiction_id : Annotated[StrictInt, Field(..., description="The unique identifier for the Jurisdiction.")], if_modified_since : Annotated[Optional[date], Field(description="The server will send the requested resource with a 200 status, but only if it has been modified after the given date. (Expects an RFC 2822 timestamp).")] = None, if_none_match : Annotated[Optional[StrictStr], Field(description="The server will send the requested resource with a 200 status, but only if the existing resource's [ETag](#section/ETags) doesn't match any of the values listed.")] = None, x_api_version : Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None, fields : Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Return the data for the trigger  # noqa: E501
        ...
        >>> thread = api.jurisdictions_to_trigger_show_with_http_info(id, jurisdiction_id, if_modified_since, if_none_match, x_api_version, fields, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(JurisdictionsToTriggerShow, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method jurisdictions_to_trigger_show" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "JurisdictionsToTriggerShow",
            '400': "Error",
            '403': "Error",
            '404': "Error",
            '401': "Error",
        ...
        return self.api_client.call_api(
            '/court_rules/jurisdictions/{jurisdiction_id}/triggers/{id}.json', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
