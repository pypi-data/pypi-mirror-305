...
class TrustLineItemsApi:
    ...
    @validate_arguments
    def trust_line_item_index(self, x_api_version : Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None, bill_id : Annotated[Optional[StrictInt], Field(description="The unique identifier for a single Bill. The keyword `null` is not valid for this field. The list will be filtered to include only the TrustLineItem records with the matching property.")] = None, created_since : Annotated[Optional[datetime], Field(description="Filter TrustLineItem records to those having the `created_at` field after a specific time. (Expects an ISO-8601 timestamp).")] = None, fields : Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None, ids : Annotated[Optional[StrictInt], Field(description="Filter TrustLineItem records to those having the specified unique identifiers.")] = None, limit : Annotated[Optional[StrictInt], Field(description="A limit on the number of TrustLineItem records to be returned. Limit can range between 1 and 200. Default: `200`.")] = None, matter_id : Annotated[Optional[StrictInt], Field(description="The unique identifier for a single Matter. Use the keyword `null` to match those without a TrustLineItem. The list will be filtered to include only the TrustLineItem records with the matching property.")] = None, order : Annotated[Optional[StrictStr], Field(description="Orders the TrustLineItem records by the given field. Default: `id(asc)`.")] = None, page_token : Annotated[Optional[StrictStr], Field(description="A token specifying which page to return.")] = None, updated_since : Annotated[Optional[datetime], Field(description="Filter TrustLineItem records to those having the `updated_at` field after a specific time. (Expects an ISO-8601 timestamp).")] = None, **kwargs) -> TrustLineItemList:  # noqa: E501
        """Return the data for all TrustLineItems  # noqa: E501

        Outlines the parameters, optional and required, used when requesting the data for all TrustLineItems  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.trust_line_item_index(x_api_version, bill_id, created_since, fields, ids, limit, matter_id, order, page_token, updated_since, async_req=True)
        >>> result = thread.get()
        ...
        :rtype: TrustLineItemList
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the trust_line_item_index_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.trust_line_item_index_with_http_info(x_api_version, bill_id, created_since, fields, ids, limit, matter_id, order, page_token, updated_since, **kwargs)  # noqa: E501

    @validate_arguments
    def trust_line_item_index_with_http_info(self, x_api_version : Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None, bill_id : Annotated[Optional[StrictInt], Field(description="The unique identifier for a single Bill. The keyword `null` is not valid for this field. The list will be filtered to include only the TrustLineItem records with the matching property.")] = None, created_since : Annotated[Optional[datetime], Field(description="Filter TrustLineItem records to those having the `created_at` field after a specific time. (Expects an ISO-8601 timestamp).")] = None, fields : Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None, ids : Annotated[Optional[StrictInt], Field(description="Filter TrustLineItem records to those having the specified unique identifiers.")] = None, limit : Annotated[Optional[StrictInt], Field(description="A limit on the number of TrustLineItem records to be returned. Limit can range between 1 and 200. Default: `200`.")] = None, matter_id : Annotated[Optional[StrictInt], Field(description="The unique identifier for a single Matter. Use the keyword `null` to match those without a TrustLineItem. The list will be filtered to include only the TrustLineItem records with the matching property.")] = None, order : Annotated[Optional[StrictStr], Field(description="Orders the TrustLineItem records by the given field. Default: `id(asc)`.")] = None, page_token : Annotated[Optional[StrictStr], Field(description="A token specifying which page to return.")] = None, updated_since : Annotated[Optional[datetime], Field(description="Filter TrustLineItem records to those having the `updated_at` field after a specific time. (Expects an ISO-8601 timestamp).")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Return the data for all TrustLineItems  # noqa: E501
        ...
        >>> thread = api.trust_line_item_index_with_http_info(x_api_version, bill_id, created_since, fields, ids, limit, matter_id, order, page_token, updated_since, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(TrustLineItemList, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method trust_line_item_index" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    @validate_arguments
    def trust_line_item_update(self, id : Annotated[StrictInt, Field(..., description="The unique identifier for the TrustLineItem.")], if_match : Annotated[Optional[StrictStr], Field(description="The server will update the requested resource and send back a 200 status, but only if value in the header matches the existing resource's [ETag](#section/ETags).")] = None, x_api_version : Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None, fields : Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None, trust_line_item_update_request : Annotated[Optional[TrustLineItemUpdateRequest], Field(description="Request Body for Trust Line Items")] = None, **kwargs) -> TrustLineItemShow:  # noqa: E501
        """Update a single TrustLineItem  # noqa: E501

        Outlines the parameters and data fields used when updating a single TrustLineItem  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.trust_line_item_update(id, if_match, x_api_version, fields, trust_line_item_update_request, async_req=True)
        >>> result = thread.get()

        :param id: The unique identifier for the TrustLineItem. (required)
        :type id: int
        ...
        :param fields: The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).
        :type fields: str
        :param trust_line_item_update_request: Request Body for Trust Line Items
        :type trust_line_item_update_request: TrustLineItemUpdateRequest
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: timeout setting for this request.
               If one number provided, it will be total request
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: TrustLineItemShow
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the trust_line_item_update_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.trust_line_item_update_with_http_info(id, if_match, x_api_version, fields, trust_line_item_update_request, **kwargs)  # noqa: E501

    @validate_arguments
    def trust_line_item_update_with_http_info(self, id : Annotated[StrictInt, Field(..., description="The unique identifier for the TrustLineItem.")], if_match : Annotated[Optional[StrictStr], Field(description="The server will update the requested resource and send back a 200 status, but only if value in the header matches the existing resource's [ETag](#section/ETags).")] = None, x_api_version : Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None, fields : Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None, trust_line_item_update_request : Annotated[Optional[TrustLineItemUpdateRequest], Field(description="Request Body for Trust Line Items")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Update a single TrustLineItem  # noqa: E501
        ...
        >>> thread = api.trust_line_item_update_with_http_info(id, if_match, x_api_version, fields, trust_line_item_update_request, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(TrustLineItemShow, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        _all_params = [
            ...
            'x_api_version',
            'fields',
            'trust_line_item_update_request'
        ]
        _all_params.extend(
            [
                'async_req',
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method trust_line_item_update" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        # process the body parameter
        _body_params = None
        if _params['trust_line_item_update_request'] is not None:
            _body_params = _params['trust_line_item_update_request']
        ...
        return self.api_client.call_api(
            '/trust_line_items/{id}.json', 'PATCH',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
