...
class LineItemsApi:
    ...
    @validate_arguments
    def line_item_destroy(self, id : Annotated[StrictInt, Field(..., description="The unique identifier for the LineItem.")], x_api_version : Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None, **kwargs) -> None:  # noqa: E501
        """Delete a single LineItem  # noqa: E501

        A LineItem can not be deleted if it's Bill is not editable  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.line_item_destroy(id, x_api_version, async_req=True)
        >>> result = thread.get()

        :param id: The unique identifier for the LineItem. (required)
        :type id: int
        ...
        if '_preload_content' in kwargs:
            message = "Error! Please call the line_item_destroy_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.line_item_destroy_with_http_info(id, x_api_version, **kwargs)  # noqa: E501

    @validate_arguments
    def line_item_destroy_with_http_info(self, id : Annotated[StrictInt, Field(..., description="The unique identifier for the LineItem.")], x_api_version : Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Delete a single LineItem  # noqa: E501
        ...
        >>> thread = api.line_item_destroy_with_http_info(id, x_api_version, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method line_item_destroy" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    @validate_arguments
    def line_item_index(self, x_api_version : Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None, activity_id : Annotated[Optional[StrictInt], Field(description="The unique identifier for a single Activity. Use the keyword `null` to match those without a LineItem. The list will be filtered to include only the LineItem records with the matching property.")] = None, bill_id : Annotated[Optional[StrictInt], Field(description="The unique identifier for a single Bill. The keyword `null` is not valid for this field. The list will be filtered to include only the LineItem records with the matching property.")] = None, created_since : Annotated[Optional[datetime], Field(description="Filter LineItem records to those having the `created_at` field after a specific time. (Expects an ISO-8601 timestamp).")] = None, display : Annotated[Optional[StrictBool], Field(description="Set this flag to true to return only LineItems displayed on the bill.")] = None, exclude_ids : Annotated[Optional[StrictInt], Field(description="Array containing LineItem identifiers that should be excluded from the query.")] = None, fields : Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None, group_ordering : Annotated[Optional[StrictInt], Field(description="Filters LineItem records to match given group ordering.")] = None, ids : Annotated[Optional[StrictInt], Field(description="Filter LineItem records to those having the specified unique identifiers.")] = None, kind : Annotated[Optional[StrictStr], Field(description="The kind of LineItem.")] = None, limit : Annotated[Optional[StrictInt], Field(description="A limit on the number of LineItem records to be returned. Limit can range between 1 and 200. Default: `200`.")] = None, matter_id : Annotated[Optional[StrictInt], Field(description="The unique identifier for a single Matter. Use the keyword `null` to match those without a LineItem. The list will be filtered to include only the LineItem records with the matching property.")] = None, page_token : Annotated[Optional[StrictStr], Field(description="A token specifying which page to return.")] = None, query : Annotated[Optional[StrictStr], Field(description="Wildcard search for `description` or `note` matching a given string.")] = None, updated_since : Annotated[Optional[datetime], Field(description="Filter LineItem records to those having the `updated_at` field after a specific time. (Expects an ISO-8601 timestamp).")] = None, **kwargs) -> LineItemList:  # noqa: E501
        """Return the data for all LineItems  # noqa: E501

        Outlines the parameters, optional and required, used when requesting the data for all LineItems  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.line_item_index(x_api_version, activity_id, bill_id, created_since, display, exclude_ids, fields, group_ordering, ids, kind, limit, matter_id, page_token, query, updated_since, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the line_item_index_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.line_item_index_with_http_info(x_api_version, activity_id, bill_id, created_since, display, exclude_ids, fields, group_ordering, ids, kind, limit, matter_id, page_token, query, updated_since, **kwargs)  # noqa: E501

    @validate_arguments
    def line_item_index_with_http_info(self, x_api_version : Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None, activity_id : Annotated[Optional[StrictInt], Field(description="The unique identifier for a single Activity. Use the keyword `null` to match those without a LineItem. The list will be filtered to include only the LineItem records with the matching property.")] = None, bill_id : Annotated[Optional[StrictInt], Field(description="The unique identifier for a single Bill. The keyword `null` is not valid for this field. The list will be filtered to include only the LineItem records with the matching property.")] = None, created_since : Annotated[Optional[datetime], Field(description="Filter LineItem records to those having the `created_at` field after a specific time. (Expects an ISO-8601 timestamp).")] = None, display : Annotated[Optional[StrictBool], Field(description="Set this flag to true to return only LineItems displayed on the bill.")] = None, exclude_ids : Annotated[Optional[StrictInt], Field(description="Array containing LineItem identifiers that should be excluded from the query.")] = None, fields : Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None, group_ordering : Annotated[Optional[StrictInt], Field(description="Filters LineItem records to match given group ordering.")] = None, ids : Annotated[Optional[StrictInt], Field(description="Filter LineItem records to those having the specified unique identifiers.")] = None, kind : Annotated[Optional[StrictStr], Field(description="The kind of LineItem.")] = None, limit : Annotated[Optional[StrictInt], Field(description="A limit on the number of LineItem records to be returned. Limit can range between 1 and 200. Default: `200`.")] = None, matter_id : Annotated[Optional[StrictInt], Field(description="The unique identifier for a single Matter. Use the keyword `null` to match those without a LineItem. The list will be filtered to include only the LineItem records with the matching property.")] = None, page_token : Annotated[Optional[StrictStr], Field(description="A token specifying which page to return.")] = None, query : Annotated[Optional[StrictStr], Field(description="Wildcard search for `description` or `note` matching a given string.")] = None, updated_since : Annotated[Optional[datetime], Field(description="Filter LineItem records to those having the `updated_at` field after a specific time. (Expects an ISO-8601 timestamp).")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Return the data for all LineItems  # noqa: E501
        ...
        >>> thread = api.line_item_index_with_http_info(x_api_version, activity_id, bill_id, created_since, display, exclude_ids, fields, group_ordering, ids, kind, limit, matter_id, page_token, query, updated_since, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(LineItemList, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method line_item_index" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        if _params.get('bill_id') is not None:  # noqa: E501
            _query_params.append(('bill_id', _params['bill_id']))
        ...
        if _params.get('display') is not None:  # noqa: E501
            _query_params.append(('display', _params['display']))
        ...
        if _params.get('group_ordering') is not None:  # noqa: E501
            _query_params.append(('group_ordering', _params['group_ordering']))
    ...
    @validate_arguments
    def line_item_update(self, id : Annotated[StrictInt, Field(..., description="The unique identifier for the LineItem.")], if_match : Annotated[Optional[StrictStr], Field(description="The server will update the requested resource and send back a 200 status, but only if value in the header matches the existing resource's [ETag](#section/ETags).")] = None, x_api_version : Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None, fields : Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None, line_item_update_request : Annotated[Optional[LineItemUpdateRequest], Field(description="Request Body for Line Items")] = None, **kwargs) -> LineItemShow:  # noqa: E501
        """Update a single LineItem  # noqa: E501

        Outlines the parameters and data fields used when updating a single LineItem  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.line_item_update(id, if_match, x_api_version, fields, line_item_update_request, async_req=True)
        >>> result = thread.get()
        ...
        :param fields: The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).
        :type fields: str
        :param line_item_update_request: Request Body for Line Items
        :type line_item_update_request: LineItemUpdateRequest
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: timeout setting for this request.
               If one number provided, it will be total request
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the line_item_update_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.line_item_update_with_http_info(id, if_match, x_api_version, fields, line_item_update_request, **kwargs)  # noqa: E501

    @validate_arguments
    def line_item_update_with_http_info(self, id : Annotated[StrictInt, Field(..., description="The unique identifier for the LineItem.")], if_match : Annotated[Optional[StrictStr], Field(description="The server will update the requested resource and send back a 200 status, but only if value in the header matches the existing resource's [ETag](#section/ETags).")] = None, x_api_version : Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None, fields : Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None, line_item_update_request : Annotated[Optional[LineItemUpdateRequest], Field(description="Request Body for Line Items")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Update a single LineItem  # noqa: E501
        ...
        >>> thread = api.line_item_update_with_http_info(id, if_match, x_api_version, fields, line_item_update_request, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(LineItemShow, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method line_item_update" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        # process the body parameter
        _body_params = None
        if _params['line_item_update_request'] is not None:
            _body_params = _params['line_item_update_request']
