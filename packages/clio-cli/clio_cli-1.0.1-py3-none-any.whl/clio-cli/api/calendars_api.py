...
class CalendarsApi:
    ...
    @validate_arguments
    def calendar_create(self, x_api_version : Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None, fields : Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None, calendar_create_request : Annotated[Optional[CalendarCreateRequest], Field(description="Request Body for Calendars")] = None, **kwargs) -> CalendarShow:  # noqa: E501
        """Create a new Calendar  # noqa: E501

        Outlines the parameters and data fields used when creating a new Calendar  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.calendar_create(x_api_version, fields, calendar_create_request, async_req=True)
        >>> result = thread.get()
        ...
        :type fields: str
        :param calendar_create_request: Request Body for Calendars
        ...
        if '_preload_content' in kwargs:
            message = "Error! Please call the calendar_create_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.calendar_create_with_http_info(x_api_version, fields, calendar_create_request, **kwargs)  # noqa: E501

    @validate_arguments
    def calendar_create_with_http_info(self, x_api_version : Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None, fields : Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None, calendar_create_request : Annotated[Optional[CalendarCreateRequest], Field(description="Request Body for Calendars")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Create a new Calendar  # noqa: E501
        ...
        >>> thread = api.calendar_create_with_http_info(x_api_version, fields, calendar_create_request, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(CalendarShow, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method calendar_create" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _body_params = None
        if _params['calendar_create_request'] is not None:
            _body_params = _params['calendar_create_request']
    ...
    @validate_arguments
    def calendar_destroy(self, id : Annotated[StrictInt, Field(..., description="The unique identifier for the Calendar.")], x_api_version : Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None, **kwargs) -> None:  # noqa: E501
        """Delete a single Calendar  # noqa: E501

        Outlines the parameters, optional and required, used when deleting the record for a single Calendar  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.calendar_destroy(id, x_api_version, async_req=True)
        >>> result = thread.get()

        :param id: The unique identifier for the Calendar. (required)
        :type id: int
        :param x_api_version: The [API minor version](#section/Minor-Versions). Default: latest version.
        :type x_api_version: str
        :param async_req: Whether to execute the request asynchronously.
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the calendar_destroy_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.calendar_destroy_with_http_info(id, x_api_version, **kwargs)  # noqa: E501

    @validate_arguments
    def calendar_destroy_with_http_info(self, id : Annotated[StrictInt, Field(..., description="The unique identifier for the Calendar.")], x_api_version : Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Delete a single Calendar  # noqa: E501
        ...
        >>> thread = api.calendar_destroy_with_http_info(id, x_api_version, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method calendar_destroy" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    @validate_arguments
    def calendar_index(self, x_api_version : Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None, created_since : Annotated[Optional[datetime], Field(description="Filter Calendar records to those having the `created_at` field after a specific time. (Expects an ISO-8601 timestamp).")] = None, fields : Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None, filter_inactive_users : Annotated[Optional[StrictBool], Field(description="Filter any shared UserCalendar records whose owner is inactive.")] = None, ids : Annotated[Optional[StrictInt], Field(description="Filter Calendar records to those having the specified unique identifiers.")] = None, limit : Annotated[Optional[StrictInt], Field(description="A limit on the number of Calendar records to be returned. Limit can range between 1 and 200. Default: `200`.")] = None, order : Annotated[Optional[StrictStr], Field(description="Orders the Calendar records by the given field. Default: `id(asc)`.")] = None, owner : Annotated[Optional[StrictBool], Field(description="Filter Calendar records to those that the user owns.")] = None, page_token : Annotated[Optional[StrictStr], Field(description="A token specifying which page to return.")] = None, source : Annotated[Optional[StrictStr], Field(description="Filter Calendar records to those having a specific calendar visibility source (mobile, web).")] = None, type : Annotated[Optional[StrictStr], Field(description="Filter Calendar records to those of the specified type.")] = None, updated_since : Annotated[Optional[datetime], Field(description="Filter Calendar records to those having the `updated_at` field after a specific time. (Expects an ISO-8601 timestamp).")] = None, visible : Annotated[Optional[StrictBool], Field(description="Filter Calendar records to those that are visible.")] = None, writeable : Annotated[Optional[StrictBool], Field(description="Filter Calendar records to those which the user can write to.")] = None, **kwargs) -> CalendarList:  # noqa: E501
        """Return the data for all Calendars  # noqa: E501

        Outlines the parameters, optional and required, used when requesting the data for all Calendars  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.calendar_index(x_api_version, created_since, fields, filter_inactive_users, ids, limit, order, owner, page_token, source, type, updated_since, visible, writeable, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the calendar_index_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.calendar_index_with_http_info(x_api_version, created_since, fields, filter_inactive_users, ids, limit, order, owner, page_token, source, type, updated_since, visible, writeable, **kwargs)  # noqa: E501

    @validate_arguments
    def calendar_index_with_http_info(self, x_api_version : Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None, created_since : Annotated[Optional[datetime], Field(description="Filter Calendar records to those having the `created_at` field after a specific time. (Expects an ISO-8601 timestamp).")] = None, fields : Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None, filter_inactive_users : Annotated[Optional[StrictBool], Field(description="Filter any shared UserCalendar records whose owner is inactive.")] = None, ids : Annotated[Optional[StrictInt], Field(description="Filter Calendar records to those having the specified unique identifiers.")] = None, limit : Annotated[Optional[StrictInt], Field(description="A limit on the number of Calendar records to be returned. Limit can range between 1 and 200. Default: `200`.")] = None, order : Annotated[Optional[StrictStr], Field(description="Orders the Calendar records by the given field. Default: `id(asc)`.")] = None, owner : Annotated[Optional[StrictBool], Field(description="Filter Calendar records to those that the user owns.")] = None, page_token : Annotated[Optional[StrictStr], Field(description="A token specifying which page to return.")] = None, source : Annotated[Optional[StrictStr], Field(description="Filter Calendar records to those having a specific calendar visibility source (mobile, web).")] = None, type : Annotated[Optional[StrictStr], Field(description="Filter Calendar records to those of the specified type.")] = None, updated_since : Annotated[Optional[datetime], Field(description="Filter Calendar records to those having the `updated_at` field after a specific time. (Expects an ISO-8601 timestamp).")] = None, visible : Annotated[Optional[StrictBool], Field(description="Filter Calendar records to those that are visible.")] = None, writeable : Annotated[Optional[StrictBool], Field(description="Filter Calendar records to those which the user can write to.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Return the data for all Calendars  # noqa: E501
        ...
        >>> thread = api.calendar_index_with_http_info(x_api_version, created_since, fields, filter_inactive_users, ids, limit, order, owner, page_token, source, type, updated_since, visible, writeable, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(CalendarList, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        if _params.get('filter_inactive_users') is not None:  # noqa: E501
            _query_params.append(('filter_inactive_users', _params['filter_inactive_users']))
        ...
        if _params.get('writeable') is not None:  # noqa: E501
            _query_params.append(('writeable', _params['writeable']))
    ...
    def calendar_show(self, id : Annotated[StrictInt, Field(..., description="The unique identifier for the Calendar.")], if_modified_since : Annotated[Optional[date], Field(description="The server will send the requested resource with a 200 status, but only if it has been modified after the given date. (Expects an RFC 2822 timestamp).")] = None, if_none_match : Annotated[Optional[StrictStr], Field(description="The server will send the requested resource with a 200 status, but only if the existing resource's [ETag](#section/ETags) doesn't match any of the values listed.")] = None, x_api_version : Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None, fields : Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None, **kwargs) -> CalendarShow:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the calendar_show_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.calendar_show_with_http_info(id, if_modified_since, if_none_match, x_api_version, fields, **kwargs)  # noqa: E501

    @validate_arguments
    def calendar_show_with_http_info(self, id : Annotated[StrictInt, Field(..., description="The unique identifier for the Calendar.")], if_modified_since : Annotated[Optional[date], Field(description="The server will send the requested resource with a 200 status, but only if it has been modified after the given date. (Expects an RFC 2822 timestamp).")] = None, if_none_match : Annotated[Optional[StrictStr], Field(description="The server will send the requested resource with a 200 status, but only if the existing resource's [ETag](#section/ETags) doesn't match any of the values listed.")] = None, x_api_version : Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None, fields : Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Return the data for a single Calendar  # noqa: E501
        ...
        >>> thread = api.calendar_show_with_http_info(id, if_modified_since, if_none_match, x_api_version, fields, async_req=True)
        >>> result = thread.get()
    ...
    @validate_arguments
    def calendar_update(self, id : Annotated[StrictInt, Field(..., description="The unique identifier for the Calendar.")], if_match : Annotated[Optional[StrictStr], Field(description="The server will update the requested resource and send back a 200 status, but only if value in the header matches the existing resource's [ETag](#section/ETags).")] = None, x_api_version : Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None, fields : Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None, calendar_update_request : Annotated[Optional[CalendarUpdateRequest], Field(description="Request Body for Calendars")] = None, **kwargs) -> CalendarShow:  # noqa: E501
        """Update a single Calendar  # noqa: E501

        Outlines the parameters and data fields used when updating a single Calendar  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.calendar_update(id, if_match, x_api_version, fields, calendar_update_request, async_req=True)
        >>> result = thread.get()
        ...
        :param fields: The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).
        :type fields: str
        :param calendar_update_request: Request Body for Calendars
        :type calendar_update_request: CalendarUpdateRequest
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: timeout setting for this request.
               If one number provided, it will be total request
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the calendar_update_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.calendar_update_with_http_info(id, if_match, x_api_version, fields, calendar_update_request, **kwargs)  # noqa: E501

    @validate_arguments
    def calendar_update_with_http_info(self, id : Annotated[StrictInt, Field(..., description="The unique identifier for the Calendar.")], if_match : Annotated[Optional[StrictStr], Field(description="The server will update the requested resource and send back a 200 status, but only if value in the header matches the existing resource's [ETag](#section/ETags).")] = None, x_api_version : Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None, fields : Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None, calendar_update_request : Annotated[Optional[CalendarUpdateRequest], Field(description="Request Body for Calendars")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Update a single Calendar  # noqa: E501
        ...
        >>> thread = api.calendar_update_with_http_info(id, if_match, x_api_version, fields, calendar_update_request, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method calendar_update" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        # process the body parameter
        _body_params = None
        if _params['calendar_update_request'] is not None:
            _body_params = _params['calendar_update_request']
