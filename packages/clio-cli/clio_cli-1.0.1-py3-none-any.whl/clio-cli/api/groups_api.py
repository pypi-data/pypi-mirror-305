...
class GroupsApi:
    ...
    @validate_arguments
    def group_create(self, x_api_version : Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None, fields : Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None, group_create_request : Annotated[Optional[GroupCreateRequest], Field(description="Request Body for Groups")] = None, **kwargs) -> GroupShow:  # noqa: E501
        """Create a new Group  # noqa: E501

        Outlines the parameters and data fields used when creating a new Group  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.group_create(x_api_version, fields, group_create_request, async_req=True)
        >>> result = thread.get()
        ...
        :type fields: str
        :param group_create_request: Request Body for Groups
        ...
        return self.group_create_with_http_info(x_api_version, fields, group_create_request, **kwargs)  # noqa: E501

    @validate_arguments
    def group_create_with_http_info(self, x_api_version : Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None, fields : Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None, group_create_request : Annotated[Optional[GroupCreateRequest], Field(description="Request Body for Groups")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Create a new Group  # noqa: E501
        ...
        >>> thread = api.group_create_with_http_info(x_api_version, fields, group_create_request, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(GroupShow, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        _body_params = None
        if _params['group_create_request'] is not None:
            _body_params = _params['group_create_request']
    ...
    @validate_arguments
    def group_destroy(self, id : Annotated[StrictInt, Field(..., description="The unique identifier for the Group.")], x_api_version : Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None, **kwargs) -> None:  # noqa: E501
        """Delete a single Group  # noqa: E501

        Outlines the parameters, optional and required, used when deleting the record for a single Group  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.group_destroy(id, x_api_version, async_req=True)
        >>> result = thread.get()

        :param id: The unique identifier for the Group. (required)
        :type id: int
        :param x_api_version: The [API minor version](#section/Minor-Versions). Default: latest version.
        :type x_api_version: str
        :param async_req: Whether to execute the request asynchronously.
        ...
        if '_preload_content' in kwargs:
            ...
            raise ValueError(message)
        return self.group_destroy_with_http_info(id, x_api_version, **kwargs)  # noqa: E501

    @validate_arguments
    def group_destroy_with_http_info(self, id : Annotated[StrictInt, Field(..., description="The unique identifier for the Group.")], x_api_version : Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Delete a single Group  # noqa: E501
        ...
        >>> thread = api.group_destroy_with_http_info(id, x_api_version, async_req=True)
        >>> result = thread.get()
    ...
    def group_index(self, x_api_version : Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None, archived : Annotated[Optional[StrictBool], Field(description="Filter archived Group records.")] = None, created_since : Annotated[Optional[datetime], Field(description="Filter Group records to those having the `created_at` field after a specific time. (Expects an ISO-8601 timestamp).")] = None, fields : Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None, ids : Annotated[Optional[StrictInt], Field(description="Filter Group records to those having the specified unique identifiers.")] = None, limit : Annotated[Optional[StrictInt], Field(description="A limit on the number of Group records to be returned. Limit can range between 1 and 200. Default: `200`.")] = None, name : Annotated[Optional[StrictStr], Field(description="Filter Group records to those that match the given name.")] = None, order : Annotated[Optional[StrictStr], Field(description="Orders the Group records by the given field. Default: `id(asc)`.")] = None, page_token : Annotated[Optional[StrictStr], Field(description="A token specifying which page to return.")] = None, query : Annotated[Optional[StrictStr], Field(description="Wildcard search for `name` matching a given string.")] = None, type : Annotated[Optional[StrictStr], Field(description="Filter Group records to those that match the given type.")] = None, updated_since : Annotated[Optional[datetime], Field(description="Filter Group records to those having the `updated_at` field after a specific time. (Expects an ISO-8601 timestamp).")] = None, user_id : Annotated[Optional[StrictInt], Field(description="The unique identifier for a single User. The keyword `null` is not valid for this field. The list will be filtered to include only the Group records with the matching property.")] = None, **kwargs) -> GroupList:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the group_index_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.group_index_with_http_info(x_api_version, archived, created_since, fields, ids, limit, name, order, page_token, query, type, updated_since, user_id, **kwargs)  # noqa: E501
    ...
    def group_index_with_http_info(self, x_api_version : Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None, archived : Annotated[Optional[StrictBool], Field(description="Filter archived Group records.")] = None, created_since : Annotated[Optional[datetime], Field(description="Filter Group records to those having the `created_at` field after a specific time. (Expects an ISO-8601 timestamp).")] = None, fields : Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None, ids : Annotated[Optional[StrictInt], Field(description="Filter Group records to those having the specified unique identifiers.")] = None, limit : Annotated[Optional[StrictInt], Field(description="A limit on the number of Group records to be returned. Limit can range between 1 and 200. Default: `200`.")] = None, name : Annotated[Optional[StrictStr], Field(description="Filter Group records to those that match the given name.")] = None, order : Annotated[Optional[StrictStr], Field(description="Orders the Group records by the given field. Default: `id(asc)`.")] = None, page_token : Annotated[Optional[StrictStr], Field(description="A token specifying which page to return.")] = None, query : Annotated[Optional[StrictStr], Field(description="Wildcard search for `name` matching a given string.")] = None, type : Annotated[Optional[StrictStr], Field(description="Filter Group records to those that match the given type.")] = None, updated_since : Annotated[Optional[datetime], Field(description="Filter Group records to those having the `updated_at` field after a specific time. (Expects an ISO-8601 timestamp).")] = None, user_id : Annotated[Optional[StrictInt], Field(description="The unique identifier for a single User. The keyword `null` is not valid for this field. The list will be filtered to include only the Group records with the matching property.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        >>> thread = api.group_index_with_http_info(x_api_version, archived, created_since, fields, ids, limit, name, order, page_token, query, type, updated_since, user_id, async_req=True)
        >>> result = thread.get()
    ...
    def group_show(self, id : Annotated[StrictInt, Field(..., description="The unique identifier for the Group.")], if_modified_since : Annotated[Optional[date], Field(description="The server will send the requested resource with a 200 status, but only if it has been modified after the given date. (Expects an RFC 2822 timestamp).")] = None, if_none_match : Annotated[Optional[StrictStr], Field(description="The server will send the requested resource with a 200 status, but only if the existing resource's [ETag](#section/ETags) doesn't match any of the values listed.")] = None, x_api_version : Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None, fields : Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None, **kwargs) -> GroupShow:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the group_show_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.group_show_with_http_info(id, if_modified_since, if_none_match, x_api_version, fields, **kwargs)  # noqa: E501
    ...
    def group_show_with_http_info(self, id : Annotated[StrictInt, Field(..., description="The unique identifier for the Group.")], if_modified_since : Annotated[Optional[date], Field(description="The server will send the requested resource with a 200 status, but only if it has been modified after the given date. (Expects an RFC 2822 timestamp).")] = None, if_none_match : Annotated[Optional[StrictStr], Field(description="The server will send the requested resource with a 200 status, but only if the existing resource's [ETag](#section/ETags) doesn't match any of the values listed.")] = None, x_api_version : Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None, fields : Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        >>> thread = api.group_show_with_http_info(id, if_modified_since, if_none_match, x_api_version, fields, async_req=True)
        >>> result = thread.get()
    ...
    @validate_arguments
    def group_update(self, id : Annotated[StrictInt, Field(..., description="The unique identifier for the Group.")], if_match : Annotated[Optional[StrictStr], Field(description="The server will update the requested resource and send back a 200 status, but only if value in the header matches the existing resource's [ETag](#section/ETags).")] = None, x_api_version : Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None, fields : Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None, group_create_request : Annotated[Optional[GroupCreateRequest], Field(description="Request Body for Groups")] = None, **kwargs) -> GroupShow:  # noqa: E501
        """Update a single Group  # noqa: E501

        Outlines the parameters and data fields used when updating a single Group  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.group_update(id, if_match, x_api_version, fields, group_create_request, async_req=True)
        >>> result = thread.get()
        ...
        if '_preload_content' in kwargs:
            ...
            raise ValueError(message)
        return self.group_update_with_http_info(id, if_match, x_api_version, fields, group_create_request, **kwargs)  # noqa: E501

    @validate_arguments
    def group_update_with_http_info(self, id : Annotated[StrictInt, Field(..., description="The unique identifier for the Group.")], if_match : Annotated[Optional[StrictStr], Field(description="The server will update the requested resource and send back a 200 status, but only if value in the header matches the existing resource's [ETag](#section/ETags).")] = None, x_api_version : Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None, fields : Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None, group_create_request : Annotated[Optional[GroupCreateRequest], Field(description="Request Body for Groups")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Update a single Group  # noqa: E501
        ...
        >>> thread = api.group_update_with_http_info(id, if_match, x_api_version, fields, group_create_request, async_req=True)
        >>> result = thread.get()
