...
class MedicalBillsApi:
    ...
    @validate_arguments
    def medical_bill_destroy(self, id : Annotated[StrictInt, Field(..., description="The unique identifier for the Medical Bill.")], x_api_version : Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None, **kwargs) -> None:  # noqa: E501
        """Destroying a Medical Bill  # noqa: E501

        Outlines the parameters, optional and required, used when deleting the record for a single Medical Bill   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.medical_bill_destroy(id, x_api_version, async_req=True)
        >>> result = thread.get()
        ...
        if '_preload_content' in kwargs:
            message = "Error! Please call the medical_bill_destroy_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.medical_bill_destroy_with_http_info(id, x_api_version, **kwargs)  # noqa: E501

    @validate_arguments
    def medical_bill_destroy_with_http_info(self, id : Annotated[StrictInt, Field(..., description="The unique identifier for the Medical Bill.")], x_api_version : Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Destroying a Medical Bill  # noqa: E501
        ...
        >>> thread = api.medical_bill_destroy_with_http_info(id, x_api_version, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method medical_bill_destroy" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    @validate_arguments
    def medical_bill_update(self, id : Annotated[StrictInt, Field(..., description="The unique identifier for the Medical Bill.")], if_match : Annotated[Optional[StrictStr], Field(description="The server will update the requested resource and send back a 200 status, but only if value in the header matches the existing resource's [ETag](#section/ETags).")] = None, x_api_version : Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None, fields : Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None, medical_bill_update_request : Annotated[Optional[MedicalBillUpdateRequest], Field(description="Request Body for Medical Bills")] = None, **kwargs) -> MedicalBillShow:  # noqa: E501
        """Updating a Medical Bill  # noqa: E501

        Outlines the parameters and data fields used when updating a single Medical Bill   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.medical_bill_update(id, if_match, x_api_version, fields, medical_bill_update_request, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: MedicalBillShow
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the medical_bill_update_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.medical_bill_update_with_http_info(id, if_match, x_api_version, fields, medical_bill_update_request, **kwargs)  # noqa: E501

    @validate_arguments
    def medical_bill_update_with_http_info(self, id : Annotated[StrictInt, Field(..., description="The unique identifier for the Medical Bill.")], if_match : Annotated[Optional[StrictStr], Field(description="The server will update the requested resource and send back a 200 status, but only if value in the header matches the existing resource's [ETag](#section/ETags).")] = None, x_api_version : Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None, fields : Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None, medical_bill_update_request : Annotated[Optional[MedicalBillUpdateRequest], Field(description="Request Body for Medical Bills")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Updating a Medical Bill  # noqa: E501
        ...
        >>> thread = api.medical_bill_update_with_http_info(id, if_match, x_api_version, fields, medical_bill_update_request, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(MedicalBillShow, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method medical_bill_update" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        # process the body parameter
        _body_params = None
        if _params['medical_bill_update_request'] is not None:
            _body_params = _params['medical_bill_update_request']
