...
class ReportsApi:
    ...
    @validate_arguments
    def report_create(self, x_api_version : Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None, fields : Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None, report_create_request : Annotated[Optional[ReportCreateRequest], Field(description="Request Body for Reports")] = None, **kwargs) -> ReportShow:  # noqa: E501
        """Create a new Report  # noqa: E501

        Outlines the parameters and data fields used when creating a new Report  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.report_create(x_api_version, fields, report_create_request, async_req=True)
        >>> result = thread.get()
        ...
        :type fields: str
        :param report_create_request: Request Body for Reports
        ...
        if '_preload_content' in kwargs:
            message = "Error! Please call the report_create_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.report_create_with_http_info(x_api_version, fields, report_create_request, **kwargs)  # noqa: E501
    ...
    def report_create_with_http_info(self, x_api_version : Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None, fields : Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None, report_create_request : Annotated[Optional[ReportCreateRequest], Field(description="Request Body for Reports")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        >>> thread = api.report_create_with_http_info(x_api_version, fields, report_create_request, async_req=True)
        >>> result = thread.get()
        ...
        _body_params = None
        if _params['report_create_request'] is not None:
            _body_params = _params['report_create_request']
    ...
    @validate_arguments
    def report_download(self, id : Annotated[StrictInt, Field(..., description="The unique identifier for the Report.")], **kwargs) -> None:  # noqa: E501
        """Download the completed Report  # noqa: E501

        Download the completed Report  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.report_download(id, async_req=True)
        >>> result = thread.get()

        :param id: The unique identifier for the Report. (required)
        :type id: int
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: timeout setting for this request.
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the report_download_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.report_download_with_http_info(id, **kwargs)  # noqa: E501

    @validate_arguments
    def report_download_with_http_info(self, id : Annotated[StrictInt, Field(..., description="The unique identifier for the Report.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Download the completed Report  # noqa: E501
        ...
        >>> thread = api.report_download_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method report_download" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    @validate_arguments
    def report_index(self, x_api_version : Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None, category : Annotated[Optional[StrictStr], Field(description="Filters Report data by category.")] = None, created_before : Annotated[Optional[datetime], Field(description="Filters Report data by date. (Expects an ISO-8601 date).")] = None, created_since : Annotated[Optional[datetime], Field(description="Filter Report records to those having the `created_at` field after a specific time. (Expects an ISO-8601 timestamp).")] = None, fields : Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None, ids : Annotated[Optional[StrictInt], Field(description="Filter Report records to those having the specified unique identifiers.")] = None, kind : Annotated[Optional[StrictStr], Field(description="Filters Report data by kind.")] = None, limit : Annotated[Optional[StrictInt], Field(description="A limit on the number of Report records to be returned. Limit can range between 1 and 200. Default: `200`.")] = None, output_format : Annotated[Optional[StrictStr], Field(description="Filters Report data by format.")] = None, page_token : Annotated[Optional[StrictStr], Field(description="A token specifying which page to return.")] = None, query : Annotated[Optional[StrictStr], Field(description="Wildcard search for Report name.")] = None, source : Annotated[Optional[StrictStr], Field(description="Filters Report data by source.")] = None, state : Annotated[Optional[StrictStr], Field(description="Filters Report data by state.")] = None, updated_since : Annotated[Optional[datetime], Field(description="Filter Report records to those having the `updated_at` field after a specific time. (Expects an ISO-8601 timestamp).")] = None, **kwargs) -> ReportList:  # noqa: E501
        """Return the data for all Reports  # noqa: E501

        Outlines the parameters, optional and required, used when requesting the data for all Reports  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.report_index(x_api_version, category, created_before, created_since, fields, ids, kind, limit, output_format, page_token, query, source, state, updated_since, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the report_index_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.report_index_with_http_info(x_api_version, category, created_before, created_since, fields, ids, kind, limit, output_format, page_token, query, source, state, updated_since, **kwargs)  # noqa: E501

    @validate_arguments
    def report_index_with_http_info(self, x_api_version : Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None, category : Annotated[Optional[StrictStr], Field(description="Filters Report data by category.")] = None, created_before : Annotated[Optional[datetime], Field(description="Filters Report data by date. (Expects an ISO-8601 date).")] = None, created_since : Annotated[Optional[datetime], Field(description="Filter Report records to those having the `created_at` field after a specific time. (Expects an ISO-8601 timestamp).")] = None, fields : Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None, ids : Annotated[Optional[StrictInt], Field(description="Filter Report records to those having the specified unique identifiers.")] = None, kind : Annotated[Optional[StrictStr], Field(description="Filters Report data by kind.")] = None, limit : Annotated[Optional[StrictInt], Field(description="A limit on the number of Report records to be returned. Limit can range between 1 and 200. Default: `200`.")] = None, output_format : Annotated[Optional[StrictStr], Field(description="Filters Report data by format.")] = None, page_token : Annotated[Optional[StrictStr], Field(description="A token specifying which page to return.")] = None, query : Annotated[Optional[StrictStr], Field(description="Wildcard search for Report name.")] = None, source : Annotated[Optional[StrictStr], Field(description="Filters Report data by source.")] = None, state : Annotated[Optional[StrictStr], Field(description="Filters Report data by state.")] = None, updated_since : Annotated[Optional[datetime], Field(description="Filter Report records to those having the `updated_at` field after a specific time. (Expects an ISO-8601 timestamp).")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Return the data for all Reports  # noqa: E501
        ...
        >>> thread = api.report_index_with_http_info(x_api_version, category, created_before, created_since, fields, ids, kind, limit, output_format, page_token, query, source, state, updated_since, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(ReportList, status_code(int), headers(HTTPHeaderDict))
        """
    ...
    def report_show(self, id : Annotated[StrictInt, Field(..., description="The unique identifier for the Report.")], if_modified_since : Annotated[Optional[date], Field(description="The server will send the requested resource with a 200 status, but only if it has been modified after the given date. (Expects an RFC 2822 timestamp).")] = None, if_none_match : Annotated[Optional[StrictStr], Field(description="The server will send the requested resource with a 200 status, but only if the existing resource's [ETag](#section/ETags) doesn't match any of the values listed.")] = None, x_api_version : Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None, fields : Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None, **kwargs) -> ReportShow:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the report_show_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.report_show_with_http_info(id, if_modified_since, if_none_match, x_api_version, fields, **kwargs)  # noqa: E501

    @validate_arguments
    def report_show_with_http_info(self, id : Annotated[StrictInt, Field(..., description="The unique identifier for the Report.")], if_modified_since : Annotated[Optional[date], Field(description="The server will send the requested resource with a 200 status, but only if it has been modified after the given date. (Expects an RFC 2822 timestamp).")] = None, if_none_match : Annotated[Optional[StrictStr], Field(description="The server will send the requested resource with a 200 status, but only if the existing resource's [ETag](#section/ETags) doesn't match any of the values listed.")] = None, x_api_version : Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None, fields : Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Return the data for a single Report  # noqa: E501
        ...
        >>> thread = api.report_show_with_http_info(id, if_modified_since, if_none_match, x_api_version, fields, async_req=True)
        >>> result = thread.get()
