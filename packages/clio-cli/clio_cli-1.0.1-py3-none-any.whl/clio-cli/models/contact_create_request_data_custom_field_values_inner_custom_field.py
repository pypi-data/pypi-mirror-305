...
class ContactCreateRequestDataCustomFieldValuesInnerCustomField(BaseModel):
    """
    ContactCreateRequestDataCustomFieldValuesInnerCustomField
    """
    id: StrictInt = Field(default=..., description="The unique identifier for a single CustomField associated with the CustomFieldValue. The keyword `null` is not valid for this field.")
    __properties = ["id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ContactCreateRequestDataCustomFieldValuesInnerCustomField:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ContactCreateRequestDataCustomFieldValuesInnerCustomField:
        """Create an instance of ContactCreateRequestDataCustomFieldValuesInnerCustomField from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ContactCreateRequestDataCustomFieldValuesInnerCustomField.parse_obj(obj)

        _obj = ContactCreateRequestDataCustomFieldValuesInnerCustomField.parse_obj({
            "id": obj.get("id")
        })
        return _obj
