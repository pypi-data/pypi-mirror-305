...
class MedicalRecordsRequestUpdateRequestDataMedicalBillsInner(BaseModel):
    ...
    payers: Optional[conlist(MedicalRecordsRequestUpdateRequestDataMedicalBillsInnerPayersInner)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MedicalRecordsRequestUpdateRequestDataMedicalBillsInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MedicalRecordsRequestUpdateRequestDataMedicalBillsInner:
        """Create an instance of MedicalRecordsRequestUpdateRequestDataMedicalBillsInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MedicalRecordsRequestUpdateRequestDataMedicalBillsInner.parse_obj(obj)

        _obj = MedicalRecordsRequestUpdateRequestDataMedicalBillsInner.parse_obj({
            ...
            "payers": [MedicalRecordsRequestUpdateRequestDataMedicalBillsInnerPayersInner.from_dict(_item) for _item in obj.get("payers")] if obj.get("payers") is not None else None
        })
        return _obj
