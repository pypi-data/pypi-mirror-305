...
class TextSnippetCreateRequest(BaseModel):
    ...
    """
    data: TextSnippetCreateRequestData = Field(...)
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TextSnippetCreateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TextSnippetCreateRequest:
        """Create an instance of TextSnippetCreateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TextSnippetCreateRequest.parse_obj(obj)

        _obj = TextSnippetCreateRequest.parse_obj({
            "data": TextSnippetCreateRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
