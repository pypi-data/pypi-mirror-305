...
class DocumentList(BaseModel):
    ...
    DocumentList
    """
    data: conlist(Document) = Field(default=..., description="Document List Response")
    __properties = ["data"]
    ...
    def from_dict(cls, obj: dict) -> DocumentList:
        ...
        _obj = DocumentList.parse_obj({
            "data": [Document.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
