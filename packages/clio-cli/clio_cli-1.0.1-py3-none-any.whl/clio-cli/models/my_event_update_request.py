...
class MyEventUpdateRequest(BaseModel):
    """
    MyEventUpdateRequest
    """
    data: MyEventUpdateRequestData = Field(...)
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MyEventUpdateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MyEventUpdateRequest:
        """Create an instance of MyEventUpdateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MyEventUpdateRequest.parse_obj(obj)

        _obj = MyEventUpdateRequest.parse_obj({
            "data": MyEventUpdateRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
