...
class CustomFieldCreateRequest(BaseModel):
    ...
    """
    data: CustomFieldCreateRequestData = Field(...)
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CustomFieldCreateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CustomFieldCreateRequest:
        """Create an instance of CustomFieldCreateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CustomFieldCreateRequest.parse_obj(obj)

        _obj = CustomFieldCreateRequest.parse_obj({
            "data": CustomFieldCreateRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
