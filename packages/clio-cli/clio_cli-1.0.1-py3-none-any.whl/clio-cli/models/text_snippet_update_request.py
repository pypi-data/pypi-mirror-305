...
class TextSnippetUpdateRequest(BaseModel):
    ...
    """
    data: TextSnippetUpdateRequestData = Field(...)
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TextSnippetUpdateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TextSnippetUpdateRequest:
        """Create an instance of TextSnippetUpdateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TextSnippetUpdateRequest.parse_obj(obj)

        _obj = TextSnippetUpdateRequest.parse_obj({
            "data": TextSnippetUpdateRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
