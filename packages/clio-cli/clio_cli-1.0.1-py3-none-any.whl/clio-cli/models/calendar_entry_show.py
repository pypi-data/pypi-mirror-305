...
class CalendarEntryShow(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CalendarEntryShow:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CalendarEntryShow:
        """Create an instance of CalendarEntryShow from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CalendarEntryShow.parse_obj(obj)

        _obj = CalendarEntryShow.parse_obj({
            "data": CalendarEntry.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
