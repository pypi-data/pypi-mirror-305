...
class ActivityDescriptionList(BaseModel):
    ...
    """
    data: conlist(ActivityDescription) = Field(default=..., description="ActivityDescription List Response")
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ActivityDescriptionList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ActivityDescriptionList:
        """Create an instance of ActivityDescriptionList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ActivityDescriptionList.parse_obj(obj)

        _obj = ActivityDescriptionList.parse_obj({
            "data": [ActivityDescription.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
