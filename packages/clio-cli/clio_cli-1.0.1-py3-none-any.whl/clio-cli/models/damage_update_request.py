...
class DamageUpdateRequest(BaseModel):
    ...
    DamageUpdateRequest
    """
    data: DamageUpdateRequestData = Field(...)
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DamageUpdateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DamageUpdateRequest:
        """Create an instance of DamageUpdateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DamageUpdateRequest.parse_obj(obj)

        _obj = DamageUpdateRequest.parse_obj({
            "data": DamageUpdateRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
