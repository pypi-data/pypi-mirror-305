...
class BankAccountUpdateRequestData(BaseModel):
    """
    ...
    currency: Optional[StrictStr] = Field(default=None, description="Currency the BankAccount is in.")
    ...
    __properties = ["account_number", "controlled_account", "currency", "default_account", "domicile_branch", "general_ledger_number", "holder", "institution", "name", "swift", "transit_number"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BankAccountUpdateRequestData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BankAccountUpdateRequestData:
        """Create an instance of BankAccountUpdateRequestData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BankAccountUpdateRequestData.parse_obj(obj)

        _obj = BankAccountUpdateRequestData.parse_obj({
