...
class ClioPaymentsLinkCreateRequest(BaseModel):
    """
    ClioPaymentsLinkCreateRequest
    """
    data: ClioPaymentsLinkCreateRequestData = Field(...)
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ClioPaymentsLinkCreateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ClioPaymentsLinkCreateRequest:
        """Create an instance of ClioPaymentsLinkCreateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ClioPaymentsLinkCreateRequest.parse_obj(obj)

        _obj = ClioPaymentsLinkCreateRequest.parse_obj({
            "data": ClioPaymentsLinkCreateRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
