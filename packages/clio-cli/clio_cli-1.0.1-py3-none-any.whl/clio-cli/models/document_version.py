...
class DocumentVersion(BaseModel):
    ...
    put_headers: Optional[conlist(MultipartHeaderBase)] = Field(default=None, description="MultipartHeader")
    multiparts: Optional[conlist(Multipart)] = Field(default=None, description="Multipart")
    __properties = ["id", "document_id", "etag", "uuid", "created_at", "updated_at", "filename", "size", "version_number", "content_type", "received_at", "put_url", "fully_uploaded", "creator", "put_headers", "multiparts"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DocumentVersion:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DocumentVersion:
        """Create an instance of DocumentVersion from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DocumentVersion.parse_obj(obj)

        _obj = DocumentVersion.parse_obj({
            "id": obj.get("id"),
            ...
            "put_headers": [MultipartHeaderBase.from_dict(_item) for _item in obj.get("put_headers")] if obj.get("put_headers") is not None else None,
            "multiparts": [Multipart.from_dict(_item) for _item in obj.get("multiparts")] if obj.get("multiparts") is not None else None
        })
        return _obj
