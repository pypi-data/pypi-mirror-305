...
class ConversationUpdateRequestData(BaseModel):
    ...
    """
    archived: Optional[StrictBool] = Field(default=None, description="Whether or not the Conversation has been archived.")
    matter: Optional[ConversationUpdateRequestDataMatter] = None
    read: Optional[StrictBool] = Field(default=None, description="Whether or not the Conversation has been read.")
    __properties = ["archived", "matter", "read"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ConversationUpdateRequestData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ConversationUpdateRequestData:
        """Create an instance of ConversationUpdateRequestData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ConversationUpdateRequestData.parse_obj(obj)

        _obj = ConversationUpdateRequestData.parse_obj({
            "archived": obj.get("archived"),
            "matter": ConversationUpdateRequestDataMatter.from_dict(obj.get("matter")) if obj.get("matter") is not None else None,
            "read": obj.get("read")
        })
        return _obj
