...
class ReportScheduleList(BaseModel):
    ...
    ReportScheduleList
    """
    data: conlist(ReportSchedule) = Field(default=..., description="ReportSchedule List Response")
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ReportScheduleList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ReportScheduleList:
        """Create an instance of ReportScheduleList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ReportScheduleList.parse_obj(obj)

        _obj = ReportScheduleList.parse_obj({
            "data": [ReportSchedule.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
