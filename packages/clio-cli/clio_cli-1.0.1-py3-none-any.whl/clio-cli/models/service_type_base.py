...
class ServiceTypeBase(BaseModel):
    ...
    ServiceTypeBase
    """
    id: Optional[StrictInt] = Field(default=None, description="Unique identifier for the *ServiceType*")
    etag: Optional[StrictStr] = Field(default=None, description="ETag for the *ServiceType*")
    created_at: Optional[datetime] = Field(default=None, description="The time the *ServiceType* was created (as a ISO-8601 timestamp)")
    updated_at: Optional[datetime] = Field(default=None, description="The time the *ServiceType* was last updated (as a ISO-8601 timestamp)")
    system_id: Optional[StrictInt] = Field(default=None, description="Server ID")
    description: Optional[StrictStr] = Field(default=None, description="A detailed description of the *ServiceType*")
    default: Optional[StrictBool] = Field(default=None, description="Whether *ServiceType* is default for the current user")
    __properties = ["id", "etag", "created_at", "updated_at", "system_id", "description", "default"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ServiceTypeBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ServiceTypeBase:
        """Create an instance of ServiceTypeBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ServiceTypeBase.parse_obj(obj)

        _obj = ServiceTypeBase.parse_obj({
            "id": obj.get("id"),
            "etag": obj.get("etag"),
