...
class ContactUpdateRequestDataCustomFieldValuesInner(BaseModel):
    """
    ...
    custom_field: Optional[ContactUpdateRequestDataCustomFieldValuesInnerCustomField] = None
    id: Optional[StrictInt] = Field(default=None, description="The unique identifier for a single CustomFieldValue associated with the Contact. The keyword `null` is not valid for this field.")
    destroy: Optional[StrictBool] = Field(default=None, alias="_destroy", description="The destroy flag. If the flag is set to `true` and the unique identifier of the associated CustomFieldValue is present, the CustomFieldValue is deleted from the Contact.")
    __properties = ["value", "custom_field", "id", "_destroy"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ContactUpdateRequestDataCustomFieldValuesInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ContactUpdateRequestDataCustomFieldValuesInner:
        """Create an instance of ContactUpdateRequestDataCustomFieldValuesInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ContactUpdateRequestDataCustomFieldValuesInner.parse_obj(obj)

        _obj = ContactUpdateRequestDataCustomFieldValuesInner.parse_obj({
            "value": obj.get("value"),
            "custom_field": ContactUpdateRequestDataCustomFieldValuesInnerCustomField.from_dict(obj.get("custom_field")) if obj.get("custom_field") is not None else None,
            "id": obj.get("id"),
