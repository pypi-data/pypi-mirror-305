...
class BillUpdateRequest(BaseModel):
    ...
    BillUpdateRequest
    """
    data: BillUpdateRequestData = Field(...)
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BillUpdateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BillUpdateRequest:
        """Create an instance of BillUpdateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BillUpdateRequest.parse_obj(obj)

        _obj = BillUpdateRequest.parse_obj({
            "data": BillUpdateRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
