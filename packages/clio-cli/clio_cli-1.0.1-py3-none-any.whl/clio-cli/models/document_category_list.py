...
class DocumentCategoryList(BaseModel):
    ...
    """
    data: conlist(DocumentCategory) = Field(default=..., description="DocumentCategory List Response")
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DocumentCategoryList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DocumentCategoryList:
        """Create an instance of DocumentCategoryList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DocumentCategoryList.parse_obj(obj)

        _obj = DocumentCategoryList.parse_obj({
            "data": [DocumentCategory.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
