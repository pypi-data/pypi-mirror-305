...
class OutstandingClientBalanceList(BaseModel):
    ...
    """
    data: conlist(OutstandingClientBalance) = Field(default=..., description="OutstandingClientBalance List Response")
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OutstandingClientBalanceList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OutstandingClientBalanceList:
        """Create an instance of OutstandingClientBalanceList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OutstandingClientBalanceList.parse_obj(obj)

        _obj = OutstandingClientBalanceList.parse_obj({
            "data": [OutstandingClientBalance.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
