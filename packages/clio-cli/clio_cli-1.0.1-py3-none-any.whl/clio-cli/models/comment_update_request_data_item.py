...
class CommentUpdateRequestDataItem(BaseModel):
    """
    CommentUpdateRequestDataItem
    """
    id: Optional[StrictInt] = Field(default=None, description="The unique identifier of the Document or Folder to which the Comment is associated.")
    __properties = ["id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CommentUpdateRequestDataItem:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CommentUpdateRequestDataItem:
        """Create an instance of CommentUpdateRequestDataItem from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CommentUpdateRequestDataItem.parse_obj(obj)

        _obj = CommentUpdateRequestDataItem.parse_obj({
            "id": obj.get("id")
        })
        return _obj
