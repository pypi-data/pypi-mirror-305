...
class ReminderCreateRequestData(BaseModel):
    """
    ...
    notification_method: MatterCreateRequestDataStatuteOfLimitationsRemindersInnerNotificationMethod = Field(...)
    subject: ReminderCreateRequestDataSubject = Field(...)
    __properties = ["duration_unit", "duration_value", "notification_method", "subject"]
    ...
    def duration_unit_validate_enum(cls, value):
        ...
        if value not in ('weeks', 'days', 'hours', 'minutes'):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ReminderCreateRequestData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ReminderCreateRequestData:
        """Create an instance of ReminderCreateRequestData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ReminderCreateRequestData.parse_obj(obj)

        _obj = ReminderCreateRequestData.parse_obj({
            "duration_unit": obj.get("duration_unit"),
            "duration_value": obj.get("duration_value"),
            "notification_method": MatterCreateRequestDataStatuteOfLimitationsRemindersInnerNotificationMethod.from_dict(obj.get("notification_method")) if obj.get("notification_method") is not None else None,
            "subject": ReminderCreateRequestDataSubject.from_dict(obj.get("subject")) if obj.get("subject") is not None else None
        })
        return _obj
