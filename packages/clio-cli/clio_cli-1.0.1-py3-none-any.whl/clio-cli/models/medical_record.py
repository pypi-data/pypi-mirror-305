...
class MedicalRecord(BaseModel):
    ...
    MedicalRecord
    """
    id: Optional[StrictInt] = Field(default=None, description="Unique identifier for the *MedicalRecord*")
    document_id: Optional[StrictInt] = Field(default=None, description="The id of the document associated with the Medical Record")
    etag: Optional[StrictStr] = Field(default=None, description="ETag for the *MedicalRecord*")
    end_date: Optional[datetime] = Field(default=None, description="End date for *MedicalRecord* (as a ISO-8601 date)")
    start_date: Optional[datetime] = Field(default=None, description="Start date for *MedicalRecord* (as a ISO-8601 date)")
    created_at: Optional[datetime] = Field(default=None, description="The time the *MedicalRecord* was created (as a ISO-8601 timestamp)")
    updated_at: Optional[datetime] = Field(default=None, description="The time the *MedicalRecord* was last updated (as a ISO-8601 timestamp)")
    matter: Optional[MatterBase] = None
    __properties = ["id", "document_id", "etag", "end_date", "start_date", "created_at", "updated_at", "matter"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MedicalRecord:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MedicalRecord:
        """Create an instance of MedicalRecord from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MedicalRecord.parse_obj(obj)

        _obj = MedicalRecord.parse_obj({
            "id": obj.get("id"),
