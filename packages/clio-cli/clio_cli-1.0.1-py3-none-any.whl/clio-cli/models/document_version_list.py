...
class DocumentVersionList(BaseModel):
    ...
    DocumentVersionList
    """
    data: conlist(DocumentVersion) = Field(default=..., description="DocumentVersion List Response")
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DocumentVersionList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DocumentVersionList:
        """Create an instance of DocumentVersionList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DocumentVersionList.parse_obj(obj)

        _obj = DocumentVersionList.parse_obj({
            "data": [DocumentVersion.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
