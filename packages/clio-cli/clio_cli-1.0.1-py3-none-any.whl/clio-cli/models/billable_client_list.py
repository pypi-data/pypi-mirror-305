...
class BillableClientList(BaseModel):
    ...
    BillableClientList
    """
    data: conlist(BillableClient) = Field(default=..., description="BillableClient List Response")
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BillableClientList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BillableClientList:
        """Create an instance of BillableClientList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BillableClientList.parse_obj(obj)

        _obj = BillableClientList.parse_obj({
            "data": [BillableClient.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
