...
class CommunicationCreateRequest(BaseModel):
    ...
    """
    data: CommunicationCreateRequestData = Field(...)
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CommunicationCreateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CommunicationCreateRequest:
        """Create an instance of CommunicationCreateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CommunicationCreateRequest.parse_obj(obj)

        _obj = CommunicationCreateRequest.parse_obj({
            "data": CommunicationCreateRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
