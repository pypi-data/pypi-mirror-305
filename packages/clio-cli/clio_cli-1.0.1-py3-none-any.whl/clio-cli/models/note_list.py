...
class NoteList(BaseModel):
    ...
    NoteList
    """
    data: conlist(Note) = Field(default=..., description="Note List Response")
    __properties = ["data"]
    ...
    def from_dict(cls, obj: dict) -> NoteList:
        ...
        _obj = NoteList.parse_obj({
            "data": [Note.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
