...
class CalendarCreateRequest(BaseModel):
    ...
    """
    data: CalendarCreateRequestData = Field(...)
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CalendarCreateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CalendarCreateRequest:
        """Create an instance of CalendarCreateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CalendarCreateRequest.parse_obj(obj)

        _obj = CalendarCreateRequest.parse_obj({
            "data": CalendarCreateRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
