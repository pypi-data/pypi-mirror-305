...
class TaskTemplateListCopyRequestData(BaseModel):
    """
    TaskTemplateListCopyRequestData
    """
    description: Optional[StrictStr] = Field(default=None, description="The description of the TaskTemplateList copy.")
    name: Optional[StrictStr] = Field(default=None, description="The name of the TaskTemplateList copy.")
    practice_area: Optional[TaskTemplateListCopyRequestDataPracticeArea] = None
    __properties = ["description", "name", "practice_area"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TaskTemplateListCopyRequestData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TaskTemplateListCopyRequestData:
        """Create an instance of TaskTemplateListCopyRequestData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TaskTemplateListCopyRequestData.parse_obj(obj)

        _obj = TaskTemplateListCopyRequestData.parse_obj({
            "description": obj.get("description"),
            "name": obj.get("name"),
            "practice_area": TaskTemplateListCopyRequestDataPracticeArea.from_dict(obj.get("practice_area")) if obj.get("practice_area") is not None else None
        })
        return _obj
