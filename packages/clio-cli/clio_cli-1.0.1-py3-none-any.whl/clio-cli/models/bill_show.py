...
class BillShow(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BillShow:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BillShow:
        """Create an instance of BillShow from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BillShow.parse_obj(obj)

        _obj = BillShow.parse_obj({
            "data": Bill.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
