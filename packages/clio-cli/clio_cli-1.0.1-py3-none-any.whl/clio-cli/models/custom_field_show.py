...
class CustomFieldShow(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CustomFieldShow:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CustomFieldShow:
        """Create an instance of CustomFieldShow from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CustomFieldShow.parse_obj(obj)

        _obj = CustomFieldShow.parse_obj({
            "data": CustomField.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
