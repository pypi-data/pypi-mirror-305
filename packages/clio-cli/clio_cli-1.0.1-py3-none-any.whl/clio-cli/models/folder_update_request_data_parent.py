...
class FolderUpdateRequestDataParent(BaseModel):
    """
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in ('Folder', 'Contact', 'Matter'):
            raise ValueError("must be one of enum values ('Folder', 'Contact', 'Matter')")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FolderUpdateRequestDataParent:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FolderUpdateRequestDataParent:
        """Create an instance of FolderUpdateRequestDataParent from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FolderUpdateRequestDataParent.parse_obj(obj)

        _obj = FolderUpdateRequestDataParent.parse_obj({
            "id": obj.get("id"),
            "type": obj.get("type")
        })
        return _obj
