...
class ContactCreateRequestDataCustomFieldSetAssociationsInner(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ContactCreateRequestDataCustomFieldSetAssociationsInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ContactCreateRequestDataCustomFieldSetAssociationsInner:
        """Create an instance of ContactCreateRequestDataCustomFieldSetAssociationsInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ContactCreateRequestDataCustomFieldSetAssociationsInner.parse_obj(obj)

        _obj = ContactCreateRequestDataCustomFieldSetAssociationsInner.parse_obj({
