...
class TrustRequestShow(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TrustRequestShow:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TrustRequestShow:
        """Create an instance of TrustRequestShow from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TrustRequestShow.parse_obj(obj)

        _obj = TrustRequestShow.parse_obj({
            "data": TrustRequest.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
