...
class WebhookShow(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WebhookShow:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WebhookShow:
        """Create an instance of WebhookShow from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WebhookShow.parse_obj(obj)

        _obj = WebhookShow.parse_obj({
            "data": Webhook.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
