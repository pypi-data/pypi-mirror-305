...
class MyEventList(BaseModel):
    ...
    MyEventList
    """
    data: conlist(MyEvent) = Field(default=..., description="MyEvent List Response")
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MyEventList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MyEventList:
        """Create an instance of MyEventList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MyEventList.parse_obj(obj)

        _obj = MyEventList.parse_obj({
            "data": [MyEvent.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
