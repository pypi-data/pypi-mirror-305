...
class DocumentTemplate(BaseModel):
    ...
    DocumentTemplate
    """
    id: Optional[StrictInt] = Field(default=None, description="Unique identifier for the *DocumentTemplate*")
    etag: Optional[StrictStr] = Field(default=None, description="ETag for the *DocumentTemplate*")
    size: Optional[StrictInt] = Field(default=None, description="The size in bytes of the template")
    ...
    filename: Optional[StrictStr] = Field(default=None, description="The name of the original file that was uploaded")
    created_at: Optional[datetime] = Field(default=None, description="The time the *DocumentTemplate* was created (as a ISO-8601 timestamp)")
    updated_at: Optional[datetime] = Field(default=None, description="The time the *DocumentTemplate* was last updated (as a ISO-8601 timestamp)")
    document_category: Optional[DocumentCategoryBase] = None
    last_modified_by: Optional[UserBase] = None
    __properties = ["id", "etag", "size", "content_type", "filename", "created_at", "updated_at", "document_category", "last_modified_by"]
    ...
    def from_dict(cls, obj: dict) -> DocumentTemplate:
        ...
        _obj = DocumentTemplate.parse_obj({
            ...
            "last_modified_by": UserBase.from_dict(obj.get("last_modified_by")) if obj.get("last_modified_by") is not None else None
        })
        return _obj
