...
class CommentUpdateRequest(BaseModel):
    ...
    """
    data: CommentUpdateRequestData = Field(...)
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CommentUpdateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CommentUpdateRequest:
        """Create an instance of CommentUpdateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CommentUpdateRequest.parse_obj(obj)

        _obj = CommentUpdateRequest.parse_obj({
            "data": CommentUpdateRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
