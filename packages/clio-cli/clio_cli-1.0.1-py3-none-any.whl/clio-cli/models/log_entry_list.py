...
class LogEntryList(BaseModel):
    ...
    LogEntryList
    """
    data: conlist(LogEntry) = Field(default=..., description="LogEntry List Response")
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LogEntryList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LogEntryList:
        """Create an instance of LogEntryList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LogEntryList.parse_obj(obj)

        _obj = LogEntryList.parse_obj({
            "data": [LogEntry.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
