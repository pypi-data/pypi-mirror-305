...
class MatterUpdateRequestDataStatuteOfLimitationsRemindersInner(BaseModel):
    """
    MatterUpdateRequestDataStatuteOfLimitationsRemindersInner
    """
    duration_value: Optional[StrictInt] = Field(default=None, description="Time measured in `duration_unit` to remind user before the subject.")
    duration_unit: Optional[StrictStr] = Field(default=None, description="Unit to measure the duration value in.")
    notification_method: Optional[MatterUpdateRequestDataStatuteOfLimitationsRemindersInnerNotificationMethod] = None
    id: Optional[StrictInt] = Field(default=None, description="The unique identifier for a single Reminder associated with the Matter. The keyword `null` is not valid for this field.")
    destroy: Optional[StrictBool] = Field(default=None, alias="_destroy", description="The destroy flag. If the flag is set to `true` and the unique identifier of the associated Reminder is present, the Reminder is deleted from the Matter.")
    __properties = ["duration_value", "duration_unit", "notification_method", "id", "_destroy"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MatterUpdateRequestDataStatuteOfLimitationsRemindersInner:
    ...
    def to_dict(self):
        ...
        if self.notification_method:
            _dict['notification_method'] = self.notification_method.to_dict()
        return _dict

    @classmethod
    def from_dict(cls, obj: dict) -> MatterUpdateRequestDataStatuteOfLimitationsRemindersInner:
        """Create an instance of MatterUpdateRequestDataStatuteOfLimitationsRemindersInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MatterUpdateRequestDataStatuteOfLimitationsRemindersInner.parse_obj(obj)

        _obj = MatterUpdateRequestDataStatuteOfLimitationsRemindersInner.parse_obj({
            "duration_value": obj.get("duration_value"),
            "duration_unit": obj.get("duration_unit"),
            "notification_method": MatterUpdateRequestDataStatuteOfLimitationsRemindersInnerNotificationMethod.from_dict(obj.get("notification_method")) if obj.get("notification_method") is not None else None,
            "id": obj.get("id"),
