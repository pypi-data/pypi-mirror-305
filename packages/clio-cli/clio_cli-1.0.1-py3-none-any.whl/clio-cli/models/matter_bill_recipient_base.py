...
class MatterBillRecipientBase(BaseModel):
    ...
    __properties = ["created_at", "etag", "id", "updated_at"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MatterBillRecipientBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MatterBillRecipientBase:
        """Create an instance of MatterBillRecipientBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MatterBillRecipientBase.parse_obj(obj)

        _obj = MatterBillRecipientBase.parse_obj({
