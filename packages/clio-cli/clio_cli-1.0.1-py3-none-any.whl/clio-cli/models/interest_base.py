...
class InterestBase(BaseModel):
    ...
    __properties = ["balance", "period", "rate", "total", "type"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InterestBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InterestBase:
        """Create an instance of InterestBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return InterestBase.parse_obj(obj)

        _obj = InterestBase.parse_obj({
