...
class ContactCreateRequestDataEmailAddressesInner(BaseModel):
    """
    ...
    __properties = ["name", "address", "default_email"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ContactCreateRequestDataEmailAddressesInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ContactCreateRequestDataEmailAddressesInner:
        """Create an instance of ContactCreateRequestDataEmailAddressesInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ContactCreateRequestDataEmailAddressesInner.parse_obj(obj)

        _obj = ContactCreateRequestDataEmailAddressesInner.parse_obj({
