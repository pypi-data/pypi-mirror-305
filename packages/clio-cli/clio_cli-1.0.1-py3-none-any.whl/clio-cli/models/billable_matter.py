...
class BillableMatter(BaseModel):
    ...
    __properties = ["id", "unbilled_hours", "unbilled_amount", "amount_in_trust", "display_number", "client"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BillableMatter:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BillableMatter:
        """Create an instance of BillableMatter from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BillableMatter.parse_obj(obj)

        _obj = BillableMatter.parse_obj({
            "id": obj.get("id"),
