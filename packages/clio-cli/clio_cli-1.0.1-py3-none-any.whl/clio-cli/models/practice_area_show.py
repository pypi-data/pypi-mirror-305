...
class PracticeAreaShow(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PracticeAreaShow:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PracticeAreaShow:
        """Create an instance of PracticeAreaShow from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PracticeAreaShow.parse_obj(obj)

        _obj = PracticeAreaShow.parse_obj({
            "data": PracticeArea.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
