...
class TrustLineItemList(BaseModel):
    ...
    TrustLineItemList
    """
    data: conlist(TrustLineItem) = Field(default=..., description="TrustLineItem List Response")
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TrustLineItemList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TrustLineItemList:
        """Create an instance of TrustLineItemList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TrustLineItemList.parse_obj(obj)

        _obj = TrustLineItemList.parse_obj({
            "data": [TrustLineItem.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
