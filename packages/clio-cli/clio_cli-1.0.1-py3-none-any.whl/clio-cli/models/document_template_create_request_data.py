...
class DocumentTemplateCreateRequestData(BaseModel):
    ...
    file: StrictStr = Field(default=..., description="A file that contains the DocumentTemplate. The file can be uploaded through a form as application/x-www-form-urlencoded or multipart/form-data request. Alternatively, the file can be converted to a BASE64-encoded string and serialized to JSON. ")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DocumentTemplateCreateRequestData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DocumentTemplateCreateRequestData:
        """Create an instance of DocumentTemplateCreateRequestData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DocumentTemplateCreateRequestData.parse_obj(obj)

        _obj = DocumentTemplateCreateRequestData.parse_obj({
