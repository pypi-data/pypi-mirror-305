...
class MatterUpdateRequest(BaseModel):
    ...
    MatterUpdateRequest
    """
    data: MatterUpdateRequestData = Field(...)
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MatterUpdateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MatterUpdateRequest:
        """Create an instance of MatterUpdateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MatterUpdateRequest.parse_obj(obj)

        _obj = MatterUpdateRequest.parse_obj({
            "data": MatterUpdateRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
