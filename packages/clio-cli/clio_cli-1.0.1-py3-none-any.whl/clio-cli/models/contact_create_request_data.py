...
class ContactCreateRequestData(BaseModel):
    ...
    """
    addresses: Optional[conlist(ContactCreateRequestDataAddressesInner)] = None
    ...
    custom_field_set_associations: Optional[conlist(ContactCreateRequestDataCustomFieldSetAssociationsInner)] = None
    ...
    email_addresses: Optional[conlist(ContactCreateRequestDataEmailAddressesInner)] = None
    first_name: Optional[StrictStr] = Field(default=None, description="First name of the Contact.")
    instant_messengers: Optional[conlist(ContactCreateRequestDataInstantMessengersInner)] = None
    ...
    name: StrictStr = Field(default=..., description="Full name of the Contact. For requirements, see [Contact Name](https://docs.developers.clio.com/api-reference/#section/Contact-Name).")
    phone_numbers: Optional[conlist(ContactCreateRequestDataPhoneNumbersInner)] = None
    ...
    type: StrictStr = Field(default=..., description="Type of the Contact.")
    web_sites: Optional[conlist(ContactCreateRequestDataWebSitesInner)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ContactCreateRequestData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ContactCreateRequestData:
        """Create an instance of ContactCreateRequestData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ContactCreateRequestData.parse_obj(obj)

        _obj = ContactCreateRequestData.parse_obj({
            "addresses": [ContactCreateRequestDataAddressesInner.from_dict(_item) for _item in obj.get("addresses")] if obj.get("addresses") is not None else None,
            ...
            "custom_field_set_associations": [ContactCreateRequestDataCustomFieldSetAssociationsInner.from_dict(_item) for _item in obj.get("custom_field_set_associations")] if obj.get("custom_field_set_associations") is not None else None,
            ...
            "email_addresses": [ContactCreateRequestDataEmailAddressesInner.from_dict(_item) for _item in obj.get("email_addresses")] if obj.get("email_addresses") is not None else None,
            "first_name": obj.get("first_name"),
            "instant_messengers": [ContactCreateRequestDataInstantMessengersInner.from_dict(_item) for _item in obj.get("instant_messengers")] if obj.get("instant_messengers") is not None else None,
            "last_name": obj.get("last_name"),
            "ledes_client_id": obj.get("ledes_client_id"),
            "middle_name": obj.get("middle_name"),
            "name": obj.get("name"),
            "phone_numbers": [ContactCreateRequestDataPhoneNumbersInner.from_dict(_item) for _item in obj.get("phone_numbers")] if obj.get("phone_numbers") is not None else None,
            "prefix": obj.get("prefix"),
            "sales_tax_number": obj.get("sales_tax_number"),
            "title": obj.get("title"),
            "type": obj.get("type"),
            "web_sites": [ContactCreateRequestDataWebSitesInner.from_dict(_item) for _item in obj.get("web_sites")] if obj.get("web_sites") is not None else None
        })
        return _obj
