...
class CalendarUpdateRequest(BaseModel):
    ...
    """
    data: CalendarUpdateRequestData = Field(...)
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CalendarUpdateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CalendarUpdateRequest:
        """Create an instance of CalendarUpdateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CalendarUpdateRequest.parse_obj(obj)

        _obj = CalendarUpdateRequest.parse_obj({
            "data": CalendarUpdateRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
