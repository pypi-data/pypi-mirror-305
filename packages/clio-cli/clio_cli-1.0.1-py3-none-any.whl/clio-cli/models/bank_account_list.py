...
class BankAccountList(BaseModel):
    ...
    BankAccountList
    """
    data: conlist(BankAccount) = Field(default=..., description="BankAccount List Response")
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BankAccountList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BankAccountList:
        """Create an instance of BankAccountList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BankAccountList.parse_obj(obj)

        _obj = BankAccountList.parse_obj({
            "data": [BankAccount.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
