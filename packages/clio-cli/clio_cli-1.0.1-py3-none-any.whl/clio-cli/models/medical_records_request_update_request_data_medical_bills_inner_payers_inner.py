...
class MedicalRecordsRequestUpdateRequestDataMedicalBillsInnerPayersInner(BaseModel):
    """
    MedicalRecordsRequestUpdateRequestDataMedicalBillsInnerPayersInner
    """
    amount: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Lien amount.")
    holder_id: Optional[StrictInt] = Field(default=None, description="The unique identifier for a single Damage associated with the MedicalRecordsRequest. The keyword `null` is not valid for this field.")
    mark_as_lien: Optional[StrictBool] = Field(default=None, description="Mark record as Lien.")
    __properties = ["amount", "holder_id", "mark_as_lien"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MedicalRecordsRequestUpdateRequestDataMedicalBillsInnerPayersInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MedicalRecordsRequestUpdateRequestDataMedicalBillsInnerPayersInner:
        """Create an instance of MedicalRecordsRequestUpdateRequestDataMedicalBillsInnerPayersInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MedicalRecordsRequestUpdateRequestDataMedicalBillsInnerPayersInner.parse_obj(obj)

        _obj = MedicalRecordsRequestUpdateRequestDataMedicalBillsInnerPayersInner.parse_obj({
