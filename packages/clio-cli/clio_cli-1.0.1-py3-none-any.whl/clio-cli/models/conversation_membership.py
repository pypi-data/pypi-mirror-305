...
class ConversationMembership(BaseModel):
    ...
    __properties = ["id", "etag", "read", "archived", "created_at", "updated_at", "member"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ConversationMembership:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ConversationMembership:
        """Create an instance of ConversationMembership from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ConversationMembership.parse_obj(obj)

        _obj = ConversationMembership.parse_obj({
            "id": obj.get("id"),
            "etag": obj.get("etag"),
            "read": obj.get("read"),
