...
class ActivityRateShow(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ActivityRateShow:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ActivityRateShow:
        """Create an instance of ActivityRateShow from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ActivityRateShow.parse_obj(obj)

        _obj = ActivityRateShow.parse_obj({
            "data": ActivityRate.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
