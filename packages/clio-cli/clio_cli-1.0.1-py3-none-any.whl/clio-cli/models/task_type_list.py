...
class TaskTypeList(BaseModel):
    ...
    TaskTypeList
    """
    data: conlist(TaskType) = Field(default=..., description="TaskType List Response")
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TaskTypeList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TaskTypeList:
        """Create an instance of TaskTypeList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TaskTypeList.parse_obj(obj)

        _obj = TaskTypeList.parse_obj({
            "data": [TaskType.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
