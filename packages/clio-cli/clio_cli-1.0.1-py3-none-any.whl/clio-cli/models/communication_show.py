...
class CommunicationShow(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CommunicationShow:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CommunicationShow:
        """Create an instance of CommunicationShow from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CommunicationShow.parse_obj(obj)

        _obj = CommunicationShow.parse_obj({
            "data": Communication.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
