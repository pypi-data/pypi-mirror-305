...
class CalendarVisibilityShow(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CalendarVisibilityShow:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CalendarVisibilityShow:
        """Create an instance of CalendarVisibilityShow from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CalendarVisibilityShow.parse_obj(obj)

        _obj = CalendarVisibilityShow.parse_obj({
            "data": CalendarVisibility.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
