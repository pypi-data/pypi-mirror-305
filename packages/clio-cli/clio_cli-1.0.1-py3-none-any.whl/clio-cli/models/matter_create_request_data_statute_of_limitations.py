...
class MatterCreateRequestDataStatuteOfLimitations(BaseModel):
    ...
    reminders: Optional[conlist(MatterCreateRequestDataStatuteOfLimitationsRemindersInner)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MatterCreateRequestDataStatuteOfLimitations:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MatterCreateRequestDataStatuteOfLimitations:
        """Create an instance of MatterCreateRequestDataStatuteOfLimitations from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MatterCreateRequestDataStatuteOfLimitations.parse_obj(obj)

        _obj = MatterCreateRequestDataStatuteOfLimitations.parse_obj({
            "status": obj.get("status"),
            "due_at": obj.get("due_at"),
            "reminders": [MatterCreateRequestDataStatuteOfLimitationsRemindersInner.from_dict(_item) for _item in obj.get("reminders")] if obj.get("reminders") is not None else None
        })
        return _obj
