...
class NoteCreateRequest(BaseModel):
    ...
    NoteCreateRequest
    """
    data: NoteCreateRequestData = Field(...)
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NoteCreateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NoteCreateRequest:
        """Create an instance of NoteCreateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NoteCreateRequest.parse_obj(obj)

        _obj = NoteCreateRequest.parse_obj({
            "data": NoteCreateRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
