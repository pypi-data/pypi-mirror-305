...
class CalendarEntryList(BaseModel):
    ...
    CalendarEntryList
    """
    data: conlist(CalendarEntry) = Field(default=..., description="CalendarEntry List Response")
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CalendarEntryList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CalendarEntryList:
        """Create an instance of CalendarEntryList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CalendarEntryList.parse_obj(obj)

        _obj = CalendarEntryList.parse_obj({
            "data": [CalendarEntry.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
