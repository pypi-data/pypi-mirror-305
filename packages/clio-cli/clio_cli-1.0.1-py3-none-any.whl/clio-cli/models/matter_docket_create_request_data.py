...
class MatterDocketCreateRequestData(BaseModel):
    ...
    """
    jurisdiction: MatterDocketCreateRequestDataJurisdiction = Field(...)
    name: StrictStr = Field(default=..., description="Name of the MatterDocket.")
    start_date: date = Field(default=..., description="Start date of the MatterDocket. (Expects an ISO-8601 date).")
    start_time: Optional[datetime] = Field(default=None, description="Start time of the MatterDocket. Required for some triggers.  (Expects an ISO-8601 timestamp).")
    trigger: MatterDocketCreateRequestDataTrigger = Field(...)
    __properties = ["jurisdiction", "name", "start_date", "start_time", "trigger"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MatterDocketCreateRequestData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MatterDocketCreateRequestData:
        """Create an instance of MatterDocketCreateRequestData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MatterDocketCreateRequestData.parse_obj(obj)

        _obj = MatterDocketCreateRequestData.parse_obj({
            "jurisdiction": MatterDocketCreateRequestDataJurisdiction.from_dict(obj.get("jurisdiction")) if obj.get("jurisdiction") is not None else None,
            "name": obj.get("name"),
            "start_date": obj.get("start_date"),
            "start_time": obj.get("start_time"),
            "trigger": MatterDocketCreateRequestDataTrigger.from_dict(obj.get("trigger")) if obj.get("trigger") is not None else None
        })
        return _obj
