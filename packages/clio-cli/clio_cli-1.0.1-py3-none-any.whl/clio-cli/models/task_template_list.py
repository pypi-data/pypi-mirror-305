...
class TaskTemplateList(BaseModel):
    ...
    TaskTemplateList
    """
    data: conlist(TaskTemplate) = Field(default=..., description="TaskTemplate List Response")
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TaskTemplateList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TaskTemplateList:
        """Create an instance of TaskTemplateList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TaskTemplateList.parse_obj(obj)

        _obj = TaskTemplateList.parse_obj({
            "data": [TaskTemplate.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
