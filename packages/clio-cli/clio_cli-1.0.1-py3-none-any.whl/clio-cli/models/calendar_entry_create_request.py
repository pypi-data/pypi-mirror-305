...
class CalendarEntryCreateRequest(BaseModel):
    ...
    """
    data: CalendarEntryCreateRequestData = Field(...)
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CalendarEntryCreateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CalendarEntryCreateRequest:
        """Create an instance of CalendarEntryCreateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CalendarEntryCreateRequest.parse_obj(obj)

        _obj = CalendarEntryCreateRequest.parse_obj({
            "data": CalendarEntryCreateRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
