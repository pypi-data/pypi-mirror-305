...
class MatterUpdateRequestDataTaskTemplateListInstancesInnerTaskTemplateList(BaseModel):
    """
    MatterUpdateRequestDataTaskTemplateListInstancesInnerTaskTemplateList
    """
    id: Optional[StrictInt] = Field(default=None, description="The unique identifier for a single TaskTemplateList associated with the TaskTemplateListInstance. The keyword `null` is not valid for this field.")
    __properties = ["id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MatterUpdateRequestDataTaskTemplateListInstancesInnerTaskTemplateList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MatterUpdateRequestDataTaskTemplateListInstancesInnerTaskTemplateList:
        """Create an instance of MatterUpdateRequestDataTaskTemplateListInstancesInnerTaskTemplateList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MatterUpdateRequestDataTaskTemplateListInstancesInnerTaskTemplateList.parse_obj(obj)

        _obj = MatterUpdateRequestDataTaskTemplateListInstancesInnerTaskTemplateList.parse_obj({
            "id": obj.get("id")
        })
        return _obj
