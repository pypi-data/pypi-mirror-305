...
class GrantCreateRequest(BaseModel):
    ...
    GrantCreateRequest
    """
    data: GrantCreateRequestData = Field(...)
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GrantCreateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GrantCreateRequest:
        """Create an instance of GrantCreateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GrantCreateRequest.parse_obj(obj)

        _obj = GrantCreateRequest.parse_obj({
            "data": GrantCreateRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
