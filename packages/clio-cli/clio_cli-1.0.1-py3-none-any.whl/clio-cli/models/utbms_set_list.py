...
class UtbmsSetList(BaseModel):
    ...
    UtbmsSetList
    """
    data: conlist(UtbmsSet) = Field(default=..., description="UtbmsSet List Response")
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UtbmsSetList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UtbmsSetList:
        """Create an instance of UtbmsSetList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UtbmsSetList.parse_obj(obj)

        _obj = UtbmsSetList.parse_obj({
            "data": [UtbmsSet.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
