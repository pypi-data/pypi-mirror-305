...
class GroupShow(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GroupShow:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GroupShow:
        """Create an instance of GroupShow from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GroupShow.parse_obj(obj)

        _obj = GroupShow.parse_obj({
            "data": Group.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
