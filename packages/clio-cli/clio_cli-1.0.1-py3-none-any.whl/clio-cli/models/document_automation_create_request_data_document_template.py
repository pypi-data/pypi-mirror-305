...
class DocumentAutomationCreateRequestDataDocumentTemplate(BaseModel):
    """
    DocumentAutomationCreateRequestDataDocumentTemplate
    """
    id: StrictInt = Field(default=..., description="The unique identifier for a single DocumentTemplate associated with the DocumentAutomation. The keyword `null` is not valid for this field.")
    __properties = ["id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DocumentAutomationCreateRequestDataDocumentTemplate:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DocumentAutomationCreateRequestDataDocumentTemplate:
        """Create an instance of DocumentAutomationCreateRequestDataDocumentTemplate from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DocumentAutomationCreateRequestDataDocumentTemplate.parse_obj(obj)

        _obj = DocumentAutomationCreateRequestDataDocumentTemplate.parse_obj({
            "id": obj.get("id")
        })
        return _obj
