...
class CustomActionShow(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CustomActionShow:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CustomActionShow:
        """Create an instance of CustomActionShow from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CustomActionShow.parse_obj(obj)

        _obj = CustomActionShow.parse_obj({
            "data": CustomAction.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
