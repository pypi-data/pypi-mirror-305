...
class ClioPaymentsPaymentList(BaseModel):
    ...
    """
    data: conlist(ClioPaymentsPayment) = Field(default=..., description="ClioPaymentsPayment List Response")
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ClioPaymentsPaymentList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ClioPaymentsPaymentList:
        """Create an instance of ClioPaymentsPaymentList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ClioPaymentsPaymentList.parse_obj(obj)

        _obj = ClioPaymentsPaymentList.parse_obj({
            "data": [ClioPaymentsPayment.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
