...
class DocumentAutomationShow(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DocumentAutomationShow:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DocumentAutomationShow:
        """Create an instance of DocumentAutomationShow from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DocumentAutomationShow.parse_obj(obj)

        _obj = DocumentAutomationShow.parse_obj({
            "data": DocumentAutomation.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
