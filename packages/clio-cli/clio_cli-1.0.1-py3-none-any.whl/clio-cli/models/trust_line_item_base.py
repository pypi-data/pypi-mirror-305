...
class TrustLineItemBase(BaseModel):
    ...
    __properties = ["id", "etag", "date", "total", "note", "created_at", "updated_at"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TrustLineItemBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TrustLineItemBase:
        """Create an instance of TrustLineItemBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TrustLineItemBase.parse_obj(obj)

        _obj = TrustLineItemBase.parse_obj({
            "id": obj.get("id"),
            "etag": obj.get("etag"),
