...
class NoteShow(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NoteShow:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NoteShow:
        """Create an instance of NoteShow from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NoteShow.parse_obj(obj)

        _obj = NoteShow.parse_obj({
            "data": Note.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
