...
class BillThemeList(BaseModel):
    ...
    BillThemeList
    """
    data: conlist(BillTheme) = Field(default=..., description="BillTheme List Response")
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BillThemeList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BillThemeList:
        """Create an instance of BillThemeList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BillThemeList.parse_obj(obj)

        _obj = BillThemeList.parse_obj({
            "data": [BillTheme.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
