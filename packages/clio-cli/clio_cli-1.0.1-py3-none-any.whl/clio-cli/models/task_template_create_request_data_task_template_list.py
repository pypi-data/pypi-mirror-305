...
class TaskTemplateCreateRequestDataTaskTemplateList(BaseModel):
    """
    TaskTemplateCreateRequestDataTaskTemplateList
    """
    id: Optional[StrictInt] = Field(default=None, description="The unique identifier for a single TaskTemplateList associated with the TaskTemplate. The keyword `null` is not valid for this field.")
    __properties = ["id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TaskTemplateCreateRequestDataTaskTemplateList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TaskTemplateCreateRequestDataTaskTemplateList:
        """Create an instance of TaskTemplateCreateRequestDataTaskTemplateList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TaskTemplateCreateRequestDataTaskTemplateList.parse_obj(obj)

        _obj = TaskTemplateCreateRequestDataTaskTemplateList.parse_obj({
            "id": obj.get("id")
        })
        return _obj
