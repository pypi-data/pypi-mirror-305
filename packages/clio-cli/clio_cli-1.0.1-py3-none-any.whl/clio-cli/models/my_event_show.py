...
class MyEventShow(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MyEventShow:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MyEventShow:
        """Create an instance of MyEventShow from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MyEventShow.parse_obj(obj)

        _obj = MyEventShow.parse_obj({
            "data": MyEvent.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
