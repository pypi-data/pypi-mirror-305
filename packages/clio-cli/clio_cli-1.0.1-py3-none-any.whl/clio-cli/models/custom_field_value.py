...
class CustomFieldValue(BaseModel):
    ...
    CustomFieldValue
    """
    id: Optional[StrictStr] = Field(default=None, description="Unique identifier for the *CustomFieldValue*")
    etag: Optional[StrictStr] = Field(default=None, description="ETag for the *CustomFieldValue*")
    field_name: Optional[StrictStr] = Field(default=None, description="The name of the custom field")
    created_at: Optional[datetime] = Field(default=None, description="The time the *CustomFieldValue* was created (as a ISO-8601 timestamp)")
    updated_at: Optional[datetime] = Field(default=None, description="The time the *CustomFieldValue* was last updated (as a ISO-8601 timestamp)")
    field_type: Optional[StrictStr] = Field(default=None, description="The type of the *CustomFieldValue*")
    field_required: Optional[StrictBool] = Field(default=None, description="Whether the *CustomFieldValue* requires a value")
    field_displayed: Optional[StrictBool] = Field(default=None, description="Whether the *CustomFieldValue* is displayed by default")
    field_display_order: Optional[StrictInt] = Field(default=None, description="The display position of the *CustomFieldValue*")
    value: Optional[StrictStr] = Field(default=None, description="The value of the *CustomFieldValue*")
    soft_deleted: Optional[StrictBool] = Field(default=None, description="Whether the value is associated with a deleted custom field")
    custom_field: Optional[CustomField] = None
    picklist_option: Optional[PicklistOption] = None
    matter: Optional[CustomFieldMatterSelectionBase] = None
    contact: Optional[ContactBase] = None
    __properties = ["id", "etag", "field_name", "created_at", "updated_at", "field_type", "field_required", "field_displayed", "field_display_order", "value", "soft_deleted", "custom_field", "picklist_option", "matter", "contact"]
    ...
    def field_type_validate_enum(cls, value):
        ...
        if value not in ('checkbox', 'contact', 'currency', 'date', 'time', 'email', 'matter', 'numeric', 'picklist', 'text_area', 'text_line', 'url'):
            raise ValueError("must be one of enum values ('checkbox', 'contact', 'currency', 'date', 'time', 'email', 'matter', 'numeric', 'picklist', 'text_area', 'text_line', 'url')")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CustomFieldValue:
    ...
    def to_dict(self):
        ...
        # override the default output from pydantic by calling `to_dict()` of picklist_option
        if self.picklist_option:
            _dict['picklist_option'] = self.picklist_option.to_dict()
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CustomFieldValue:
        """Create an instance of CustomFieldValue from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CustomFieldValue.parse_obj(obj)

        _obj = CustomFieldValue.parse_obj({
            "id": obj.get("id"),
            "etag": obj.get("etag"),
            ...
            "field_required": obj.get("field_required"),
            "field_displayed": obj.get("field_displayed"),
            "field_display_order": obj.get("field_display_order"),
            "value": obj.get("value"),
            "soft_deleted": obj.get("soft_deleted"),
            "custom_field": CustomField.from_dict(obj.get("custom_field")) if obj.get("custom_field") is not None else None,
            "picklist_option": PicklistOption.from_dict(obj.get("picklist_option")) if obj.get("picklist_option") is not None else None,
            "matter": CustomFieldMatterSelectionBase.from_dict(obj.get("matter")) if obj.get("matter") is not None else None,
