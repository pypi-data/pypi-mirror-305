...
class ConversationMessageList(BaseModel):
    ...
    """
    data: conlist(ConversationMessage) = Field(default=..., description="ConversationMessage List Response")
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ConversationMessageList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ConversationMessageList:
        """Create an instance of ConversationMessageList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ConversationMessageList.parse_obj(obj)

        _obj = ConversationMessageList.parse_obj({
            "data": [ConversationMessage.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
