...
class Note(BaseModel):
    ...
    var_date: Optional[date] = Field(default=None, alias="date", description="The date the *Note* is for (as a ISO-8601 date)")
    ...
    __properties = ["id", "etag", "type", "subject", "detail", "date", "created_at", "updated_at", "time_entries_count", "matter", "contact", "author", "time_entries", "notification_event_subscribers"]
    ...
    def from_dict(cls, obj: dict) -> Note:
        ...
        _obj = Note.parse_obj({
            ...
            "author": UserBase.from_dict(obj.get("author")) if obj.get("author") is not None else None,
