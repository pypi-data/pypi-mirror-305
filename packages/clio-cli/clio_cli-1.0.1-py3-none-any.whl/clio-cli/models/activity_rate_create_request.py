...
class ActivityRateCreateRequest(BaseModel):
    """
    ActivityRateCreateRequest
    """
    data: ActivityRateCreateRequestData = Field(...)
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ActivityRateCreateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ActivityRateCreateRequest:
        """Create an instance of ActivityRateCreateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ActivityRateCreateRequest.parse_obj(obj)

        _obj = ActivityRateCreateRequest.parse_obj({
            "data": ActivityRateCreateRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
