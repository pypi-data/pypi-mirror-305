...
class ReportScheduleShow(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ReportScheduleShow:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ReportScheduleShow:
        """Create an instance of ReportScheduleShow from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ReportScheduleShow.parse_obj(obj)

        _obj = ReportScheduleShow.parse_obj({
            "data": ReportSchedule.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
