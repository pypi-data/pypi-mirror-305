...
class ActivityUpdateRequest(BaseModel):
    ...
    """
    data: ActivityUpdateRequestData = Field(...)
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ActivityUpdateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ActivityUpdateRequest:
        """Create an instance of ActivityUpdateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ActivityUpdateRequest.parse_obj(obj)

        _obj = ActivityUpdateRequest.parse_obj({
            "data": ActivityUpdateRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
