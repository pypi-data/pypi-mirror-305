...
class MedicalBillShow(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MedicalBillShow:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MedicalBillShow:
        """Create an instance of MedicalBillShow from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MedicalBillShow.parse_obj(obj)

        _obj = MedicalBillShow.parse_obj({
            "data": MedicalBill.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
