...
class CustomFieldSetList(BaseModel):
    ...
    CustomFieldSetList
    """
    data: conlist(CustomFieldSet) = Field(default=..., description="CustomFieldSet List Response")
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CustomFieldSetList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CustomFieldSetList:
        """Create an instance of CustomFieldSetList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CustomFieldSetList.parse_obj(obj)

        _obj = CustomFieldSetList.parse_obj({
            "data": [CustomFieldSet.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
