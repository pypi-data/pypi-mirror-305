...
class FolderCreateRequestData(BaseModel):
    ...
    external_properties: Optional[conlist(FolderCreateRequestDataExternalPropertiesInner)] = None
    name: StrictStr = Field(default=..., description="Name of the Folder")
    parent: FolderCreateRequestDataParent = Field(...)
    restore: Optional[StrictBool] = Field(default=None, description="Whether or not a trashed Folder should be restored.")
    __properties = ["document_category", "external_properties", "name", "parent", "restore"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FolderCreateRequestData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FolderCreateRequestData:
        """Create an instance of FolderCreateRequestData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FolderCreateRequestData.parse_obj(obj)

        _obj = FolderCreateRequestData.parse_obj({
            "document_category": FolderCreateRequestDataDocumentCategory.from_dict(obj.get("document_category")) if obj.get("document_category") is not None else None,
            "external_properties": [FolderCreateRequestDataExternalPropertiesInner.from_dict(_item) for _item in obj.get("external_properties")] if obj.get("external_properties") is not None else None,
            "name": obj.get("name"),
            "parent": FolderCreateRequestDataParent.from_dict(obj.get("parent")) if obj.get("parent") is not None else None,
