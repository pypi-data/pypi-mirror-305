...
class LaukCivilCertificatedRateList(BaseModel):
    ...
    """
    data: conlist(LaukCivilCertificatedRate) = Field(default=..., description="LaukCivilCertificatedRate List Response")
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LaukCivilCertificatedRateList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LaukCivilCertificatedRateList:
        """Create an instance of LaukCivilCertificatedRateList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LaukCivilCertificatedRateList.parse_obj(obj)

        _obj = LaukCivilCertificatedRateList.parse_obj({
            "data": [LaukCivilCertificatedRate.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
