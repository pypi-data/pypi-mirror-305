...
class DocumentCopyRequestDataDocumentCategory(BaseModel):
    """
    DocumentCopyRequestDataDocumentCategory
    """
    id: Optional[StrictInt] = Field(default=None, description="The unique identifier for a single DocumentCategory associated with the Document. Use the keyword `null` to specify no association.")
    __properties = ["id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DocumentCopyRequestDataDocumentCategory:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DocumentCopyRequestDataDocumentCategory:
        """Create an instance of DocumentCopyRequestDataDocumentCategory from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DocumentCopyRequestDataDocumentCategory.parse_obj(obj)

        _obj = DocumentCopyRequestDataDocumentCategory.parse_obj({
            "id": obj.get("id")
        })
        return _obj
