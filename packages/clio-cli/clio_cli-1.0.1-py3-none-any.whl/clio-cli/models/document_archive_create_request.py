...
class DocumentArchiveCreateRequest(BaseModel):
    """
    DocumentArchiveCreateRequest
    """
    data: DocumentArchiveCreateRequestData = Field(...)
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DocumentArchiveCreateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DocumentArchiveCreateRequest:
        """Create an instance of DocumentArchiveCreateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DocumentArchiveCreateRequest.parse_obj(obj)

        _obj = DocumentArchiveCreateRequest.parse_obj({
            "data": DocumentArchiveCreateRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
