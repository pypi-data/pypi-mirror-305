...
class ConversationMessageCreateRequestDataAttachment(BaseModel):
    """
    ConversationMessageCreateRequestDataAttachment
    """
    document_id: Optional[StrictInt] = Field(default=None, description="The document id of the attached document.")
    document_version_id: Optional[StrictInt] = Field(default=None, description="The document version id of the attached document.")
    __properties = ["document_id", "document_version_id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ConversationMessageCreateRequestDataAttachment:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ConversationMessageCreateRequestDataAttachment:
        """Create an instance of ConversationMessageCreateRequestDataAttachment from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ConversationMessageCreateRequestDataAttachment.parse_obj(obj)

        _obj = ConversationMessageCreateRequestDataAttachment.parse_obj({
