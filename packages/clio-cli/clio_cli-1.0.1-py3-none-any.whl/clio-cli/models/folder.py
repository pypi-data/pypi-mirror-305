...
class Folder(BaseModel):
    ...
    __properties = ["id", "etag", "created_at", "updated_at", "deleted_at", "type", "locked", "name", "root", "parent", "matter", "contact", "document_category", "creator", "latest_document_version", "group", "external_properties"]
