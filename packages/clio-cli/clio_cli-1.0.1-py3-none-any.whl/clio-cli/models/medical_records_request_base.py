...
class MedicalRecordsRequestBase(BaseModel):
    ...
    __properties = ["id", "etag", "bills_follow_up_date", "bills_request_date", "bills_status", "description", "in_treatment", "records_follow_up_date", "records_request_date", "records_status", "treatment_end_date", "treatment_start_date", "created_at", "updated_at"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MedicalRecordsRequestBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MedicalRecordsRequestBase:
        """Create an instance of MedicalRecordsRequestBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MedicalRecordsRequestBase.parse_obj(obj)

        _obj = MedicalRecordsRequestBase.parse_obj({
            "id": obj.get("id"),
            "etag": obj.get("etag"),
