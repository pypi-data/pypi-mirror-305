...
class ReportScheduleCreateRequest(BaseModel):
    ...
    """
    data: ReportScheduleCreateRequestData = Field(...)
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ReportScheduleCreateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ReportScheduleCreateRequest:
        """Create an instance of ReportScheduleCreateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ReportScheduleCreateRequest.parse_obj(obj)

        _obj = ReportScheduleCreateRequest.parse_obj({
            "data": ReportScheduleCreateRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
