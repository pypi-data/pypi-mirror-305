...
class ContactUpdateRequestDataAddressesInner(BaseModel):
    """
    ...
    destroy: Optional[StrictBool] = Field(default=None, alias="_destroy", description="The destroy flag. If the flag is set to `true` and the unique identifier of the associated Address is present, the Address is deleted from the Contact.")
    __properties = ["name", "street", "city", "province", "postal_code", "country", "id", "_destroy"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ContactUpdateRequestDataAddressesInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ContactUpdateRequestDataAddressesInner:
        """Create an instance of ContactUpdateRequestDataAddressesInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ContactUpdateRequestDataAddressesInner.parse_obj(obj)

        _obj = ContactUpdateRequestDataAddressesInner.parse_obj({
