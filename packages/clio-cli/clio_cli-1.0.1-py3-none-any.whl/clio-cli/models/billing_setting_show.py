...
class BillingSettingShow(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BillingSettingShow:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BillingSettingShow:
        """Create an instance of BillingSettingShow from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BillingSettingShow.parse_obj(obj)

        _obj = BillingSettingShow.parse_obj({
            "data": BillingSetting.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
