...
class FolderCreateRequest(BaseModel):
    ...
    FolderCreateRequest
    """
    data: FolderCreateRequestData = Field(...)
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FolderCreateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FolderCreateRequest:
        """Create an instance of FolderCreateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FolderCreateRequest.parse_obj(obj)

        _obj = FolderCreateRequest.parse_obj({
            "data": FolderCreateRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
