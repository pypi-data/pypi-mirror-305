...
class ConversationMessageShow(BaseModel):
    ...
    """
    data: ConversationMessage = Field(...)
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ConversationMessageShow:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ConversationMessageShow:
        """Create an instance of ConversationMessageShow from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ConversationMessageShow.parse_obj(obj)

        _obj = ConversationMessageShow.parse_obj({
            "data": ConversationMessage.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
