...
class BillThemeUpdateRequest(BaseModel):
    """
    BillThemeUpdateRequest
    """
    data: BillThemeUpdateRequestData = Field(...)
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BillThemeUpdateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BillThemeUpdateRequest:
        """Create an instance of BillThemeUpdateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BillThemeUpdateRequest.parse_obj(obj)

        _obj = BillThemeUpdateRequest.parse_obj({
            "data": BillThemeUpdateRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
