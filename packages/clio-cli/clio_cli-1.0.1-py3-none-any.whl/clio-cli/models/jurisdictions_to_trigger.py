...
class JurisdictionsToTrigger(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> JurisdictionsToTrigger:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> JurisdictionsToTrigger:
        """Create an instance of JurisdictionsToTrigger from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return JurisdictionsToTrigger.parse_obj(obj)

        _obj = JurisdictionsToTrigger.parse_obj({
            "id": obj.get("id"),
            "etag": obj.get("etag"),
