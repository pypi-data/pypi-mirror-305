...
class AttendeeBase(BaseModel):
    ...
    AttendeeBase
    """
    id: Optional[StrictInt] = Field(default=None, description="Unique identifier for the *Attendee*")
    etag: Optional[StrictStr] = Field(default=None, description="ETag for the *Attendee*")
    type: Optional[StrictStr] = Field(default=None, description="The class name of the *Attendee*")
    name: Optional[StrictStr] = Field(default=None, description="The name of the *Attendee*")
    enabled: Optional[StrictBool] = Field(default=None, description="If the Attendee is a user, represents whether the user is enabled or disabled. Returns null if attendee is a Contact.")
    email: Optional[StrictStr] = Field(default=None, description="If the Attendee is a User, this is the User's email. If the Attendee is a contact, this is the Contact's primary email address.")
    created_at: Optional[datetime] = Field(default=None, description="The time the *Attendee* was created (as a ISO-8601 timestamp)")
    updated_at: Optional[datetime] = Field(default=None, description="The time the *Attendee* was last updated (as a ISO-8601 timestamp)")
    __properties = ["id", "etag", "type", "name", "enabled", "email", "created_at", "updated_at"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in ('Contact', 'Calendar'):
            raise ValueError("must be one of enum values ('Contact', 'Calendar')")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AttendeeBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AttendeeBase:
        """Create an instance of AttendeeBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AttendeeBase.parse_obj(obj)

        _obj = AttendeeBase.parse_obj({
            "id": obj.get("id"),
            "etag": obj.get("etag"),
            "type": obj.get("type"),
            "name": obj.get("name"),
