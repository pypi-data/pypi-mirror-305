...
class MatterCreateRequestDataOriginatingAttorney(BaseModel):
    """
    MatterCreateRequestDataOriginatingAttorney
    """
    id: Optional[StrictInt] = Field(default=None, description="The unique identifier for a single User associated with the Matter. The keyword `null` is not valid for this field.")
    __properties = ["id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MatterCreateRequestDataOriginatingAttorney:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MatterCreateRequestDataOriginatingAttorney:
        """Create an instance of MatterCreateRequestDataOriginatingAttorney from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MatterCreateRequestDataOriginatingAttorney.parse_obj(obj)

        _obj = MatterCreateRequestDataOriginatingAttorney.parse_obj({
            "id": obj.get("id")
        })
        return _obj
