...
class MatterBalanceBase(BaseModel):
    ...
    MatterBalanceBase
    """
    id: Optional[StrictInt] = Field(default=None, description="Unique identifier for the *MatterBalance*")
    amount: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The amount of balance of a matter.")
    __properties = ["id", "amount"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MatterBalanceBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MatterBalanceBase:
        """Create an instance of MatterBalanceBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MatterBalanceBase.parse_obj(obj)

        _obj = MatterBalanceBase.parse_obj({
            "id": obj.get("id"),
