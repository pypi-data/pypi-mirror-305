...
class ActivityDescriptionBase(BaseModel):
    ...
    __properties = ["id", "etag", "name", "visible_to_co_counsel", "created_at", "updated_at", "default", "type", "utbms_activity_id", "utbms_task_name", "utbms_task_id", "xero_service_code", "accessible_to_user", "category_type"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ActivityDescriptionBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ActivityDescriptionBase:
        """Create an instance of ActivityDescriptionBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ActivityDescriptionBase.parse_obj(obj)

        _obj = ActivityDescriptionBase.parse_obj({
            "id": obj.get("id"),
            "etag": obj.get("etag"),
            "name": obj.get("name"),
