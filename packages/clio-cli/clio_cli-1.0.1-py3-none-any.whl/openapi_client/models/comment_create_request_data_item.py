...
class CommentCreateRequestDataItem(BaseModel):
    """
    CommentCreateRequestDataItem
    """
    id: StrictInt = Field(default=..., description="The unique identifier of the Document or Folder to which the Comment is associated.")
    __properties = ["id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CommentCreateRequestDataItem:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CommentCreateRequestDataItem:
        """Create an instance of CommentCreateRequestDataItem from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CommentCreateRequestDataItem.parse_obj(obj)

        _obj = CommentCreateRequestDataItem.parse_obj({
            "id": obj.get("id")
        })
        return _obj
