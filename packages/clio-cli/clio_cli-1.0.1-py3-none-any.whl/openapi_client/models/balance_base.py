...
class BalanceBase(BaseModel):
    ...
    BalanceBase
    """
    id: Optional[StrictInt] = Field(default=None, description="Unique identifier for the *Balance*")
    amount: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The amount for this Balance.")
    type: Optional[StrictStr] = Field(default=None, description="The type of Balance this data is for.")
    interest_amount: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The interest amount for this Balance.")
    due: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The amount due for this Balance, factoring in applicable discounts.")
    __properties = ["id", "amount", "type", "interest_amount", "due"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in ('Matter', 'Client'):
            raise ValueError("must be one of enum values ('Matter', 'Client')")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BalanceBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BalanceBase:
        """Create an instance of BalanceBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BalanceBase.parse_obj(obj)

        _obj = BalanceBase.parse_obj({
            "id": obj.get("id"),
