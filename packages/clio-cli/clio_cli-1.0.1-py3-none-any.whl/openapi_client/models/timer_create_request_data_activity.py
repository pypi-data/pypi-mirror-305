...
class TimerCreateRequestDataActivity(BaseModel):
    """
    TimerCreateRequestDataActivity
    """
    id: StrictInt = Field(default=..., description="The unique identifier for a single Activity associated with the Timer. The keyword `null` is not valid for this field.")
    __properties = ["id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TimerCreateRequestDataActivity:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TimerCreateRequestDataActivity:
        """Create an instance of TimerCreateRequestDataActivity from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TimerCreateRequestDataActivity.parse_obj(obj)

        _obj = TimerCreateRequestDataActivity.parse_obj({
            "id": obj.get("id")
        })
        return _obj
