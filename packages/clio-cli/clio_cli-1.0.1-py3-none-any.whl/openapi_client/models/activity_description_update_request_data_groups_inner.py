...
class ActivityDescriptionUpdateRequestDataGroupsInner(BaseModel):
    """
    ActivityDescriptionUpdateRequestDataGroupsInner
    """
    id: Optional[StrictInt] = Field(default=None, description="The unique identifier for a single Group associated with the ActivityDescription. The keyword `null` is not valid for this field.")
    deleted: Optional[StrictBool] = Field(default=None, alias="_deleted", description="A flag to determine if this Group should lose access to this ActivityDescription.")
    __properties = ["id", "_deleted"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ActivityDescriptionUpdateRequestDataGroupsInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ActivityDescriptionUpdateRequestDataGroupsInner:
        """Create an instance of ActivityDescriptionUpdateRequestDataGroupsInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ActivityDescriptionUpdateRequestDataGroupsInner.parse_obj(obj)

        _obj = ActivityDescriptionUpdateRequestDataGroupsInner.parse_obj({
            "id": obj.get("id"),
