...
class MedicalRecordsRequestCreateRequestDataMedicalBillsInnerPayersInner(BaseModel):
    """
    MedicalRecordsRequestCreateRequestDataMedicalBillsInnerPayersInner
    """
    amount: Union[StrictFloat, StrictInt] = Field(default=..., description="Lien amount.")
    holder_id: StrictInt = Field(default=..., description="The unique identifier for a single Damage associated with the MedicalRecordsRequest. The keyword `null` is not valid for this field.")
    mark_as_lien: StrictBool = Field(default=..., description="Mark record as Lien.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MedicalRecordsRequestCreateRequestDataMedicalBillsInnerPayersInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MedicalRecordsRequestCreateRequestDataMedicalBillsInnerPayersInner:
        """Create an instance of MedicalRecordsRequestCreateRequestDataMedicalBillsInnerPayersInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MedicalRecordsRequestCreateRequestDataMedicalBillsInnerPayersInner.parse_obj(obj)

        _obj = MedicalRecordsRequestCreateRequestDataMedicalBillsInnerPayersInner.parse_obj({
