...
class LegalAidUkActivityBase(BaseModel):
    ...
    __properties = ["activity_sub_category", "advocacy", "base_rate", "bolt_ons", "bolt_ons_summary", "court", "eligible_for_sqm", "expert", "form_of_civil_legal_service", "id", "is_custom_rate", "json_key", "region", "tax_exclusive", "uplift", "user_type"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LegalAidUkActivityBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LegalAidUkActivityBase:
        """Create an instance of LegalAidUkActivityBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LegalAidUkActivityBase.parse_obj(obj)

        _obj = LegalAidUkActivityBase.parse_obj({
            "activity_sub_category": obj.get("activity_sub_category"),
            "advocacy": obj.get("advocacy"),
            "base_rate": obj.get("base_rate"),
            "bolt_ons": obj.get("bolt_ons"),
            "bolt_ons_summary": obj.get("bolt_ons_summary"),
            "court": obj.get("court"),
            "eligible_for_sqm": obj.get("eligible_for_sqm"),
            "expert": obj.get("expert"),
            "form_of_civil_legal_service": obj.get("form_of_civil_legal_service"),
            "id": obj.get("id"),
            "is_custom_rate": obj.get("is_custom_rate"),
            "json_key": obj.get("json_key"),
            "region": obj.get("region"),
            "tax_exclusive": obj.get("tax_exclusive"),
