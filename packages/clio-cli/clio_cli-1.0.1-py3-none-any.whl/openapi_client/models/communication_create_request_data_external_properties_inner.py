...
class CommunicationCreateRequestDataExternalPropertiesInner(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CommunicationCreateRequestDataExternalPropertiesInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CommunicationCreateRequestDataExternalPropertiesInner:
        """Create an instance of CommunicationCreateRequestDataExternalPropertiesInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CommunicationCreateRequestDataExternalPropertiesInner.parse_obj(obj)

        _obj = CommunicationCreateRequestDataExternalPropertiesInner.parse_obj({
            "name": obj.get("name"),
            "value": obj.get("value")
        })
        return _obj
