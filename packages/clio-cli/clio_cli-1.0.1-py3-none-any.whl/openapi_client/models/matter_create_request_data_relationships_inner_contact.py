...
class MatterCreateRequestDataRelationshipsInnerContact(BaseModel):
    """
    MatterCreateRequestDataRelationshipsInnerContact
    """
    id: StrictInt = Field(default=..., description="The unique identifier for a single Contact associated with the Relationship. The keyword `null` is not valid for this field.")
    __properties = ["id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MatterCreateRequestDataRelationshipsInnerContact:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MatterCreateRequestDataRelationshipsInnerContact:
        """Create an instance of MatterCreateRequestDataRelationshipsInnerContact from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MatterCreateRequestDataRelationshipsInnerContact.parse_obj(obj)

        _obj = MatterCreateRequestDataRelationshipsInnerContact.parse_obj({
            "id": obj.get("id")
        })
        return _obj
