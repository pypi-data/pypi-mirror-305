...
class ContactCreateRequestDataWebSitesInner(BaseModel):
    """
    ...
    __properties = ["name", "address", "default_web_site"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ContactCreateRequestDataWebSitesInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ContactCreateRequestDataWebSitesInner:
        """Create an instance of ContactCreateRequestDataWebSitesInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ContactCreateRequestDataWebSitesInner.parse_obj(obj)

        _obj = ContactCreateRequestDataWebSitesInner.parse_obj({
