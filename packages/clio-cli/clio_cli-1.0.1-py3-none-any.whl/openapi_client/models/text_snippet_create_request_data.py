...
class TextSnippetCreateRequestData(BaseModel):
    """
    TextSnippetCreateRequestData
    """
    phrase: StrictStr = Field(default=..., description="The phrase expanded to from a TextSnippet.")
    snippet: StrictStr = Field(default=..., description="The abbreviation that expands to a phrase.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TextSnippetCreateRequestData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TextSnippetCreateRequestData:
        """Create an instance of TextSnippetCreateRequestData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TextSnippetCreateRequestData.parse_obj(obj)

        _obj = TextSnippetCreateRequestData.parse_obj({
