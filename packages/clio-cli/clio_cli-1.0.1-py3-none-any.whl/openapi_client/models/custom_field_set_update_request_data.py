...
class CustomFieldSetUpdateRequestData(BaseModel):
    """
    ...
    name: Optional[StrictStr] = Field(default=None, description="CustomFieldSet name.")
    parent_type: Optional[StrictStr] = Field(default=None, description="Type of object the CustomFieldSet is for.")
    __properties = ["displayed", "name", "parent_type"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CustomFieldSetUpdateRequestData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CustomFieldSetUpdateRequestData:
        """Create an instance of CustomFieldSetUpdateRequestData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CustomFieldSetUpdateRequestData.parse_obj(obj)

        _obj = CustomFieldSetUpdateRequestData.parse_obj({
