...
class LaukCivilControlledRateBase(BaseModel):
    ...
    __properties = ["id", "activity", "activity_type", "category_of_law", "created_at", "etag", "exceptional", "fee", "fee_scheme", "key", "rate_type", "region", "updated_at"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LaukCivilControlledRateBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LaukCivilControlledRateBase:
        """Create an instance of LaukCivilControlledRateBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LaukCivilControlledRateBase.parse_obj(obj)

        _obj = LaukCivilControlledRateBase.parse_obj({
            "id": obj.get("id"),
