...
class BillThemeBase(BaseModel):
    ...
    BillThemeBase
    """
    id: Optional[StrictInt] = Field(default=None, description="Unique identifier for the *BillTheme*")
    etag: Optional[StrictStr] = Field(default=None, description="ETag for the *BillTheme*")
    created_at: Optional[datetime] = Field(default=None, description="The time the *BillTheme* was created (as a ISO-8601 timestamp)")
    updated_at: Optional[datetime] = Field(default=None, description="The time the *BillTheme* was last updated (as a ISO-8601 timestamp)")
    account_id: Optional[StrictInt] = Field(default=None, description="The account number the *BillTheme* belongs to")
    default: Optional[StrictBool] = Field(default=None, description="Whether the *BillTheme* is the default for its account")
    name: Optional[StrictStr] = Field(default=None, description="The name of the *BillTheme*")
    config: Optional[StrictStr] = Field(default=None, description="The configuration of the *BillTheme*")
    __properties = ["id", "etag", "created_at", "updated_at", "account_id", "default", "name", "config"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BillThemeBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BillThemeBase:
        """Create an instance of BillThemeBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BillThemeBase.parse_obj(obj)

        _obj = BillThemeBase.parse_obj({
            "id": obj.get("id"),
            "etag": obj.get("etag"),
