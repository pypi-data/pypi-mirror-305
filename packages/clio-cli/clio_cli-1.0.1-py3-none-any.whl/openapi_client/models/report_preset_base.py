...
class ReportPresetBase(BaseModel):
    ...
    __properties = ["id", "etag", "name", "kind", "format", "last_generated_at", "created_at", "updated_at", "category", "options"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ReportPresetBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ReportPresetBase:
        """Create an instance of ReportPresetBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ReportPresetBase.parse_obj(obj)

        _obj = ReportPresetBase.parse_obj({
            "id": obj.get("id"),
            "etag": obj.get("etag"),
            "name": obj.get("name"),
            "kind": obj.get("kind"),
