...
class CalendarBase(BaseModel):
    ...
    __properties = ["id", "etag", "color", "light_color", "court_rules_default_calendar", "name", "permission", "type", "visible", "created_at", "updated_at", "source"]
    ...
    def light_color_validate_enum(cls, value):
        ...
        if value not in ('#5DA5C7', '#F95957', '#209412', '#FF7715', '#DE649D', '#FF6B02', '#56C4FC', '#00B177', '#50D19B', '#F14A8C', '#A3A2A2', '#84AB3B', '#B091EE', '#BD9E69', '#F2A000', '#00A5CA', '#CB5A3D', '#959CD0', '#B0B0B0', '#7BA6CD'):
    ...
    def permission_validate_enum(cls, value):
        ...
        if value not in ('owner', 'editor', 'viewer', 'limited_viewer', 'none'):
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in ('AccountCalendar', 'AdhocCalendar', 'UserCalendar'):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CalendarBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CalendarBase:
        """Create an instance of CalendarBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CalendarBase.parse_obj(obj)

        _obj = CalendarBase.parse_obj({
            "id": obj.get("id"),
            "etag": obj.get("etag"),
            "color": obj.get("color"),
