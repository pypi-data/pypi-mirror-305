...
class ExpenseCategoryCreateRequestDataUtbmsCode(BaseModel):
    """
    ExpenseCategoryCreateRequestDataUtbmsCode
    """
    id: Optional[StrictInt] = Field(default=None, description="The unique identifier for a single UtbmsCode associated with the ExpenseCategory. The keyword `null` is not valid for this field.")
    __properties = ["id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ExpenseCategoryCreateRequestDataUtbmsCode:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ExpenseCategoryCreateRequestDataUtbmsCode:
        """Create an instance of ExpenseCategoryCreateRequestDataUtbmsCode from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ExpenseCategoryCreateRequestDataUtbmsCode.parse_obj(obj)

        _obj = ExpenseCategoryCreateRequestDataUtbmsCode.parse_obj({
            "id": obj.get("id")
        })
        return _obj
