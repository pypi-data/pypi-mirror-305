...
class MatterCreateRequestDataCustomRateRatesInnerUser(BaseModel):
    """
    MatterCreateRequestDataCustomRateRatesInnerUser
    """
    id: StrictInt = Field(default=..., description="The unique identifier for a single User associated with the Rate. The keyword `null` is not valid for this field.")
    __properties = ["id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MatterCreateRequestDataCustomRateRatesInnerUser:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MatterCreateRequestDataCustomRateRatesInnerUser:
        """Create an instance of MatterCreateRequestDataCustomRateRatesInnerUser from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MatterCreateRequestDataCustomRateRatesInnerUser.parse_obj(obj)

        _obj = MatterCreateRequestDataCustomRateRatesInnerUser.parse_obj({
            "id": obj.get("id")
        })
        return _obj
