...
class MatterContactsApi:
    ...
    @validate_arguments
    def matter_contacts_index(self, matter_id : Annotated[StrictInt, Field(..., description="Filters contact data by matter.")], x_api_version : Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None, custom_field_ids : Annotated[Optional[StrictInt], Field(description="IDs of custom fields to include in results.")] = None, fields : Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None, limit : Annotated[Optional[StrictInt], Field(description="A limit on the number of MatterContacts records to be returned. Limit can range between 1 and 200. Default: `200`.")] = None, order : Annotated[Optional[StrictStr], Field(description="Orders the MatterContacts records by the given field. Note that `id` is ordered by the `id` of the nested Relationship record. Default: `is_client(asc)`.")] = None, page_token : Annotated[Optional[StrictStr], Field(description="A token specifying which page to return.")] = None, **kwargs) -> MatterContactsList:  # noqa: E501
        """Return the related contact data for a single matter  # noqa: E501

        Outlines the parameters, optional and required, used when requesting the data for all MatterContacts  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.matter_contacts_index(matter_id, x_api_version, custom_field_ids, fields, limit, order, page_token, async_req=True)
        >>> result = thread.get()

        :param matter_id: Filters contact data by matter. (required)
        :type matter_id: int
        ...
        :rtype: MatterContactsList
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the matter_contacts_index_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.matter_contacts_index_with_http_info(matter_id, x_api_version, custom_field_ids, fields, limit, order, page_token, **kwargs)  # noqa: E501

    @validate_arguments
    def matter_contacts_index_with_http_info(self, matter_id : Annotated[StrictInt, Field(..., description="Filters contact data by matter.")], x_api_version : Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None, custom_field_ids : Annotated[Optional[StrictInt], Field(description="IDs of custom fields to include in results.")] = None, fields : Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None, limit : Annotated[Optional[StrictInt], Field(description="A limit on the number of MatterContacts records to be returned. Limit can range between 1 and 200. Default: `200`.")] = None, order : Annotated[Optional[StrictStr], Field(description="Orders the MatterContacts records by the given field. Note that `id` is ordered by the `id` of the nested Relationship record. Default: `is_client(asc)`.")] = None, page_token : Annotated[Optional[StrictStr], Field(description="A token specifying which page to return.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Return the related contact data for a single matter  # noqa: E501
        ...
        >>> thread = api.matter_contacts_index_with_http_info(matter_id, x_api_version, custom_field_ids, fields, limit, order, page_token, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(MatterContactsList, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method matter_contacts_index" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _path_params = {}
        if _params['matter_id'] is not None:
            _path_params['matter_id'] = _params['matter_id']
        ...
        return self.api_client.call_api(
            '/matters/{matter_id}/contacts.json', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
