...
class CivilControlledRatesApi:
    ...
    @validate_arguments
    def lauk_civil_controlled_rate_index(self, x_api_version : Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None, activity : Annotated[Optional[StrictStr], Field(description="Filter by activity.")] = None, category_of_law : Annotated[Optional[StrictStr], Field(description="Filter by category of law.")] = None, fields : Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None, key : Annotated[Optional[StrictStr], Field(description="Filter by key.")] = None, limit : Annotated[Optional[StrictInt], Field(description="A limit on the number of LaukCivilControlledRate records to be returned. Limit can range between 1 and 200. Default: `200`.")] = None, page_token : Annotated[Optional[StrictStr], Field(description="A token specifying which page to return.")] = None, rate_type : Annotated[Optional[StrictStr], Field(description="Filter by rate type.")] = None, region : Annotated[Optional[StrictStr], Field(description="Filter by region.")] = None, **kwargs) -> LaukCivilControlledRateList:  # noqa: E501
        """List Civil Controlled Rates  # noqa: E501

        Outlines the parameters, optional and required, used when requesting the data for all LaukCivilControlledRates  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.lauk_civil_controlled_rate_index(x_api_version, activity, category_of_law, fields, key, limit, page_token, rate_type, region, async_req=True)
        >>> result = thread.get()
        ...
        :rtype: LaukCivilControlledRateList
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the lauk_civil_controlled_rate_index_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.lauk_civil_controlled_rate_index_with_http_info(x_api_version, activity, category_of_law, fields, key, limit, page_token, rate_type, region, **kwargs)  # noqa: E501

    @validate_arguments
    def lauk_civil_controlled_rate_index_with_http_info(self, x_api_version : Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None, activity : Annotated[Optional[StrictStr], Field(description="Filter by activity.")] = None, category_of_law : Annotated[Optional[StrictStr], Field(description="Filter by category of law.")] = None, fields : Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None, key : Annotated[Optional[StrictStr], Field(description="Filter by key.")] = None, limit : Annotated[Optional[StrictInt], Field(description="A limit on the number of LaukCivilControlledRate records to be returned. Limit can range between 1 and 200. Default: `200`.")] = None, page_token : Annotated[Optional[StrictStr], Field(description="A token specifying which page to return.")] = None, rate_type : Annotated[Optional[StrictStr], Field(description="Filter by rate type.")] = None, region : Annotated[Optional[StrictStr], Field(description="Filter by region.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """List Civil Controlled Rates  # noqa: E501
        ...
        >>> thread = api.lauk_civil_controlled_rate_index_with_http_info(x_api_version, activity, category_of_law, fields, key, limit, page_token, rate_type, region, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(LaukCivilControlledRateList, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method lauk_civil_controlled_rate_index" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "LaukCivilControlledRateList",
            '400': "Error",
            '401': "Error",
            '403': "Error",
            '429': "Error",
        ...
        return self.api_client.call_api(
            '/lauk_civil_controlled_rates.json', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
