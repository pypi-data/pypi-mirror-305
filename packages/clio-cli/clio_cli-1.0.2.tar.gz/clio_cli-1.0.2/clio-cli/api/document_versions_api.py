...
class DocumentVersionsApi:
    ...
    @validate_arguments
    def document_version_index(self, id : Annotated[StrictInt, Field(..., description="The unique identifier for the DocumentVersion.")], id2 : Annotated[StrictInt, Field(..., description="ID of the Document")], x_api_version : Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None, fields : Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None, fully_uploaded : Annotated[Optional[StrictBool], Field(description="Filter DocumentVersion records to those with the given `fully_uploaded` status.")] = None, limit : Annotated[Optional[StrictInt], Field(description="A limit on the number of DocumentVersion records to be returned. Limit can range between 1 and 200. Default: `200`.")] = None, page_token : Annotated[Optional[StrictStr], Field(description="A token specifying which page to return.")] = None, **kwargs) -> DocumentVersionList:  # noqa: E501
        """Return the data for all DocumentVersions  # noqa: E501

        Outlines the parameters, optional and required, used when requesting the data for all DocumentVersions  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.document_version_index(id, id2, x_api_version, fields, fully_uploaded, limit, page_token, async_req=True)
        >>> result = thread.get()

        :param id: The unique identifier for the DocumentVersion. (required)
        :type id: int
        :param id2: ID of the Document (required)
        :type id2: int
        ...
        :rtype: DocumentVersionList
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the document_version_index_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.document_version_index_with_http_info(id, id2, x_api_version, fields, fully_uploaded, limit, page_token, **kwargs)  # noqa: E501

    @validate_arguments
    def document_version_index_with_http_info(self, id : Annotated[StrictInt, Field(..., description="The unique identifier for the DocumentVersion.")], id2 : Annotated[StrictInt, Field(..., description="ID of the Document")], x_api_version : Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None, fields : Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None, fully_uploaded : Annotated[Optional[StrictBool], Field(description="Filter DocumentVersion records to those with the given `fully_uploaded` status.")] = None, limit : Annotated[Optional[StrictInt], Field(description="A limit on the number of DocumentVersion records to be returned. Limit can range between 1 and 200. Default: `200`.")] = None, page_token : Annotated[Optional[StrictStr], Field(description="A token specifying which page to return.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Return the data for all DocumentVersions  # noqa: E501
        ...
        >>> thread = api.document_version_index_with_http_info(id, id2, x_api_version, fields, fully_uploaded, limit, page_token, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(DocumentVersionList, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method document_version_index" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _path_params = {}
        if _params['id2'] is not None:
            _path_params['id'] = _params['id2']
        ...
        if _params.get('fully_uploaded') is not None:  # noqa: E501
            _query_params.append(('fully_uploaded', _params['fully_uploaded']))
        ...
        return self.api_client.call_api(
            '/documents/{id}/versions.json', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
