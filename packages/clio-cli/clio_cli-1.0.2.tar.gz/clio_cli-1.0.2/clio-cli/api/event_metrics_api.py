...
class EventMetricsApi:
    ...
    @validate_arguments
    def event_metrics_index(self, x_api_version : Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None, fields : Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None, **kwargs) -> EventMetricsShow:  # noqa: E501
        """Unread in-app notification events  # noqa: E501

        Outlines the parameters, optional and required, used when requesting Event Metrics  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.event_metrics_index(x_api_version, fields, async_req=True)
        >>> result = thread.get()
        ...
        :rtype: EventMetricsShow
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the event_metrics_index_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.event_metrics_index_with_http_info(x_api_version, fields, **kwargs)  # noqa: E501

    @validate_arguments
    def event_metrics_index_with_http_info(self, x_api_version : Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None, fields : Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Unread in-app notification events  # noqa: E501
        ...
        >>> thread = api.event_metrics_index_with_http_info(x_api_version, fields, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(EventMetricsShow, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method event_metrics_index" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/internal_notifications/event_metrics.json', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
