...
class MedicalRecordsApi:
    ...
    @validate_arguments
    def medical_record_destroy(self, id : Annotated[StrictInt, Field(..., description="The unique identifier for the MedicalRecord.")], x_api_version : Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None, **kwargs) -> None:  # noqa: E501
        """Destroying a Medical Record  # noqa: E501

        Outlines the parameters, optional and required, used when deleting the record for a single MedicalRecord  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.medical_record_destroy(id, x_api_version, async_req=True)
        >>> result = thread.get()

        :param id: The unique identifier for the MedicalRecord. (required)
        :type id: int
        ...
        if '_preload_content' in kwargs:
            message = "Error! Please call the medical_record_destroy_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.medical_record_destroy_with_http_info(id, x_api_version, **kwargs)  # noqa: E501

    @validate_arguments
    def medical_record_destroy_with_http_info(self, id : Annotated[StrictInt, Field(..., description="The unique identifier for the MedicalRecord.")], x_api_version : Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Destroying a Medical Record  # noqa: E501
        ...
        >>> thread = api.medical_record_destroy_with_http_info(id, x_api_version, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method medical_record_destroy" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/medical_records/{id}.json', 'DELETE',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def medical_record_update(self, id : Annotated[StrictInt, Field(..., description="The unique identifier for the MedicalRecord.")], if_match : Annotated[Optional[StrictStr], Field(description="The server will update the requested resource and send back a 200 status, but only if value in the header matches the existing resource's [ETag](#section/ETags).")] = None, x_api_version : Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None, fields : Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None, medical_record_update_request : Annotated[Optional[MedicalRecordUpdateRequest], Field(description="Request Body for Medical Records")] = None, **kwargs) -> MedicalRecordShow:  # noqa: E501
        """Updating a Medical Record  # noqa: E501

        Outlines the parameters and data fields used when updating a single MedicalRecord  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.medical_record_update(id, if_match, x_api_version, fields, medical_record_update_request, async_req=True)
        >>> result = thread.get()
        ...
        :type fields: str
        :param medical_record_update_request: Request Body for Medical Records
        :type medical_record_update_request: MedicalRecordUpdateRequest
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: timeout setting for this request.
               If one number provided, it will be total request
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: MedicalRecordShow
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the medical_record_update_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.medical_record_update_with_http_info(id, if_match, x_api_version, fields, medical_record_update_request, **kwargs)  # noqa: E501

    @validate_arguments
    def medical_record_update_with_http_info(self, id : Annotated[StrictInt, Field(..., description="The unique identifier for the MedicalRecord.")], if_match : Annotated[Optional[StrictStr], Field(description="The server will update the requested resource and send back a 200 status, but only if value in the header matches the existing resource's [ETag](#section/ETags).")] = None, x_api_version : Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None, fields : Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None, medical_record_update_request : Annotated[Optional[MedicalRecordUpdateRequest], Field(description="Request Body for Medical Records")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Updating a Medical Record  # noqa: E501
        ...
        >>> thread = api.medical_record_update_with_http_info(id, if_match, x_api_version, fields, medical_record_update_request, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(MedicalRecordShow, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method medical_record_update" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        # process the body parameter
        _body_params = None
        if _params['medical_record_update_request'] is not None:
            _body_params = _params['medical_record_update_request']
