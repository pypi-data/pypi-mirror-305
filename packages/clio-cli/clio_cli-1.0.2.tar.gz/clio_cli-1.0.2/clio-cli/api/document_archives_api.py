...
class DocumentArchivesApi:
    ...
    @validate_arguments
    def document_archive_create(self, x_api_version : Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None, fields : Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None, document_archive_create_request : Annotated[Optional[DocumentArchiveCreateRequest], Field(description="Request Body for Document Archives")] = None, **kwargs) -> DocumentArchiveShow:  # noqa: E501
        """Create a new DocumentArchive  # noqa: E501

        Outlines the parameters and data fields used when creating a new DocumentArchive  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.document_archive_create(x_api_version, fields, document_archive_create_request, async_req=True)
        >>> result = thread.get()
        ...
        :type fields: str
        :param document_archive_create_request: Request Body for Document Archives
        :type document_archive_create_request: DocumentArchiveCreateRequest
        ...
        :rtype: DocumentArchiveShow
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the document_archive_create_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.document_archive_create_with_http_info(x_api_version, fields, document_archive_create_request, **kwargs)  # noqa: E501

    @validate_arguments
    def document_archive_create_with_http_info(self, x_api_version : Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None, fields : Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None, document_archive_create_request : Annotated[Optional[DocumentArchiveCreateRequest], Field(description="Request Body for Document Archives")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Create a new DocumentArchive  # noqa: E501
        ...
        >>> thread = api.document_archive_create_with_http_info(x_api_version, fields, document_archive_create_request, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(DocumentArchiveShow, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        _all_params = [
            'x_api_version',
            'fields',
            'document_archive_create_request'
        ]
        _all_params.extend(
            [
                'async_req',
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method document_archive_create" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _body_params = None
        if _params['document_archive_create_request'] is not None:
            _body_params = _params['document_archive_create_request']
    ...
    @validate_arguments
    def document_archive_download(self, id : Annotated[StrictInt, Field(..., description="The unique identifier for the DocumentArchive.")], **kwargs) -> None:  # noqa: E501
        """Download the DocumentArchive  # noqa: E501

        Download the DocumentArchive  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.document_archive_download(id, async_req=True)
        >>> result = thread.get()

        :param id: The unique identifier for the DocumentArchive. (required)
        :type id: int
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: timeout setting for this request.
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the document_archive_download_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.document_archive_download_with_http_info(id, **kwargs)  # noqa: E501

    @validate_arguments
    def document_archive_download_with_http_info(self, id : Annotated[StrictInt, Field(..., description="The unique identifier for the DocumentArchive.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Download the DocumentArchive  # noqa: E501
        ...
        >>> thread = api.document_archive_download_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method document_archive_download" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/document_archives/{id}/download.json', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def document_archive_show(self, id : Annotated[StrictInt, Field(..., description="The unique identifier for the DocumentArchive.")], if_modified_since : Annotated[Optional[date], Field(description="The server will send the requested resource with a 200 status, but only if it has been modified after the given date. (Expects an RFC 2822 timestamp).")] = None, if_none_match : Annotated[Optional[StrictStr], Field(description="The server will send the requested resource with a 200 status, but only if the existing resource's [ETag](#section/ETags) doesn't match any of the values listed.")] = None, x_api_version : Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None, fields : Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None, **kwargs) -> DocumentArchiveShow:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the document_archive_show_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.document_archive_show_with_http_info(id, if_modified_since, if_none_match, x_api_version, fields, **kwargs)  # noqa: E501

    @validate_arguments
    def document_archive_show_with_http_info(self, id : Annotated[StrictInt, Field(..., description="The unique identifier for the DocumentArchive.")], if_modified_since : Annotated[Optional[date], Field(description="The server will send the requested resource with a 200 status, but only if it has been modified after the given date. (Expects an RFC 2822 timestamp).")] = None, if_none_match : Annotated[Optional[StrictStr], Field(description="The server will send the requested resource with a 200 status, but only if the existing resource's [ETag](#section/ETags) doesn't match any of the values listed.")] = None, x_api_version : Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None, fields : Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Return the data for a single DocumentArchive  # noqa: E501
        ...
        >>> thread = api.document_archive_show_with_http_info(id, if_modified_since, if_none_match, x_api_version, fields, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method document_archive_show" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
