...
class MedicalBill(BaseModel):
    ...
    liens: Optional[conlist(LienBase)] = Field(default=None, description="Lien")
    __properties = ["id", "adjustment", "amount", "bill_date", "bill_received_date", "damage_type", "document_id", "etag", "name", "created_at", "updated_at", "matter", "liens"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MedicalBill:
    ...
    def from_dict(cls, obj: dict) -> MedicalBill:
        ...
        _obj = MedicalBill.parse_obj({
            ...
            "liens": [LienBase.from_dict(_item) for _item in obj.get("liens")] if obj.get("liens") is not None else None
        })
        return _obj
