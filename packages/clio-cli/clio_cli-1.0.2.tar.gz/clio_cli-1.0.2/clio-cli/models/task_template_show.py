...
class TaskTemplateShow(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TaskTemplateShow:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TaskTemplateShow:
        """Create an instance of TaskTemplateShow from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TaskTemplateShow.parse_obj(obj)

        _obj = TaskTemplateShow.parse_obj({
            "data": TaskTemplate.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
