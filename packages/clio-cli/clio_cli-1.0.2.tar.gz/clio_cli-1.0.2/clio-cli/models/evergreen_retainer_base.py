...
class EvergreenRetainerBase(BaseModel):
    ...
    """
    id: Optional[StrictInt] = Field(default=None, description="Unique identifier for the *EvergreenRetainer*")
    created_at: Optional[datetime] = Field(default=None, description="The time the *EvergreenRetainer* was created (as a ISO-8601 timestamp)")
    updated_at: Optional[datetime] = Field(default=None, description="The time the *EvergreenRetainer* was last updated (as a ISO-8601 timestamp)")
    etag: Optional[StrictStr] = Field(default=None, description="ETag for the *EvergreenRetainer*")
    minimum_threshold: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The trust balance threshold for the associated Matter. When the balance falls below the threshold, the retainer's associated recipients (firm users) will receive a notification.")
    __properties = ["id", "created_at", "updated_at", "etag", "minimum_threshold"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EvergreenRetainerBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EvergreenRetainerBase:
        """Create an instance of EvergreenRetainerBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EvergreenRetainerBase.parse_obj(obj)

        _obj = EvergreenRetainerBase.parse_obj({
            "id": obj.get("id"),
            "created_at": obj.get("created_at"),
            "updated_at": obj.get("updated_at"),
            "etag": obj.get("etag"),
            "minimum_threshold": obj.get("minimum_threshold")
        })
        return _obj
