...
class BillRecipient(BaseModel):
    ...
    BillRecipient
    """
    created_at: Optional[datetime] = Field(default=None, description="The time the *BillRecipient* was created (as a ISO-8601 timestamp)")
    etag: Optional[StrictStr] = Field(default=None, description="ETag for the *BillRecipient*")
    id: Optional[StrictInt] = Field(default=None, description="Unique identifier for the *BillRecipient*")
    on_all_matters: Optional[StrictBool] = Field(default=None, description="If the associated contact is a recipient for all of the bill's matters")
    updated_at: Optional[datetime] = Field(default=None, description="The time the *BillRecipient* was updated (as a ISO-8601 timestamp)")
    recipient: Optional[BillRecipientContactBase] = None
    __properties = ["created_at", "etag", "id", "on_all_matters", "updated_at", "recipient"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BillRecipient:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BillRecipient:
        """Create an instance of BillRecipient from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BillRecipient.parse_obj(obj)

        _obj = BillRecipient.parse_obj({
            "created_at": obj.get("created_at"),
            "etag": obj.get("etag"),
            "id": obj.get("id"),
            "on_all_matters": obj.get("on_all_matters"),
            "updated_at": obj.get("updated_at"),
            "recipient": BillRecipientContactBase.from_dict(obj.get("recipient")) if obj.get("recipient") is not None else None
        })
        return _obj
