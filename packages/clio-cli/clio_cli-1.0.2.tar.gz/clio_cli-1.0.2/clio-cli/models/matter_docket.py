...
class MatterDocket(BaseModel):
    ...
    MatterDocket
    """
    id: Optional[StrictInt] = Field(default=None, description="Unique identifier for the *MatterDocket*")
    etag: Optional[StrictStr] = Field(default=None, description="ETag for the *MatterDocket*")
    name: Optional[StrictStr] = Field(default=None, description="The name of the *MatterDocket*")
    start_date: Optional[date] = Field(default=None, description="The date the *MatterDocket* will start (as a ISO-8601 date)")
    start_time: Optional[datetime] = Field(default=None, description="The time the *MatterDocket* will start, required for specific triggers (as a ISO-8601 timestamp)")
    status: Optional[StrictStr] = Field(default=None, description="The status of the *MatterDocket* creation")
    created_at: Optional[datetime] = Field(default=None, description="The time the *MatterDocket* was created (as a ISO-8601 timestamp)")
    updated_at: Optional[datetime] = Field(default=None, description="The time the *MatterDocket* was last updated (as a ISO-8601 timestamp)")
    deleted_at: Optional[datetime] = Field(default=None, description="The time the *MatterDocket* was deleted (as a ISO-8601 timestamp)")
    ...
    calendar_entries: Optional[conlist(CalendarEntryBase)] = Field(default=None, description="CalendarEntry")
    __properties = ["id", "etag", "name", "start_date", "start_time", "status", "created_at", "updated_at", "deleted_at", "matter", "jurisdiction", "trigger", "service_type", "calendar_entries"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MatterDocket:
    ...
    def to_dict(self):
        ...
        if self.service_type:
            _dict['service_type'] = self.service_type.to_dict()
        # override the default output from pydantic by calling `to_dict()` of each item in calendar_entries (list)
        _items = []
        if self.calendar_entries:
            for _item in self.calendar_entries:
                if _item:
                    _items.append(_item.to_dict())
            _dict['calendar_entries'] = _items
        return _dict

    @classmethod
    def from_dict(cls, obj: dict) -> MatterDocket:
        """Create an instance of MatterDocket from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MatterDocket.parse_obj(obj)

        _obj = MatterDocket.parse_obj({
            "id": obj.get("id"),
            "etag": obj.get("etag"),
            "name": obj.get("name"),
            ...
            "jurisdiction": JurisdictionBase.from_dict(obj.get("jurisdiction")) if obj.get("jurisdiction") is not None else None,
            "trigger": JurisdictionsToTriggerBase.from_dict(obj.get("trigger")) if obj.get("trigger") is not None else None,
            "service_type": ServiceTypeBase.from_dict(obj.get("service_type")) if obj.get("service_type") is not None else None,
            "calendar_entries": [CalendarEntryBase.from_dict(_item) for _item in obj.get("calendar_entries")] if obj.get("calendar_entries") is not None else None
        })
        return _obj
