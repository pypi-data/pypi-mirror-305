...
class MatterCreateRequestDataCustomRate(BaseModel):
    """
    MatterCreateRequestDataCustomRate
    """
    type: StrictStr = Field(default=..., description="The type of custom rate for the Matter.")
    rates: Optional[conlist(MatterCreateRequestDataCustomRateRatesInner)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MatterCreateRequestDataCustomRate:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MatterCreateRequestDataCustomRate:
        """Create an instance of MatterCreateRequestDataCustomRate from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MatterCreateRequestDataCustomRate.parse_obj(obj)

        _obj = MatterCreateRequestDataCustomRate.parse_obj({
            "type": obj.get("type"),
            "rates": [MatterCreateRequestDataCustomRateRatesInner.from_dict(_item) for _item in obj.get("rates")] if obj.get("rates") is not None else None
        })
        return _obj
