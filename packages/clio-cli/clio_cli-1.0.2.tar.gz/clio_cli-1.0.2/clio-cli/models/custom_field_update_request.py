...
class CustomFieldUpdateRequest(BaseModel):
    ...
    """
    data: CustomFieldUpdateRequestData = Field(...)
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CustomFieldUpdateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CustomFieldUpdateRequest:
        """Create an instance of CustomFieldUpdateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CustomFieldUpdateRequest.parse_obj(obj)

        _obj = CustomFieldUpdateRequest.parse_obj({
            "data": CustomFieldUpdateRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
