...
class TaskCreateRequestData(BaseModel):
    ...
    """
    assignee: TaskCreateRequestDataAssignee = Field(...)
    ...
    description: StrictStr = Field(default=..., description="Longer description of the Task.")
    ...
    name: StrictStr = Field(default=..., description="Name of the Task.")
    ...
    __properties = ["assignee", "cascading", "cascading_offset", "cascading_offset_polarity", "cascading_offset_type", "cascading_source", "description", "due_at", "matter", "name", "notify_assignee", "notify_completion", "permission", "priority", "status", "statute_of_limitations", "task_type", "time_estimated"]
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in ('pending', 'in_progress', 'in_review', 'complete'):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TaskCreateRequestData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TaskCreateRequestData:
        """Create an instance of TaskCreateRequestData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TaskCreateRequestData.parse_obj(obj)

        _obj = TaskCreateRequestData.parse_obj({
            "assignee": TaskCreateRequestDataAssignee.from_dict(obj.get("assignee")) if obj.get("assignee") is not None else None,
            ...
            "matter": TaskCreateRequestDataMatter.from_dict(obj.get("matter")) if obj.get("matter") is not None else None,
            "name": obj.get("name"),
            ...
            "task_type": TaskCreateRequestDataTaskType.from_dict(obj.get("task_type")) if obj.get("task_type") is not None else None,
