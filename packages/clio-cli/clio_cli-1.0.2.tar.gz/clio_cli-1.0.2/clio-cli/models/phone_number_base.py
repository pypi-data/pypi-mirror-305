...
class PhoneNumberBase(BaseModel):
    ...
    PhoneNumberBase
    """
    id: Optional[StrictInt] = Field(default=None, description="Unique identifier for the *PhoneNumber*")
    etag: Optional[StrictStr] = Field(default=None, description="ETag for the *PhoneNumber*")
    number: Optional[StrictStr] = Field(default=None, description="Contact's Phone Number")
    name: Optional[StrictStr] = Field(default=None, description="The type of *PhoneNumber* it is")
    primary: Optional[StrictBool] = Field(default=None, description="Whether it is default for this contact")
    created_at: Optional[datetime] = Field(default=None, description="The time the *PhoneNumber* was created (as a ISO-8601 timestamp)")
    updated_at: Optional[datetime] = Field(default=None, description="The time the *PhoneNumber* was last updated (as a ISO-8601 timestamp)")
    __properties = ["id", "etag", "number", "name", "primary", "created_at", "updated_at"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PhoneNumberBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PhoneNumberBase:
        """Create an instance of PhoneNumberBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PhoneNumberBase.parse_obj(obj)

        _obj = PhoneNumberBase.parse_obj({
            "id": obj.get("id"),
            "etag": obj.get("etag"),
