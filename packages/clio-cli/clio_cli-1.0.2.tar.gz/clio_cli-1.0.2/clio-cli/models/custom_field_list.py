...
class CustomFieldList(BaseModel):
    ...
    CustomFieldList
    """
    data: conlist(CustomField) = Field(default=..., description="CustomField List Response")
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CustomFieldList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CustomFieldList:
        """Create an instance of CustomFieldList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CustomFieldList.parse_obj(obj)

        _obj = CustomFieldList.parse_obj({
            "data": [CustomField.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
