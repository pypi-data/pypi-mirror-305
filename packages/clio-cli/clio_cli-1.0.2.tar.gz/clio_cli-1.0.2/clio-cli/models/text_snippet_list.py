...
class TextSnippetList(BaseModel):
    ...
    TextSnippetList
    """
    data: conlist(TextSnippet) = Field(default=..., description="TextSnippet List Response")
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TextSnippetList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TextSnippetList:
        """Create an instance of TextSnippetList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TextSnippetList.parse_obj(obj)

        _obj = TextSnippetList.parse_obj({
            "data": [TextSnippet.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
