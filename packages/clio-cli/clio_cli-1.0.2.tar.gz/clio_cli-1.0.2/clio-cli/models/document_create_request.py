...
class DocumentCreateRequest(BaseModel):
    ...
    """
    data: DocumentCreateRequestData = Field(...)
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DocumentCreateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DocumentCreateRequest:
        """Create an instance of DocumentCreateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DocumentCreateRequest.parse_obj(obj)

        _obj = DocumentCreateRequest.parse_obj({
            "data": DocumentCreateRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
