...
class RelationshipCreateRequest(BaseModel):
    ...
    """
    data: RelationshipCreateRequestData = Field(...)
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RelationshipCreateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RelationshipCreateRequest:
        """Create an instance of RelationshipCreateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RelationshipCreateRequest.parse_obj(obj)

        _obj = RelationshipCreateRequest.parse_obj({
            "data": RelationshipCreateRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
