...
class CustomFieldSetCreateRequestData(BaseModel):
    """
    ...
    name: StrictStr = Field(default=..., description="CustomFieldSet name.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CustomFieldSetCreateRequestData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CustomFieldSetCreateRequestData:
        """Create an instance of CustomFieldSetCreateRequestData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CustomFieldSetCreateRequestData.parse_obj(obj)

        _obj = CustomFieldSetCreateRequestData.parse_obj({
