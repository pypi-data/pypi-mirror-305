...
class MedicalRecordShow(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MedicalRecordShow:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MedicalRecordShow:
        """Create an instance of MedicalRecordShow from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MedicalRecordShow.parse_obj(obj)

        _obj = MedicalRecordShow.parse_obj({
            "data": MedicalRecord.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
