...
class CalendarVisibilityUpdateRequest(BaseModel):
    ...
    """
    data: CalendarVisibilityUpdateRequestData = Field(...)
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CalendarVisibilityUpdateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CalendarVisibilityUpdateRequest:
        """Create an instance of CalendarVisibilityUpdateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CalendarVisibilityUpdateRequest.parse_obj(obj)

        _obj = CalendarVisibilityUpdateRequest.parse_obj({
            "data": CalendarVisibilityUpdateRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
