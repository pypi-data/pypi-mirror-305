...
class NoteUpdateRequest(BaseModel):
    ...
    NoteUpdateRequest
    """
    data: NoteUpdateRequestData = Field(...)
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NoteUpdateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NoteUpdateRequest:
        """Create an instance of NoteUpdateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NoteUpdateRequest.parse_obj(obj)

        _obj = NoteUpdateRequest.parse_obj({
            "data": NoteUpdateRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
