...
class CustomFieldSetUpdateRequest(BaseModel):
    """
    CustomFieldSetUpdateRequest
    """
    data: CustomFieldSetUpdateRequestData = Field(...)
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CustomFieldSetUpdateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CustomFieldSetUpdateRequest:
        """Create an instance of CustomFieldSetUpdateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CustomFieldSetUpdateRequest.parse_obj(obj)

        _obj = CustomFieldSetUpdateRequest.parse_obj({
            "data": CustomFieldSetUpdateRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
