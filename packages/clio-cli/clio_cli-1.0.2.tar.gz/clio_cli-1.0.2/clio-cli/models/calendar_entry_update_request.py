...
class CalendarEntryUpdateRequest(BaseModel):
    ...
    """
    data: CalendarEntryUpdateRequestData = Field(...)
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CalendarEntryUpdateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CalendarEntryUpdateRequest:
        """Create an instance of CalendarEntryUpdateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CalendarEntryUpdateRequest.parse_obj(obj)

        _obj = CalendarEntryUpdateRequest.parse_obj({
            "data": CalendarEntryUpdateRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
