...
class TaskTemplateListList(BaseModel):
    ...
    """
    data: conlist(TaskTemplateList) = Field(default=..., description="TaskTemplateList List Response")
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TaskTemplateListList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TaskTemplateListList:
        """Create an instance of TaskTemplateListList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TaskTemplateListList.parse_obj(obj)

        _obj = TaskTemplateListList.parse_obj({
            "data": [TaskTemplateList.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
