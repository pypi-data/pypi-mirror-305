...
class MatterDocketCreateRequest(BaseModel):
    """
    MatterDocketCreateRequest
    """
    data: MatterDocketCreateRequestData = Field(...)
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MatterDocketCreateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MatterDocketCreateRequest:
        """Create an instance of MatterDocketCreateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MatterDocketCreateRequest.parse_obj(obj)

        _obj = MatterDocketCreateRequest.parse_obj({
            "data": MatterDocketCreateRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
