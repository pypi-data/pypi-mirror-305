...
class Account(BaseModel):
    ...
    Account
    """
    id: Optional[StrictInt] = Field(default=None, description="Unique identifier for the *Account*")
    etag: Optional[StrictStr] = Field(default=None, description="ETag for the *Account*")
    ...
    created_at: Optional[datetime] = Field(default=None, description="The time the *Account* was created (as a ISO-8601 timestamp)")
    updated_at: Optional[datetime] = Field(default=None, description="The time the *Account* was last updated (as a ISO-8601 timestamp)")
    owner: Optional[UserBase] = None
    __properties = ["id", "etag", "name", "state", "created_at", "updated_at", "owner"]
    ...
    def from_dict(cls, obj: dict) -> Account:
        ...
        _obj = Account.parse_obj({
            ...
            "owner": UserBase.from_dict(obj.get("owner")) if obj.get("owner") is not None else None
        })
        return _obj
