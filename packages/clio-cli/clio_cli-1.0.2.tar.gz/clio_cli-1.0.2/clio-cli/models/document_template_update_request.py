...
class DocumentTemplateUpdateRequest(BaseModel):
    ...
    """
    data: DocumentTemplateUpdateRequestData = Field(...)
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DocumentTemplateUpdateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DocumentTemplateUpdateRequest:
        """Create an instance of DocumentTemplateUpdateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DocumentTemplateUpdateRequest.parse_obj(obj)

        _obj = DocumentTemplateUpdateRequest.parse_obj({
            "data": DocumentTemplateUpdateRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
