...
class RelatedContacts(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RelatedContacts:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RelatedContacts:
        """Create an instance of RelatedContacts from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RelatedContacts.parse_obj(obj)

        _obj = RelatedContacts.parse_obj({
            "id": obj.get("id"),
