...
class GrantFundingSourceList(BaseModel):
    ...
    """
    data: conlist(GrantFundingSource) = Field(default=..., description="GrantFundingSource List Response")
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GrantFundingSourceList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GrantFundingSourceList:
        """Create an instance of GrantFundingSourceList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GrantFundingSourceList.parse_obj(obj)

        _obj = GrantFundingSourceList.parse_obj({
            "data": [GrantFundingSource.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
