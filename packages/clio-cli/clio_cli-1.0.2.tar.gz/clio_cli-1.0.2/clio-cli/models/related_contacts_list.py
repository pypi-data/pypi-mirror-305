...
class RelatedContactsList(BaseModel):
    ...
    RelatedContactsList
    """
    data: conlist(RelatedContacts) = Field(default=..., description="RelatedContacts List Response")
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RelatedContactsList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RelatedContactsList:
        """Create an instance of RelatedContactsList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RelatedContactsList.parse_obj(obj)

        _obj = RelatedContactsList.parse_obj({
            "data": [RelatedContacts.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
