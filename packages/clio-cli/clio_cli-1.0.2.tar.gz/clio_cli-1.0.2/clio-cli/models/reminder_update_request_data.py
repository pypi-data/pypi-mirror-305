...
class ReminderUpdateRequestData(BaseModel):
    ...
    __properties = ["duration_unit", "duration_value", "notification_method"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ReminderUpdateRequestData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ReminderUpdateRequestData:
        """Create an instance of ReminderUpdateRequestData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ReminderUpdateRequestData.parse_obj(obj)

        _obj = ReminderUpdateRequestData.parse_obj({
