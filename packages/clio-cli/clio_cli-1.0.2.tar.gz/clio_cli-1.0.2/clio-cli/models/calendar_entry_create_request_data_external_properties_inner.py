...
class CalendarEntryCreateRequestDataExternalPropertiesInner(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CalendarEntryCreateRequestDataExternalPropertiesInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CalendarEntryCreateRequestDataExternalPropertiesInner:
        """Create an instance of CalendarEntryCreateRequestDataExternalPropertiesInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CalendarEntryCreateRequestDataExternalPropertiesInner.parse_obj(obj)

        _obj = CalendarEntryCreateRequestDataExternalPropertiesInner.parse_obj({
            "name": obj.get("name"),
            "value": obj.get("value")
        })
        return _obj
