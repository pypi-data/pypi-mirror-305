...
class BankTransferShow(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BankTransferShow:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BankTransferShow:
        """Create an instance of BankTransferShow from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BankTransferShow.parse_obj(obj)

        _obj = BankTransferShow.parse_obj({
            "data": BankTransfer.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
