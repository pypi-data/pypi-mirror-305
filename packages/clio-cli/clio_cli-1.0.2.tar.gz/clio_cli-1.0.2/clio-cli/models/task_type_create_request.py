...
class TaskTypeCreateRequest(BaseModel):
    ...
    """
    data: TaskTypeCreateRequestData = Field(...)
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TaskTypeCreateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TaskTypeCreateRequest:
        """Create an instance of TaskTypeCreateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TaskTypeCreateRequest.parse_obj(obj)

        _obj = TaskTypeCreateRequest.parse_obj({
            "data": TaskTypeCreateRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
