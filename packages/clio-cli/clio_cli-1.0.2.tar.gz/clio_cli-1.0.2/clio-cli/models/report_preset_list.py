...
class ReportPresetList(BaseModel):
    ...
    ReportPresetList
    """
    data: conlist(ReportPreset) = Field(default=..., description="ReportPreset List Response")
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ReportPresetList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ReportPresetList:
        """Create an instance of ReportPresetList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ReportPresetList.parse_obj(obj)

        _obj = ReportPresetList.parse_obj({
            "data": [ReportPreset.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
