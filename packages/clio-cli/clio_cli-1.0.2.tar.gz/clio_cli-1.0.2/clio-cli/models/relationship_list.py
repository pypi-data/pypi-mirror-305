...
class RelationshipList(BaseModel):
    ...
    RelationshipList
    """
    data: conlist(Relationship) = Field(default=..., description="Relationship List Response")
    __properties = ["data"]
    ...
    def from_dict(cls, obj: dict) -> RelationshipList:
        ...
        _obj = RelationshipList.parse_obj({
            "data": [Relationship.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
