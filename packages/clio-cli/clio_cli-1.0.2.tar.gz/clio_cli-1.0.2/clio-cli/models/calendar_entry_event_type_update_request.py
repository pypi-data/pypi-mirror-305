...
class CalendarEntryEventTypeUpdateRequest(BaseModel):
    """
    CalendarEntryEventTypeUpdateRequest
    """
    data: CalendarEntryEventTypeUpdateRequestData = Field(...)
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CalendarEntryEventTypeUpdateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CalendarEntryEventTypeUpdateRequest:
        """Create an instance of CalendarEntryEventTypeUpdateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CalendarEntryEventTypeUpdateRequest.parse_obj(obj)

        _obj = CalendarEntryEventTypeUpdateRequest.parse_obj({
            "data": CalendarEntryEventTypeUpdateRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
