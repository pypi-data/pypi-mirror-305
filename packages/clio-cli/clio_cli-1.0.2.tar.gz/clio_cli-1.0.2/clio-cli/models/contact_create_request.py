...
class ContactCreateRequest(BaseModel):
    ...
    """
    data: ContactCreateRequestData = Field(...)
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ContactCreateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ContactCreateRequest:
        """Create an instance of ContactCreateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ContactCreateRequest.parse_obj(obj)

        _obj = ContactCreateRequest.parse_obj({
            "data": ContactCreateRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
