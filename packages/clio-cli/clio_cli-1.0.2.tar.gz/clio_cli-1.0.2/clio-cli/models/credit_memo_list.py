...
class CreditMemoList(BaseModel):
    ...
    CreditMemoList
    """
    data: conlist(CreditMemo) = Field(default=..., description="CreditMemo List Response")
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreditMemoList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreditMemoList:
        """Create an instance of CreditMemoList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreditMemoList.parse_obj(obj)

        _obj = CreditMemoList.parse_obj({
            "data": [CreditMemo.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
