...
class InterestCharge(BaseModel):
    ...
    InterestCharge
    """
    id: Optional[StrictInt] = Field(default=None, description="Unique identifier for the *InterestCharge*")
    etag: Optional[StrictStr] = Field(default=None, description="ETag for the *InterestCharge*")
    var_date: Optional[date] = Field(default=None, alias="date", description="The *InterestCharge* date (as a ISO-8601 date)")
    description: Optional[StrictStr] = Field(default=None, description="The description for the *InterestCharge*")
    total: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The total amount for the *InterestCharge*")
    created_at: Optional[datetime] = Field(default=None, description="The time the *InterestCharge* was created (as a ISO-8601 timestamp)")
    updated_at: Optional[datetime] = Field(default=None, description="The time the *InterestCharge* was last updated (as a ISO-8601 timestamp)")
    ...
    __properties = ["id", "etag", "date", "description", "total", "created_at", "updated_at", "bill", "balances", "matters"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InterestCharge:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InterestCharge:
        """Create an instance of InterestCharge from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return InterestCharge.parse_obj(obj)

        _obj = InterestCharge.parse_obj({
            "id": obj.get("id"),
            "etag": obj.get("etag"),
