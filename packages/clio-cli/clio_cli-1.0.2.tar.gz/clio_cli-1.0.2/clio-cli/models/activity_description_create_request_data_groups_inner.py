...
class ActivityDescriptionCreateRequestDataGroupsInner(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ActivityDescriptionCreateRequestDataGroupsInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ActivityDescriptionCreateRequestDataGroupsInner:
        """Create an instance of ActivityDescriptionCreateRequestDataGroupsInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ActivityDescriptionCreateRequestDataGroupsInner.parse_obj(obj)

        _obj = ActivityDescriptionCreateRequestDataGroupsInner.parse_obj({
            "id": obj.get("id")
        })
        return _obj
