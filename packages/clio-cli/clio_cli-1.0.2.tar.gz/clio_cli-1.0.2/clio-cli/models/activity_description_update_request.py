...
class ActivityDescriptionUpdateRequest(BaseModel):
    """
    ActivityDescriptionUpdateRequest
    """
    data: ActivityDescriptionUpdateRequestData = Field(...)
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ActivityDescriptionUpdateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ActivityDescriptionUpdateRequest:
        """Create an instance of ActivityDescriptionUpdateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ActivityDescriptionUpdateRequest.parse_obj(obj)

        _obj = ActivityDescriptionUpdateRequest.parse_obj({
            "data": ActivityDescriptionUpdateRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
