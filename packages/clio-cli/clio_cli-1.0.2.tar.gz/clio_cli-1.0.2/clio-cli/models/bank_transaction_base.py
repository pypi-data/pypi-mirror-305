...
class BankTransactionBase(BaseModel):
    ...
    __properties = ["id", "type", "etag", "created_at", "updated_at", "bank_account_id", "source", "confirmation", "date", "amount", "currency", "description", "exchange_rate", "transaction_type", "funds_in", "funds_out", "clio_payments_transaction", "current_account_balance", "read_only_confirmation"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BankTransactionBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BankTransactionBase:
        """Create an instance of BankTransactionBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BankTransactionBase.parse_obj(obj)

        _obj = BankTransactionBase.parse_obj({
            "id": obj.get("id"),
            "type": obj.get("type"),
            "etag": obj.get("etag"),
