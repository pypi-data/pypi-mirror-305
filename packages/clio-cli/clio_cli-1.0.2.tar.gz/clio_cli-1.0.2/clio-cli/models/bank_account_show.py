...
class BankAccountShow(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BankAccountShow:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BankAccountShow:
        """Create an instance of BankAccountShow from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BankAccountShow.parse_obj(obj)

        _obj = BankAccountShow.parse_obj({
            "data": BankAccount.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
