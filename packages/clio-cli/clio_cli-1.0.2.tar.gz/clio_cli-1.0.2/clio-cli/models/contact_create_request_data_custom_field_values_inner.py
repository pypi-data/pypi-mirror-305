...
class ContactCreateRequestDataCustomFieldValuesInner(BaseModel):
    """
    ContactCreateRequestDataCustomFieldValuesInner
    """
    value: StrictStr = Field(default=..., description="The value of the CustomFieldValue.")
    custom_field: ContactCreateRequestDataCustomFieldValuesInnerCustomField = Field(...)
    __properties = ["value", "custom_field"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ContactCreateRequestDataCustomFieldValuesInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ContactCreateRequestDataCustomFieldValuesInner:
        """Create an instance of ContactCreateRequestDataCustomFieldValuesInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ContactCreateRequestDataCustomFieldValuesInner.parse_obj(obj)

        _obj = ContactCreateRequestDataCustomFieldValuesInner.parse_obj({
            "value": obj.get("value"),
            "custom_field": ContactCreateRequestDataCustomFieldValuesInnerCustomField.from_dict(obj.get("custom_field")) if obj.get("custom_field") is not None else None
        })
        return _obj
