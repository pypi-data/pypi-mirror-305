...
class MatterCreateRequestDataPracticeArea(BaseModel):
    """
    MatterCreateRequestDataPracticeArea
    """
    id: Optional[StrictInt] = Field(default=None, description="The unique identifier for a single PracticeArea associated with the Matter. Use the keyword `null` to specify no association.")
    __properties = ["id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MatterCreateRequestDataPracticeArea:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MatterCreateRequestDataPracticeArea:
        """Create an instance of MatterCreateRequestDataPracticeArea from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MatterCreateRequestDataPracticeArea.parse_obj(obj)

        _obj = MatterCreateRequestDataPracticeArea.parse_obj({
            "id": obj.get("id")
        })
        return _obj
