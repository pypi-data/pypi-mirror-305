...
class JurisdictionShow(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> JurisdictionShow:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> JurisdictionShow:
        """Create an instance of JurisdictionShow from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return JurisdictionShow.parse_obj(obj)

        _obj = JurisdictionShow.parse_obj({
            "data": Jurisdiction.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
