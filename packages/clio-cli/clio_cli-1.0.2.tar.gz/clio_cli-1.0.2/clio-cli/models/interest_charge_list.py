...
class InterestChargeList(BaseModel):
    ...
    InterestChargeList
    """
    data: conlist(InterestCharge) = Field(default=..., description="InterestCharge List Response")
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InterestChargeList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InterestChargeList:
        """Create an instance of InterestChargeList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return InterestChargeList.parse_obj(obj)

        _obj = InterestChargeList.parse_obj({
            "data": [InterestCharge.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
