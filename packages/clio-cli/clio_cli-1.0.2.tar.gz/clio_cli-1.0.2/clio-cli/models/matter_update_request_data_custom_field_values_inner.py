...
class MatterUpdateRequestDataCustomFieldValuesInner(BaseModel):
    """
    ...
    id: Optional[StrictInt] = Field(default=None, description="The unique identifier for a single CustomFieldValue associated with the Matter. The keyword `null` is not valid for this field.")
    destroy: Optional[StrictBool] = Field(default=None, alias="_destroy", description="The destroy flag. If the flag is set to `true` and the unique identifier of the associated CustomFieldValue is present, the CustomFieldValue is deleted from the Matter.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MatterUpdateRequestDataCustomFieldValuesInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MatterUpdateRequestDataCustomFieldValuesInner:
        """Create an instance of MatterUpdateRequestDataCustomFieldValuesInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MatterUpdateRequestDataCustomFieldValuesInner.parse_obj(obj)

        _obj = MatterUpdateRequestDataCustomFieldValuesInner.parse_obj({
            "value": obj.get("value"),
