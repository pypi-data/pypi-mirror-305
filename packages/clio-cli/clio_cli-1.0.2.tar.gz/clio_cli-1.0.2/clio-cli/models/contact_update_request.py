...
class ContactUpdateRequest(BaseModel):
    ...
    """
    data: ContactUpdateRequestData = Field(...)
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ContactUpdateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ContactUpdateRequest:
        """Create an instance of ContactUpdateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ContactUpdateRequest.parse_obj(obj)

        _obj = ContactUpdateRequest.parse_obj({
            "data": ContactUpdateRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
