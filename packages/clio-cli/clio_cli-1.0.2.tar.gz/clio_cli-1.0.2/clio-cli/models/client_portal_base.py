...
class ClientPortalBase(BaseModel):
    ...
    ClientPortalBase
    """
    id: Optional[StrictInt] = Field(default=None, description="Unique identifier for the *ClientPortal*")
    etag: Optional[StrictStr] = Field(default=None, description="ETag for the *ClientPortal*")
    created_at: Optional[datetime] = Field(default=None, description="The time the *ClientPortal* was created (as a ISO-8601 timestamp)")
    updated_at: Optional[datetime] = Field(default=None, description="The time the *ClientPortal* was last updated (as a ISO-8601 timestamp)")
    unread_count: Optional[StrictInt] = Field(default=None, description="The number of unread count messages for the current user.")
    unread_notifiable_count: Optional[StrictInt] = Field(default=None, description="The number of unread messages for the current user once their notification settings have been applied.")
    __properties = ["id", "etag", "created_at", "updated_at", "unread_count", "unread_notifiable_count"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ClientPortalBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ClientPortalBase:
        """Create an instance of ClientPortalBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ClientPortalBase.parse_obj(obj)

        _obj = ClientPortalBase.parse_obj({
            "id": obj.get("id"),
            "etag": obj.get("etag"),
            "created_at": obj.get("created_at"),
            "updated_at": obj.get("updated_at"),
            "unread_count": obj.get("unread_count"),
            "unread_notifiable_count": obj.get("unread_notifiable_count")
        })
        return _obj
