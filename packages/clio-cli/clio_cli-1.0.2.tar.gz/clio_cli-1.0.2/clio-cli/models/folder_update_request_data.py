...
class FolderUpdateRequestData(BaseModel):
    ...
    external_properties: Optional[conlist(FolderUpdateRequestDataExternalPropertiesInner)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FolderUpdateRequestData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FolderUpdateRequestData:
        """Create an instance of FolderUpdateRequestData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FolderUpdateRequestData.parse_obj(obj)

        _obj = FolderUpdateRequestData.parse_obj({
            ...
            "external_properties": [FolderUpdateRequestDataExternalPropertiesInner.from_dict(_item) for _item in obj.get("external_properties")] if obj.get("external_properties") is not None else None,
            "name": obj.get("name"),
            "parent": FolderUpdateRequestDataParent.from_dict(obj.get("parent")) if obj.get("parent") is not None else None,
