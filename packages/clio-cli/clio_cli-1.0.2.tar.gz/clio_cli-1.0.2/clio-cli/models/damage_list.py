...
class DamageList(BaseModel):
    ...
    DamageList
    """
    data: conlist(Damage) = Field(default=..., description="Damage List Response")
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DamageList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DamageList:
        """Create an instance of DamageList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DamageList.parse_obj(obj)

        _obj = DamageList.parse_obj({
            "data": [Damage.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
