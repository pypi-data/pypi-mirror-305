...
class PolymorphicCustomRate(BaseModel):
    ...
    var_date: Optional[date] = Field(default=None, alias="date", description="The date of the ContingencyFee award.")
    ...
    __properties = ["id", "etag", "created_at", "updated_at", "rate", "award", "note", "date", "user", "group", "activity_description"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PolymorphicCustomRate:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PolymorphicCustomRate:
        """Create an instance of PolymorphicCustomRate from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PolymorphicCustomRate.parse_obj(obj)

        _obj = PolymorphicCustomRate.parse_obj({
            "id": obj.get("id"),
            "etag": obj.get("etag"),
            ...
            "user": PolymorphicCustomRateUserBase.from_dict(obj.get("user")) if obj.get("user") is not None else None,
            "group": PolymorphicCustomRateGroupBase.from_dict(obj.get("group")) if obj.get("group") is not None else None,
            "activity_description": PolymorphicCustomRateActivityDescriptionBase.from_dict(obj.get("activity_description")) if obj.get("activity_description") is not None else None
        })
        return _obj
