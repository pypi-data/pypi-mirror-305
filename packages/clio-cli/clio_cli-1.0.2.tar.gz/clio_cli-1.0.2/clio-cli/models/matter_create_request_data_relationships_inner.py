...
class MatterCreateRequestDataRelationshipsInner(BaseModel):
    """
    MatterCreateRequestDataRelationshipsInner
    """
    description: StrictStr = Field(default=..., description="Describe the relationship between a Contact and a Matter.")
    contact: MatterCreateRequestDataRelationshipsInnerContact = Field(...)
    __properties = ["description", "contact"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MatterCreateRequestDataRelationshipsInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MatterCreateRequestDataRelationshipsInner:
        """Create an instance of MatterCreateRequestDataRelationshipsInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MatterCreateRequestDataRelationshipsInner.parse_obj(obj)

        _obj = MatterCreateRequestDataRelationshipsInner.parse_obj({
            "description": obj.get("description"),
            "contact": MatterCreateRequestDataRelationshipsInnerContact.from_dict(obj.get("contact")) if obj.get("contact") is not None else None
        })
        return _obj
