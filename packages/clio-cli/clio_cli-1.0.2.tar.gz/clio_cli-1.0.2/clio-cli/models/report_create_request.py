...
class ReportCreateRequest(BaseModel):
    ...
    ReportCreateRequest
    """
    data: ReportCreateRequestData = Field(...)
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ReportCreateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ReportCreateRequest:
        """Create an instance of ReportCreateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ReportCreateRequest.parse_obj(obj)

        _obj = ReportCreateRequest.parse_obj({
            "data": ReportCreateRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
