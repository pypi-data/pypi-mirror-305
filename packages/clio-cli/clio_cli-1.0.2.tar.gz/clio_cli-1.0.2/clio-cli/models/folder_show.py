...
class FolderShow(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FolderShow:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FolderShow:
        """Create an instance of FolderShow from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FolderShow.parse_obj(obj)

        _obj = FolderShow.parse_obj({
            "data": Folder.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
