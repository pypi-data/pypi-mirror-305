...
class DocumentCopyRequestData(BaseModel):
    ...
    __properties = ["communication_id", "document_category", "external_properties", "filename", "name", "parent", "received_at"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DocumentCopyRequestData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DocumentCopyRequestData:
        """Create an instance of DocumentCopyRequestData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DocumentCopyRequestData.parse_obj(obj)

        _obj = DocumentCopyRequestData.parse_obj({
