...
class ContactCreateRequestDataCompany(BaseModel):
    """
    ContactCreateRequestDataCompany
    """
    id: Optional[StrictInt] = Field(default=None, description="The unique identifier for a single Company associated with the Contact. The keyword `null` is not valid for this field.")
    __properties = ["id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ContactCreateRequestDataCompany:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ContactCreateRequestDataCompany:
        """Create an instance of ContactCreateRequestDataCompany from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ContactCreateRequestDataCompany.parse_obj(obj)

        _obj = ContactCreateRequestDataCompany.parse_obj({
            "id": obj.get("id")
        })
        return _obj
