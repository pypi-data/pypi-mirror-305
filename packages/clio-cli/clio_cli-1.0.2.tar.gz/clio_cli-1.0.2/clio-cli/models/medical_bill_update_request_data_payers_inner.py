...
class MedicalBillUpdateRequestDataPayersInner(BaseModel):
    """
    ...
    holder_id: Optional[StrictInt] = Field(default=None, description="Lien holder ID")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MedicalBillUpdateRequestDataPayersInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MedicalBillUpdateRequestDataPayersInner:
        """Create an instance of MedicalBillUpdateRequestDataPayersInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MedicalBillUpdateRequestDataPayersInner.parse_obj(obj)

        _obj = MedicalBillUpdateRequestDataPayersInner.parse_obj({
