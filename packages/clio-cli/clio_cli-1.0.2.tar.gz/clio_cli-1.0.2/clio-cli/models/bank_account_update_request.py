...
class BankAccountUpdateRequest(BaseModel):
    ...
    """
    data: BankAccountUpdateRequestData = Field(...)
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BankAccountUpdateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BankAccountUpdateRequest:
        """Create an instance of BankAccountUpdateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BankAccountUpdateRequest.parse_obj(obj)

        _obj = BankAccountUpdateRequest.parse_obj({
            "data": BankAccountUpdateRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
