...
class ConversationMessageCreateRequestData(BaseModel):
    """
    ConversationMessageCreateRequestData
    """
    attachment: Optional[ConversationMessageCreateRequestDataAttachment] = None
    body: StrictStr = Field(default=..., description="The body value.")
    conversation: Optional[ConversationMessageCreateRequestDataConversation] = None
    matter: Optional[ConversationMessageCreateRequestDataMatter] = None
    receivers: conlist(ConversationMessageCreateRequestDataReceiversInner) = Field(...)
    subject: StrictStr = Field(default=..., description="The subject value.")
    __properties = ["attachment", "body", "conversation", "matter", "receivers", "subject"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ConversationMessageCreateRequestData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ConversationMessageCreateRequestData:
        """Create an instance of ConversationMessageCreateRequestData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ConversationMessageCreateRequestData.parse_obj(obj)

        _obj = ConversationMessageCreateRequestData.parse_obj({
            "attachment": ConversationMessageCreateRequestDataAttachment.from_dict(obj.get("attachment")) if obj.get("attachment") is not None else None,
            "body": obj.get("body"),
            "conversation": ConversationMessageCreateRequestDataConversation.from_dict(obj.get("conversation")) if obj.get("conversation") is not None else None,
            "matter": ConversationMessageCreateRequestDataMatter.from_dict(obj.get("matter")) if obj.get("matter") is not None else None,
            "receivers": [ConversationMessageCreateRequestDataReceiversInner.from_dict(_item) for _item in obj.get("receivers")] if obj.get("receivers") is not None else None,
