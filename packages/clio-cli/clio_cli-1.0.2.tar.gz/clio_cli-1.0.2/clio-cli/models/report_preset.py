...
class ReportPreset(BaseModel):
    ...
    __properties = ["id", "etag", "name", "kind", "format", "last_generated_at", "created_at", "updated_at", "category", "options", "report_schedule"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ReportPreset:
    ...
    def to_dict(self):
        ...
        _dict = self.dict(by_alias=True,
                          ...
                          exclude_none=True)
        # override the default output from pydantic by calling `to_dict()` of report_schedule
        if self.report_schedule:
            _dict['report_schedule'] = self.report_schedule.to_dict()
        return _dict

    @classmethod
    def from_dict(cls, obj: dict) -> ReportPreset:
        """Create an instance of ReportPreset from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ReportPreset.parse_obj(obj)

        _obj = ReportPreset.parse_obj({
            "id": obj.get("id"),
            "etag": obj.get("etag"),
            "name": obj.get("name"),
            "kind": obj.get("kind"),
            ...
            "report_schedule": ReportScheduleBase.from_dict(obj.get("report_schedule")) if obj.get("report_schedule") is not None else None
        })
        return _obj
