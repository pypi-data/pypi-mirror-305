...
class DocumentArchiveCreateRequestDataItemsInner(BaseModel):
    """
    DocumentArchiveCreateRequestDataItemsInner
    """
    id: StrictInt = Field(default=..., description="The unique identifier for a single Document or Folder associated with the DocumentArchive. Use the keyword `null` to specify no association.")
    type: StrictInt = Field(default=..., description="The type of the item to download")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DocumentArchiveCreateRequestDataItemsInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DocumentArchiveCreateRequestDataItemsInner:
        """Create an instance of DocumentArchiveCreateRequestDataItemsInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DocumentArchiveCreateRequestDataItemsInner.parse_obj(obj)

        _obj = DocumentArchiveCreateRequestDataItemsInner.parse_obj({
            "id": obj.get("id"),
            "type": obj.get("type")
        })
        return _obj
