...
class GrantShow(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GrantShow:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GrantShow:
        """Create an instance of GrantShow from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GrantShow.parse_obj(obj)

        _obj = GrantShow.parse_obj({
            "data": Grant.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
