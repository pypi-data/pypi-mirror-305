...
class MatterCreateRequestDataStatuteOfLimitationsRemindersInner(BaseModel):
    """
    MatterCreateRequestDataStatuteOfLimitationsRemindersInner
    """
    duration_value: StrictInt = Field(default=..., description="Time measured in `duration_unit` to remind user before the subject.")
    duration_unit: StrictStr = Field(default=..., description="Unit to measure the duration value in.")
    notification_method: MatterCreateRequestDataStatuteOfLimitationsRemindersInnerNotificationMethod = Field(...)
    __properties = ["duration_value", "duration_unit", "notification_method"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MatterCreateRequestDataStatuteOfLimitationsRemindersInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MatterCreateRequestDataStatuteOfLimitationsRemindersInner:
        """Create an instance of MatterCreateRequestDataStatuteOfLimitationsRemindersInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MatterCreateRequestDataStatuteOfLimitationsRemindersInner.parse_obj(obj)

        _obj = MatterCreateRequestDataStatuteOfLimitationsRemindersInner.parse_obj({
