...
class ExpenseCategoryShow(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ExpenseCategoryShow:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ExpenseCategoryShow:
        """Create an instance of ExpenseCategoryShow from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ExpenseCategoryShow.parse_obj(obj)

        _obj = ExpenseCategoryShow.parse_obj({
            "data": ExpenseCategory.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
