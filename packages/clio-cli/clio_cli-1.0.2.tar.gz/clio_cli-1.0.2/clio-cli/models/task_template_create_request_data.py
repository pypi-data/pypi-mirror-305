...
class TaskTemplateCreateRequestData(BaseModel):
    """
    ...
    name: StrictStr = Field(default=..., description="Short name for the TaskTemplate.")
    ...
    reminder_templates: Optional[conlist(TaskTemplateCreateRequestDataReminderTemplatesInner)] = None
    task_template_list: Optional[TaskTemplateCreateRequestDataTaskTemplateList] = None
    __properties = ["cascading", "cascading_offset", "cascading_offset_polarity", "cascading_offset_type", "cascading_source", "description", "name", "priority", "private", "reminder_templates", "task_template_list"]

    @validator('cascading_offset_polarity')
    ...
    @validator('cascading_offset_type')
    def cascading_offset_type_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value

        if value not in ('CalendarDays', 'CalendarWeeks', 'CalendarMonths', 'CalendarYears', 'BusinessDays'):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TaskTemplateCreateRequestData:
    ...
    def to_dict(self):
        ...
        if self.reminder_templates:
            for _item in self.reminder_templates:
                if _item:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TaskTemplateCreateRequestData:
        """Create an instance of TaskTemplateCreateRequestData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TaskTemplateCreateRequestData.parse_obj(obj)

        _obj = TaskTemplateCreateRequestData.parse_obj({
            ...
            "cascading_source": TaskTemplateCreateRequestDataCascadingSource.from_dict(obj.get("cascading_source")) if obj.get("cascading_source") is not None else None,
            "description": obj.get("description"),
            "name": obj.get("name"),
            "priority": obj.get("priority") if obj.get("priority") is not None else 'Normal',
            "private": obj.get("private"),
            "reminder_templates": [TaskTemplateCreateRequestDataReminderTemplatesInner.from_dict(_item) for _item in obj.get("reminder_templates")] if obj.get("reminder_templates") is not None else None,
            "task_template_list": TaskTemplateCreateRequestDataTaskTemplateList.from_dict(obj.get("task_template_list")) if obj.get("task_template_list") is not None else None
        })
        return _obj
