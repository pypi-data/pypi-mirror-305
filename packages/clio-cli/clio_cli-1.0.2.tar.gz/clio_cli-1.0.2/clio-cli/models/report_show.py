...
class ReportShow(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ReportShow:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ReportShow:
        """Create an instance of ReportShow from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ReportShow.parse_obj(obj)

        _obj = ReportShow.parse_obj({
            "data": Report.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
