...
class TimerShow(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TimerShow:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TimerShow:
        """Create an instance of TimerShow from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TimerShow.parse_obj(obj)

        _obj = TimerShow.parse_obj({
            "data": Timer.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
