...
class ReportScheduleUpdateRequest(BaseModel):
    ...
    """
    data: ReportScheduleUpdateRequestData = Field(...)
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ReportScheduleUpdateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ReportScheduleUpdateRequest:
        """Create an instance of ReportScheduleUpdateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ReportScheduleUpdateRequest.parse_obj(obj)

        _obj = ReportScheduleUpdateRequest.parse_obj({
            "data": ReportScheduleUpdateRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
