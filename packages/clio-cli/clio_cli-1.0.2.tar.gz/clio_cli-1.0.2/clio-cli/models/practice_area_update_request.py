...
class PracticeAreaUpdateRequest(BaseModel):
    """
    PracticeAreaUpdateRequest
    """
    data: PracticeAreaUpdateRequestData = Field(...)
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PracticeAreaUpdateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PracticeAreaUpdateRequest:
        """Create an instance of PracticeAreaUpdateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PracticeAreaUpdateRequest.parse_obj(obj)

        _obj = PracticeAreaUpdateRequest.parse_obj({
            "data": PracticeAreaUpdateRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
