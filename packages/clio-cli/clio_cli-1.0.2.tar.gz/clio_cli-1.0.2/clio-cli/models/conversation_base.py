...
class ConversationBase(BaseModel):
    ...
    __properties = ["id", "etag", "archived", "read_only", "current_user_is_member", "subject", "message_count", "time_entries_count", "read", "created_at", "updated_at"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ConversationBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ConversationBase:
        """Create an instance of ConversationBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ConversationBase.parse_obj(obj)

        _obj = ConversationBase.parse_obj({
            "id": obj.get("id"),
            "etag": obj.get("etag"),
