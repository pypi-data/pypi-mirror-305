...
class MatterCustomRate(BaseModel):
    ...
    rates: Optional[conlist(PolymorphicCustomRate)] = Field(default=None, description="PolymorphicCustomRate")
    __properties = ["type", "on_invoice", "rates"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MatterCustomRate:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MatterCustomRate:
        """Create an instance of MatterCustomRate from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MatterCustomRate.parse_obj(obj)

        _obj = MatterCustomRate.parse_obj({
            "type": obj.get("type"),
            "on_invoice": obj.get("on_invoice"),
            "rates": [PolymorphicCustomRate.from_dict(_item) for _item in obj.get("rates")] if obj.get("rates") is not None else None
        })
        return _obj
