...
class PolymorphicCustomRateActivityDescriptionBase(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PolymorphicCustomRateActivityDescriptionBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PolymorphicCustomRateActivityDescriptionBase:
        """Create an instance of PolymorphicCustomRateActivityDescriptionBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PolymorphicCustomRateActivityDescriptionBase.parse_obj(obj)

        _obj = PolymorphicCustomRateActivityDescriptionBase.parse_obj({
            "id": obj.get("id"),
            "etag": obj.get("etag"),
            "name": obj.get("name")
        })
