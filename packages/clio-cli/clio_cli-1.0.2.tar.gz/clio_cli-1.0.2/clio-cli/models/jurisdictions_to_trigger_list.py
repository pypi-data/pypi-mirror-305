...
class JurisdictionsToTriggerList(BaseModel):
    ...
    """
    data: conlist(JurisdictionsToTrigger) = Field(default=..., description="JurisdictionsToTrigger List Response")
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> JurisdictionsToTriggerList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> JurisdictionsToTriggerList:
        """Create an instance of JurisdictionsToTriggerList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return JurisdictionsToTriggerList.parse_obj(obj)

        _obj = JurisdictionsToTriggerList.parse_obj({
            "data": [JurisdictionsToTrigger.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
