...
class BillableMatterList(BaseModel):
    ...
    BillableMatterList
    """
    data: conlist(BillableMatter) = Field(default=..., description="BillableMatter List Response")
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BillableMatterList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BillableMatterList:
        """Create an instance of BillableMatterList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BillableMatterList.parse_obj(obj)

        _obj = BillableMatterList.parse_obj({
            "data": [BillableMatter.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
