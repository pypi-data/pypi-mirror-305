...
class DamageShow(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DamageShow:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DamageShow:
        """Create an instance of DamageShow from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DamageShow.parse_obj(obj)

        _obj = DamageShow.parse_obj({
            "data": Damage.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
