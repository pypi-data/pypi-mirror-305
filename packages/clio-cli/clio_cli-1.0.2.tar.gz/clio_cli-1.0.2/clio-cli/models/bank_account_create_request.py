...
class BankAccountCreateRequest(BaseModel):
    ...
    """
    data: BankAccountCreateRequestData = Field(...)
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BankAccountCreateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BankAccountCreateRequest:
        """Create an instance of BankAccountCreateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BankAccountCreateRequest.parse_obj(obj)

        _obj = BankAccountCreateRequest.parse_obj({
            "data": BankAccountCreateRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
