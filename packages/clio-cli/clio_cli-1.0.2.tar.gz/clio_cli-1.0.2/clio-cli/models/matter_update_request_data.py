...
class MatterUpdateRequestData(BaseModel):
    ...
    custom_field_set_associations: Optional[conlist(MatterUpdateRequestDataCustomFieldSetAssociationsInner)] = None
    custom_field_values: Optional[conlist(MatterUpdateRequestDataCustomFieldValuesInner)] = None
    ...
    relationships: Optional[conlist(MatterUpdateRequestDataRelationshipsInner)] = None
    ...
    split_invoice_payers: Optional[conlist(MatterUpdateRequestDataSplitInvoicePayersInner)] = None
    ...
    task_template_list_instances: Optional[conlist(MatterUpdateRequestDataTaskTemplateListInstancesInner)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MatterUpdateRequestData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MatterUpdateRequestData:
        """Create an instance of MatterUpdateRequestData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MatterUpdateRequestData.parse_obj(obj)

        _obj = MatterUpdateRequestData.parse_obj({
            "billable": obj.get("billable") if obj.get("billable") is not None else True,
            "client": MatterUpdateRequestDataClient.from_dict(obj.get("client")) if obj.get("client") is not None else None,
            "client_reference": obj.get("client_reference"),
            "close_date": obj.get("close_date"),
            "custom_field_set_associations": [MatterUpdateRequestDataCustomFieldSetAssociationsInner.from_dict(_item) for _item in obj.get("custom_field_set_associations")] if obj.get("custom_field_set_associations") is not None else None,
            "custom_field_values": [MatterUpdateRequestDataCustomFieldValuesInner.from_dict(_item) for _item in obj.get("custom_field_values")] if obj.get("custom_field_values") is not None else None,
            "custom_rate": MatterUpdateRequestDataCustomRate.from_dict(obj.get("custom_rate")) if obj.get("custom_rate") is not None else None,
            "description": obj.get("description"),
            "display_number": obj.get("display_number"),
            "evergreen_retainer": MatterUpdateRequestDataEvergreenRetainer.from_dict(obj.get("evergreen_retainer")) if obj.get("evergreen_retainer") is not None else None,
            ...
            "relationships": [MatterUpdateRequestDataRelationshipsInner.from_dict(_item) for _item in obj.get("relationships")] if obj.get("relationships") is not None else None,
            ...
            "split_invoice_payers": [MatterUpdateRequestDataSplitInvoicePayersInner.from_dict(_item) for _item in obj.get("split_invoice_payers")] if obj.get("split_invoice_payers") is not None else None,
            "status": obj.get("status"),
            "statute_of_limitations": MatterUpdateRequestDataStatuteOfLimitations.from_dict(obj.get("statute_of_limitations")) if obj.get("statute_of_limitations") is not None else None,
            "task_template_list_instances": [MatterUpdateRequestDataTaskTemplateListInstancesInner.from_dict(_item) for _item in obj.get("task_template_list_instances")] if obj.get("task_template_list_instances") is not None else None
        })
        return _obj
