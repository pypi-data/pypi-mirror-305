...
class Item(BaseModel):
    ...
    Item
    """
    id: Optional[StrictInt] = Field(default=None, description="Unique identifier for the *Item*")
    etag: Optional[StrictStr] = Field(default=None, description="ETag for the *Item*")
    created_at: Optional[datetime] = Field(default=None, description="The time the *Item* was created (as a ISO-8601 timestamp)")
    updated_at: Optional[datetime] = Field(default=None, description="The time the *Item* was last updated (as a ISO-8601 timestamp)")
    deleted_at: Optional[datetime] = Field(default=None, description="The time the *Item* was deleted (as a ISO-8601 timestamp)")
    type: Optional[StrictStr] = Field(default=None, description="The type of the *Item*")
    locked: Optional[StrictBool] = Field(default=None, description="Whether or not the Item is locked. Locked Item cannot be modified")
    ...
    __properties = ["id", "etag", "created_at", "updated_at", "deleted_at", "type", "locked", "name", "parent", "matter", "contact", "document_category", "creator", "latest_document_version", "group", "external_properties"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in ('Document', 'Folder'):
            raise ValueError("must be one of enum values ('Document', 'Folder')")
        return value
    ...
    def from_dict(cls, obj: dict) -> Item:
        ...
        _obj = Item.parse_obj({
            ...
            "name": obj.get("name"),
            "parent": LinkedFolderBase.from_dict(obj.get("parent")) if obj.get("parent") is not None else None,
            ...
            "document_category": DocumentCategoryBase.from_dict(obj.get("document_category")) if obj.get("document_category") is not None else None,
            "creator": ClioCreatorBase.from_dict(obj.get("creator")) if obj.get("creator") is not None else None,
            "latest_document_version": DocumentVersionBase.from_dict(obj.get("latest_document_version")) if obj.get("latest_document_version") is not None else None,
