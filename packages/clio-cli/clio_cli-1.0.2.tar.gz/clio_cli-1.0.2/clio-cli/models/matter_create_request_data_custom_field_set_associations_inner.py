...
class MatterCreateRequestDataCustomFieldSetAssociationsInner(BaseModel):
    """
    ...
    custom_field_set: ContactCreateRequestDataCustomFieldSetAssociationsInnerCustomFieldSet = Field(...)
    __properties = ["display_order", "custom_field_set"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MatterCreateRequestDataCustomFieldSetAssociationsInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MatterCreateRequestDataCustomFieldSetAssociationsInner:
        """Create an instance of MatterCreateRequestDataCustomFieldSetAssociationsInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MatterCreateRequestDataCustomFieldSetAssociationsInner.parse_obj(obj)

        _obj = MatterCreateRequestDataCustomFieldSetAssociationsInner.parse_obj({
            "display_order": obj.get("display_order"),
            "custom_field_set": ContactCreateRequestDataCustomFieldSetAssociationsInnerCustomFieldSet.from_dict(obj.get("custom_field_set")) if obj.get("custom_field_set") is not None else None
        })
        return _obj
