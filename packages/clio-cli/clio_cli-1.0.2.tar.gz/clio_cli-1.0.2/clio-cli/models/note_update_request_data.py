...
class NoteUpdateRequestData(BaseModel):
    ...
    notification_event_subscribers: Optional[conlist(NoteUpdateRequestDataNotificationEventSubscribersInner)] = None
    subject: Optional[StrictStr] = Field(default=None, description="Note subject.")
    __properties = ["date", "detail", "notification_event_subscribers", "subject"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NoteUpdateRequestData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NoteUpdateRequestData:
        """Create an instance of NoteUpdateRequestData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NoteUpdateRequestData.parse_obj(obj)

        _obj = NoteUpdateRequestData.parse_obj({
            "var_date": obj.get("date"),
            "detail": obj.get("detail"),
            "notification_event_subscribers": [NoteUpdateRequestDataNotificationEventSubscribersInner.from_dict(_item) for _item in obj.get("notification_event_subscribers")] if obj.get("notification_event_subscribers") is not None else None,
