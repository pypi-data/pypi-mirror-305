...
class OutstandingClientBalance(BaseModel):
    ...
    """
    associated_matter_ids: Optional[conlist(StrictInt)] = Field(default=None, description="An array of Matter IDs associated with bills in the unpaid state")
    ...
    outstanding_bills: Optional[conlist(BillBase)] = Field(default=None, description="Bill")
    contact: Optional[ContactBase] = None
    currency: Optional[CurrencyBase] = None
    __properties = ["associated_matter_ids", "etag", "id", "last_payment_date", "last_shared_date", "newest_issued_bill_due_date", "pending_payments_total", "reminders_enabled", "total_outstanding_balance", "created_at", "updated_at", "outstanding_bills", "contact", "currency"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OutstandingClientBalance:
    ...
    def to_dict(self):
        ...
        _dict = self.dict(by_alias=True,
                          ...
                          exclude_none=True)
        # override the default output from pydantic by calling `to_dict()` of each item in outstanding_bills (list)
        _items = []
        if self.outstanding_bills:
            for _item in self.outstanding_bills:
                if _item:
                    _items.append(_item.to_dict())
            _dict['outstanding_bills'] = _items
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OutstandingClientBalance:
        """Create an instance of OutstandingClientBalance from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OutstandingClientBalance.parse_obj(obj)

        _obj = OutstandingClientBalance.parse_obj({
            "associated_matter_ids": obj.get("associated_matter_ids"),
            "etag": obj.get("etag"),
            "id": obj.get("id"),
            "last_payment_date": obj.get("last_payment_date"),
            "last_shared_date": obj.get("last_shared_date"),
            "newest_issued_bill_due_date": obj.get("newest_issued_bill_due_date"),
            "pending_payments_total": obj.get("pending_payments_total"),
            "reminders_enabled": obj.get("reminders_enabled"),
            "total_outstanding_balance": obj.get("total_outstanding_balance"),
            "created_at": obj.get("created_at"),
            "updated_at": obj.get("updated_at"),
            "outstanding_bills": [BillBase.from_dict(_item) for _item in obj.get("outstanding_bills")] if obj.get("outstanding_bills") is not None else None,
