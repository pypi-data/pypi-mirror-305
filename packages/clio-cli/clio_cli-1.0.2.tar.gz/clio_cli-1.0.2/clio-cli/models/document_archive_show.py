...
class DocumentArchiveShow(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DocumentArchiveShow:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DocumentArchiveShow:
        """Create an instance of DocumentArchiveShow from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DocumentArchiveShow.parse_obj(obj)

        _obj = DocumentArchiveShow.parse_obj({
            "data": DocumentArchive.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
