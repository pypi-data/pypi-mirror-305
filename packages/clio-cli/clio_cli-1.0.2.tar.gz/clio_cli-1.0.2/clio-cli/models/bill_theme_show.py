...
class BillThemeShow(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BillThemeShow:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BillThemeShow:
        """Create an instance of BillThemeShow from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BillThemeShow.parse_obj(obj)

        _obj = BillThemeShow.parse_obj({
            "data": BillTheme.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
