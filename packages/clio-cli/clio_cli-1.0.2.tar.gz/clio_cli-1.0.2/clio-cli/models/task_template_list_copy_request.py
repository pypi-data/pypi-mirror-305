...
class TaskTemplateListCopyRequest(BaseModel):
    """
    TaskTemplateListCopyRequest
    """
    data: TaskTemplateListCopyRequestData = Field(...)
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TaskTemplateListCopyRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TaskTemplateListCopyRequest:
        """Create an instance of TaskTemplateListCopyRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TaskTemplateListCopyRequest.parse_obj(obj)

        _obj = TaskTemplateListCopyRequest.parse_obj({
            "data": TaskTemplateListCopyRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
