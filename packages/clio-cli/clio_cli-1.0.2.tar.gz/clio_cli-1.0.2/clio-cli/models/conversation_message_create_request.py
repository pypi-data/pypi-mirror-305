...
class ConversationMessageCreateRequest(BaseModel):
    ...
    """
    data: ConversationMessageCreateRequestData = Field(...)
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ConversationMessageCreateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ConversationMessageCreateRequest:
        """Create an instance of ConversationMessageCreateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ConversationMessageCreateRequest.parse_obj(obj)

        _obj = ConversationMessageCreateRequest.parse_obj({
            "data": ConversationMessageCreateRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
