...
class PracticeAreaCreateRequest(BaseModel):
    """
    PracticeAreaCreateRequest
    """
    data: PracticeAreaCreateRequestData = Field(...)
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PracticeAreaCreateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PracticeAreaCreateRequest:
        """Create an instance of PracticeAreaCreateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PracticeAreaCreateRequest.parse_obj(obj)

        _obj = PracticeAreaCreateRequest.parse_obj({
            "data": PracticeAreaCreateRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
