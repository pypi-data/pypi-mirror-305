...
class CustomFieldSetShow(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CustomFieldSetShow:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CustomFieldSetShow:
        """Create an instance of CustomFieldSetShow from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CustomFieldSetShow.parse_obj(obj)

        _obj = CustomFieldSetShow.parse_obj({
            "data": CustomFieldSet.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
