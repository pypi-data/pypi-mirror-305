...
class DocumentShow(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DocumentShow:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DocumentShow:
        """Create an instance of DocumentShow from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DocumentShow.parse_obj(obj)

        _obj = DocumentShow.parse_obj({
            "data": Document.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
