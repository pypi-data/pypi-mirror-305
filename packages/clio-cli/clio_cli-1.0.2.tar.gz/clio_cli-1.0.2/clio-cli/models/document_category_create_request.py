...
class DocumentCategoryCreateRequest(BaseModel):
    ...
    """
    data: DocumentCategoryCreateRequestData = Field(...)
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DocumentCategoryCreateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DocumentCategoryCreateRequest:
        """Create an instance of DocumentCategoryCreateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DocumentCategoryCreateRequest.parse_obj(obj)

        _obj = DocumentCategoryCreateRequest.parse_obj({
            "data": DocumentCategoryCreateRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
