...
class ActivityCreateRequest(BaseModel):
    ...
    """
    data: ActivityCreateRequestData = Field(...)
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ActivityCreateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ActivityCreateRequest:
        """Create an instance of ActivityCreateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ActivityCreateRequest.parse_obj(obj)

        _obj = ActivityCreateRequest.parse_obj({
            "data": ActivityCreateRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
