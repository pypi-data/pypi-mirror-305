...
class ReportPresetUpdateRequest(BaseModel):
    """
    ReportPresetUpdateRequest
    """
    data: ReportPresetUpdateRequestData = Field(...)
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ReportPresetUpdateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ReportPresetUpdateRequest:
        """Create an instance of ReportPresetUpdateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ReportPresetUpdateRequest.parse_obj(obj)

        _obj = ReportPresetUpdateRequest.parse_obj({
            "data": ReportPresetUpdateRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
