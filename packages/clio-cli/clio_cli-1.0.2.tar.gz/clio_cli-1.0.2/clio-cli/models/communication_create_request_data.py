...
class CommunicationCreateRequestData(BaseModel):
    ...
    """
    body: StrictStr = Field(default=..., description="The body value.")
    var_date: Optional[StrictStr] = Field(default=None, alias="date", description="The date for the Communication. (Expects an ISO-8601 date.)")
    external_properties: Optional[conlist(CommunicationCreateRequestDataExternalPropertiesInner)] = None
    matter: Optional[CommunicationCreateRequestDataMatter] = None
    notification_event_subscribers: Optional[conlist(CommunicationCreateRequestDataNotificationEventSubscribersInner)] = None
    ...
    receivers: Optional[conlist(CommunicationCreateRequestDataReceiversInner)] = None
    senders: Optional[conlist(CommunicationCreateRequestDataSendersInner)] = None
    subject: StrictStr = Field(default=..., description="The subject value.")
    type: StrictStr = Field(default=..., description="Type of the Communication.")
    __properties = ["body", "date", "external_properties", "matter", "notification_event_subscribers", "received_at", "receivers", "senders", "subject", "type"]

    @validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('PhoneCommunication', 'EmailCommunication'):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CommunicationCreateRequestData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CommunicationCreateRequestData:
        """Create an instance of CommunicationCreateRequestData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CommunicationCreateRequestData.parse_obj(obj)

        _obj = CommunicationCreateRequestData.parse_obj({
            "body": obj.get("body"),
            "var_date": obj.get("date"),
            "external_properties": [CommunicationCreateRequestDataExternalPropertiesInner.from_dict(_item) for _item in obj.get("external_properties")] if obj.get("external_properties") is not None else None,
            "matter": CommunicationCreateRequestDataMatter.from_dict(obj.get("matter")) if obj.get("matter") is not None else None,
            "notification_event_subscribers": [CommunicationCreateRequestDataNotificationEventSubscribersInner.from_dict(_item) for _item in obj.get("notification_event_subscribers")] if obj.get("notification_event_subscribers") is not None else None,
            "received_at": obj.get("received_at"),
            "receivers": [CommunicationCreateRequestDataReceiversInner.from_dict(_item) for _item in obj.get("receivers")] if obj.get("receivers") is not None else None,
            "senders": [CommunicationCreateRequestDataSendersInner.from_dict(_item) for _item in obj.get("senders")] if obj.get("senders") is not None else None,
