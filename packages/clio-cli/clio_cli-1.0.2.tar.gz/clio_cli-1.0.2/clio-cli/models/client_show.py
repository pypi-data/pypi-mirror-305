...
class ClientShow(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ClientShow:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ClientShow:
        """Create an instance of ClientShow from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ClientShow.parse_obj(obj)

        _obj = ClientShow.parse_obj({
            "data": Client.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
