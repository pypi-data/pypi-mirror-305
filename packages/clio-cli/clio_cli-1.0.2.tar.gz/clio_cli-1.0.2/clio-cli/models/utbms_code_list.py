...
class UtbmsCodeList(BaseModel):
    ...
    UtbmsCodeList
    """
    data: conlist(UtbmsCode) = Field(default=..., description="UtbmsCode List Response")
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UtbmsCodeList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UtbmsCodeList:
        """Create an instance of UtbmsCodeList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UtbmsCodeList.parse_obj(obj)

        _obj = UtbmsCodeList.parse_obj({
            "data": [UtbmsCode.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
