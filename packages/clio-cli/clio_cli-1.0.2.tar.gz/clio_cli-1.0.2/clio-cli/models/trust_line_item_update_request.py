...
class TrustLineItemUpdateRequest(BaseModel):
    """
    TrustLineItemUpdateRequest
    """
    data: TrustLineItemUpdateRequestData = Field(...)
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TrustLineItemUpdateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TrustLineItemUpdateRequest:
        """Create an instance of TrustLineItemUpdateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TrustLineItemUpdateRequest.parse_obj(obj)

        _obj = TrustLineItemUpdateRequest.parse_obj({
            "data": TrustLineItemUpdateRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
