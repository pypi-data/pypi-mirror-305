...
from clio-cli.models.polymorphic_custom_rate import PolymorphicCustomRate  # noqa: E501
    ...
    def make_instance(self, include_optional) -> PolymorphicCustomRate:
        ...
        if include_optional:
            return PolymorphicCustomRate(
                ...
                user = clio-cli.models.polymorphic_custom_rate_user_base.PolymorphicCustomRate_User_base(
                    enabled = True, 
                    etag = '', 
                    id = 56, 
                    name = '', ),
                group = clio-cli.models.polymorphic_custom_rate_group_base.PolymorphicCustomRate_Group_base(
                    etag = '', 
                    id = 56, 
                    name = '', ),
                activity_description = clio-cli.models.polymorphic_custom_rate_activity_description_base.PolymorphicCustomRate_ActivityDescription_base(
                    id = 56, 
                    etag = '', 
                    name = '', )
            )
