...
from clio-cli.models.calendar_update_request import CalendarUpdateRequest  # noqa: E501
    ...
    def make_instance(self, include_optional) -> CalendarUpdateRequest:
        ...
        if include_optional:
            return CalendarUpdateRequest(
                data = clio-cli.models.calendar_update_request_data.Calendar_update_request_data(
                    color = '#367B9C', 
                    name = '', 
                    source = 'web', 
                    visible = True, )
