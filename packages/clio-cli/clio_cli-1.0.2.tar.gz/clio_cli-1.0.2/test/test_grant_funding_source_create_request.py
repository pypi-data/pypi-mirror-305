...
from clio-cli.models.grant_funding_source_create_request import GrantFundingSourceCreateRequest  # noqa: E501
    ...
    def make_instance(self, include_optional) -> GrantFundingSourceCreateRequest:
        ...
        if include_optional:
            return GrantFundingSourceCreateRequest(
                data = clio-cli.models.grant_funding_source_create_request_data.GrantFundingSource_create_request_data(
                    name = '', )
            )
        else:
            return GrantFundingSourceCreateRequest(
