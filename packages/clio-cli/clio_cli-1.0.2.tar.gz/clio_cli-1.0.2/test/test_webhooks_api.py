...
from clio-cli.api.webhooks_api import WebhooksApi  # noqa: E501
...
class TestWebhooksApi(unittest.TestCase):
    ...
    def test_webhook_destroy(self) -> None:
    ...
    def test_webhook_index(self) -> None:
    ...
    def test_webhook_show(self) -> None:
