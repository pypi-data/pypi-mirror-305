...
from clio-cli.api.documents_api import DocumentsApi  # noqa: E501
...
class TestDocumentsApi(unittest.TestCase):
    ...
    def test_document_destroy(self) -> None:
    ...
    def test_document_download(self) -> None:
    ...
    def test_document_show(self) -> None:
