...
from clio-cli.models.custom_field_value import CustomFieldValue  # noqa: E501
    ...
    def make_instance(self, include_optional) -> CustomFieldValue:
        ...
        if include_optional:
            return CustomFieldValue(
                ...
                soft_deleted = True,
                custom_field = None,
                picklist_option = None,
                matter = clio-cli.models.custom_field_matter_selection_base.CustomFieldMatterSelection_base(
                    id = 56, 
                    display_number = '', ),
