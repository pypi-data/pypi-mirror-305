...
from clio-cli.models.folder_create_request_data import FolderCreateRequestData  # noqa: E501
        ...
        if include_optional:
            return FolderCreateRequestData(
                document_category = clio-cli.models.folder_create_request_data_document_category.Folder_create_request_data_document_category(
                    id = 56, ),
                external_properties = [
                    clio-cli.models.folder_create_request_data_external_properties_inner.Folder_create_request_data_external_properties_inner(
                        name = '', 
                        value = '', )
                    ],
                name = '',
                parent = clio-cli.models.folder_create_request_data_parent.Folder_create_request_data_parent(
                    id = 56, 
                    type = 'Folder', ),
                restore = True
            )
