...
from clio-cli.models.bank_account_create_request import BankAccountCreateRequest  # noqa: E501
    ...
    def make_instance(self, include_optional) -> BankAccountCreateRequest:
        ...
        if include_optional:
            return BankAccountCreateRequest(
                data = clio-cli.models.bank_account_create_request_data.BankAccount_create_request_data(
                    account_number = '', 
                    balance = 1.337, 
