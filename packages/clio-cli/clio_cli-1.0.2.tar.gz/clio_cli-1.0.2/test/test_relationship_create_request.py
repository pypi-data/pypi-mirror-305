...
from clio-cli.models.relationship_create_request import RelationshipCreateRequest  # noqa: E501
    ...
    def make_instance(self, include_optional) -> RelationshipCreateRequest:
        ...
        if include_optional:
            return RelationshipCreateRequest(
                data = clio-cli.models.relationship_create_request_data.Relationship_create_request_data(
                    contact = clio-cli.models.matter_update_request_data_relationships_inner_contact.Matter_update_request_data_relationships_inner_contact(
                        id = 56, ), 
                    description = '', 
                    matter = clio-cli.models.relationship_create_request_data_matter.Relationship_create_request_data_matter(
                        id = 56, ), )
            )
        else:
            return RelationshipCreateRequest(
