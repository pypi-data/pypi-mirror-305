...
from clio-cli.models.damage_update_request import DamageUpdateRequest  # noqa: E501
    ...
    def make_instance(self, include_optional) -> DamageUpdateRequest:
        ...
        if include_optional:
            return DamageUpdateRequest(
                data = clio-cli.models.damage_update_request_data.Damage_update_request_data(
                    amount = 1.337, 
                    damage_type = 'special', 
                    description = '', )
            )
