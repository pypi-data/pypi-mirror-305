...
from clio-cli.models.text_snippet_create_request import TextSnippetCreateRequest  # noqa: E501
    ...
    def make_instance(self, include_optional) -> TextSnippetCreateRequest:
        ...
        if include_optional:
            return TextSnippetCreateRequest(
                data = clio-cli.models.text_snippet_create_request_data.TextSnippet_create_request_data(
                    phrase = '', 
                    snippet = '', 
                    whole_word = True, )
            )
