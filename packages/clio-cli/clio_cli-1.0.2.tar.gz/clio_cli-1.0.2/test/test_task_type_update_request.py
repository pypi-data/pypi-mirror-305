...
from clio-cli.models.task_type_update_request import TaskTypeUpdateRequest  # noqa: E501
    ...
    def make_instance(self, include_optional) -> TaskTypeUpdateRequest:
        ...
        if include_optional:
            return TaskTypeUpdateRequest(
                data = clio-cli.models.task_type_update_request_data.TaskType_update_request_data(
