...
from clio-cli.models.calendar_entry import CalendarEntry  # noqa: E501
    ...
    def make_instance(self, include_optional) -> CalendarEntry:
        ...
        if include_optional:
            return CalendarEntry(
                ...
                time_entries = [
                    clio-cli.models.activity_base.Activity_base(
                        id = 56, 
                        etag = '', 
                        type = 'TimeEntry', 
                ...
                conference_meeting = clio-cli.models.conference_meeting_base.ConferenceMeeting_base(
                    conference_id = 56, 
                    conference_password = '', 
                    created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    etag = '', 
                ...
                matter_docket = clio-cli.models.matter_docket_base.MatterDocket_base(
                    id = 56, 
                    etag = '', 
                    name = '', 
                ...
                calendar_owner = clio-cli.models.calendar_base.Calendar_base(
                    id = 56, 
                    etag = '', 
                    color = '#367B9C', 
                    light_color = '#5DA5C7', 
                    ...
                    updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    source = 'web', ),
                parent_calendar_entry = clio-cli.models.calendar_entry_base.CalendarEntry_base(
                    id = '', 
                    etag = '', 
                    summary = '', 
                    description = '', 
                    ...
                    start_at_time_zone = '', 
                    time_entries_count = 56, ),
                calendar_entry_event_type = clio-cli.models.calendar_entry_event_type_base.CalendarEntryEventType_base(
                    id = 56, 
                    etag = '', 
                    created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    ...
                    name = '', ),
                attendees = [
                    clio-cli.models.attendee_base.Attendee_base(
                        id = 56, 
                        etag = '', 
                        type = 'Contact', 
                        name = '', 
                ...
                calendars = [
                    clio-cli.models.calendar_base.Calendar_base(
                        id = 56, 
                        etag = '', 
                        color = '#367B9C', 
                        light_color = '#5DA5C7', 
                ...
                reminders = [
                    clio-cli.models.reminder_base.Reminder_base(
                        id = 56, 
                        etag = '', 
                        duration = 56, 
                ...
                external_properties = [
                    clio-cli.models.external_property_base.ExternalProperty_base(
                        id = 56, 
                        etag = '', 
                        name = '', 
                        value = '', 
