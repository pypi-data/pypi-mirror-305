...
from clio-cli.models.trust_line_item_update_request import TrustLineItemUpdateRequest  # noqa: E501
    ...
    def make_instance(self, include_optional) -> TrustLineItemUpdateRequest:
        ...
        if include_optional:
            return TrustLineItemUpdateRequest(
                data = clio-cli.models.trust_line_item_update_request_data.TrustLineItem_update_request_data(
