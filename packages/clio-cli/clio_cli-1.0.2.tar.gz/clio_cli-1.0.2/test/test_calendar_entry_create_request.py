...
from clio-cli.models.calendar_entry_create_request import CalendarEntryCreateRequest  # noqa: E501
    ...
    def make_instance(self, include_optional) -> CalendarEntryCreateRequest:
        ...
        if include_optional:
            return CalendarEntryCreateRequest(
                data = clio-cli.models.calendar_entry_create_request_data.CalendarEntry_create_request_data(
                    _deleted = 'single', 
                    all_day = True, 
                    attendees = [
                        clio-cli.models.calendar_entry_create_request_data_attendees_inner.CalendarEntry_create_request_data_attendees_inner(
                            id = 56, 
                            type = '', 
                            _destroy = True, )
                        ], 
                    calendar_entry_event_type = clio-cli.models.calendar_entry_create_request_data_calendar_entry_event_type.CalendarEntry_create_request_data_calendar_entry_event_type(
                        id = 56, ), 
                    calendar_owner = clio-cli.models.calendar_entry_create_request_data_calendar_owner.CalendarEntry_create_request_data_calendar_owner(
                        id = 56, ), 
                    conference_meeting = clio-cli.models.calendar_entry_create_request_data_conference_meeting.CalendarEntry_create_request_data_conference_meeting(
                        type = 'zoom', ), 
                    description = '', 
                    end_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    external_properties = [
                        clio-cli.models.calendar_entry_create_request_data_external_properties_inner.CalendarEntry_create_request_data_external_properties_inner(
                            name = '', 
                            value = '', )
                        ], 
                    location = '', 
                    matter = clio-cli.models.calendar_entry_create_request_data_matter.CalendarEntry_create_request_data_matter(
                        id = 56, ), 
                    recurrence_rule = '', 
