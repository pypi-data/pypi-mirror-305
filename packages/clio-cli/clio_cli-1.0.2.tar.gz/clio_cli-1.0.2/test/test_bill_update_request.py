...
from clio-cli.models.bill_update_request import BillUpdateRequest  # noqa: E501
    ...
    def make_instance(self, include_optional) -> BillUpdateRequest:
        ...
        if include_optional:
            return BillUpdateRequest(
                data = clio-cli.models.bill_update_request_data.Bill_update_request_data(
                    bill_theme = clio-cli.models.bill_update_request_data_bill_theme.Bill_update_request_data_bill_theme(
                        id = 56, ), 
                    currency_id = 56, 
                    discount = clio-cli.models.bill_update_request_data_discount.Bill_update_request_data_discount(
                        rate = 1.337, 
                        type = 'percentage', 
                        note = '', ), 
                    due_at = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(), 
                    interest = clio-cli.models.bill_update_request_data_interest.Bill_update_request_data_interest(
                        rate = 1.337, 
                        type = 'simple', 
                        period = 56, ), 
