...
from clio-cli.models.timer_create_request import TimerCreateRequest  # noqa: E501
    ...
    def make_instance(self, include_optional) -> TimerCreateRequest:
        ...
        if include_optional:
            return TimerCreateRequest(
                data = clio-cli.models.timer_create_request_data.Timer_create_request_data(
                    activity = clio-cli.models.timer_create_request_data_activity.Timer_create_request_data_activity(
                        id = 56, ), )
            )
        else:
            return TimerCreateRequest(
