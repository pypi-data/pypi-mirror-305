...
from clio-cli.models.timer import Timer  # noqa: E501
...
class TestTimer(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Timer:
        """Test Timer
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Timer`
        """
        model = Timer()  # noqa: E501
        if include_optional:
            return Timer(
                id = 56,
                etag = '',
