...
from clio-cli.models.matter_update_request import MatterUpdateRequest  # noqa: E501
    ...
    def make_instance(self, include_optional) -> MatterUpdateRequest:
        ...
        if include_optional:
            return MatterUpdateRequest(
                data = clio-cli.models.matter_update_request_data.Matter_update_request_data(
                    billable = True, 
                    client = clio-cli.models.matter_update_request_data_client.Matter_update_request_data_client(
                        id = 56, ), 
                    client_reference = '', 
                    close_date = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(), 
                    custom_field_set_associations = [
                        clio-cli.models.matter_update_request_data_custom_field_set_associations_inner.Matter_update_request_data_custom_field_set_associations_inner(
                            id = 56, 
                            display_order = 56, 
                            custom_field_set = clio-cli.models.contact_update_request_data_custom_field_set_associations_inner_custom_field_set.Contact_update_request_data_custom_field_set_associations_inner_custom_field_set(
                                id = 56, ), 
                            _destroy = True, )
                        ], 
                    custom_field_values = [
                        clio-cli.models.matter_update_request_data_custom_field_values_inner.Matter_update_request_data_custom_field_values_inner(
                            value = '', 
                            custom_field = clio-cli.models.contact_update_request_data_custom_field_values_inner_custom_field.Contact_update_request_data_custom_field_values_inner_custom_field(
                                id = 56, ), 
                            id = 56, 
                            _destroy = True, )
                        ], 
                    custom_rate = clio-cli.models.matter_update_request_data_custom_rate.Matter_update_request_data_custom_rate(
                        type = 'FlatRate', 
                        rates = [
                            clio-cli.models.matter_update_request_data_custom_rate_rates_inner.Matter_update_request_data_custom_rate_rates_inner(
                                user = clio-cli.models.matter_update_request_data_custom_rate_rates_inner_user.Matter_update_request_data_custom_rate_rates_inner_user(
                                    id = 56, ), 
                                award = 1.337, 
                                note = '', 
                                ...
                                id = 56, 
                                _destroy = True, 
                                activity_description = clio-cli.models.matter_create_request_data_custom_rate_rates_inner_activity_description.Matter_create_request_data_custom_rate_rates_inner_activity_description(
                                    id = 56, ), 
                                group = clio-cli.models.matter_create_request_data_custom_rate_rates_inner_group.Matter_create_request_data_custom_rate_rates_inner_group(
                                    id = 56, ), )
                            ], ), 
                    description = '', 
                    display_number = '', 
                    evergreen_retainer = clio-cli.models.matter_update_request_data_evergreen_retainer.Matter_update_request_data_evergreen_retainer(
                        minimum_threshold = 1.337, 
                        _destroy = True, 
                        recipients = [
                            clio-cli.models.matter_create_request_data_evergreen_retainer_recipients_inner.Matter_create_request_data_evergreen_retainer_recipients_inner(
                                id = 56, 
                                _destroy = True, )
                            ], ), 
                    group = clio-cli.models.matter_create_request_data_group.Matter_create_request_data_group(
                        id = 56, ), 
                    location = '', 
                    matter_budget = clio-cli.models.matter_create_request_data_matter_budget.Matter_create_request_data_matter_budget(
                        _destroy = True, 
                        budget = 1.337, 
                        include_expenses = True, 
                        notification_threshold = 56, 
                        notify_users = True, ), 
                    matter_stage = clio-cli.models.matter_create_request_data_matter_stage.Matter_create_request_data_matter_stage(
                        id = 56, ), 
                    open_date = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(), 
                    originating_attorney = clio-cli.models.matter_create_request_data_originating_attorney.Matter_create_request_data_originating_attorney(
                        id = 56, ), 
                    pending_date = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(), 
                    practice_area = clio-cli.models.matter_create_request_data_practice_area.Matter_create_request_data_practice_area(
                        id = 56, ), 
                    relationships = [
                        clio-cli.models.matter_update_request_data_relationships_inner.Matter_update_request_data_relationships_inner(
                            description = '', 
                            contact = clio-cli.models.matter_update_request_data_relationships_inner_contact.Matter_update_request_data_relationships_inner_contact(
                                id = 56, ), 
                            id = 56, 
                            _destroy = True, )
                        ], 
                    reset_matter_number = True, 
                    responsible_attorney = clio-cli.models.matter_create_request_data_originating_attorney.Matter_create_request_data_originating_attorney(
                        id = 56, ), 
                    split_invoice_payers = [
                        clio-cli.models.matter_update_request_data_split_invoice_payers_inner.Matter_update_request_data_split_invoice_payers_inner(
                            contact_id = 56, 
                            id = 56, 
                    ...
                    status = 'open', 
                    statute_of_limitations = clio-cli.models.matter_update_request_data_statute_of_limitations.Matter_update_request_data_statute_of_limitations(
                        status = 'pending', 
                        due_at = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(), 
                        reminders = [
                            clio-cli.models.matter_update_request_data_statute_of_limitations_reminders_inner.Matter_update_request_data_statute_of_limitations_reminders_inner(
                                duration_value = 56, 
                                duration_unit = '', 
                                notification_method = clio-cli.models.matter_update_request_data_statute_of_limitations_reminders_inner_notification_method.Matter_update_request_data_statute_of_limitations_reminders_inner_notification_method(
                                    id = 56, ), 
                                id = 56, 
                                _destroy = True, )
                            ], ), 
                    task_template_list_instances = [
                        clio-cli.models.matter_update_request_data_task_template_list_instances_inner.Matter_update_request_data_task_template_list_instances_inner(
                            task_template_list = clio-cli.models.matter_update_request_data_task_template_list_instances_inner_task_template_list.Matter_update_request_data_task_template_list_instances_inner_task_template_list(
                                id = 56, ), 
                            assignee_id = 56, 
