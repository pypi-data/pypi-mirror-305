...
from clio-cli.models.custom_field_set_create_request import CustomFieldSetCreateRequest  # noqa: E501
    ...
    def make_instance(self, include_optional) -> CustomFieldSetCreateRequest:
        ...
        if include_optional:
            return CustomFieldSetCreateRequest(
                data = clio-cli.models.custom_field_set_create_request_data.CustomFieldSet_create_request_data(
                    displayed = True, 
                    name = '', 
                    parent_type = 'Contact', )
            )
