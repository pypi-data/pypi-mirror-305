...
from clio-cli.models.custom_field_update_request import CustomFieldUpdateRequest  # noqa: E501
    ...
    def make_instance(self, include_optional) -> CustomFieldUpdateRequest:
        ...
        if include_optional:
            return CustomFieldUpdateRequest(
                data = clio-cli.models.custom_field_update_request_data.CustomField_update_request_data(
                    display_order = 56, 
                    displayed = True, 
                    name = '', 
                    picklist_options = [
