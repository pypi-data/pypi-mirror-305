...
from clio-cli.models.activity_description_create_request import ActivityDescriptionCreateRequest  # noqa: E501
    ...
    def make_instance(self, include_optional) -> ActivityDescriptionCreateRequest:
        ...
        if include_optional:
            return ActivityDescriptionCreateRequest(
                data = clio-cli.models.activity_description_create_request_data.ActivityDescription_create_request_data(
                    default = True, 
                    groups = [
                        clio-cli.models.activity_description_create_request_data_groups_inner.ActivityDescription_create_request_data_groups_inner(
                            id = 56, )
                        ], 
                    name = '', 
