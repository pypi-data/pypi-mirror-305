...
from clio-cli.models.matter_docket_create_request import MatterDocketCreateRequest  # noqa: E501
    ...
    def make_instance(self, include_optional) -> MatterDocketCreateRequest:
        ...
        if include_optional:
            return MatterDocketCreateRequest(
                data = clio-cli.models.matter_docket_create_request_data.MatterDocket_create_request_data(
                    jurisdiction = clio-cli.models.matter_docket_create_request_data_jurisdiction.MatterDocket_create_request_data_jurisdiction(
                        id = 56, ), 
                    name = '', 
                    start_date = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(), 
                    start_time = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    trigger = clio-cli.models.matter_docket_create_request_data_trigger.MatterDocket_create_request_data_trigger(
                        id = 56, ), )
            )
        else:
            return MatterDocketCreateRequest(
