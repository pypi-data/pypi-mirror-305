...
from clio-cli.api.calendars_api import CalendarsApi  # noqa: E501
...
class TestCalendarsApi(unittest.TestCase):
    ...
    def test_calendar_destroy(self) -> None:
    ...
    def test_calendar_index(self) -> None:
    ...
    def test_calendar_show(self) -> None:
    ...
    def test_calendar_update(self) -> None:
