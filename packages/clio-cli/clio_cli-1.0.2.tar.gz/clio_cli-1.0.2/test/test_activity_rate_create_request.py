...
from clio-cli.models.activity_rate_create_request import ActivityRateCreateRequest  # noqa: E501
    ...
    def make_instance(self, include_optional) -> ActivityRateCreateRequest:
        ...
        if include_optional:
            return ActivityRateCreateRequest(
                data = clio-cli.models.activity_rate_create_request_data.ActivityRate_create_request_data(
