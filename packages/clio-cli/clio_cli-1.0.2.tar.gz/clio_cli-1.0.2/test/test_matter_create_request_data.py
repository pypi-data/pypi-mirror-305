...
from clio-cli.models.matter_create_request_data import MatterCreateRequestData  # noqa: E501
    ...
    def make_instance(self, include_optional) -> MatterCreateRequestData:
        ...
        if include_optional:
            return MatterCreateRequestData(
                billable = True,
                client = clio-cli.models.matter_create_request_data_client.Matter_create_request_data_client(
                    id = 56, ),
                client_reference = '',
                close_date = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(),
                custom_field_set_associations = [
                    clio-cli.models.matter_create_request_data_custom_field_set_associations_inner.Matter_create_request_data_custom_field_set_associations_inner(
                        display_order = 56, 
                        custom_field_set = clio-cli.models.contact_create_request_data_custom_field_set_associations_inner_custom_field_set.Contact_create_request_data_custom_field_set_associations_inner_custom_field_set(
                            id = 56, ), )
                    ],
                custom_field_values = [
                    clio-cli.models.contact_create_request_data_custom_field_values_inner.Contact_create_request_data_custom_field_values_inner(
                        value = '', 
                        custom_field = clio-cli.models.contact_create_request_data_custom_field_values_inner_custom_field.Contact_create_request_data_custom_field_values_inner_custom_field(
                            id = 56, ), )
                    ],
                custom_rate = clio-cli.models.matter_create_request_data_custom_rate.Matter_create_request_data_custom_rate(
                    type = 'FlatRate', 
                    rates = [
                        clio-cli.models.matter_create_request_data_custom_rate_rates_inner.Matter_create_request_data_custom_rate_rates_inner(
                            user = clio-cli.models.matter_create_request_data_custom_rate_rates_inner_user.Matter_create_request_data_custom_rate_rates_inner_user(
                                id = 56, ), 
                            award = 1.337, 
                            note = '', 
                ...
                description = '',
                display_number = '',
                evergreen_retainer = clio-cli.models.matter_create_request_data_evergreen_retainer.Matter_create_request_data_evergreen_retainer(
                ...
                practice_area = clio-cli.models.matter_create_request_data_practice_area.Matter_create_request_data_practice_area(
                    id = 56, ),
                relationships = [
                    clio-cli.models.matter_create_request_data_relationships_inner.Matter_create_request_data_relationships_inner(
                        description = '', 
                        contact = clio-cli.models.matter_create_request_data_relationships_inner_contact.Matter_create_request_data_relationships_inner_contact(
                            id = 56, ), )
                    ],
                ...
                split_invoice_payers = [
                    clio-cli.models.matter_create_request_data_split_invoice_payers_inner.Matter_create_request_data_split_invoice_payers_inner(
                        contact_id = 56, 
                        send_to_bill_recipients = True, 
                        split_portion = 1.337, )
                    ],
                status = 'open',
                statute_of_limitations = clio-cli.models.matter_create_request_data_statute_of_limitations.Matter_create_request_data_statute_of_limitations(
                    status = 'pending', 
                    due_at = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(), 
                    reminders = [
                        clio-cli.models.matter_create_request_data_statute_of_limitations_reminders_inner.Matter_create_request_data_statute_of_limitations_reminders_inner(
                            duration_value = 56, 
                            duration_unit = '', 
                            notification_method = clio-cli.models.matter_create_request_data_statute_of_limitations_reminders_inner_notification_method.Matter_create_request_data_statute_of_limitations_reminders_inner_notification_method(
                                id = 56, ), )
                        ], ),
                task_template_list_instances = [
                    clio-cli.models.matter_create_request_data_task_template_list_instances_inner.Matter_create_request_data_task_template_list_instances_inner(
                        task_template_list = clio-cli.models.matter_create_request_data_task_template_list_instances_inner_task_template_list.Matter_create_request_data_task_template_list_instances_inner_task_template_list(
                            id = 56, ), 
                        assignee_id = 56, 
