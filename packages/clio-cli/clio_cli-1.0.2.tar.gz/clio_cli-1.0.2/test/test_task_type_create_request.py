...
from clio-cli.models.task_type_create_request import TaskTypeCreateRequest  # noqa: E501
    ...
    def make_instance(self, include_optional) -> TaskTypeCreateRequest:
        ...
        if include_optional:
            return TaskTypeCreateRequest(
                data = clio-cli.models.task_type_create_request_data.TaskType_create_request_data(
