...
from clio-cli.models.custom_field_set_update_request import CustomFieldSetUpdateRequest  # noqa: E501
    ...
    def make_instance(self, include_optional) -> CustomFieldSetUpdateRequest:
        ...
        if include_optional:
            return CustomFieldSetUpdateRequest(
                data = clio-cli.models.custom_field_set_update_request_data.CustomFieldSet_update_request_data(
                    displayed = True, 
                    name = '', 
                    parent_type = 'Contact', )
            )
