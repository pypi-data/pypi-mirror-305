...
from clio-cli.models.note_update_request import NoteUpdateRequest  # noqa: E501
    ...
    def make_instance(self, include_optional) -> NoteUpdateRequest:
        ...
        if include_optional:
            return NoteUpdateRequest(
                data = clio-cli.models.note_update_request_data.Note_update_request_data(
                    date = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(), 
                    detail = '', 
                    notification_event_subscribers = [
                        clio-cli.models.note_update_request_data_notification_event_subscribers_inner.Note_update_request_data_notification_event_subscribers_inner(
                            user_id = '', 
                            id = 56, 
                            _destroy = True, )
                        ], 
