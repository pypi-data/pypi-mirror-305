...
from clio-cli.models.activity_update_request_data import ActivityUpdateRequestData  # noqa: E501
    ...
    def make_instance(self, include_optional) -> ActivityUpdateRequestData:
        ...
        if include_optional:
            return ActivityUpdateRequestData(
                activity_description = clio-cli.models.activity_create_request_data_activity_description.Activity_create_request_data_activity_description(
                    id = 56, 
                    utbms_task_id = 56, 
                    utbms_activity_id = 56, ),
                calendar_entry = clio-cli.models.activity_create_request_data_calendar_entry.Activity_create_request_data_calendar_entry(
                    id = 56, ),
                client_portal = clio-cli.models.activity_create_request_data_client_portal.Activity_create_request_data_client_portal(
                    id = 56, ),
                communication = clio-cli.models.activity_create_request_data_communication.Activity_create_request_data_communication(
                    id = 56, ),
                contact_note = clio-cli.models.activity_create_request_data_contact_note.Activity_create_request_data_contact_note(
                    id = 56, ),
                var_date = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(),
                expense_category = clio-cli.models.activity_create_request_data_expense_category.Activity_create_request_data_expense_category(
                    id = 56, ),
                matter = clio-cli.models.activity_create_request_data_matter.Activity_create_request_data_matter(
                    id = 56, ),
                matter_note = clio-cli.models.activity_create_request_data_contact_note.Activity_create_request_data_contact_note(
                    id = 56, ),
                no_charge = True,
                non_billable = True,
                note = '',
                ...
                reference = '',
                start_timer = True,
                task = clio-cli.models.activity_create_request_data_task.Activity_create_request_data_task(
                    id = 56, ),
                tax_setting = 'no_tax',
                text_message_conversation = clio-cli.models.activity_create_request_data_text_message_conversation.Activity_create_request_data_text_message_conversation(
                    id = 56, ),
                type = 'TimeEntry',
                user = clio-cli.models.activity_create_request_data_user.Activity_create_request_data_user(
                    id = 56, ),
                utbms_expense = clio-cli.models.activity_create_request_data_utbms_expense.Activity_create_request_data_utbms_expense(
                    id = 56, ),
                vendor = clio-cli.models.activity_create_request_data_vendor.Activity_create_request_data_vendor(
                    id = 56, )
            )
        else:
            return ActivityUpdateRequestData(
