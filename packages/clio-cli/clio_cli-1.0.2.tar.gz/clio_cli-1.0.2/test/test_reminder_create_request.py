...
from clio-cli.models.reminder_create_request import ReminderCreateRequest  # noqa: E501
    ...
    def make_instance(self, include_optional) -> ReminderCreateRequest:
        ...
        if include_optional:
            return ReminderCreateRequest(
                data = clio-cli.models.reminder_create_request_data.Reminder_create_request_data(
                    duration_unit = 'weeks', 
                    duration_value = 56, 
