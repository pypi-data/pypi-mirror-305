...
from clio-cli.models.communication_create_request import CommunicationCreateRequest  # noqa: E501
    ...
    def make_instance(self, include_optional) -> CommunicationCreateRequest:
        ...
        if include_optional:
            return CommunicationCreateRequest(
                data = clio-cli.models.communication_create_request_data.Communication_create_request_data(
                    body = '', 
                    date = '', 
                    external_properties = [
                        clio-cli.models.communication_create_request_data_external_properties_inner.Communication_create_request_data_external_properties_inner(
                            name = '', 
                            value = '', )
                        ], 
                    ...
                    notification_event_subscribers = [
                        clio-cli.models.communication_create_request_data_notification_event_subscribers_inner.Communication_create_request_data_notification_event_subscribers_inner(
                            user_id = '', )
                        ], 
                    received_at = '', 
                    receivers = [
