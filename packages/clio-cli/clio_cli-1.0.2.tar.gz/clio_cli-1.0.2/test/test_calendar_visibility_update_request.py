...
from clio-cli.models.calendar_visibility_update_request import CalendarVisibilityUpdateRequest  # noqa: E501
    ...
    def make_instance(self, include_optional) -> CalendarVisibilityUpdateRequest:
        ...
        if include_optional:
            return CalendarVisibilityUpdateRequest(
                data = clio-cli.models.calendar_visibility_update_request_data.CalendarVisibility_update_request_data(
                    color = '#367B9C', 
                    visible = '', )
            )
        else:
