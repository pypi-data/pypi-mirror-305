...
from clio-cli.models.bank_account_update_request import BankAccountUpdateRequest  # noqa: E501
    ...
    def make_instance(self, include_optional) -> BankAccountUpdateRequest:
        ...
        if include_optional:
            return BankAccountUpdateRequest(
                data = clio-cli.models.bank_account_update_request_data.BankAccount_update_request_data(
                    account_number = '', 
