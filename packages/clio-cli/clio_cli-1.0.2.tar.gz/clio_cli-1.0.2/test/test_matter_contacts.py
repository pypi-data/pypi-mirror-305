...
from clio-cli.models.matter_contacts import MatterContacts  # noqa: E501
        ...
        if include_optional:
            return MatterContacts(
                ...
                secondary_address = clio-cli.models.address_base.Address_base(
                    ...
                    updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    primary = True, ),
                secondary_web_site = clio-cli.models.web_site_base.WebSite_base(
                    id = 56, 
                    etag = '', 
                    address = '', 
                    name = 'Work', 
                ...
                custom_field_values = [
                    clio-cli.models.custom_field_value_base.CustomFieldValue_base(
                        id = '', 
                        etag = '', 
                        field_name = '', 
                        created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                ...
                relationship = clio-cli.models.relationship_base.Relationship_base(
                    id = 56, 
                    etag = '', 
                    description = '', 
                    created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
