...
from clio-cli.api.activities_api import ActivitiesApi  # noqa: E501
...
class TestActivitiesApi(unittest.TestCase):
    ...
    def test_activity_destroy(self) -> None:
    ...
    def test_activity_index(self) -> None:
    ...
    def test_activity_show(self) -> None:
