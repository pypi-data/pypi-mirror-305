...
from clio-cli.models.bill_theme_update_request import BillThemeUpdateRequest  # noqa: E501
    ...
    def make_instance(self, include_optional) -> BillThemeUpdateRequest:
        ...
        if include_optional:
            return BillThemeUpdateRequest(
                data = clio-cli.models.bill_theme_update_request_data.BillTheme_update_request_data(
                    config = '', 
                    name = '', )
            )
        else:
