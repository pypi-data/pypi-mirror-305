...
from clio-cli.models.practice_area_create_request import PracticeAreaCreateRequest  # noqa: E501
    ...
    def make_instance(self, include_optional) -> PracticeAreaCreateRequest:
        ...
        if include_optional:
            return PracticeAreaCreateRequest(
                data = clio-cli.models.practice_area_create_request_data.PracticeArea_create_request_data(
