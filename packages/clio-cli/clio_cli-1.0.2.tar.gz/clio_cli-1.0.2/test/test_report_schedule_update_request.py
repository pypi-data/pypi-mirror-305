...
from clio-cli.models.report_schedule_update_request import ReportScheduleUpdateRequest  # noqa: E501
    ...
    def make_instance(self, include_optional) -> ReportScheduleUpdateRequest:
        ...
        if include_optional:
            return ReportScheduleUpdateRequest(
                data = clio-cli.models.report_schedule_update_request_data.ReportSchedule_update_request_data(
                    day_of_month = 56, 
                    days_of_week = [
                        56
                        ], 
