...
from clio-cli.models.document_template_create_request import DocumentTemplateCreateRequest  # noqa: E501
    ...
    def make_instance(self, include_optional) -> DocumentTemplateCreateRequest:
        ...
        if include_optional:
            return DocumentTemplateCreateRequest(
                data = clio-cli.models.document_template_create_request_data.DocumentTemplate_create_request_data(
                    document_category = clio-cli.models.document_template_create_request_data_document_category.DocumentTemplate_create_request_data_document_category(
                        id = 56, ), 
                    file = '', 
                    filename = '', )
            )
