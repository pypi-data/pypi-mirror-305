...
from clio-cli.models.interest_charge import InterestCharge  # noqa: E501

class TestInterestCharge(unittest.TestCase):
    """InterestCharge unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterestCharge:
        """Test InterestCharge
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterestCharge`
        """
        model = InterestCharge()  # noqa: E501
        if include_optional:
