...
from clio-cli.models.expense_category_create_request import ExpenseCategoryCreateRequest  # noqa: E501
    ...
    def make_instance(self, include_optional) -> ExpenseCategoryCreateRequest:
        ...
        if include_optional:
            return ExpenseCategoryCreateRequest(
                data = clio-cli.models.expense_category_create_request_data.ExpenseCategory_create_request_data(
                    entry_type = 'hard_cost', 
                    groups = [
                        clio-cli.models.expense_category_create_request_data_groups_inner.ExpenseCategory_create_request_data_groups_inner(
                            id = 56, 
                            _deleted = True, )
                        ], 
                    name = '', 
                    rate = 1.337, 
                    utbms_code = clio-cli.models.expense_category_create_request_data_utbms_code.ExpenseCategory_create_request_data_utbms_code(
                        id = 56, ), )
            )
        else:
            return ExpenseCategoryCreateRequest(
