...
from clio-cli.models.document_template_update_request import DocumentTemplateUpdateRequest  # noqa: E501
    ...
    def make_instance(self, include_optional) -> DocumentTemplateUpdateRequest:
        ...
        if include_optional:
            return DocumentTemplateUpdateRequest(
                data = clio-cli.models.document_template_update_request_data.DocumentTemplate_update_request_data(
