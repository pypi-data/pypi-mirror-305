...
from clio-cli.models.report_preset_create_request import ReportPresetCreateRequest  # noqa: E501
    ...
    def make_instance(self, include_optional) -> ReportPresetCreateRequest:
        ...
        if include_optional:
            return ReportPresetCreateRequest(
                data = clio-cli.models.report_preset_create_request_data.ReportPreset_create_request_data(
                    format = 'csv', 
