...
from clio-cli.models.activity_rate import ActivityRate  # noqa: E501
...
class TestActivityRate(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ActivityRate:
        """Test ActivityRate
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ActivityRate`
        """
        model = ActivityRate()  # noqa: E501
        if include_optional:
            return ActivityRate(
                id = 56,
                etag = '',
