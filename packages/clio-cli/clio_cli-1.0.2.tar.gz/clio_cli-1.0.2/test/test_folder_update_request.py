...
from clio-cli.models.folder_update_request import FolderUpdateRequest  # noqa: E501
    ...
    def make_instance(self, include_optional) -> FolderUpdateRequest:
        ...
        if include_optional:
            return FolderUpdateRequest(
                data = clio-cli.models.folder_update_request_data.Folder_update_request_data(
