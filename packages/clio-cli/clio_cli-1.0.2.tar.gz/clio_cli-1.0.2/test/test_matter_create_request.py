...
from clio-cli.models.matter_create_request import MatterCreateRequest  # noqa: E501
    ...
    def make_instance(self, include_optional) -> MatterCreateRequest:
        ...
        if include_optional:
            return MatterCreateRequest(
                data = clio-cli.models.matter_create_request_data.Matter_create_request_data(
                    billable = True, 
