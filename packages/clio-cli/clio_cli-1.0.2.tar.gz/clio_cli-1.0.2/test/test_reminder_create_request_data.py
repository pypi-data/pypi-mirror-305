...
from clio-cli.models.reminder_create_request_data import ReminderCreateRequestData  # noqa: E501
        ...
        if include_optional:
            return ReminderCreateRequestData(
                ...
                notification_method = clio-cli.models.matter_create_request_data_statute_of_limitations_reminders_inner_notification_method.Matter_create_request_data_statute_of_limitations_reminders_inner_notification_method(
                    id = 56, ),
                subject = clio-cli.models.reminder_create_request_data_subject.Reminder_create_request_data_subject(
                    id = 56, 
                    type = 'CalendarEntry', )
            )
        else:
