...
from clio-cli.models.line_item_update_request import LineItemUpdateRequest  # noqa: E501
    ...
    def make_instance(self, include_optional) -> LineItemUpdateRequest:
        ...
        if include_optional:
            return LineItemUpdateRequest(
                data = clio-cli.models.line_item_update_request_data.LineItem_update_request_data(
                    activity = clio-cli.models.line_item_update_request_data_activity.LineItem_update_request_data_activity(
                        id = 56, ), 
                    bill = clio-cli.models.line_item_update_request_data_bill.LineItem_update_request_data_bill(
                        id = 56, ), 
                    date = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(), 
                    description = '', 
                    discount = clio-cli.models.line_item_update_request_data_discount.LineItem_update_request_data_discount(
                        rate = 1.337, 
                        type = True, ), 
                    group_ordering = 56, 
                    kind = 'Expense', 
                    matter = clio-cli.models.line_item_update_request_data_matter.LineItem_update_request_data_matter(
                        id = 56, ), 
                    note = '', 
                    price = 1.337, 
                    quantity = 1.337, 
