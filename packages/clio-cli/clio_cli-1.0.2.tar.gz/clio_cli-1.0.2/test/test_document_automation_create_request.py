...
from clio-cli.models.document_automation_create_request import DocumentAutomationCreateRequest  # noqa: E501
    ...
    def make_instance(self, include_optional) -> DocumentAutomationCreateRequest:
        ...
        if include_optional:
            return DocumentAutomationCreateRequest(
                data = clio-cli.models.document_automation_create_request_data.DocumentAutomation_create_request_data(
                    document_template = clio-cli.models.document_automation_create_request_data_document_template.DocumentAutomation_create_request_data_document_template(
                        id = 56, ), 
                    filename = '', 
                    formats = [
                        'pdf'
                        ], 
                    matter = clio-cli.models.document_automation_create_request_data_matter.DocumentAutomation_create_request_data_matter(
                        id = 56, ), )
            )
        else:
            return DocumentAutomationCreateRequest(
