...
from clio-cli.models.task_create_request_data import TaskCreateRequestData  # noqa: E501
    ...
    def make_instance(self, include_optional) -> TaskCreateRequestData:
        ...
        if include_optional:
            return TaskCreateRequestData(
                assignee = clio-cli.models.task_create_request_data_assignee.Task_create_request_data_assignee(
                    id = 56, 
                    type = 'User', ),
                cascading = True,
                cascading_offset = 56,
