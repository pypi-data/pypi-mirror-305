...
from clio-cli.models.matter_docket import MatterDocket  # noqa: E501

class TestMatterDocket(unittest.TestCase):
    """MatterDocket unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MatterDocket:
        """Test MatterDocket
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MatterDocket`
        """
        model = MatterDocket()  # noqa: E501
        if include_optional:
            return MatterDocket(
                id = 56,
                etag = '',
                ...
                jurisdiction = clio-cli.models.jurisdiction_base.Jurisdiction_base(
                    id = 56, 
                    etag = '', 
                    created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                ...
                trigger = clio-cli.models.jurisdictions_to_trigger_base.JurisdictionsToTrigger_base(
                    id = 56, 
                    etag = '', 
                    system_id = 56, 
                    description = '', 
                    ...
                    created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), ),
                service_type = clio-cli.models.service_type_base.ServiceType_base(
                    id = 56, 
                    etag = '', 
                    created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    ...
                    default = True, ),
                calendar_entries = [
                    clio-cli.models.calendar_entry_base.CalendarEntry_base(
                        id = '', 
                        etag = '', 
                        summary = '', 
                        description = '', 
