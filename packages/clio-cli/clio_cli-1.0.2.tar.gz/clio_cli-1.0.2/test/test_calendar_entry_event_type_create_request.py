...
from clio-cli.models.calendar_entry_event_type_create_request import CalendarEntryEventTypeCreateRequest  # noqa: E501
    ...
    def make_instance(self, include_optional) -> CalendarEntryEventTypeCreateRequest:
        ...
        if include_optional:
            return CalendarEntryEventTypeCreateRequest(
                data = clio-cli.models.calendar_entry_event_type_create_request_data.CalendarEntryEventType_create_request_data(
                    color = '#367B9C', 
                    name = '', )
            )
        else:
