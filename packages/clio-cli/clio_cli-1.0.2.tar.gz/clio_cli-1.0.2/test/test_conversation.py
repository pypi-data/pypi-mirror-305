...
from clio-cli.models.conversation import Conversation  # noqa: E501
    ...
    def make_instance(self, include_optional) -> Conversation:
        ...
        if include_optional:
            return Conversation(
                ...
                last_message = clio-cli.models.conversation_message_base.ConversationMessage_base(
                    id = 56, 
                    etag = '', 
                    date = '', 
                    body = '', 
                    created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), ),
                first_message = clio-cli.models.conversation_message_base.ConversationMessage_base(
                    id = 56, 
                    etag = '', 
                    date = '', 
                    body = '', 
                ...
                messages = [
                    clio-cli.models.conversation_message_base.ConversationMessage_base(
                        id = 56, 
                        etag = '', 
                        date = '', 
                        body = '', 
