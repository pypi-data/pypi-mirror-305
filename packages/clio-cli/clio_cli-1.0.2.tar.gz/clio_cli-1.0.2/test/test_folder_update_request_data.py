...
from clio-cli.models.folder_update_request_data import FolderUpdateRequestData  # noqa: E501
    ...
    def make_instance(self, include_optional) -> FolderUpdateRequestData:
        ...
        if include_optional:
            return FolderUpdateRequestData(
                document_category = clio-cli.models.folder_create_request_data_document_category.Folder_create_request_data_document_category(
                    id = 56, ),
                external_properties = [
                    clio-cli.models.folder_update_request_data_external_properties_inner.Folder_update_request_data_external_properties_inner(
                        id = 56, 
                        name = '', 
                        value = '', 
                        _destroy = True, )
                ...
                name = '',
                parent = clio-cli.models.folder_update_request_data_parent.Folder_update_request_data_parent(
                    id = 56, 
                    type = 'Folder', ),
                restore = True
            )
