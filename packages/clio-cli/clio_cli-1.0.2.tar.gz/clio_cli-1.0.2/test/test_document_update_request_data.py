...
from clio-cli.models.document_update_request_data import DocumentUpdateRequestData  # noqa: E501
    ...
    def make_instance(self, include_optional) -> DocumentUpdateRequestData:
        ...
        if include_optional:
            return DocumentUpdateRequestData(
                communication_id = 56,
                copy_version = True,
                document_category = clio-cli.models.document_copy_request_data_document_category.Document_copy_request_data_document_category(
                    id = 56, ),
                external_properties = [
                    clio-cli.models.document_copy_request_data_external_properties_inner.Document_copy_request_data_external_properties_inner(
                        id = 56, 
                        name = '', 
                        value = '', 
                        _destroy = True, )
                ...
                fully_uploaded = True,
                multiparts = [
                    clio-cli.models.document_update_request_data_multiparts_inner.Document_update_request_data_multiparts_inner(
                        part_number = 56, 
                        content_length = '', 
                        content_md5 = '', )
                    ],
                name = '',
                parent = clio-cli.models.document_update_request_data_parent.Document_update_request_data_parent(
                    id = 56, 
                    type = 'Document', ),
