...
from clio-cli.models.expense_category_update_request import ExpenseCategoryUpdateRequest  # noqa: E501
    ...
    def make_instance(self, include_optional) -> ExpenseCategoryUpdateRequest:
        ...
        if include_optional:
            return ExpenseCategoryUpdateRequest(
                data = clio-cli.models.expense_category_update_request_data.ExpenseCategory_update_request_data(
