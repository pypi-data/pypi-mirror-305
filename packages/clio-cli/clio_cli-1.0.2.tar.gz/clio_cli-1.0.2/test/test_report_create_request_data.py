...
from clio-cli.models.report_create_request_data import ReportCreateRequestData  # noqa: E501
    ...
    def make_instance(self, include_optional) -> ReportCreateRequestData:
        ...
        if include_optional:
            return ReportCreateRequestData(
                client = clio-cli.models.report_create_request_data_client.Report_create_request_data_client(
                    id = 56, ),
                end_date = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(),
                format = 'csv',
                kind = 'accounts_receivable',
                matter = clio-cli.models.report_create_request_data_matter.Report_create_request_data_matter(
                    id = 56, ),
                originating_attorney = clio-cli.models.report_create_request_data_originating_attorney.Report_create_request_data_originating_attorney(
                    id = 56, ),
                practice_area = clio-cli.models.report_create_request_data_practice_area.Report_create_request_data_practice_area(
                    id = 56, ),
                responsible_attorney = clio-cli.models.report_create_request_data_originating_attorney.Report_create_request_data_originating_attorney(
                    id = 56, ),
                start_date = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(),
                user = clio-cli.models.report_create_request_data_originating_attorney.Report_create_request_data_originating_attorney(
                    id = 56, ),
                year = ''
            )
        else:
