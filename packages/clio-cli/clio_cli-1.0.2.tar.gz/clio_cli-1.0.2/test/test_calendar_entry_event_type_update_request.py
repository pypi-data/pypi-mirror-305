...
from clio-cli.models.calendar_entry_event_type_update_request import CalendarEntryEventTypeUpdateRequest  # noqa: E501
    ...
    def make_instance(self, include_optional) -> CalendarEntryEventTypeUpdateRequest:
        ...
        if include_optional:
            return CalendarEntryEventTypeUpdateRequest(
                data = clio-cli.models.calendar_entry_event_type_update_request_data.CalendarEntryEventType_update_request_data(
                    color = '#367B9C', 
                    name = '', )
            )
        else:
