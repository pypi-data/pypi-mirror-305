...
from clio-cli.models.custom_action_update_request import CustomActionUpdateRequest  # noqa: E501
    ...
    def make_instance(self, include_optional) -> CustomActionUpdateRequest:
        ...
        if include_optional:
            return CustomActionUpdateRequest(
                data = clio-cli.models.custom_action_update_request_data.CustomAction_update_request_data(
                    label = '', 
                    target_url = '', 
