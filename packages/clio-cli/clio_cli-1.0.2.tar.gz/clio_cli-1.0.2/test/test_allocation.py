...
from clio-cli.models.allocation import Allocation  # noqa: E501
    ...
    def make_instance(self, include_optional) -> Allocation:
        ...
        if include_optional:
            return Allocation(
                ...
                source_bank_account = clio-cli.models.bank_account_base.BankAccount_base(
                    account_number = '', 
                    balance = 1.337, 
                    ...
                    type = 'Operating', 
                    updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), ),
                destination_bank_account = clio-cli.models.bank_account_base.BankAccount_base(
                    account_number = '', 
                    balance = 1.337, 
                    bank_transactions_count = 56, 
                    clio_payment_page_link = '', 
                ...
                contact = clio-cli.models.contact_base.Contact_base(
                    ...
                    sales_tax_number = '', ),
                parent = clio-cli.models.polymorphic_object_base.PolymorphicObject_base(
                    id = 56, 
                    type = 'Task', 
                    identifier = '', 
