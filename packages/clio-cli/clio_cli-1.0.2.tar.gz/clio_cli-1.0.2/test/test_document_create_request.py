...
from clio-cli.models.document_create_request import DocumentCreateRequest  # noqa: E501
    ...
    def make_instance(self, include_optional) -> DocumentCreateRequest:
        ...
        if include_optional:
            return DocumentCreateRequest(
                data = clio-cli.models.document_create_request_data.Document_create_request_data(
                    communication_id = 56, 
                    content_type = '', 
