...
from clio-cli.models.comment_create_request_data import CommentCreateRequestData  # noqa: E501

class TestCommentCreateRequestData(unittest.TestCase):
    """CommentCreateRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CommentCreateRequestData:
        """Test CommentCreateRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CommentCreateRequestData`
        """
        model = CommentCreateRequestData()  # noqa: E501
        if include_optional:
            return CommentCreateRequestData(
                item = clio-cli.models.comment_create_request_data_item.Comment_create_request_data_item(
                    id = 56, ),
                message = ''
            )
        else:
    ...
    def testCommentCreateRequestData(self):
        """Test CommentCreateRequestData"""
