...
from clio-cli.models.text_snippet_update_request import TextSnippetUpdateRequest  # noqa: E501
    ...
    def make_instance(self, include_optional) -> TextSnippetUpdateRequest:
        ...
        if include_optional:
            return TextSnippetUpdateRequest(
                data = clio-cli.models.text_snippet_update_request_data.TextSnippet_update_request_data(
                    phrase = '', 
                    snippet = '', 
                    whole_word = True, )
            )
