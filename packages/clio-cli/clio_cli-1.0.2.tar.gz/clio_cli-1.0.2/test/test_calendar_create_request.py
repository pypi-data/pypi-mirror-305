...
from clio-cli.models.calendar_create_request import CalendarCreateRequest  # noqa: E501
    ...
    def make_instance(self, include_optional) -> CalendarCreateRequest:
        ...
        if include_optional:
            return CalendarCreateRequest(
                data = clio-cli.models.calendar_create_request_data.Calendar_create_request_data(
                    color = '#367B9C', 
                    name = '', 
                    source = 'web', 
                    visible = True, )
