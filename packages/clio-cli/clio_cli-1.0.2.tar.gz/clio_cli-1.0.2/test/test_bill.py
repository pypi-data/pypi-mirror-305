...
from clio-cli.models.bill import Bill  # noqa: E501
        ...
        if include_optional:
            return Bill(
                ...
                client = clio-cli.models.contact_base.Contact_base(
                    ...
                    sales_tax_number = '', ),
                discount = clio-cli.models.discount_base.Discount_base(
                    rate = 1.337, 
                    type = 'percentage', 
                    note = '', 
                    early_payment_rate = 56, 
                    early_payment_period = 56, ),
                interest = clio-cli.models.interest_base.Interest_base(
                    balance = 1.337, 
                    period = 56, 
                    rate = 1.337, 
                    total = 1.337, 
                    type = 'simple', ),
                matters = [
                    clio-cli.models.matter_base.Matter_base(
                        id = 56, 
                        etag = '', 
                        number = 56, 
                        display_number = '', 
                ...
                group = clio-cli.models.group_base.Group_base(
                    ...
                    type = 'UserGroup', 
                    updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), ),
                bill_theme = clio-cli.models.bill_theme_base.BillTheme_base(
                    id = 56, 
                    etag = '', 
                    created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    ...
                    name = '', 
                    config = '', ),
                original_bill = clio-cli.models.bill_base.Bill_base(
                    id = 56, 
                    etag = '', 
                    number = '', 
                    issued_at = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(), 
                    ...
                    total_tax = 1.337, 
                    available_state_transitions = 'awaiting_approval', ),
                destination_account = clio-cli.models.bank_account_base.BankAccount_base(
                    account_number = '', 
                    balance = 1.337, 
                    ...
                    updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), ),
                balances = [
                    clio-cli.models.balance_base.Balance_base(
                        id = 56, 
                        amount = 1.337, 
                        type = 'Matter', 
                ...
                matter_totals = [
                    clio-cli.models.matter_balance_base.MatterBalance_base(
                        id = 56, 
                        amount = 1.337, )
                    ],
                currency = clio-cli.models.currency_base.Currency_base(
                    id = 56, 
                    etag = '', 
                    code = '', 
                    sign = '', 
                    created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), ),
                billing_setting = clio-cli.models.billing_setting_base.BillingSetting_base(
                    id = 56, 
                    etag = '', 
                ...
                legal_aid_uk_bill = clio-cli.models.legal_aid_uk_bill_base.LegalAidUkBill_base(
