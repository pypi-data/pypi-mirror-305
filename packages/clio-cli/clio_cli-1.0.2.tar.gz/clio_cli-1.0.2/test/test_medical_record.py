...
from clio-cli.models.medical_record import MedicalRecord  # noqa: E501

class TestMedicalRecord(unittest.TestCase):
    """MedicalRecord unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MedicalRecord:
        """Test MedicalRecord
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MedicalRecord`
        """
        model = MedicalRecord()  # noqa: E501
        if include_optional:
