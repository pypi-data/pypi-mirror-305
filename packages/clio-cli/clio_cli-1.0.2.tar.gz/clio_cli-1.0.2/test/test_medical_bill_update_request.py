...
from clio-cli.models.medical_bill_update_request import MedicalBillUpdateRequest  # noqa: E501
    ...
    def make_instance(self, include_optional) -> MedicalBillUpdateRequest:
        ...
        if include_optional:
            return MedicalBillUpdateRequest(
                data = clio-cli.models.medical_bill_update_request_data.MedicalBill_update_request_data(
                    adjustment = 1.337, 
                    amount = 1.337, 
                    balance = 1.337, 
                    ...
                    name = '', 
                    payers = [
                        clio-cli.models.medical_bill_update_request_data_payers_inner.MedicalBill_update_request_data_payers_inner(
                            amount = 1.337, 
                            holder_id = 56, 
                            mark_as_lien = True, )
                        ], )
