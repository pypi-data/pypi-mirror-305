...
from clio-cli.models.report_preset_update_request import ReportPresetUpdateRequest  # noqa: E501
    ...
    def make_instance(self, include_optional) -> ReportPresetUpdateRequest:
        ...
        if include_optional:
            return ReportPresetUpdateRequest(
                data = clio-cli.models.report_preset_update_request_data.ReportPreset_update_request_data(
                    format = 'csv', 
