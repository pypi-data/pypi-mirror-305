...
from clio-cli.models.contact import Contact  # noqa: E501
    ...
    def make_instance(self, include_optional) -> Contact:
        ...
        if include_optional:
            return Contact(
                ...
                sales_tax_number = '',
                activity_rates = [
                    clio-cli.models.activity_rate_base.ActivityRate_base(
                        id = 56, 
                        etag = '', 
                        rate = 1.337, 
                        flat_rate = True, 
                ...
                addresses = [
                    clio-cli.models.address_base.Address_base(
                        id = 56, 
                        etag = '', 
                        street = '', 
                        city = '', 
                ...
                custom_field_set_associations = [
                    clio-cli.models.custom_field_set_association_base.CustomFieldSetAssociation_base(
                        id = 56, 
                        etag = '', 
                        display_order = 56, 
                        created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                ...
                email_addresses = [
                    clio-cli.models.email_address_base.EmailAddress_base(
                        id = 56, 
                        etag = '', 
                        address = '', 
                        name = '', 
                ...
                instant_messengers = [
                    clio-cli.models.instant_messenger_base.InstantMessenger_base(
                        id = 56, 
                        etag = '', 
                        address = '', 
                        name = 'Work', 
                ...
                phone_numbers = [
                    clio-cli.models.phone_number_base.PhoneNumber_base(
                        id = 56, 
                        etag = '', 
                        number = '', 
                        name = 'Work', 
                ...
                web_sites = [
                    clio-cli.models.web_site_base.WebSite_base(
                        id = 56, 
                        etag = '', 
                        address = '', 
                        name = 'Work', 
                ...
                notification_methods = [
                    clio-cli.models.notification_method_base.NotificationMethod_base(
                        id = 56, 
                        etag = '', 
                        type = 'Email', 
                        email_address = '', 
                ...
                account_balances = [
                    clio-cli.models.account_balance_base.AccountBalance_base(
                        id = 56, 
                        balance = 1.337, 
                        type = '', 
                        name = '', )
                ...
                related_contacts = [
                    clio-cli.models.contact_base.Contact_base(
                        id = 56, 
                        etag = '', 
                        name = '', 
                        first_name = '', 
                ...
                primary_work_address = clio-cli.models.address_base.Address_base(
                    id = 56, 
                    etag = '', 
                    street = '', 
                    city = '', 
                    ...
                    updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    primary = True, ),
                primary_address = clio-cli.models.address_base.Address_base(
                    id = 56, 
                    etag = '', 
                    street = '', 
                    city = '', 
                    ...
                    updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    primary = True, ),
                secondary_address = clio-cli.models.address_base.Address_base(
                    id = 56, 
                    etag = '', 
                    street = '', 
                    city = '', 
                    ...
                    updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    primary = True, ),
                company = clio-cli.models.contact_base.Contact_base(
                    id = 56, 
                    etag = '', 
                    name = '', 
                    first_name = '', 
                    ...
                    is_bill_recipient = True, 
                    sales_tax_number = '', ),
                avatar = clio-cli.models.avatar_base.Avatar_base(
                    id = 56, 
                    etag = '', 
                    created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    url = '', 
                    _destroy = True, ),
                payment_profile = clio-cli.models.payment_profile_base.PaymentProfile_base(
                    id = 56, 
                    etag = '', 
                    created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                ...
                folder = clio-cli.models.folder_base.Folder_base(
                    id = 56, 
                    etag = '', 
                    created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    ...
                    name = '', 
                    root = True, ),
                co_counsel_rate = clio-cli.models.activity_rate_base.ActivityRate_base(
                    id = 56, 
                    etag = '', 
                    rate = 1.337, 
                    flat_rate = True, 
                    ...
                    contact_id = 56, 
                    co_counsel_contact_id = 56, ),
                primary_web_site = clio-cli.models.web_site_base.WebSite_base(
                    id = 56, 
                    etag = '', 
                    address = '', 
                    name = 'Work', 
                    ...
                    created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), ),
                legal_aid_uk_contact = clio-cli.models.legal_aid_uk_contact_base.LegalAidUkContact_base(
                    id = 56, 
                    disability = 56, 
                    disability_code = '', 
                    ethnicity = 56, 
