...
from clio-cli.models.clio_payments_link_create_request import ClioPaymentsLinkCreateRequest  # noqa: E501
    ...
    def make_instance(self, include_optional) -> ClioPaymentsLinkCreateRequest:
        ...
        if include_optional:
            return ClioPaymentsLinkCreateRequest(
                data = clio-cli.models.clio_payments_link_create_request_data.ClioPaymentsLink_create_request_data(
                    amount = 1.337, 
                    currency = '', 
                    description = '', 
                    destination_account = clio-cli.models.clio_payments_link_create_request_data_destination_account.ClioPaymentsLink_create_request_data_destination_account(
                        id = 56, ), 
                    destination_contact = clio-cli.models.clio_payments_link_create_request_data_destination_contact.ClioPaymentsLink_create_request_data_destination_contact(
                        id = 56, ), 
                    duration = 56, 
                    email_address = '', 
                    is_allocated_as_revenue = True, 
                    subject = clio-cli.models.clio_payments_link_create_request_data_subject.ClioPaymentsLink_create_request_data_subject(
                        id = 56, 
                        type = 'BankAccount', ), )
            )
        else:
