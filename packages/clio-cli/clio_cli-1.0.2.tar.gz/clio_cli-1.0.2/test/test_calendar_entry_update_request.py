...
from clio-cli.models.calendar_entry_update_request import CalendarEntryUpdateRequest  # noqa: E501
    ...
    def make_instance(self, include_optional) -> CalendarEntryUpdateRequest:
        ...
        if include_optional:
            return CalendarEntryUpdateRequest(
                data = clio-cli.models.calendar_entry_update_request_data.CalendarEntry_update_request_data(
                    _deleted = 'single', 
                    all_day = True, 
                    attendees = [
                    ...
                    calendar_entry_event_type = clio-cli.models.calendar_entry_create_request_data_calendar_entry_event_type.CalendarEntry_create_request_data_calendar_entry_event_type(
                        id = 56, ), 
                    calendar_owner = clio-cli.models.calendar_entry_update_request_data_calendar_owner.CalendarEntry_update_request_data_calendar_owner(
                        id = 56, ), 
                    ...
                    external_properties = [
                        clio-cli.models.calendar_entry_update_request_data_external_properties_inner.CalendarEntry_update_request_data_external_properties_inner(
                            id = 56, 
                            name = '', 
                            value = '', 
                            _destroy = True, )
