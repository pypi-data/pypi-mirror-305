...
from clio-cli.models.activity import Activity  # noqa: E501
    ...
    def make_instance(self, include_optional) -> Activity:
        ...
        if include_optional:
            return Activity(
                ...
                no_charge = True,
                tax_setting = 'no_tax',
                activity_description = clio-cli.models.activity_description_base.ActivityDescription_base(
                    id = 56, 
                    etag = '', 
                    name = '', 
                    ...
                    category_type = '', ),
                expense_category = clio-cli.models.expense_category_base.ExpenseCategory_base(
                    id = 56, 
                    etag = '', 
                    name = '', 
                    rate = 56, 
                    ...
                    accessible_to_user = True, 
                    tax_setting = '', ),
                bill = clio-cli.models.bill_base.Bill_base(
                    id = 56, 
                    etag = '', 
                    number = '', 
                ...
                communication = clio-cli.models.communication_base.Communication_base(
                    id = 56, 
                    etag = '', 
                    subject = '', 
                    body = '', 
                ...
                client_portal = clio-cli.models.client_portal_base.ClientPortal_base(
                    id = 56, 
                    etag = '', 
                    created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                ...
                matter_note = clio-cli.models.note_base.Note_base(
                    id = 56, 
                    etag = '', 
                    type = 'Matter', 
                    subject = '', 
                    ...
                    updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    time_entries_count = 56, ),
                contact_note = clio-cli.models.note_base.Note_base(
                    id = 56, 
                    etag = '', 
                    type = 'Matter', 
                    subject = '', 
                    ...
                    updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    time_entries_count = 56, ),
                subject = clio-cli.models.polymorphic_object_base.PolymorphicObject_base(
                    id = 56, 
                    type = 'Task', 
                    identifier = '', 
                    secondary_identifier = '', 
                    tertiary_identifier = '', ),
                timer = clio-cli.models.timer_base.Timer_base(
                    id = 56, 
                    etag = '', 
                    ...
                    created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), ),
                user = clio-cli.models.user_base.User_base(
                    account_owner = True, 
                    clio_connect = True, 
                    ...
                    time_zone = '', 
                    updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), ),
                utbms_expense = clio-cli.models.utbms_code_base.UtbmsCode_base(
                    id = 56, 
                    etag = '', 
                    name = '', 
                    code = '', 
                    ...
                    created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), ),
                vendor = clio-cli.models.contact_base.Contact_base(
                    id = 56, 
                    etag = '', 
                    name = '', 
                    first_name = '', 
                    ...
                    sales_tax_number = '', ),
                calendar_entry = clio-cli.models.activity_calendar_entry_base.Activity_CalendarEntry_base(
                    id = '', 
                    etag = '', 
                    calendar_owner_id = 56, ),
                task = clio-cli.models.activity_task_base.Activity_Task_base(
                    id = 56, 
                    etag = '', ),
                text_message_conversation = clio-cli.models.activity_text_message_conversation_base.Activity_TextMessageConversation_base(
                    id = 56, 
                    etag = '', ),
                document_version = clio-cli.models.document_version_base.DocumentVersion_base(
                    id = 56, 
                    document_id = 56, 
                    etag = '', 
                    uuid = '', 
                    ...
                    put_url = '', 
                    fully_uploaded = True, ),
                legal_aid_uk_activity = clio-cli.models.legal_aid_uk_activity_base.LegalAidUkActivity_base(
