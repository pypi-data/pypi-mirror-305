...
from clio-cli.models.task_template_create_request import TaskTemplateCreateRequest  # noqa: E501
    ...
    def make_instance(self, include_optional) -> TaskTemplateCreateRequest:
        ...
        if include_optional:
            return TaskTemplateCreateRequest(
                data = clio-cli.models.task_template_create_request_data.TaskTemplate_create_request_data(
                    cascading = True, 
                    cascading_offset = 56, 
                    cascading_offset_polarity = 'Before', 
                    cascading_offset_type = 'CalendarDays', 
                    cascading_source = clio-cli.models.task_template_create_request_data_cascading_source.TaskTemplate_create_request_data_cascading_source(
                        id = 56, ), 
                    description = '', 
                    name = '', 
                    priority = 'Normal', 
                    private = True, 
                    reminder_templates = [
                        clio-cli.models.task_template_create_request_data_reminder_templates_inner.TaskTemplate_create_request_data_reminder_templates_inner(
                            duration_value = 56, 
                            duration_unit = '', 
                            notification_type = 'Email', )
                        ], 
                    task_template_list = clio-cli.models.task_template_create_request_data_task_template_list.TaskTemplate_create_request_data_task_template_list(
                        id = 56, ), )
            )
        else:
            return TaskTemplateCreateRequest(
