...
from clio-cli.models.note_create_request_data import NoteCreateRequestData  # noqa: E501
    ...
    def make_instance(self, include_optional) -> NoteCreateRequestData:
        ...
        if include_optional:
            return NoteCreateRequestData(
                contact = clio-cli.models.note_create_request_data_contact.Note_create_request_data_contact(
                    id = 56, ),
                var_date = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(),
                detail = '',
                matter = clio-cli.models.note_create_request_data_matter.Note_create_request_data_matter(
                    id = 56, ),
                notification_event_subscribers = [
                    clio-cli.models.note_create_request_data_notification_event_subscribers_inner.Note_create_request_data_notification_event_subscribers_inner(
                        user_id = '', )
                    ],
                subject = '',
                type = 'Matter'
