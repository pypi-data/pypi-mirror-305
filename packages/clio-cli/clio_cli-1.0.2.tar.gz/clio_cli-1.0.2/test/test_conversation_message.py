...
from clio-cli.models.conversation_message import ConversationMessage  # noqa: E501
    ...
    def make_instance(self, include_optional) -> ConversationMessage:
        ...
        if include_optional:
            return ConversationMessage(
                ...
                sender = clio-cli.models.unredacted_participant_base.UnredactedParticipant_base(),
                document = clio-cli.models.document_base.Document_base(
                    id = 56, 
                    etag = '', 
                    created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    ...
                    size = 56, 
                    content_type = '', ),
                conversation = clio-cli.models.conversation_base.Conversation_base(
                    id = 56, 
                    etag = '', 
                    archived = True, 
                    read_only = True, 
                    ...
                    updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), ),
                receivers = [
                    clio-cli.models.unredacted_participant_base.UnredactedParticipant_base()
                    ]
            )
        else:
            return ConversationMessage(
