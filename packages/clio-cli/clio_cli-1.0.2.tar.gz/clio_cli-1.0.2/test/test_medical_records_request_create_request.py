...
from clio-cli.models.medical_records_request_create_request import MedicalRecordsRequestCreateRequest  # noqa: E501
    ...
    def make_instance(self, include_optional) -> MedicalRecordsRequestCreateRequest:
        ...
        if include_optional:
            return MedicalRecordsRequestCreateRequest(
                data = clio-cli.models.medical_records_request_create_request_data.MedicalRecordsRequest_create_request_data(
                    ...
                    matter_id = 56, 
                    medical_bills = [
                        clio-cli.models.medical_records_request_create_request_data_medical_bills_inner.MedicalRecordsRequest_create_request_data_medical_bills_inner(
                            adjustment = 1.337, 
                            amount = 1.337, 
                            balance = 1.337, 
                            ...
                            payers = [
                                clio-cli.models.medical_records_request_create_request_data_medical_bills_inner_payers_inner.MedicalRecordsRequest_create_request_data_medical_bills_inner_payers_inner(
                                    amount = 1.337, 
                                    holder_id = 56, 
                                    mark_as_lien = True, )
                                ], )
                    ...
                    medical_records = [
                        clio-cli.models.medical_records_request_create_request_data_medical_records_inner.MedicalRecordsRequest_create_request_data_medical_records_inner(
                            document_id = 56, 
