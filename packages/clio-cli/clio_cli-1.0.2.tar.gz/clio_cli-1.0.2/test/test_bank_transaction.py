...
from clio-cli.models.bank_transaction import BankTransaction  # noqa: E501
...
class TestBankTransaction(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> BankTransaction:
        """Test BankTransaction
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BankTransaction`
        """
        model = BankTransaction()  # noqa: E501
        if include_optional:
            return BankTransaction(
                ...
                allocation = clio-cli.models.allocation_base.Allocation_base(
                    id = 56, 
                    etag = '', 
