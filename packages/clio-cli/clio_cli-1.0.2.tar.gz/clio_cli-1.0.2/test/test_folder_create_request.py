...
from clio-cli.models.folder_create_request import FolderCreateRequest  # noqa: E501
    ...
    def make_instance(self, include_optional) -> FolderCreateRequest:
        ...
        if include_optional:
            return FolderCreateRequest(
                data = clio-cli.models.folder_create_request_data.Folder_create_request_data(
