...
from clio-cli.models.activity_description import ActivityDescription  # noqa: E501
    ...
    def make_instance(self, include_optional) -> ActivityDescription:
        ...
        if include_optional:
            return ActivityDescription(
                ...
                category_type = '',
                groups = [
                    clio-cli.models.group_base.Group_base(
                ...
                rate = clio-cli.models.activity_description_rate_base.ActivityDescriptionRate_base(
                    amount = 1.337, 
                    non_billable_amount = 1.337, 
                    type = 'User', 
                    hierarchy = 'Default', ),
                utbms_task = clio-cli.models.utbms_code_base.UtbmsCode_base(
                    id = 56, 
                    etag = '', 
                    name = '', 
                    code = '', 
                    ...
                    created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), ),
                utbms_activity = clio-cli.models.utbms_code_base.UtbmsCode_base(
                    id = 56, 
                    etag = '', 
                    name = '', 
                    code = '', 
