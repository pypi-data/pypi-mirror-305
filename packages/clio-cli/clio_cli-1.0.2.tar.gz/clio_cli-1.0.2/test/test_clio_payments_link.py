...
from clio-cli.models.clio_payments_link import ClioPaymentsLink  # noqa: E501

class TestClioPaymentsLink(unittest.TestCase):
    """ClioPaymentsLink unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ClioPaymentsLink:
        """Test ClioPaymentsLink
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ClioPaymentsLink`
        """
        model = ClioPaymentsLink()  # noqa: E501
        if include_optional:
            return ClioPaymentsLink(
                active = True,
                amount = 1.337,
                ...
                redirect_url = '',
                url = '',
                bank_account = clio-cli.models.bank_account_base.BankAccount_base(
                    account_number = '', 
                    balance = 1.337, 
                ...
                clio_payments_payment = clio-cli.models.clio_payments_payment_base.ClioPaymentsPayment_base(
                    amount = 1.337, 
                    confirmation_number = '', 
                    created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    currency = '', 
                ...
                destination_account = clio-cli.models.bank_account_base.BankAccount_base(
                    ...
                    type = 'Operating', 
                    updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), ),
                destination_contact = clio-cli.models.contact_base.Contact_base(
                    id = 56, 
                    etag = '', 
                    name = '', 
                    first_name = '', 
