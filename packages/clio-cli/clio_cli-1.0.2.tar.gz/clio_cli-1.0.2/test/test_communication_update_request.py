...
from clio-cli.models.communication_update_request import CommunicationUpdateRequest  # noqa: E501
    ...
    def make_instance(self, include_optional) -> CommunicationUpdateRequest:
        ...
        if include_optional:
            return CommunicationUpdateRequest(
                data = clio-cli.models.communication_update_request_data.Communication_update_request_data(
                    body = '', 
                    date = '', 
                    external_properties = [
                        clio-cli.models.communication_update_request_data_external_properties_inner.Communication_update_request_data_external_properties_inner(
                            id = 56, 
                            name = '', 
                            value = '', 
                            _destroy = True, )
                        ], 
                    matter = clio-cli.models.communication_create_request_data_matter.Communication_create_request_data_matter(
                        id = 56, ), 
                    notification_event_subscribers = [
                        clio-cli.models.communication_update_request_data_notification_event_subscribers_inner.Communication_update_request_data_notification_event_subscribers_inner(
                            user_id = '', 
                            id = 56, 
                            _destroy = True, )
                        ], 
                    received_at = '', 
                    receivers = [
                        clio-cli.models.communication_create_request_data_receivers_inner.Communication_create_request_data_receivers_inner(
                            _deleted = True, 
                            id = 56, 
                            type = 'User', )
                        ], 
                    senders = [
                        clio-cli.models.communication_create_request_data_senders_inner.Communication_create_request_data_senders_inner(
                            _deleted = True, 
                            id = 56, 
                            type = 'User', )
                        ], 
