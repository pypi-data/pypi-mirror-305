...
from clio-cli.models.practice_area_update_request import PracticeAreaUpdateRequest  # noqa: E501
    ...
    def make_instance(self, include_optional) -> PracticeAreaUpdateRequest:
        ...
        if include_optional:
            return PracticeAreaUpdateRequest(
                data = clio-cli.models.practice_area_update_request_data.PracticeArea_update_request_data(
