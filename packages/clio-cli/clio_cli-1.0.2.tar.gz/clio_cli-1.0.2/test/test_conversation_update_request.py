...
from clio-cli.models.conversation_update_request import ConversationUpdateRequest  # noqa: E501
    ...
    def make_instance(self, include_optional) -> ConversationUpdateRequest:
        ...
        if include_optional:
            return ConversationUpdateRequest(
                data = clio-cli.models.conversation_update_request_data.Conversation_update_request_data(
                    archived = True, 
                    matter = clio-cli.models.conversation_update_request_data_matter.Conversation_update_request_data_matter(
                        id = 56, ), 
                    read = True, )
            )
        else:
