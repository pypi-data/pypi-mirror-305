...
from clio-cli.models.custom_field_create_request import CustomFieldCreateRequest  # noqa: E501
    ...
    def make_instance(self, include_optional) -> CustomFieldCreateRequest:
        ...
        if include_optional:
            return CustomFieldCreateRequest(
                data = clio-cli.models.custom_field_create_request_data.CustomField_create_request_data(
                    display_order = 56, 
                    displayed = True, 
                    field_type = 'checkbox', 
                    name = '', 
                    parent_type = 'Contact', 
                    picklist_options = [
                        clio-cli.models.custom_field_create_request_data_picklist_options_inner.CustomField_create_request_data_picklist_options_inner(
                            id = 56, 
                            option = '', 
                            _deleted = True, )
                        ], 
