...
from clio-cli.models.trust_request_create_request import TrustRequestCreateRequest  # noqa: E501
    ...
    def make_instance(self, include_optional) -> TrustRequestCreateRequest:
        ...
        if include_optional:
            return TrustRequestCreateRequest(
                data = clio-cli.models.trust_request_create_request_data.TrustRequest_create_request_data(
                    approved = True, 
                    client_id = 56, 
                    due_date = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(), 
                    issue_date = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(), 
                    matter = [
                        clio-cli.models.trust_request_create_request_data_matter_inner.TrustRequest_create_request_data_matter_inner(
                            id = 56, 
                            trust_amount = 56, 
                            note = '', )
                        ], 
