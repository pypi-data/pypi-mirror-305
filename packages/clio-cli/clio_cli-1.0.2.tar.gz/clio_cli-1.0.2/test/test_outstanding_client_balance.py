...
from clio-cli.models.outstanding_client_balance import OutstandingClientBalance  # noqa: E501

class TestOutstandingClientBalance(unittest.TestCase):
    """OutstandingClientBalance unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OutstandingClientBalance:
        """Test OutstandingClientBalance
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OutstandingClientBalance`
        """
        model = OutstandingClientBalance()  # noqa: E501
        if include_optional:
            return OutstandingClientBalance(
                ...
                last_shared_date = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(),
                newest_issued_bill_due_date = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(),
                pending_payments_total = 1.337,
                reminders_enabled = True,
                total_outstanding_balance = 1.337,
                created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'),
                updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'),
                outstanding_bills = [
                    clio-cli.models.bill_base.Bill_base(
                        id = 56, 
                        etag = '', 
                        number = '', 
                ...
                contact = clio-cli.models.contact_base.Contact_base(
                    id = 56, 
                    etag = '', 
                    name = '', 
                    first_name = '', 
    ...
    def testOutstandingClientBalance(self):
        """Test OutstandingClientBalance"""
