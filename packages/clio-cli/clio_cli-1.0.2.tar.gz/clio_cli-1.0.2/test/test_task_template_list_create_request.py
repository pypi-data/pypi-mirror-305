...
from clio-cli.models.task_template_list_create_request import TaskTemplateListCreateRequest  # noqa: E501
    ...
    def make_instance(self, include_optional) -> TaskTemplateListCreateRequest:
        ...
        if include_optional:
            return TaskTemplateListCreateRequest(
                data = clio-cli.models.task_template_list_create_request_data.TaskTemplateList_create_request_data(
                    description = '', 
                    name = '', 
                    practice_area = clio-cli.models.task_template_list_create_request_data_practice_area.TaskTemplateList_create_request_data_practice_area(
                        id = 56, ), )
            )
        else:
            return TaskTemplateListCreateRequest(
