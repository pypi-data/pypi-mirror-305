...
from clio-cli.models.communication import Communication  # noqa: E501
...
class TestCommunication(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Communication:
        """Test Communication
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Communication`
        """
        ...
        if include_optional:
            return Communication(
                ...
                communication_eml_file = clio-cli.models.communication_eml_file_base.CommunicationEmlFile_base(
                    id = 56, ),
                senders = [
                    null
                    ],
                ...
                documents = [
                    clio-cli.models.document_base.Document_base(
                        id = 56, 
                        etag = '', 
                        created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                ...
                notification_event_subscribers = [
                    clio-cli.models.notification_event_subscriber_base.NotificationEventSubscriber_base(
                        id = 56, 
                        etag = '', 
                        user_id = 56, 
                        name = '', 
