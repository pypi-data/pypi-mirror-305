...
from clio-cli.models.comment_update_request_data import CommentUpdateRequestData  # noqa: E501
    ...
    def make_instance(self, include_optional) -> CommentUpdateRequestData:
        ...
        if include_optional:
            return CommentUpdateRequestData(
                item = clio-cli.models.comment_update_request_data_item.Comment_update_request_data_item(
                    id = 56, ),
                message = ''
            )
        else:
