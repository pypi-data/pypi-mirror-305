...
from clio-cli.models.conversation_message_create_request import ConversationMessageCreateRequest  # noqa: E501
    ...
    def make_instance(self, include_optional) -> ConversationMessageCreateRequest:
        ...
        if include_optional:
            return ConversationMessageCreateRequest(
                data = clio-cli.models.conversation_message_create_request_data.ConversationMessage_create_request_data(
                    attachment = clio-cli.models.conversation_message_create_request_data_attachment.ConversationMessage_create_request_data_attachment(
                        document_id = 56, 
                        document_version_id = 56, ), 
                    body = '', 
                    conversation = clio-cli.models.conversation_message_create_request_data_conversation.ConversationMessage_create_request_data_conversation(
                        id = 56, ), 
                    matter = clio-cli.models.conversation_message_create_request_data_matter.ConversationMessage_create_request_data_matter(
                        id = 56, ), 
                    receivers = [
                        clio-cli.models.conversation_message_create_request_data_receivers_inner.ConversationMessage_create_request_data_receivers_inner(
                            id = 56, 
                            type = 'Contact', )
                        ], 
                    subject = '', )
