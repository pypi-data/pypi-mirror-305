...
from clio-cli.models.task_template_update_request import TaskTemplateUpdateRequest  # noqa: E501
    ...
    def make_instance(self, include_optional) -> TaskTemplateUpdateRequest:
        ...
        if include_optional:
            return TaskTemplateUpdateRequest(
                data = clio-cli.models.task_template_update_request_data.TaskTemplate_update_request_data(
                    cascading = True, 
                    cascading_offset = 56, 
                    ...
                    private = True, 
                    reminder_templates = [
                        clio-cli.models.task_template_update_request_data_reminder_templates_inner.TaskTemplate_update_request_data_reminder_templates_inner(
                            duration_value = 56, 
                            duration_unit = '', 
