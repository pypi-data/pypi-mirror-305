...
from clio-cli.models.folder import Folder  # noqa: E501
    ...
    def make_instance(self, include_optional) -> Folder:
        ...
        if include_optional:
            return Folder(
                ...
                name = '',
                root = True,
                parent = clio-cli.models.linked_folder_base.LinkedFolder_base(
                    id = 56, 
                    etag = '', 
                    created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                ...
                contact = clio-cli.models.contact_base.Contact_base(
                    ...
                    sales_tax_number = '', ),
                document_category = clio-cli.models.document_category_base.DocumentCategory_base(
                    id = 56, 
                    etag = '', 
                    name = '', 
                    created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), ),
                creator = clio-cli.models.clio_creator_base.ClioCreator_base(
                    account_owner = True, 
                    clio_connect = True, 
                    ...
                    created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), ),
                latest_document_version = clio-cli.models.document_version_base.DocumentVersion_base(
                    id = 56, 
                    document_id = 56, 
                    etag = '', 
                    uuid = '', 
