...
from clio-cli.models.matter import Matter  # noqa: E501
    ...
    def make_instance(self, include_optional) -> Matter:
        ...
        if include_optional:
            return Matter(
                ...
                client = clio-cli.models.contact_base.Contact_base(
                    id = 56, 
                    etag = '', 
                    name = '', 
                    first_name = '', 
                    ...
                    sales_tax_number = '', ),
                contingency_fee = clio-cli.models.contingency_fee_base.ContingencyFee_base(
                    id = 56, 
                    etag = '', 
                    created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                ...
                custom_rate = None,
                evergreen_retainer = clio-cli.models.evergreen_retainer_base.EvergreenRetainer_base(
                    id = 56, 
                    created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    etag = '', 
                ...
                folder = clio-cli.models.folder_base.Folder_base(
                    ...
                    name = '', 
                    root = True, ),
                group = clio-cli.models.group_base.Group_base(
                    ...
                    type = 'UserGroup', 
                    updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), ),
                matter_budget = clio-cli.models.matter_budget_base.MatterBudget_base(
                    id = 56, 
                    etag = '', 
                    budget = 1.337, 
                    ...
                    created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), ),
                matter_stage = clio-cli.models.matter_stage_base.MatterStage_base(
                    id = 56, 
                    etag = '', 
                    practice_area_id = '', 
                    name = '', 
                    ...
                    created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), ),
                originating_attorney = clio-cli.models.user_base.User_base(
                    account_owner = True, 
                    clio_connect = True, 
                    ...
                    time_zone = '', 
                    updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), ),
                practice_area = clio-cli.models.practice_area_base.PracticeArea_base(
                    id = 56, 
                    etag = '', 
                    created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    ...
                    code = '', ),
                responsible_attorney = clio-cli.models.user_base.User_base(
                    account_owner = True, 
                    clio_connect = True, 
                    court_rules_default_attendee = True, 
                    created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    ...
                    time_zone = '', 
                    updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), ),
                statute_of_limitations = clio-cli.models.task_base.Task_base(
                    id = 56, 
                    etag = '', 
                    name = '', 
                    status = 'pending', 
                ...
                user = clio-cli.models.user_base.User_base(
                    ...
                    time_zone = '', 
                    updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), ),
                legal_aid_uk_matter = clio-cli.models.legal_aid_uk_matter_base.LegalAidUkMatter_base(
                    access_point = '', 
                    laa_office_number = '', 
                ...
                relationships = [
                    clio-cli.models.relationship_base.Relationship_base(
                        id = 56, 
                        etag = '', 
                        description = '', 
                        created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                ...
                task_template_list_instances = [
                    clio-cli.models.task_template_list_instace_base.TaskTemplateListInstace_base(
                        id = 56, 
                        etag = '', 
                        created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), )
