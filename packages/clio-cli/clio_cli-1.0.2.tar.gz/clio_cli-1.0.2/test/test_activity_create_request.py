...
from clio-cli.models.activity_create_request import ActivityCreateRequest  # noqa: E501
    ...
    def make_instance(self, include_optional) -> ActivityCreateRequest:
        ...
        if include_optional:
            return ActivityCreateRequest(
                data = clio-cli.models.activity_create_request_data.Activity_create_request_data(
