...
from clio-cli.models.report_schedule_create_request import ReportScheduleCreateRequest  # noqa: E501
    ...
    def make_instance(self, include_optional) -> ReportScheduleCreateRequest:
        ...
        if include_optional:
            return ReportScheduleCreateRequest(
                data = clio-cli.models.report_schedule_create_request_data.ReportSchedule_create_request_data(
                    day_of_month = 56, 
                    days_of_week = [
                        56
                        ], 
