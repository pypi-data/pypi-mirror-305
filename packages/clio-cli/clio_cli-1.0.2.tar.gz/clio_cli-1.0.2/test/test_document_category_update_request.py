...
from clio-cli.models.document_category_update_request import DocumentCategoryUpdateRequest  # noqa: E501
    ...
    def make_instance(self, include_optional) -> DocumentCategoryUpdateRequest:
        ...
        if include_optional:
            return DocumentCategoryUpdateRequest(
                data = clio-cli.models.document_category_update_request_data.DocumentCategory_update_request_data(
                    name = '', )
            )
        else:
            return DocumentCategoryUpdateRequest(
