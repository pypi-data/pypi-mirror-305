...
from clio-cli.api.contacts_api import ContactsApi  # noqa: E501
...
class TestContactsApi(unittest.TestCase):
    ...
    def test_contact_destroy(self) -> None:
    ...
    def test_contact_show(self) -> None:
    ...
    def test_contact_update(self) -> None:
