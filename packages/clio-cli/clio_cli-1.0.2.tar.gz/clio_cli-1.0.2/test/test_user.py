...
from clio-cli.models.user import User  # noqa: E501
    ...
    def make_instance(self, include_optional) -> User:
        ...
        if include_optional:
            return User(
                ...
                default_activity_description = clio-cli.models.activity_description_base.ActivityDescription_base(
                    id = 56, 
                    etag = '', 
                    name = '', 
                ...
                account = clio-cli.models.account_base.Account_base(
                    id = 56, 
                    etag = '', 
                    name = '', 
                    state = '', 
                ...
                contact = clio-cli.models.contact_base.Contact_base(
                    ...
                    sales_tax_number = '', ),
                job_title = clio-cli.models.job_title_base.JobTitle_base(
                    id = 56, 
                    etag = '', 
                    name = '', 
                    initials = '', ),
