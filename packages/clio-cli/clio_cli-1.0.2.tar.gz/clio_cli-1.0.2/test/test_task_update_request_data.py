...
from clio-cli.models.task_update_request_data import TaskUpdateRequestData  # noqa: E501
    ...
    def make_instance(self, include_optional) -> TaskUpdateRequestData:
        ...
        if include_optional:
            return TaskUpdateRequestData(
                assignee = clio-cli.models.task_update_request_data_assignee.Task_update_request_data_assignee(
                    id = 56, 
                    type = 'User', ),
                cascading = True,
                cascading_offset = 56,
                ...
                matter = clio-cli.models.task_create_request_data_matter.Task_create_request_data_matter(
                    id = 56, ),
                name = '',
                ...
                priority = 'Normal',
                status = 'pending',
                task_type = clio-cli.models.task_create_request_data_task_type.Task_create_request_data_task_type(
                    id = 56, ),
                time_estimated = 56
            )
        else:
