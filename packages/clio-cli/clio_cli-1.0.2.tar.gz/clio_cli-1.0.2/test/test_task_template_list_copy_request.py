...
from clio-cli.models.task_template_list_copy_request import TaskTemplateListCopyRequest  # noqa: E501
    ...
    def make_instance(self, include_optional) -> TaskTemplateListCopyRequest:
        ...
        if include_optional:
            return TaskTemplateListCopyRequest(
                data = clio-cli.models.task_template_list_copy_request_data.TaskTemplateList_copy_request_data(
                    description = '', 
                    name = '', 
                    practice_area = clio-cli.models.task_template_list_copy_request_data_practice_area.TaskTemplateList_copy_request_data_practice_area(
                        id = 56, ), )
            )
        else:
            return TaskTemplateListCopyRequest(
