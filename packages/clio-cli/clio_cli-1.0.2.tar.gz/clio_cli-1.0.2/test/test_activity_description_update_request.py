...
from clio-cli.models.activity_description_update_request import ActivityDescriptionUpdateRequest  # noqa: E501
    ...
    def make_instance(self, include_optional) -> ActivityDescriptionUpdateRequest:
        ...
        if include_optional:
            return ActivityDescriptionUpdateRequest(
                data = clio-cli.models.activity_description_update_request_data.ActivityDescription_update_request_data(
                    default = True, 
                    groups = [
                        clio-cli.models.activity_description_update_request_data_groups_inner.ActivityDescription_update_request_data_groups_inner(
                            id = 56, 
                            _deleted = True, )
                        ], 
                    name = '', 
                    rate = clio-cli.models.activity_description_create_request_data_rate.ActivityDescription_create_request_data_rate(
                        amount = 1.337, 
