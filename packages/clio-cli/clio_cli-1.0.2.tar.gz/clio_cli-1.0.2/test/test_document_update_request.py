...
from clio-cli.models.document_update_request import DocumentUpdateRequest  # noqa: E501
    ...
    def make_instance(self, include_optional) -> DocumentUpdateRequest:
        ...
        if include_optional:
            return DocumentUpdateRequest(
                data = clio-cli.models.document_update_request_data.Document_update_request_data(
                    communication_id = 56, 
                    copy_version = True, 
