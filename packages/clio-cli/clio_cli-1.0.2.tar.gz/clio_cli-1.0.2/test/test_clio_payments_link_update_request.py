...
from clio-cli.models.clio_payments_link_update_request import ClioPaymentsLinkUpdateRequest  # noqa: E501
    ...
    def make_instance(self, include_optional) -> ClioPaymentsLinkUpdateRequest:
        ...
        if include_optional:
            return ClioPaymentsLinkUpdateRequest(
                data = clio-cli.models.clio_payments_link_update_request_data.ClioPaymentsLink_update_request_data(
                    expired = True, )
            )
        else:
            return ClioPaymentsLinkUpdateRequest(
