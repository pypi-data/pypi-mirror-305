...
from clio-cli.models.reminder_update_request import ReminderUpdateRequest  # noqa: E501
    ...
    def make_instance(self, include_optional) -> ReminderUpdateRequest:
        ...
        if include_optional:
            return ReminderUpdateRequest(
                data = clio-cli.models.reminder_update_request_data.Reminder_update_request_data(
                    duration_unit = 'weeks', 
                    duration_value = 56, 
