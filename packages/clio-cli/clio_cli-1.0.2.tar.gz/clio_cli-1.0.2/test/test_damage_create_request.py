...
from clio-cli.models.damage_create_request import DamageCreateRequest  # noqa: E501
    ...
    def make_instance(self, include_optional) -> DamageCreateRequest:
        ...
        if include_optional:
            return DamageCreateRequest(
                data = clio-cli.models.damage_create_request_data.Damage_create_request_data(
                    amount = 1.337, 
                    damage_type = 'special', 
                    description = '', 
                    matter_id = 56, )
