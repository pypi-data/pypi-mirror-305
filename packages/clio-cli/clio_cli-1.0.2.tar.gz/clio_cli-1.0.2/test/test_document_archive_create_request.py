...
from clio-cli.models.document_archive_create_request import DocumentArchiveCreateRequest  # noqa: E501
    ...
    def make_instance(self, include_optional) -> DocumentArchiveCreateRequest:
        ...
        if include_optional:
            return DocumentArchiveCreateRequest(
                data = clio-cli.models.document_archive_create_request_data.DocumentArchive_create_request_data(
                    items = [
                        clio-cli.models.document_archive_create_request_data_items_inner.DocumentArchive_create_request_data_items_inner(
                            id = 56, 
                            type = 56, )
                        ], )
            )
