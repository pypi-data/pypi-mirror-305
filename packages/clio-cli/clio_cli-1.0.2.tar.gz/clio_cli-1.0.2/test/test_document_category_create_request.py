...
from clio-cli.models.document_category_create_request import DocumentCategoryCreateRequest  # noqa: E501
    ...
    def make_instance(self, include_optional) -> DocumentCategoryCreateRequest:
        ...
        if include_optional:
            return DocumentCategoryCreateRequest(
                data = clio-cli.models.document_category_create_request_data.DocumentCategory_create_request_data(
                    name = '', )
            )
        else:
            return DocumentCategoryCreateRequest(
