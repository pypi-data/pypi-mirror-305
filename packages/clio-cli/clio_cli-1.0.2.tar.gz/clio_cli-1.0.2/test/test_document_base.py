...
from clio-cli.models.document_base import DocumentBase  # noqa: E501
...
class TestDocumentBase(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DocumentBase:
        """Test DocumentBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentBase`
        """
        model = DocumentBase()  # noqa: E501
        if include_optional:
            return DocumentBase(
                id = 56,
                etag = '',
