...
from clio-cli.models.custom_action_create_request import CustomActionCreateRequest  # noqa: E501
    ...
    def make_instance(self, include_optional) -> CustomActionCreateRequest:
        ...
        if include_optional:
            return CustomActionCreateRequest(
                data = clio-cli.models.custom_action_create_request_data.CustomAction_create_request_data(
                    label = '', 
                    target_url = '', 
