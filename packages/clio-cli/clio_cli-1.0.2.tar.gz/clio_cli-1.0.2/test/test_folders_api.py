...
from clio-cli.api.folders_api import FoldersApi  # noqa: E501
...
class TestFoldersApi(unittest.TestCase):
    ...
    def test_folder_destroy(self) -> None:
    ...
    def test_folder_show(self) -> None:
    ...
    def test_folder_update(self) -> None:
