...
from clio-cli.models.conversation_membership import ConversationMembership  # noqa: E501
    ...
    def make_instance(self, include_optional) -> ConversationMembership:
        ...
        if include_optional:
            return ConversationMembership(
                ...
                member = clio-cli.models.unredacted_participant_base.UnredactedParticipant_base()
            )
        else:
            return ConversationMembership(
        )
