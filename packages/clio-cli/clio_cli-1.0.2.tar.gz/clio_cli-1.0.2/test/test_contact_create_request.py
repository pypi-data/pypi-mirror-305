...
from clio-cli.models.contact_create_request import ContactCreateRequest  # noqa: E501
    ...
    def make_instance(self, include_optional) -> ContactCreateRequest:
        ...
        if include_optional:
            return ContactCreateRequest(
                data = clio-cli.models.contact_create_request_data.Contact_create_request_data(
                    addresses = [
