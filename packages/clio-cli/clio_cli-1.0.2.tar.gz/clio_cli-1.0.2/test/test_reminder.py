...
from clio-cli.models.reminder import Reminder  # noqa: E501
    ...
    def make_instance(self, include_optional) -> Reminder:
        ...
        if include_optional:
            return Reminder(
                ...
                notification_method = clio-cli.models.notification_method_base.NotificationMethod_base(
                    id = 56, 
                    etag = '', 
                    type = 'Email', 
                    email_address = '', 
