...
from clio-cli.models.comment_update_request import CommentUpdateRequest  # noqa: E501
    ...
    def make_instance(self, include_optional) -> CommentUpdateRequest:
        ...
        if include_optional:
            return CommentUpdateRequest(
                data = clio-cli.models.comment_update_request_data.Comment_update_request_data(
