...
from clio-cli.models.document_create_request_data import DocumentCreateRequestData  # noqa: E501
        ...
        if include_optional:
            return DocumentCreateRequestData(
                ...
                document_category = clio-cli.models.document_copy_request_data_document_category.Document_copy_request_data_document_category(
                    id = 56, ),
                external_properties = [
                    clio-cli.models.document_create_request_data_external_properties_inner.Document_create_request_data_external_properties_inner(
                        name = '', 
                        value = '', )
                    ],
                filename = 'name',
                multiparts = [
                    clio-cli.models.document_create_request_data_multiparts_inner.Document_create_request_data_multiparts_inner(
                        part_number = 56, 
                        content_length = '', 
                        content_md5 = '', )
                    ],
                name = '',
                parent = clio-cli.models.document_copy_request_data_parent.Document_copy_request_data_parent(
                    id = 56, 
                    type = 'Document', ),
