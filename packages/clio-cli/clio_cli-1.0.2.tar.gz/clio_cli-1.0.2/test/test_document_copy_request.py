...
from clio-cli.models.document_copy_request import DocumentCopyRequest  # noqa: E501
    ...
    def make_instance(self, include_optional) -> DocumentCopyRequest:
        ...
        if include_optional:
            return DocumentCopyRequest(
                data = clio-cli.models.document_copy_request_data.Document_copy_request_data(
                    communication_id = 56, 
