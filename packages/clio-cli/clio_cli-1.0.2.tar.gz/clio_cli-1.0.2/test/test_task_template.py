...
from clio-cli.models.task_template import TaskTemplate  # noqa: E501
    ...
    def make_instance(self, include_optional) -> TaskTemplate:
        ...
        if include_optional:
            return TaskTemplate(
                ...
                cascading_source = clio-cli.models.cascading_task_template_base.CascadingTaskTemplate_base(
                    id = 56, 
                    name = '', ),
                assignee = clio-cli.models.user_base.User_base(
                    account_owner = True, 
                    clio_connect = True, 
                    ...
                    time_zone = '', 
                    updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), ),
                task_template_list = clio-cli.models.task_template_list_base.TaskTemplateList_base(
                    created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    description = '', 
                    id = 56, 
                    etag = '', 
                    ...
                    templates_count = 56, 
                    updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), ),
                task_type = clio-cli.models.task_type_base.TaskType_base(
                    id = 56, 
                    etag = '', 
                    name = '', 
                    ...
                    created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), ),
                template_creator = clio-cli.models.user_base.User_base(
                    account_owner = True, 
                    clio_connect = True, 
                    court_rules_default_attendee = True, 
                    created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    ...
                    updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), ),
                reminder_templates = [
                    clio-cli.models.reminder_template_base.ReminderTemplate_base(
                        id = 56, 
                        etag = '', 
                        duration = 56, 
