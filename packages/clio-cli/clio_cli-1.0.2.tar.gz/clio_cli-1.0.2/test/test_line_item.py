...
from clio-cli.models.line_item import LineItem  # noqa: E501
    ...
    def make_instance(self, include_optional) -> LineItem:
        ...
        if include_optional:
            return LineItem(
                ...
                activity = clio-cli.models.activity_base.Activity_base(
                    id = 56, 
                    etag = '', 
                    type = 'TimeEntry', 
                ...
                included_line_item_totals = clio-cli.models.line_item_totals_base.LineItemTotals_base(
                    quantity = 1.337, 
                    price = 1.337, 
