...
from clio-cli.models.task_template_list_update_request import TaskTemplateListUpdateRequest  # noqa: E501
    ...
    def make_instance(self, include_optional) -> TaskTemplateListUpdateRequest:
        ...
        if include_optional:
            return TaskTemplateListUpdateRequest(
                data = clio-cli.models.task_template_list_update_request_data.TaskTemplateList_update_request_data(
                    description = '', 
                    name = '', 
