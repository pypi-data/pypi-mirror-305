...
from clio-cli.models.contact_update_request import ContactUpdateRequest  # noqa: E501
    ...
    def make_instance(self, include_optional) -> ContactUpdateRequest:
        ...
        if include_optional:
            return ContactUpdateRequest(
                data = clio-cli.models.contact_update_request_data.Contact_update_request_data(
                    addresses = [
                        clio-cli.models.contact_update_request_data_addresses_inner.Contact_update_request_data_addresses_inner(
                            name = 'Other', 
                            street = '', 
                            city = '', 
                            province = '', 
                    ...
                    custom_field_set_associations = [
                        clio-cli.models.contact_update_request_data_custom_field_set_associations_inner.Contact_update_request_data_custom_field_set_associations_inner(
                            id = 56, 
                            display_order = 56, 
                    ...
                    custom_field_values = [
                        clio-cli.models.contact_update_request_data_custom_field_values_inner.Contact_update_request_data_custom_field_values_inner(
                            value = '', 
                    ...
                    email_addresses = [
                        clio-cli.models.contact_update_request_data_email_addresses_inner.Contact_update_request_data_email_addresses_inner(
                            id = 56, 
                            name = 'Other', 
                            address = '', 
                            default_email = True, 
                    ...
                    first_name = '', 
                    instant_messengers = [
                        clio-cli.models.contact_update_request_data_instant_messengers_inner.Contact_update_request_data_instant_messengers_inner(
                            name = 'Other', 
                            address = '', 
                            id = 56, 
                            _destroy = True, )
                    ...
                    name = '', 
                    phone_numbers = [
                        clio-cli.models.contact_update_request_data_phone_numbers_inner.Contact_update_request_data_phone_numbers_inner(
                            name = 'Other', 
                            number = '', 
                            default_number = True, 
                            id = 56, 
                    ...
                    type = 'Person', 
                    web_sites = [
                        clio-cli.models.contact_update_request_data_web_sites_inner.Contact_update_request_data_web_sites_inner(
                            name = 'Other', 
                            address = '', 
                            id = 56, 
