...
from clio-cli.api.document_templates_api import DocumentTemplatesApi  # noqa: E501
...
class TestDocumentTemplatesApi(unittest.TestCase):
    ...
    def test_document_template_create(self) -> None:
    ...
    def test_document_template_destroy(self) -> None:
    ...
    def test_document_template_download(self) -> None:
    ...
    def test_document_template_index(self) -> None:
    ...
    def test_document_template_show(self) -> None:
    ...
    def test_document_template_update(self) -> None:
