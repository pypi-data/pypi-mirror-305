...
from clio-cli.models.medical_record_update_request import MedicalRecordUpdateRequest  # noqa: E501
    ...
    def make_instance(self, include_optional) -> MedicalRecordUpdateRequest:
        ...
        if include_optional:
            return MedicalRecordUpdateRequest(
                data = clio-cli.models.medical_record_update_request_data.MedicalRecord_update_request_data(
