...
from clio-cli.models.clio_payments_payment import ClioPaymentsPayment  # noqa: E501
...
class TestClioPaymentsPayment(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ClioPaymentsPayment:
        ...
        """
        model = ClioPaymentsPayment()  # noqa: E501
        if include_optional:
            return ClioPaymentsPayment(
                ...
                bank_transaction = clio-cli.models.bank_transaction_base.BankTransaction_base(
                    id = 56, 
                    type = '', 
                    etag = '', 
                    created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                ...
                clio_payments_link = clio-cli.models.clio_payments_link_base.ClioPaymentsLink_base(
                    active = True, 
                    amount = 1.337, 
                    created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    currency = '', 
                ...
                user = clio-cli.models.user_base.User_base(
                    ...
                    updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), ),
                allocations = [
                    clio-cli.models.allocation_base.Allocation_base(
                        id = 56, 
                        etag = '', 
                        date = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(), 
                        amount = 1.337, 
