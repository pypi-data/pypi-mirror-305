...
from clio-cli.models.activity_update_request import ActivityUpdateRequest  # noqa: E501
    ...
    def make_instance(self, include_optional) -> ActivityUpdateRequest:
        ...
        if include_optional:
            return ActivityUpdateRequest(
                data = clio-cli.models.activity_update_request_data.Activity_update_request_data(
