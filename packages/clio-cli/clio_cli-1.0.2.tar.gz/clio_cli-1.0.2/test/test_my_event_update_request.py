...
from clio-cli.models.my_event_update_request import MyEventUpdateRequest  # noqa: E501
    ...
    def make_instance(self, include_optional) -> MyEventUpdateRequest:
        ...
        if include_optional:
            return MyEventUpdateRequest(
                data = clio-cli.models.my_event_update_request_data.MyEvent_update_request_data(
                    marked_as_read = True, )
            )
        else:
            return MyEventUpdateRequest(
