...
from clio-cli.models.report_create_request import ReportCreateRequest  # noqa: E501
    ...
    def make_instance(self, include_optional) -> ReportCreateRequest:
        ...
        if include_optional:
            return ReportCreateRequest(
                data = clio-cli.models.report_create_request_data.Report_create_request_data(
