...
from clio-cli.models.medical_bill import MedicalBill  # noqa: E501

class TestMedicalBill(unittest.TestCase):
    """MedicalBill unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MedicalBill:
        """Test MedicalBill
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MedicalBill`
        """
        model = MedicalBill()  # noqa: E501
        if include_optional:
            return MedicalBill(
                id = 56,
                adjustment = 1.337,
                ...
                liens = [
                    clio-cli.models.lien_base.Lien_base(
                        id = 56, 
                        amount = 1.337, 
                        description = '', 
                        etag = '', 
