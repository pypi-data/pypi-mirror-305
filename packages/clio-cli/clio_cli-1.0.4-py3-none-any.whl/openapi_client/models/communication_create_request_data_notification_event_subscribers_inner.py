...
class CommunicationCreateRequestDataNotificationEventSubscribersInner(BaseModel):
    """
    CommunicationCreateRequestDataNotificationEventSubscribersInner
    """
    user_id: StrictStr = Field(default=..., description="The unique identifier for a User to be added as a notification event subscriber to the Phone Log Communication. Note: Only applicable to Phone Log Communications, invalid for other communication types.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CommunicationCreateRequestDataNotificationEventSubscribersInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CommunicationCreateRequestDataNotificationEventSubscribersInner:
        """Create an instance of CommunicationCreateRequestDataNotificationEventSubscribersInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CommunicationCreateRequestDataNotificationEventSubscribersInner.parse_obj(obj)

        _obj = CommunicationCreateRequestDataNotificationEventSubscribersInner.parse_obj({
