...
class MatterDocketBase(BaseModel):
    ...
    __properties = ["id", "etag", "name", "start_date", "start_time", "status", "created_at", "updated_at", "deleted_at"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MatterDocketBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MatterDocketBase:
        """Create an instance of MatterDocketBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MatterDocketBase.parse_obj(obj)

        _obj = MatterDocketBase.parse_obj({
            "id": obj.get("id"),
            "etag": obj.get("etag"),
            "name": obj.get("name"),
