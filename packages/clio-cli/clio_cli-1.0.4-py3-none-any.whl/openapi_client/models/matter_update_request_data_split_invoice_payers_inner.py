...
class MatterUpdateRequestDataSplitInvoicePayersInner(BaseModel):
    """
    MatterUpdateRequestDataSplitInvoicePayersInner
    """
    contact_id: Optional[StrictInt] = Field(default=None, description="Contact id for the matter payer.")
    id: Optional[StrictInt] = Field(default=None, description="The id for the payer.")
    send_to_bill_recipients: Optional[StrictBool] = Field(default=None, description="Boolean indication to send a split invoice to all bill recipients.")
    split_portion: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The split portion for the payer.")
    destroy: Optional[StrictBool] = Field(default=None, alias="_destroy", description="If this flag is set to `true`, the split invoice payer will be deleted from the Matter.")
    __properties = ["contact_id", "id", "send_to_bill_recipients", "split_portion", "_destroy"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MatterUpdateRequestDataSplitInvoicePayersInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MatterUpdateRequestDataSplitInvoicePayersInner:
        """Create an instance of MatterUpdateRequestDataSplitInvoicePayersInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MatterUpdateRequestDataSplitInvoicePayersInner.parse_obj(obj)

        _obj = MatterUpdateRequestDataSplitInvoicePayersInner.parse_obj({
            "contact_id": obj.get("contact_id"),
            "id": obj.get("id"),
            "send_to_bill_recipients": obj.get("send_to_bill_recipients"),
            "split_portion": obj.get("split_portion"),
