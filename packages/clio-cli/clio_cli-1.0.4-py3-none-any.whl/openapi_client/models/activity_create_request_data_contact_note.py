...
class ActivityCreateRequestDataContactNote(BaseModel):
    """
    ActivityCreateRequestDataContactNote
    """
    id: Optional[StrictInt] = Field(default=None, description="The unique identifier for a single Note associated with the Activity. The keyword `null` is not valid for this field.")
    __properties = ["id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ActivityCreateRequestDataContactNote:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ActivityCreateRequestDataContactNote:
        """Create an instance of ActivityCreateRequestDataContactNote from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ActivityCreateRequestDataContactNote.parse_obj(obj)

        _obj = ActivityCreateRequestDataContactNote.parse_obj({
            "id": obj.get("id")
        })
        return _obj
