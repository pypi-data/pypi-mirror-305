...
class CalendarVisibilityBase(BaseModel):
    ...
    __properties = ["id", "etag", "color", "light_color", "visible", "name", "created_at", "updated_at"]
    ...
    def color_validate_enum(cls, value):
        ...
        if value not in ('#658CDA', '#DA6666', '#49B050', '#E7804C', '#8C66DA', '#C4A882', '#64AD88', '#84AAA5', '#56BFB3', '#E77399', '#BFBF4B', '#8BBF3C', '#B473B4', '#A7A77D', '#F2A53D', '#658CB3', '#BE9494', '#A992A9', '#8897A5', '#93A2BE'):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CalendarVisibilityBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CalendarVisibilityBase:
        """Create an instance of CalendarVisibilityBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CalendarVisibilityBase.parse_obj(obj)

        _obj = CalendarVisibilityBase.parse_obj({
            "id": obj.get("id"),
            "etag": obj.get("etag"),
            "color": obj.get("color"),
