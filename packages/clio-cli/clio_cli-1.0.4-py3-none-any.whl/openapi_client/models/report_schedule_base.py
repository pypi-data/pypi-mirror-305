...
class ReportScheduleBase(BaseModel):
    ...
    days_of_week: Optional[conlist(StrictInt)] = Field(default=None, description="If the frequency is weekly, which days of the week the Report Schedule is run. Values are 0 to 6, representing Sunday to Saturday.")
    ...
    __properties = ["id", "etag", "time_of_day", "frequency", "days_of_week", "day_of_month", "status", "status_updated_at", "next_scheduled_date", "time_zone", "report_preset_id", "created_at", "updated_at", "every_no_of_months", "effective_from"]
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in ('initial', 'queued', 'processing', 'failed', 'completed'):
            raise ValueError("must be one of enum values ('initial', 'queued', 'processing', 'failed', 'completed')")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ReportScheduleBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ReportScheduleBase:
        """Create an instance of ReportScheduleBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ReportScheduleBase.parse_obj(obj)

        _obj = ReportScheduleBase.parse_obj({
            "id": obj.get("id"),
            "etag": obj.get("etag"),
            ...
            "next_scheduled_date": obj.get("next_scheduled_date"),
            "time_zone": obj.get("time_zone"),
            "report_preset_id": obj.get("report_preset_id"),
            "created_at": obj.get("created_at"),
            "updated_at": obj.get("updated_at"),
            "every_no_of_months": obj.get("every_no_of_months"),
