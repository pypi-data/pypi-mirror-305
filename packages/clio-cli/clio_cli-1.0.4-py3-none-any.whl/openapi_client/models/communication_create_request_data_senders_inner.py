...
class CommunicationCreateRequestDataSendersInner(BaseModel):
    """
    CommunicationCreateRequestDataSendersInner
    """
    deleted: Optional[StrictBool] = Field(default=None, alias="_deleted", description="Whether or not the senders should be deleted.")
    id: Optional[StrictInt] = Field(default=None, description="Unique ids for the senders of this Communication.")
    type: Optional[StrictStr] = Field(default=None, description="Types of the senders of this Communication.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CommunicationCreateRequestDataSendersInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CommunicationCreateRequestDataSendersInner:
        """Create an instance of CommunicationCreateRequestDataSendersInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CommunicationCreateRequestDataSendersInner.parse_obj(obj)

        _obj = CommunicationCreateRequestDataSendersInner.parse_obj({
