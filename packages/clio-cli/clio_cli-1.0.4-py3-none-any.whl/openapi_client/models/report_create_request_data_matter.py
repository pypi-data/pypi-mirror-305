...
class ReportCreateRequestDataMatter(BaseModel):
    """
    ReportCreateRequestDataMatter
    """
    id: Optional[StrictInt] = Field(default=None, description="The unique identifier for a single Matter associated with the Report. The keyword `null` is not valid for this field.")
    __properties = ["id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ReportCreateRequestDataMatter:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ReportCreateRequestDataMatter:
        """Create an instance of ReportCreateRequestDataMatter from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ReportCreateRequestDataMatter.parse_obj(obj)

        _obj = ReportCreateRequestDataMatter.parse_obj({
            "id": obj.get("id")
        })
        return _obj
