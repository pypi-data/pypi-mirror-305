...
class NotificationMethodBase(BaseModel):
    ...
    """
    id: Optional[StrictInt] = Field(default=None, description="Unique identifier for the *NotificationMethod*")
    etag: Optional[StrictStr] = Field(default=None, description="ETag for the *NotificationMethod*")
    type: Optional[StrictStr] = Field(default=None, description="Human readable description of the type of notification")
    email_address: Optional[StrictStr] = Field(default=None, description="Email address to send the notification to (only for email type)")
    is_default_email_address: Optional[StrictBool] = Field(default=None, description="A boolean that is returned only on notification method objects that are relevant e.g. Email notification or Alternative Email")
    created_at: Optional[datetime] = Field(default=None, description="The time the *NotificationMethod* was created (as a ISO-8601 timestamp)")
    updated_at: Optional[datetime] = Field(default=None, description="The time the *NotificationMethod* was last updated (as a ISO-8601 timestamp)")
    __properties = ["id", "etag", "type", "email_address", "is_default_email_address", "created_at", "updated_at"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in ('Email', 'Popup', 'SMS'):
            raise ValueError("must be one of enum values ('Email', 'Popup', 'SMS')")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NotificationMethodBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NotificationMethodBase:
        """Create an instance of NotificationMethodBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NotificationMethodBase.parse_obj(obj)

        _obj = NotificationMethodBase.parse_obj({
            "id": obj.get("id"),
            "etag": obj.get("etag"),
            "type": obj.get("type"),
            "email_address": obj.get("email_address"),
            "is_default_email_address": obj.get("is_default_email_address"),
