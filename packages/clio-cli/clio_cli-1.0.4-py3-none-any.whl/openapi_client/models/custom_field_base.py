...
class CustomFieldBase(BaseModel):
    ...
    __properties = ["id", "etag", "created_at", "updated_at", "name", "parent_type", "field_type", "displayed", "deleted", "required", "display_order"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CustomFieldBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CustomFieldBase:
        """Create an instance of CustomFieldBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CustomFieldBase.parse_obj(obj)

        _obj = CustomFieldBase.parse_obj({
            "id": obj.get("id"),
            "etag": obj.get("etag"),
