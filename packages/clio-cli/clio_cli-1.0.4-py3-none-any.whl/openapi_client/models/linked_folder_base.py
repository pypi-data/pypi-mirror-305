...
class LinkedFolderBase(BaseModel):
    ...
    __properties = ["id", "etag", "created_at", "updated_at", "deleted_at", "type", "locked", "name", "root"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LinkedFolderBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LinkedFolderBase:
        """Create an instance of LinkedFolderBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LinkedFolderBase.parse_obj(obj)

        _obj = LinkedFolderBase.parse_obj({
            "id": obj.get("id"),
            "etag": obj.get("etag"),
