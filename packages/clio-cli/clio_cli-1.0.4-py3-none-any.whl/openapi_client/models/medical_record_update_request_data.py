...
class MedicalRecordUpdateRequestData(BaseModel):
    """
    ...
    __properties = ["end_date", "start_date"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MedicalRecordUpdateRequestData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MedicalRecordUpdateRequestData:
        """Create an instance of MedicalRecordUpdateRequestData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MedicalRecordUpdateRequestData.parse_obj(obj)

        _obj = MedicalRecordUpdateRequestData.parse_obj({
