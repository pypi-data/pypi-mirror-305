...
class PracticeAreaCreateRequestData(BaseModel):
    ...
    name: StrictStr = Field(default=..., description="Name of the PracticeArea.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PracticeAreaCreateRequestData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PracticeAreaCreateRequestData:
        """Create an instance of PracticeAreaCreateRequestData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PracticeAreaCreateRequestData.parse_obj(obj)

        _obj = PracticeAreaCreateRequestData.parse_obj({
