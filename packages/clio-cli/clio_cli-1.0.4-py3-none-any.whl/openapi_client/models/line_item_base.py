...
class LineItemBase(BaseModel):
    ...
    __properties = ["id", "etag", "type", "description", "date", "price", "taxable", "kind", "note", "secondary_taxable", "total", "tax", "secondary_tax", "sub_total", "quantity", "group_ordering", "created_at", "updated_at"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LineItemBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LineItemBase:
        """Create an instance of LineItemBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LineItemBase.parse_obj(obj)

        _obj = LineItemBase.parse_obj({
            "id": obj.get("id"),
            "etag": obj.get("etag"),
            "type": obj.get("type"),
