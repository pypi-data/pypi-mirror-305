...
class ClioPaymentsLinkCreateRequestDataDestinationAccount(BaseModel):
    """
    ClioPaymentsLinkCreateRequestDataDestinationAccount
    """
    id: StrictInt = Field(default=..., description="The ID of the bank account that the payment will be deposited into.")
    __properties = ["id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ClioPaymentsLinkCreateRequestDataDestinationAccount:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ClioPaymentsLinkCreateRequestDataDestinationAccount:
        """Create an instance of ClioPaymentsLinkCreateRequestDataDestinationAccount from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ClioPaymentsLinkCreateRequestDataDestinationAccount.parse_obj(obj)

        _obj = ClioPaymentsLinkCreateRequestDataDestinationAccount.parse_obj({
            "id": obj.get("id")
        })
        return _obj
