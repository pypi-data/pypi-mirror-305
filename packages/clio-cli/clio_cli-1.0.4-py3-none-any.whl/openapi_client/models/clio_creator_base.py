...
class ClioCreatorBase(BaseModel):
    ...
    roles: Optional[conlist(StrictStr)] = Field(default=None, description="An array of roles assigned to this *ClioCreator*")
    ...
    __properties = ["account_owner", "clio_connect", "court_rules_default_attendee", "default_calendar_id", "email", "enabled", "etag", "id", "type", "initials", "first_name", "last_name", "name", "phone_number", "rate", "subscription_type", "time_zone", "roles", "created_at", "updated_at"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in ('ManageUser', 'ClientUser'):
            raise ValueError("must be one of enum values ('ManageUser', 'ClientUser')")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ClioCreatorBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ClioCreatorBase:
        """Create an instance of ClioCreatorBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ClioCreatorBase.parse_obj(obj)

        _obj = ClioCreatorBase.parse_obj({
