...
class CalendarEntryCreateRequestDataConferenceMeeting(BaseModel):
    """
    CalendarEntryCreateRequestDataConferenceMeeting
    """
    type: Optional[StrictStr] = Field(default=None, description="The type of conference meeting. If no conference meeting is present or the user is in an ineligible pricing tier for this feature, it will be null.")
    __properties = ["type"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CalendarEntryCreateRequestDataConferenceMeeting:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CalendarEntryCreateRequestDataConferenceMeeting:
        """Create an instance of CalendarEntryCreateRequestDataConferenceMeeting from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CalendarEntryCreateRequestDataConferenceMeeting.parse_obj(obj)

        _obj = CalendarEntryCreateRequestDataConferenceMeeting.parse_obj({
            "type": obj.get("type")
        })
        return _obj
