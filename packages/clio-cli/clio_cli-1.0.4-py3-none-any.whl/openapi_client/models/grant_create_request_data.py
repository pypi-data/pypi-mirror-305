...
class GrantCreateRequestData(BaseModel):
    """
    GrantCreateRequestData
    """
    name: Optional[StrictStr] = Field(default=None, description="Name of the Grant.")
    __properties = ["name"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GrantCreateRequestData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GrantCreateRequestData:
        """Create an instance of GrantCreateRequestData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GrantCreateRequestData.parse_obj(obj)

        _obj = GrantCreateRequestData.parse_obj({
            "name": obj.get("name")
        })
        return _obj
