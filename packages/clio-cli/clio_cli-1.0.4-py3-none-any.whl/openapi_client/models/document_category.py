...
class DocumentCategory(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DocumentCategory:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DocumentCategory:
        """Create an instance of DocumentCategory from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DocumentCategory.parse_obj(obj)

        _obj = DocumentCategory.parse_obj({
            "id": obj.get("id"),
            "etag": obj.get("etag"),
            "name": obj.get("name"),
