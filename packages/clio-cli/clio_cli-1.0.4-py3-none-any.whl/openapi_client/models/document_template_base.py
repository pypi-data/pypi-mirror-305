...
class DocumentTemplateBase(BaseModel):
    ...
    __properties = ["id", "etag", "size", "content_type", "filename", "created_at", "updated_at"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DocumentTemplateBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DocumentTemplateBase:
        """Create an instance of DocumentTemplateBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DocumentTemplateBase.parse_obj(obj)

        _obj = DocumentTemplateBase.parse_obj({
            "id": obj.get("id"),
            "etag": obj.get("etag"),
            "size": obj.get("size"),
