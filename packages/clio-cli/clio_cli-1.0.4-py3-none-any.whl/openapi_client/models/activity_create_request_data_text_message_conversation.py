...
class ActivityCreateRequestDataTextMessageConversation(BaseModel):
    """
    ActivityCreateRequestDataTextMessageConversation
    """
    id: Optional[StrictInt] = Field(default=None, description="The unique identifier for a single TextMessageConversation associated with the Activity. The keyword `null` is not valid for this field.")
    __properties = ["id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ActivityCreateRequestDataTextMessageConversation:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ActivityCreateRequestDataTextMessageConversation:
        """Create an instance of ActivityCreateRequestDataTextMessageConversation from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ActivityCreateRequestDataTextMessageConversation.parse_obj(obj)

        _obj = ActivityCreateRequestDataTextMessageConversation.parse_obj({
            "id": obj.get("id")
        })
        return _obj
