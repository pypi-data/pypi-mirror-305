...
class ContactUpdateRequestDataEmailAddressesInner(BaseModel):
    """
    ...
    destroy: Optional[StrictBool] = Field(default=None, alias="_destroy", description="The destroy flag. If the flag is set to `true` and the unique identifier of the associated EmailAddress is present, the EmailAddress is deleted from the Contact.")
    __properties = ["id", "name", "address", "default_email", "_destroy"]
    ...
    def name_validate_enum(cls, value):
        ...
        if value not in ('Work', 'Home', 'Other'):
            raise ValueError("must be one of enum values ('Work', 'Home', 'Other')")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ContactUpdateRequestDataEmailAddressesInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ContactUpdateRequestDataEmailAddressesInner:
        """Create an instance of ContactUpdateRequestDataEmailAddressesInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ContactUpdateRequestDataEmailAddressesInner.parse_obj(obj)

        _obj = ContactUpdateRequestDataEmailAddressesInner.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name") if obj.get("name") is not None else 'Other',
            "address": obj.get("address"),
            "default_email": obj.get("default_email"),
