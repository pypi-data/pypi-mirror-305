...
class CommentBase(BaseModel):
    ...
    __properties = ["id", "etag", "message", "created_at", "updated_at"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CommentBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CommentBase:
        """Create an instance of CommentBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CommentBase.parse_obj(obj)

        _obj = CommentBase.parse_obj({
            "id": obj.get("id"),
            "etag": obj.get("etag"),
