...
class ActivityRateCreateRequestData(BaseModel):
    """
    ActivityRateCreateRequestData
    """
    co_counsel_contact_id: Optional[StrictInt] = Field(default=None, description="The unique identifier for a single Contact associated with the ActivityRate. The keyword `null` is not valid for this field.")
    contact_id: Optional[StrictInt] = Field(default=None, description="The unique identifier for a single Contact associated with the ActivityRate. The keyword `null` is not valid for this field.")
    ...
    __properties = ["co_counsel_contact_id", "contact_id", "flat_rate", "rate"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ActivityRateCreateRequestData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ActivityRateCreateRequestData:
        """Create an instance of ActivityRateCreateRequestData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ActivityRateCreateRequestData.parse_obj(obj)

        _obj = ActivityRateCreateRequestData.parse_obj({
