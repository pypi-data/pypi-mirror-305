...
class DocumentArchiveBase(BaseModel):
    ...
    __properties = ["id", "etag", "created_at", "updated_at", "size", "progress", "state", "message"]
    ...
    def state_validate_enum(cls, value):
        ...
        if value not in ('not_started', 'queued', 'in_progress', 'completed', 'failed'):
            raise ValueError("must be one of enum values ('not_started', 'queued', 'in_progress', 'completed', 'failed')")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DocumentArchiveBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DocumentArchiveBase:
        """Create an instance of DocumentArchiveBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DocumentArchiveBase.parse_obj(obj)

        _obj = DocumentArchiveBase.parse_obj({
            "id": obj.get("id"),
            "etag": obj.get("etag"),
