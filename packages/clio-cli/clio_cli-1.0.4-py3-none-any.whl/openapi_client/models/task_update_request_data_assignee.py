...
class TaskUpdateRequestDataAssignee(BaseModel):
    """
    TaskUpdateRequestDataAssignee
    """
    id: Optional[StrictInt] = Field(default=None, description="The unique identifier for a single User or Contact associated with the Task. The keyword `null` is not valid for this field.")
    type: Optional[StrictStr] = Field(default=None, description="Model type of the assignee.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TaskUpdateRequestDataAssignee:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TaskUpdateRequestDataAssignee:
        """Create an instance of TaskUpdateRequestDataAssignee from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TaskUpdateRequestDataAssignee.parse_obj(obj)

        _obj = TaskUpdateRequestDataAssignee.parse_obj({
            "id": obj.get("id"),
            "type": obj.get("type")
        })
        return _obj
