...
class TimerBase(BaseModel):
    ...
    __properties = ["id", "etag", "start_time", "elapsed_time", "created_at", "updated_at"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TimerBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TimerBase:
        """Create an instance of TimerBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TimerBase.parse_obj(obj)

        _obj = TimerBase.parse_obj({
            "id": obj.get("id"),
            "etag": obj.get("etag"),
