...
class TaskTemplateListCreateRequestDataPracticeArea(BaseModel):
    """
    TaskTemplateListCreateRequestDataPracticeArea
    """
    id: Optional[StrictInt] = Field(default=None, description="The unique identifier for a single PracticeArea associated with the TaskTemplateList. The keyword `null` is not valid for this field.")
    __properties = ["id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TaskTemplateListCreateRequestDataPracticeArea:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TaskTemplateListCreateRequestDataPracticeArea:
        """Create an instance of TaskTemplateListCreateRequestDataPracticeArea from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TaskTemplateListCreateRequestDataPracticeArea.parse_obj(obj)

        _obj = TaskTemplateListCreateRequestDataPracticeArea.parse_obj({
            "id": obj.get("id")
        })
        return _obj
