...
class TaskCreateRequestDataTaskType(BaseModel):
    """
    TaskCreateRequestDataTaskType
    """
    id: Optional[StrictInt] = Field(default=None, description="The unique identifier for a single TaskType associated with the Task. The keyword `null` is not valid for this field.")
    __properties = ["id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TaskCreateRequestDataTaskType:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TaskCreateRequestDataTaskType:
        """Create an instance of TaskCreateRequestDataTaskType from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TaskCreateRequestDataTaskType.parse_obj(obj)

        _obj = TaskCreateRequestDataTaskType.parse_obj({
            "id": obj.get("id")
        })
        return _obj
