...
class InterestChargeBase(BaseModel):
    ...
    __properties = ["id", "etag", "date", "description", "total", "created_at", "updated_at"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InterestChargeBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InterestChargeBase:
        """Create an instance of InterestChargeBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return InterestChargeBase.parse_obj(obj)

        _obj = InterestChargeBase.parse_obj({
            "id": obj.get("id"),
            "etag": obj.get("etag"),
