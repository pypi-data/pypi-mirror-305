...
class MedicalRecordsRequestUpdateRequestDataMedicalRecordsInner(BaseModel):
    """
    MedicalRecordsRequestUpdateRequestDataMedicalRecordsInner
    """
    document_id: Optional[StrictInt] = Field(default=None, description="The unique identifier for a single MedicalRecord associated with the MedicalRecordsRequest. The keyword `null` is not valid for this field.")
    end_date: Optional[datetime] = Field(default=None, description="End date for Medical Record.")
    start_date: Optional[datetime] = Field(default=None, description="Start date for Medical Record.")
    __properties = ["document_id", "end_date", "start_date"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MedicalRecordsRequestUpdateRequestDataMedicalRecordsInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MedicalRecordsRequestUpdateRequestDataMedicalRecordsInner:
        """Create an instance of MedicalRecordsRequestUpdateRequestDataMedicalRecordsInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MedicalRecordsRequestUpdateRequestDataMedicalRecordsInner.parse_obj(obj)

        _obj = MedicalRecordsRequestUpdateRequestDataMedicalRecordsInner.parse_obj({
