...
class ClioPaymentsLinkBase(BaseModel):
    ...
    __properties = ["active", "amount", "created_at", "currency", "description", "email_address", "etag", "expires_at", "id", "is_allocated_as_revenue", "redirect_url", "url"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ClioPaymentsLinkBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ClioPaymentsLinkBase:
        """Create an instance of ClioPaymentsLinkBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ClioPaymentsLinkBase.parse_obj(obj)

        _obj = ClioPaymentsLinkBase.parse_obj({
