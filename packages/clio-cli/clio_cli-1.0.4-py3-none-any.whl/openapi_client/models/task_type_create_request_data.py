...
class TaskTypeCreateRequestData(BaseModel):
    """
    ...
    name: StrictStr = Field(default=..., description="Name of the TaskType.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TaskTypeCreateRequestData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TaskTypeCreateRequestData:
        """Create an instance of TaskTypeCreateRequestData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TaskTypeCreateRequestData.parse_obj(obj)

        _obj = TaskTypeCreateRequestData.parse_obj({
