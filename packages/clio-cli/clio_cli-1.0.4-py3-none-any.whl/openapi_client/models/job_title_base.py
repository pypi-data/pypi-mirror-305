...
class JobTitleBase(BaseModel):
    ...
    JobTitleBase
    """
    id: Optional[StrictInt] = Field(default=None, description="Unique identifier for the *JobTitle*")
    etag: Optional[StrictStr] = Field(default=None, description="ETag for the *JobTitle*")
    name: Optional[StrictStr] = Field(default=None, description="Name of the job title")
    initials: Optional[StrictStr] = Field(default=None, description="Initials of the job title")
    __properties = ["id", "etag", "name", "initials"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> JobTitleBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> JobTitleBase:
        """Create an instance of JobTitleBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return JobTitleBase.parse_obj(obj)

        _obj = JobTitleBase.parse_obj({
            "id": obj.get("id"),
            "etag": obj.get("etag"),
            "name": obj.get("name"),
