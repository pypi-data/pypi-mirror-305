...
class ConversationMembershipBase(BaseModel):
    ...
    """
    id: Optional[StrictInt] = Field(default=None, description="Unique identifier for the *ConversationMembership*")
    etag: Optional[StrictStr] = Field(default=None, description="ETag for the *ConversationMembership*")
    read: Optional[StrictBool] = Field(default=None, description="Whether or not the ConversationMembership has been read by the member")
    archived: Optional[StrictBool] = Field(default=None, description="Whether or not the ConversationMembership has been archived by the member")
    created_at: Optional[datetime] = Field(default=None, description="The time the *ConversationMembership* was created (as a ISO-8601 timestamp)")
    updated_at: Optional[datetime] = Field(default=None, description="The time the *ConversationMembership* was last updated (as a ISO-8601 timestamp)")
    __properties = ["id", "etag", "read", "archived", "created_at", "updated_at"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ConversationMembershipBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ConversationMembershipBase:
        """Create an instance of ConversationMembershipBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ConversationMembershipBase.parse_obj(obj)

        _obj = ConversationMembershipBase.parse_obj({
            "id": obj.get("id"),
            "etag": obj.get("etag"),
            "read": obj.get("read"),
