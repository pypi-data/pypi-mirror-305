...
class CustomFieldMatterSelection(BaseModel):
    """
    CustomFieldMatterSelection
    """
    id: Optional[StrictInt] = Field(default=None, description="Unique identifier for the *CustomFieldMatterSelection*")
    display_number: Optional[StrictStr] = Field(default=None, description="The reference and label of the *CustomFieldMatterSelection*. Depending on the account's manual_matter_numbering setting, this is either read only (generated) or customizable.")
    __properties = ["id", "display_number"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CustomFieldMatterSelection:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CustomFieldMatterSelection:
        """Create an instance of CustomFieldMatterSelection from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CustomFieldMatterSelection.parse_obj(obj)

        _obj = CustomFieldMatterSelection.parse_obj({
            "id": obj.get("id"),
