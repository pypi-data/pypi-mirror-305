...
class ConversationUpdateRequestDataMatter(BaseModel):
    """
    ConversationUpdateRequestDataMatter
    """
    id: Optional[StrictInt] = Field(default=None, description="The unique identifier for a single Matter associated with the Conversation. The keyword `null` is not valid for this field.")
    __properties = ["id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ConversationUpdateRequestDataMatter:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ConversationUpdateRequestDataMatter:
        """Create an instance of ConversationUpdateRequestDataMatter from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ConversationUpdateRequestDataMatter.parse_obj(obj)

        _obj = ConversationUpdateRequestDataMatter.parse_obj({
            "id": obj.get("id")
        })
        return _obj
