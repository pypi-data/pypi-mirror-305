...
class DocumentCategoryUpdateRequestData(BaseModel):
    """
    DocumentCategoryUpdateRequestData
    """
    name: Optional[StrictStr] = Field(default=None, description="What the DocumentCategory should be called.")
    __properties = ["name"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DocumentCategoryUpdateRequestData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DocumentCategoryUpdateRequestData:
        """Create an instance of DocumentCategoryUpdateRequestData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DocumentCategoryUpdateRequestData.parse_obj(obj)

        _obj = DocumentCategoryUpdateRequestData.parse_obj({
            "name": obj.get("name")
        })
        return _obj
