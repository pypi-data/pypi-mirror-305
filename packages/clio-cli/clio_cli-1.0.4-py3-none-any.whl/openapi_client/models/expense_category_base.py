...
class ExpenseCategoryBase(BaseModel):
    ...
    __properties = ["id", "etag", "name", "rate", "entry_type", "created_at", "updated_at", "xero_expense_code", "accessible_to_user", "tax_setting"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ExpenseCategoryBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ExpenseCategoryBase:
        """Create an instance of ExpenseCategoryBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ExpenseCategoryBase.parse_obj(obj)

        _obj = ExpenseCategoryBase.parse_obj({
            "id": obj.get("id"),
            "etag": obj.get("etag"),
            "name": obj.get("name"),
            "rate": obj.get("rate"),
