...
class LaukExpenseCategory(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LaukExpenseCategory:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LaukExpenseCategory:
        """Create an instance of LaukExpenseCategory from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LaukExpenseCategory.parse_obj(obj)

        _obj = LaukExpenseCategory.parse_obj({
