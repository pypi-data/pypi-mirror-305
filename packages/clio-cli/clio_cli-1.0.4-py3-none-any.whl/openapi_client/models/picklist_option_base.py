...
class PicklistOptionBase(BaseModel):
    ...
    PicklistOptionBase
    """
    id: Optional[StrictInt] = Field(default=None, description="Unique identifier for the *PicklistOption*")
    etag: Optional[StrictStr] = Field(default=None, description="ETag for the *PicklistOption*")
    created_at: Optional[datetime] = Field(default=None, description="The time the *PicklistOption* was created (as a ISO-8601 timestamp)")
    updated_at: Optional[datetime] = Field(default=None, description="The time the *PicklistOption* was last updated (as a ISO-8601 timestamp)")
    option: Optional[StrictStr] = Field(default=None, description="The value of the *PicklistOption*")
    deleted_at: Optional[datetime] = Field(default=None, description="The time the *PicklistOption* was deleted (as a ISO-8601 timestamp)")
    __properties = ["id", "etag", "created_at", "updated_at", "option", "deleted_at"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PicklistOptionBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PicklistOptionBase:
        """Create an instance of PicklistOptionBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PicklistOptionBase.parse_obj(obj)

        _obj = PicklistOptionBase.parse_obj({
            "id": obj.get("id"),
            "etag": obj.get("etag"),
