...
class CustomFieldSetAssociationBase(BaseModel):
    ...
    """
    id: Optional[StrictInt] = Field(default=None, description="Unique identifier for the *CustomFieldSetAssociation*")
    etag: Optional[StrictStr] = Field(default=None, description="ETag for the *CustomFieldSetAssociation*")
    display_order: Optional[StrictInt] = Field(default=None, description="The display position of the *CustomFieldSetAssociation*")
    created_at: Optional[datetime] = Field(default=None, description="The time the *CustomFieldSetAssociation* was created (as a ISO-8601 timestamp)")
    updated_at: Optional[datetime] = Field(default=None, description="The time the *CustomFieldSetAssociation* was last updated (as a ISO-8601 timestamp)")
    __properties = ["id", "etag", "display_order", "created_at", "updated_at"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CustomFieldSetAssociationBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CustomFieldSetAssociationBase:
        """Create an instance of CustomFieldSetAssociationBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CustomFieldSetAssociationBase.parse_obj(obj)

        _obj = CustomFieldSetAssociationBase.parse_obj({
            "id": obj.get("id"),
            "etag": obj.get("etag"),
