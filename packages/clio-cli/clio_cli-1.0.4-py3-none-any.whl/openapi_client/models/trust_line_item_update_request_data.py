...
class TrustLineItemUpdateRequestData(BaseModel):
    """
    TrustLineItemUpdateRequestData
    """
    var_date: Optional[date] = Field(default=None, alias="date", description="Date for the TrustLineItem. (Expects an ISO-8601 date).")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TrustLineItemUpdateRequestData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TrustLineItemUpdateRequestData:
        """Create an instance of TrustLineItemUpdateRequestData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TrustLineItemUpdateRequestData.parse_obj(obj)

        _obj = TrustLineItemUpdateRequestData.parse_obj({
