...
class FolderCreateRequestDataDocumentCategory(BaseModel):
    """
    FolderCreateRequestDataDocumentCategory
    """
    id: Optional[StrictInt] = Field(default=None, description="The unique identifier for a single DocumentCategory associated with the Folder. Use the keyword `null` to specify no association.")
    __properties = ["id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FolderCreateRequestDataDocumentCategory:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FolderCreateRequestDataDocumentCategory:
        """Create an instance of FolderCreateRequestDataDocumentCategory from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FolderCreateRequestDataDocumentCategory.parse_obj(obj)

        _obj = FolderCreateRequestDataDocumentCategory.parse_obj({
            "id": obj.get("id")
        })
        return _obj
