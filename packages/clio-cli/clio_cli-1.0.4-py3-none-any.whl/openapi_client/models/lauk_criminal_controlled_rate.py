...
class LaukCriminalControlledRate(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LaukCriminalControlledRate:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LaukCriminalControlledRate:
        """Create an instance of LaukCriminalControlledRate from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LaukCriminalControlledRate.parse_obj(obj)

        _obj = LaukCriminalControlledRate.parse_obj({
            "id": obj.get("id"),
