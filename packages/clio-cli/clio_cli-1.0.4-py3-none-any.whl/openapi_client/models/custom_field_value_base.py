...
class CustomFieldValueBase(BaseModel):
    ...
    __properties = ["id", "etag", "field_name", "created_at", "updated_at", "field_type", "field_required", "field_displayed", "field_display_order", "value", "soft_deleted"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CustomFieldValueBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CustomFieldValueBase:
        """Create an instance of CustomFieldValueBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CustomFieldValueBase.parse_obj(obj)

        _obj = CustomFieldValueBase.parse_obj({
            "id": obj.get("id"),
            "etag": obj.get("etag"),
