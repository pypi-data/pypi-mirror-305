...
class TaskTypeBase(BaseModel):
    ...
    TaskTypeBase
    """
    id: Optional[StrictInt] = Field(default=None, description="Unique identifier for the *TaskType*")
    etag: Optional[StrictStr] = Field(default=None, description="ETag for the *TaskType*")
    name: Optional[StrictStr] = Field(default=None, description="The name of the *TaskType*")
    deleted_at: Optional[datetime] = Field(default=None, description="The time the *TaskType* was deleted (as a ISO-8601 timestamp)")
    created_at: Optional[datetime] = Field(default=None, description="The time the *TaskType* was created (as a ISO-8601 timestamp)")
    updated_at: Optional[datetime] = Field(default=None, description="The time the *TaskType* was last updated (as a ISO-8601 timestamp)")
    __properties = ["id", "etag", "name", "deleted_at", "created_at", "updated_at"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TaskTypeBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TaskTypeBase:
        """Create an instance of TaskTypeBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TaskTypeBase.parse_obj(obj)

        _obj = TaskTypeBase.parse_obj({
            "id": obj.get("id"),
            "etag": obj.get("etag"),
            "name": obj.get("name"),
