...
class PolymorphicCustomRateUserBase(BaseModel):
    ...
    __properties = ["enabled", "etag", "id", "name"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PolymorphicCustomRateUserBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PolymorphicCustomRateUserBase:
        """Create an instance of PolymorphicCustomRateUserBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PolymorphicCustomRateUserBase.parse_obj(obj)

        _obj = PolymorphicCustomRateUserBase.parse_obj({
