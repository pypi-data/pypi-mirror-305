...
class CalendarVisibilityUpdateRequestData(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CalendarVisibilityUpdateRequestData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CalendarVisibilityUpdateRequestData:
        """Create an instance of CalendarVisibilityUpdateRequestData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CalendarVisibilityUpdateRequestData.parse_obj(obj)

        _obj = CalendarVisibilityUpdateRequestData.parse_obj({
            "color": obj.get("color"),
