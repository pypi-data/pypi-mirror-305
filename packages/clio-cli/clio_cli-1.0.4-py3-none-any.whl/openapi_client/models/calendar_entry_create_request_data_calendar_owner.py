...
class CalendarEntryCreateRequestDataCalendarOwner(BaseModel):
    """
    CalendarEntryCreateRequestDataCalendarOwner
    """
    id: StrictInt = Field(default=..., description="The unique identifier for a single Calendar associated with the CalendarEntry. The keyword `null` is not valid for this field.")
    __properties = ["id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CalendarEntryCreateRequestDataCalendarOwner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CalendarEntryCreateRequestDataCalendarOwner:
        """Create an instance of CalendarEntryCreateRequestDataCalendarOwner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CalendarEntryCreateRequestDataCalendarOwner.parse_obj(obj)

        _obj = CalendarEntryCreateRequestDataCalendarOwner.parse_obj({
            "id": obj.get("id")
        })
        return _obj
