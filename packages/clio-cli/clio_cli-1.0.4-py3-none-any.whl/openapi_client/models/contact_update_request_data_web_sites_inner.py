...
class ContactUpdateRequestDataWebSitesInner(BaseModel):
    """
    ContactUpdateRequestDataWebSitesInner
    """
    name: Optional[StrictStr] = Field(default='Other', description="Name of the WebSite.")
    address: Optional[StrictStr] = Field(default=None, description="URL of the WebSite.")
    id: Optional[StrictInt] = Field(default=None, description="The unique identifier for a single WebSite associated with the Contact. The keyword `null` is not valid for this field.")
    default_web_site: Optional[StrictBool] = Field(default=None, description="Whether or not the Contact should be the default website for the Contact.")
    destroy: Optional[StrictBool] = Field(default=None, alias="_destroy", description="The destroy flag. If the flag is set to `true` and the unique identifier of the associated WebSite is present, the WebSite is deleted from the Contact.")
    __properties = ["name", "address", "id", "default_web_site", "_destroy"]
    ...
    def name_validate_enum(cls, value):
        ...
        if value not in ('Work', 'Personal', 'Twitter', 'Facebook', 'LinkedIn', 'Instant Messenger', 'Other'):
            raise ValueError("must be one of enum values ('Work', 'Personal', 'Twitter', 'Facebook', 'LinkedIn', 'Instant Messenger', 'Other')")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ContactUpdateRequestDataWebSitesInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ContactUpdateRequestDataWebSitesInner:
        """Create an instance of ContactUpdateRequestDataWebSitesInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ContactUpdateRequestDataWebSitesInner.parse_obj(obj)

        _obj = ContactUpdateRequestDataWebSitesInner.parse_obj({
            "name": obj.get("name") if obj.get("name") is not None else 'Other',
            "address": obj.get("address"),
            "id": obj.get("id"),
            "default_web_site": obj.get("default_web_site"),
