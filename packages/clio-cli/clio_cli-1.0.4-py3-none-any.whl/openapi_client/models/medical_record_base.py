...
class MedicalRecordBase(BaseModel):
    ...
    __properties = ["id", "document_id", "etag", "end_date", "start_date", "created_at", "updated_at"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MedicalRecordBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MedicalRecordBase:
        """Create an instance of MedicalRecordBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MedicalRecordBase.parse_obj(obj)

        _obj = MedicalRecordBase.parse_obj({
            "id": obj.get("id"),
