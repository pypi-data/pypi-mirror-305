...
class CalendarEntryEventTypeCreateRequestData(BaseModel):
    """
    CalendarEntryEventTypeCreateRequestData
    """
    color: StrictStr = Field(default=..., description="The color assigned to the CalendarEntryEventType")
    name: StrictStr = Field(default=..., description="The name of the CalendarEntryEventType")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CalendarEntryEventTypeCreateRequestData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CalendarEntryEventTypeCreateRequestData:
        """Create an instance of CalendarEntryEventTypeCreateRequestData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CalendarEntryEventTypeCreateRequestData.parse_obj(obj)

        _obj = CalendarEntryEventTypeCreateRequestData.parse_obj({
            "color": obj.get("color"),
            "name": obj.get("name")
        })
        return _obj
