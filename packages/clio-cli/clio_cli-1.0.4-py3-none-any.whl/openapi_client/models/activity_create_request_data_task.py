...
class ActivityCreateRequestDataTask(BaseModel):
    """
    ActivityCreateRequestDataTask
    """
    id: Optional[StrictInt] = Field(default=None, description="The unique identifier for a single Task associated with the Activity. The keyword `null` is not valid for this field.")
    __properties = ["id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ActivityCreateRequestDataTask:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ActivityCreateRequestDataTask:
        """Create an instance of ActivityCreateRequestDataTask from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ActivityCreateRequestDataTask.parse_obj(obj)

        _obj = ActivityCreateRequestDataTask.parse_obj({
            "id": obj.get("id")
        })
        return _obj
