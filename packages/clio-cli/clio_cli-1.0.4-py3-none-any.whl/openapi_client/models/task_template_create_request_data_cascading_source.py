...
class TaskTemplateCreateRequestDataCascadingSource(BaseModel):
    """
    TaskTemplateCreateRequestDataCascadingSource
    """
    id: Optional[StrictInt] = Field(default=None, description="The unique identifier for a single TaskTemplate associated with the TaskTemplate. The keyword `null` is not valid for this field.")
    __properties = ["id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TaskTemplateCreateRequestDataCascadingSource:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TaskTemplateCreateRequestDataCascadingSource:
        """Create an instance of TaskTemplateCreateRequestDataCascadingSource from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TaskTemplateCreateRequestDataCascadingSource.parse_obj(obj)

        _obj = TaskTemplateCreateRequestDataCascadingSource.parse_obj({
            "id": obj.get("id")
        })
        return _obj
