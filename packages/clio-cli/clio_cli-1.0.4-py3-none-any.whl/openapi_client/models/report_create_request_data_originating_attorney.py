...
class ReportCreateRequestDataOriginatingAttorney(BaseModel):
    """
    ReportCreateRequestDataOriginatingAttorney
    """
    id: Optional[StrictInt] = Field(default=None, description="The unique identifier for a single User associated with the Report. The keyword `null` is not valid for this field.")
    __properties = ["id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ReportCreateRequestDataOriginatingAttorney:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ReportCreateRequestDataOriginatingAttorney:
        """Create an instance of ReportCreateRequestDataOriginatingAttorney from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ReportCreateRequestDataOriginatingAttorney.parse_obj(obj)

        _obj = ReportCreateRequestDataOriginatingAttorney.parse_obj({
            "id": obj.get("id")
        })
        return _obj
