...
class BillUpdateRequestDataInterest(BaseModel):
    """
    BillUpdateRequestDataInterest
    """
    rate: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Interest amount for the Bill as percentage.")
    type: Optional[StrictStr] = Field(default=None, description="The type of interest you are applying to your Bill with the `interest[rate]`.")
    period: Optional[StrictInt] = Field(default=None, description="The interest period for how frequently your Bill will charge interest.")
    __properties = ["rate", "type", "period"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BillUpdateRequestDataInterest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BillUpdateRequestDataInterest:
        """Create an instance of BillUpdateRequestDataInterest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BillUpdateRequestDataInterest.parse_obj(obj)

        _obj = BillUpdateRequestDataInterest.parse_obj({
            "rate": obj.get("rate"),
            "type": obj.get("type"),
