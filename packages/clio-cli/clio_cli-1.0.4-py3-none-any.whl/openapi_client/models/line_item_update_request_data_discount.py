...
class LineItemUpdateRequestDataDiscount(BaseModel):
    """
    LineItemUpdateRequestDataDiscount
    """
    rate: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Discount rate for the LineItem.")
    type: Optional[StrictBool] = Field(default=None, description="Discount type. This should be set to one of: 'percentage' or 'money'.")
    __properties = ["rate", "type"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LineItemUpdateRequestDataDiscount:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LineItemUpdateRequestDataDiscount:
        """Create an instance of LineItemUpdateRequestDataDiscount from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LineItemUpdateRequestDataDiscount.parse_obj(obj)

        _obj = LineItemUpdateRequestDataDiscount.parse_obj({
            "rate": obj.get("rate"),
            "type": obj.get("type")
        })
        return _obj
