...
class ContactUpdateRequestDataPhoneNumbersInner(BaseModel):
    """
    ContactUpdateRequestDataPhoneNumbersInner
    """
    name: Optional[StrictStr] = Field(default='Other', description="Name of the PhoneNumber.")
    number: Optional[StrictStr] = Field(default=None, description="Phone number.")
    default_number: Optional[StrictBool] = Field(default=None, description="Whether or not the PhoneNumber should be the default number for the Contact.")
    id: Optional[StrictInt] = Field(default=None, description="The unique identifier for a single PhoneNumber associated with the Contact. The keyword `null` is not valid for this field.")
    destroy: Optional[StrictBool] = Field(default=None, alias="_destroy", description="The destroy flag. If the flag is set to `true` and the unique identifier of the associated PhoneNumber is present, the PhoneNumber is deleted from the Contact.")
    __properties = ["name", "number", "default_number", "id", "_destroy"]
    ...
    def name_validate_enum(cls, value):
        ...
        if value not in ('Work', 'Home', 'Mobile', 'Fax', 'Pager', 'Skype', 'Other'):
            raise ValueError("must be one of enum values ('Work', 'Home', 'Mobile', 'Fax', 'Pager', 'Skype', 'Other')")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ContactUpdateRequestDataPhoneNumbersInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ContactUpdateRequestDataPhoneNumbersInner:
        """Create an instance of ContactUpdateRequestDataPhoneNumbersInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ContactUpdateRequestDataPhoneNumbersInner.parse_obj(obj)

        _obj = ContactUpdateRequestDataPhoneNumbersInner.parse_obj({
            "name": obj.get("name") if obj.get("name") is not None else 'Other',
            "number": obj.get("number"),
            "default_number": obj.get("default_number"),
            "id": obj.get("id"),
