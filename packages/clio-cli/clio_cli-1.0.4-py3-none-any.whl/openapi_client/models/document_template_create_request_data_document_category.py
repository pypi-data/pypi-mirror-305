...
class DocumentTemplateCreateRequestDataDocumentCategory(BaseModel):
    """
    DocumentTemplateCreateRequestDataDocumentCategory
    """
    id: Optional[StrictInt] = Field(default=None, description="The unique identifier for a single DocumentCategory associated with the DocumentTemplate. The keyword `null` is not valid for this field.")
    __properties = ["id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DocumentTemplateCreateRequestDataDocumentCategory:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DocumentTemplateCreateRequestDataDocumentCategory:
        """Create an instance of DocumentTemplateCreateRequestDataDocumentCategory from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DocumentTemplateCreateRequestDataDocumentCategory.parse_obj(obj)

        _obj = DocumentTemplateCreateRequestDataDocumentCategory.parse_obj({
            "id": obj.get("id")
        })
        return _obj
