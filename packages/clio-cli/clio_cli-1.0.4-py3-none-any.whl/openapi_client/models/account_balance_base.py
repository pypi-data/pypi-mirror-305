...
class AccountBalanceBase(BaseModel):
    ...
    AccountBalanceBase
    """
    id: Optional[StrictInt] = Field(default=None, description="Unique identifier for the *AccountBalance*")
    balance: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The current balance of the bank account available to the matter or contact")
    type: Optional[StrictStr] = Field(default=None, description="The bank account type. Either Operating or Trust")
    name: Optional[StrictStr] = Field(default=None, description="The name of the bank account")
    __properties = ["id", "balance", "type", "name"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AccountBalanceBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AccountBalanceBase:
        """Create an instance of AccountBalanceBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AccountBalanceBase.parse_obj(obj)

        _obj = AccountBalanceBase.parse_obj({
            "id": obj.get("id"),
