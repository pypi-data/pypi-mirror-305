...
class ContactCreateRequestDataPhoneNumbersInner(BaseModel):
    """
    ...
    __properties = ["name", "number", "default_number"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ContactCreateRequestDataPhoneNumbersInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ContactCreateRequestDataPhoneNumbersInner:
        """Create an instance of ContactCreateRequestDataPhoneNumbersInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ContactCreateRequestDataPhoneNumbersInner.parse_obj(obj)

        _obj = ContactCreateRequestDataPhoneNumbersInner.parse_obj({
