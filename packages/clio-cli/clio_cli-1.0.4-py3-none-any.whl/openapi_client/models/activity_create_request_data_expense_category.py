...
class ActivityCreateRequestDataExpenseCategory(BaseModel):
    """
    ActivityCreateRequestDataExpenseCategory
    """
    id: Optional[StrictInt] = Field(default=None, description="The unique identifier for a single ExpenseCategory associated with an Activity. Use the keyword `null` to specify no association. ")
    __properties = ["id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ActivityCreateRequestDataExpenseCategory:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ActivityCreateRequestDataExpenseCategory:
        """Create an instance of ActivityCreateRequestDataExpenseCategory from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ActivityCreateRequestDataExpenseCategory.parse_obj(obj)

        _obj = ActivityCreateRequestDataExpenseCategory.parse_obj({
            "id": obj.get("id")
        })
        return _obj
