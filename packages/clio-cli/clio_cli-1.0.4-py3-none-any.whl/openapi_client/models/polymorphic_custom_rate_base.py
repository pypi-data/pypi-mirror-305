...
class PolymorphicCustomRateBase(BaseModel):
    ...
    __properties = ["id", "etag", "created_at", "updated_at", "rate", "award", "note", "date"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PolymorphicCustomRateBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PolymorphicCustomRateBase:
        """Create an instance of PolymorphicCustomRateBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PolymorphicCustomRateBase.parse_obj(obj)

        _obj = PolymorphicCustomRateBase.parse_obj({
            "id": obj.get("id"),
            "etag": obj.get("etag"),
