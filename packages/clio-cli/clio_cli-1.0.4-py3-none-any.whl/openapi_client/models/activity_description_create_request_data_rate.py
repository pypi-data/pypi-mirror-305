...
class ActivityDescriptionCreateRequestDataRate(BaseModel):
    """
    ActivityDescriptionCreateRequestDataRate
    """
    amount: Optional[Union[StrictFloat, StrictInt]] = Field(default=0, description="The rate of the ActivityDescription. This is ignored for 'User' rates.")
    non_billable_amount: Optional[Union[StrictFloat, StrictInt]] = Field(default=0, description="The non billable rate of the ActivityDescription. This is ignored for 'User' rates.")
    type: Optional[StrictStr] = Field(default=None, description="What kind of rate it will be.")
    __properties = ["amount", "non_billable_amount", "type"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in ('User', 'FlatRate', 'Custom'):
            raise ValueError("must be one of enum values ('User', 'FlatRate', 'Custom')")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ActivityDescriptionCreateRequestDataRate:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ActivityDescriptionCreateRequestDataRate:
        """Create an instance of ActivityDescriptionCreateRequestDataRate from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ActivityDescriptionCreateRequestDataRate.parse_obj(obj)

        _obj = ActivityDescriptionCreateRequestDataRate.parse_obj({
            "amount": obj.get("amount") if obj.get("amount") is not None else 0,
            "non_billable_amount": obj.get("non_billable_amount") if obj.get("non_billable_amount") is not None else 0,
            "type": obj.get("type")
        })
        return _obj
