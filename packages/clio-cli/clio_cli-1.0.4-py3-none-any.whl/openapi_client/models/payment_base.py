...
class PaymentBase(BaseModel):
    ...
    __properties = ["id", "etag", "description", "reference", "amount", "date", "source_fund_type", "voided_at", "created_at", "updated_at"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PaymentBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PaymentBase:
        """Create an instance of PaymentBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PaymentBase.parse_obj(obj)

        _obj = PaymentBase.parse_obj({
            "id": obj.get("id"),
            "etag": obj.get("etag"),
