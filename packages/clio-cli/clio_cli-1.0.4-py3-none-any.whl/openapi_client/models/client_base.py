...
class ClientBase(BaseModel):
    ...
    __properties = ["id", "name", "first_name", "middle_name", "last_name", "type", "created_at", "updated_at", "prefix", "title", "initials", "is_matter_client", "primary_email_address", "primary_phone_number", "client_connect_user_id", "date_of_birth"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ClientBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ClientBase:
        """Create an instance of ClientBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ClientBase.parse_obj(obj)

        _obj = ClientBase.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
