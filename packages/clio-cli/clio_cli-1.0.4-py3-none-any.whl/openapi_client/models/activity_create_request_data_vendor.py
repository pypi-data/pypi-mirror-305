...
class ActivityCreateRequestDataVendor(BaseModel):
    """
    ActivityCreateRequestDataVendor
    """
    id: Optional[StrictInt] = Field(default=None, description="The unique identifier for a single Contact associated with a HardCostEntry. Use the keyword `null` to specify no association. ")
    __properties = ["id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ActivityCreateRequestDataVendor:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ActivityCreateRequestDataVendor:
        """Create an instance of ActivityCreateRequestDataVendor from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ActivityCreateRequestDataVendor.parse_obj(obj)

        _obj = ActivityCreateRequestDataVendor.parse_obj({
            "id": obj.get("id")
        })
        return _obj
