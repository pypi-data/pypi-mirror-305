...
class MatterCreateRequestDataMatterBudget(BaseModel):
    """
    MatterCreateRequestDataMatterBudget
    """
    destroy: Optional[StrictBool] = Field(default=None, alias="_destroy", description="Determines whether the matter budget associated with the matter should be destroyed. Only users with matter budget destroy capabilities can destroy matter budgets.")
    budget: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The amount allocated for the matter.")
    include_expenses: Optional[StrictBool] = Field(default=None, description="Determines whether the budget includes expenses in the calculation.")
    notification_threshold: Optional[StrictInt] = Field(default=None, description="Percentage of the budget when it starts notifying users.")
    notify_users: Optional[StrictBool] = Field(default=False, description="Determine whether to notify users when the matter reaches the notification threshold.")
    __properties = ["_destroy", "budget", "include_expenses", "notification_threshold", "notify_users"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MatterCreateRequestDataMatterBudget:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MatterCreateRequestDataMatterBudget:
        """Create an instance of MatterCreateRequestDataMatterBudget from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MatterCreateRequestDataMatterBudget.parse_obj(obj)

        _obj = MatterCreateRequestDataMatterBudget.parse_obj({
            "destroy": obj.get("_destroy"),
            "budget": obj.get("budget"),
            "include_expenses": obj.get("include_expenses"),
            "notification_threshold": obj.get("notification_threshold"),
            "notify_users": obj.get("notify_users") if obj.get("notify_users") is not None else False
        })
        return _obj
