...
class MultipartHeaderBase(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MultipartHeaderBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MultipartHeaderBase:
        """Create an instance of MultipartHeaderBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MultipartHeaderBase.parse_obj(obj)

        _obj = MultipartHeaderBase.parse_obj({
            "name": obj.get("name"),
            "value": obj.get("value")
        })
        return _obj
