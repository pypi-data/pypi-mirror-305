...
class LaukCivilControlledRate(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LaukCivilControlledRate:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LaukCivilControlledRate:
        """Create an instance of LaukCivilControlledRate from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LaukCivilControlledRate.parse_obj(obj)

        _obj = LaukCivilControlledRate.parse_obj({
            "id": obj.get("id"),
