...
class CustomFieldSetBase(BaseModel):
    ...
    __properties = ["id", "etag", "name", "parent_type", "displayed", "created_at", "updated_at"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CustomFieldSetBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CustomFieldSetBase:
        """Create an instance of CustomFieldSetBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CustomFieldSetBase.parse_obj(obj)

        _obj = CustomFieldSetBase.parse_obj({
            "id": obj.get("id"),
            "etag": obj.get("etag"),
            "name": obj.get("name"),
