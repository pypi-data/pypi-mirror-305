...
class DocumentCreateRequestDataMultipartsInner(BaseModel):
    ...
    __properties = ["part_number", "content_length", "content_md5"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DocumentCreateRequestDataMultipartsInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DocumentCreateRequestDataMultipartsInner:
        """Create an instance of DocumentCreateRequestDataMultipartsInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DocumentCreateRequestDataMultipartsInner.parse_obj(obj)

        _obj = DocumentCreateRequestDataMultipartsInner.parse_obj({
