...
class MatterStageBase(BaseModel):
    ...
    __properties = ["id", "etag", "practice_area_id", "name", "order", "created_at", "updated_at"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MatterStageBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MatterStageBase:
        """Create an instance of MatterStageBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MatterStageBase.parse_obj(obj)

        _obj = MatterStageBase.parse_obj({
            "id": obj.get("id"),
            "etag": obj.get("etag"),
            "practice_area_id": obj.get("practice_area_id"),
            "name": obj.get("name"),
            "order": obj.get("order"),
