...
class TaskCreateRequestDataAssignee(BaseModel):
    """
    TaskCreateRequestDataAssignee
    """
    id: StrictInt = Field(default=..., description="The unique identifier for a single User or Contact associated with the Task. The keyword `null` is not valid for this field.")
    type: StrictStr = Field(default=..., description="Model type of the assignee.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TaskCreateRequestDataAssignee:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TaskCreateRequestDataAssignee:
        """Create an instance of TaskCreateRequestDataAssignee from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TaskCreateRequestDataAssignee.parse_obj(obj)

        _obj = TaskCreateRequestDataAssignee.parse_obj({
            "id": obj.get("id"),
            "type": obj.get("type")
        })
        return _obj
