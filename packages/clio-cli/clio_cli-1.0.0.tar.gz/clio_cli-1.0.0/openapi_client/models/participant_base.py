...
class ParticipantBase(BaseModel):
    ...
    __properties = ["id", "etag", "created_at", "updated_at", "type", "identifier", "secondary_identifier", "enabled", "name", "initials", "job_title_name"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in ('Person', 'Company', 'User'):
            raise ValueError("must be one of enum values ('Person', 'Company', 'User')")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ParticipantBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ParticipantBase:
        """Create an instance of ParticipantBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ParticipantBase.parse_obj(obj)

        _obj = ParticipantBase.parse_obj({
            "id": obj.get("id"),
            "etag": obj.get("etag"),
