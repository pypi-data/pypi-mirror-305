...
class DocumentCategoryCreateRequestData(BaseModel):
    """
    DocumentCategoryCreateRequestData
    """
    name: StrictStr = Field(default=..., description="What the DocumentCategory should be called.")
    __properties = ["name"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DocumentCategoryCreateRequestData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DocumentCategoryCreateRequestData:
        """Create an instance of DocumentCategoryCreateRequestData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DocumentCategoryCreateRequestData.parse_obj(obj)

        _obj = DocumentCategoryCreateRequestData.parse_obj({
            "name": obj.get("name")
        })
        return _obj
