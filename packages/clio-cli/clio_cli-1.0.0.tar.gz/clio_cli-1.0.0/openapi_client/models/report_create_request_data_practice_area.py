...
class ReportCreateRequestDataPracticeArea(BaseModel):
    """
    ReportCreateRequestDataPracticeArea
    """
    id: Optional[StrictInt] = Field(default=None, description="The unique identifier for a single PracticeArea associated with the Report. The keyword `null` is not valid for this field.")
    __properties = ["id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ReportCreateRequestDataPracticeArea:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ReportCreateRequestDataPracticeArea:
        """Create an instance of ReportCreateRequestDataPracticeArea from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ReportCreateRequestDataPracticeArea.parse_obj(obj)

        _obj = ReportCreateRequestDataPracticeArea.parse_obj({
            "id": obj.get("id")
        })
        return _obj
