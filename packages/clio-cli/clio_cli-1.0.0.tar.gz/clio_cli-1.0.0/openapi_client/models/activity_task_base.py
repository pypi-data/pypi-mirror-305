...
class ActivityTaskBase(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ActivityTaskBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ActivityTaskBase:
        """Create an instance of ActivityTaskBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ActivityTaskBase.parse_obj(obj)

        _obj = ActivityTaskBase.parse_obj({
            "id": obj.get("id"),
            "etag": obj.get("etag")
        })
        return _obj
