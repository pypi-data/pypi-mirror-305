...
class BillableMatterBase(BaseModel):
    ...
    __properties = ["id", "unbilled_hours", "unbilled_amount", "amount_in_trust", "display_number"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BillableMatterBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BillableMatterBase:
        """Create an instance of BillableMatterBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BillableMatterBase.parse_obj(obj)

        _obj = BillableMatterBase.parse_obj({
            "id": obj.get("id"),
