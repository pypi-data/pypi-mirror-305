...
class LineItemTotalsBase(BaseModel):
    ...
    __properties = ["quantity", "price", "discount_percent", "total", "sub_total"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LineItemTotalsBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LineItemTotalsBase:
        """Create an instance of LineItemTotalsBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LineItemTotalsBase.parse_obj(obj)

        _obj = LineItemTotalsBase.parse_obj({
