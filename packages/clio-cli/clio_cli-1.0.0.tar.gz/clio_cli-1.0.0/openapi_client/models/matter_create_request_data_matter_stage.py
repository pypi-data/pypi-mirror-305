...
class MatterCreateRequestDataMatterStage(BaseModel):
    """
    MatterCreateRequestDataMatterStage
    """
    id: Optional[StrictInt] = Field(default=None, description="The unique identifier for a single MatterStage associated with the Matter. Use the keyword `null` to specify no association.")
    __properties = ["id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MatterCreateRequestDataMatterStage:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MatterCreateRequestDataMatterStage:
        """Create an instance of MatterCreateRequestDataMatterStage from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MatterCreateRequestDataMatterStage.parse_obj(obj)

        _obj = MatterCreateRequestDataMatterStage.parse_obj({
            "id": obj.get("id")
        })
        return _obj
