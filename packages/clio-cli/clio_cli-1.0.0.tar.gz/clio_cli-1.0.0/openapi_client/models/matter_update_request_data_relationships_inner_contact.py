...
class MatterUpdateRequestDataRelationshipsInnerContact(BaseModel):
    """
    MatterUpdateRequestDataRelationshipsInnerContact
    """
    id: Optional[StrictInt] = Field(default=None, description="The unique identifier for a single Contact associated with the Relationship. The keyword `null` is not valid for this field.")
    __properties = ["id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MatterUpdateRequestDataRelationshipsInnerContact:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MatterUpdateRequestDataRelationshipsInnerContact:
        """Create an instance of MatterUpdateRequestDataRelationshipsInnerContact from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MatterUpdateRequestDataRelationshipsInnerContact.parse_obj(obj)

        _obj = MatterUpdateRequestDataRelationshipsInnerContact.parse_obj({
            "id": obj.get("id")
        })
        return _obj
