...
class MatterCreateRequestDataGroup(BaseModel):
    """
    MatterCreateRequestDataGroup
    """
    id: Optional[StrictInt] = Field(default=None, description="The unique identifier for a single Group associated with the Matter. Use the keyword `null` to specify no association.")
    __properties = ["id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MatterCreateRequestDataGroup:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MatterCreateRequestDataGroup:
        """Create an instance of MatterCreateRequestDataGroup from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MatterCreateRequestDataGroup.parse_obj(obj)

        _obj = MatterCreateRequestDataGroup.parse_obj({
            "id": obj.get("id")
        })
        return _obj
