...
class MatterBase(BaseModel):
    ...
    __properties = ["id", "etag", "number", "display_number", "custom_number", "description", "status", "location", "client_reference", "client_id", "billable", "maildrop_address", "billing_method", "open_date", "close_date", "pending_date", "created_at", "updated_at", "shared", "has_tasks", "last_activity_date", "matter_stage_updated_at"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MatterBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MatterBase:
        """Create an instance of MatterBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MatterBase.parse_obj(obj)

        _obj = MatterBase.parse_obj({
            "id": obj.get("id"),
            "etag": obj.get("etag"),
