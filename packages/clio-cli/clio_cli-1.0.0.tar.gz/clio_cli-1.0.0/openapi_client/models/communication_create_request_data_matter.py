...
class CommunicationCreateRequestDataMatter(BaseModel):
    """
    CommunicationCreateRequestDataMatter
    """
    id: Optional[StrictInt] = Field(default=None, description="The unique identifier for a single Matter associated with the Communication. The keyword `null` is not valid for this field.")
    __properties = ["id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CommunicationCreateRequestDataMatter:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CommunicationCreateRequestDataMatter:
        """Create an instance of CommunicationCreateRequestDataMatter from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CommunicationCreateRequestDataMatter.parse_obj(obj)

        _obj = CommunicationCreateRequestDataMatter.parse_obj({
            "id": obj.get("id")
        })
        return _obj
