...
class ActivityRateBase(BaseModel):
    ...
    __properties = ["id", "etag", "rate", "flat_rate", "created_at", "updated_at", "contact_id", "co_counsel_contact_id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ActivityRateBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ActivityRateBase:
        """Create an instance of ActivityRateBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ActivityRateBase.parse_obj(obj)

        _obj = ActivityRateBase.parse_obj({
            "id": obj.get("id"),
            "etag": obj.get("etag"),
            "rate": obj.get("rate"),
