...
class MatterCustomRateBase(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MatterCustomRateBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MatterCustomRateBase:
        """Create an instance of MatterCustomRateBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MatterCustomRateBase.parse_obj(obj)

        _obj = MatterCustomRateBase.parse_obj({
            "type": obj.get("type"),
