...
class MatterCreateRequestDataSplitInvoicePayersInner(BaseModel):
    """
    MatterCreateRequestDataSplitInvoicePayersInner
    """
    contact_id: StrictInt = Field(default=..., description="Contact id for the matter payer.")
    ...
    split_portion: Union[StrictFloat, StrictInt] = Field(default=..., description="The split portion for the payer.")
    __properties = ["contact_id", "send_to_bill_recipients", "split_portion"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MatterCreateRequestDataSplitInvoicePayersInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MatterCreateRequestDataSplitInvoicePayersInner:
        """Create an instance of MatterCreateRequestDataSplitInvoicePayersInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MatterCreateRequestDataSplitInvoicePayersInner.parse_obj(obj)

        _obj = MatterCreateRequestDataSplitInvoicePayersInner.parse_obj({
