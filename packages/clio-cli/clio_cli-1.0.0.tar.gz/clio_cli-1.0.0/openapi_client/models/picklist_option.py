...
class PicklistOption(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PicklistOption:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PicklistOption:
        """Create an instance of PicklistOption from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PicklistOption.parse_obj(obj)

        _obj = PicklistOption.parse_obj({
            "id": obj.get("id"),
            "etag": obj.get("etag"),
