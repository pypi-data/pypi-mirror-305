...
class BillingSetting(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BillingSetting:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BillingSetting:
        """Create an instance of BillingSetting from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BillingSetting.parse_obj(obj)

        _obj = BillingSetting.parse_obj({
            "id": obj.get("id"),
            "etag": obj.get("etag"),
