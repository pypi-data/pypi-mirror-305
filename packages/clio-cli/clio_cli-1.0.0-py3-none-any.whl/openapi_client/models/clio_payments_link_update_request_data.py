...
class ClioPaymentsLinkUpdateRequestData(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ClioPaymentsLinkUpdateRequestData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ClioPaymentsLinkUpdateRequestData:
        """Create an instance of ClioPaymentsLinkUpdateRequestData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ClioPaymentsLinkUpdateRequestData.parse_obj(obj)

        _obj = ClioPaymentsLinkUpdateRequestData.parse_obj({
