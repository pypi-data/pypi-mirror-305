...
class WebSiteBase(BaseModel):
    ...
    __properties = ["id", "etag", "address", "name", "default_web_site", "created_at", "updated_at"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WebSiteBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WebSiteBase:
        """Create an instance of WebSiteBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WebSiteBase.parse_obj(obj)

        _obj = WebSiteBase.parse_obj({
            "id": obj.get("id"),
            "etag": obj.get("etag"),
