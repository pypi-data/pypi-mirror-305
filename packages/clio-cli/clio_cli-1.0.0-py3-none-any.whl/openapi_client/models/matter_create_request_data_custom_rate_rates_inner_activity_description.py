...
class MatterCreateRequestDataCustomRateRatesInnerActivityDescription(BaseModel):
    """
    MatterCreateRequestDataCustomRateRatesInnerActivityDescription
    """
    id: Optional[StrictInt] = Field(default=None, description="The unique identifier for a single ActivityDescription associated with the Rate. The keyword `null` is not valid for this field.")
    __properties = ["id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MatterCreateRequestDataCustomRateRatesInnerActivityDescription:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MatterCreateRequestDataCustomRateRatesInnerActivityDescription:
        """Create an instance of MatterCreateRequestDataCustomRateRatesInnerActivityDescription from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MatterCreateRequestDataCustomRateRatesInnerActivityDescription.parse_obj(obj)

        _obj = MatterCreateRequestDataCustomRateRatesInnerActivityDescription.parse_obj({
            "id": obj.get("id")
        })
        return _obj
