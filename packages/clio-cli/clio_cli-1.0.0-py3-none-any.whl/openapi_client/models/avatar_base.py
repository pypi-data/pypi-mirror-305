...
class AvatarBase(BaseModel):
    ...
    AvatarBase
    """
    id: Optional[StrictInt] = Field(default=None, description="Unique identifier for the *Avatar*")
    etag: Optional[StrictStr] = Field(default=None, description="ETag for the *Avatar*")
    created_at: Optional[datetime] = Field(default=None, description="The time the *Avatar* was created (as a ISO-8601 timestamp)")
    updated_at: Optional[datetime] = Field(default=None, description="The time the *Avatar* was last updated (as a ISO-8601 timestamp)")
    url: Optional[StrictStr] = Field(default=None, description="The URL for the *Avatar*")
    destroy: Optional[StrictBool] = Field(default=None, alias="_destroy", description="Whether to destroy the *Avatar*")
    __properties = ["id", "etag", "created_at", "updated_at", "url", "_destroy"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AvatarBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AvatarBase:
        """Create an instance of AvatarBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AvatarBase.parse_obj(obj)

        _obj = AvatarBase.parse_obj({
            "id": obj.get("id"),
            "etag": obj.get("etag"),
