...
class ContactCreateRequestDataInstantMessengersInner(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ContactCreateRequestDataInstantMessengersInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ContactCreateRequestDataInstantMessengersInner:
        """Create an instance of ContactCreateRequestDataInstantMessengersInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ContactCreateRequestDataInstantMessengersInner.parse_obj(obj)

        _obj = ContactCreateRequestDataInstantMessengersInner.parse_obj({
