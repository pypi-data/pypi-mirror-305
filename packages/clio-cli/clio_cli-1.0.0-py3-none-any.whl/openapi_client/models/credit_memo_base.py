...
class CreditMemoBase(BaseModel):
    ...
    __properties = ["id", "etag", "date", "amount", "description", "discount", "voided_at", "created_at", "updated_at"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreditMemoBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreditMemoBase:
        """Create an instance of CreditMemoBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreditMemoBase.parse_obj(obj)

        _obj = CreditMemoBase.parse_obj({
            "id": obj.get("id"),
            "etag": obj.get("etag"),
