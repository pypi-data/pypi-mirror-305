...
class DocumentArchive(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DocumentArchive:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DocumentArchive:
        """Create an instance of DocumentArchive from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DocumentArchive.parse_obj(obj)

        _obj = DocumentArchive.parse_obj({
            "id": obj.get("id"),
            "etag": obj.get("etag"),
