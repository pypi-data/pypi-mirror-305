...
class FolderUpdateRequestDataExternalPropertiesInner(BaseModel):
    """
    ...
    destroy: Optional[StrictBool] = Field(default=None, alias="_destroy", description="The destroy flag. If the flag is set to `true` and the unique identifier of the associated ExternalProperty is present, the ExternalProperty is deleted from the Folder.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FolderUpdateRequestDataExternalPropertiesInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FolderUpdateRequestDataExternalPropertiesInner:
        """Create an instance of FolderUpdateRequestDataExternalPropertiesInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FolderUpdateRequestDataExternalPropertiesInner.parse_obj(obj)

        _obj = FolderUpdateRequestDataExternalPropertiesInner.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "value": obj.get("value"),
