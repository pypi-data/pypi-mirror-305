...
class CalendarCreateRequestData(BaseModel):
    """
    ...
    name: StrictStr = Field(default=..., description="Calendar name.")
    ...
    __properties = ["color", "name", "source", "visible"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CalendarCreateRequestData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CalendarCreateRequestData:
        """Create an instance of CalendarCreateRequestData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CalendarCreateRequestData.parse_obj(obj)

        _obj = CalendarCreateRequestData.parse_obj({
            "color": obj.get("color"),
            "name": obj.get("name"),
