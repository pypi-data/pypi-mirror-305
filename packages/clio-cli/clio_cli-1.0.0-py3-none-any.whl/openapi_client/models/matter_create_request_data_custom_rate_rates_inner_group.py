...
class MatterCreateRequestDataCustomRateRatesInnerGroup(BaseModel):
    """
    MatterCreateRequestDataCustomRateRatesInnerGroup
    """
    id: Optional[StrictInt] = Field(default=None, description="The unique identifier for a single Group associated with the Rate. The keyword `null` is not valid for this field.")
    __properties = ["id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MatterCreateRequestDataCustomRateRatesInnerGroup:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MatterCreateRequestDataCustomRateRatesInnerGroup:
        """Create an instance of MatterCreateRequestDataCustomRateRatesInnerGroup from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MatterCreateRequestDataCustomRateRatesInnerGroup.parse_obj(obj)

        _obj = MatterCreateRequestDataCustomRateRatesInnerGroup.parse_obj({
            "id": obj.get("id")
        })
        return _obj
