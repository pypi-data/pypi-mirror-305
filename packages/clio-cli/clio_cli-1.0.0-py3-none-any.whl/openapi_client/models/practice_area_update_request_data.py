...
class PracticeAreaUpdateRequestData(BaseModel):
    """
    ...
    name: Optional[StrictStr] = Field(default=None, description="Name of the PracticeArea.")
    __properties = ["category", "code", "name"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PracticeAreaUpdateRequestData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PracticeAreaUpdateRequestData:
        """Create an instance of PracticeAreaUpdateRequestData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PracticeAreaUpdateRequestData.parse_obj(obj)

        _obj = PracticeAreaUpdateRequestData.parse_obj({
