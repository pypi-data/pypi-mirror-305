...
class MatterCreateRequestDataStatuteOfLimitationsRemindersInnerNotificationMethod(BaseModel):
    """
    MatterCreateRequestDataStatuteOfLimitationsRemindersInnerNotificationMethod
    """
    id: StrictInt = Field(default=..., description="The unique identifier for a single NotificationMethod associated with the Reminder. The keyword `null` is not valid for this field.")
    __properties = ["id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MatterCreateRequestDataStatuteOfLimitationsRemindersInnerNotificationMethod:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MatterCreateRequestDataStatuteOfLimitationsRemindersInnerNotificationMethod:
        """Create an instance of MatterCreateRequestDataStatuteOfLimitationsRemindersInnerNotificationMethod from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MatterCreateRequestDataStatuteOfLimitationsRemindersInnerNotificationMethod.parse_obj(obj)

        _obj = MatterCreateRequestDataStatuteOfLimitationsRemindersInnerNotificationMethod.parse_obj({
            "id": obj.get("id")
        })
        return _obj
