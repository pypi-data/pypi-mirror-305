...
class FolderCreateRequestDataParent(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FolderCreateRequestDataParent:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FolderCreateRequestDataParent:
        """Create an instance of FolderCreateRequestDataParent from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FolderCreateRequestDataParent.parse_obj(obj)

        _obj = FolderCreateRequestDataParent.parse_obj({
            "id": obj.get("id"),
            "type": obj.get("type")
        })
        return _obj
