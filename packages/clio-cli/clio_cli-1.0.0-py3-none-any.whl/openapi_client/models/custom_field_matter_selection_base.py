...
class CustomFieldMatterSelectionBase(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CustomFieldMatterSelectionBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CustomFieldMatterSelectionBase:
        """Create an instance of CustomFieldMatterSelectionBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CustomFieldMatterSelectionBase.parse_obj(obj)

        _obj = CustomFieldMatterSelectionBase.parse_obj({
            "id": obj.get("id"),
