...
class DocumentBase(BaseModel):
    ...
    __properties = ["id", "etag", "created_at", "updated_at", "deleted_at", "type", "locked", "name", "received_at", "filename", "size", "content_type"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DocumentBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DocumentBase:
        """Create an instance of DocumentBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DocumentBase.parse_obj(obj)

        _obj = DocumentBase.parse_obj({
            "id": obj.get("id"),
            "etag": obj.get("etag"),
