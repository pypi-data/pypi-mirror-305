...
class BillableClientBase(BaseModel):
    ...
    __properties = ["id", "unbilled_hours", "unbilled_amount", "amount_in_trust", "name", "billable_matters_count"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BillableClientBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BillableClientBase:
        """Create an instance of BillableClientBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BillableClientBase.parse_obj(obj)

        _obj = BillableClientBase.parse_obj({
            "id": obj.get("id"),
