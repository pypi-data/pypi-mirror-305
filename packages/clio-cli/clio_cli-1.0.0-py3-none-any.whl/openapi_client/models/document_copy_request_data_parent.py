...
class DocumentCopyRequestDataParent(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DocumentCopyRequestDataParent:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DocumentCopyRequestDataParent:
        """Create an instance of DocumentCopyRequestDataParent from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DocumentCopyRequestDataParent.parse_obj(obj)

        _obj = DocumentCopyRequestDataParent.parse_obj({
            "id": obj.get("id"),
            "type": obj.get("type")
        })
        return _obj
