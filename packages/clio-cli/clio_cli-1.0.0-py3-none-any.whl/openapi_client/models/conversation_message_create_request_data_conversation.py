...
class ConversationMessageCreateRequestDataConversation(BaseModel):
    """
    ConversationMessageCreateRequestDataConversation
    """
    id: Optional[StrictInt] = Field(default=None, description="The unique identifier for a single Conversation associated with this ConversationMessage.")
    __properties = ["id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ConversationMessageCreateRequestDataConversation:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ConversationMessageCreateRequestDataConversation:
        """Create an instance of ConversationMessageCreateRequestDataConversation from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ConversationMessageCreateRequestDataConversation.parse_obj(obj)

        _obj = ConversationMessageCreateRequestDataConversation.parse_obj({
            "id": obj.get("id")
        })
        return _obj
