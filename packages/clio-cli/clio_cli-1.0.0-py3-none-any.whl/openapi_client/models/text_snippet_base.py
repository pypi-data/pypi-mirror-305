...
class TextSnippetBase(BaseModel):
    ...
    TextSnippetBase
    """
    id: Optional[StrictInt] = Field(default=None, description="Unique identifier for the *TextSnippet*")
    etag: Optional[StrictStr] = Field(default=None, description="ETag for the *TextSnippet*")
    created_at: Optional[datetime] = Field(default=None, description="The time the *TextSnippet* was created (as a ISO-8601 timestamp)")
    updated_at: Optional[datetime] = Field(default=None, description="The time the *TextSnippet* was last updated (as a ISO-8601 timestamp)")
    snippet: Optional[StrictStr] = Field(default=None, description="The abbreviation that should be expanded")
    phrase: Optional[StrictStr] = Field(default=None, description="The phrase the abbreviation should be expanded to")
    whole_word: Optional[StrictBool] = Field(default=None, description="Whether the *TextSnippet* abbreviation requires a space after it has been entered to expand to a phrase")
    __properties = ["id", "etag", "created_at", "updated_at", "snippet", "phrase", "whole_word"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TextSnippetBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TextSnippetBase:
        """Create an instance of TextSnippetBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TextSnippetBase.parse_obj(obj)

        _obj = TextSnippetBase.parse_obj({
            "id": obj.get("id"),
            "etag": obj.get("etag"),
