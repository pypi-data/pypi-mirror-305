...
from openapi_client.models.activity_create_request_data_vendor import ActivityCreateRequestDataVendor  # noqa: E501

class TestActivityCreateRequestDataVendor(unittest.TestCase):
    """ActivityCreateRequestDataVendor unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ActivityCreateRequestDataVendor:
        """Test ActivityCreateRequestDataVendor
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ActivityCreateRequestDataVendor`
        """
        model = ActivityCreateRequestDataVendor()  # noqa: E501
        if include_optional:
            return ActivityCreateRequestDataVendor(
                id = 56
            )
        else:
            return ActivityCreateRequestDataVendor(
    ...
    def testActivityCreateRequestDataVendor(self):
        """Test ActivityCreateRequestDataVendor"""
