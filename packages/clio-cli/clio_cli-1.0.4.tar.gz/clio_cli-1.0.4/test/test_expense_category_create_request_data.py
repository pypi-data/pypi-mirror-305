...
from openapi_client.models.expense_category_create_request_data import ExpenseCategoryCreateRequestData  # noqa: E501

class TestExpenseCategoryCreateRequestData(unittest.TestCase):
    """ExpenseCategoryCreateRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExpenseCategoryCreateRequestData:
        """Test ExpenseCategoryCreateRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExpenseCategoryCreateRequestData`
        """
        model = ExpenseCategoryCreateRequestData()  # noqa: E501
        if include_optional:
            return ExpenseCategoryCreateRequestData(
    ...
    def testExpenseCategoryCreateRequestData(self):
        """Test ExpenseCategoryCreateRequestData"""
