...
from openapi_client.models.text_snippet_update_request_data import TextSnippetUpdateRequestData  # noqa: E501

class TestTextSnippetUpdateRequestData(unittest.TestCase):
    """TextSnippetUpdateRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TextSnippetUpdateRequestData:
        """Test TextSnippetUpdateRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TextSnippetUpdateRequestData`
        """
        model = TextSnippetUpdateRequestData()  # noqa: E501
        if include_optional:
            return TextSnippetUpdateRequestData(
                phrase = '',
                snippet = '',
                whole_word = True
            )
    ...
    def testTextSnippetUpdateRequestData(self):
        """Test TextSnippetUpdateRequestData"""
