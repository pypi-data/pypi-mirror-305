...
from openapi_client.models.contingency_fee_base import ContingencyFeeBase  # noqa: E501

class TestContingencyFeeBase(unittest.TestCase):
    """ContingencyFeeBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ContingencyFeeBase:
        """Test ContingencyFeeBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ContingencyFeeBase`
        """
        model = ContingencyFeeBase()  # noqa: E501
        if include_optional:
            return ContingencyFeeBase(
                id = 56,
                etag = '',
    ...
    def testContingencyFeeBase(self):
        """Test ContingencyFeeBase"""
