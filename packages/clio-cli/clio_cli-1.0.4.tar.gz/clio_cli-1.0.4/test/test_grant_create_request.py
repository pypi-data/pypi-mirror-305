...
from openapi_client.models.grant_create_request import GrantCreateRequest  # noqa: E501
...
class TestGrantCreateRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GrantCreateRequest:
        """Test GrantCreateRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GrantCreateRequest`
        """
        model = GrantCreateRequest()  # noqa: E501
        if include_optional:
            return GrantCreateRequest(
                data = openapi_client.models.grant_create_request_data.Grant_create_request_data(
                    name = '', )
            )
        else:
            return GrantCreateRequest(
