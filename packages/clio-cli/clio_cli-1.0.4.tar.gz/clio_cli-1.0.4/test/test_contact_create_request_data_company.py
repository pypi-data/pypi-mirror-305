...
from openapi_client.models.contact_create_request_data_company import ContactCreateRequestDataCompany  # noqa: E501

class TestContactCreateRequestDataCompany(unittest.TestCase):
    """ContactCreateRequestDataCompany unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ContactCreateRequestDataCompany:
        """Test ContactCreateRequestDataCompany
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ContactCreateRequestDataCompany`
        """
        model = ContactCreateRequestDataCompany()  # noqa: E501
        if include_optional:
            return ContactCreateRequestDataCompany(
                id = 56
            )
        else:
            return ContactCreateRequestDataCompany(
    ...
    def testContactCreateRequestDataCompany(self):
        """Test ContactCreateRequestDataCompany"""
