...
from openapi_client.models.reminder_base import ReminderBase  # noqa: E501

class TestReminderBase(unittest.TestCase):
    """ReminderBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReminderBase:
        """Test ReminderBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReminderBase`
        """
        model = ReminderBase()  # noqa: E501
        if include_optional:
            return ReminderBase(
                id = 56,
                etag = '',
