...
from openapi_client.models.billing_setting_show import BillingSettingShow  # noqa: E501

class TestBillingSettingShow(unittest.TestCase):
    """BillingSettingShow unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BillingSettingShow:
        """Test BillingSettingShow
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BillingSettingShow`
        """
        model = BillingSettingShow()  # noqa: E501
        if include_optional:
            return BillingSettingShow(
                data = None
            )
        else:
            return BillingSettingShow(
    ...
    def testBillingSettingShow(self):
        """Test BillingSettingShow"""
