...
from openapi_client.models.damage_create_request import DamageCreateRequest  # noqa: E501

class TestDamageCreateRequest(unittest.TestCase):
    """DamageCreateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DamageCreateRequest:
        """Test DamageCreateRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DamageCreateRequest`
        """
        model = DamageCreateRequest()  # noqa: E501
        if include_optional:
            return DamageCreateRequest(
                data = openapi_client.models.damage_create_request_data.Damage_create_request_data(
                    amount = 1.337, 
                    damage_type = 'special', 
                    description = '', 
                    matter_id = 56, )
    ...
    def testDamageCreateRequest(self):
        """Test DamageCreateRequest"""
