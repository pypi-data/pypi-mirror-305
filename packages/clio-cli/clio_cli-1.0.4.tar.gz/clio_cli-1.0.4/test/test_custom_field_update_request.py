...
from openapi_client.models.custom_field_update_request import CustomFieldUpdateRequest  # noqa: E501

class TestCustomFieldUpdateRequest(unittest.TestCase):
    """CustomFieldUpdateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CustomFieldUpdateRequest:
        """Test CustomFieldUpdateRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CustomFieldUpdateRequest`
        """
        model = CustomFieldUpdateRequest()  # noqa: E501
        if include_optional:
            return CustomFieldUpdateRequest(
                data = openapi_client.models.custom_field_update_request_data.CustomField_update_request_data(
                    display_order = 56, 
                    displayed = True, 
                    name = '', 
                    picklist_options = [
                        openapi_client.models.custom_field_create_request_data_picklist_options_inner.CustomField_create_request_data_picklist_options_inner(
                            id = 56, 
                            option = '', 
                            _deleted = True, )
                        ], 
    ...
    def testCustomFieldUpdateRequest(self):
        """Test CustomFieldUpdateRequest"""
