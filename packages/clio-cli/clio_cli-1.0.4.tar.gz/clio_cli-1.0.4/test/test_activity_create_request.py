...
from openapi_client.models.activity_create_request import ActivityCreateRequest  # noqa: E501
...
class TestActivityCreateRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ActivityCreateRequest:
        """Test ActivityCreateRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ActivityCreateRequest`
        """
        model = ActivityCreateRequest()  # noqa: E501
        if include_optional:
            return ActivityCreateRequest(
                data = openapi_client.models.activity_create_request_data.Activity_create_request_data(
