...
from openapi_client.models.document_automation_show import DocumentAutomationShow  # noqa: E501

class TestDocumentAutomationShow(unittest.TestCase):
    """DocumentAutomationShow unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentAutomationShow:
        """Test DocumentAutomationShow
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentAutomationShow`
        """
        model = DocumentAutomationShow()  # noqa: E501
        if include_optional:
            return DocumentAutomationShow(
                data = None
            )
        else:
            return DocumentAutomationShow(
    ...
    def testDocumentAutomationShow(self):
        """Test DocumentAutomationShow"""
