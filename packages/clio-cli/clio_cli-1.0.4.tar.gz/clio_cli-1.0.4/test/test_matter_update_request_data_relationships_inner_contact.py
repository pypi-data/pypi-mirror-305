...
from openapi_client.models.matter_update_request_data_relationships_inner_contact import MatterUpdateRequestDataRelationshipsInnerContact  # noqa: E501

class TestMatterUpdateRequestDataRelationshipsInnerContact(unittest.TestCase):
    """MatterUpdateRequestDataRelationshipsInnerContact unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MatterUpdateRequestDataRelationshipsInnerContact:
        """Test MatterUpdateRequestDataRelationshipsInnerContact
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MatterUpdateRequestDataRelationshipsInnerContact`
        """
        model = MatterUpdateRequestDataRelationshipsInnerContact()  # noqa: E501
        if include_optional:
            return MatterUpdateRequestDataRelationshipsInnerContact(
                id = 56
            )
        else:
            return MatterUpdateRequestDataRelationshipsInnerContact(
    ...
    def testMatterUpdateRequestDataRelationshipsInnerContact(self):
        """Test MatterUpdateRequestDataRelationshipsInnerContact"""
