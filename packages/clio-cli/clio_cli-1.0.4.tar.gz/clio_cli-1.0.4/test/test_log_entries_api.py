...
from openapi_client.api.log_entries_api import LogEntriesApi  # noqa: E501


class TestLogEntriesApi(unittest.TestCase):
    """LogEntriesApi unit test stubs"""

    def setUp(self) -> None:
        self.api = LogEntriesApi()

    def tearDown(self) -> None:
        pass

    def test_log_entry_index(self) -> None:
