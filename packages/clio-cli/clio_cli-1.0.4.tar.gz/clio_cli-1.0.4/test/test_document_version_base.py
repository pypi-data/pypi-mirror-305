...
from openapi_client.models.document_version_base import DocumentVersionBase  # noqa: E501

class TestDocumentVersionBase(unittest.TestCase):
    """DocumentVersionBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentVersionBase:
        """Test DocumentVersionBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentVersionBase`
        """
        model = DocumentVersionBase()  # noqa: E501
        if include_optional:
            return DocumentVersionBase(
                id = 56,
                document_id = 56,
                etag = '',
                uuid = '',
    ...
    def testDocumentVersionBase(self):
        """Test DocumentVersionBase"""
