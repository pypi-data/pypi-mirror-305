...
from openapi_client.models.folder_base import FolderBase  # noqa: E501
...
class TestFolderBase(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> FolderBase:
        """Test FolderBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FolderBase`
        """
        model = FolderBase()  # noqa: E501
        if include_optional:
            return FolderBase(
                id = 56,
                etag = '',
