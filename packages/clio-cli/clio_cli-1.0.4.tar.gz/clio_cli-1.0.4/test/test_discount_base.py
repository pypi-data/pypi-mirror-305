...
from openapi_client.models.discount_base import DiscountBase  # noqa: E501

class TestDiscountBase(unittest.TestCase):
    """DiscountBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DiscountBase:
        """Test DiscountBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DiscountBase`
        """
        model = DiscountBase()  # noqa: E501
        if include_optional:
            return DiscountBase(
                rate = 1.337,
                type = 'percentage',
