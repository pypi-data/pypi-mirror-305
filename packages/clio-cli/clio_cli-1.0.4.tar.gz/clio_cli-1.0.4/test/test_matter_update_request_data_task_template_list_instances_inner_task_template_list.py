...
from openapi_client.models.matter_update_request_data_task_template_list_instances_inner_task_template_list import MatterUpdateRequestDataTaskTemplateListInstancesInnerTaskTemplateList  # noqa: E501

class TestMatterUpdateRequestDataTaskTemplateListInstancesInnerTaskTemplateList(unittest.TestCase):
    """MatterUpdateRequestDataTaskTemplateListInstancesInnerTaskTemplateList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MatterUpdateRequestDataTaskTemplateListInstancesInnerTaskTemplateList:
        """Test MatterUpdateRequestDataTaskTemplateListInstancesInnerTaskTemplateList
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MatterUpdateRequestDataTaskTemplateListInstancesInnerTaskTemplateList`
        """
        model = MatterUpdateRequestDataTaskTemplateListInstancesInnerTaskTemplateList()  # noqa: E501
        if include_optional:
            return MatterUpdateRequestDataTaskTemplateListInstancesInnerTaskTemplateList(
                id = 56
            )
        else:
            return MatterUpdateRequestDataTaskTemplateListInstancesInnerTaskTemplateList(
    ...
    def testMatterUpdateRequestDataTaskTemplateListInstancesInnerTaskTemplateList(self):
        """Test MatterUpdateRequestDataTaskTemplateListInstancesInnerTaskTemplateList"""
