...
from openapi_client.models.activity_create_request_data_task import ActivityCreateRequestDataTask  # noqa: E501

class TestActivityCreateRequestDataTask(unittest.TestCase):
    """ActivityCreateRequestDataTask unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ActivityCreateRequestDataTask:
        """Test ActivityCreateRequestDataTask
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ActivityCreateRequestDataTask`
        """
        model = ActivityCreateRequestDataTask()  # noqa: E501
        if include_optional:
            return ActivityCreateRequestDataTask(
                id = 56
            )
        else:
            return ActivityCreateRequestDataTask(
    ...
    def testActivityCreateRequestDataTask(self):
        """Test ActivityCreateRequestDataTask"""
