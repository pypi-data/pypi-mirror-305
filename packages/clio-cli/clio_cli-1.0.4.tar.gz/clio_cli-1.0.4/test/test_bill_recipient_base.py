...
from openapi_client.models.bill_recipient_base import BillRecipientBase  # noqa: E501

class TestBillRecipientBase(unittest.TestCase):
    """BillRecipientBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BillRecipientBase:
        """Test BillRecipientBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BillRecipientBase`
        """
        model = BillRecipientBase()  # noqa: E501
        if include_optional:
            return BillRecipientBase(
    ...
    def testBillRecipientBase(self):
        """Test BillRecipientBase"""
