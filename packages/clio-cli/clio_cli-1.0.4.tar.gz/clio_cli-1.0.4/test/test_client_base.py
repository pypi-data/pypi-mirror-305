...
from openapi_client.models.client_base import ClientBase  # noqa: E501

class TestClientBase(unittest.TestCase):
    """ClientBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ClientBase:
        """Test ClientBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ClientBase`
        """
        model = ClientBase()  # noqa: E501
        if include_optional:
            return ClientBase(
                id = 56,
                name = '',
