...
from openapi_client.models.medical_records_request_create_request_data_medical_records_inner import MedicalRecordsRequestCreateRequestDataMedicalRecordsInner  # noqa: E501

class TestMedicalRecordsRequestCreateRequestDataMedicalRecordsInner(unittest.TestCase):
    """MedicalRecordsRequestCreateRequestDataMedicalRecordsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MedicalRecordsRequestCreateRequestDataMedicalRecordsInner:
        """Test MedicalRecordsRequestCreateRequestDataMedicalRecordsInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MedicalRecordsRequestCreateRequestDataMedicalRecordsInner`
        """
        model = MedicalRecordsRequestCreateRequestDataMedicalRecordsInner()  # noqa: E501
        if include_optional:
            return MedicalRecordsRequestCreateRequestDataMedicalRecordsInner(
                document_id = 56,
    ...
    def testMedicalRecordsRequestCreateRequestDataMedicalRecordsInner(self):
        """Test MedicalRecordsRequestCreateRequestDataMedicalRecordsInner"""
