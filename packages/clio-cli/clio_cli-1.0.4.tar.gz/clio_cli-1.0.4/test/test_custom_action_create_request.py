...
from openapi_client.models.custom_action_create_request import CustomActionCreateRequest  # noqa: E501

class TestCustomActionCreateRequest(unittest.TestCase):
    """CustomActionCreateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CustomActionCreateRequest:
        """Test CustomActionCreateRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CustomActionCreateRequest`
        """
        model = CustomActionCreateRequest()  # noqa: E501
        if include_optional:
            return CustomActionCreateRequest(
                data = openapi_client.models.custom_action_create_request_data.CustomAction_create_request_data(
                    label = '', 
                    target_url = '', 
    ...
    def testCustomActionCreateRequest(self):
        """Test CustomActionCreateRequest"""
