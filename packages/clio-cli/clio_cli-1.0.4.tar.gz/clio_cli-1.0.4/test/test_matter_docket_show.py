...
from openapi_client.models.matter_docket_show import MatterDocketShow  # noqa: E501

class TestMatterDocketShow(unittest.TestCase):
    """MatterDocketShow unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MatterDocketShow:
        """Test MatterDocketShow
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MatterDocketShow`
        """
        model = MatterDocketShow()  # noqa: E501
        if include_optional:
            return MatterDocketShow(
                data = None
            )
        else:
            return MatterDocketShow(
