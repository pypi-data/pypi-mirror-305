...
from openapi_client.models.clio_payments_link_create_request_data_destination_account import ClioPaymentsLinkCreateRequestDataDestinationAccount  # noqa: E501

class TestClioPaymentsLinkCreateRequestDataDestinationAccount(unittest.TestCase):
    """ClioPaymentsLinkCreateRequestDataDestinationAccount unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ClioPaymentsLinkCreateRequestDataDestinationAccount:
        """Test ClioPaymentsLinkCreateRequestDataDestinationAccount
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ClioPaymentsLinkCreateRequestDataDestinationAccount`
        """
        model = ClioPaymentsLinkCreateRequestDataDestinationAccount()  # noqa: E501
        if include_optional:
            return ClioPaymentsLinkCreateRequestDataDestinationAccount(
                id = 56
            )
        else:
            return ClioPaymentsLinkCreateRequestDataDestinationAccount(
    ...
    def testClioPaymentsLinkCreateRequestDataDestinationAccount(self):
        """Test ClioPaymentsLinkCreateRequestDataDestinationAccount"""
