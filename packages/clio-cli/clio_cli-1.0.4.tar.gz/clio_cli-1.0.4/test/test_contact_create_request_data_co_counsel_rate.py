...
from openapi_client.models.contact_create_request_data_co_counsel_rate import ContactCreateRequestDataCoCounselRate  # noqa: E501

class TestContactCreateRequestDataCoCounselRate(unittest.TestCase):
    """ContactCreateRequestDataCoCounselRate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ContactCreateRequestDataCoCounselRate:
        """Test ContactCreateRequestDataCoCounselRate
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ContactCreateRequestDataCoCounselRate`
        """
        model = ContactCreateRequestDataCoCounselRate()  # noqa: E501
        if include_optional:
            return ContactCreateRequestDataCoCounselRate(
                rate = 1.337
            )
        else:
            return ContactCreateRequestDataCoCounselRate(
    ...
    def testContactCreateRequestDataCoCounselRate(self):
        """Test ContactCreateRequestDataCoCounselRate"""
