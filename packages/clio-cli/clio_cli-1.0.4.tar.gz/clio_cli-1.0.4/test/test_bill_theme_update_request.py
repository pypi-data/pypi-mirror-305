...
from openapi_client.models.bill_theme_update_request import BillThemeUpdateRequest  # noqa: E501

class TestBillThemeUpdateRequest(unittest.TestCase):
    """BillThemeUpdateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BillThemeUpdateRequest:
        """Test BillThemeUpdateRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BillThemeUpdateRequest`
        """
        model = BillThemeUpdateRequest()  # noqa: E501
        if include_optional:
            return BillThemeUpdateRequest(
                data = openapi_client.models.bill_theme_update_request_data.BillTheme_update_request_data(
                    config = '', 
                    name = '', )
            )
        else:
    ...
    def testBillThemeUpdateRequest(self):
        """Test BillThemeUpdateRequest"""
