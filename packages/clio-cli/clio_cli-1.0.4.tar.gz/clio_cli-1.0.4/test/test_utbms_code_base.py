...
from openapi_client.models.utbms_code_base import UtbmsCodeBase  # noqa: E501

class TestUtbmsCodeBase(unittest.TestCase):
    """UtbmsCodeBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UtbmsCodeBase:
        """Test UtbmsCodeBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UtbmsCodeBase`
        """
        model = UtbmsCodeBase()  # noqa: E501
        if include_optional:
            return UtbmsCodeBase(
                id = 56,
                etag = '',
                name = '',
                code = '',
