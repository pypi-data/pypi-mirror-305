...
from openapi_client.api.utbms_sets_api import UtbmsSetsApi  # noqa: E501


class TestUtbmsSetsApi(unittest.TestCase):
    """UtbmsSetsApi unit test stubs"""

    def setUp(self) -> None:
        self.api = UtbmsSetsApi()

    def tearDown(self) -> None:
        pass

    def test_utbms_set_index(self) -> None:
