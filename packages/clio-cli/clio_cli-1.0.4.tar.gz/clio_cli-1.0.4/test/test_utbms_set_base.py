...
from openapi_client.models.utbms_set_base import UtbmsSetBase  # noqa: E501

class TestUtbmsSetBase(unittest.TestCase):
    """UtbmsSetBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UtbmsSetBase:
        """Test UtbmsSetBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UtbmsSetBase`
        """
        model = UtbmsSetBase()  # noqa: E501
        if include_optional:
            return UtbmsSetBase(
                id = 56,
                etag = '',
