...
from openapi_client.models.bank_account_create_request import BankAccountCreateRequest  # noqa: E501

class TestBankAccountCreateRequest(unittest.TestCase):
    """BankAccountCreateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BankAccountCreateRequest:
        """Test BankAccountCreateRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BankAccountCreateRequest`
        """
        model = BankAccountCreateRequest()  # noqa: E501
        if include_optional:
            return BankAccountCreateRequest(
                data = openapi_client.models.bank_account_create_request_data.BankAccount_create_request_data(
                    account_number = '', 
                    balance = 1.337, 
    ...
    def testBankAccountCreateRequest(self):
        """Test BankAccountCreateRequest"""
