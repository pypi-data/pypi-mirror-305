...
from openapi_client.models.allocation_show import AllocationShow  # noqa: E501

class TestAllocationShow(unittest.TestCase):
    """AllocationShow unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AllocationShow:
        """Test AllocationShow
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AllocationShow`
        """
        model = AllocationShow()  # noqa: E501
        if include_optional:
            return AllocationShow(
                data = None
            )
        else:
            return AllocationShow(
