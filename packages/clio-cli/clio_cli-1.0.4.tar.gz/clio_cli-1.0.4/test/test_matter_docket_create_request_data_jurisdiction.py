...
from openapi_client.models.matter_docket_create_request_data_jurisdiction import MatterDocketCreateRequestDataJurisdiction  # noqa: E501

class TestMatterDocketCreateRequestDataJurisdiction(unittest.TestCase):
    """MatterDocketCreateRequestDataJurisdiction unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MatterDocketCreateRequestDataJurisdiction:
        """Test MatterDocketCreateRequestDataJurisdiction
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MatterDocketCreateRequestDataJurisdiction`
        """
        model = MatterDocketCreateRequestDataJurisdiction()  # noqa: E501
        if include_optional:
            return MatterDocketCreateRequestDataJurisdiction(
                id = 56
            )
        else:
            return MatterDocketCreateRequestDataJurisdiction(
    ...
    def testMatterDocketCreateRequestDataJurisdiction(self):
        """Test MatterDocketCreateRequestDataJurisdiction"""
