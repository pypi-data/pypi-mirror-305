...
from openapi_client.models.billable_matter_base import BillableMatterBase  # noqa: E501

class TestBillableMatterBase(unittest.TestCase):
    """BillableMatterBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BillableMatterBase:
        """Test BillableMatterBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BillableMatterBase`
        """
        model = BillableMatterBase()  # noqa: E501
        if include_optional:
            return BillableMatterBase(
                id = 56,
    ...
    def testBillableMatterBase(self):
        """Test BillableMatterBase"""
