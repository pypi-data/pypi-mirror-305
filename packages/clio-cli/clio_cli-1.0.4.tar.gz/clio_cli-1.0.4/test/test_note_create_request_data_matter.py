...
from openapi_client.models.note_create_request_data_matter import NoteCreateRequestDataMatter  # noqa: E501

class TestNoteCreateRequestDataMatter(unittest.TestCase):
    """NoteCreateRequestDataMatter unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NoteCreateRequestDataMatter:
        """Test NoteCreateRequestDataMatter
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NoteCreateRequestDataMatter`
        """
        model = NoteCreateRequestDataMatter()  # noqa: E501
        if include_optional:
            return NoteCreateRequestDataMatter(
                id = 56
            )
        else:
            return NoteCreateRequestDataMatter(
    ...
    def testNoteCreateRequestDataMatter(self):
        """Test NoteCreateRequestDataMatter"""
