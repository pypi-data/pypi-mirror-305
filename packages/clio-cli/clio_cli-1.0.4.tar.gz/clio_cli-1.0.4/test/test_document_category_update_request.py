...
from openapi_client.models.document_category_update_request import DocumentCategoryUpdateRequest  # noqa: E501
...
class TestDocumentCategoryUpdateRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DocumentCategoryUpdateRequest:
        ...
        """
        model = DocumentCategoryUpdateRequest()  # noqa: E501
        if include_optional:
            return DocumentCategoryUpdateRequest(
                data = openapi_client.models.document_category_update_request_data.DocumentCategory_update_request_data(
                    name = '', )
            )
        else:
            return DocumentCategoryUpdateRequest(
