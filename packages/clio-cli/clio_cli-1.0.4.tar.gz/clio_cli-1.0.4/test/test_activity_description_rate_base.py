...
from openapi_client.models.activity_description_rate_base import ActivityDescriptionRateBase  # noqa: E501

class TestActivityDescriptionRateBase(unittest.TestCase):
    """ActivityDescriptionRateBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ActivityDescriptionRateBase:
        """Test ActivityDescriptionRateBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ActivityDescriptionRateBase`
        """
        model = ActivityDescriptionRateBase()  # noqa: E501
        if include_optional:
            return ActivityDescriptionRateBase(
                amount = 1.337,
    ...
    def testActivityDescriptionRateBase(self):
        """Test ActivityDescriptionRateBase"""
