...
from openapi_client.models.note_create_request_data_contact import NoteCreateRequestDataContact  # noqa: E501

class TestNoteCreateRequestDataContact(unittest.TestCase):
    """NoteCreateRequestDataContact unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NoteCreateRequestDataContact:
        """Test NoteCreateRequestDataContact
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NoteCreateRequestDataContact`
        """
        model = NoteCreateRequestDataContact()  # noqa: E501
        if include_optional:
            return NoteCreateRequestDataContact(
                id = 56
            )
        else:
            return NoteCreateRequestDataContact(
    ...
    def testNoteCreateRequestDataContact(self):
        """Test NoteCreateRequestDataContact"""
