...
from openapi_client.models.activity_description_show import ActivityDescriptionShow  # noqa: E501

class TestActivityDescriptionShow(unittest.TestCase):
    """ActivityDescriptionShow unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ActivityDescriptionShow:
        """Test ActivityDescriptionShow
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ActivityDescriptionShow`
        """
        model = ActivityDescriptionShow()  # noqa: E501
        if include_optional:
            return ActivityDescriptionShow(
                data = None
            )
        else:
            return ActivityDescriptionShow(
    ...
    def testActivityDescriptionShow(self):
        """Test ActivityDescriptionShow"""
