...
from openapi_client.models.note_create_request_data import NoteCreateRequestData  # noqa: E501

class TestNoteCreateRequestData(unittest.TestCase):
    """NoteCreateRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NoteCreateRequestData:
        """Test NoteCreateRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NoteCreateRequestData`
        """
        model = NoteCreateRequestData()  # noqa: E501
        if include_optional:
            return NoteCreateRequestData(
                contact = openapi_client.models.note_create_request_data_contact.Note_create_request_data_contact(
                    id = 56, ),
                var_date = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(),
                detail = '',
                matter = openapi_client.models.note_create_request_data_matter.Note_create_request_data_matter(
                    id = 56, ),
                notification_event_subscribers = [
                    openapi_client.models.note_create_request_data_notification_event_subscribers_inner.Note_create_request_data_notification_event_subscribers_inner(
                        user_id = '', )
                    ],
                subject = '',
                type = 'Matter'
    ...
    def testNoteCreateRequestData(self):
        """Test NoteCreateRequestData"""
