...
from openapi_client.models.currency_base import CurrencyBase  # noqa: E501

class TestCurrencyBase(unittest.TestCase):
    """CurrencyBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CurrencyBase:
        """Test CurrencyBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CurrencyBase`
        """
        model = CurrencyBase()  # noqa: E501
        if include_optional:
            return CurrencyBase(
                id = 56,
                etag = '',
