...
from openapi_client.models.relationship_list import RelationshipList  # noqa: E501
...
class TestRelationshipList(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> RelationshipList:
        """Test RelationshipList
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RelationshipList`
        """
        model = RelationshipList()  # noqa: E501
        if include_optional:
