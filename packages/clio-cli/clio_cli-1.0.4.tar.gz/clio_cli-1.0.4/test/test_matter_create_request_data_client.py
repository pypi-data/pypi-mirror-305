...
from openapi_client.models.matter_create_request_data_client import MatterCreateRequestDataClient  # noqa: E501

class TestMatterCreateRequestDataClient(unittest.TestCase):
    """MatterCreateRequestDataClient unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MatterCreateRequestDataClient:
        """Test MatterCreateRequestDataClient
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MatterCreateRequestDataClient`
        """
        model = MatterCreateRequestDataClient()  # noqa: E501
        if include_optional:
            return MatterCreateRequestDataClient(
                id = 56
            )
        else:
            return MatterCreateRequestDataClient(
    ...
    def testMatterCreateRequestDataClient(self):
        """Test MatterCreateRequestDataClient"""
