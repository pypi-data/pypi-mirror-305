...
from openapi_client.models.matter_show import MatterShow  # noqa: E501

class TestMatterShow(unittest.TestCase):
    """MatterShow unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MatterShow:
        """Test MatterShow
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MatterShow`
        """
        model = MatterShow()  # noqa: E501
        if include_optional:
            return MatterShow(
                data = None
            )
