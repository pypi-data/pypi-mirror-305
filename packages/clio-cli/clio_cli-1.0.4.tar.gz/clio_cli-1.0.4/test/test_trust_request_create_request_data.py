...
from openapi_client.models.trust_request_create_request_data import TrustRequestCreateRequestData  # noqa: E501

class TestTrustRequestCreateRequestData(unittest.TestCase):
    """TrustRequestCreateRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TrustRequestCreateRequestData:
        """Test TrustRequestCreateRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TrustRequestCreateRequestData`
        """
        model = TrustRequestCreateRequestData()  # noqa: E501
        if include_optional:
            return TrustRequestCreateRequestData(
                approved = True,
                client_id = 56,
    ...
    def testTrustRequestCreateRequestData(self):
        """Test TrustRequestCreateRequestData"""
