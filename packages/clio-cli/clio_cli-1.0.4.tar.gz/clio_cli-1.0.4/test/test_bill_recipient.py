...
from openapi_client.models.bill_recipient import BillRecipient  # noqa: E501

class TestBillRecipient(unittest.TestCase):
    """BillRecipient unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BillRecipient:
        """Test BillRecipient
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BillRecipient`
        """
        model = BillRecipient()  # noqa: E501
        if include_optional:
            return BillRecipient(
                ...
                recipient = openapi_client.models.bill_recipient_contact_base.BillRecipient_Contact_base(
                    id = 56, 
                    name = '', 
                    first_name = '', 
                    middle_name = '', 
