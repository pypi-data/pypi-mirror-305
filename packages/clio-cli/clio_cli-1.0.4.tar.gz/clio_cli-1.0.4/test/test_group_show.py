...
from openapi_client.models.group_show import GroupShow  # noqa: E501

class TestGroupShow(unittest.TestCase):
    """GroupShow unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GroupShow:
        """Test GroupShow
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GroupShow`
        """
        model = GroupShow()  # noqa: E501
        if include_optional:
            return GroupShow(
                data = None
            )
