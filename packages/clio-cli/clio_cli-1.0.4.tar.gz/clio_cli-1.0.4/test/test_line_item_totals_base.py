...
from openapi_client.models.line_item_totals_base import LineItemTotalsBase  # noqa: E501

class TestLineItemTotalsBase(unittest.TestCase):
    """LineItemTotalsBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LineItemTotalsBase:
        """Test LineItemTotalsBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LineItemTotalsBase`
        """
        model = LineItemTotalsBase()  # noqa: E501
        if include_optional:
            return LineItemTotalsBase(
                quantity = 1.337,
                price = 1.337,
    ...
    def testLineItemTotalsBase(self):
        """Test LineItemTotalsBase"""
