...
from openapi_client.models.practice_area_update_request_data import PracticeAreaUpdateRequestData  # noqa: E501

class TestPracticeAreaUpdateRequestData(unittest.TestCase):
    """PracticeAreaUpdateRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PracticeAreaUpdateRequestData:
        """Test PracticeAreaUpdateRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PracticeAreaUpdateRequestData`
        """
        model = PracticeAreaUpdateRequestData()  # noqa: E501
        if include_optional:
            return PracticeAreaUpdateRequestData(
    ...
    def testPracticeAreaUpdateRequestData(self):
        """Test PracticeAreaUpdateRequestData"""
