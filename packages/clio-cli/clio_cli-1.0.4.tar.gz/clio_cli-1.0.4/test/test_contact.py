    ...
    def make_instance(self, include_optional) -> Contact:
        ...
        if include_optional:
            return Contact(
                ...
                sales_tax_number = '',
                activity_rates = [
                    openapi_client.models.activity_rate_base.ActivityRate_base(
                        id = 56, 
                        etag = '', 
                        rate = 1.337, 
                        flat_rate = True, 
                        ...
                        updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        contact_id = 56, 
                        co_counsel_contact_id = 56, )
                    ],
                addresses = [
                    openapi_client.models.address_base.Address_base(
                        id = 56, 
                        etag = '', 
                        street = '', 
                        city = '', 
                ...
                custom_field_set_associations = [
                    openapi_client.models.custom_field_set_association_base.CustomFieldSetAssociation_base(
                        id = 56, 
                        etag = '', 
                        display_order = 56, 
                        created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                ...
                email_addresses = [
                    openapi_client.models.email_address_base.EmailAddress_base(
                        id = 56, 
                        etag = '', 
                        address = '', 
                        name = '', 
                ...
                instant_messengers = [
                    openapi_client.models.instant_messenger_base.InstantMessenger_base(
                        id = 56, 
                        etag = '', 
                        address = '', 
                        name = 'Work', 
                ...
                phone_numbers = [
                    openapi_client.models.phone_number_base.PhoneNumber_base(
                        id = 56, 
                        etag = '', 
                        number = '', 
                        name = 'Work', 
                ...
                web_sites = [
                    openapi_client.models.web_site_base.WebSite_base(
                        id = 56, 
                        etag = '', 
                        address = '', 
                        name = 'Work', 
                ...
                notification_methods = [
                    openapi_client.models.notification_method_base.NotificationMethod_base(
                        id = 56, 
                        etag = '', 
                        type = 'Email', 
                        email_address = '', 
                ...
                account_balances = [
                    openapi_client.models.account_balance_base.AccountBalance_base(
                        id = 56, 
                        balance = 1.337, 
                        type = '', 
                        name = '', )
                ...
                related_contacts = [
                    openapi_client.models.contact_base.Contact_base(
                        id = 56, 
                        etag = '', 
                        name = '', 
                        first_name = '', 
                ...
                primary_work_address = openapi_client.models.address_base.Address_base(
                    id = 56, 
                    etag = '', 
                    street = '', 
                    city = '', 
                    ...
                    updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    primary = True, ),
                primary_address = openapi_client.models.address_base.Address_base(
                    id = 56, 
                    etag = '', 
                    street = '', 
                    city = '', 
                    ...
                    updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    primary = True, ),
                secondary_address = openapi_client.models.address_base.Address_base(
                    id = 56, 
                    etag = '', 
                    street = '', 
                    city = '', 
                    ...
                    updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    primary = True, ),
                company = openapi_client.models.contact_base.Contact_base(
                    id = 56, 
                    etag = '', 
                    name = '', 
                    first_name = '', 
                    ...
                    is_bill_recipient = True, 
                    sales_tax_number = '', ),
                avatar = openapi_client.models.avatar_base.Avatar_base(
                    id = 56, 
                    etag = '', 
                    created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    url = '', 
                    _destroy = True, ),
                payment_profile = openapi_client.models.payment_profile_base.PaymentProfile_base(
                    id = 56, 
                    etag = '', 
                    created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    billing_setting_id = 56, 
                    name = '', 
                    terms = 56, 
                    discount_rate = 1.337, 
                    discount_period = 56, 
                ...
                folder = openapi_client.models.folder_base.Folder_base(
                    id = 56, 
                    etag = '', 
                    created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    ...
                    name = '', 
                    root = True, ),
                co_counsel_rate = openapi_client.models.activity_rate_base.ActivityRate_base(
                    id = 56, 
                    etag = '', 
                    rate = 1.337, 
                    flat_rate = True, 
                    ...
                    contact_id = 56, 
                    co_counsel_contact_id = 56, ),
                primary_web_site = openapi_client.models.web_site_base.WebSite_base(
                    id = 56, 
                    etag = '', 
                    address = '', 
                    name = 'Work', 
                    ...
                    created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), ),
                legal_aid_uk_contact = openapi_client.models.legal_aid_uk_contact_base.LegalAidUkContact_base(
                    id = 56, 
                    disability = 56, 
                    disability_code = '', 
                    ethnicity = 56, 
