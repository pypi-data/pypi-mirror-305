...
from openapi_client.models.activity_rate_list import ActivityRateList  # noqa: E501

class TestActivityRateList(unittest.TestCase):
    """ActivityRateList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ActivityRateList:
        """Test ActivityRateList
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ActivityRateList`
        """
        model = ActivityRateList()  # noqa: E501
        if include_optional:
            return ActivityRateList(
                data = [
                    null
                    ]
            )
