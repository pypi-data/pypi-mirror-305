...
from openapi_client.models.custom_field_update_request_data import CustomFieldUpdateRequestData  # noqa: E501

class TestCustomFieldUpdateRequestData(unittest.TestCase):
    """CustomFieldUpdateRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CustomFieldUpdateRequestData:
        """Test CustomFieldUpdateRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CustomFieldUpdateRequestData`
        """
        model = CustomFieldUpdateRequestData()  # noqa: E501
        if include_optional:
            return CustomFieldUpdateRequestData(
                display_order = 56,
                displayed = True,
                name = '',
                picklist_options = [
    ...
    def testCustomFieldUpdateRequestData(self):
        """Test CustomFieldUpdateRequestData"""
