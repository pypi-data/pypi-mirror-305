...
from openapi_client.models.matter_create_request_data_practice_area import MatterCreateRequestDataPracticeArea  # noqa: E501

class TestMatterCreateRequestDataPracticeArea(unittest.TestCase):
    """MatterCreateRequestDataPracticeArea unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MatterCreateRequestDataPracticeArea:
        """Test MatterCreateRequestDataPracticeArea
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MatterCreateRequestDataPracticeArea`
        """
        model = MatterCreateRequestDataPracticeArea()  # noqa: E501
        if include_optional:
            return MatterCreateRequestDataPracticeArea(
                id = 56
            )
        else:
            return MatterCreateRequestDataPracticeArea(
    ...
    def testMatterCreateRequestDataPracticeArea(self):
        """Test MatterCreateRequestDataPracticeArea"""
