...
from openapi_client.models.document_automation_create_request_data_document_template import DocumentAutomationCreateRequestDataDocumentTemplate  # noqa: E501

class TestDocumentAutomationCreateRequestDataDocumentTemplate(unittest.TestCase):
    """DocumentAutomationCreateRequestDataDocumentTemplate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentAutomationCreateRequestDataDocumentTemplate:
        """Test DocumentAutomationCreateRequestDataDocumentTemplate
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentAutomationCreateRequestDataDocumentTemplate`
        """
        model = DocumentAutomationCreateRequestDataDocumentTemplate()  # noqa: E501
        if include_optional:
            return DocumentAutomationCreateRequestDataDocumentTemplate(
                id = 56
            )
        else:
            return DocumentAutomationCreateRequestDataDocumentTemplate(
    ...
    def testDocumentAutomationCreateRequestDataDocumentTemplate(self):
        """Test DocumentAutomationCreateRequestDataDocumentTemplate"""
