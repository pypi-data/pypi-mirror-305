...
from openapi_client.models.my_event_list import MyEventList  # noqa: E501

class TestMyEventList(unittest.TestCase):
    """MyEventList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MyEventList:
        """Test MyEventList
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MyEventList`
        """
        model = MyEventList()  # noqa: E501
        if include_optional:
            return MyEventList(
                data = [
                    null
