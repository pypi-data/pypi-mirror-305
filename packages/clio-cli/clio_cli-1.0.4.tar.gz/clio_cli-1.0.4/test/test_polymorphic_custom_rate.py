...
from openapi_client.models.polymorphic_custom_rate import PolymorphicCustomRate  # noqa: E501

class TestPolymorphicCustomRate(unittest.TestCase):
    """PolymorphicCustomRate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolymorphicCustomRate:
        """Test PolymorphicCustomRate
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolymorphicCustomRate`
        """
        model = PolymorphicCustomRate()  # noqa: E501
        if include_optional:
            return PolymorphicCustomRate(
                id = 56,
                etag = '',
                ...
                user = openapi_client.models.polymorphic_custom_rate_user_base.PolymorphicCustomRate_User_base(
                    enabled = True, 
                    etag = '', 
                    id = 56, 
                    name = '', ),
                group = openapi_client.models.polymorphic_custom_rate_group_base.PolymorphicCustomRate_Group_base(
                    etag = '', 
                    id = 56, 
                    name = '', ),
                activity_description = openapi_client.models.polymorphic_custom_rate_activity_description_base.PolymorphicCustomRate_ActivityDescription_base(
                    id = 56, 
                    etag = '', 
                    name = '', )
            )
    ...
    def testPolymorphicCustomRate(self):
        """Test PolymorphicCustomRate"""
