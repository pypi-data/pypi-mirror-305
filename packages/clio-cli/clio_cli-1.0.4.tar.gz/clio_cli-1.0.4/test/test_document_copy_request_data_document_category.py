...
from openapi_client.models.document_copy_request_data_document_category import DocumentCopyRequestDataDocumentCategory  # noqa: E501

class TestDocumentCopyRequestDataDocumentCategory(unittest.TestCase):
    """DocumentCopyRequestDataDocumentCategory unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentCopyRequestDataDocumentCategory:
        """Test DocumentCopyRequestDataDocumentCategory
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentCopyRequestDataDocumentCategory`
        """
        model = DocumentCopyRequestDataDocumentCategory()  # noqa: E501
        if include_optional:
            return DocumentCopyRequestDataDocumentCategory(
                id = 56
            )
        else:
            return DocumentCopyRequestDataDocumentCategory(
    ...
    def testDocumentCopyRequestDataDocumentCategory(self):
        """Test DocumentCopyRequestDataDocumentCategory"""
