...
from openapi_client.models.clio_payments_link_create_request_data_subject import ClioPaymentsLinkCreateRequestDataSubject  # noqa: E501

class TestClioPaymentsLinkCreateRequestDataSubject(unittest.TestCase):
    """ClioPaymentsLinkCreateRequestDataSubject unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ClioPaymentsLinkCreateRequestDataSubject:
        """Test ClioPaymentsLinkCreateRequestDataSubject
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ClioPaymentsLinkCreateRequestDataSubject`
        """
        model = ClioPaymentsLinkCreateRequestDataSubject()  # noqa: E501
        if include_optional:
            return ClioPaymentsLinkCreateRequestDataSubject(
                id = 56,
                type = 'BankAccount'
            )
        else:
    ...
    def testClioPaymentsLinkCreateRequestDataSubject(self):
        """Test ClioPaymentsLinkCreateRequestDataSubject"""
