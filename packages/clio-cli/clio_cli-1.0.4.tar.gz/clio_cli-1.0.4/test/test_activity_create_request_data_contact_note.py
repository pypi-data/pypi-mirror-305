...
from openapi_client.models.activity_create_request_data_contact_note import ActivityCreateRequestDataContactNote  # noqa: E501

class TestActivityCreateRequestDataContactNote(unittest.TestCase):
    """ActivityCreateRequestDataContactNote unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ActivityCreateRequestDataContactNote:
        """Test ActivityCreateRequestDataContactNote
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ActivityCreateRequestDataContactNote`
        """
        model = ActivityCreateRequestDataContactNote()  # noqa: E501
        if include_optional:
            return ActivityCreateRequestDataContactNote(
                id = 56
            )
        else:
            return ActivityCreateRequestDataContactNote(
    ...
    def testActivityCreateRequestDataContactNote(self):
        """Test ActivityCreateRequestDataContactNote"""
