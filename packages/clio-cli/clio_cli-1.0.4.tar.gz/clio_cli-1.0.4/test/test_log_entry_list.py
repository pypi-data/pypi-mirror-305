...
from openapi_client.models.log_entry_list import LogEntryList  # noqa: E501

class TestLogEntryList(unittest.TestCase):
    """LogEntryList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LogEntryList:
        """Test LogEntryList
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LogEntryList`
        """
        model = LogEntryList()  # noqa: E501
        if include_optional:
            return LogEntryList(
                data = [
                    null
