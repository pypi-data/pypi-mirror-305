...
from openapi_client.models.polymorphic_object_base import PolymorphicObjectBase  # noqa: E501

class TestPolymorphicObjectBase(unittest.TestCase):
    """PolymorphicObjectBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolymorphicObjectBase:
        """Test PolymorphicObjectBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolymorphicObjectBase`
        """
        model = PolymorphicObjectBase()  # noqa: E501
        if include_optional:
            return PolymorphicObjectBase(
                id = 56,
                type = 'Task',
                identifier = '',
    ...
    def testPolymorphicObjectBase(self):
        """Test PolymorphicObjectBase"""
