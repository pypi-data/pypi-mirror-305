...
from openapi_client.models.activity_create_request_data_user import ActivityCreateRequestDataUser  # noqa: E501

class TestActivityCreateRequestDataUser(unittest.TestCase):
    """ActivityCreateRequestDataUser unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ActivityCreateRequestDataUser:
        """Test ActivityCreateRequestDataUser
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ActivityCreateRequestDataUser`
        """
        model = ActivityCreateRequestDataUser()  # noqa: E501
        if include_optional:
            return ActivityCreateRequestDataUser(
                id = 56
            )
        else:
            return ActivityCreateRequestDataUser(
    ...
    def testActivityCreateRequestDataUser(self):
        """Test ActivityCreateRequestDataUser"""
