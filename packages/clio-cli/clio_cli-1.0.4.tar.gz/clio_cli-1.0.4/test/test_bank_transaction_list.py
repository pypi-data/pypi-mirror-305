...
from openapi_client.models.bank_transaction_list import BankTransactionList  # noqa: E501

class TestBankTransactionList(unittest.TestCase):
    """BankTransactionList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BankTransactionList:
        """Test BankTransactionList
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BankTransactionList`
        """
        model = BankTransactionList()  # noqa: E501
        if include_optional:
    ...
    def testBankTransactionList(self):
        """Test BankTransactionList"""
