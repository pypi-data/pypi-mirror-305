...
from openapi_client.models.matter_docket_base import MatterDocketBase  # noqa: E501

class TestMatterDocketBase(unittest.TestCase):
    """MatterDocketBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MatterDocketBase:
        """Test MatterDocketBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MatterDocketBase`
        """
        model = MatterDocketBase()  # noqa: E501
        if include_optional:
            return MatterDocketBase(
                id = 56,
                etag = '',
                name = '',
