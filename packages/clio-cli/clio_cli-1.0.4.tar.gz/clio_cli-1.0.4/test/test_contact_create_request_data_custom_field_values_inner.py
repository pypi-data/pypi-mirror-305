...
from openapi_client.models.contact_create_request_data_custom_field_values_inner import ContactCreateRequestDataCustomFieldValuesInner  # noqa: E501

class TestContactCreateRequestDataCustomFieldValuesInner(unittest.TestCase):
    """ContactCreateRequestDataCustomFieldValuesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ContactCreateRequestDataCustomFieldValuesInner:
        """Test ContactCreateRequestDataCustomFieldValuesInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ContactCreateRequestDataCustomFieldValuesInner`
        """
        model = ContactCreateRequestDataCustomFieldValuesInner()  # noqa: E501
        if include_optional:
            return ContactCreateRequestDataCustomFieldValuesInner(
                value = '',
    ...
    def testContactCreateRequestDataCustomFieldValuesInner(self):
        """Test ContactCreateRequestDataCustomFieldValuesInner"""
