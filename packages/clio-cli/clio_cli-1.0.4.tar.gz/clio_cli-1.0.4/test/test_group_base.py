...
from openapi_client.models.group_base import GroupBase  # noqa: E501
...
class TestGroupBase(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GroupBase:
        """Test GroupBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GroupBase`
        """
        model = GroupBase()  # noqa: E501
        if include_optional:
            return GroupBase(
