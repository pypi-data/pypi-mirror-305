...
from openapi_client.models.jurisdiction import Jurisdiction  # noqa: E501
    ...
    def make_instance(self, include_optional) -> Jurisdiction:
        ...
        if include_optional:
            return Jurisdiction(
                ...
                service_types = [
                    openapi_client.models.service_type_base.ServiceType_base(
                        id = 56, 
                        etag = '', 
                        created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
