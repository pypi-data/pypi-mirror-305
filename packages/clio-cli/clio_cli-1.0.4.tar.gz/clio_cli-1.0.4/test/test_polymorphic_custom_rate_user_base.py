...
from openapi_client.models.polymorphic_custom_rate_user_base import PolymorphicCustomRateUserBase  # noqa: E501

class TestPolymorphicCustomRateUserBase(unittest.TestCase):
    """PolymorphicCustomRateUserBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolymorphicCustomRateUserBase:
        """Test PolymorphicCustomRateUserBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolymorphicCustomRateUserBase`
        """
        model = PolymorphicCustomRateUserBase()  # noqa: E501
        if include_optional:
            return PolymorphicCustomRateUserBase(
                enabled = True,
                etag = '',
                id = 56,
                name = ''
    ...
    def testPolymorphicCustomRateUserBase(self):
        """Test PolymorphicCustomRateUserBase"""
