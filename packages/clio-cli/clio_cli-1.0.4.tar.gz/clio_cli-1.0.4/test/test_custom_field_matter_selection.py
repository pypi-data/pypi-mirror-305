...
from openapi_client.models.custom_field_matter_selection import CustomFieldMatterSelection  # noqa: E501

class TestCustomFieldMatterSelection(unittest.TestCase):
    """CustomFieldMatterSelection unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CustomFieldMatterSelection:
        """Test CustomFieldMatterSelection
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CustomFieldMatterSelection`
        """
        model = CustomFieldMatterSelection()  # noqa: E501
        if include_optional:
            return CustomFieldMatterSelection(
                id = 56,
                display_number = ''
            )
        else:
    ...
    def testCustomFieldMatterSelection(self):
        """Test CustomFieldMatterSelection"""
