...
from openapi_client.models.activity_create_request_data_matter import ActivityCreateRequestDataMatter  # noqa: E501

class TestActivityCreateRequestDataMatter(unittest.TestCase):
    """ActivityCreateRequestDataMatter unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ActivityCreateRequestDataMatter:
        """Test ActivityCreateRequestDataMatter
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ActivityCreateRequestDataMatter`
        """
        model = ActivityCreateRequestDataMatter()  # noqa: E501
        if include_optional:
            return ActivityCreateRequestDataMatter(
                id = 56
            )
        else:
            return ActivityCreateRequestDataMatter(
    ...
    def testActivityCreateRequestDataMatter(self):
        """Test ActivityCreateRequestDataMatter"""
