...
from openapi_client.models.document_automation_create_request_data import DocumentAutomationCreateRequestData  # noqa: E501

class TestDocumentAutomationCreateRequestData(unittest.TestCase):
    """DocumentAutomationCreateRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentAutomationCreateRequestData:
        """Test DocumentAutomationCreateRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentAutomationCreateRequestData`
        """
        model = DocumentAutomationCreateRequestData()  # noqa: E501
        if include_optional:
            return DocumentAutomationCreateRequestData(
    ...
    def testDocumentAutomationCreateRequestData(self):
        """Test DocumentAutomationCreateRequestData"""
