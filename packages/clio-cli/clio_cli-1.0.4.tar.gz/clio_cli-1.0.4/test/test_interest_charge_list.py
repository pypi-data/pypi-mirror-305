...
from openapi_client.models.interest_charge_list import InterestChargeList  # noqa: E501

class TestInterestChargeList(unittest.TestCase):
    """InterestChargeList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterestChargeList:
        """Test InterestChargeList
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterestChargeList`
        """
        model = InterestChargeList()  # noqa: E501
        if include_optional:
            return InterestChargeList(
                data = [
                    null
                    ]
            )
    ...
    def testInterestChargeList(self):
        """Test InterestChargeList"""
