...
from openapi_client.models.utbms_code_show import UtbmsCodeShow  # noqa: E501

class TestUtbmsCodeShow(unittest.TestCase):
    """UtbmsCodeShow unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UtbmsCodeShow:
        """Test UtbmsCodeShow
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UtbmsCodeShow`
        """
        model = UtbmsCodeShow()  # noqa: E501
        if include_optional:
            return UtbmsCodeShow(
                data = None
            )
        else:
            return UtbmsCodeShow(
