...
from openapi_client.models.matter_create_request_data_task_template_list_instances_inner_task_template_list import MatterCreateRequestDataTaskTemplateListInstancesInnerTaskTemplateList  # noqa: E501

class TestMatterCreateRequestDataTaskTemplateListInstancesInnerTaskTemplateList(unittest.TestCase):
    """MatterCreateRequestDataTaskTemplateListInstancesInnerTaskTemplateList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MatterCreateRequestDataTaskTemplateListInstancesInnerTaskTemplateList:
        """Test MatterCreateRequestDataTaskTemplateListInstancesInnerTaskTemplateList
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MatterCreateRequestDataTaskTemplateListInstancesInnerTaskTemplateList`
        """
        model = MatterCreateRequestDataTaskTemplateListInstancesInnerTaskTemplateList()  # noqa: E501
        if include_optional:
            return MatterCreateRequestDataTaskTemplateListInstancesInnerTaskTemplateList(
                id = 56
            )
        else:
            return MatterCreateRequestDataTaskTemplateListInstancesInnerTaskTemplateList(
    ...
    def testMatterCreateRequestDataTaskTemplateListInstancesInnerTaskTemplateList(self):
        """Test MatterCreateRequestDataTaskTemplateListInstancesInnerTaskTemplateList"""
