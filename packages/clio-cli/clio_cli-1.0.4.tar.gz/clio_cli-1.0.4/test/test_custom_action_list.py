...
from openapi_client.models.custom_action_list import CustomActionList  # noqa: E501

class TestCustomActionList(unittest.TestCase):
    """CustomActionList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CustomActionList:
        """Test CustomActionList
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CustomActionList`
        """
        model = CustomActionList()  # noqa: E501
        if include_optional:
