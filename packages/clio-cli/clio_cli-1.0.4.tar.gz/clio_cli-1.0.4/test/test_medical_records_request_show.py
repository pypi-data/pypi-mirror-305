...
from openapi_client.models.medical_records_request_show import MedicalRecordsRequestShow  # noqa: E501

class TestMedicalRecordsRequestShow(unittest.TestCase):
    """MedicalRecordsRequestShow unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MedicalRecordsRequestShow:
        """Test MedicalRecordsRequestShow
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MedicalRecordsRequestShow`
        """
        model = MedicalRecordsRequestShow()  # noqa: E501
        if include_optional:
            return MedicalRecordsRequestShow(
                data = None
            )
        else:
            return MedicalRecordsRequestShow(
    ...
    def testMedicalRecordsRequestShow(self):
        """Test MedicalRecordsRequestShow"""
