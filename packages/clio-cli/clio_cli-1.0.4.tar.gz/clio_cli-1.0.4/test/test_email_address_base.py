...
from openapi_client.models.email_address_base import EmailAddressBase  # noqa: E501

class TestEmailAddressBase(unittest.TestCase):
    """EmailAddressBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EmailAddressBase:
        """Test EmailAddressBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EmailAddressBase`
        """
        model = EmailAddressBase()  # noqa: E501
        if include_optional:
            return EmailAddressBase(
                id = 56,
                etag = '',
                address = '',
                name = '',
