...
from openapi_client.models.clio_payments_link_create_request import ClioPaymentsLinkCreateRequest  # noqa: E501

class TestClioPaymentsLinkCreateRequest(unittest.TestCase):
    """ClioPaymentsLinkCreateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ClioPaymentsLinkCreateRequest:
        """Test ClioPaymentsLinkCreateRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ClioPaymentsLinkCreateRequest`
        """
        model = ClioPaymentsLinkCreateRequest()  # noqa: E501
        if include_optional:
            return ClioPaymentsLinkCreateRequest(
                data = openapi_client.models.clio_payments_link_create_request_data.ClioPaymentsLink_create_request_data(
                    amount = 1.337, 
                    currency = '', 
                    description = '', 
                    destination_account = openapi_client.models.clio_payments_link_create_request_data_destination_account.ClioPaymentsLink_create_request_data_destination_account(
                        id = 56, ), 
                    destination_contact = openapi_client.models.clio_payments_link_create_request_data_destination_contact.ClioPaymentsLink_create_request_data_destination_contact(
                        id = 56, ), 
                    duration = 56, 
                    email_address = '', 
                    is_allocated_as_revenue = True, 
                    subject = openapi_client.models.clio_payments_link_create_request_data_subject.ClioPaymentsLink_create_request_data_subject(
                        id = 56, 
                        type = 'BankAccount', ), )
            )
        else:
    ...
    def testClioPaymentsLinkCreateRequest(self):
        """Test ClioPaymentsLinkCreateRequest"""
