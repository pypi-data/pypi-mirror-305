...
from openapi_client.models.matter_create_request_data_relationships_inner import MatterCreateRequestDataRelationshipsInner  # noqa: E501

class TestMatterCreateRequestDataRelationshipsInner(unittest.TestCase):
    """MatterCreateRequestDataRelationshipsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MatterCreateRequestDataRelationshipsInner:
        """Test MatterCreateRequestDataRelationshipsInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MatterCreateRequestDataRelationshipsInner`
        """
        model = MatterCreateRequestDataRelationshipsInner()  # noqa: E501
        if include_optional:
            return MatterCreateRequestDataRelationshipsInner(
                description = '',
    ...
    def testMatterCreateRequestDataRelationshipsInner(self):
        """Test MatterCreateRequestDataRelationshipsInner"""
