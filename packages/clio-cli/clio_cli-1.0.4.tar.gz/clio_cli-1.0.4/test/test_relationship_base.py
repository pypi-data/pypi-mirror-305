...
from openapi_client.models.relationship_base import RelationshipBase  # noqa: E501

class TestRelationshipBase(unittest.TestCase):
    """RelationshipBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RelationshipBase:
        """Test RelationshipBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RelationshipBase`
        """
        model = RelationshipBase()  # noqa: E501
        if include_optional:
