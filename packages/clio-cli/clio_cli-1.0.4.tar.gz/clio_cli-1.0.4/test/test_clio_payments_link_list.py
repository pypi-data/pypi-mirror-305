...
from openapi_client.models.clio_payments_link_list import ClioPaymentsLinkList  # noqa: E501

class TestClioPaymentsLinkList(unittest.TestCase):
    """ClioPaymentsLinkList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ClioPaymentsLinkList:
        """Test ClioPaymentsLinkList
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ClioPaymentsLinkList`
        """
        model = ClioPaymentsLinkList()  # noqa: E501
        if include_optional:
            return ClioPaymentsLinkList(
                data = [
                    null
                    ]
            )
    ...
    def testClioPaymentsLinkList(self):
        """Test ClioPaymentsLinkList"""
