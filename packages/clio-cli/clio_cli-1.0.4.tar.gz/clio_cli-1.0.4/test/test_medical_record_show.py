...
from openapi_client.models.medical_record_show import MedicalRecordShow  # noqa: E501

class TestMedicalRecordShow(unittest.TestCase):
    """MedicalRecordShow unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MedicalRecordShow:
        """Test MedicalRecordShow
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MedicalRecordShow`
        """
        model = MedicalRecordShow()  # noqa: E501
        if include_optional:
    ...
    def testMedicalRecordShow(self):
        """Test MedicalRecordShow"""
