...
from openapi_client.models.trust_line_item_list import TrustLineItemList  # noqa: E501

class TestTrustLineItemList(unittest.TestCase):
    """TrustLineItemList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TrustLineItemList:
        """Test TrustLineItemList
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TrustLineItemList`
        """
        model = TrustLineItemList()  # noqa: E501
        if include_optional:
            return TrustLineItemList(
                data = [
                    null
                    ]
            )
    ...
    def testTrustLineItemList(self):
        """Test TrustLineItemList"""
