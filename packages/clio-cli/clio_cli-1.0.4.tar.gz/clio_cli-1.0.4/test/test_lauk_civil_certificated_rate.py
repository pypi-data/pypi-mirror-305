...
from openapi_client.models.lauk_civil_certificated_rate import LaukCivilCertificatedRate  # noqa: E501

class TestLaukCivilCertificatedRate(unittest.TestCase):
    """LaukCivilCertificatedRate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LaukCivilCertificatedRate:
        """Test LaukCivilCertificatedRate
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LaukCivilCertificatedRate`
        """
        model = LaukCivilCertificatedRate()  # noqa: E501
        if include_optional:
            return LaukCivilCertificatedRate(
                id = 56,
                activity = '',
    ...
    def testLaukCivilCertificatedRate(self):
        """Test LaukCivilCertificatedRate"""
