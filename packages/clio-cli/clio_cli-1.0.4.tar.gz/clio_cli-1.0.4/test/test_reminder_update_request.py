...
from openapi_client.models.reminder_update_request import ReminderUpdateRequest  # noqa: E501

class TestReminderUpdateRequest(unittest.TestCase):
    """ReminderUpdateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReminderUpdateRequest:
        """Test ReminderUpdateRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReminderUpdateRequest`
        """
        model = ReminderUpdateRequest()  # noqa: E501
        if include_optional:
            return ReminderUpdateRequest(
                data = openapi_client.models.reminder_update_request_data.Reminder_update_request_data(
                    duration_unit = 'weeks', 
                    duration_value = 56, 
    ...
    def testReminderUpdateRequest(self):
        """Test ReminderUpdateRequest"""
