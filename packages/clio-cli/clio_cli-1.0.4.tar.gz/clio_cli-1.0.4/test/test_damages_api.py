...
from openapi_client.api.damages_api import DamagesApi  # noqa: E501


class TestDamagesApi(unittest.TestCase):
    """DamagesApi unit test stubs"""
    ...
    def test_damage_create(self) -> None:
    ...
    def test_damage_destroy(self) -> None:
    ...
    def test_damage_index(self) -> None:
    ...
    def test_damage_show(self) -> None:
    ...
    def test_damage_update(self) -> None:
