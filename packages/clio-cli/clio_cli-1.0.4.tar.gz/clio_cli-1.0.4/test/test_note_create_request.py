...
from openapi_client.models.note_create_request import NoteCreateRequest  # noqa: E501
...
class TestNoteCreateRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> NoteCreateRequest:
        """Test NoteCreateRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NoteCreateRequest`
        """
        model = NoteCreateRequest()  # noqa: E501
        if include_optional:
            return NoteCreateRequest(
                data = openapi_client.models.note_create_request_data.Note_create_request_data(
