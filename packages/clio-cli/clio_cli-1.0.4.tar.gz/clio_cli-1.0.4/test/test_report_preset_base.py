...
from openapi_client.models.report_preset_base import ReportPresetBase  # noqa: E501

class TestReportPresetBase(unittest.TestCase):
    """ReportPresetBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReportPresetBase:
        """Test ReportPresetBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReportPresetBase`
        """
        model = ReportPresetBase()  # noqa: E501
        if include_optional:
            return ReportPresetBase(
                id = 56,
                etag = '',
                name = '',
