...
from openapi_client.models.task_template_create_request_data_reminder_templates_inner import TaskTemplateCreateRequestDataReminderTemplatesInner  # noqa: E501

class TestTaskTemplateCreateRequestDataReminderTemplatesInner(unittest.TestCase):
    """TaskTemplateCreateRequestDataReminderTemplatesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TaskTemplateCreateRequestDataReminderTemplatesInner:
        """Test TaskTemplateCreateRequestDataReminderTemplatesInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TaskTemplateCreateRequestDataReminderTemplatesInner`
        """
        model = TaskTemplateCreateRequestDataReminderTemplatesInner()  # noqa: E501
        if include_optional:
            return TaskTemplateCreateRequestDataReminderTemplatesInner(
                duration_value = 56,
                duration_unit = '',
    ...
    def testTaskTemplateCreateRequestDataReminderTemplatesInner(self):
        """Test TaskTemplateCreateRequestDataReminderTemplatesInner"""
