...
from openapi_client.models.trust_line_item_show import TrustLineItemShow  # noqa: E501

class TestTrustLineItemShow(unittest.TestCase):
    """TrustLineItemShow unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TrustLineItemShow:
        """Test TrustLineItemShow
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TrustLineItemShow`
        """
        model = TrustLineItemShow()  # noqa: E501
        if include_optional:
            return TrustLineItemShow(
                data = None
            )
        else:
            return TrustLineItemShow(
    ...
    def testTrustLineItemShow(self):
        """Test TrustLineItemShow"""
