...
from openapi_client.models.clio_payments_link_show import ClioPaymentsLinkShow  # noqa: E501

class TestClioPaymentsLinkShow(unittest.TestCase):
    """ClioPaymentsLinkShow unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ClioPaymentsLinkShow:
        """Test ClioPaymentsLinkShow
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ClioPaymentsLinkShow`
        """
        model = ClioPaymentsLinkShow()  # noqa: E501
        if include_optional:
            return ClioPaymentsLinkShow(
                data = None
            )
        else:
            return ClioPaymentsLinkShow(
    ...
    def testClioPaymentsLinkShow(self):
        """Test ClioPaymentsLinkShow"""
