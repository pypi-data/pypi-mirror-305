...
from openapi_client.models.expense_category_base import ExpenseCategoryBase  # noqa: E501

class TestExpenseCategoryBase(unittest.TestCase):
    """ExpenseCategoryBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExpenseCategoryBase:
        """Test ExpenseCategoryBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExpenseCategoryBase`
        """
        model = ExpenseCategoryBase()  # noqa: E501
        if include_optional:
            return ExpenseCategoryBase(
                id = 56,
                etag = '',
                name = '',
                rate = 56,
    ...
    def testExpenseCategoryBase(self):
        """Test ExpenseCategoryBase"""
