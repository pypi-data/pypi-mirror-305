...
from openapi_client.models.user_show import UserShow  # noqa: E501

class TestUserShow(unittest.TestCase):
    """UserShow unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UserShow:
        """Test UserShow
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UserShow`
        """
        model = UserShow()  # noqa: E501
        if include_optional:
            return UserShow(
                data = None
            )
