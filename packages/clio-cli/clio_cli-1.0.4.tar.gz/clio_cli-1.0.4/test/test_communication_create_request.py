...
from openapi_client.models.communication_create_request import CommunicationCreateRequest  # noqa: E501

class TestCommunicationCreateRequest(unittest.TestCase):
    """CommunicationCreateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CommunicationCreateRequest:
        """Test CommunicationCreateRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CommunicationCreateRequest`
        """
        model = CommunicationCreateRequest()  # noqa: E501
        if include_optional:
            return CommunicationCreateRequest(
                data = openapi_client.models.communication_create_request_data.Communication_create_request_data(
                    body = '', 
                    date = '', 
                    external_properties = [
                        openapi_client.models.communication_create_request_data_external_properties_inner.Communication_create_request_data_external_properties_inner(
                            name = '', 
                            value = '', )
                        ], 
                    ...
                    notification_event_subscribers = [
                        openapi_client.models.communication_create_request_data_notification_event_subscribers_inner.Communication_create_request_data_notification_event_subscribers_inner(
                            user_id = '', )
                        ], 
                    received_at = '', 
                    receivers = [
    ...
    def testCommunicationCreateRequest(self):
        """Test CommunicationCreateRequest"""
