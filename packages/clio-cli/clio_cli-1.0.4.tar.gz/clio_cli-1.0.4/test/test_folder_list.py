...
from openapi_client.models.folder_list import FolderList  # noqa: E501
...
class TestFolderList(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> FolderList:
        """Test FolderList
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FolderList`
        """
        model = FolderList()  # noqa: E501
        if include_optional:
            return FolderList(
                data = [
                    null
