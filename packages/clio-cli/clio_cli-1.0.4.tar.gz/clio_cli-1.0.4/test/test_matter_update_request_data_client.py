...
from openapi_client.models.matter_update_request_data_client import MatterUpdateRequestDataClient  # noqa: E501

class TestMatterUpdateRequestDataClient(unittest.TestCase):
    """MatterUpdateRequestDataClient unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MatterUpdateRequestDataClient:
        """Test MatterUpdateRequestDataClient
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MatterUpdateRequestDataClient`
        """
        model = MatterUpdateRequestDataClient()  # noqa: E501
        if include_optional:
            return MatterUpdateRequestDataClient(
                id = 56
            )
        else:
            return MatterUpdateRequestDataClient(
    ...
    def testMatterUpdateRequestDataClient(self):
        """Test MatterUpdateRequestDataClient"""
