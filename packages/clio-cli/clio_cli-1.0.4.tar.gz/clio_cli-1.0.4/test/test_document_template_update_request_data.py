...
from openapi_client.models.document_template_update_request_data import DocumentTemplateUpdateRequestData  # noqa: E501

class TestDocumentTemplateUpdateRequestData(unittest.TestCase):
    """DocumentTemplateUpdateRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentTemplateUpdateRequestData:
        """Test DocumentTemplateUpdateRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentTemplateUpdateRequestData`
        """
        model = DocumentTemplateUpdateRequestData()  # noqa: E501
        if include_optional:
            return DocumentTemplateUpdateRequestData(
    ...
    def testDocumentTemplateUpdateRequestData(self):
        """Test DocumentTemplateUpdateRequestData"""
