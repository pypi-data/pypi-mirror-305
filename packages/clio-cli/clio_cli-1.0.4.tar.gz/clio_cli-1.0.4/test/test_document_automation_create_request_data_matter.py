...
from openapi_client.models.document_automation_create_request_data_matter import DocumentAutomationCreateRequestDataMatter  # noqa: E501

class TestDocumentAutomationCreateRequestDataMatter(unittest.TestCase):
    """DocumentAutomationCreateRequestDataMatter unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentAutomationCreateRequestDataMatter:
        """Test DocumentAutomationCreateRequestDataMatter
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentAutomationCreateRequestDataMatter`
        """
        model = DocumentAutomationCreateRequestDataMatter()  # noqa: E501
        if include_optional:
            return DocumentAutomationCreateRequestDataMatter(
                id = 56
            )
        else:
            return DocumentAutomationCreateRequestDataMatter(
    ...
    def testDocumentAutomationCreateRequestDataMatter(self):
        """Test DocumentAutomationCreateRequestDataMatter"""
