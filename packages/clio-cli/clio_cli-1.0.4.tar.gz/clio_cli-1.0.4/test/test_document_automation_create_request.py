...
from openapi_client.models.document_automation_create_request import DocumentAutomationCreateRequest  # noqa: E501

class TestDocumentAutomationCreateRequest(unittest.TestCase):
    """DocumentAutomationCreateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentAutomationCreateRequest:
        """Test DocumentAutomationCreateRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentAutomationCreateRequest`
        """
        model = DocumentAutomationCreateRequest()  # noqa: E501
        if include_optional:
            return DocumentAutomationCreateRequest(
                data = openapi_client.models.document_automation_create_request_data.DocumentAutomation_create_request_data(
                    document_template = openapi_client.models.document_automation_create_request_data_document_template.DocumentAutomation_create_request_data_document_template(
                        id = 56, ), 
                    filename = '', 
                    formats = [
                        'pdf'
                        ], 
                    matter = openapi_client.models.document_automation_create_request_data_matter.DocumentAutomation_create_request_data_matter(
                        id = 56, ), )
            )
        else:
            return DocumentAutomationCreateRequest(
    ...
    def testDocumentAutomationCreateRequest(self):
        """Test DocumentAutomationCreateRequest"""
