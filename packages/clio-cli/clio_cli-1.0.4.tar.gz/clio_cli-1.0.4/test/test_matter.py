...
from openapi_client.models.matter import Matter  # noqa: E501
    ...
    def make_instance(self, include_optional) -> Matter:
        ...
        if include_optional:
            return Matter(
                ...
                client = openapi_client.models.contact_base.Contact_base(
                    id = 56, 
                    etag = '', 
                    name = '', 
                    first_name = '', 
                    ...
                    sales_tax_number = '', ),
                contingency_fee = openapi_client.models.contingency_fee_base.ContingencyFee_base(
                    id = 56, 
                    etag = '', 
                    created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                ...
                custom_rate = None,
                evergreen_retainer = openapi_client.models.evergreen_retainer_base.EvergreenRetainer_base(
                    id = 56, 
                    created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    etag = '', 
                ...
                folder = openapi_client.models.folder_base.Folder_base(
                    ...
                    name = '', 
                    root = True, ),
                group = openapi_client.models.group_base.Group_base(
                    ...
                    type = 'UserGroup', 
                    updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), ),
                matter_budget = openapi_client.models.matter_budget_base.MatterBudget_base(
                    id = 56, 
                    etag = '', 
                    budget = 1.337, 
                    ...
                    created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), ),
                matter_stage = openapi_client.models.matter_stage_base.MatterStage_base(
                    id = 56, 
                    etag = '', 
                    practice_area_id = '', 
                    name = '', 
                    ...
                    created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), ),
                originating_attorney = openapi_client.models.user_base.User_base(
                    account_owner = True, 
                    clio_connect = True, 
                    ...
                    time_zone = '', 
                    updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), ),
                practice_area = openapi_client.models.practice_area_base.PracticeArea_base(
                    id = 56, 
                    etag = '', 
                    created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    ...
                    code = '', ),
                responsible_attorney = openapi_client.models.user_base.User_base(
                    account_owner = True, 
                    clio_connect = True, 
                    court_rules_default_attendee = True, 
                    created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    ...
                    time_zone = '', 
                    updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), ),
                statute_of_limitations = openapi_client.models.task_base.Task_base(
                    id = 56, 
                    etag = '', 
                    name = '', 
                    status = 'pending', 
                ...
                user = openapi_client.models.user_base.User_base(
                    ...
                    time_zone = '', 
                    updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), ),
                legal_aid_uk_matter = openapi_client.models.legal_aid_uk_matter_base.LegalAidUkMatter_base(
                    access_point = '', 
                    laa_office_number = '', 
                ...
                relationships = [
                    openapi_client.models.relationship_base.Relationship_base(
                        id = 56, 
                        etag = '', 
                        description = '', 
                        created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                ...
                task_template_list_instances = [
                    openapi_client.models.task_template_list_instace_base.TaskTemplateListInstace_base(
                        id = 56, 
                        etag = '', 
                        created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), )
