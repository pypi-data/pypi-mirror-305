...
from openapi_client.models.payment_profile_base import PaymentProfileBase  # noqa: E501

class TestPaymentProfileBase(unittest.TestCase):
    """PaymentProfileBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaymentProfileBase:
        """Test PaymentProfileBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaymentProfileBase`
        """
        model = PaymentProfileBase()  # noqa: E501
        if include_optional:
            return PaymentProfileBase(
                id = 56,
                etag = '',
    ...
    def testPaymentProfileBase(self):
        """Test PaymentProfileBase"""
