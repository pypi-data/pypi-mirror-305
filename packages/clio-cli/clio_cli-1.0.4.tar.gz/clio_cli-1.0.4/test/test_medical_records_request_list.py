...
from openapi_client.models.medical_records_request_list import MedicalRecordsRequestList  # noqa: E501

class TestMedicalRecordsRequestList(unittest.TestCase):
    """MedicalRecordsRequestList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MedicalRecordsRequestList:
        """Test MedicalRecordsRequestList
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MedicalRecordsRequestList`
        """
        model = MedicalRecordsRequestList()  # noqa: E501
        if include_optional:
            return MedicalRecordsRequestList(
                data = [
                    null
                    ]
            )
    ...
    def testMedicalRecordsRequestList(self):
        """Test MedicalRecordsRequestList"""
