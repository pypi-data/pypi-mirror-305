...
from openapi_client.api.communications_api import CommunicationsApi  # noqa: E501
...
class TestCommunicationsApi(unittest.TestCase):
    ...
    def test_communication_create(self) -> None:
    ...
    def test_communication_destroy(self) -> None:
    ...
    def test_communication_index(self) -> None:
    ...
    def test_communication_show(self) -> None:
