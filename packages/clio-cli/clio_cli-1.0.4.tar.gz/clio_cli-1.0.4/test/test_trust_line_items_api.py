...
from openapi_client.api.trust_line_items_api import TrustLineItemsApi  # noqa: E501


class TestTrustLineItemsApi(unittest.TestCase):
    """TrustLineItemsApi unit test stubs"""

    def setUp(self) -> None:
        self.api = TrustLineItemsApi()

    def tearDown(self) -> None:
        pass

    def test_trust_line_item_index(self) -> None:
    ...
    def test_trust_line_item_update(self) -> None:
