...
from openapi_client.models.calendar_entry_event_type_base import CalendarEntryEventTypeBase  # noqa: E501

class TestCalendarEntryEventTypeBase(unittest.TestCase):
    """CalendarEntryEventTypeBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CalendarEntryEventTypeBase:
        """Test CalendarEntryEventTypeBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CalendarEntryEventTypeBase`
        """
        model = CalendarEntryEventTypeBase()  # noqa: E501
        if include_optional:
            return CalendarEntryEventTypeBase(
                id = 56,
                etag = '',
    ...
    def testCalendarEntryEventTypeBase(self):
        """Test CalendarEntryEventTypeBase"""
