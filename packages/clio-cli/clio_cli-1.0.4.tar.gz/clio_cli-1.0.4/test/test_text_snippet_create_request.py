...
from openapi_client.models.text_snippet_create_request import TextSnippetCreateRequest  # noqa: E501

class TestTextSnippetCreateRequest(unittest.TestCase):
    """TextSnippetCreateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TextSnippetCreateRequest:
        """Test TextSnippetCreateRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TextSnippetCreateRequest`
        """
        model = TextSnippetCreateRequest()  # noqa: E501
        if include_optional:
            return TextSnippetCreateRequest(
                data = openapi_client.models.text_snippet_create_request_data.TextSnippet_create_request_data(
                    phrase = '', 
                    snippet = '', 
                    whole_word = True, )
            )
    ...
    def testTextSnippetCreateRequest(self):
        """Test TextSnippetCreateRequest"""
