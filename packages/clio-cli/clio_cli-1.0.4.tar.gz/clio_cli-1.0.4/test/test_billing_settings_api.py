...
from openapi_client.api.billing_settings_api import BillingSettingsApi  # noqa: E501


class TestBillingSettingsApi(unittest.TestCase):
    """BillingSettingsApi unit test stubs"""

    def setUp(self) -> None:
        self.api = BillingSettingsApi()

    def tearDown(self) -> None:
        pass

    def test_billing_setting_show(self) -> None:
