...
from openapi_client.api.line_items_api import LineItemsApi  # noqa: E501


class TestLineItemsApi(unittest.TestCase):
    """LineItemsApi unit test stubs"""

    def setUp(self) -> None:
        self.api = LineItemsApi()

    def tearDown(self) -> None:
        pass

    def test_line_item_destroy(self) -> None:
    ...
    def test_line_item_index(self) -> None:
    ...
    def test_line_item_update(self) -> None:
