...
from openapi_client.models.task_create_request_data_assignee import TaskCreateRequestDataAssignee  # noqa: E501

class TestTaskCreateRequestDataAssignee(unittest.TestCase):
    """TaskCreateRequestDataAssignee unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TaskCreateRequestDataAssignee:
        """Test TaskCreateRequestDataAssignee
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TaskCreateRequestDataAssignee`
        """
        model = TaskCreateRequestDataAssignee()  # noqa: E501
        if include_optional:
            return TaskCreateRequestDataAssignee(
                id = 56,
                type = 'User'
            )
        else:
    ...
    def testTaskCreateRequestDataAssignee(self):
        """Test TaskCreateRequestDataAssignee"""
