...
from openapi_client.models.contact_create_request_data_custom_field_values_inner_custom_field import ContactCreateRequestDataCustomFieldValuesInnerCustomField  # noqa: E501

class TestContactCreateRequestDataCustomFieldValuesInnerCustomField(unittest.TestCase):
    """ContactCreateRequestDataCustomFieldValuesInnerCustomField unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ContactCreateRequestDataCustomFieldValuesInnerCustomField:
        """Test ContactCreateRequestDataCustomFieldValuesInnerCustomField
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ContactCreateRequestDataCustomFieldValuesInnerCustomField`
        """
        model = ContactCreateRequestDataCustomFieldValuesInnerCustomField()  # noqa: E501
        if include_optional:
            return ContactCreateRequestDataCustomFieldValuesInnerCustomField(
                id = 56
            )
        else:
            return ContactCreateRequestDataCustomFieldValuesInnerCustomField(
    ...
    def testContactCreateRequestDataCustomFieldValuesInnerCustomField(self):
        """Test ContactCreateRequestDataCustomFieldValuesInnerCustomField"""
