...
from openapi_client.models.jurisdiction_base import JurisdictionBase  # noqa: E501

class TestJurisdictionBase(unittest.TestCase):
    """JurisdictionBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> JurisdictionBase:
        """Test JurisdictionBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `JurisdictionBase`
        """
        model = JurisdictionBase()  # noqa: E501
        if include_optional:
            return JurisdictionBase(
                id = 56,
                etag = '',
