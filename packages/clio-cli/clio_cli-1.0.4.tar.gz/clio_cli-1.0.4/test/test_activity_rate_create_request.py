...
from openapi_client.models.activity_rate_create_request import ActivityRateCreateRequest  # noqa: E501

class TestActivityRateCreateRequest(unittest.TestCase):
    """ActivityRateCreateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ActivityRateCreateRequest:
        """Test ActivityRateCreateRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ActivityRateCreateRequest`
        """
        model = ActivityRateCreateRequest()  # noqa: E501
        if include_optional:
            return ActivityRateCreateRequest(
                data = openapi_client.models.activity_rate_create_request_data.ActivityRate_create_request_data(
    ...
    def testActivityRateCreateRequest(self):
        """Test ActivityRateCreateRequest"""
