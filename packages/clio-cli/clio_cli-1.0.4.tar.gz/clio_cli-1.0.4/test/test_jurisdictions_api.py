...
from openapi_client.api.jurisdictions_api import JurisdictionsApi  # noqa: E501


class TestJurisdictionsApi(unittest.TestCase):
    """JurisdictionsApi unit test stubs"""

    def setUp(self) -> None:
        self.api = JurisdictionsApi()

    def tearDown(self) -> None:
        pass

    def test_jurisdiction_index(self) -> None:
    ...
    def test_jurisdiction_show(self) -> None:
