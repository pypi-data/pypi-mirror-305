...
from openapi_client.models.custom_field_create_request import CustomFieldCreateRequest  # noqa: E501

class TestCustomFieldCreateRequest(unittest.TestCase):
    """CustomFieldCreateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CustomFieldCreateRequest:
        """Test CustomFieldCreateRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CustomFieldCreateRequest`
        """
        model = CustomFieldCreateRequest()  # noqa: E501
        if include_optional:
            return CustomFieldCreateRequest(
                data = openapi_client.models.custom_field_create_request_data.CustomField_create_request_data(
                    display_order = 56, 
                    displayed = True, 
                    field_type = 'checkbox', 
                    name = '', 
    ...
    def testCustomFieldCreateRequest(self):
        """Test CustomFieldCreateRequest"""
