...
from openapi_client.models.activity_description_update_request_data_groups_inner import ActivityDescriptionUpdateRequestDataGroupsInner  # noqa: E501

class TestActivityDescriptionUpdateRequestDataGroupsInner(unittest.TestCase):
    """ActivityDescriptionUpdateRequestDataGroupsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ActivityDescriptionUpdateRequestDataGroupsInner:
        """Test ActivityDescriptionUpdateRequestDataGroupsInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ActivityDescriptionUpdateRequestDataGroupsInner`
        """
        model = ActivityDescriptionUpdateRequestDataGroupsInner()  # noqa: E501
        if include_optional:
            return ActivityDescriptionUpdateRequestDataGroupsInner(
                id = 56,
                deleted = True
            )
        else:
    ...
    def testActivityDescriptionUpdateRequestDataGroupsInner(self):
        """Test ActivityDescriptionUpdateRequestDataGroupsInner"""
