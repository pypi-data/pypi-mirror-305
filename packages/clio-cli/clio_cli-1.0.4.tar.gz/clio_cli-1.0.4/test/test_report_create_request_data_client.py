...
from openapi_client.models.report_create_request_data_client import ReportCreateRequestDataClient  # noqa: E501

class TestReportCreateRequestDataClient(unittest.TestCase):
    """ReportCreateRequestDataClient unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReportCreateRequestDataClient:
        """Test ReportCreateRequestDataClient
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReportCreateRequestDataClient`
        """
        model = ReportCreateRequestDataClient()  # noqa: E501
        if include_optional:
            return ReportCreateRequestDataClient(
                id = 56
            )
        else:
            return ReportCreateRequestDataClient(
    ...
    def testReportCreateRequestDataClient(self):
        """Test ReportCreateRequestDataClient"""
