...
from openapi_client.models.billing_setting_base import BillingSettingBase  # noqa: E501

class TestBillingSettingBase(unittest.TestCase):
    """BillingSettingBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BillingSettingBase:
        """Test BillingSettingBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BillingSettingBase`
        """
        model = BillingSettingBase()  # noqa: E501
        if include_optional:
            return BillingSettingBase(
                id = 56,
                etag = '',
    ...
    def testBillingSettingBase(self):
        """Test BillingSettingBase"""
