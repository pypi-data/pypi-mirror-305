...
from openapi_client.models.task_template_update_request import TaskTemplateUpdateRequest  # noqa: E501

class TestTaskTemplateUpdateRequest(unittest.TestCase):
    """TaskTemplateUpdateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TaskTemplateUpdateRequest:
        """Test TaskTemplateUpdateRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TaskTemplateUpdateRequest`
        """
        model = TaskTemplateUpdateRequest()  # noqa: E501
        if include_optional:
            return TaskTemplateUpdateRequest(
                data = openapi_client.models.task_template_update_request_data.TaskTemplate_update_request_data(
                    cascading = True, 
                    cascading_offset = 56, 
                    ...
                    private = True, 
                    reminder_templates = [
                        openapi_client.models.task_template_update_request_data_reminder_templates_inner.TaskTemplate_update_request_data_reminder_templates_inner(
                            duration_value = 56, 
                            duration_unit = '', 
    ...
    def testTaskTemplateUpdateRequest(self):
        """Test TaskTemplateUpdateRequest"""
