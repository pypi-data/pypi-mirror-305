...
from openapi_client.models.clio_payments_link_base import ClioPaymentsLinkBase  # noqa: E501

class TestClioPaymentsLinkBase(unittest.TestCase):
    """ClioPaymentsLinkBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ClioPaymentsLinkBase:
        """Test ClioPaymentsLinkBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ClioPaymentsLinkBase`
        """
        model = ClioPaymentsLinkBase()  # noqa: E501
        if include_optional:
            return ClioPaymentsLinkBase(
                active = True,
                amount = 1.337,
    ...
    def testClioPaymentsLinkBase(self):
        """Test ClioPaymentsLinkBase"""
