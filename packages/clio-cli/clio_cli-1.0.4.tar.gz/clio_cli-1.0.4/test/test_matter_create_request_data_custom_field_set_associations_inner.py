...
from openapi_client.models.matter_create_request_data_custom_field_set_associations_inner import MatterCreateRequestDataCustomFieldSetAssociationsInner  # noqa: E501

class TestMatterCreateRequestDataCustomFieldSetAssociationsInner(unittest.TestCase):
    """MatterCreateRequestDataCustomFieldSetAssociationsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MatterCreateRequestDataCustomFieldSetAssociationsInner:
        """Test MatterCreateRequestDataCustomFieldSetAssociationsInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MatterCreateRequestDataCustomFieldSetAssociationsInner`
        """
        model = MatterCreateRequestDataCustomFieldSetAssociationsInner()  # noqa: E501
        if include_optional:
            return MatterCreateRequestDataCustomFieldSetAssociationsInner(
                display_order = 56,
    ...
    def testMatterCreateRequestDataCustomFieldSetAssociationsInner(self):
        """Test MatterCreateRequestDataCustomFieldSetAssociationsInner"""
