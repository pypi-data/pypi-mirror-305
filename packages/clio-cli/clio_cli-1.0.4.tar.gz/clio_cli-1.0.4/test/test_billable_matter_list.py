...
from openapi_client.models.billable_matter_list import BillableMatterList  # noqa: E501

class TestBillableMatterList(unittest.TestCase):
    """BillableMatterList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BillableMatterList:
        """Test BillableMatterList
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BillableMatterList`
        """
        model = BillableMatterList()  # noqa: E501
        if include_optional:
            return BillableMatterList(
                data = [
                    null
                    ]
            )
    ...
    def testBillableMatterList(self):
        """Test BillableMatterList"""
