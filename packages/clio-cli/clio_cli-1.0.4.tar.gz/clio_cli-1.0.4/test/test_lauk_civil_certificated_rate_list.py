...
from openapi_client.models.lauk_civil_certificated_rate_list import LaukCivilCertificatedRateList  # noqa: E501

class TestLaukCivilCertificatedRateList(unittest.TestCase):
    """LaukCivilCertificatedRateList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LaukCivilCertificatedRateList:
        """Test LaukCivilCertificatedRateList
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LaukCivilCertificatedRateList`
        """
        model = LaukCivilCertificatedRateList()  # noqa: E501
        if include_optional:
            return LaukCivilCertificatedRateList(
                data = [
                    null
                    ]
            )
    ...
    def testLaukCivilCertificatedRateList(self):
        """Test LaukCivilCertificatedRateList"""
