...
from openapi_client.models.evergreen_retainer_base import EvergreenRetainerBase  # noqa: E501

class TestEvergreenRetainerBase(unittest.TestCase):
    """EvergreenRetainerBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EvergreenRetainerBase:
        """Test EvergreenRetainerBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EvergreenRetainerBase`
        """
        model = EvergreenRetainerBase()  # noqa: E501
        if include_optional:
            return EvergreenRetainerBase(
                id = 56,
    ...
    def testEvergreenRetainerBase(self):
        """Test EvergreenRetainerBase"""
