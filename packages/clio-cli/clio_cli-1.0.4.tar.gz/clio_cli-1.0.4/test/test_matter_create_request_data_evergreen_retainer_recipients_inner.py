...
from openapi_client.models.matter_create_request_data_evergreen_retainer_recipients_inner import MatterCreateRequestDataEvergreenRetainerRecipientsInner  # noqa: E501

class TestMatterCreateRequestDataEvergreenRetainerRecipientsInner(unittest.TestCase):
    """MatterCreateRequestDataEvergreenRetainerRecipientsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MatterCreateRequestDataEvergreenRetainerRecipientsInner:
        """Test MatterCreateRequestDataEvergreenRetainerRecipientsInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MatterCreateRequestDataEvergreenRetainerRecipientsInner`
        """
        model = MatterCreateRequestDataEvergreenRetainerRecipientsInner()  # noqa: E501
        if include_optional:
            return MatterCreateRequestDataEvergreenRetainerRecipientsInner(
                id = 56,
                destroy = True
            )
        else:
    ...
    def testMatterCreateRequestDataEvergreenRetainerRecipientsInner(self):
        """Test MatterCreateRequestDataEvergreenRetainerRecipientsInner"""
