...
from openapi_client.models.line_item_update_request_data_discount import LineItemUpdateRequestDataDiscount  # noqa: E501

class TestLineItemUpdateRequestDataDiscount(unittest.TestCase):
    """LineItemUpdateRequestDataDiscount unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LineItemUpdateRequestDataDiscount:
        """Test LineItemUpdateRequestDataDiscount
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LineItemUpdateRequestDataDiscount`
        """
        model = LineItemUpdateRequestDataDiscount()  # noqa: E501
        if include_optional:
            return LineItemUpdateRequestDataDiscount(
                rate = 1.337,
                type = True
            )
        else:
    ...
    def testLineItemUpdateRequestDataDiscount(self):
        """Test LineItemUpdateRequestDataDiscount"""
