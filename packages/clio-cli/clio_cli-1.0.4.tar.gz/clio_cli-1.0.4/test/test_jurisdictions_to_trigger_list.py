...
from openapi_client.models.jurisdictions_to_trigger_list import JurisdictionsToTriggerList  # noqa: E501

class TestJurisdictionsToTriggerList(unittest.TestCase):
    """JurisdictionsToTriggerList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> JurisdictionsToTriggerList:
        """Test JurisdictionsToTriggerList
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `JurisdictionsToTriggerList`
        """
        model = JurisdictionsToTriggerList()  # noqa: E501
        if include_optional:
            return JurisdictionsToTriggerList(
                data = [
                    null
                    ]
            )
    ...
    def testJurisdictionsToTriggerList(self):
        """Test JurisdictionsToTriggerList"""
