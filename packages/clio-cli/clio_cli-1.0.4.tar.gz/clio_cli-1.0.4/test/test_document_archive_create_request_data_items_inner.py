...
from openapi_client.models.document_archive_create_request_data_items_inner import DocumentArchiveCreateRequestDataItemsInner  # noqa: E501

class TestDocumentArchiveCreateRequestDataItemsInner(unittest.TestCase):
    """DocumentArchiveCreateRequestDataItemsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentArchiveCreateRequestDataItemsInner:
        """Test DocumentArchiveCreateRequestDataItemsInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentArchiveCreateRequestDataItemsInner`
        """
        model = DocumentArchiveCreateRequestDataItemsInner()  # noqa: E501
        if include_optional:
            return DocumentArchiveCreateRequestDataItemsInner(
                id = 56,
                type = 56
            )
        else:
    ...
    def testDocumentArchiveCreateRequestDataItemsInner(self):
        """Test DocumentArchiveCreateRequestDataItemsInner"""
