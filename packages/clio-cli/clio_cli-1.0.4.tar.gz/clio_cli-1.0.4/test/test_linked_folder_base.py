...
from openapi_client.models.linked_folder_base import LinkedFolderBase  # noqa: E501

class TestLinkedFolderBase(unittest.TestCase):
    """LinkedFolderBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LinkedFolderBase:
        """Test LinkedFolderBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LinkedFolderBase`
        """
        model = LinkedFolderBase()  # noqa: E501
        if include_optional:
            return LinkedFolderBase(
                id = 56,
                etag = '',
