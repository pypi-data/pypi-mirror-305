...
from openapi_client.models.document_copy_request_data_parent import DocumentCopyRequestDataParent  # noqa: E501

class TestDocumentCopyRequestDataParent(unittest.TestCase):
    """DocumentCopyRequestDataParent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentCopyRequestDataParent:
        """Test DocumentCopyRequestDataParent
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentCopyRequestDataParent`
        """
        model = DocumentCopyRequestDataParent()  # noqa: E501
        if include_optional:
            return DocumentCopyRequestDataParent(
                id = 56,
                type = 'Document'
            )
        else:
    ...
    def testDocumentCopyRequestDataParent(self):
        """Test DocumentCopyRequestDataParent"""
