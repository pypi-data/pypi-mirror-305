...
from openapi_client.models.grant_funding_source_show import GrantFundingSourceShow  # noqa: E501

class TestGrantFundingSourceShow(unittest.TestCase):
    """GrantFundingSourceShow unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GrantFundingSourceShow:
        """Test GrantFundingSourceShow
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GrantFundingSourceShow`
        """
        model = GrantFundingSourceShow()  # noqa: E501
        if include_optional:
            return GrantFundingSourceShow(
                data = None
            )
        else:
            return GrantFundingSourceShow(
    ...
    def testGrantFundingSourceShow(self):
        """Test GrantFundingSourceShow"""
