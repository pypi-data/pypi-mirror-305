...
from openapi_client.models.medical_bill_update_request_data_payers_inner import MedicalBillUpdateRequestDataPayersInner  # noqa: E501

class TestMedicalBillUpdateRequestDataPayersInner(unittest.TestCase):
    """MedicalBillUpdateRequestDataPayersInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MedicalBillUpdateRequestDataPayersInner:
        """Test MedicalBillUpdateRequestDataPayersInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MedicalBillUpdateRequestDataPayersInner`
        """
        model = MedicalBillUpdateRequestDataPayersInner()  # noqa: E501
        if include_optional:
            return MedicalBillUpdateRequestDataPayersInner(
                amount = 1.337,
                holder_id = 56,
                mark_as_lien = True
            )
    ...
    def testMedicalBillUpdateRequestDataPayersInner(self):
        """Test MedicalBillUpdateRequestDataPayersInner"""
