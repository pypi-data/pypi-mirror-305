...
from openapi_client.models.calendar_visibility_list import CalendarVisibilityList  # noqa: E501

class TestCalendarVisibilityList(unittest.TestCase):
    """CalendarVisibilityList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CalendarVisibilityList:
        """Test CalendarVisibilityList
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CalendarVisibilityList`
        """
        model = CalendarVisibilityList()  # noqa: E501
        if include_optional:
            return CalendarVisibilityList(
                data = [
                    null
                    ]
            )
    ...
    def testCalendarVisibilityList(self):
        """Test CalendarVisibilityList"""
