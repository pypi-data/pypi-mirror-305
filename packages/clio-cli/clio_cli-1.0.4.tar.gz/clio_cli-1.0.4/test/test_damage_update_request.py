...
from openapi_client.models.damage_update_request import DamageUpdateRequest  # noqa: E501

class TestDamageUpdateRequest(unittest.TestCase):
    """DamageUpdateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DamageUpdateRequest:
        """Test DamageUpdateRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DamageUpdateRequest`
        """
        model = DamageUpdateRequest()  # noqa: E501
        if include_optional:
            return DamageUpdateRequest(
                data = openapi_client.models.damage_update_request_data.Damage_update_request_data(
                    amount = 1.337, 
                    damage_type = 'special', 
                    description = '', )
            )
    ...
    def testDamageUpdateRequest(self):
        """Test DamageUpdateRequest"""
