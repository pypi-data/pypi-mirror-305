...
from openapi_client.models.medical_records_request_create_request_data_medical_bills_inner import MedicalRecordsRequestCreateRequestDataMedicalBillsInner  # noqa: E501

class TestMedicalRecordsRequestCreateRequestDataMedicalBillsInner(unittest.TestCase):
    """MedicalRecordsRequestCreateRequestDataMedicalBillsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MedicalRecordsRequestCreateRequestDataMedicalBillsInner:
        """Test MedicalRecordsRequestCreateRequestDataMedicalBillsInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MedicalRecordsRequestCreateRequestDataMedicalBillsInner`
        """
        model = MedicalRecordsRequestCreateRequestDataMedicalBillsInner()  # noqa: E501
        if include_optional:
            return MedicalRecordsRequestCreateRequestDataMedicalBillsInner(
                adjustment = 1.337,
                amount = 1.337,
                balance = 1.337,
    ...
    def testMedicalRecordsRequestCreateRequestDataMedicalBillsInner(self):
        """Test MedicalRecordsRequestCreateRequestDataMedicalBillsInner"""
