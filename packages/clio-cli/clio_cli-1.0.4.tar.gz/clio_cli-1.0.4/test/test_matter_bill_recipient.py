...
from openapi_client.models.matter_bill_recipient import MatterBillRecipient  # noqa: E501

class TestMatterBillRecipient(unittest.TestCase):
    """MatterBillRecipient unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MatterBillRecipient:
        """Test MatterBillRecipient
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MatterBillRecipient`
        """
        model = MatterBillRecipient()  # noqa: E501
        if include_optional:
            return MatterBillRecipient(
                created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'),
                etag = '',
                id = 56,
                updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'),
                recipient = openapi_client.models.contact_base.Contact_base(
                    id = 56, 
                    etag = '', 
                    name = '', 
                    first_name = '', 
    ...
    def testMatterBillRecipient(self):
        """Test MatterBillRecipient"""
