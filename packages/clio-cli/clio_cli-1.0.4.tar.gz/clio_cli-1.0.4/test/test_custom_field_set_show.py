...
from openapi_client.models.custom_field_set_show import CustomFieldSetShow  # noqa: E501

class TestCustomFieldSetShow(unittest.TestCase):
    """CustomFieldSetShow unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CustomFieldSetShow:
        """Test CustomFieldSetShow
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CustomFieldSetShow`
        """
        model = CustomFieldSetShow()  # noqa: E501
        if include_optional:
            return CustomFieldSetShow(
                data = None
            )
        else:
            return CustomFieldSetShow(
    ...
    def testCustomFieldSetShow(self):
        """Test CustomFieldSetShow"""
