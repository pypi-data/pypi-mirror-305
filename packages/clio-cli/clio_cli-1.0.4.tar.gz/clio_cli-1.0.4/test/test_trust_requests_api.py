...
from openapi_client.api.trust_requests_api import TrustRequestsApi  # noqa: E501


class TestTrustRequestsApi(unittest.TestCase):
    """TrustRequestsApi unit test stubs"""

    def setUp(self) -> None:
        self.api = TrustRequestsApi()

    def tearDown(self) -> None:
        pass

    def test_trust_request_create(self) -> None:
