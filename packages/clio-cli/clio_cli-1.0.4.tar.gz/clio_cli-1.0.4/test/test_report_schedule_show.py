...
from openapi_client.models.report_schedule_show import ReportScheduleShow  # noqa: E501

class TestReportScheduleShow(unittest.TestCase):
    """ReportScheduleShow unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReportScheduleShow:
        """Test ReportScheduleShow
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReportScheduleShow`
        """
        model = ReportScheduleShow()  # noqa: E501
        if include_optional:
            return ReportScheduleShow(
                data = None
            )
        else:
            return ReportScheduleShow(
    ...
    def testReportScheduleShow(self):
        """Test ReportScheduleShow"""
