...
from openapi_client.models.conversation_message_create_request_data_attachment import ConversationMessageCreateRequestDataAttachment  # noqa: E501

class TestConversationMessageCreateRequestDataAttachment(unittest.TestCase):
    """ConversationMessageCreateRequestDataAttachment unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConversationMessageCreateRequestDataAttachment:
        """Test ConversationMessageCreateRequestDataAttachment
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConversationMessageCreateRequestDataAttachment`
        """
        model = ConversationMessageCreateRequestDataAttachment()  # noqa: E501
        if include_optional:
            return ConversationMessageCreateRequestDataAttachment(
                document_id = 56,
    ...
    def testConversationMessageCreateRequestDataAttachment(self):
        """Test ConversationMessageCreateRequestDataAttachment"""
