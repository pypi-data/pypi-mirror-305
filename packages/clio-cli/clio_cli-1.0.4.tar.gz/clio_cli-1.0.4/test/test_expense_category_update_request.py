...
from openapi_client.models.expense_category_update_request import ExpenseCategoryUpdateRequest  # noqa: E501

class TestExpenseCategoryUpdateRequest(unittest.TestCase):
    """ExpenseCategoryUpdateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExpenseCategoryUpdateRequest:
        """Test ExpenseCategoryUpdateRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExpenseCategoryUpdateRequest`
        """
        model = ExpenseCategoryUpdateRequest()  # noqa: E501
        if include_optional:
            return ExpenseCategoryUpdateRequest(
                data = openapi_client.models.expense_category_update_request_data.ExpenseCategory_update_request_data(
    ...
    def testExpenseCategoryUpdateRequest(self):
        """Test ExpenseCategoryUpdateRequest"""
