...
from openapi_client.api.matter_stages_api import MatterStagesApi  # noqa: E501


class TestMatterStagesApi(unittest.TestCase):
    """MatterStagesApi unit test stubs"""

    def setUp(self) -> None:
        self.api = MatterStagesApi()

    def tearDown(self) -> None:
        pass

    def test_matter_stage_index(self) -> None:
