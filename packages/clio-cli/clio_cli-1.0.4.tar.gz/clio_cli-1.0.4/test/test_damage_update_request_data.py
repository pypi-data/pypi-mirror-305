...
from openapi_client.models.damage_update_request_data import DamageUpdateRequestData  # noqa: E501

class TestDamageUpdateRequestData(unittest.TestCase):
    """DamageUpdateRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DamageUpdateRequestData:
        """Test DamageUpdateRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DamageUpdateRequestData`
        """
        model = DamageUpdateRequestData()  # noqa: E501
        if include_optional:
            return DamageUpdateRequestData(
                amount = 1.337,
                damage_type = 'special',
                description = ''
            )
    ...
    def testDamageUpdateRequestData(self):
        """Test DamageUpdateRequestData"""
