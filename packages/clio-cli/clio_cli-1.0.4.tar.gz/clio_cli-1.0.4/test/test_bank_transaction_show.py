...
from openapi_client.models.bank_transaction_show import BankTransactionShow  # noqa: E501

class TestBankTransactionShow(unittest.TestCase):
    """BankTransactionShow unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BankTransactionShow:
        """Test BankTransactionShow
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BankTransactionShow`
        """
        model = BankTransactionShow()  # noqa: E501
        if include_optional:
            return BankTransactionShow(
                data = None
            )
        else:
            return BankTransactionShow(
    ...
    def testBankTransactionShow(self):
        """Test BankTransactionShow"""
