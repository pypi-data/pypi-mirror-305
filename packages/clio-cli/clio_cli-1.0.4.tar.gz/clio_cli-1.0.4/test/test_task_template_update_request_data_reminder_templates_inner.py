...
from openapi_client.models.task_template_update_request_data_reminder_templates_inner import TaskTemplateUpdateRequestDataReminderTemplatesInner  # noqa: E501

class TestTaskTemplateUpdateRequestDataReminderTemplatesInner(unittest.TestCase):
    """TaskTemplateUpdateRequestDataReminderTemplatesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TaskTemplateUpdateRequestDataReminderTemplatesInner:
        """Test TaskTemplateUpdateRequestDataReminderTemplatesInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TaskTemplateUpdateRequestDataReminderTemplatesInner`
        """
        model = TaskTemplateUpdateRequestDataReminderTemplatesInner()  # noqa: E501
        if include_optional:
            return TaskTemplateUpdateRequestDataReminderTemplatesInner(
                duration_value = 56,
                duration_unit = '',
    ...
    def testTaskTemplateUpdateRequestDataReminderTemplatesInner(self):
        """Test TaskTemplateUpdateRequestDataReminderTemplatesInner"""
