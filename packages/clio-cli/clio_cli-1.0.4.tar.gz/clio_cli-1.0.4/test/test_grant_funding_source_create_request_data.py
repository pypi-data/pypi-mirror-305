...
from openapi_client.models.grant_funding_source_create_request_data import GrantFundingSourceCreateRequestData  # noqa: E501

class TestGrantFundingSourceCreateRequestData(unittest.TestCase):
    """GrantFundingSourceCreateRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GrantFundingSourceCreateRequestData:
        """Test GrantFundingSourceCreateRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GrantFundingSourceCreateRequestData`
        """
        model = GrantFundingSourceCreateRequestData()  # noqa: E501
        if include_optional:
            return GrantFundingSourceCreateRequestData(
                name = ''
            )
        else:
            return GrantFundingSourceCreateRequestData(
    ...
    def testGrantFundingSourceCreateRequestData(self):
        """Test GrantFundingSourceCreateRequestData"""
