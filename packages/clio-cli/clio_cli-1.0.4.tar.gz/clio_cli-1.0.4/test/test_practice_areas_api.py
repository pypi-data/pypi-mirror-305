...
from openapi_client.api.practice_areas_api import PracticeAreasApi  # noqa: E501


class TestPracticeAreasApi(unittest.TestCase):
    """PracticeAreasApi unit test stubs"""

    def setUp(self) -> None:
        self.api = PracticeAreasApi()

    def tearDown(self) -> None:
        pass

    def test_practice_area_create(self) -> None:
    ...
    def test_practice_area_destroy(self) -> None:
    ...
    def test_practice_area_index(self) -> None:
    ...
    def test_practice_area_show(self) -> None:
    ...
    def test_practice_area_update(self) -> None:
