...
from openapi_client.models.report_schedule_base import ReportScheduleBase  # noqa: E501

class TestReportScheduleBase(unittest.TestCase):
    """ReportScheduleBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReportScheduleBase:
        """Test ReportScheduleBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReportScheduleBase`
        """
        model = ReportScheduleBase()  # noqa: E501
        if include_optional:
            return ReportScheduleBase(
                id = 56,
                etag = '',
    ...
    def testReportScheduleBase(self):
        """Test ReportScheduleBase"""
