...
from openapi_client.models.credit_memo_base import CreditMemoBase  # noqa: E501

class TestCreditMemoBase(unittest.TestCase):
    """CreditMemoBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreditMemoBase:
        """Test CreditMemoBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreditMemoBase`
        """
        model = CreditMemoBase()  # noqa: E501
        if include_optional:
