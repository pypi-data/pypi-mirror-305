...
from openapi_client.models.jurisdictions_to_trigger import JurisdictionsToTrigger  # noqa: E501

class TestJurisdictionsToTrigger(unittest.TestCase):
    """JurisdictionsToTrigger unit test stubs"""
    ...
    def make_instance(self, include_optional) -> JurisdictionsToTrigger:
        """Test JurisdictionsToTrigger
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `JurisdictionsToTrigger`
        """
        model = JurisdictionsToTrigger()  # noqa: E501
        if include_optional:
            return JurisdictionsToTrigger(
                id = 56,
                etag = '',
                system_id = 56,
                description = '',
    ...
    def testJurisdictionsToTrigger(self):
        """Test JurisdictionsToTrigger"""
