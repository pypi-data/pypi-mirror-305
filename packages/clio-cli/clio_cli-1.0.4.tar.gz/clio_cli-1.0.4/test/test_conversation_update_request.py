...
from openapi_client.models.conversation_update_request import ConversationUpdateRequest  # noqa: E501

class TestConversationUpdateRequest(unittest.TestCase):
    """ConversationUpdateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConversationUpdateRequest:
        """Test ConversationUpdateRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConversationUpdateRequest`
        """
        model = ConversationUpdateRequest()  # noqa: E501
        if include_optional:
            return ConversationUpdateRequest(
                data = openapi_client.models.conversation_update_request_data.Conversation_update_request_data(
                    archived = True, 
                    matter = openapi_client.models.conversation_update_request_data_matter.Conversation_update_request_data_matter(
                        id = 56, ), 
                    read = True, )
            )
        else:
    ...
    def testConversationUpdateRequest(self):
        """Test ConversationUpdateRequest"""
