...
from openapi_client.api.document_categories_api import DocumentCategoriesApi  # noqa: E501


class TestDocumentCategoriesApi(unittest.TestCase):
    """DocumentCategoriesApi unit test stubs"""

    def setUp(self) -> None:
        self.api = DocumentCategoriesApi()

    def tearDown(self) -> None:
        pass

    def test_document_category_create(self) -> None:
    ...
    def test_document_category_destroy(self) -> None:
    ...
    def test_document_category_index(self) -> None:
    ...
    def test_document_category_show(self) -> None:
    ...
    def test_document_category_update(self) -> None:
