...
from openapi_client.models.timer_show import TimerShow  # noqa: E501

class TestTimerShow(unittest.TestCase):
    """TimerShow unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TimerShow:
        """Test TimerShow
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TimerShow`
        """
        model = TimerShow()  # noqa: E501
        if include_optional:
            return TimerShow(
                data = None
            )
