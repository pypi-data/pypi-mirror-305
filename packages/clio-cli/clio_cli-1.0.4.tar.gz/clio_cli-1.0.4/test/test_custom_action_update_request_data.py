...
from openapi_client.models.custom_action_update_request_data import CustomActionUpdateRequestData  # noqa: E501

class TestCustomActionUpdateRequestData(unittest.TestCase):
    """CustomActionUpdateRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CustomActionUpdateRequestData:
        """Test CustomActionUpdateRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CustomActionUpdateRequestData`
        """
        model = CustomActionUpdateRequestData()  # noqa: E501
        if include_optional:
            return CustomActionUpdateRequestData(
                label = '',
                target_url = '',
    ...
    def testCustomActionUpdateRequestData(self):
        """Test CustomActionUpdateRequestData"""
