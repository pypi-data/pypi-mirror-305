...
from openapi_client.models.avatar_base import AvatarBase  # noqa: E501

class TestAvatarBase(unittest.TestCase):
    """AvatarBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AvatarBase:
        """Test AvatarBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AvatarBase`
        """
        model = AvatarBase()  # noqa: E501
        if include_optional:
            return AvatarBase(
                id = 56,
                etag = '',
