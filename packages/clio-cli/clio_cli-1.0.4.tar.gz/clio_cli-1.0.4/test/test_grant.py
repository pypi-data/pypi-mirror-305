...
from openapi_client.models.grant import Grant  # noqa: E501
    ...
    def make_instance(self, include_optional) -> Grant:
        ...
        if include_optional:
            return Grant(
                ...
                balance = '',
                grant_funding_source = openapi_client.models.grant_funding_source_base.GrantFundingSource_base(
                    id = 56, 
                    etag = '', 
                    name = '', 
                    created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
