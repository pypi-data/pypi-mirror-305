...
from openapi_client.models.medical_records_request_create_request import MedicalRecordsRequestCreateRequest  # noqa: E501

class TestMedicalRecordsRequestCreateRequest(unittest.TestCase):
    """MedicalRecordsRequestCreateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MedicalRecordsRequestCreateRequest:
        """Test MedicalRecordsRequestCreateRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MedicalRecordsRequestCreateRequest`
        """
        model = MedicalRecordsRequestCreateRequest()  # noqa: E501
        if include_optional:
            return MedicalRecordsRequestCreateRequest(
                data = openapi_client.models.medical_records_request_create_request_data.MedicalRecordsRequest_create_request_data(
                    bills_follow_up_date = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    bills_request_date = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    bills_status = 'not_yet_requested', 
                    description = '', 
                    in_treatment = True, 
                    matter_id = 56, 
                    medical_bills = [
                        openapi_client.models.medical_records_request_create_request_data_medical_bills_inner.MedicalRecordsRequest_create_request_data_medical_bills_inner(
                            adjustment = 1.337, 
                            amount = 1.337, 
                            balance = 1.337, 
                            bill_date = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(), 
                            bill_received_date = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(), 
                            document_id = 56, 
                            name = '', 
                            mark_balance_as_lien = True, 
                            payers = [
                                openapi_client.models.medical_records_request_create_request_data_medical_bills_inner_payers_inner.MedicalRecordsRequest_create_request_data_medical_bills_inner_payers_inner(
                                    amount = 1.337, 
                                    holder_id = 56, 
                                    mark_as_lien = True, )
                                ], )
                        ], 
                    medical_provider_id = 56, 
                    medical_records = [
                        openapi_client.models.medical_records_request_create_request_data_medical_records_inner.MedicalRecordsRequest_create_request_data_medical_records_inner(
                            document_id = 56, 
                            end_date = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                            start_date = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), )
                        ], 
                    records_follow_up_date = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    records_request_date = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    records_status = 'not_yet_requested', 
                    treatment_end_date = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    treatment_start_date = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), )
            )
        else:
            return MedicalRecordsRequestCreateRequest(
                data = openapi_client.models.medical_records_request_create_request_data.MedicalRecordsRequest_create_request_data(
    ...
    def testMedicalRecordsRequestCreateRequest(self):
        """Test MedicalRecordsRequestCreateRequest"""
