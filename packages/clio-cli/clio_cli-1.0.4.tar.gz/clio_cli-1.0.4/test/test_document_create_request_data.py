...
from openapi_client.models.document_create_request_data import DocumentCreateRequestData  # noqa: E501

class TestDocumentCreateRequestData(unittest.TestCase):
    """DocumentCreateRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentCreateRequestData:
        """Test DocumentCreateRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentCreateRequestData`
        """
        model = DocumentCreateRequestData()  # noqa: E501
        if include_optional:
            return DocumentCreateRequestData(
                communication_id = 56,
                content_type = '',
                document_category = openapi_client.models.document_copy_request_data_document_category.Document_copy_request_data_document_category(
                    id = 56, ),
                external_properties = [
                    openapi_client.models.document_create_request_data_external_properties_inner.Document_create_request_data_external_properties_inner(
                        name = '', 
                        value = '', )
                    ],
                filename = 'name',
                multiparts = [
                    openapi_client.models.document_create_request_data_multiparts_inner.Document_create_request_data_multiparts_inner(
                        part_number = 56, 
                        content_length = '', 
                        content_md5 = '', )
                    ],
                name = '',
                parent = openapi_client.models.document_copy_request_data_parent.Document_copy_request_data_parent(
                    id = 56, 
                    type = 'Document', ),
    ...
    def testDocumentCreateRequestData(self):
        """Test DocumentCreateRequestData"""
