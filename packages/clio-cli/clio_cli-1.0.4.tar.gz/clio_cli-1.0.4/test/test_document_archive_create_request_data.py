...
from openapi_client.models.document_archive_create_request_data import DocumentArchiveCreateRequestData  # noqa: E501

class TestDocumentArchiveCreateRequestData(unittest.TestCase):
    """DocumentArchiveCreateRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentArchiveCreateRequestData:
        """Test DocumentArchiveCreateRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentArchiveCreateRequestData`
        """
        model = DocumentArchiveCreateRequestData()  # noqa: E501
        if include_optional:
            return DocumentArchiveCreateRequestData(
                items = [
    ...
    def testDocumentArchiveCreateRequestData(self):
        """Test DocumentArchiveCreateRequestData"""
