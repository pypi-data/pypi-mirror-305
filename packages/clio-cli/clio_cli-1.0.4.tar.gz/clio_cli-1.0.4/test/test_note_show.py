...
from openapi_client.models.note_show import NoteShow  # noqa: E501

class TestNoteShow(unittest.TestCase):
    """NoteShow unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NoteShow:
        """Test NoteShow
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NoteShow`
        """
        model = NoteShow()  # noqa: E501
        if include_optional:
            return NoteShow(
                data = None
            )
