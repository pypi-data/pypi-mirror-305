...
from openapi_client.models.line_item_base import LineItemBase  # noqa: E501

class TestLineItemBase(unittest.TestCase):
    """LineItemBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LineItemBase:
        """Test LineItemBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LineItemBase`
        """
        model = LineItemBase()  # noqa: E501
        if include_optional:
            return LineItemBase(
                id = 56,
                etag = '',
