...
from openapi_client.models.matter_update_request_data_split_invoice_payers_inner import MatterUpdateRequestDataSplitInvoicePayersInner  # noqa: E501

class TestMatterUpdateRequestDataSplitInvoicePayersInner(unittest.TestCase):
    """MatterUpdateRequestDataSplitInvoicePayersInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MatterUpdateRequestDataSplitInvoicePayersInner:
        """Test MatterUpdateRequestDataSplitInvoicePayersInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MatterUpdateRequestDataSplitInvoicePayersInner`
        """
        model = MatterUpdateRequestDataSplitInvoicePayersInner()  # noqa: E501
        if include_optional:
            return MatterUpdateRequestDataSplitInvoicePayersInner(
                contact_id = 56,
                id = 56,
    ...
    def testMatterUpdateRequestDataSplitInvoicePayersInner(self):
        """Test MatterUpdateRequestDataSplitInvoicePayersInner"""
