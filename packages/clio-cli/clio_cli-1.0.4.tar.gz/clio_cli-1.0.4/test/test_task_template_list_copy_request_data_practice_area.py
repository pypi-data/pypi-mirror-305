...
from openapi_client.models.task_template_list_copy_request_data_practice_area import TaskTemplateListCopyRequestDataPracticeArea  # noqa: E501

class TestTaskTemplateListCopyRequestDataPracticeArea(unittest.TestCase):
    """TaskTemplateListCopyRequestDataPracticeArea unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TaskTemplateListCopyRequestDataPracticeArea:
        """Test TaskTemplateListCopyRequestDataPracticeArea
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TaskTemplateListCopyRequestDataPracticeArea`
        """
        model = TaskTemplateListCopyRequestDataPracticeArea()  # noqa: E501
        if include_optional:
            return TaskTemplateListCopyRequestDataPracticeArea(
                id = 56
            )
        else:
            return TaskTemplateListCopyRequestDataPracticeArea(
    ...
    def testTaskTemplateListCopyRequestDataPracticeArea(self):
        """Test TaskTemplateListCopyRequestDataPracticeArea"""
