...
from openapi_client.models.note_update_request_data_notification_event_subscribers_inner import NoteUpdateRequestDataNotificationEventSubscribersInner  # noqa: E501

class TestNoteUpdateRequestDataNotificationEventSubscribersInner(unittest.TestCase):
    """NoteUpdateRequestDataNotificationEventSubscribersInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NoteUpdateRequestDataNotificationEventSubscribersInner:
        """Test NoteUpdateRequestDataNotificationEventSubscribersInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NoteUpdateRequestDataNotificationEventSubscribersInner`
        """
        model = NoteUpdateRequestDataNotificationEventSubscribersInner()  # noqa: E501
        if include_optional:
            return NoteUpdateRequestDataNotificationEventSubscribersInner(
                user_id = '',
                id = 56,
                destroy = True
            )
    ...
    def testNoteUpdateRequestDataNotificationEventSubscribersInner(self):
        """Test NoteUpdateRequestDataNotificationEventSubscribersInner"""
