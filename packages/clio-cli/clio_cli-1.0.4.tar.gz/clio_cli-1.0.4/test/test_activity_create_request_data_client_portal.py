...
from openapi_client.models.activity_create_request_data_client_portal import ActivityCreateRequestDataClientPortal  # noqa: E501

class TestActivityCreateRequestDataClientPortal(unittest.TestCase):
    """ActivityCreateRequestDataClientPortal unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ActivityCreateRequestDataClientPortal:
        """Test ActivityCreateRequestDataClientPortal
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ActivityCreateRequestDataClientPortal`
        """
        model = ActivityCreateRequestDataClientPortal()  # noqa: E501
        if include_optional:
            return ActivityCreateRequestDataClientPortal(
                id = 56
            )
        else:
            return ActivityCreateRequestDataClientPortal(
    ...
    def testActivityCreateRequestDataClientPortal(self):
        """Test ActivityCreateRequestDataClientPortal"""
