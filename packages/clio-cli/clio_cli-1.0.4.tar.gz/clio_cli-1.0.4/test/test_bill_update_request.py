...
from openapi_client.models.bill_update_request import BillUpdateRequest  # noqa: E501

class TestBillUpdateRequest(unittest.TestCase):
    """BillUpdateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BillUpdateRequest:
        """Test BillUpdateRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BillUpdateRequest`
        """
        model = BillUpdateRequest()  # noqa: E501
        if include_optional:
            return BillUpdateRequest(
                data = openapi_client.models.bill_update_request_data.Bill_update_request_data(
                    bill_theme = openapi_client.models.bill_update_request_data_bill_theme.Bill_update_request_data_bill_theme(
                        id = 56, ), 
                    currency_id = 56, 
                    discount = openapi_client.models.bill_update_request_data_discount.Bill_update_request_data_discount(
                        rate = 1.337, 
                        type = 'percentage', 
                        note = '', ), 
                    due_at = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(), 
                    interest = openapi_client.models.bill_update_request_data_interest.Bill_update_request_data_interest(
                        rate = 1.337, 
                        type = 'simple', 
                        period = 56, ), 
    ...
    def testBillUpdateRequest(self):
        """Test BillUpdateRequest"""
