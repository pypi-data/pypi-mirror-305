...
from openapi_client.models.activity_create_request_data_utbms_expense import ActivityCreateRequestDataUtbmsExpense  # noqa: E501

class TestActivityCreateRequestDataUtbmsExpense(unittest.TestCase):
    """ActivityCreateRequestDataUtbmsExpense unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ActivityCreateRequestDataUtbmsExpense:
        """Test ActivityCreateRequestDataUtbmsExpense
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ActivityCreateRequestDataUtbmsExpense`
        """
        model = ActivityCreateRequestDataUtbmsExpense()  # noqa: E501
        if include_optional:
            return ActivityCreateRequestDataUtbmsExpense(
                id = 56
            )
        else:
            return ActivityCreateRequestDataUtbmsExpense(
    ...
    def testActivityCreateRequestDataUtbmsExpense(self):
        """Test ActivityCreateRequestDataUtbmsExpense"""
