...
from openapi_client.models.matter_docket import MatterDocket  # noqa: E501
    ...
    def make_instance(self, include_optional) -> MatterDocket:
        ...
        if include_optional:
            return MatterDocket(
                ...
                jurisdiction = openapi_client.models.jurisdiction_base.Jurisdiction_base(
                    id = 56, 
                    etag = '', 
                    created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                ...
                trigger = openapi_client.models.jurisdictions_to_trigger_base.JurisdictionsToTrigger_base(
                    id = 56, 
                    etag = '', 
                    system_id = 56, 
                    description = '', 
                    ...
                    created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), ),
                service_type = openapi_client.models.service_type_base.ServiceType_base(
                    id = 56, 
                    etag = '', 
                    created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    ...
                    default = True, ),
                calendar_entries = [
                    openapi_client.models.calendar_entry_base.CalendarEntry_base(
                        id = '', 
                        etag = '', 
                        summary = '', 
                        description = '', 
