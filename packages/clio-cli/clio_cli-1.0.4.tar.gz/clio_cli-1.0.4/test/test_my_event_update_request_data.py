...
from openapi_client.models.my_event_update_request_data import MyEventUpdateRequestData  # noqa: E501

class TestMyEventUpdateRequestData(unittest.TestCase):
    """MyEventUpdateRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MyEventUpdateRequestData:
        """Test MyEventUpdateRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MyEventUpdateRequestData`
        """
        model = MyEventUpdateRequestData()  # noqa: E501
        if include_optional:
            return MyEventUpdateRequestData(
                marked_as_read = True
            )
        else:
            return MyEventUpdateRequestData(
    ...
    def testMyEventUpdateRequestData(self):
        """Test MyEventUpdateRequestData"""
