...
from openapi_client.models.conversation_message_create_request_data_conversation import ConversationMessageCreateRequestDataConversation  # noqa: E501

class TestConversationMessageCreateRequestDataConversation(unittest.TestCase):
    """ConversationMessageCreateRequestDataConversation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConversationMessageCreateRequestDataConversation:
        """Test ConversationMessageCreateRequestDataConversation
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConversationMessageCreateRequestDataConversation`
        """
        model = ConversationMessageCreateRequestDataConversation()  # noqa: E501
        if include_optional:
            return ConversationMessageCreateRequestDataConversation(
                id = 56
            )
        else:
            return ConversationMessageCreateRequestDataConversation(
    ...
    def testConversationMessageCreateRequestDataConversation(self):
        """Test ConversationMessageCreateRequestDataConversation"""
