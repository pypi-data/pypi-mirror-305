...
from openapi_client.models.medical_records_request_create_request_data_medical_bills_inner_payers_inner import MedicalRecordsRequestCreateRequestDataMedicalBillsInnerPayersInner  # noqa: E501

class TestMedicalRecordsRequestCreateRequestDataMedicalBillsInnerPayersInner(unittest.TestCase):
    """MedicalRecordsRequestCreateRequestDataMedicalBillsInnerPayersInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MedicalRecordsRequestCreateRequestDataMedicalBillsInnerPayersInner:
        """Test MedicalRecordsRequestCreateRequestDataMedicalBillsInnerPayersInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MedicalRecordsRequestCreateRequestDataMedicalBillsInnerPayersInner`
        """
        model = MedicalRecordsRequestCreateRequestDataMedicalBillsInnerPayersInner()  # noqa: E501
        if include_optional:
            return MedicalRecordsRequestCreateRequestDataMedicalBillsInnerPayersInner(
                amount = 1.337,
                holder_id = 56,
                mark_as_lien = True
            )
    ...
    def testMedicalRecordsRequestCreateRequestDataMedicalBillsInnerPayersInner(self):
        """Test MedicalRecordsRequestCreateRequestDataMedicalBillsInnerPayersInner"""
