...
from openapi_client.models.conversation_show import ConversationShow  # noqa: E501

class TestConversationShow(unittest.TestCase):
    """ConversationShow unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConversationShow:
        """Test ConversationShow
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConversationShow`
        """
        model = ConversationShow()  # noqa: E501
        if include_optional:
