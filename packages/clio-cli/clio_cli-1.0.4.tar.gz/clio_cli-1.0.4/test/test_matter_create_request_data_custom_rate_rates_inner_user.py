...
from openapi_client.models.matter_create_request_data_custom_rate_rates_inner_user import MatterCreateRequestDataCustomRateRatesInnerUser  # noqa: E501

class TestMatterCreateRequestDataCustomRateRatesInnerUser(unittest.TestCase):
    """MatterCreateRequestDataCustomRateRatesInnerUser unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MatterCreateRequestDataCustomRateRatesInnerUser:
        """Test MatterCreateRequestDataCustomRateRatesInnerUser
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MatterCreateRequestDataCustomRateRatesInnerUser`
        """
        model = MatterCreateRequestDataCustomRateRatesInnerUser()  # noqa: E501
        if include_optional:
            return MatterCreateRequestDataCustomRateRatesInnerUser(
                id = 56
            )
        else:
            return MatterCreateRequestDataCustomRateRatesInnerUser(
    ...
    def testMatterCreateRequestDataCustomRateRatesInnerUser(self):
        """Test MatterCreateRequestDataCustomRateRatesInnerUser"""
