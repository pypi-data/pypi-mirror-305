...
from openapi_client.models.report_schedule_update_request_data import ReportScheduleUpdateRequestData  # noqa: E501

class TestReportScheduleUpdateRequestData(unittest.TestCase):
    """ReportScheduleUpdateRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReportScheduleUpdateRequestData:
        """Test ReportScheduleUpdateRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReportScheduleUpdateRequestData`
        """
        model = ReportScheduleUpdateRequestData()  # noqa: E501
        if include_optional:
            return ReportScheduleUpdateRequestData(
                day_of_month = 56,
                days_of_week = [
                    56
                    ],
    ...
    def testReportScheduleUpdateRequestData(self):
        """Test ReportScheduleUpdateRequestData"""
