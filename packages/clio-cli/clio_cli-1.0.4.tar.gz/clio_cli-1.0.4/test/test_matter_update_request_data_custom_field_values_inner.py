...
from openapi_client.models.matter_update_request_data_custom_field_values_inner import MatterUpdateRequestDataCustomFieldValuesInner  # noqa: E501

class TestMatterUpdateRequestDataCustomFieldValuesInner(unittest.TestCase):
    """MatterUpdateRequestDataCustomFieldValuesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MatterUpdateRequestDataCustomFieldValuesInner:
        """Test MatterUpdateRequestDataCustomFieldValuesInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MatterUpdateRequestDataCustomFieldValuesInner`
        """
        model = MatterUpdateRequestDataCustomFieldValuesInner()  # noqa: E501
        if include_optional:
            return MatterUpdateRequestDataCustomFieldValuesInner(
                value = '',
    ...
    def testMatterUpdateRequestDataCustomFieldValuesInner(self):
        """Test MatterUpdateRequestDataCustomFieldValuesInner"""
