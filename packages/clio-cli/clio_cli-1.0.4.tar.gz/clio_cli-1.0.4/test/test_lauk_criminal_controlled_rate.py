...
from openapi_client.models.lauk_criminal_controlled_rate import LaukCriminalControlledRate  # noqa: E501

class TestLaukCriminalControlledRate(unittest.TestCase):
    """LaukCriminalControlledRate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LaukCriminalControlledRate:
        """Test LaukCriminalControlledRate
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LaukCriminalControlledRate`
        """
        model = LaukCriminalControlledRate()  # noqa: E501
        if include_optional:
            return LaukCriminalControlledRate(
                id = 56,
                activity = '',
                activity_type = '',
                category_of_law = '',
    ...
    def testLaukCriminalControlledRate(self):
        """Test LaukCriminalControlledRate"""
