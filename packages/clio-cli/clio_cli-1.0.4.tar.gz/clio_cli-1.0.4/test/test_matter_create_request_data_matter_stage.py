...
from openapi_client.models.matter_create_request_data_matter_stage import MatterCreateRequestDataMatterStage  # noqa: E501

class TestMatterCreateRequestDataMatterStage(unittest.TestCase):
    """MatterCreateRequestDataMatterStage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MatterCreateRequestDataMatterStage:
        """Test MatterCreateRequestDataMatterStage
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MatterCreateRequestDataMatterStage`
        """
        model = MatterCreateRequestDataMatterStage()  # noqa: E501
        if include_optional:
            return MatterCreateRequestDataMatterStage(
                id = 56
            )
        else:
            return MatterCreateRequestDataMatterStage(
    ...
    def testMatterCreateRequestDataMatterStage(self):
        """Test MatterCreateRequestDataMatterStage"""
