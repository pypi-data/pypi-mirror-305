...
from openapi_client.models.interest_base import InterestBase  # noqa: E501

class TestInterestBase(unittest.TestCase):
    """InterestBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterestBase:
        """Test InterestBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterestBase`
        """
        model = InterestBase()  # noqa: E501
        if include_optional:
            return InterestBase(
                balance = 1.337,
                period = 56,
