...
from openapi_client.models.calendar_entry_base import CalendarEntryBase  # noqa: E501

class TestCalendarEntryBase(unittest.TestCase):
    """CalendarEntryBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CalendarEntryBase:
        """Test CalendarEntryBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CalendarEntryBase`
        """
        model = CalendarEntryBase()  # noqa: E501
        if include_optional:
            return CalendarEntryBase(
                id = '',
                etag = '',
                summary = '',
                description = '',
    ...
    def testCalendarEntryBase(self):
        """Test CalendarEntryBase"""
