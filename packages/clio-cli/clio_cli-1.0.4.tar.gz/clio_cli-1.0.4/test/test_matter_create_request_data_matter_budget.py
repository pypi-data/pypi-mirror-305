...
from openapi_client.models.matter_create_request_data_matter_budget import MatterCreateRequestDataMatterBudget  # noqa: E501

class TestMatterCreateRequestDataMatterBudget(unittest.TestCase):
    """MatterCreateRequestDataMatterBudget unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MatterCreateRequestDataMatterBudget:
        """Test MatterCreateRequestDataMatterBudget
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MatterCreateRequestDataMatterBudget`
        """
        model = MatterCreateRequestDataMatterBudget()  # noqa: E501
        if include_optional:
            return MatterCreateRequestDataMatterBudget(
                destroy = True,
                budget = 1.337,
    ...
    def testMatterCreateRequestDataMatterBudget(self):
        """Test MatterCreateRequestDataMatterBudget"""
