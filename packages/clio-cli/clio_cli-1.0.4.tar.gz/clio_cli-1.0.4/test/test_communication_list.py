...
from openapi_client.models.communication_list import CommunicationList  # noqa: E501

class TestCommunicationList(unittest.TestCase):
    """CommunicationList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CommunicationList:
        """Test CommunicationList
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CommunicationList`
        """
        model = CommunicationList()  # noqa: E501
        if include_optional:
    ...
    def testCommunicationList(self):
        """Test CommunicationList"""
