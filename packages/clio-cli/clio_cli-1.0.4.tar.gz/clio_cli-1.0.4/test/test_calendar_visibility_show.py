...
from openapi_client.models.calendar_visibility_show import CalendarVisibilityShow  # noqa: E501

class TestCalendarVisibilityShow(unittest.TestCase):
    """CalendarVisibilityShow unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CalendarVisibilityShow:
        """Test CalendarVisibilityShow
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CalendarVisibilityShow`
        """
        model = CalendarVisibilityShow()  # noqa: E501
        if include_optional:
            return CalendarVisibilityShow(
                data = None
            )
        else:
            return CalendarVisibilityShow(
    ...
    def testCalendarVisibilityShow(self):
        """Test CalendarVisibilityShow"""
