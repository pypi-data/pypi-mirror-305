...
from openapi_client.models.medical_records_request_update_request_data_medical_bills_inner_payers_inner import MedicalRecordsRequestUpdateRequestDataMedicalBillsInnerPayersInner  # noqa: E501

class TestMedicalRecordsRequestUpdateRequestDataMedicalBillsInnerPayersInner(unittest.TestCase):
    """MedicalRecordsRequestUpdateRequestDataMedicalBillsInnerPayersInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MedicalRecordsRequestUpdateRequestDataMedicalBillsInnerPayersInner:
        """Test MedicalRecordsRequestUpdateRequestDataMedicalBillsInnerPayersInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MedicalRecordsRequestUpdateRequestDataMedicalBillsInnerPayersInner`
        """
        model = MedicalRecordsRequestUpdateRequestDataMedicalBillsInnerPayersInner()  # noqa: E501
        if include_optional:
            return MedicalRecordsRequestUpdateRequestDataMedicalBillsInnerPayersInner(
                amount = 1.337,
                holder_id = 56,
                mark_as_lien = True
            )
    ...
    def testMedicalRecordsRequestUpdateRequestDataMedicalBillsInnerPayersInner(self):
        """Test MedicalRecordsRequestUpdateRequestDataMedicalBillsInnerPayersInner"""
