...
from openapi_client.models.external_property_base import ExternalPropertyBase  # noqa: E501

class TestExternalPropertyBase(unittest.TestCase):
    """ExternalPropertyBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExternalPropertyBase:
        """Test ExternalPropertyBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExternalPropertyBase`
        """
        model = ExternalPropertyBase()  # noqa: E501
        if include_optional:
            return ExternalPropertyBase(
                id = 56,
                etag = '',
                name = '',
                value = '',
    ...
    def testExternalPropertyBase(self):
        """Test ExternalPropertyBase"""
