...
from openapi_client.models.activity_show import ActivityShow  # noqa: E501

class TestActivityShow(unittest.TestCase):
    """ActivityShow unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ActivityShow:
        """Test ActivityShow
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ActivityShow`
        """
        model = ActivityShow()  # noqa: E501
        if include_optional:
            return ActivityShow(
                data = None
            )
