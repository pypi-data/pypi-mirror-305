...
from openapi_client.models.clio_payments_link_update_request import ClioPaymentsLinkUpdateRequest  # noqa: E501

class TestClioPaymentsLinkUpdateRequest(unittest.TestCase):
    """ClioPaymentsLinkUpdateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ClioPaymentsLinkUpdateRequest:
        """Test ClioPaymentsLinkUpdateRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ClioPaymentsLinkUpdateRequest`
        """
        model = ClioPaymentsLinkUpdateRequest()  # noqa: E501
        if include_optional:
            return ClioPaymentsLinkUpdateRequest(
                data = openapi_client.models.clio_payments_link_update_request_data.ClioPaymentsLink_update_request_data(
                    expired = True, )
            )
        else:
            return ClioPaymentsLinkUpdateRequest(
    ...
    def testClioPaymentsLinkUpdateRequest(self):
        """Test ClioPaymentsLinkUpdateRequest"""
