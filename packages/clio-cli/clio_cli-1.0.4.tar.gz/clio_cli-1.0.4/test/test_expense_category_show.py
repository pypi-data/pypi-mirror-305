...
from openapi_client.models.expense_category_show import ExpenseCategoryShow  # noqa: E501

class TestExpenseCategoryShow(unittest.TestCase):
    """ExpenseCategoryShow unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExpenseCategoryShow:
        """Test ExpenseCategoryShow
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExpenseCategoryShow`
        """
        model = ExpenseCategoryShow()  # noqa: E501
        if include_optional:
            return ExpenseCategoryShow(
                data = None
            )
        else:
            return ExpenseCategoryShow(
    ...
    def testExpenseCategoryShow(self):
        """Test ExpenseCategoryShow"""
