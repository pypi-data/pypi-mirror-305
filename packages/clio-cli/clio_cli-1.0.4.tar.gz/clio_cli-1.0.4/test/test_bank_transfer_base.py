...
from openapi_client.models.bank_transfer_base import BankTransferBase  # noqa: E501

class TestBankTransferBase(unittest.TestCase):
    """BankTransferBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BankTransferBase:
        """Test BankTransferBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BankTransferBase`
        """
        model = BankTransferBase()  # noqa: E501
        if include_optional:
            return BankTransferBase(
                id = 56,
                etag = '',
                amount = 1.337,
