...
from openapi_client.models.reminder_create_request_data import ReminderCreateRequestData  # noqa: E501

class TestReminderCreateRequestData(unittest.TestCase):
    """ReminderCreateRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReminderCreateRequestData:
        """Test ReminderCreateRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReminderCreateRequestData`
        """
        model = ReminderCreateRequestData()  # noqa: E501
        if include_optional:
            return ReminderCreateRequestData(
                duration_unit = 'weeks',
                duration_value = 56,
                notification_method = openapi_client.models.matter_create_request_data_statute_of_limitations_reminders_inner_notification_method.Matter_create_request_data_statute_of_limitations_reminders_inner_notification_method(
                    id = 56, ),
                subject = openapi_client.models.reminder_create_request_data_subject.Reminder_create_request_data_subject(
                    id = 56, 
                    type = 'CalendarEntry', )
            )
        else:
    ...
    def testReminderCreateRequestData(self):
        """Test ReminderCreateRequestData"""
