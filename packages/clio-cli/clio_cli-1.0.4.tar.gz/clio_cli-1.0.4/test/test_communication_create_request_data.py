...
from openapi_client.models.communication_create_request_data import CommunicationCreateRequestData  # noqa: E501

class TestCommunicationCreateRequestData(unittest.TestCase):
    """CommunicationCreateRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CommunicationCreateRequestData:
        """Test CommunicationCreateRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CommunicationCreateRequestData`
        """
        model = CommunicationCreateRequestData()  # noqa: E501
        if include_optional:
            return CommunicationCreateRequestData(
                body = '',
                var_date = '',
                external_properties = [
    ...
    def testCommunicationCreateRequestData(self):
        """Test CommunicationCreateRequestData"""
