...
from openapi_client.models.activity_description_list import ActivityDescriptionList  # noqa: E501

class TestActivityDescriptionList(unittest.TestCase):
    """ActivityDescriptionList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ActivityDescriptionList:
        """Test ActivityDescriptionList
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ActivityDescriptionList`
        """
        model = ActivityDescriptionList()  # noqa: E501
        if include_optional:
    ...
    def testActivityDescriptionList(self):
        """Test ActivityDescriptionList"""
