...
from openapi_client.models.calendar_entry_event_type_create_request_data import CalendarEntryEventTypeCreateRequestData  # noqa: E501

class TestCalendarEntryEventTypeCreateRequestData(unittest.TestCase):
    """CalendarEntryEventTypeCreateRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CalendarEntryEventTypeCreateRequestData:
        """Test CalendarEntryEventTypeCreateRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CalendarEntryEventTypeCreateRequestData`
        """
        model = CalendarEntryEventTypeCreateRequestData()  # noqa: E501
        if include_optional:
            return CalendarEntryEventTypeCreateRequestData(
                color = '#367B9C',
                name = ''
            )
        else:
    ...
    def testCalendarEntryEventTypeCreateRequestData(self):
        """Test CalendarEntryEventTypeCreateRequestData"""
