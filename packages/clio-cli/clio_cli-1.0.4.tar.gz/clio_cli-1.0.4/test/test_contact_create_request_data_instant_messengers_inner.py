...
from openapi_client.models.contact_create_request_data_instant_messengers_inner import ContactCreateRequestDataInstantMessengersInner  # noqa: E501

class TestContactCreateRequestDataInstantMessengersInner(unittest.TestCase):
    """ContactCreateRequestDataInstantMessengersInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ContactCreateRequestDataInstantMessengersInner:
        """Test ContactCreateRequestDataInstantMessengersInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ContactCreateRequestDataInstantMessengersInner`
        """
        model = ContactCreateRequestDataInstantMessengersInner()  # noqa: E501
        if include_optional:
            return ContactCreateRequestDataInstantMessengersInner(
                name = 'Other',
                address = ''
            )
        else:
    ...
    def testContactCreateRequestDataInstantMessengersInner(self):
        """Test ContactCreateRequestDataInstantMessengersInner"""
