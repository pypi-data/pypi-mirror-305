...
from openapi_client.api.utbms_codes_api import UtbmsCodesApi  # noqa: E501


class TestUtbmsCodesApi(unittest.TestCase):
    """UtbmsCodesApi unit test stubs"""

    def setUp(self) -> None:
        self.api = UtbmsCodesApi()

    def tearDown(self) -> None:
        pass

    def test_utbms_code_index(self) -> None:
    ...
    def test_utbms_code_show(self) -> None:
