...
from openapi_client.models.utbms_set import UtbmsSet  # noqa: E501

class TestUtbmsSet(unittest.TestCase):
    """UtbmsSet unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UtbmsSet:
        """Test UtbmsSet
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UtbmsSet`
        """
        model = UtbmsSet()  # noqa: E501
        if include_optional:
            return UtbmsSet(
                id = 56,
                etag = '',
