...
from openapi_client.models.web_site_base import WebSiteBase  # noqa: E501

class TestWebSiteBase(unittest.TestCase):
    """WebSiteBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebSiteBase:
        """Test WebSiteBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebSiteBase`
        """
        model = WebSiteBase()  # noqa: E501
        if include_optional:
            return WebSiteBase(
                id = 56,
                etag = '',
