...
from openapi_client.models.conversation_message_create_request_data import ConversationMessageCreateRequestData  # noqa: E501

class TestConversationMessageCreateRequestData(unittest.TestCase):
    """ConversationMessageCreateRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConversationMessageCreateRequestData:
        """Test ConversationMessageCreateRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConversationMessageCreateRequestData`
        """
        model = ConversationMessageCreateRequestData()  # noqa: E501
        if include_optional:
            return ConversationMessageCreateRequestData(
    ...
    def testConversationMessageCreateRequestData(self):
        """Test ConversationMessageCreateRequestData"""
