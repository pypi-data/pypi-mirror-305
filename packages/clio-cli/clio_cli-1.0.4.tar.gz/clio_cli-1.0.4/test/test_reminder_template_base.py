...
from openapi_client.models.reminder_template_base import ReminderTemplateBase  # noqa: E501

class TestReminderTemplateBase(unittest.TestCase):
    """ReminderTemplateBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReminderTemplateBase:
        """Test ReminderTemplateBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReminderTemplateBase`
        """
        model = ReminderTemplateBase()  # noqa: E501
        if include_optional:
            return ReminderTemplateBase(
                id = 56,
                etag = '',
                duration = 56,
    ...
    def testReminderTemplateBase(self):
        """Test ReminderTemplateBase"""
