...
from openapi_client.models.bill_theme_show import BillThemeShow  # noqa: E501

class TestBillThemeShow(unittest.TestCase):
    """BillThemeShow unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BillThemeShow:
        """Test BillThemeShow
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BillThemeShow`
        """
        model = BillThemeShow()  # noqa: E501
        if include_optional:
            return BillThemeShow(
                data = None
            )
        else:
            return BillThemeShow(
