...
from openapi_client.models.service_type_show import ServiceTypeShow  # noqa: E501

class TestServiceTypeShow(unittest.TestCase):
    """ServiceTypeShow unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ServiceTypeShow:
        """Test ServiceTypeShow
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ServiceTypeShow`
        """
        model = ServiceTypeShow()  # noqa: E501
        if include_optional:
            return ServiceTypeShow(
                data = None
            )
        else:
            return ServiceTypeShow(
