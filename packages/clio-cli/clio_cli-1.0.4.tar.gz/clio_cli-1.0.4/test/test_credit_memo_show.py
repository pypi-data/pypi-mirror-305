...
from openapi_client.models.credit_memo_show import CreditMemoShow  # noqa: E501

class TestCreditMemoShow(unittest.TestCase):
    """CreditMemoShow unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreditMemoShow:
        """Test CreditMemoShow
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreditMemoShow`
        """
        model = CreditMemoShow()  # noqa: E501
        if include_optional:
            return CreditMemoShow(
                data = None
            )
        else:
            return CreditMemoShow(
