...
from openapi_client.models.billable_matter_show import BillableMatterShow  # noqa: E501

class TestBillableMatterShow(unittest.TestCase):
    """BillableMatterShow unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BillableMatterShow:
        """Test BillableMatterShow
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BillableMatterShow`
        """
        model = BillableMatterShow()  # noqa: E501
        if include_optional:
            return BillableMatterShow(
                data = None
            )
        else:
            return BillableMatterShow(
    ...
    def testBillableMatterShow(self):
        """Test BillableMatterShow"""
