...
from openapi_client.api.calendar_entry_event_types_api import CalendarEntryEventTypesApi  # noqa: E501


class TestCalendarEntryEventTypesApi(unittest.TestCase):
    """CalendarEntryEventTypesApi unit test stubs"""

    def setUp(self) -> None:
        self.api = CalendarEntryEventTypesApi()

    def tearDown(self) -> None:
        pass

    def test_calendar_entry_event_type_create(self) -> None:
    ...
    def test_calendar_entry_event_type_destroy(self) -> None:
    ...
    def test_calendar_entry_event_type_index(self) -> None:
    ...
    def test_calendar_entry_event_type_show(self) -> None:
    ...
    def test_calendar_entry_event_type_update(self) -> None:
