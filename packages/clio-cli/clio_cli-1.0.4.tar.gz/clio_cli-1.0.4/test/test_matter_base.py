...
from openapi_client.models.matter_base import MatterBase  # noqa: E501

class TestMatterBase(unittest.TestCase):
    """MatterBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MatterBase:
        """Test MatterBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MatterBase`
        """
        model = MatterBase()  # noqa: E501
        if include_optional:
            return MatterBase(
                id = 56,
                etag = '',
