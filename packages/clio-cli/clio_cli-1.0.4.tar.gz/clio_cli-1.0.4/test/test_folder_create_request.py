...
from openapi_client.models.folder_create_request import FolderCreateRequest  # noqa: E501

class TestFolderCreateRequest(unittest.TestCase):
    """FolderCreateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FolderCreateRequest:
        """Test FolderCreateRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FolderCreateRequest`
        """
        model = FolderCreateRequest()  # noqa: E501
        if include_optional:
            return FolderCreateRequest(
                data = openapi_client.models.folder_create_request_data.Folder_create_request_data(
    ...
    def testFolderCreateRequest(self):
        """Test FolderCreateRequest"""
