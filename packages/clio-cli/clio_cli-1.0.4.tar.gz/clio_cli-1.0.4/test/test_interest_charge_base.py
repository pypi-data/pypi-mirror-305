...
from openapi_client.models.interest_charge_base import InterestChargeBase  # noqa: E501

class TestInterestChargeBase(unittest.TestCase):
    """InterestChargeBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterestChargeBase:
        """Test InterestChargeBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterestChargeBase`
        """
        model = InterestChargeBase()  # noqa: E501
        if include_optional:
            return InterestChargeBase(
                id = 56,
                etag = '',
    ...
    def testInterestChargeBase(self):
        """Test InterestChargeBase"""
