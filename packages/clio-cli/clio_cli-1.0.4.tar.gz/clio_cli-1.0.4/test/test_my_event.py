...
from openapi_client.models.my_event import MyEvent  # noqa: E501

class TestMyEvent(unittest.TestCase):
    """MyEvent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MyEvent:
        """Test MyEvent
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MyEvent`
        """
        model = MyEvent()  # noqa: E501
        if include_optional:
            return MyEvent(
                event = openapi_client.models.event_base.Event_base(
                    id = 56, 
                    etag = '', 
                    message = '', 
                    icon = '', 
