...
from openapi_client.models.note_base import NoteBase  # noqa: E501
...
class TestNoteBase(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> NoteBase:
        """Test NoteBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NoteBase`
        """
