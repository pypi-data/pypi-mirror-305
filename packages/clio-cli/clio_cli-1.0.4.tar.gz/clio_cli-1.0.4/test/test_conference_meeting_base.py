...
from openapi_client.models.conference_meeting_base import ConferenceMeetingBase  # noqa: E501

class TestConferenceMeetingBase(unittest.TestCase):
    """ConferenceMeetingBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConferenceMeetingBase:
        """Test ConferenceMeetingBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConferenceMeetingBase`
        """
        model = ConferenceMeetingBase()  # noqa: E501
        if include_optional:
            return ConferenceMeetingBase(
                conference_id = 56,
                conference_password = '',
    ...
    def testConferenceMeetingBase(self):
        """Test ConferenceMeetingBase"""
