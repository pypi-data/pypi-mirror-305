...
from openapi_client.models.timer_create_request_data_activity import TimerCreateRequestDataActivity  # noqa: E501

class TestTimerCreateRequestDataActivity(unittest.TestCase):
    """TimerCreateRequestDataActivity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TimerCreateRequestDataActivity:
        """Test TimerCreateRequestDataActivity
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TimerCreateRequestDataActivity`
        """
        model = TimerCreateRequestDataActivity()  # noqa: E501
        if include_optional:
            return TimerCreateRequestDataActivity(
                id = 56
            )
        else:
            return TimerCreateRequestDataActivity(
    ...
    def testTimerCreateRequestDataActivity(self):
        """Test TimerCreateRequestDataActivity"""
