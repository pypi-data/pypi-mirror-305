...
from openapi_client.models.communication_show import CommunicationShow  # noqa: E501

class TestCommunicationShow(unittest.TestCase):
    """CommunicationShow unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CommunicationShow:
        """Test CommunicationShow
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CommunicationShow`
        """
        model = CommunicationShow()  # noqa: E501
        if include_optional:
            return CommunicationShow(
                data = None
            )
        else:
            return CommunicationShow(
    ...
    def testCommunicationShow(self):
        """Test CommunicationShow"""
