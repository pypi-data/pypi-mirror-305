...
from openapi_client.models.document_archive_show import DocumentArchiveShow  # noqa: E501

class TestDocumentArchiveShow(unittest.TestCase):
    """DocumentArchiveShow unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentArchiveShow:
        """Test DocumentArchiveShow
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentArchiveShow`
        """
        model = DocumentArchiveShow()  # noqa: E501
        if include_optional:
            return DocumentArchiveShow(
                data = None
            )
        else:
            return DocumentArchiveShow(
    ...
    def testDocumentArchiveShow(self):
        """Test DocumentArchiveShow"""
