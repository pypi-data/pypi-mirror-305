...
from openapi_client.models.note_create_request_data_notification_event_subscribers_inner import NoteCreateRequestDataNotificationEventSubscribersInner  # noqa: E501

class TestNoteCreateRequestDataNotificationEventSubscribersInner(unittest.TestCase):
    """NoteCreateRequestDataNotificationEventSubscribersInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NoteCreateRequestDataNotificationEventSubscribersInner:
        """Test NoteCreateRequestDataNotificationEventSubscribersInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NoteCreateRequestDataNotificationEventSubscribersInner`
        """
        model = NoteCreateRequestDataNotificationEventSubscribersInner()  # noqa: E501
        if include_optional:
            return NoteCreateRequestDataNotificationEventSubscribersInner(
                user_id = ''
            )
        else:
            return NoteCreateRequestDataNotificationEventSubscribersInner(
    ...
    def testNoteCreateRequestDataNotificationEventSubscribersInner(self):
        """Test NoteCreateRequestDataNotificationEventSubscribersInner"""
