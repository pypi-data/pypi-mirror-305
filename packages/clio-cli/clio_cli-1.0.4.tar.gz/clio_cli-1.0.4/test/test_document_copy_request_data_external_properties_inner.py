...
from openapi_client.models.document_copy_request_data_external_properties_inner import DocumentCopyRequestDataExternalPropertiesInner  # noqa: E501

class TestDocumentCopyRequestDataExternalPropertiesInner(unittest.TestCase):
    """DocumentCopyRequestDataExternalPropertiesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentCopyRequestDataExternalPropertiesInner:
        """Test DocumentCopyRequestDataExternalPropertiesInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentCopyRequestDataExternalPropertiesInner`
        """
        model = DocumentCopyRequestDataExternalPropertiesInner()  # noqa: E501
        if include_optional:
            return DocumentCopyRequestDataExternalPropertiesInner(
                id = 56,
                name = '',
                value = '',
                destroy = True
    ...
    def testDocumentCopyRequestDataExternalPropertiesInner(self):
        """Test DocumentCopyRequestDataExternalPropertiesInner"""
