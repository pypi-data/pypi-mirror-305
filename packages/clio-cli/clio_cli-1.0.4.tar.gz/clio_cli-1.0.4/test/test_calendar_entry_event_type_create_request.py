...
from openapi_client.models.calendar_entry_event_type_create_request import CalendarEntryEventTypeCreateRequest  # noqa: E501

class TestCalendarEntryEventTypeCreateRequest(unittest.TestCase):
    """CalendarEntryEventTypeCreateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CalendarEntryEventTypeCreateRequest:
        """Test CalendarEntryEventTypeCreateRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CalendarEntryEventTypeCreateRequest`
        """
        model = CalendarEntryEventTypeCreateRequest()  # noqa: E501
        if include_optional:
            return CalendarEntryEventTypeCreateRequest(
                data = openapi_client.models.calendar_entry_event_type_create_request_data.CalendarEntryEventType_create_request_data(
                    color = '#367B9C', 
                    name = '', )
            )
        else:
    ...
    def testCalendarEntryEventTypeCreateRequest(self):
        """Test CalendarEntryEventTypeCreateRequest"""
