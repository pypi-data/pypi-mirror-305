...
from openapi_client.models.conversation_membership import ConversationMembership  # noqa: E501

class TestConversationMembership(unittest.TestCase):
    """ConversationMembership unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConversationMembership:
        """Test ConversationMembership
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConversationMembership`
        """
        model = ConversationMembership()  # noqa: E501
        if include_optional:
            return ConversationMembership(
                ...
                member = openapi_client.models.unredacted_participant_base.UnredactedParticipant_base()
            )
        else:
            return ConversationMembership(
        )
    ...
    def testConversationMembership(self):
        """Test ConversationMembership"""
