...
from openapi_client.models.comment_update_request_data_item import CommentUpdateRequestDataItem  # noqa: E501

class TestCommentUpdateRequestDataItem(unittest.TestCase):
    """CommentUpdateRequestDataItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CommentUpdateRequestDataItem:
        """Test CommentUpdateRequestDataItem
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CommentUpdateRequestDataItem`
        """
        model = CommentUpdateRequestDataItem()  # noqa: E501
        if include_optional:
            return CommentUpdateRequestDataItem(
                id = 56
            )
        else:
            return CommentUpdateRequestDataItem(
    ...
    def testCommentUpdateRequestDataItem(self):
        """Test CommentUpdateRequestDataItem"""
