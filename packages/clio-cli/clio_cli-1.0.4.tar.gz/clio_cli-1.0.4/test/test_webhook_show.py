...
from openapi_client.models.webhook_show import WebhookShow  # noqa: E501

class TestWebhookShow(unittest.TestCase):
    """WebhookShow unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookShow:
        """Test WebhookShow
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookShow`
        """
        model = WebhookShow()  # noqa: E501
        if include_optional:
            return WebhookShow(
                data = None
            )
