...
from openapi_client.models.report_create_request_data_matter import ReportCreateRequestDataMatter  # noqa: E501

class TestReportCreateRequestDataMatter(unittest.TestCase):
    """ReportCreateRequestDataMatter unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReportCreateRequestDataMatter:
        """Test ReportCreateRequestDataMatter
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReportCreateRequestDataMatter`
        """
        model = ReportCreateRequestDataMatter()  # noqa: E501
        if include_optional:
            return ReportCreateRequestDataMatter(
                id = 56
            )
        else:
            return ReportCreateRequestDataMatter(
    ...
    def testReportCreateRequestDataMatter(self):
        """Test ReportCreateRequestDataMatter"""
