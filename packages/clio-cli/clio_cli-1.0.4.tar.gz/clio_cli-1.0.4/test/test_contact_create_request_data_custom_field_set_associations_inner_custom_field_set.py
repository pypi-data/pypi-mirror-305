...
from openapi_client.models.contact_create_request_data_custom_field_set_associations_inner_custom_field_set import ContactCreateRequestDataCustomFieldSetAssociationsInnerCustomFieldSet  # noqa: E501

class TestContactCreateRequestDataCustomFieldSetAssociationsInnerCustomFieldSet(unittest.TestCase):
    """ContactCreateRequestDataCustomFieldSetAssociationsInnerCustomFieldSet unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ContactCreateRequestDataCustomFieldSetAssociationsInnerCustomFieldSet:
        """Test ContactCreateRequestDataCustomFieldSetAssociationsInnerCustomFieldSet
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ContactCreateRequestDataCustomFieldSetAssociationsInnerCustomFieldSet`
        """
        model = ContactCreateRequestDataCustomFieldSetAssociationsInnerCustomFieldSet()  # noqa: E501
        if include_optional:
            return ContactCreateRequestDataCustomFieldSetAssociationsInnerCustomFieldSet(
                id = 56
            )
        else:
            return ContactCreateRequestDataCustomFieldSetAssociationsInnerCustomFieldSet(
    ...
    def testContactCreateRequestDataCustomFieldSetAssociationsInnerCustomFieldSet(self):
        """Test ContactCreateRequestDataCustomFieldSetAssociationsInnerCustomFieldSet"""
