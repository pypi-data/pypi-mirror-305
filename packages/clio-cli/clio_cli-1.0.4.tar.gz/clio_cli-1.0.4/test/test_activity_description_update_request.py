...
from openapi_client.models.activity_description_update_request import ActivityDescriptionUpdateRequest  # noqa: E501

class TestActivityDescriptionUpdateRequest(unittest.TestCase):
    """ActivityDescriptionUpdateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ActivityDescriptionUpdateRequest:
        """Test ActivityDescriptionUpdateRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ActivityDescriptionUpdateRequest`
        """
        model = ActivityDescriptionUpdateRequest()  # noqa: E501
        if include_optional:
            return ActivityDescriptionUpdateRequest(
                data = openapi_client.models.activity_description_update_request_data.ActivityDescription_update_request_data(
                    default = True, 
                    groups = [
                        openapi_client.models.activity_description_update_request_data_groups_inner.ActivityDescription_update_request_data_groups_inner(
                            id = 56, 
                            _deleted = True, )
                        ], 
                    name = '', 
                    rate = openapi_client.models.activity_description_create_request_data_rate.ActivityDescription_create_request_data_rate(
                        amount = 1.337, 
    ...
    def testActivityDescriptionUpdateRequest(self):
        """Test ActivityDescriptionUpdateRequest"""
