...
from openapi_client.api.my_events_api import MyEventsApi  # noqa: E501


class TestMyEventsApi(unittest.TestCase):
    """MyEventsApi unit test stubs"""

    def setUp(self) -> None:
        self.api = MyEventsApi()

    def tearDown(self) -> None:
        pass

    def test_my_event_destroy(self) -> None:
    ...
    def test_my_event_index(self) -> None:
    ...
    def test_my_event_update(self) -> None:
