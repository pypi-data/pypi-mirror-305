...
from openapi_client.models.communication_update_request import CommunicationUpdateRequest  # noqa: E501

class TestCommunicationUpdateRequest(unittest.TestCase):
    """CommunicationUpdateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CommunicationUpdateRequest:
        """Test CommunicationUpdateRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CommunicationUpdateRequest`
        """
        model = CommunicationUpdateRequest()  # noqa: E501
        if include_optional:
            return CommunicationUpdateRequest(
                data = openapi_client.models.communication_update_request_data.Communication_update_request_data(
                    body = '', 
                    date = '', 
                    external_properties = [
                        openapi_client.models.communication_update_request_data_external_properties_inner.Communication_update_request_data_external_properties_inner(
                            id = 56, 
                            name = '', 
                            value = '', 
                            _destroy = True, )
                        ], 
                    matter = openapi_client.models.communication_create_request_data_matter.Communication_create_request_data_matter(
                        id = 56, ), 
                    notification_event_subscribers = [
                        openapi_client.models.communication_update_request_data_notification_event_subscribers_inner.Communication_update_request_data_notification_event_subscribers_inner(
                            user_id = '', 
                            id = 56, 
                            _destroy = True, )
                        ], 
                    received_at = '', 
                    receivers = [
                        openapi_client.models.communication_create_request_data_receivers_inner.Communication_create_request_data_receivers_inner(
                            _deleted = True, 
                            id = 56, 
                            type = 'User', )
                        ], 
                    senders = [
                        openapi_client.models.communication_create_request_data_senders_inner.Communication_create_request_data_senders_inner(
                            _deleted = True, 
                            id = 56, 
                            type = 'User', )
                        ], 
    ...
    def testCommunicationUpdateRequest(self):
        """Test CommunicationUpdateRequest"""
