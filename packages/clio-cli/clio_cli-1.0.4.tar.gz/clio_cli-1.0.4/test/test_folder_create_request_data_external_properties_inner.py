...
from openapi_client.models.folder_create_request_data_external_properties_inner import FolderCreateRequestDataExternalPropertiesInner  # noqa: E501

class TestFolderCreateRequestDataExternalPropertiesInner(unittest.TestCase):
    """FolderCreateRequestDataExternalPropertiesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FolderCreateRequestDataExternalPropertiesInner:
        """Test FolderCreateRequestDataExternalPropertiesInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FolderCreateRequestDataExternalPropertiesInner`
        """
        model = FolderCreateRequestDataExternalPropertiesInner()  # noqa: E501
        if include_optional:
            return FolderCreateRequestDataExternalPropertiesInner(
                name = '',
                value = ''
            )
        else:
    ...
    def testFolderCreateRequestDataExternalPropertiesInner(self):
        """Test FolderCreateRequestDataExternalPropertiesInner"""
