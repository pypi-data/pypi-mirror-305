...
from openapi_client.models.matter_create_request_data_group import MatterCreateRequestDataGroup  # noqa: E501

class TestMatterCreateRequestDataGroup(unittest.TestCase):
    """MatterCreateRequestDataGroup unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MatterCreateRequestDataGroup:
        """Test MatterCreateRequestDataGroup
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MatterCreateRequestDataGroup`
        """
        model = MatterCreateRequestDataGroup()  # noqa: E501
        if include_optional:
            return MatterCreateRequestDataGroup(
                id = 56
            )
        else:
            return MatterCreateRequestDataGroup(
    ...
    def testMatterCreateRequestDataGroup(self):
        """Test MatterCreateRequestDataGroup"""
