...
from openapi_client.models.lauk_criminal_controlled_rate_list import LaukCriminalControlledRateList  # noqa: E501

class TestLaukCriminalControlledRateList(unittest.TestCase):
    """LaukCriminalControlledRateList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LaukCriminalControlledRateList:
        """Test LaukCriminalControlledRateList
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LaukCriminalControlledRateList`
        """
        model = LaukCriminalControlledRateList()  # noqa: E501
        if include_optional:
            return LaukCriminalControlledRateList(
                data = [
                    null
                    ]
            )
    ...
    def testLaukCriminalControlledRateList(self):
        """Test LaukCriminalControlledRateList"""
