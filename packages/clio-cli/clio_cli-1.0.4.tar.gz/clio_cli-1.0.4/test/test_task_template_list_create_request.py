...
from openapi_client.models.task_template_list_create_request import TaskTemplateListCreateRequest  # noqa: E501

class TestTaskTemplateListCreateRequest(unittest.TestCase):
    """TaskTemplateListCreateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TaskTemplateListCreateRequest:
        """Test TaskTemplateListCreateRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TaskTemplateListCreateRequest`
        """
        model = TaskTemplateListCreateRequest()  # noqa: E501
        if include_optional:
            return TaskTemplateListCreateRequest(
                data = openapi_client.models.task_template_list_create_request_data.TaskTemplateList_create_request_data(
                    description = '', 
                    name = '', 
                    practice_area = openapi_client.models.task_template_list_create_request_data_practice_area.TaskTemplateList_create_request_data_practice_area(
                        id = 56, ), )
            )
        else:
            return TaskTemplateListCreateRequest(
    ...
    def testTaskTemplateListCreateRequest(self):
        """Test TaskTemplateListCreateRequest"""
