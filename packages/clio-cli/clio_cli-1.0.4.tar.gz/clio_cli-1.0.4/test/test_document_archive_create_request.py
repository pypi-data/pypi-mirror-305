...
from openapi_client.models.document_archive_create_request import DocumentArchiveCreateRequest  # noqa: E501

class TestDocumentArchiveCreateRequest(unittest.TestCase):
    """DocumentArchiveCreateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentArchiveCreateRequest:
        """Test DocumentArchiveCreateRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentArchiveCreateRequest`
        """
        model = DocumentArchiveCreateRequest()  # noqa: E501
        if include_optional:
            return DocumentArchiveCreateRequest(
                data = openapi_client.models.document_archive_create_request_data.DocumentArchive_create_request_data(
                    items = [
                        openapi_client.models.document_archive_create_request_data_items_inner.DocumentArchive_create_request_data_items_inner(
                            id = 56, 
                            type = 56, )
                        ], )
            )
    ...
    def testDocumentArchiveCreateRequest(self):
        """Test DocumentArchiveCreateRequest"""
