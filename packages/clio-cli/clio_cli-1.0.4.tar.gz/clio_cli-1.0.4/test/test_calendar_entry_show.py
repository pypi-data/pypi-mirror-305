...
from openapi_client.models.calendar_entry_show import CalendarEntryShow  # noqa: E501

class TestCalendarEntryShow(unittest.TestCase):
    """CalendarEntryShow unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CalendarEntryShow:
        """Test CalendarEntryShow
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CalendarEntryShow`
        """
        model = CalendarEntryShow()  # noqa: E501
        if include_optional:
            return CalendarEntryShow(
                data = None
            )
        else:
            return CalendarEntryShow(
    ...
    def testCalendarEntryShow(self):
        """Test CalendarEntryShow"""
