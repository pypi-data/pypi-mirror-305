...
from openapi_client.models.reminder_update_request_data import ReminderUpdateRequestData  # noqa: E501

class TestReminderUpdateRequestData(unittest.TestCase):
    """ReminderUpdateRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReminderUpdateRequestData:
        """Test ReminderUpdateRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReminderUpdateRequestData`
        """
        model = ReminderUpdateRequestData()  # noqa: E501
        if include_optional:
            return ReminderUpdateRequestData(
                duration_unit = 'weeks',
                duration_value = 56,
    ...
    def testReminderUpdateRequestData(self):
        """Test ReminderUpdateRequestData"""
