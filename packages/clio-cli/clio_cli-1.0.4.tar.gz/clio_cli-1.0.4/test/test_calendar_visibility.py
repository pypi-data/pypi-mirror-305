...
from openapi_client.models.calendar_visibility import CalendarVisibility  # noqa: E501

class TestCalendarVisibility(unittest.TestCase):
    """CalendarVisibility unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CalendarVisibility:
        """Test CalendarVisibility
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CalendarVisibility`
        """
        model = CalendarVisibility()  # noqa: E501
        if include_optional:
    ...
    def testCalendarVisibility(self):
        """Test CalendarVisibility"""
