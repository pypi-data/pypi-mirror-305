...
from openapi_client.models.billable_client_list import BillableClientList  # noqa: E501

class TestBillableClientList(unittest.TestCase):
    """BillableClientList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BillableClientList:
        """Test BillableClientList
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BillableClientList`
        """
        model = BillableClientList()  # noqa: E501
        if include_optional:
            return BillableClientList(
                data = [
                    null
                    ]
            )
    ...
    def testBillableClientList(self):
        """Test BillableClientList"""
