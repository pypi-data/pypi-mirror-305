...
from openapi_client.models.custom_field_create_request_data import CustomFieldCreateRequestData  # noqa: E501

class TestCustomFieldCreateRequestData(unittest.TestCase):
    """CustomFieldCreateRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CustomFieldCreateRequestData:
        """Test CustomFieldCreateRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CustomFieldCreateRequestData`
        """
        model = CustomFieldCreateRequestData()  # noqa: E501
        if include_optional:
            return CustomFieldCreateRequestData(
                display_order = 56,
                displayed = True,
                field_type = 'checkbox',
                name = '',
    ...
    def testCustomFieldCreateRequestData(self):
        """Test CustomFieldCreateRequestData"""
