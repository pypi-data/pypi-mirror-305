...
from openapi_client.models.related_contacts_list import RelatedContactsList  # noqa: E501

class TestRelatedContactsList(unittest.TestCase):
    """RelatedContactsList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RelatedContactsList:
        """Test RelatedContactsList
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RelatedContactsList`
        """
        model = RelatedContactsList()  # noqa: E501
        if include_optional:
    ...
    def testRelatedContactsList(self):
        """Test RelatedContactsList"""
