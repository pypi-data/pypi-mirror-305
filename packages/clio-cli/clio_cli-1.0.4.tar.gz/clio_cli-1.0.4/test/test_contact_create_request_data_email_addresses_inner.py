...
from openapi_client.models.contact_create_request_data_email_addresses_inner import ContactCreateRequestDataEmailAddressesInner  # noqa: E501

class TestContactCreateRequestDataEmailAddressesInner(unittest.TestCase):
    """ContactCreateRequestDataEmailAddressesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ContactCreateRequestDataEmailAddressesInner:
        """Test ContactCreateRequestDataEmailAddressesInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ContactCreateRequestDataEmailAddressesInner`
        """
        model = ContactCreateRequestDataEmailAddressesInner()  # noqa: E501
        if include_optional:
            return ContactCreateRequestDataEmailAddressesInner(
                name = 'Other',
                address = '',
                default_email = True
            )
    ...
    def testContactCreateRequestDataEmailAddressesInner(self):
        """Test ContactCreateRequestDataEmailAddressesInner"""
