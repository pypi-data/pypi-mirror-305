...
from openapi_client.models.multipart_base import MultipartBase  # noqa: E501

class TestMultipartBase(unittest.TestCase):
    """MultipartBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MultipartBase:
        """Test MultipartBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MultipartBase`
        """
        model = MultipartBase()  # noqa: E501
        if include_optional:
            return MultipartBase(
                part_number = 56,
                put_url = ''
            )
        else:
