...
from openapi_client.models.report_preset_create_request import ReportPresetCreateRequest  # noqa: E501

class TestReportPresetCreateRequest(unittest.TestCase):
    """ReportPresetCreateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReportPresetCreateRequest:
        """Test ReportPresetCreateRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReportPresetCreateRequest`
        """
        model = ReportPresetCreateRequest()  # noqa: E501
        if include_optional:
            return ReportPresetCreateRequest(
                data = openapi_client.models.report_preset_create_request_data.ReportPreset_create_request_data(
                    format = 'csv', 
    ...
    def testReportPresetCreateRequest(self):
        """Test ReportPresetCreateRequest"""
