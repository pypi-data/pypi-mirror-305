...
from openapi_client.models.relationship_show import RelationshipShow  # noqa: E501

class TestRelationshipShow(unittest.TestCase):
    """RelationshipShow unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RelationshipShow:
        """Test RelationshipShow
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RelationshipShow`
        """
        model = RelationshipShow()  # noqa: E501
        if include_optional:
