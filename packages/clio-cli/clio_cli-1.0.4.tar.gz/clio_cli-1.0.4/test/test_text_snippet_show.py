...
from openapi_client.models.text_snippet_show import TextSnippetShow  # noqa: E501

class TestTextSnippetShow(unittest.TestCase):
    """TextSnippetShow unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TextSnippetShow:
        """Test TextSnippetShow
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TextSnippetShow`
        """
        model = TextSnippetShow()  # noqa: E501
        if include_optional:
            return TextSnippetShow(
                data = None
            )
        else:
            return TextSnippetShow(
