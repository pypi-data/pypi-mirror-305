...
from openapi_client.models.lauk_expense_category_list import LaukExpenseCategoryList  # noqa: E501

class TestLaukExpenseCategoryList(unittest.TestCase):
    """LaukExpenseCategoryList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LaukExpenseCategoryList:
        """Test LaukExpenseCategoryList
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LaukExpenseCategoryList`
        """
        model = LaukExpenseCategoryList()  # noqa: E501
        if include_optional:
            return LaukExpenseCategoryList(
                data = [
                    null
                    ]
            )
    ...
    def testLaukExpenseCategoryList(self):
        """Test LaukExpenseCategoryList"""
