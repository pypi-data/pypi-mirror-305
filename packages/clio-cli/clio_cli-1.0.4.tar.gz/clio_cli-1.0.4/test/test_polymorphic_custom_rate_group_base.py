...
from openapi_client.models.polymorphic_custom_rate_group_base import PolymorphicCustomRateGroupBase  # noqa: E501

class TestPolymorphicCustomRateGroupBase(unittest.TestCase):
    """PolymorphicCustomRateGroupBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolymorphicCustomRateGroupBase:
        """Test PolymorphicCustomRateGroupBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolymorphicCustomRateGroupBase`
        """
        model = PolymorphicCustomRateGroupBase()  # noqa: E501
        if include_optional:
            return PolymorphicCustomRateGroupBase(
                etag = '',
                id = 56,
                name = ''
            )
    ...
    def testPolymorphicCustomRateGroupBase(self):
        """Test PolymorphicCustomRateGroupBase"""
