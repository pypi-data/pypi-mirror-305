...
from openapi_client.models.folder_update_request import FolderUpdateRequest  # noqa: E501
...
class TestFolderUpdateRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> FolderUpdateRequest:
        """Test FolderUpdateRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FolderUpdateRequest`
        """
        model = FolderUpdateRequest()  # noqa: E501
        if include_optional:
            return FolderUpdateRequest(
                data = openapi_client.models.folder_update_request_data.Folder_update_request_data(
