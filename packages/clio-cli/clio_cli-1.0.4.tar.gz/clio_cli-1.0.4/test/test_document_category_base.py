...
from openapi_client.models.document_category_base import DocumentCategoryBase  # noqa: E501

class TestDocumentCategoryBase(unittest.TestCase):
    """DocumentCategoryBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentCategoryBase:
        """Test DocumentCategoryBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentCategoryBase`
        """
        model = DocumentCategoryBase()  # noqa: E501
        if include_optional:
            return DocumentCategoryBase(
                id = 56,
                etag = '',
                name = '',
    ...
    def testDocumentCategoryBase(self):
        """Test DocumentCategoryBase"""
