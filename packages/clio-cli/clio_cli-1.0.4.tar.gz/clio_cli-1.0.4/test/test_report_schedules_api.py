...
from openapi_client.api.report_schedules_api import ReportSchedulesApi  # noqa: E501


class TestReportSchedulesApi(unittest.TestCase):
    """ReportSchedulesApi unit test stubs"""

    def setUp(self) -> None:
        self.api = ReportSchedulesApi()

    def tearDown(self) -> None:
        pass

    def test_report_schedule_create(self) -> None:
    ...
    def test_report_schedule_destroy(self) -> None:
    ...
    def test_report_schedule_index(self) -> None:
    ...
    def test_report_schedule_show(self) -> None:
    ...
    def test_report_schedule_update(self) -> None:
