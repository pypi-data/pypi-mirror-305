...
from openapi_client.models.trust_request import TrustRequest  # noqa: E501

class TestTrustRequest(unittest.TestCase):
    """TrustRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TrustRequest:
        """Test TrustRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TrustRequest`
        """
        model = TrustRequest()  # noqa: E501
        if include_optional:
            return TrustRequest(
                id = 56,
                etag = '',
