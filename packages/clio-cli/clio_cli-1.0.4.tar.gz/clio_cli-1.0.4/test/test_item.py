    ...
    def make_instance(self, include_optional) -> Item:
        ...
        if include_optional:
            return Item(
                ...
                locked = True,
                name = '',
                parent = openapi_client.models.linked_folder_base.LinkedFolder_base(
                    id = 56, 
                    etag = '', 
                    created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                ...
                contact = openapi_client.models.contact_base.Contact_base(
                    ...
                    sales_tax_number = '', ),
                document_category = openapi_client.models.document_category_base.DocumentCategory_base(
                    id = 56, 
                    etag = '', 
                    name = '', 
                    created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), ),
                creator = openapi_client.models.clio_creator_base.ClioCreator_base(
                    account_owner = True, 
                    clio_connect = True, 
                    ...
                    created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), ),
                latest_document_version = openapi_client.models.document_version_base.DocumentVersion_base(
                    id = 56, 
                    document_id = 56, 
                    etag = '', 
                    uuid = '', 
