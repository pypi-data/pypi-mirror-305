...
from openapi_client.models.task_template_list_instace_base import TaskTemplateListInstaceBase  # noqa: E501

class TestTaskTemplateListInstaceBase(unittest.TestCase):
    """TaskTemplateListInstaceBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TaskTemplateListInstaceBase:
        """Test TaskTemplateListInstaceBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TaskTemplateListInstaceBase`
        """
        model = TaskTemplateListInstaceBase()  # noqa: E501
        if include_optional:
            return TaskTemplateListInstaceBase(
                id = 56,
                etag = '',
    ...
    def testTaskTemplateListInstaceBase(self):
        """Test TaskTemplateListInstaceBase"""
