...
from openapi_client.models.document_automation import DocumentAutomation  # noqa: E501
    ...
    def make_instance(self, include_optional) -> DocumentAutomation:
        ...
        if include_optional:
            return DocumentAutomation(
                ...
                document_template = openapi_client.models.document_template_base.DocumentTemplate_base(
                    id = 56, 
                    etag = '', 
                    size = 56, 
                    content_type = '', 
                    ...
                    updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), ),
                documents = [
                    openapi_client.models.document_base.Document_base(
                        id = 56, 
                        etag = '', 
                        created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
