...
from openapi_client.models.bank_account_create_request_data import BankAccountCreateRequestData  # noqa: E501

class TestBankAccountCreateRequestData(unittest.TestCase):
    """BankAccountCreateRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BankAccountCreateRequestData:
        """Test BankAccountCreateRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BankAccountCreateRequestData`
        """
        model = BankAccountCreateRequestData()  # noqa: E501
        if include_optional:
            return BankAccountCreateRequestData(
                account_number = '',
                balance = 1.337,
    ...
    def testBankAccountCreateRequestData(self):
        """Test BankAccountCreateRequestData"""
