...
from openapi_client.models.document_automation_list import DocumentAutomationList  # noqa: E501

class TestDocumentAutomationList(unittest.TestCase):
    """DocumentAutomationList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentAutomationList:
        """Test DocumentAutomationList
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentAutomationList`
        """
        model = DocumentAutomationList()  # noqa: E501
        if include_optional:
            return DocumentAutomationList(
                data = [
                    null
                    ]
            )
    ...
    def testDocumentAutomationList(self):
        """Test DocumentAutomationList"""
