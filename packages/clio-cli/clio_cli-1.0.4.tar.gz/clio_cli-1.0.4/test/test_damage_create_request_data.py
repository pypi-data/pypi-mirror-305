...
from openapi_client.models.damage_create_request_data import DamageCreateRequestData  # noqa: E501

class TestDamageCreateRequestData(unittest.TestCase):
    """DamageCreateRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DamageCreateRequestData:
        """Test DamageCreateRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DamageCreateRequestData`
        """
        model = DamageCreateRequestData()  # noqa: E501
        if include_optional:
            return DamageCreateRequestData(
                amount = 1.337,
                damage_type = 'special',
                description = '',
                matter_id = 56
    ...
    def testDamageCreateRequestData(self):
        """Test DamageCreateRequestData"""
