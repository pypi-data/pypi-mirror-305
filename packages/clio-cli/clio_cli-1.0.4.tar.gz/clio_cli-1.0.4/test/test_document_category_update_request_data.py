...
from openapi_client.models.document_category_update_request_data import DocumentCategoryUpdateRequestData  # noqa: E501

class TestDocumentCategoryUpdateRequestData(unittest.TestCase):
    """DocumentCategoryUpdateRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentCategoryUpdateRequestData:
        """Test DocumentCategoryUpdateRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentCategoryUpdateRequestData`
        """
        model = DocumentCategoryUpdateRequestData()  # noqa: E501
        if include_optional:
            return DocumentCategoryUpdateRequestData(
                name = ''
            )
        else:
            return DocumentCategoryUpdateRequestData(
    ...
    def testDocumentCategoryUpdateRequestData(self):
        """Test DocumentCategoryUpdateRequestData"""
