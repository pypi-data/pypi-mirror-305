    ...
    def make_instance(self, include_optional) -> Bill:
        ...
        if include_optional:
            return Bill(
                ...
                interest = openapi_client.models.interest_base.Interest_base(
                    balance = 1.337, 
                    period = 56, 
                    rate = 1.337, 
                    total = 1.337, 
                ...
                group = openapi_client.models.group_base.Group_base(
                    ...
                    type = 'UserGroup', 
                    updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), ),
                bill_theme = openapi_client.models.bill_theme_base.BillTheme_base(
                    id = 56, 
                    etag = '', 
                    created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    ...
                    name = '', 
                    config = '', ),
                original_bill = openapi_client.models.bill_base.Bill_base(
                    id = 56, 
                    etag = '', 
                    number = '', 
                    issued_at = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(), 
                ...
                destination_account = openapi_client.models.bank_account_base.BankAccount_base(
                    ...
                    updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), ),
                balances = [
                    openapi_client.models.balance_base.Balance_base(
                        id = 56, 
                        amount = 1.337, 
                        type = 'Matter', 
                ...
                matter_totals = [
                    openapi_client.models.matter_balance_base.MatterBalance_base(
                        id = 56, 
                        amount = 1.337, )
                    ],
                currency = openapi_client.models.currency_base.Currency_base(
                    ...
                    created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), ),
                billing_setting = openapi_client.models.billing_setting_base.BillingSetting_base(
                    id = 56, 
                    etag = '', 
                ...
                legal_aid_uk_bill = openapi_client.models.legal_aid_uk_bill_base.LegalAidUkBill_base(
