...
from openapi_client.models.task_create_request_data_matter import TaskCreateRequestDataMatter  # noqa: E501

class TestTaskCreateRequestDataMatter(unittest.TestCase):
    """TaskCreateRequestDataMatter unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TaskCreateRequestDataMatter:
        """Test TaskCreateRequestDataMatter
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TaskCreateRequestDataMatter`
        """
        model = TaskCreateRequestDataMatter()  # noqa: E501
        if include_optional:
            return TaskCreateRequestDataMatter(
                id = 56
            )
        else:
            return TaskCreateRequestDataMatter(
    ...
    def testTaskCreateRequestDataMatter(self):
        """Test TaskCreateRequestDataMatter"""
