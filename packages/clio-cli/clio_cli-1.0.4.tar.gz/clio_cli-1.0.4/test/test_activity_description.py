...
from openapi_client.models.activity_description import ActivityDescription  # noqa: E501

class TestActivityDescription(unittest.TestCase):
    """ActivityDescription unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ActivityDescription:
        """Test ActivityDescription
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ActivityDescription`
        """
        model = ActivityDescription()  # noqa: E501
        if include_optional:
            return ActivityDescription(
                ...
                category_type = '',
                groups = [
                    openapi_client.models.group_base.Group_base(
                ...
                rate = openapi_client.models.activity_description_rate_base.ActivityDescriptionRate_base(
                    amount = 1.337, 
                    non_billable_amount = 1.337, 
                    type = 'User', 
                    hierarchy = 'Default', ),
                utbms_task = openapi_client.models.utbms_code_base.UtbmsCode_base(
                    id = 56, 
                    etag = '', 
                    name = '', 
                    code = '', 
                    ...
                    created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), ),
                utbms_activity = openapi_client.models.utbms_code_base.UtbmsCode_base(
                    id = 56, 
                    etag = '', 
                    name = '', 
                    code = '', 
    ...
    def testActivityDescription(self):
        """Test ActivityDescription"""
