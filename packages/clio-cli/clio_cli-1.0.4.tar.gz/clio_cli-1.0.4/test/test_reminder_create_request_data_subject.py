...
from openapi_client.models.reminder_create_request_data_subject import ReminderCreateRequestDataSubject  # noqa: E501

class TestReminderCreateRequestDataSubject(unittest.TestCase):
    """ReminderCreateRequestDataSubject unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReminderCreateRequestDataSubject:
        """Test ReminderCreateRequestDataSubject
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReminderCreateRequestDataSubject`
        """
        model = ReminderCreateRequestDataSubject()  # noqa: E501
        if include_optional:
            return ReminderCreateRequestDataSubject(
                id = 56,
                type = 'CalendarEntry'
            )
        else:
    ...
    def testReminderCreateRequestDataSubject(self):
        """Test ReminderCreateRequestDataSubject"""
