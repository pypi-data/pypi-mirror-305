...
from openapi_client.models.custom_field_set import CustomFieldSet  # noqa: E501
...
class TestCustomFieldSet(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CustomFieldSet:
        """Test CustomFieldSet
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CustomFieldSet`
        """
        model = CustomFieldSet()  # noqa: E501
        if include_optional:
            return CustomFieldSet(
                ...
                custom_fields = [
                    openapi_client.models.custom_field_base.CustomField_base(
                        id = 56, 
                        etag = '', 
                        created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
