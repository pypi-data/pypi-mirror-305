...
from openapi_client.models.clio_payments_link_create_request_data import ClioPaymentsLinkCreateRequestData  # noqa: E501

class TestClioPaymentsLinkCreateRequestData(unittest.TestCase):
    """ClioPaymentsLinkCreateRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ClioPaymentsLinkCreateRequestData:
        """Test ClioPaymentsLinkCreateRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ClioPaymentsLinkCreateRequestData`
        """
        model = ClioPaymentsLinkCreateRequestData()  # noqa: E501
        if include_optional:
            return ClioPaymentsLinkCreateRequestData(
                amount = 1.337,
                currency = '',
                description = '',
    ...
    def testClioPaymentsLinkCreateRequestData(self):
        """Test ClioPaymentsLinkCreateRequestData"""
