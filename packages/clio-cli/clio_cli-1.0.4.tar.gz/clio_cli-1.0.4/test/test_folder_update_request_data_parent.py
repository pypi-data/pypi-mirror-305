...
from openapi_client.models.folder_update_request_data_parent import FolderUpdateRequestDataParent  # noqa: E501

class TestFolderUpdateRequestDataParent(unittest.TestCase):
    """FolderUpdateRequestDataParent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FolderUpdateRequestDataParent:
        """Test FolderUpdateRequestDataParent
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FolderUpdateRequestDataParent`
        """
        model = FolderUpdateRequestDataParent()  # noqa: E501
        if include_optional:
            return FolderUpdateRequestDataParent(
                id = 56,
                type = 'Folder'
            )
        else:
    ...
    def testFolderUpdateRequestDataParent(self):
        """Test FolderUpdateRequestDataParent"""
