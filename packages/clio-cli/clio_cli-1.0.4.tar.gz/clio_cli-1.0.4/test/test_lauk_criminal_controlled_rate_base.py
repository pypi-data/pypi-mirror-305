...
from openapi_client.models.lauk_criminal_controlled_rate_base import LaukCriminalControlledRateBase  # noqa: E501

class TestLaukCriminalControlledRateBase(unittest.TestCase):
    """LaukCriminalControlledRateBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LaukCriminalControlledRateBase:
        """Test LaukCriminalControlledRateBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LaukCriminalControlledRateBase`
        """
        model = LaukCriminalControlledRateBase()  # noqa: E501
        if include_optional:
            return LaukCriminalControlledRateBase(
                id = 56,
                activity = '',
                activity_type = '',
                category_of_law = '',
                ...
                fee = 1.337,
                fee_scheme = '',
                post_sept_22_exceptional = 1.337,
                post_sept_22_fee = 1.337,
                key = '',
                rate_type = '',
                region = '',
                solicitor_type = '',
    ...
    def testLaukCriminalControlledRateBase(self):
        """Test LaukCriminalControlledRateBase"""
