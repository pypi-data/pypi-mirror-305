...
from openapi_client.models.bill_theme_update_request_data import BillThemeUpdateRequestData  # noqa: E501

class TestBillThemeUpdateRequestData(unittest.TestCase):
    """BillThemeUpdateRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BillThemeUpdateRequestData:
        """Test BillThemeUpdateRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BillThemeUpdateRequestData`
        """
        model = BillThemeUpdateRequestData()  # noqa: E501
        if include_optional:
            return BillThemeUpdateRequestData(
                config = '',
                name = ''
            )
        else:
    ...
    def testBillThemeUpdateRequestData(self):
        """Test BillThemeUpdateRequestData"""
