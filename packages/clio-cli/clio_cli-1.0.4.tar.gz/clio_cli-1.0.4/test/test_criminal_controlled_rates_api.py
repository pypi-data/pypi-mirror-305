...
from openapi_client.api.criminal_controlled_rates_api import CriminalControlledRatesApi  # noqa: E501


class TestCriminalControlledRatesApi(unittest.TestCase):
    """CriminalControlledRatesApi unit test stubs"""

    def setUp(self) -> None:
        self.api = CriminalControlledRatesApi()

    def tearDown(self) -> None:
        pass

    def test_lauk_criminal_controlled_rate_index(self) -> None:
