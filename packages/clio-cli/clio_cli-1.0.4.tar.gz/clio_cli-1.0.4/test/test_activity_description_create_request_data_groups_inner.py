...
from openapi_client.models.activity_description_create_request_data_groups_inner import ActivityDescriptionCreateRequestDataGroupsInner  # noqa: E501

class TestActivityDescriptionCreateRequestDataGroupsInner(unittest.TestCase):
    """ActivityDescriptionCreateRequestDataGroupsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ActivityDescriptionCreateRequestDataGroupsInner:
        """Test ActivityDescriptionCreateRequestDataGroupsInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ActivityDescriptionCreateRequestDataGroupsInner`
        """
        model = ActivityDescriptionCreateRequestDataGroupsInner()  # noqa: E501
        if include_optional:
            return ActivityDescriptionCreateRequestDataGroupsInner(
                id = 56
            )
        else:
            return ActivityDescriptionCreateRequestDataGroupsInner(
    ...
    def testActivityDescriptionCreateRequestDataGroupsInner(self):
        """Test ActivityDescriptionCreateRequestDataGroupsInner"""
