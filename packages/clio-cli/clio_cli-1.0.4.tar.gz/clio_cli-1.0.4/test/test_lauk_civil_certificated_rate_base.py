...
from openapi_client.models.lauk_civil_certificated_rate_base import LaukCivilCertificatedRateBase  # noqa: E501

class TestLaukCivilCertificatedRateBase(unittest.TestCase):
    """LaukCivilCertificatedRateBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LaukCivilCertificatedRateBase:
        """Test LaukCivilCertificatedRateBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LaukCivilCertificatedRateBase`
        """
        model = LaukCivilCertificatedRateBase()  # noqa: E501
        if include_optional:
            return LaukCivilCertificatedRateBase(
                id = 56,
                activity = '',
    ...
    def testLaukCivilCertificatedRateBase(self):
        """Test LaukCivilCertificatedRateBase"""
