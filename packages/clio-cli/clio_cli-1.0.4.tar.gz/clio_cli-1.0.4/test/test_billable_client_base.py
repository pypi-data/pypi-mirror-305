...
from openapi_client.models.billable_client_base import BillableClientBase  # noqa: E501

class TestBillableClientBase(unittest.TestCase):
    """BillableClientBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BillableClientBase:
        """Test BillableClientBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BillableClientBase`
        """
        model = BillableClientBase()  # noqa: E501
        if include_optional:
            return BillableClientBase(
                id = 56,
    ...
    def testBillableClientBase(self):
        """Test BillableClientBase"""
