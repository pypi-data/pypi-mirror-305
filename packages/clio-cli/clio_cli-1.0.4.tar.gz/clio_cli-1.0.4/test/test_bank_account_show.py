...
from openapi_client.models.bank_account_show import BankAccountShow  # noqa: E501

class TestBankAccountShow(unittest.TestCase):
    """BankAccountShow unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BankAccountShow:
        """Test BankAccountShow
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BankAccountShow`
        """
        model = BankAccountShow()  # noqa: E501
        if include_optional:
