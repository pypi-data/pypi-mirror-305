...
from openapi_client.models.document_template_create_request import DocumentTemplateCreateRequest  # noqa: E501

class TestDocumentTemplateCreateRequest(unittest.TestCase):
    """DocumentTemplateCreateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentTemplateCreateRequest:
        """Test DocumentTemplateCreateRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentTemplateCreateRequest`
        """
        model = DocumentTemplateCreateRequest()  # noqa: E501
        if include_optional:
            return DocumentTemplateCreateRequest(
                data = openapi_client.models.document_template_create_request_data.DocumentTemplate_create_request_data(
                    document_category = openapi_client.models.document_template_create_request_data_document_category.DocumentTemplate_create_request_data_document_category(
                        id = 56, ), 
                    file = '', 
                    filename = '', )
            )
    ...
    def testDocumentTemplateCreateRequest(self):
        """Test DocumentTemplateCreateRequest"""
