...
from openapi_client.models.activity_update_request import ActivityUpdateRequest  # noqa: E501
...
class TestActivityUpdateRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ActivityUpdateRequest:
        """Test ActivityUpdateRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ActivityUpdateRequest`
        """
        model = ActivityUpdateRequest()  # noqa: E501
        if include_optional:
            return ActivityUpdateRequest(
                data = openapi_client.models.activity_update_request_data.Activity_update_request_data(
