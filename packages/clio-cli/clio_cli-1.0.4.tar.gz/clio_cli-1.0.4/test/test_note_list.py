...
from openapi_client.models.note_list import NoteList  # noqa: E501
...
class TestNoteList(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> NoteList:
        """Test NoteList
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NoteList`
        """
        model = NoteList()  # noqa: E501
        if include_optional:
            return NoteList(
                data = [
                    null
