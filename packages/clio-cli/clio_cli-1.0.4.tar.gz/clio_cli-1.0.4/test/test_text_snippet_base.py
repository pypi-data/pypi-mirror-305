...
from openapi_client.models.text_snippet_base import TextSnippetBase  # noqa: E501

class TestTextSnippetBase(unittest.TestCase):
    """TextSnippetBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TextSnippetBase:
        """Test TextSnippetBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TextSnippetBase`
        """
        model = TextSnippetBase()  # noqa: E501
        if include_optional:
            return TextSnippetBase(
                id = 56,
                etag = '',
