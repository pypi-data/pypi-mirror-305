...
from openapi_client.models.phone_number_base import PhoneNumberBase  # noqa: E501

class TestPhoneNumberBase(unittest.TestCase):
    """PhoneNumberBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PhoneNumberBase:
        """Test PhoneNumberBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PhoneNumberBase`
        """
        model = PhoneNumberBase()  # noqa: E501
        if include_optional:
