...
from openapi_client.models.activity_create_request_data_text_message_conversation import ActivityCreateRequestDataTextMessageConversation  # noqa: E501

class TestActivityCreateRequestDataTextMessageConversation(unittest.TestCase):
    """ActivityCreateRequestDataTextMessageConversation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ActivityCreateRequestDataTextMessageConversation:
        """Test ActivityCreateRequestDataTextMessageConversation
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ActivityCreateRequestDataTextMessageConversation`
        """
        model = ActivityCreateRequestDataTextMessageConversation()  # noqa: E501
        if include_optional:
            return ActivityCreateRequestDataTextMessageConversation(
                id = 56
            )
        else:
            return ActivityCreateRequestDataTextMessageConversation(
    ...
    def testActivityCreateRequestDataTextMessageConversation(self):
        """Test ActivityCreateRequestDataTextMessageConversation"""
