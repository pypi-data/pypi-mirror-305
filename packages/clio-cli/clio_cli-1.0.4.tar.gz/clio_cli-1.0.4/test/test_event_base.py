...
from openapi_client.models.event_base import EventBase  # noqa: E501
...
class TestEventBase(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> EventBase:
        """Test EventBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EventBase`
        """
