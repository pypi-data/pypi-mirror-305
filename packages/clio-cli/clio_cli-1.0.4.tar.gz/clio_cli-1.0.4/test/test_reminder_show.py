...
from openapi_client.models.reminder_show import ReminderShow  # noqa: E501

class TestReminderShow(unittest.TestCase):
    """ReminderShow unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReminderShow:
        """Test ReminderShow
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReminderShow`
        """
        model = ReminderShow()  # noqa: E501
        if include_optional:
            return ReminderShow(
                data = None
            )
