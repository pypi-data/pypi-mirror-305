...
from openapi_client.models.matter_contacts import MatterContacts  # noqa: E501

class TestMatterContacts(unittest.TestCase):
    """MatterContacts unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MatterContacts:
        """Test MatterContacts
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MatterContacts`
        """
        model = MatterContacts()  # noqa: E501
        if include_optional:
            return MatterContacts(
                contact_created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'),
                contact_updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'),
                ...
                secondary_address = openapi_client.models.address_base.Address_base(
                    ...
                    updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    primary = True, ),
                secondary_web_site = openapi_client.models.web_site_base.WebSite_base(
                    id = 56, 
                    etag = '', 
                    address = '', 
                    name = 'Work', 
                ...
                custom_field_values = [
                    openapi_client.models.custom_field_value_base.CustomFieldValue_base(
                        id = '', 
                        etag = '', 
                        field_name = '', 
                        created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                ...
                relationship = openapi_client.models.relationship_base.Relationship_base(
                    id = 56, 
                    etag = '', 
                    description = '', 
                    created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
