...
from openapi_client.models.matter_create_request_data_custom_rate_rates_inner_activity_description import MatterCreateRequestDataCustomRateRatesInnerActivityDescription  # noqa: E501

class TestMatterCreateRequestDataCustomRateRatesInnerActivityDescription(unittest.TestCase):
    """MatterCreateRequestDataCustomRateRatesInnerActivityDescription unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MatterCreateRequestDataCustomRateRatesInnerActivityDescription:
        """Test MatterCreateRequestDataCustomRateRatesInnerActivityDescription
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MatterCreateRequestDataCustomRateRatesInnerActivityDescription`
        """
        model = MatterCreateRequestDataCustomRateRatesInnerActivityDescription()  # noqa: E501
        if include_optional:
            return MatterCreateRequestDataCustomRateRatesInnerActivityDescription(
                id = 56
            )
        else:
            return MatterCreateRequestDataCustomRateRatesInnerActivityDescription(
    ...
    def testMatterCreateRequestDataCustomRateRatesInnerActivityDescription(self):
        """Test MatterCreateRequestDataCustomRateRatesInnerActivityDescription"""
