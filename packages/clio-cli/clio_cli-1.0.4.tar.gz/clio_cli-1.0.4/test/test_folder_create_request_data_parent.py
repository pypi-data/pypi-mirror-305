...
from openapi_client.models.folder_create_request_data_parent import FolderCreateRequestDataParent  # noqa: E501

class TestFolderCreateRequestDataParent(unittest.TestCase):
    """FolderCreateRequestDataParent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FolderCreateRequestDataParent:
        """Test FolderCreateRequestDataParent
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FolderCreateRequestDataParent`
        """
        model = FolderCreateRequestDataParent()  # noqa: E501
        if include_optional:
            return FolderCreateRequestDataParent(
                id = 56,
                type = 'Folder'
            )
        else:
    ...
    def testFolderCreateRequestDataParent(self):
        """Test FolderCreateRequestDataParent"""
