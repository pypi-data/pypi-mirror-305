...
from openapi_client.api.outstanding_client_balances_api import OutstandingClientBalancesApi  # noqa: E501


class TestOutstandingClientBalancesApi(unittest.TestCase):
    """OutstandingClientBalancesApi unit test stubs"""

    def setUp(self) -> None:
        self.api = OutstandingClientBalancesApi()

    def tearDown(self) -> None:
        pass

    def test_outstanding_client_balance_index(self) -> None:
