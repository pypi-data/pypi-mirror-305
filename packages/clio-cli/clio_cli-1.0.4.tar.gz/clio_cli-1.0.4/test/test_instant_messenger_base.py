...
from openapi_client.models.instant_messenger_base import InstantMessengerBase  # noqa: E501

class TestInstantMessengerBase(unittest.TestCase):
    """InstantMessengerBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InstantMessengerBase:
        """Test InstantMessengerBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InstantMessengerBase`
        """
        model = InstantMessengerBase()  # noqa: E501
        if include_optional:
            return InstantMessengerBase(
                id = 56,
                etag = '',
                address = '',
                name = 'Work',
    ...
    def testInstantMessengerBase(self):
        """Test InstantMessengerBase"""
