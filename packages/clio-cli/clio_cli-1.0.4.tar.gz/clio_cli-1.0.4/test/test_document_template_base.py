...
from openapi_client.models.document_template_base import DocumentTemplateBase  # noqa: E501

class TestDocumentTemplateBase(unittest.TestCase):
    """DocumentTemplateBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentTemplateBase:
        """Test DocumentTemplateBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentTemplateBase`
        """
        model = DocumentTemplateBase()  # noqa: E501
        if include_optional:
            return DocumentTemplateBase(
                id = 56,
                etag = '',
                size = 56,
                content_type = '',
    ...
    def testDocumentTemplateBase(self):
        """Test DocumentTemplateBase"""
