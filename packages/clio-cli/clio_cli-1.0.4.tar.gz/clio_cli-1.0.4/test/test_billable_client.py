...
from openapi_client.models.billable_client import BillableClient  # noqa: E501

class TestBillableClient(unittest.TestCase):
    """BillableClient unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BillableClient:
        """Test BillableClient
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BillableClient`
        """
        model = BillableClient()  # noqa: E501
        if include_optional:
            return BillableClient(
                id = 56,
                unbilled_hours = 1.337,
                unbilled_amount = 1.337,
                amount_in_trust = 1.337,
                name = '',
                billable_matters_count = 56,
                billable_matters = [
                    openapi_client.models.billable_matter_base.BillableMatter_base(
                        id = 56, 
                        unbilled_hours = 1.337, 
                        unbilled_amount = 1.337, 
                        amount_in_trust = 1.337, 
