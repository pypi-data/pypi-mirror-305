...
from openapi_client.models.calendar_create_request import CalendarCreateRequest  # noqa: E501
...
class TestCalendarCreateRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CalendarCreateRequest:
        ...
        """
        model = CalendarCreateRequest()  # noqa: E501
        if include_optional:
            return CalendarCreateRequest(
                data = openapi_client.models.calendar_create_request_data.Calendar_create_request_data(
                    color = '#367B9C', 
                    name = '', 
                    source = 'web', 
                    visible = True, )
