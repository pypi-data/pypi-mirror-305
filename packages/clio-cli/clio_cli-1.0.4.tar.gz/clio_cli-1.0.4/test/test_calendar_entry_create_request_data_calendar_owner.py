...
from openapi_client.models.calendar_entry_create_request_data_calendar_owner import CalendarEntryCreateRequestDataCalendarOwner  # noqa: E501

class TestCalendarEntryCreateRequestDataCalendarOwner(unittest.TestCase):
    """CalendarEntryCreateRequestDataCalendarOwner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CalendarEntryCreateRequestDataCalendarOwner:
        """Test CalendarEntryCreateRequestDataCalendarOwner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CalendarEntryCreateRequestDataCalendarOwner`
        """
        model = CalendarEntryCreateRequestDataCalendarOwner()  # noqa: E501
        if include_optional:
            return CalendarEntryCreateRequestDataCalendarOwner(
                id = 56
            )
        else:
            return CalendarEntryCreateRequestDataCalendarOwner(
    ...
    def testCalendarEntryCreateRequestDataCalendarOwner(self):
        """Test CalendarEntryCreateRequestDataCalendarOwner"""
