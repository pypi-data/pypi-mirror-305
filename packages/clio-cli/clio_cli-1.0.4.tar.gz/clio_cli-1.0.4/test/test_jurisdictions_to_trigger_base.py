...
from openapi_client.models.jurisdictions_to_trigger_base import JurisdictionsToTriggerBase  # noqa: E501

class TestJurisdictionsToTriggerBase(unittest.TestCase):
    """JurisdictionsToTriggerBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> JurisdictionsToTriggerBase:
        """Test JurisdictionsToTriggerBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `JurisdictionsToTriggerBase`
        """
        model = JurisdictionsToTriggerBase()  # noqa: E501
        if include_optional:
            return JurisdictionsToTriggerBase(
                id = 56,
                etag = '',
                system_id = 56,
                description = '',
    ...
    def testJurisdictionsToTriggerBase(self):
        """Test JurisdictionsToTriggerBase"""
