...
from openapi_client.models.report_create_request_data_originating_attorney import ReportCreateRequestDataOriginatingAttorney  # noqa: E501

class TestReportCreateRequestDataOriginatingAttorney(unittest.TestCase):
    """ReportCreateRequestDataOriginatingAttorney unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReportCreateRequestDataOriginatingAttorney:
        """Test ReportCreateRequestDataOriginatingAttorney
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReportCreateRequestDataOriginatingAttorney`
        """
        model = ReportCreateRequestDataOriginatingAttorney()  # noqa: E501
        if include_optional:
            return ReportCreateRequestDataOriginatingAttorney(
                id = 56
            )
        else:
            return ReportCreateRequestDataOriginatingAttorney(
    ...
    def testReportCreateRequestDataOriginatingAttorney(self):
        """Test ReportCreateRequestDataOriginatingAttorney"""
