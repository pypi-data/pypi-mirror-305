...
from openapi_client.models.participant_base import ParticipantBase  # noqa: E501

class TestParticipantBase(unittest.TestCase):
    """ParticipantBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ParticipantBase:
        """Test ParticipantBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ParticipantBase`
        """
        model = ParticipantBase()  # noqa: E501
        if include_optional:
