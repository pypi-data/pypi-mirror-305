...
from openapi_client.models.document_automation_base import DocumentAutomationBase  # noqa: E501

class TestDocumentAutomationBase(unittest.TestCase):
    """DocumentAutomationBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentAutomationBase:
        """Test DocumentAutomationBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentAutomationBase`
        """
        model = DocumentAutomationBase()  # noqa: E501
        if include_optional:
            return DocumentAutomationBase(
                id = 56,
                etag = '',
                state = 'not_started',
                export_formats = 'pdf',
    ...
    def testDocumentAutomationBase(self):
        """Test DocumentAutomationBase"""
