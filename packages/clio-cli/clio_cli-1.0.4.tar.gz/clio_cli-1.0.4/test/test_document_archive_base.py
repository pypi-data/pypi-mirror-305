...
from openapi_client.models.document_archive_base import DocumentArchiveBase  # noqa: E501

class TestDocumentArchiveBase(unittest.TestCase):
    """DocumentArchiveBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentArchiveBase:
        """Test DocumentArchiveBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentArchiveBase`
        """
        model = DocumentArchiveBase()  # noqa: E501
        if include_optional:
            return DocumentArchiveBase(
                id = 56,
                etag = '',
    ...
    def testDocumentArchiveBase(self):
        """Test DocumentArchiveBase"""
