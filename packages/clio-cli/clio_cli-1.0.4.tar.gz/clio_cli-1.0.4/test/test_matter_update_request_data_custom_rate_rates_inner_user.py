...
from openapi_client.models.matter_update_request_data_custom_rate_rates_inner_user import MatterUpdateRequestDataCustomRateRatesInnerUser  # noqa: E501

class TestMatterUpdateRequestDataCustomRateRatesInnerUser(unittest.TestCase):
    """MatterUpdateRequestDataCustomRateRatesInnerUser unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MatterUpdateRequestDataCustomRateRatesInnerUser:
        """Test MatterUpdateRequestDataCustomRateRatesInnerUser
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MatterUpdateRequestDataCustomRateRatesInnerUser`
        """
        model = MatterUpdateRequestDataCustomRateRatesInnerUser()  # noqa: E501
        if include_optional:
            return MatterUpdateRequestDataCustomRateRatesInnerUser(
                id = 56
            )
        else:
            return MatterUpdateRequestDataCustomRateRatesInnerUser(
    ...
    def testMatterUpdateRequestDataCustomRateRatesInnerUser(self):
        """Test MatterUpdateRequestDataCustomRateRatesInnerUser"""
