...
from openapi_client.models.custom_field_set_association_base import CustomFieldSetAssociationBase  # noqa: E501

class TestCustomFieldSetAssociationBase(unittest.TestCase):
    """CustomFieldSetAssociationBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CustomFieldSetAssociationBase:
        """Test CustomFieldSetAssociationBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CustomFieldSetAssociationBase`
        """
        model = CustomFieldSetAssociationBase()  # noqa: E501
        if include_optional:
            return CustomFieldSetAssociationBase(
                id = 56,
                etag = '',
                display_order = 56,
    ...
    def testCustomFieldSetAssociationBase(self):
        """Test CustomFieldSetAssociationBase"""
