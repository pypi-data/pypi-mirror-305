...
from openapi_client.models.grant_funding_source_list import GrantFundingSourceList  # noqa: E501

class TestGrantFundingSourceList(unittest.TestCase):
    """GrantFundingSourceList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GrantFundingSourceList:
        """Test GrantFundingSourceList
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GrantFundingSourceList`
        """
        model = GrantFundingSourceList()  # noqa: E501
        if include_optional:
            return GrantFundingSourceList(
                data = [
                    null
                    ]
            )
    ...
    def testGrantFundingSourceList(self):
        """Test GrantFundingSourceList"""
