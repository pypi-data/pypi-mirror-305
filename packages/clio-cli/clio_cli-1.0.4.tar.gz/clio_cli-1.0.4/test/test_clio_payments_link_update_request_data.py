...
from openapi_client.models.clio_payments_link_update_request_data import ClioPaymentsLinkUpdateRequestData  # noqa: E501

class TestClioPaymentsLinkUpdateRequestData(unittest.TestCase):
    """ClioPaymentsLinkUpdateRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ClioPaymentsLinkUpdateRequestData:
        """Test ClioPaymentsLinkUpdateRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ClioPaymentsLinkUpdateRequestData`
        """
        model = ClioPaymentsLinkUpdateRequestData()  # noqa: E501
        if include_optional:
            return ClioPaymentsLinkUpdateRequestData(
                expired = True
            )
        else:
            return ClioPaymentsLinkUpdateRequestData(
    ...
    def testClioPaymentsLinkUpdateRequestData(self):
        """Test ClioPaymentsLinkUpdateRequestData"""
