...
from openapi_client.models.task_template_create_request_data_task_template_list import TaskTemplateCreateRequestDataTaskTemplateList  # noqa: E501

class TestTaskTemplateCreateRequestDataTaskTemplateList(unittest.TestCase):
    """TaskTemplateCreateRequestDataTaskTemplateList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TaskTemplateCreateRequestDataTaskTemplateList:
        """Test TaskTemplateCreateRequestDataTaskTemplateList
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TaskTemplateCreateRequestDataTaskTemplateList`
        """
        model = TaskTemplateCreateRequestDataTaskTemplateList()  # noqa: E501
        if include_optional:
            return TaskTemplateCreateRequestDataTaskTemplateList(
                id = 56
            )
        else:
            return TaskTemplateCreateRequestDataTaskTemplateList(
    ...
    def testTaskTemplateCreateRequestDataTaskTemplateList(self):
        """Test TaskTemplateCreateRequestDataTaskTemplateList"""
