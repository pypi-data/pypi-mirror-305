...
from openapi_client.models.cascading_task_template_base import CascadingTaskTemplateBase  # noqa: E501

class TestCascadingTaskTemplateBase(unittest.TestCase):
    """CascadingTaskTemplateBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CascadingTaskTemplateBase:
        """Test CascadingTaskTemplateBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CascadingTaskTemplateBase`
        """
        model = CascadingTaskTemplateBase()  # noqa: E501
        if include_optional:
            return CascadingTaskTemplateBase(
                id = 56,
                name = ''
            )
        else:
    ...
    def testCascadingTaskTemplateBase(self):
        """Test CascadingTaskTemplateBase"""
