...
from openapi_client.models.conversation_message_create_request import ConversationMessageCreateRequest  # noqa: E501

class TestConversationMessageCreateRequest(unittest.TestCase):
    """ConversationMessageCreateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConversationMessageCreateRequest:
        """Test ConversationMessageCreateRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConversationMessageCreateRequest`
        """
        model = ConversationMessageCreateRequest()  # noqa: E501
        if include_optional:
            return ConversationMessageCreateRequest(
                data = openapi_client.models.conversation_message_create_request_data.ConversationMessage_create_request_data(
                    attachment = openapi_client.models.conversation_message_create_request_data_attachment.ConversationMessage_create_request_data_attachment(
                        document_id = 56, 
                        document_version_id = 56, ), 
                    body = '', 
                    conversation = openapi_client.models.conversation_message_create_request_data_conversation.ConversationMessage_create_request_data_conversation(
                        id = 56, ), 
                    matter = openapi_client.models.conversation_message_create_request_data_matter.ConversationMessage_create_request_data_matter(
                        id = 56, ), 
                    receivers = [
                        openapi_client.models.conversation_message_create_request_data_receivers_inner.ConversationMessage_create_request_data_receivers_inner(
                            id = 56, 
                            type = 'Contact', )
                        ], 
                    subject = '', )
    ...
    def testConversationMessageCreateRequest(self):
        """Test ConversationMessageCreateRequest"""
