...
from openapi_client.models.conversation_message_show import ConversationMessageShow  # noqa: E501

class TestConversationMessageShow(unittest.TestCase):
    """ConversationMessageShow unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConversationMessageShow:
        """Test ConversationMessageShow
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConversationMessageShow`
        """
        model = ConversationMessageShow()  # noqa: E501
        if include_optional:
            return ConversationMessageShow(
                data = None
            )
        else:
            return ConversationMessageShow(
    ...
    def testConversationMessageShow(self):
        """Test ConversationMessageShow"""
