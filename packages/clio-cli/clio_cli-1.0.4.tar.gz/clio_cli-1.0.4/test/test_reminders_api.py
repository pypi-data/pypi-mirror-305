...
from openapi_client.api.reminders_api import RemindersApi  # noqa: E501
...
class TestRemindersApi(unittest.TestCase):
    ...
    def test_reminder_create(self) -> None:
    ...
    def test_reminder_destroy(self) -> None:
    ...
    def test_reminder_index(self) -> None:
    ...
    def test_reminder_show(self) -> None:
    ...
    def test_reminder_update(self) -> None:
