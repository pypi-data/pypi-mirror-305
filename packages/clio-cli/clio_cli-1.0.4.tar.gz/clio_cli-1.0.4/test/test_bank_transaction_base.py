...
from openapi_client.models.bank_transaction_base import BankTransactionBase  # noqa: E501

class TestBankTransactionBase(unittest.TestCase):
    """BankTransactionBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BankTransactionBase:
        """Test BankTransactionBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BankTransactionBase`
        """
        model = BankTransactionBase()  # noqa: E501
        if include_optional:
            return BankTransactionBase(
                id = 56,
                type = '',
                etag = '',
    ...
    def testBankTransactionBase(self):
        """Test BankTransactionBase"""
