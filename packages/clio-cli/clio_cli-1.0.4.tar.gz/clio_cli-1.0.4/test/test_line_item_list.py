...
from openapi_client.models.line_item_list import LineItemList  # noqa: E501
...
class TestLineItemList(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> LineItemList:
        """Test LineItemList
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LineItemList`
        """
        model = LineItemList()  # noqa: E501
        if include_optional:
            return LineItemList(
                data = [
                    null
