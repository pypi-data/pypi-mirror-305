...
from openapi_client.models.calendar_entry_event_type import CalendarEntryEventType  # noqa: E501

class TestCalendarEntryEventType(unittest.TestCase):
    """CalendarEntryEventType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CalendarEntryEventType:
        """Test CalendarEntryEventType
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CalendarEntryEventType`
        """
        model = CalendarEntryEventType()  # noqa: E501
        if include_optional:
            return CalendarEntryEventType(
                id = 56,
                etag = '',
    ...
    def testCalendarEntryEventType(self):
        """Test CalendarEntryEventType"""
