...
from openapi_client.models.task_template_list_update_request_data import TaskTemplateListUpdateRequestData  # noqa: E501

class TestTaskTemplateListUpdateRequestData(unittest.TestCase):
    """TaskTemplateListUpdateRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TaskTemplateListUpdateRequestData:
        """Test TaskTemplateListUpdateRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TaskTemplateListUpdateRequestData`
        """
        model = TaskTemplateListUpdateRequestData()  # noqa: E501
        if include_optional:
            return TaskTemplateListUpdateRequestData(
                description = '',
                name = '',
    ...
    def testTaskTemplateListUpdateRequestData(self):
        """Test TaskTemplateListUpdateRequestData"""
