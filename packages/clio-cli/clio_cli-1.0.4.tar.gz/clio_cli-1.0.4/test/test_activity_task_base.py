...
from openapi_client.models.activity_task_base import ActivityTaskBase  # noqa: E501

class TestActivityTaskBase(unittest.TestCase):
    """ActivityTaskBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ActivityTaskBase:
        """Test ActivityTaskBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ActivityTaskBase`
        """
        model = ActivityTaskBase()  # noqa: E501
        if include_optional:
            return ActivityTaskBase(
                id = 56,
                etag = ''
            )
        else:
