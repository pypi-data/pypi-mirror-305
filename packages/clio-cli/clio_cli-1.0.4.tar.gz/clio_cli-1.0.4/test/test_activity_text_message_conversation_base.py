...
from openapi_client.models.activity_text_message_conversation_base import ActivityTextMessageConversationBase  # noqa: E501

class TestActivityTextMessageConversationBase(unittest.TestCase):
    """ActivityTextMessageConversationBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ActivityTextMessageConversationBase:
        """Test ActivityTextMessageConversationBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ActivityTextMessageConversationBase`
        """
        model = ActivityTextMessageConversationBase()  # noqa: E501
        if include_optional:
            return ActivityTextMessageConversationBase(
                id = 56,
                etag = ''
            )
        else:
    ...
    def testActivityTextMessageConversationBase(self):
        """Test ActivityTextMessageConversationBase"""
