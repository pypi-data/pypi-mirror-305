...
from openapi_client.models.clio_payments_payment_list import ClioPaymentsPaymentList  # noqa: E501

class TestClioPaymentsPaymentList(unittest.TestCase):
    """ClioPaymentsPaymentList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ClioPaymentsPaymentList:
        """Test ClioPaymentsPaymentList
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ClioPaymentsPaymentList`
        """
        model = ClioPaymentsPaymentList()  # noqa: E501
        if include_optional:
            return ClioPaymentsPaymentList(
                data = [
                    null
                    ]
            )
    ...
    def testClioPaymentsPaymentList(self):
        """Test ClioPaymentsPaymentList"""
