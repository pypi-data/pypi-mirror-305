...
from openapi_client.models.folder_create_request_data import FolderCreateRequestData  # noqa: E501

class TestFolderCreateRequestData(unittest.TestCase):
    """FolderCreateRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FolderCreateRequestData:
        """Test FolderCreateRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FolderCreateRequestData`
        """
        model = FolderCreateRequestData()  # noqa: E501
        if include_optional:
            return FolderCreateRequestData(
                document_category = openapi_client.models.folder_create_request_data_document_category.Folder_create_request_data_document_category(
                    id = 56, ),
                external_properties = [
                    openapi_client.models.folder_create_request_data_external_properties_inner.Folder_create_request_data_external_properties_inner(
                        name = '', 
                        value = '', )
                    ],
                name = '',
                parent = openapi_client.models.folder_create_request_data_parent.Folder_create_request_data_parent(
                    id = 56, 
                    type = 'Folder', ),
                restore = True
            )
    ...
    def testFolderCreateRequestData(self):
        """Test FolderCreateRequestData"""
