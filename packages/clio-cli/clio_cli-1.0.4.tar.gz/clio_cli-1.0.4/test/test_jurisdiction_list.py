...
from openapi_client.models.jurisdiction_list import JurisdictionList  # noqa: E501

class TestJurisdictionList(unittest.TestCase):
    """JurisdictionList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> JurisdictionList:
        """Test JurisdictionList
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `JurisdictionList`
        """
        model = JurisdictionList()  # noqa: E501
        if include_optional:
