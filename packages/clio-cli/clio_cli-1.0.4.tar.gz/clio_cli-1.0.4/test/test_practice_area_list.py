...
from openapi_client.models.practice_area_list import PracticeAreaList  # noqa: E501

class TestPracticeAreaList(unittest.TestCase):
    """PracticeAreaList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PracticeAreaList:
        """Test PracticeAreaList
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PracticeAreaList`
        """
        model = PracticeAreaList()  # noqa: E501
        if include_optional:
