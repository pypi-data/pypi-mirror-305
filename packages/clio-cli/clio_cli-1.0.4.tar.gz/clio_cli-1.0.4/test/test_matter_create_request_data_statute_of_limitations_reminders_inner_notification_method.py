...
from openapi_client.models.matter_create_request_data_statute_of_limitations_reminders_inner_notification_method import MatterCreateRequestDataStatuteOfLimitationsRemindersInnerNotificationMethod  # noqa: E501

class TestMatterCreateRequestDataStatuteOfLimitationsRemindersInnerNotificationMethod(unittest.TestCase):
    """MatterCreateRequestDataStatuteOfLimitationsRemindersInnerNotificationMethod unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MatterCreateRequestDataStatuteOfLimitationsRemindersInnerNotificationMethod:
        """Test MatterCreateRequestDataStatuteOfLimitationsRemindersInnerNotificationMethod
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MatterCreateRequestDataStatuteOfLimitationsRemindersInnerNotificationMethod`
        """
        model = MatterCreateRequestDataStatuteOfLimitationsRemindersInnerNotificationMethod()  # noqa: E501
        if include_optional:
            return MatterCreateRequestDataStatuteOfLimitationsRemindersInnerNotificationMethod(
                id = 56
            )
        else:
            return MatterCreateRequestDataStatuteOfLimitationsRemindersInnerNotificationMethod(
    ...
    def testMatterCreateRequestDataStatuteOfLimitationsRemindersInnerNotificationMethod(self):
        """Test MatterCreateRequestDataStatuteOfLimitationsRemindersInnerNotificationMethod"""
