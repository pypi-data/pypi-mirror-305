...
from openapi_client.api.matters_api import MattersApi  # noqa: E501
...
class TestMattersApi(unittest.TestCase):
    ...
    def test_matter_create(self) -> None:
    ...
    def test_matter_destroy(self) -> None:
    ...
    def test_matter_index(self) -> None:
    ...
    def test_matter_show(self) -> None:
    ...
    def test_matter_update(self) -> None:
