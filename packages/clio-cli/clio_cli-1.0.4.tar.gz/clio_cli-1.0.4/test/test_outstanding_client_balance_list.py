...
from openapi_client.models.outstanding_client_balance_list import OutstandingClientBalanceList  # noqa: E501

class TestOutstandingClientBalanceList(unittest.TestCase):
    """OutstandingClientBalanceList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OutstandingClientBalanceList:
        """Test OutstandingClientBalanceList
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OutstandingClientBalanceList`
        """
        model = OutstandingClientBalanceList()  # noqa: E501
        if include_optional:
            return OutstandingClientBalanceList(
                data = [
                    null
                    ]
            )
    ...
    def testOutstandingClientBalanceList(self):
        """Test OutstandingClientBalanceList"""
