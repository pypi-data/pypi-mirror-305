...
from openapi_client.models.line_item_show import LineItemShow  # noqa: E501

class TestLineItemShow(unittest.TestCase):
    """LineItemShow unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LineItemShow:
        """Test LineItemShow
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LineItemShow`
        """
        model = LineItemShow()  # noqa: E501
        if include_optional:
            return LineItemShow(
                data = None
            )
