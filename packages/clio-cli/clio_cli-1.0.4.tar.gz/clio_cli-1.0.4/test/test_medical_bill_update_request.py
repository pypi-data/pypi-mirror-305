...
from openapi_client.models.medical_bill_update_request import MedicalBillUpdateRequest  # noqa: E501

class TestMedicalBillUpdateRequest(unittest.TestCase):
    """MedicalBillUpdateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MedicalBillUpdateRequest:
        """Test MedicalBillUpdateRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MedicalBillUpdateRequest`
        """
        model = MedicalBillUpdateRequest()  # noqa: E501
        if include_optional:
            return MedicalBillUpdateRequest(
                data = openapi_client.models.medical_bill_update_request_data.MedicalBill_update_request_data(
                    adjustment = 1.337, 
                    amount = 1.337, 
                    balance = 1.337, 
                    ...
                    name = '', 
                    payers = [
                        openapi_client.models.medical_bill_update_request_data_payers_inner.MedicalBill_update_request_data_payers_inner(
                            amount = 1.337, 
                            holder_id = 56, 
                            mark_as_lien = True, )
                        ], )
    ...
    def testMedicalBillUpdateRequest(self):
        """Test MedicalBillUpdateRequest"""
