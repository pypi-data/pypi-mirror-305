...
from openapi_client.models.account_balance_base import AccountBalanceBase  # noqa: E501

class TestAccountBalanceBase(unittest.TestCase):
    """AccountBalanceBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AccountBalanceBase:
        """Test AccountBalanceBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AccountBalanceBase`
        """
        model = AccountBalanceBase()  # noqa: E501
        if include_optional:
    ...
    def testAccountBalanceBase(self):
        """Test AccountBalanceBase"""
