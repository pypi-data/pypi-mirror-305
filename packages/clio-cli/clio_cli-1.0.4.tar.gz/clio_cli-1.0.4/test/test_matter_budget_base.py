...
from openapi_client.models.matter_budget_base import MatterBudgetBase  # noqa: E501

class TestMatterBudgetBase(unittest.TestCase):
    """MatterBudgetBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MatterBudgetBase:
        """Test MatterBudgetBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MatterBudgetBase`
        """
        model = MatterBudgetBase()  # noqa: E501
        if include_optional:
            return MatterBudgetBase(
                id = 56,
                etag = '',
                budget = 1.337,
