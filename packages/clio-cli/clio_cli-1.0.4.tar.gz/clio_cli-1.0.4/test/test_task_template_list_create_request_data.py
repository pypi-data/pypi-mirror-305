...
from openapi_client.models.task_template_list_create_request_data import TaskTemplateListCreateRequestData  # noqa: E501

class TestTaskTemplateListCreateRequestData(unittest.TestCase):
    """TaskTemplateListCreateRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TaskTemplateListCreateRequestData:
        """Test TaskTemplateListCreateRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TaskTemplateListCreateRequestData`
        """
        model = TaskTemplateListCreateRequestData()  # noqa: E501
        if include_optional:
            return TaskTemplateListCreateRequestData(
                description = '',
                name = '',
    ...
    def testTaskTemplateListCreateRequestData(self):
        """Test TaskTemplateListCreateRequestData"""
