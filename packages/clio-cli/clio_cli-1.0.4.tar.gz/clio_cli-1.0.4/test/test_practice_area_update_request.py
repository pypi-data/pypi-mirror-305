...
from openapi_client.models.practice_area_update_request import PracticeAreaUpdateRequest  # noqa: E501

class TestPracticeAreaUpdateRequest(unittest.TestCase):
    """PracticeAreaUpdateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PracticeAreaUpdateRequest:
        """Test PracticeAreaUpdateRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PracticeAreaUpdateRequest`
        """
        model = PracticeAreaUpdateRequest()  # noqa: E501
        if include_optional:
            return PracticeAreaUpdateRequest(
                data = openapi_client.models.practice_area_update_request_data.PracticeArea_update_request_data(
    ...
    def testPracticeAreaUpdateRequest(self):
        """Test PracticeAreaUpdateRequest"""
