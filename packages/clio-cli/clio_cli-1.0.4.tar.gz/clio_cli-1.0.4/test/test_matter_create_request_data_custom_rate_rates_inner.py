...
from openapi_client.models.matter_create_request_data_custom_rate_rates_inner import MatterCreateRequestDataCustomRateRatesInner  # noqa: E501

class TestMatterCreateRequestDataCustomRateRatesInner(unittest.TestCase):
    """MatterCreateRequestDataCustomRateRatesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MatterCreateRequestDataCustomRateRatesInner:
        """Test MatterCreateRequestDataCustomRateRatesInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MatterCreateRequestDataCustomRateRatesInner`
        """
        model = MatterCreateRequestDataCustomRateRatesInner()  # noqa: E501
        if include_optional:
            return MatterCreateRequestDataCustomRateRatesInner(
    ...
    def testMatterCreateRequestDataCustomRateRatesInner(self):
        """Test MatterCreateRequestDataCustomRateRatesInner"""
