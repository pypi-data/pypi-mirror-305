...
from openapi_client.models.bill_update_request_data_discount import BillUpdateRequestDataDiscount  # noqa: E501

class TestBillUpdateRequestDataDiscount(unittest.TestCase):
    """BillUpdateRequestDataDiscount unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BillUpdateRequestDataDiscount:
        """Test BillUpdateRequestDataDiscount
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BillUpdateRequestDataDiscount`
        """
        model = BillUpdateRequestDataDiscount()  # noqa: E501
        if include_optional:
            return BillUpdateRequestDataDiscount(
                rate = 1.337,
                type = 'percentage',
                note = ''
            )
    ...
    def testBillUpdateRequestDataDiscount(self):
        """Test BillUpdateRequestDataDiscount"""
