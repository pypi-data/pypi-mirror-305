...
from openapi_client.models.document_update_request import DocumentUpdateRequest  # noqa: E501
...
class TestDocumentUpdateRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DocumentUpdateRequest:
        ...
        """
        model = DocumentUpdateRequest()  # noqa: E501
        if include_optional:
            return DocumentUpdateRequest(
                data = openapi_client.models.document_update_request_data.Document_update_request_data(
                    communication_id = 56, 
                    copy_version = True, 
