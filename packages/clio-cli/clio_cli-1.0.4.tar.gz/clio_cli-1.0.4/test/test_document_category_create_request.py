...
from openapi_client.models.document_category_create_request import DocumentCategoryCreateRequest  # noqa: E501
...
class TestDocumentCategoryCreateRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DocumentCategoryCreateRequest:
        ...
        """
        model = DocumentCategoryCreateRequest()  # noqa: E501
        if include_optional:
            return DocumentCategoryCreateRequest(
                data = openapi_client.models.document_category_create_request_data.DocumentCategory_create_request_data(
                    name = '', )
            )
        else:
            return DocumentCategoryCreateRequest(
