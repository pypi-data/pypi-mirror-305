...
from openapi_client.models.conversation_base import ConversationBase  # noqa: E501

class TestConversationBase(unittest.TestCase):
    """ConversationBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConversationBase:
        """Test ConversationBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConversationBase`
        """
        model = ConversationBase()  # noqa: E501
        if include_optional:
