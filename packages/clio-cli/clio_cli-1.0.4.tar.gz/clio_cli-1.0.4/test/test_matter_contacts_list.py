...
from openapi_client.models.matter_contacts_list import MatterContactsList  # noqa: E501

class TestMatterContactsList(unittest.TestCase):
    """MatterContactsList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MatterContactsList:
        """Test MatterContactsList
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MatterContactsList`
        """
        model = MatterContactsList()  # noqa: E501
        if include_optional:
            return MatterContactsList(
                data = [
                    null
                    ]
            )
    ...
    def testMatterContactsList(self):
        """Test MatterContactsList"""
