...
from openapi_client.models.calendar_entry_create_request_data_attendees_inner import CalendarEntryCreateRequestDataAttendeesInner  # noqa: E501

class TestCalendarEntryCreateRequestDataAttendeesInner(unittest.TestCase):
    """CalendarEntryCreateRequestDataAttendeesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CalendarEntryCreateRequestDataAttendeesInner:
        """Test CalendarEntryCreateRequestDataAttendeesInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CalendarEntryCreateRequestDataAttendeesInner`
        """
        model = CalendarEntryCreateRequestDataAttendeesInner()  # noqa: E501
        if include_optional:
            return CalendarEntryCreateRequestDataAttendeesInner(
                id = 56,
                type = '',
                destroy = True
            )
    ...
    def testCalendarEntryCreateRequestDataAttendeesInner(self):
        """Test CalendarEntryCreateRequestDataAttendeesInner"""
