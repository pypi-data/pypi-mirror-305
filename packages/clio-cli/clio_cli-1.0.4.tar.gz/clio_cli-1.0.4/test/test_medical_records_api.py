...
from openapi_client.api.medical_records_api import MedicalRecordsApi  # noqa: E501
...
class TestMedicalRecordsApi(unittest.TestCase):
    ...
    def setUp(self) -> None:
        self.api = MedicalRecordsApi()

    def tearDown(self) -> None:
        pass

    def test_medical_record_destroy(self) -> None:
    ...
    def test_medical_record_update(self) -> None:
