...
from openapi_client.models.billing_setting import BillingSetting  # noqa: E501

class TestBillingSetting(unittest.TestCase):
    """BillingSetting unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BillingSetting:
        """Test BillingSetting
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BillingSetting`
        """
        model = BillingSetting()  # noqa: E501
        if include_optional:
