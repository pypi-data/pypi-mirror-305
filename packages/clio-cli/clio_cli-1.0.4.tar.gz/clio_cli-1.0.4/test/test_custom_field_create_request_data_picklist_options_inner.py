...
from openapi_client.models.custom_field_create_request_data_picklist_options_inner import CustomFieldCreateRequestDataPicklistOptionsInner  # noqa: E501

class TestCustomFieldCreateRequestDataPicklistOptionsInner(unittest.TestCase):
    """CustomFieldCreateRequestDataPicklistOptionsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CustomFieldCreateRequestDataPicklistOptionsInner:
        """Test CustomFieldCreateRequestDataPicklistOptionsInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CustomFieldCreateRequestDataPicklistOptionsInner`
        """
        model = CustomFieldCreateRequestDataPicklistOptionsInner()  # noqa: E501
        if include_optional:
            return CustomFieldCreateRequestDataPicklistOptionsInner(
                id = 56,
                option = '',
                deleted = True
            )
    ...
    def testCustomFieldCreateRequestDataPicklistOptionsInner(self):
        """Test CustomFieldCreateRequestDataPicklistOptionsInner"""
