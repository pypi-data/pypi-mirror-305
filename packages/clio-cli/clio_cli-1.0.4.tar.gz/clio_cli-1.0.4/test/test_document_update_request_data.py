...
from openapi_client.models.document_update_request_data import DocumentUpdateRequestData  # noqa: E501

class TestDocumentUpdateRequestData(unittest.TestCase):
    """DocumentUpdateRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentUpdateRequestData:
        """Test DocumentUpdateRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentUpdateRequestData`
        """
        model = DocumentUpdateRequestData()  # noqa: E501
        if include_optional:
            return DocumentUpdateRequestData(
                communication_id = 56,
                copy_version = True,
                document_category = openapi_client.models.document_copy_request_data_document_category.Document_copy_request_data_document_category(
                    id = 56, ),
                external_properties = [
                    openapi_client.models.document_copy_request_data_external_properties_inner.Document_copy_request_data_external_properties_inner(
                        id = 56, 
                        name = '', 
                        value = '', 
                        _destroy = True, )
                ...
                fully_uploaded = True,
                multiparts = [
                    openapi_client.models.document_update_request_data_multiparts_inner.Document_update_request_data_multiparts_inner(
                        part_number = 56, 
                        content_length = '', 
                        content_md5 = '', )
                    ],
                name = '',
                parent = openapi_client.models.document_update_request_data_parent.Document_update_request_data_parent(
                    id = 56, 
                    type = 'Document', ),
    ...
    def testDocumentUpdateRequestData(self):
        """Test DocumentUpdateRequestData"""
