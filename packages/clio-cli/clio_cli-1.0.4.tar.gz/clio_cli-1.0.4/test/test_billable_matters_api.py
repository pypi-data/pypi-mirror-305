...
from openapi_client.api.billable_matters_api import BillableMattersApi  # noqa: E501


class TestBillableMattersApi(unittest.TestCase):
    """BillableMattersApi unit test stubs"""

    def setUp(self) -> None:
        self.api = BillableMattersApi()

    def tearDown(self) -> None:
        pass

    def test_billable_matter_ids(self) -> None:
    ...
    def test_billable_matter_index(self) -> None:
