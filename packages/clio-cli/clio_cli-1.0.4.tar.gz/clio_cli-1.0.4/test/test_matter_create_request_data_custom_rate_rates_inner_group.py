...
from openapi_client.models.matter_create_request_data_custom_rate_rates_inner_group import MatterCreateRequestDataCustomRateRatesInnerGroup  # noqa: E501

class TestMatterCreateRequestDataCustomRateRatesInnerGroup(unittest.TestCase):
    """MatterCreateRequestDataCustomRateRatesInnerGroup unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MatterCreateRequestDataCustomRateRatesInnerGroup:
        """Test MatterCreateRequestDataCustomRateRatesInnerGroup
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MatterCreateRequestDataCustomRateRatesInnerGroup`
        """
        model = MatterCreateRequestDataCustomRateRatesInnerGroup()  # noqa: E501
        if include_optional:
            return MatterCreateRequestDataCustomRateRatesInnerGroup(
                id = 56
            )
        else:
            return MatterCreateRequestDataCustomRateRatesInnerGroup(
    ...
    def testMatterCreateRequestDataCustomRateRatesInnerGroup(self):
        """Test MatterCreateRequestDataCustomRateRatesInnerGroup"""
