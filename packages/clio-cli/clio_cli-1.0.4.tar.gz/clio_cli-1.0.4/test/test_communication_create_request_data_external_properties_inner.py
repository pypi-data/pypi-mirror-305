...
from openapi_client.models.communication_create_request_data_external_properties_inner import CommunicationCreateRequestDataExternalPropertiesInner  # noqa: E501

class TestCommunicationCreateRequestDataExternalPropertiesInner(unittest.TestCase):
    """CommunicationCreateRequestDataExternalPropertiesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CommunicationCreateRequestDataExternalPropertiesInner:
        """Test CommunicationCreateRequestDataExternalPropertiesInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CommunicationCreateRequestDataExternalPropertiesInner`
        """
        model = CommunicationCreateRequestDataExternalPropertiesInner()  # noqa: E501
        if include_optional:
            return CommunicationCreateRequestDataExternalPropertiesInner(
                name = '',
                value = ''
            )
        else:
    ...
    def testCommunicationCreateRequestDataExternalPropertiesInner(self):
        """Test CommunicationCreateRequestDataExternalPropertiesInner"""
