...
from openapi_client.models.custom_field_set_create_request import CustomFieldSetCreateRequest  # noqa: E501

class TestCustomFieldSetCreateRequest(unittest.TestCase):
    """CustomFieldSetCreateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CustomFieldSetCreateRequest:
        """Test CustomFieldSetCreateRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CustomFieldSetCreateRequest`
        """
        model = CustomFieldSetCreateRequest()  # noqa: E501
        if include_optional:
            return CustomFieldSetCreateRequest(
                data = openapi_client.models.custom_field_set_create_request_data.CustomFieldSet_create_request_data(
                    displayed = True, 
                    name = '', 
                    parent_type = 'Contact', )
            )
    ...
    def testCustomFieldSetCreateRequest(self):
        """Test CustomFieldSetCreateRequest"""
