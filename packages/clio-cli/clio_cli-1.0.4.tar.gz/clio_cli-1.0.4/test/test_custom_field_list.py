...
from openapi_client.models.custom_field_list import CustomFieldList  # noqa: E501

class TestCustomFieldList(unittest.TestCase):
    """CustomFieldList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CustomFieldList:
        """Test CustomFieldList
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CustomFieldList`
        """
        model = CustomFieldList()  # noqa: E501
        if include_optional:
