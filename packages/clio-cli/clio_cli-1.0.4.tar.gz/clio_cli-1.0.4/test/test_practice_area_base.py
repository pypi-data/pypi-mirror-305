...
from openapi_client.models.practice_area_base import PracticeAreaBase  # noqa: E501

class TestPracticeAreaBase(unittest.TestCase):
    """PracticeAreaBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PracticeAreaBase:
        """Test PracticeAreaBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PracticeAreaBase`
        """
        model = PracticeAreaBase()  # noqa: E501
        if include_optional:
            return PracticeAreaBase(
                id = 56,
                etag = '',
