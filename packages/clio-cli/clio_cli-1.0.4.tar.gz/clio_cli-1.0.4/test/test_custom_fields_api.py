...
from openapi_client.api.custom_fields_api import CustomFieldsApi  # noqa: E501
...
class TestCustomFieldsApi(unittest.TestCase):
    ...
    def test_custom_field_create(self) -> None:
    ...
    def test_custom_field_destroy(self) -> None:
    ...
    def test_custom_field_index(self) -> None:
    ...
    def test_custom_field_show(self) -> None:
    ...
    def test_custom_field_update(self) -> None:
