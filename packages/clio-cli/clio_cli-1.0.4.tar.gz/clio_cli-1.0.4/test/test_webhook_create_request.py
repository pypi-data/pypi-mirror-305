...
from openapi_client.models.webhook_create_request import WebhookCreateRequest  # noqa: E501
    ...
    def make_instance(self, include_optional) -> WebhookCreateRequest:
        ...
        if include_optional:
            return WebhookCreateRequest(
                data = openapi_client.models.webhook_create_request_data.Webhook_create_request_data(
                    events = [
                        'created'
                        ], 
