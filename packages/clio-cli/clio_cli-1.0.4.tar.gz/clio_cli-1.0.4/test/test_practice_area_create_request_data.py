...
from openapi_client.models.practice_area_create_request_data import PracticeAreaCreateRequestData  # noqa: E501

class TestPracticeAreaCreateRequestData(unittest.TestCase):
    """PracticeAreaCreateRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PracticeAreaCreateRequestData:
        """Test PracticeAreaCreateRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PracticeAreaCreateRequestData`
        """
        model = PracticeAreaCreateRequestData()  # noqa: E501
        if include_optional:
            return PracticeAreaCreateRequestData(
    ...
    def testPracticeAreaCreateRequestData(self):
        """Test PracticeAreaCreateRequestData"""
