...
from openapi_client.models.matter_update_request_data_custom_field_set_associations_inner import MatterUpdateRequestDataCustomFieldSetAssociationsInner  # noqa: E501

class TestMatterUpdateRequestDataCustomFieldSetAssociationsInner(unittest.TestCase):
    """MatterUpdateRequestDataCustomFieldSetAssociationsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MatterUpdateRequestDataCustomFieldSetAssociationsInner:
        """Test MatterUpdateRequestDataCustomFieldSetAssociationsInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MatterUpdateRequestDataCustomFieldSetAssociationsInner`
        """
        model = MatterUpdateRequestDataCustomFieldSetAssociationsInner()  # noqa: E501
        if include_optional:
            return MatterUpdateRequestDataCustomFieldSetAssociationsInner(
                id = 56,
                display_order = 56,
    ...
    def testMatterUpdateRequestDataCustomFieldSetAssociationsInner(self):
        """Test MatterUpdateRequestDataCustomFieldSetAssociationsInner"""
