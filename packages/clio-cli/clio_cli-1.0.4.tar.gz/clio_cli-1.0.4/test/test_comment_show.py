...
from openapi_client.models.comment_show import CommentShow  # noqa: E501

class TestCommentShow(unittest.TestCase):
    """CommentShow unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CommentShow:
        """Test CommentShow
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CommentShow`
        """
        model = CommentShow()  # noqa: E501
        if include_optional:
            return CommentShow(
                data = None
            )
