...
from openapi_client.models.contact_update_request_data_custom_field_values_inner_custom_field import ContactUpdateRequestDataCustomFieldValuesInnerCustomField  # noqa: E501

class TestContactUpdateRequestDataCustomFieldValuesInnerCustomField(unittest.TestCase):
    """ContactUpdateRequestDataCustomFieldValuesInnerCustomField unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ContactUpdateRequestDataCustomFieldValuesInnerCustomField:
        """Test ContactUpdateRequestDataCustomFieldValuesInnerCustomField
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ContactUpdateRequestDataCustomFieldValuesInnerCustomField`
        """
        model = ContactUpdateRequestDataCustomFieldValuesInnerCustomField()  # noqa: E501
        if include_optional:
            return ContactUpdateRequestDataCustomFieldValuesInnerCustomField(
                id = 56
            )
        else:
            return ContactUpdateRequestDataCustomFieldValuesInnerCustomField(
    ...
    def testContactUpdateRequestDataCustomFieldValuesInnerCustomField(self):
        """Test ContactUpdateRequestDataCustomFieldValuesInnerCustomField"""
