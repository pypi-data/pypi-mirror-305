...
from openapi_client.api.task_template_lists_api import TaskTemplateListsApi  # noqa: E501


class TestTaskTemplateListsApi(unittest.TestCase):
    """TaskTemplateListsApi unit test stubs"""

    def setUp(self) -> None:
        self.api = TaskTemplateListsApi()

    def tearDown(self) -> None:
        pass

    def test_task_template_list_copy(self) -> None:
    ...
    def test_task_template_list_create(self) -> None:
    ...
    def test_task_template_list_destroy(self) -> None:
    ...
    def test_task_template_list_index(self) -> None:
    ...
    def test_task_template_list_show(self) -> None:
    ...
    def test_task_template_list_update(self) -> None:
