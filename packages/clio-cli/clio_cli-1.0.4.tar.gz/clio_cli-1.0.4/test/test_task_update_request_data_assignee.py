...
from openapi_client.models.task_update_request_data_assignee import TaskUpdateRequestDataAssignee  # noqa: E501

class TestTaskUpdateRequestDataAssignee(unittest.TestCase):
    """TaskUpdateRequestDataAssignee unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TaskUpdateRequestDataAssignee:
        """Test TaskUpdateRequestDataAssignee
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TaskUpdateRequestDataAssignee`
        """
        model = TaskUpdateRequestDataAssignee()  # noqa: E501
        if include_optional:
            return TaskUpdateRequestDataAssignee(
                id = 56,
                type = 'User'
            )
        else:
    ...
    def testTaskUpdateRequestDataAssignee(self):
        """Test TaskUpdateRequestDataAssignee"""
