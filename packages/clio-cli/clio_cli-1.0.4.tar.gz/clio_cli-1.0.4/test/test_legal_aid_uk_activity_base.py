...
from openapi_client.models.legal_aid_uk_activity_base import LegalAidUkActivityBase  # noqa: E501

class TestLegalAidUkActivityBase(unittest.TestCase):
    """LegalAidUkActivityBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LegalAidUkActivityBase:
        """Test LegalAidUkActivityBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LegalAidUkActivityBase`
        """
        model = LegalAidUkActivityBase()  # noqa: E501
        if include_optional:
            return LegalAidUkActivityBase(
    ...
    def testLegalAidUkActivityBase(self):
        """Test LegalAidUkActivityBase"""
