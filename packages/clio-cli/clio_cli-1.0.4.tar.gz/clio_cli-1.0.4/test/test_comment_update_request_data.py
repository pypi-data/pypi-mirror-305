...
from openapi_client.models.comment_update_request_data import CommentUpdateRequestData  # noqa: E501

class TestCommentUpdateRequestData(unittest.TestCase):
    """CommentUpdateRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CommentUpdateRequestData:
        """Test CommentUpdateRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CommentUpdateRequestData`
        """
        model = CommentUpdateRequestData()  # noqa: E501
        if include_optional:
            return CommentUpdateRequestData(
                item = openapi_client.models.comment_update_request_data_item.Comment_update_request_data_item(
                    id = 56, ),
                message = ''
            )
        else:
    ...
    def testCommentUpdateRequestData(self):
        """Test CommentUpdateRequestData"""
