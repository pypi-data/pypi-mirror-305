...
from openapi_client.models.calendar_create_request_data import CalendarCreateRequestData  # noqa: E501

class TestCalendarCreateRequestData(unittest.TestCase):
    """CalendarCreateRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CalendarCreateRequestData:
        """Test CalendarCreateRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CalendarCreateRequestData`
        """
        model = CalendarCreateRequestData()  # noqa: E501
        if include_optional:
            return CalendarCreateRequestData(
                color = '#367B9C',
                name = '',
                source = 'web',
                visible = True
    ...
    def testCalendarCreateRequestData(self):
        """Test CalendarCreateRequestData"""
