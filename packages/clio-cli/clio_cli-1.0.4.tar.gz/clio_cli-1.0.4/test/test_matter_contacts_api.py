...
from openapi_client.api.matter_contacts_api import MatterContactsApi  # noqa: E501


class TestMatterContactsApi(unittest.TestCase):
    """MatterContactsApi unit test stubs"""

    def setUp(self) -> None:
        self.api = MatterContactsApi()

    def tearDown(self) -> None:
        pass

    def test_matter_contacts_index(self) -> None:
