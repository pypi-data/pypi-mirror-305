...
from openapi_client.models.medical_bill_update_request_data import MedicalBillUpdateRequestData  # noqa: E501

class TestMedicalBillUpdateRequestData(unittest.TestCase):
    """MedicalBillUpdateRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MedicalBillUpdateRequestData:
        """Test MedicalBillUpdateRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MedicalBillUpdateRequestData`
        """
        model = MedicalBillUpdateRequestData()  # noqa: E501
        if include_optional:
            return MedicalBillUpdateRequestData(
                adjustment = 1.337,
                amount = 1.337,
                balance = 1.337,
    ...
    def testMedicalBillUpdateRequestData(self):
        """Test MedicalBillUpdateRequestData"""
