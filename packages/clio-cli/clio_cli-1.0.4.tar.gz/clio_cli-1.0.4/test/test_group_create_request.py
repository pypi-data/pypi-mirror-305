...
from openapi_client.models.group_create_request import GroupCreateRequest  # noqa: E501
    ...
    def make_instance(self, include_optional) -> GroupCreateRequest:
        ...
        if include_optional:
            return GroupCreateRequest(
                data = openapi_client.models.group_create_request_data.Group_create_request_data(
                    name = '', )
            )
        else:
            return GroupCreateRequest(
