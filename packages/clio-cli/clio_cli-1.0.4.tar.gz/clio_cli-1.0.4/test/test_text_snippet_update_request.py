...
from openapi_client.models.text_snippet_update_request import TextSnippetUpdateRequest  # noqa: E501

class TestTextSnippetUpdateRequest(unittest.TestCase):
    """TextSnippetUpdateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TextSnippetUpdateRequest:
        """Test TextSnippetUpdateRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TextSnippetUpdateRequest`
        """
        model = TextSnippetUpdateRequest()  # noqa: E501
        if include_optional:
            return TextSnippetUpdateRequest(
                data = openapi_client.models.text_snippet_update_request_data.TextSnippet_update_request_data(
                    phrase = '', 
                    snippet = '', 
                    whole_word = True, )
            )
    ...
    def testTextSnippetUpdateRequest(self):
        """Test TextSnippetUpdateRequest"""
