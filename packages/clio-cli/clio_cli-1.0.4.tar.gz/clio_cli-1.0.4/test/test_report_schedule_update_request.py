...
from openapi_client.models.report_schedule_update_request import ReportScheduleUpdateRequest  # noqa: E501

class TestReportScheduleUpdateRequest(unittest.TestCase):
    """ReportScheduleUpdateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReportScheduleUpdateRequest:
        """Test ReportScheduleUpdateRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReportScheduleUpdateRequest`
        """
        model = ReportScheduleUpdateRequest()  # noqa: E501
        if include_optional:
            return ReportScheduleUpdateRequest(
                data = openapi_client.models.report_schedule_update_request_data.ReportSchedule_update_request_data(
                    day_of_month = 56, 
                    days_of_week = [
                        56
                        ], 
                    effective_from = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(), 
                    every_no_of_months = 56, 
                    frequency = 'daily', 
                    report_preset_id = 56, 
                    time_of_day = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
    ...
    def testReportScheduleUpdateRequest(self):
        """Test ReportScheduleUpdateRequest"""
