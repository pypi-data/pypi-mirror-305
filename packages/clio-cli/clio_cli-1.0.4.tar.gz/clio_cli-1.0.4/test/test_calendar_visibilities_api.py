...
from openapi_client.api.calendar_visibilities_api import CalendarVisibilitiesApi  # noqa: E501


class TestCalendarVisibilitiesApi(unittest.TestCase):
    """CalendarVisibilitiesApi unit test stubs"""

    def setUp(self) -> None:
        self.api = CalendarVisibilitiesApi()

    def tearDown(self) -> None:
        pass

    def test_calendar_visibility_index(self) -> None:
    ...
    def test_calendar_visibility_show(self) -> None:
    ...
    def test_calendar_visibility_update(self) -> None:
