...
from openapi_client.models.custom_field_set_update_request_data import CustomFieldSetUpdateRequestData  # noqa: E501

class TestCustomFieldSetUpdateRequestData(unittest.TestCase):
    """CustomFieldSetUpdateRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CustomFieldSetUpdateRequestData:
        """Test CustomFieldSetUpdateRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CustomFieldSetUpdateRequestData`
        """
        model = CustomFieldSetUpdateRequestData()  # noqa: E501
        if include_optional:
            return CustomFieldSetUpdateRequestData(
                displayed = True,
                name = '',
                parent_type = 'Contact'
            )
    ...
    def testCustomFieldSetUpdateRequestData(self):
        """Test CustomFieldSetUpdateRequestData"""
