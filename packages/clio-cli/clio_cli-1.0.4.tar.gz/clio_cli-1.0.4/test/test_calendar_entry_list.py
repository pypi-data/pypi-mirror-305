...
from openapi_client.models.calendar_entry_list import CalendarEntryList  # noqa: E501

class TestCalendarEntryList(unittest.TestCase):
    """CalendarEntryList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CalendarEntryList:
        """Test CalendarEntryList
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CalendarEntryList`
        """
        model = CalendarEntryList()  # noqa: E501
        if include_optional:
    ...
    def testCalendarEntryList(self):
        """Test CalendarEntryList"""
