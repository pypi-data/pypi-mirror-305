...
from openapi_client.models.matter_docket_create_request_data import MatterDocketCreateRequestData  # noqa: E501

class TestMatterDocketCreateRequestData(unittest.TestCase):
    """MatterDocketCreateRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MatterDocketCreateRequestData:
        """Test MatterDocketCreateRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MatterDocketCreateRequestData`
        """
        model = MatterDocketCreateRequestData()  # noqa: E501
        if include_optional:
            return MatterDocketCreateRequestData(
    ...
    def testMatterDocketCreateRequestData(self):
        """Test MatterDocketCreateRequestData"""
