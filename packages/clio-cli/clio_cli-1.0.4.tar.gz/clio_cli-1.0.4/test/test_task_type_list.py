...
from openapi_client.models.task_type_list import TaskTypeList  # noqa: E501

class TestTaskTypeList(unittest.TestCase):
    """TaskTypeList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TaskTypeList:
        """Test TaskTypeList
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TaskTypeList`
        """
        model = TaskTypeList()  # noqa: E501
        if include_optional:
            return TaskTypeList(
                data = [
                    null
