...
from openapi_client.models.practice_area_show import PracticeAreaShow  # noqa: E501

class TestPracticeAreaShow(unittest.TestCase):
    """PracticeAreaShow unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PracticeAreaShow:
        """Test PracticeAreaShow
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PracticeAreaShow`
        """
        model = PracticeAreaShow()  # noqa: E501
        if include_optional:
            return PracticeAreaShow(
                data = None
            )
        else:
            return PracticeAreaShow(
