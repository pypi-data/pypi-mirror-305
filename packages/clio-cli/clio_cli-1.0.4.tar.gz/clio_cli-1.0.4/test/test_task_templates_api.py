...
from openapi_client.api.task_templates_api import TaskTemplatesApi  # noqa: E501
...
class TestTaskTemplatesApi(unittest.TestCase):
    ...
    def test_task_template_create(self) -> None:
    ...
    def test_task_template_destroy(self) -> None:
    ...
    def test_task_template_index(self) -> None:
    ...
    def test_task_template_show(self) -> None:
    ...
    def test_task_template_update(self) -> None:
