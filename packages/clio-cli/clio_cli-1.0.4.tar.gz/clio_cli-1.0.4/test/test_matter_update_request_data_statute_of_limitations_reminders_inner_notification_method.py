...
from openapi_client.models.matter_update_request_data_statute_of_limitations_reminders_inner_notification_method import MatterUpdateRequestDataStatuteOfLimitationsRemindersInnerNotificationMethod  # noqa: E501

class TestMatterUpdateRequestDataStatuteOfLimitationsRemindersInnerNotificationMethod(unittest.TestCase):
    """MatterUpdateRequestDataStatuteOfLimitationsRemindersInnerNotificationMethod unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MatterUpdateRequestDataStatuteOfLimitationsRemindersInnerNotificationMethod:
        """Test MatterUpdateRequestDataStatuteOfLimitationsRemindersInnerNotificationMethod
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MatterUpdateRequestDataStatuteOfLimitationsRemindersInnerNotificationMethod`
        """
        model = MatterUpdateRequestDataStatuteOfLimitationsRemindersInnerNotificationMethod()  # noqa: E501
        if include_optional:
            return MatterUpdateRequestDataStatuteOfLimitationsRemindersInnerNotificationMethod(
                id = 56
            )
        else:
            return MatterUpdateRequestDataStatuteOfLimitationsRemindersInnerNotificationMethod(
    ...
    def testMatterUpdateRequestDataStatuteOfLimitationsRemindersInnerNotificationMethod(self):
        """Test MatterUpdateRequestDataStatuteOfLimitationsRemindersInnerNotificationMethod"""
