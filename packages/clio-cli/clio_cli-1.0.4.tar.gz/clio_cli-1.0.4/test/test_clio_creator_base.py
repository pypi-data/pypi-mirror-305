...
from openapi_client.models.clio_creator_base import ClioCreatorBase  # noqa: E501

class TestClioCreatorBase(unittest.TestCase):
    """ClioCreatorBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ClioCreatorBase:
        """Test ClioCreatorBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ClioCreatorBase`
        """
        model = ClioCreatorBase()  # noqa: E501
        if include_optional:
            return ClioCreatorBase(
                account_owner = True,
                clio_connect = True,
