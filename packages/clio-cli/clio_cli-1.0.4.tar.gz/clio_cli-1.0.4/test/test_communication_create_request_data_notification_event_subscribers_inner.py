...
from openapi_client.models.communication_create_request_data_notification_event_subscribers_inner import CommunicationCreateRequestDataNotificationEventSubscribersInner  # noqa: E501

class TestCommunicationCreateRequestDataNotificationEventSubscribersInner(unittest.TestCase):
    """CommunicationCreateRequestDataNotificationEventSubscribersInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CommunicationCreateRequestDataNotificationEventSubscribersInner:
        """Test CommunicationCreateRequestDataNotificationEventSubscribersInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CommunicationCreateRequestDataNotificationEventSubscribersInner`
        """
        model = CommunicationCreateRequestDataNotificationEventSubscribersInner()  # noqa: E501
        if include_optional:
            return CommunicationCreateRequestDataNotificationEventSubscribersInner(
                user_id = ''
            )
        else:
            return CommunicationCreateRequestDataNotificationEventSubscribersInner(
    ...
    def testCommunicationCreateRequestDataNotificationEventSubscribersInner(self):
        """Test CommunicationCreateRequestDataNotificationEventSubscribersInner"""
