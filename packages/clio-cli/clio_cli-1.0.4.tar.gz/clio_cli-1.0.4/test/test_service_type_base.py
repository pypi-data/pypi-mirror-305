...
from openapi_client.models.service_type_base import ServiceTypeBase  # noqa: E501

class TestServiceTypeBase(unittest.TestCase):
    """ServiceTypeBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ServiceTypeBase:
        """Test ServiceTypeBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ServiceTypeBase`
        """
        model = ServiceTypeBase()  # noqa: E501
        if include_optional:
