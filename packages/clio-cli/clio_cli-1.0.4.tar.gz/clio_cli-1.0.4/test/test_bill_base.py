...
from openapi_client.models.bill_base import BillBase  # noqa: E501

class TestBillBase(unittest.TestCase):
    """BillBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BillBase:
        """Test BillBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BillBase`
        """
        model = BillBase()  # noqa: E501
        if include_optional:
            return BillBase(
                id = 56,
                etag = '',
