...
from openapi_client.models.lauk_expense_category import LaukExpenseCategory  # noqa: E501

class TestLaukExpenseCategory(unittest.TestCase):
    """LaukExpenseCategory unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LaukExpenseCategory:
        """Test LaukExpenseCategory
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LaukExpenseCategory`
        """
        model = LaukExpenseCategory()  # noqa: E501
        if include_optional:
            return LaukExpenseCategory(
                certificated = True,
                civil = True,
    ...
    def testLaukExpenseCategory(self):
        """Test LaukExpenseCategory"""
