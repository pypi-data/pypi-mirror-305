...
from openapi_client.models.bill_recipient_contact_base import BillRecipientContactBase  # noqa: E501

class TestBillRecipientContactBase(unittest.TestCase):
    """BillRecipientContactBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BillRecipientContactBase:
        """Test BillRecipientContactBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BillRecipientContactBase`
        """
        model = BillRecipientContactBase()  # noqa: E501
        if include_optional:
            return BillRecipientContactBase(
                id = 56,
                name = '',
                first_name = '',
                middle_name = '',
    ...
    def testBillRecipientContactBase(self):
        """Test BillRecipientContactBase"""
