...
from openapi_client.models.calendar_visibility_update_request_data import CalendarVisibilityUpdateRequestData  # noqa: E501

class TestCalendarVisibilityUpdateRequestData(unittest.TestCase):
    """CalendarVisibilityUpdateRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CalendarVisibilityUpdateRequestData:
        """Test CalendarVisibilityUpdateRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CalendarVisibilityUpdateRequestData`
        """
        model = CalendarVisibilityUpdateRequestData()  # noqa: E501
        if include_optional:
            return CalendarVisibilityUpdateRequestData(
                color = '#367B9C',
                visible = ''
            )
        else:
    ...
    def testCalendarVisibilityUpdateRequestData(self):
        """Test CalendarVisibilityUpdateRequestData"""
