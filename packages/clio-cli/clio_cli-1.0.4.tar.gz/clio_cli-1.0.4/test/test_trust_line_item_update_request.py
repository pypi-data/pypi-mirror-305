...
from openapi_client.models.trust_line_item_update_request import TrustLineItemUpdateRequest  # noqa: E501

class TestTrustLineItemUpdateRequest(unittest.TestCase):
    """TrustLineItemUpdateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TrustLineItemUpdateRequest:
        """Test TrustLineItemUpdateRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TrustLineItemUpdateRequest`
        """
        model = TrustLineItemUpdateRequest()  # noqa: E501
        if include_optional:
            return TrustLineItemUpdateRequest(
                data = openapi_client.models.trust_line_item_update_request_data.TrustLineItem_update_request_data(
    ...
    def testTrustLineItemUpdateRequest(self):
        """Test TrustLineItemUpdateRequest"""
