...
from openapi_client.models.calendar_base import CalendarBase  # noqa: E501

class TestCalendarBase(unittest.TestCase):
    """CalendarBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CalendarBase:
        """Test CalendarBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CalendarBase`
        """
        model = CalendarBase()  # noqa: E501
        if include_optional:
            return CalendarBase(
                id = 56,
                etag = '',
