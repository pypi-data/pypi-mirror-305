...
from openapi_client.models.document_copy_request import DocumentCopyRequest  # noqa: E501

class TestDocumentCopyRequest(unittest.TestCase):
    """DocumentCopyRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentCopyRequest:
        """Test DocumentCopyRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentCopyRequest`
        """
        model = DocumentCopyRequest()  # noqa: E501
        if include_optional:
            return DocumentCopyRequest(
                data = openapi_client.models.document_copy_request_data.Document_copy_request_data(
                    communication_id = 56, 
    ...
    def testDocumentCopyRequest(self):
        """Test DocumentCopyRequest"""
