...
from openapi_client.models.trust_request_create_request_data_matter_inner import TrustRequestCreateRequestDataMatterInner  # noqa: E501

class TestTrustRequestCreateRequestDataMatterInner(unittest.TestCase):
    """TrustRequestCreateRequestDataMatterInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TrustRequestCreateRequestDataMatterInner:
        """Test TrustRequestCreateRequestDataMatterInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TrustRequestCreateRequestDataMatterInner`
        """
        model = TrustRequestCreateRequestDataMatterInner()  # noqa: E501
        if include_optional:
            return TrustRequestCreateRequestDataMatterInner(
                id = 56,
                trust_amount = 56,
                note = ''
            )
    ...
    def testTrustRequestCreateRequestDataMatterInner(self):
        """Test TrustRequestCreateRequestDataMatterInner"""
