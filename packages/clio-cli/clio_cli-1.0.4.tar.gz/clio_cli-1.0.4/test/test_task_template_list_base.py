...
from openapi_client.models.task_template_list_base import TaskTemplateListBase  # noqa: E501

class TestTaskTemplateListBase(unittest.TestCase):
    """TaskTemplateListBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TaskTemplateListBase:
        """Test TaskTemplateListBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TaskTemplateListBase`
        """
        model = TaskTemplateListBase()  # noqa: E501
        if include_optional:
            return TaskTemplateListBase(
    ...
    def testTaskTemplateListBase(self):
        """Test TaskTemplateListBase"""
