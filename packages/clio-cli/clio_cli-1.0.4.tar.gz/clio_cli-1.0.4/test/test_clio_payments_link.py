...
from openapi_client.models.clio_payments_link import ClioPaymentsLink  # noqa: E501
    ...
    def make_instance(self, include_optional) -> ClioPaymentsLink:
        ...
        if include_optional:
            return ClioPaymentsLink(
                ...
                redirect_url = '',
                url = '',
                bank_account = openapi_client.models.bank_account_base.BankAccount_base(
                    account_number = '', 
                    balance = 1.337, 
                ...
                clio_payments_payment = openapi_client.models.clio_payments_payment_base.ClioPaymentsPayment_base(
                    amount = 1.337, 
                    confirmation_number = '', 
                    created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    currency = '', 
                ...
                destination_account = openapi_client.models.bank_account_base.BankAccount_base(
                    ...
                    type = 'Operating', 
                    updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), ),
                destination_contact = openapi_client.models.contact_base.Contact_base(
                    id = 56, 
                    etag = '', 
                    name = '', 
                    first_name = '', 
