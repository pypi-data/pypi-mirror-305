...
from openapi_client.models.balance_base import BalanceBase  # noqa: E501

class TestBalanceBase(unittest.TestCase):
    """BalanceBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BalanceBase:
        """Test BalanceBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BalanceBase`
        """
        model = BalanceBase()  # noqa: E501
        if include_optional:
            return BalanceBase(
                id = 56,
                amount = 1.337,
