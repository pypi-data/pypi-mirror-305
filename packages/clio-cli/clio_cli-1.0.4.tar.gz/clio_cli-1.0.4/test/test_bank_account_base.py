...
from openapi_client.models.bank_account_base import BankAccountBase  # noqa: E501
...
class TestBankAccountBase(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> BankAccountBase:
        """Test BankAccountBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BankAccountBase`
        """
        model = BankAccountBase()  # noqa: E501
        if include_optional:
