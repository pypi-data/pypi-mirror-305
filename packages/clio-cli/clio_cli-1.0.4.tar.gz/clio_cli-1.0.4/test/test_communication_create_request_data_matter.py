...
from openapi_client.models.communication_create_request_data_matter import CommunicationCreateRequestDataMatter  # noqa: E501

class TestCommunicationCreateRequestDataMatter(unittest.TestCase):
    """CommunicationCreateRequestDataMatter unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CommunicationCreateRequestDataMatter:
        """Test CommunicationCreateRequestDataMatter
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CommunicationCreateRequestDataMatter`
        """
        model = CommunicationCreateRequestDataMatter()  # noqa: E501
        if include_optional:
            return CommunicationCreateRequestDataMatter(
                id = 56
            )
        else:
            return CommunicationCreateRequestDataMatter(
    ...
    def testCommunicationCreateRequestDataMatter(self):
        """Test CommunicationCreateRequestDataMatter"""
