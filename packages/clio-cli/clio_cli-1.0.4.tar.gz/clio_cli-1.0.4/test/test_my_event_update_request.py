...
from openapi_client.models.my_event_update_request import MyEventUpdateRequest  # noqa: E501

class TestMyEventUpdateRequest(unittest.TestCase):
    """MyEventUpdateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MyEventUpdateRequest:
        """Test MyEventUpdateRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MyEventUpdateRequest`
        """
        model = MyEventUpdateRequest()  # noqa: E501
        if include_optional:
            return MyEventUpdateRequest(
                data = openapi_client.models.my_event_update_request_data.MyEvent_update_request_data(
                    marked_as_read = True, )
            )
        else:
            return MyEventUpdateRequest(
    ...
    def testMyEventUpdateRequest(self):
        """Test MyEventUpdateRequest"""
