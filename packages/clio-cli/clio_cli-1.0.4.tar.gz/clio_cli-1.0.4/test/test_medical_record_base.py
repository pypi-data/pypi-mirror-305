...
from openapi_client.models.medical_record_base import MedicalRecordBase  # noqa: E501

class TestMedicalRecordBase(unittest.TestCase):
    """MedicalRecordBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MedicalRecordBase:
        """Test MedicalRecordBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MedicalRecordBase`
        """
        model = MedicalRecordBase()  # noqa: E501
        if include_optional:
    ...
    def testMedicalRecordBase(self):
        """Test MedicalRecordBase"""
