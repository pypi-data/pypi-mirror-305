...
from openapi_client.models.contact_create_request_data import ContactCreateRequestData  # noqa: E501

class TestContactCreateRequestData(unittest.TestCase):
    """ContactCreateRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ContactCreateRequestData:
        """Test ContactCreateRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ContactCreateRequestData`
        """
        model = ContactCreateRequestData()  # noqa: E501
        if include_optional:
            return ContactCreateRequestData(
                addresses = [
                    openapi_client.models.contact_create_request_data_addresses_inner.Contact_create_request_data_addresses_inner(
                        name = 'Other', 
                        street = '', 
                        city = '', 
                        province = '', 
                ...
                avatar = openapi_client.models.contact_create_request_data_avatar.Contact_create_request_data_avatar(
                    image = '', 
                    _destroy = True, ),
                clio_connect_email = '',
                co_counsel_rate = openapi_client.models.contact_create_request_data_co_counsel_rate.Contact_create_request_data_co_counsel_rate(
                    rate = 1.337, ),
                company = openapi_client.models.contact_create_request_data_company.Contact_create_request_data_company(
                    id = 56, ),
                custom_field_set_associations = [
                    openapi_client.models.contact_create_request_data_custom_field_set_associations_inner.Contact_create_request_data_custom_field_set_associations_inner(
                        display_order = 56, 
                ...
                email_addresses = [
                    openapi_client.models.contact_create_request_data_email_addresses_inner.Contact_create_request_data_email_addresses_inner(
                        name = 'Other', 
                        address = '', 
                        default_email = True, )
                    ],
                first_name = '',
                instant_messengers = [
                    openapi_client.models.contact_create_request_data_instant_messengers_inner.Contact_create_request_data_instant_messengers_inner(
                        name = 'Other', 
                        address = '', )
                    ],
                last_name = '',
                ...
                name = '',
                phone_numbers = [
                    openapi_client.models.contact_create_request_data_phone_numbers_inner.Contact_create_request_data_phone_numbers_inner(
                        name = 'Other', 
                        number = '', 
                        default_number = True, )
                    ],
                ...
                type = 'Person',
                web_sites = [
                    openapi_client.models.contact_create_request_data_web_sites_inner.Contact_create_request_data_web_sites_inner(
                        name = 'Other', 
                        address = '', 
    ...
    def testContactCreateRequestData(self):
        """Test ContactCreateRequestData"""
