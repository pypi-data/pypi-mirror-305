...
from openapi_client.models.report_schedule_create_request import ReportScheduleCreateRequest  # noqa: E501

class TestReportScheduleCreateRequest(unittest.TestCase):
    """ReportScheduleCreateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReportScheduleCreateRequest:
        """Test ReportScheduleCreateRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReportScheduleCreateRequest`
        """
        model = ReportScheduleCreateRequest()  # noqa: E501
        if include_optional:
            return ReportScheduleCreateRequest(
                data = openapi_client.models.report_schedule_create_request_data.ReportSchedule_create_request_data(
                    day_of_month = 56, 
                    days_of_week = [
                        56
                        ], 
    ...
    def testReportScheduleCreateRequest(self):
        """Test ReportScheduleCreateRequest"""
