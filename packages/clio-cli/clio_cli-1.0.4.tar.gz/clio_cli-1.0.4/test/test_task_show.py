...
from openapi_client.models.task_show import TaskShow  # noqa: E501

class TestTaskShow(unittest.TestCase):
    """TaskShow unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TaskShow:
        """Test TaskShow
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TaskShow`
        """
        model = TaskShow()  # noqa: E501
        if include_optional:
            return TaskShow(
                data = None
            )
