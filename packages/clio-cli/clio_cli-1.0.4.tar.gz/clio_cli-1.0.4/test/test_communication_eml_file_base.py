...
from openapi_client.models.communication_eml_file_base import CommunicationEmlFileBase  # noqa: E501

class TestCommunicationEmlFileBase(unittest.TestCase):
    """CommunicationEmlFileBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CommunicationEmlFileBase:
        """Test CommunicationEmlFileBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CommunicationEmlFileBase`
        """
        model = CommunicationEmlFileBase()  # noqa: E501
        if include_optional:
            return CommunicationEmlFileBase(
                id = 56
            )
        else:
            return CommunicationEmlFileBase(
    ...
    def testCommunicationEmlFileBase(self):
        """Test CommunicationEmlFileBase"""
