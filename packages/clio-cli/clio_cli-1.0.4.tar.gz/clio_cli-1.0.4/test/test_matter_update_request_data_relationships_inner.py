...
from openapi_client.models.matter_update_request_data_relationships_inner import MatterUpdateRequestDataRelationshipsInner  # noqa: E501

class TestMatterUpdateRequestDataRelationshipsInner(unittest.TestCase):
    """MatterUpdateRequestDataRelationshipsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MatterUpdateRequestDataRelationshipsInner:
        """Test MatterUpdateRequestDataRelationshipsInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MatterUpdateRequestDataRelationshipsInner`
        """
        model = MatterUpdateRequestDataRelationshipsInner()  # noqa: E501
        if include_optional:
            return MatterUpdateRequestDataRelationshipsInner(
                description = '',
    ...
    def testMatterUpdateRequestDataRelationshipsInner(self):
        """Test MatterUpdateRequestDataRelationshipsInner"""
