...
from openapi_client.models.task_template_list_copy_request import TaskTemplateListCopyRequest  # noqa: E501

class TestTaskTemplateListCopyRequest(unittest.TestCase):
    """TaskTemplateListCopyRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TaskTemplateListCopyRequest:
        """Test TaskTemplateListCopyRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TaskTemplateListCopyRequest`
        """
        model = TaskTemplateListCopyRequest()  # noqa: E501
        if include_optional:
            return TaskTemplateListCopyRequest(
                data = openapi_client.models.task_template_list_copy_request_data.TaskTemplateList_copy_request_data(
                    description = '', 
                    name = '', 
                    practice_area = openapi_client.models.task_template_list_copy_request_data_practice_area.TaskTemplateList_copy_request_data_practice_area(
                        id = 56, ), )
            )
        else:
            return TaskTemplateListCopyRequest(
    ...
    def testTaskTemplateListCopyRequest(self):
        """Test TaskTemplateListCopyRequest"""
