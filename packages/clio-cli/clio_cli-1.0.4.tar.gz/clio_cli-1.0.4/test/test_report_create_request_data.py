...
from openapi_client.models.report_create_request_data import ReportCreateRequestData  # noqa: E501

class TestReportCreateRequestData(unittest.TestCase):
    """ReportCreateRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReportCreateRequestData:
        """Test ReportCreateRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReportCreateRequestData`
        """
        model = ReportCreateRequestData()  # noqa: E501
        if include_optional:
            return ReportCreateRequestData(
                client = openapi_client.models.report_create_request_data_client.Report_create_request_data_client(
                    id = 56, ),
                end_date = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(),
                format = 'csv',
                kind = 'accounts_receivable',
                matter = openapi_client.models.report_create_request_data_matter.Report_create_request_data_matter(
                    id = 56, ),
                originating_attorney = openapi_client.models.report_create_request_data_originating_attorney.Report_create_request_data_originating_attorney(
                    id = 56, ),
                practice_area = openapi_client.models.report_create_request_data_practice_area.Report_create_request_data_practice_area(
                    id = 56, ),
                responsible_attorney = openapi_client.models.report_create_request_data_originating_attorney.Report_create_request_data_originating_attorney(
                    id = 56, ),
                start_date = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(),
                user = openapi_client.models.report_create_request_data_originating_attorney.Report_create_request_data_originating_attorney(
                    id = 56, ),
                year = ''
            )
        else:
    ...
    def testReportCreateRequestData(self):
        """Test ReportCreateRequestData"""
