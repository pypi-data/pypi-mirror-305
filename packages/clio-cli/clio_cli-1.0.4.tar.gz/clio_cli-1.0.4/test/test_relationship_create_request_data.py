...
from openapi_client.models.relationship_create_request_data import RelationshipCreateRequestData  # noqa: E501

class TestRelationshipCreateRequestData(unittest.TestCase):
    """RelationshipCreateRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RelationshipCreateRequestData:
        """Test RelationshipCreateRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RelationshipCreateRequestData`
        """
        model = RelationshipCreateRequestData()  # noqa: E501
        if include_optional:
            return RelationshipCreateRequestData(
    ...
    def testRelationshipCreateRequestData(self):
        """Test RelationshipCreateRequestData"""
