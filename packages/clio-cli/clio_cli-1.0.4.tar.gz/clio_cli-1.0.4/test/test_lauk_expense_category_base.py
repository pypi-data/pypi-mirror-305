...
from openapi_client.models.lauk_expense_category_base import LaukExpenseCategoryBase  # noqa: E501

class TestLaukExpenseCategoryBase(unittest.TestCase):
    """LaukExpenseCategoryBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LaukExpenseCategoryBase:
        """Test LaukExpenseCategoryBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LaukExpenseCategoryBase`
        """
        model = LaukExpenseCategoryBase()  # noqa: E501
        if include_optional:
            return LaukExpenseCategoryBase(
                certificated = True,
                civil = True,
    ...
    def testLaukExpenseCategoryBase(self):
        """Test LaukExpenseCategoryBase"""
