...
from openapi_client.models.medical_records_request_create_request_data import MedicalRecordsRequestCreateRequestData  # noqa: E501

class TestMedicalRecordsRequestCreateRequestData(unittest.TestCase):
    """MedicalRecordsRequestCreateRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MedicalRecordsRequestCreateRequestData:
        """Test MedicalRecordsRequestCreateRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MedicalRecordsRequestCreateRequestData`
        """
        model = MedicalRecordsRequestCreateRequestData()  # noqa: E501
        if include_optional:
            return MedicalRecordsRequestCreateRequestData(
    ...
    def testMedicalRecordsRequestCreateRequestData(self):
        """Test MedicalRecordsRequestCreateRequestData"""
