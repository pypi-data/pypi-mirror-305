...
from openapi_client.models.calendar_entry_update_request_data import CalendarEntryUpdateRequestData  # noqa: E501

class TestCalendarEntryUpdateRequestData(unittest.TestCase):
    """CalendarEntryUpdateRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CalendarEntryUpdateRequestData:
        """Test CalendarEntryUpdateRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CalendarEntryUpdateRequestData`
        """
        model = CalendarEntryUpdateRequestData()  # noqa: E501
        if include_optional:
            return CalendarEntryUpdateRequestData(
                deleted = 'single',
                all_day = True,
                attendees = [
    ...
    def testCalendarEntryUpdateRequestData(self):
        """Test CalendarEntryUpdateRequestData"""
