...
from openapi_client.models.billable_matter import BillableMatter  # noqa: E501

class TestBillableMatter(unittest.TestCase):
    """BillableMatter unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BillableMatter:
        """Test BillableMatter
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BillableMatter`
        """
        model = BillableMatter()  # noqa: E501
        if include_optional:
            return BillableMatter(
                id = 56,
