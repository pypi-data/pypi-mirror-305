...
from openapi_client.models.utbms_code import UtbmsCode  # noqa: E501

class TestUtbmsCode(unittest.TestCase):
    """UtbmsCode unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UtbmsCode:
        """Test UtbmsCode
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UtbmsCode`
        """
        model = UtbmsCode()  # noqa: E501
        if include_optional:
            return UtbmsCode(
                id = 56,
                etag = '',
