...
from openapi_client.models.activity_description_update_request_data import ActivityDescriptionUpdateRequestData  # noqa: E501

class TestActivityDescriptionUpdateRequestData(unittest.TestCase):
    """ActivityDescriptionUpdateRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ActivityDescriptionUpdateRequestData:
        """Test ActivityDescriptionUpdateRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ActivityDescriptionUpdateRequestData`
        """
        model = ActivityDescriptionUpdateRequestData()  # noqa: E501
        if include_optional:
            return ActivityDescriptionUpdateRequestData(
                default = True,
                groups = [
    ...
    def testActivityDescriptionUpdateRequestData(self):
        """Test ActivityDescriptionUpdateRequestData"""
