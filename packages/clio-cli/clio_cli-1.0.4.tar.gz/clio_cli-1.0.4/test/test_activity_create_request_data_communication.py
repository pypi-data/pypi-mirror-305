...
from openapi_client.models.activity_create_request_data_communication import ActivityCreateRequestDataCommunication  # noqa: E501

class TestActivityCreateRequestDataCommunication(unittest.TestCase):
    """ActivityCreateRequestDataCommunication unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ActivityCreateRequestDataCommunication:
        """Test ActivityCreateRequestDataCommunication
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ActivityCreateRequestDataCommunication`
        """
        model = ActivityCreateRequestDataCommunication()  # noqa: E501
        if include_optional:
            return ActivityCreateRequestDataCommunication(
                id = 56
            )
        else:
            return ActivityCreateRequestDataCommunication(
    ...
    def testActivityCreateRequestDataCommunication(self):
        """Test ActivityCreateRequestDataCommunication"""
