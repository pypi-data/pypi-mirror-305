...
from openapi_client.models.expense_category_create_request_data_utbms_code import ExpenseCategoryCreateRequestDataUtbmsCode  # noqa: E501

class TestExpenseCategoryCreateRequestDataUtbmsCode(unittest.TestCase):
    """ExpenseCategoryCreateRequestDataUtbmsCode unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExpenseCategoryCreateRequestDataUtbmsCode:
        """Test ExpenseCategoryCreateRequestDataUtbmsCode
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExpenseCategoryCreateRequestDataUtbmsCode`
        """
        model = ExpenseCategoryCreateRequestDataUtbmsCode()  # noqa: E501
        if include_optional:
            return ExpenseCategoryCreateRequestDataUtbmsCode(
                id = 56
            )
        else:
            return ExpenseCategoryCreateRequestDataUtbmsCode(
    ...
    def testExpenseCategoryCreateRequestDataUtbmsCode(self):
        """Test ExpenseCategoryCreateRequestDataUtbmsCode"""
