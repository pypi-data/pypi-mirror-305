...
from openapi_client.models.picklist_option_base import PicklistOptionBase  # noqa: E501

class TestPicklistOptionBase(unittest.TestCase):
    """PicklistOptionBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PicklistOptionBase:
        """Test PicklistOptionBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PicklistOptionBase`
        """
        model = PicklistOptionBase()  # noqa: E501
        if include_optional:
            return PicklistOptionBase(
                id = 56,
                etag = '',
    ...
    def testPicklistOptionBase(self):
        """Test PicklistOptionBase"""
