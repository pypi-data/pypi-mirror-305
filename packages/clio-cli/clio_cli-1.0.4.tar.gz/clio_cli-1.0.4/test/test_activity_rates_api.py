...
from openapi_client.api.activity_rates_api import ActivityRatesApi  # noqa: E501


class TestActivityRatesApi(unittest.TestCase):
    """ActivityRatesApi unit test stubs"""

    def setUp(self) -> None:
        self.api = ActivityRatesApi()

    def tearDown(self) -> None:
        pass

    def test_activity_rate_create(self) -> None:
    ...
    def test_activity_rate_destroy(self) -> None:
    ...
    def test_activity_rate_index(self) -> None:
    ...
    def test_activity_rate_show(self) -> None:
    ...
    def test_activity_rate_update(self) -> None:
