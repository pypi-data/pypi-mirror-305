...
from openapi_client.models.activity_rate_show import ActivityRateShow  # noqa: E501

class TestActivityRateShow(unittest.TestCase):
    """ActivityRateShow unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ActivityRateShow:
        """Test ActivityRateShow
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ActivityRateShow`
        """
        model = ActivityRateShow()  # noqa: E501
        if include_optional:
            return ActivityRateShow(
                data = None
            )
        else:
            return ActivityRateShow(
