...
from openapi_client.models.conversation_update_request_data_matter import ConversationUpdateRequestDataMatter  # noqa: E501

class TestConversationUpdateRequestDataMatter(unittest.TestCase):
    """ConversationUpdateRequestDataMatter unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConversationUpdateRequestDataMatter:
        """Test ConversationUpdateRequestDataMatter
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConversationUpdateRequestDataMatter`
        """
        model = ConversationUpdateRequestDataMatter()  # noqa: E501
        if include_optional:
            return ConversationUpdateRequestDataMatter(
                id = 56
            )
        else:
            return ConversationUpdateRequestDataMatter(
    ...
    def testConversationUpdateRequestDataMatter(self):
        """Test ConversationUpdateRequestDataMatter"""
