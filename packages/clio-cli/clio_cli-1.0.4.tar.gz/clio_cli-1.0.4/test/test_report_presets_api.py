...
from openapi_client.api.report_presets_api import ReportPresetsApi  # noqa: E501


class TestReportPresetsApi(unittest.TestCase):
    """ReportPresetsApi unit test stubs"""

    def setUp(self) -> None:
        self.api = ReportPresetsApi()

    def tearDown(self) -> None:
        pass

    def test_report_preset_create(self) -> None:
    ...
    def test_report_preset_destroy(self) -> None:
    ...
    def test_report_preset_generate_report(self) -> None:
    ...
    def test_report_preset_index(self) -> None:
    ...
    def test_report_preset_show(self) -> None:
    ...
    def test_report_preset_update(self) -> None:
