...
from openapi_client.api.document_automations_api import DocumentAutomationsApi  # noqa: E501


class TestDocumentAutomationsApi(unittest.TestCase):
    """DocumentAutomationsApi unit test stubs"""

    def setUp(self) -> None:
        self.api = DocumentAutomationsApi()

    def tearDown(self) -> None:
        pass

    def test_document_automation_create(self) -> None:
    ...
    def test_document_automation_index(self) -> None:
    ...
    def test_document_automation_show(self) -> None:
