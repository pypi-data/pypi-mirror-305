...
from openapi_client.api.text_snippets_api import TextSnippetsApi  # noqa: E501


class TestTextSnippetsApi(unittest.TestCase):
    """TextSnippetsApi unit test stubs"""

    def setUp(self) -> None:
        self.api = TextSnippetsApi()

    def tearDown(self) -> None:
        pass

    def test_text_snippet_create(self) -> None:
    ...
    def test_text_snippet_destroy(self) -> None:
    ...
    def test_text_snippet_index(self) -> None:
    ...
    def test_text_snippet_show(self) -> None:
    ...
    def test_text_snippet_update(self) -> None:
