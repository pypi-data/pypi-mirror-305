...
from openapi_client.models.custom_field_set_update_request import CustomFieldSetUpdateRequest  # noqa: E501

class TestCustomFieldSetUpdateRequest(unittest.TestCase):
    """CustomFieldSetUpdateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CustomFieldSetUpdateRequest:
        """Test CustomFieldSetUpdateRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CustomFieldSetUpdateRequest`
        """
        model = CustomFieldSetUpdateRequest()  # noqa: E501
        if include_optional:
            return CustomFieldSetUpdateRequest(
                data = openapi_client.models.custom_field_set_update_request_data.CustomFieldSet_update_request_data(
                    displayed = True, 
                    name = '', 
                    parent_type = 'Contact', )
            )
    ...
    def testCustomFieldSetUpdateRequest(self):
        """Test CustomFieldSetUpdateRequest"""
