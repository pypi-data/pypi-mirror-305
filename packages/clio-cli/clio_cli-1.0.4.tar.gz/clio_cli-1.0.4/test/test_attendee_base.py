...
from openapi_client.models.attendee_base import AttendeeBase  # noqa: E501

class TestAttendeeBase(unittest.TestCase):
    """AttendeeBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AttendeeBase:
        """Test AttendeeBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AttendeeBase`
        """
        model = AttendeeBase()  # noqa: E501
        if include_optional:
            return AttendeeBase(
                id = 56,
                etag = '',
