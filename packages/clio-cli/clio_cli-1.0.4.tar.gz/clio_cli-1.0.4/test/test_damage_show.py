...
from openapi_client.models.damage_show import DamageShow  # noqa: E501

class TestDamageShow(unittest.TestCase):
    """DamageShow unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DamageShow:
        """Test DamageShow
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DamageShow`
        """
        model = DamageShow()  # noqa: E501
        if include_optional:
            return DamageShow(
                data = None
            )
