...
from openapi_client.api.related_contacts_api import RelatedContactsApi  # noqa: E501


class TestRelatedContactsApi(unittest.TestCase):
    """RelatedContactsApi unit test stubs"""

    def setUp(self) -> None:
        self.api = RelatedContactsApi()

    def tearDown(self) -> None:
        pass

    def test_related_contacts_index(self) -> None:
