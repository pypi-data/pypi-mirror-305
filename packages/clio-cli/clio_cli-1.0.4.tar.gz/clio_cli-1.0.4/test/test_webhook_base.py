...
from openapi_client.models.webhook_base import WebhookBase  # noqa: E501

class TestWebhookBase(unittest.TestCase):
    """WebhookBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebhookBase:
        """Test WebhookBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebhookBase`
        """
        model = WebhookBase()  # noqa: E501
        if include_optional:
            return WebhookBase(
                id = 56,
                etag = '',
