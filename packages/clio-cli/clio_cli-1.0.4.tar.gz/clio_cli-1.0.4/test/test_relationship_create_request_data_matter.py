...
from openapi_client.models.relationship_create_request_data_matter import RelationshipCreateRequestDataMatter  # noqa: E501

class TestRelationshipCreateRequestDataMatter(unittest.TestCase):
    """RelationshipCreateRequestDataMatter unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RelationshipCreateRequestDataMatter:
        """Test RelationshipCreateRequestDataMatter
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RelationshipCreateRequestDataMatter`
        """
        model = RelationshipCreateRequestDataMatter()  # noqa: E501
        if include_optional:
            return RelationshipCreateRequestDataMatter(
                id = 56
            )
        else:
            return RelationshipCreateRequestDataMatter(
    ...
    def testRelationshipCreateRequestDataMatter(self):
        """Test RelationshipCreateRequestDataMatter"""
