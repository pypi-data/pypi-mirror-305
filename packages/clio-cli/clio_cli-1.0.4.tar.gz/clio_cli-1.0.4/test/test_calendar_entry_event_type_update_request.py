...
from openapi_client.models.calendar_entry_event_type_update_request import CalendarEntryEventTypeUpdateRequest  # noqa: E501

class TestCalendarEntryEventTypeUpdateRequest(unittest.TestCase):
    """CalendarEntryEventTypeUpdateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CalendarEntryEventTypeUpdateRequest:
        """Test CalendarEntryEventTypeUpdateRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CalendarEntryEventTypeUpdateRequest`
        """
        model = CalendarEntryEventTypeUpdateRequest()  # noqa: E501
        if include_optional:
            return CalendarEntryEventTypeUpdateRequest(
                data = openapi_client.models.calendar_entry_event_type_update_request_data.CalendarEntryEventType_update_request_data(
                    color = '#367B9C', 
                    name = '', )
            )
        else:
    ...
    def testCalendarEntryEventTypeUpdateRequest(self):
        """Test CalendarEntryEventTypeUpdateRequest"""
