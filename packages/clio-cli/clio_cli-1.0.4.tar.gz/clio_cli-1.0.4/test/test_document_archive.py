...
from openapi_client.models.document_archive import DocumentArchive  # noqa: E501

class TestDocumentArchive(unittest.TestCase):
    """DocumentArchive unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentArchive:
        """Test DocumentArchive
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentArchive`
        """
        model = DocumentArchive()  # noqa: E501
        if include_optional:
