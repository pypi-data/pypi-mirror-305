...
from openapi_client.models.activity_create_request_data_calendar_entry import ActivityCreateRequestDataCalendarEntry  # noqa: E501

class TestActivityCreateRequestDataCalendarEntry(unittest.TestCase):
    """ActivityCreateRequestDataCalendarEntry unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ActivityCreateRequestDataCalendarEntry:
        """Test ActivityCreateRequestDataCalendarEntry
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ActivityCreateRequestDataCalendarEntry`
        """
        model = ActivityCreateRequestDataCalendarEntry()  # noqa: E501
        if include_optional:
            return ActivityCreateRequestDataCalendarEntry(
                id = 56
            )
        else:
            return ActivityCreateRequestDataCalendarEntry(
    ...
    def testActivityCreateRequestDataCalendarEntry(self):
        """Test ActivityCreateRequestDataCalendarEntry"""
