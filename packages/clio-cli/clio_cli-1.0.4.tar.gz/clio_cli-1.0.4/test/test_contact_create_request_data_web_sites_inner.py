...
from openapi_client.models.contact_create_request_data_web_sites_inner import ContactCreateRequestDataWebSitesInner  # noqa: E501

class TestContactCreateRequestDataWebSitesInner(unittest.TestCase):
    """ContactCreateRequestDataWebSitesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ContactCreateRequestDataWebSitesInner:
        """Test ContactCreateRequestDataWebSitesInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ContactCreateRequestDataWebSitesInner`
        """
        model = ContactCreateRequestDataWebSitesInner()  # noqa: E501
        if include_optional:
            return ContactCreateRequestDataWebSitesInner(
                name = 'Other',
                address = '',
    ...
    def testContactCreateRequestDataWebSitesInner(self):
        """Test ContactCreateRequestDataWebSitesInner"""
