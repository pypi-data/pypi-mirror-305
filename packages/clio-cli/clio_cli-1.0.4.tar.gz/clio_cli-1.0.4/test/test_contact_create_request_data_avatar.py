...
from openapi_client.models.contact_create_request_data_avatar import ContactCreateRequestDataAvatar  # noqa: E501

class TestContactCreateRequestDataAvatar(unittest.TestCase):
    """ContactCreateRequestDataAvatar unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ContactCreateRequestDataAvatar:
        """Test ContactCreateRequestDataAvatar
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ContactCreateRequestDataAvatar`
        """
        model = ContactCreateRequestDataAvatar()  # noqa: E501
        if include_optional:
            return ContactCreateRequestDataAvatar(
                image = '',
                destroy = True
            )
        else:
    ...
    def testContactCreateRequestDataAvatar(self):
        """Test ContactCreateRequestDataAvatar"""
