...
from openapi_client.models.document_template_list import DocumentTemplateList  # noqa: E501
...
class TestDocumentTemplateList(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DocumentTemplateList:
        """Test DocumentTemplateList
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentTemplateList`
        """
        model = DocumentTemplateList()  # noqa: E501
        if include_optional:
