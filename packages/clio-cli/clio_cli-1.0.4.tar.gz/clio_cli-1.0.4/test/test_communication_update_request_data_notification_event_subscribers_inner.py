...
from openapi_client.models.communication_update_request_data_notification_event_subscribers_inner import CommunicationUpdateRequestDataNotificationEventSubscribersInner  # noqa: E501

class TestCommunicationUpdateRequestDataNotificationEventSubscribersInner(unittest.TestCase):
    """CommunicationUpdateRequestDataNotificationEventSubscribersInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CommunicationUpdateRequestDataNotificationEventSubscribersInner:
        """Test CommunicationUpdateRequestDataNotificationEventSubscribersInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CommunicationUpdateRequestDataNotificationEventSubscribersInner`
        """
        model = CommunicationUpdateRequestDataNotificationEventSubscribersInner()  # noqa: E501
        if include_optional:
            return CommunicationUpdateRequestDataNotificationEventSubscribersInner(
                user_id = '',
                id = 56,
                destroy = True
            )
    ...
    def testCommunicationUpdateRequestDataNotificationEventSubscribersInner(self):
        """Test CommunicationUpdateRequestDataNotificationEventSubscribersInner"""
