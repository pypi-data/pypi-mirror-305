...
from openapi_client.models.medical_bill_show import MedicalBillShow  # noqa: E501

class TestMedicalBillShow(unittest.TestCase):
    """MedicalBillShow unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MedicalBillShow:
        """Test MedicalBillShow
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MedicalBillShow`
        """
        model = MedicalBillShow()  # noqa: E501
        if include_optional:
            return MedicalBillShow(
                data = None
            )
        else:
            return MedicalBillShow(
