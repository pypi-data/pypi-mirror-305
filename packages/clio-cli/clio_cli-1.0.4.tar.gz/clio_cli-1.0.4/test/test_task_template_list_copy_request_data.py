...
from openapi_client.models.task_template_list_copy_request_data import TaskTemplateListCopyRequestData  # noqa: E501

class TestTaskTemplateListCopyRequestData(unittest.TestCase):
    """TaskTemplateListCopyRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TaskTemplateListCopyRequestData:
        """Test TaskTemplateListCopyRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TaskTemplateListCopyRequestData`
        """
        model = TaskTemplateListCopyRequestData()  # noqa: E501
        if include_optional:
            return TaskTemplateListCopyRequestData(
                description = '',
                name = '',
    ...
    def testTaskTemplateListCopyRequestData(self):
        """Test TaskTemplateListCopyRequestData"""
