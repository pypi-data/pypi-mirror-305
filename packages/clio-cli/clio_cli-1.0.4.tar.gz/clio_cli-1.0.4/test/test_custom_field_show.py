...
from openapi_client.models.custom_field_show import CustomFieldShow  # noqa: E501

class TestCustomFieldShow(unittest.TestCase):
    """CustomFieldShow unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CustomFieldShow:
        """Test CustomFieldShow
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CustomFieldShow`
        """
        model = CustomFieldShow()  # noqa: E501
        if include_optional:
