...
from openapi_client.models.document_category_list import DocumentCategoryList  # noqa: E501

class TestDocumentCategoryList(unittest.TestCase):
    """DocumentCategoryList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentCategoryList:
        """Test DocumentCategoryList
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentCategoryList`
        """
        model = DocumentCategoryList()  # noqa: E501
        if include_optional:
    ...
    def testDocumentCategoryList(self):
        """Test DocumentCategoryList"""
