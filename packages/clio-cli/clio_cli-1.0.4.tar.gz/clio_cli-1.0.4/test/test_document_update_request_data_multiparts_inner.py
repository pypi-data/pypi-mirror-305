...
from openapi_client.models.document_update_request_data_multiparts_inner import DocumentUpdateRequestDataMultipartsInner  # noqa: E501

class TestDocumentUpdateRequestDataMultipartsInner(unittest.TestCase):
    """DocumentUpdateRequestDataMultipartsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentUpdateRequestDataMultipartsInner:
        """Test DocumentUpdateRequestDataMultipartsInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentUpdateRequestDataMultipartsInner`
        """
        model = DocumentUpdateRequestDataMultipartsInner()  # noqa: E501
        if include_optional:
            return DocumentUpdateRequestDataMultipartsInner(
                part_number = 56,
                content_length = '',
                content_md5 = ''
            )
    ...
    def testDocumentUpdateRequestDataMultipartsInner(self):
        """Test DocumentUpdateRequestDataMultipartsInner"""
