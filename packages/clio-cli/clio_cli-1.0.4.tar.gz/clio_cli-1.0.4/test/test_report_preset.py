...
from openapi_client.models.report_preset import ReportPreset  # noqa: E501

class TestReportPreset(unittest.TestCase):
    """ReportPreset unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReportPreset:
        """Test ReportPreset
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReportPreset`
        """
        model = ReportPreset()  # noqa: E501
        if include_optional:
            return ReportPreset(
                id = 56,
                etag = '',
                ...
                format = 'csv',
                last_generated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'),
                created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'),
                updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'),
                category = 'billing',
                options = '',
                report_schedule = openapi_client.models.report_schedule_base.ReportSchedule_base(
                    id = 56, 
                    etag = '', 
                    ...
                    next_scheduled_date = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    time_zone = '', 
                    report_preset_id = 56, 
                    created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
