...
from openapi_client.models.contact_show import ContactShow  # noqa: E501

class TestContactShow(unittest.TestCase):
    """ContactShow unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ContactShow:
        """Test ContactShow
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ContactShow`
        """
        model = ContactShow()  # noqa: E501
        if include_optional:
            return ContactShow(
                data = None
            )
