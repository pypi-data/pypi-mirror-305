...
from openapi_client.models.matter_custom_rate_base import MatterCustomRateBase  # noqa: E501

class TestMatterCustomRateBase(unittest.TestCase):
    """MatterCustomRateBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MatterCustomRateBase:
        """Test MatterCustomRateBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MatterCustomRateBase`
        """
        model = MatterCustomRateBase()  # noqa: E501
        if include_optional:
            return MatterCustomRateBase(
                type = 'FlatRate',
                on_invoice = True
            )
        else:
    ...
    def testMatterCustomRateBase(self):
        """Test MatterCustomRateBase"""
