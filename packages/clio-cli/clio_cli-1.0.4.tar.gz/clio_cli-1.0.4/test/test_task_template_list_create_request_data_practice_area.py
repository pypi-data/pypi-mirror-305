...
from openapi_client.models.task_template_list_create_request_data_practice_area import TaskTemplateListCreateRequestDataPracticeArea  # noqa: E501

class TestTaskTemplateListCreateRequestDataPracticeArea(unittest.TestCase):
    """TaskTemplateListCreateRequestDataPracticeArea unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TaskTemplateListCreateRequestDataPracticeArea:
        """Test TaskTemplateListCreateRequestDataPracticeArea
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TaskTemplateListCreateRequestDataPracticeArea`
        """
        model = TaskTemplateListCreateRequestDataPracticeArea()  # noqa: E501
        if include_optional:
            return TaskTemplateListCreateRequestDataPracticeArea(
                id = 56
            )
        else:
            return TaskTemplateListCreateRequestDataPracticeArea(
    ...
    def testTaskTemplateListCreateRequestDataPracticeArea(self):
        """Test TaskTemplateListCreateRequestDataPracticeArea"""
