...
from openapi_client.api.calendar_entries_api import CalendarEntriesApi  # noqa: E501


class TestCalendarEntriesApi(unittest.TestCase):
    """CalendarEntriesApi unit test stubs"""

    def setUp(self) -> None:
        self.api = CalendarEntriesApi()

    def tearDown(self) -> None:
        pass

    def test_calendar_entry_create(self) -> None:
    ...
    def test_calendar_entry_destroy(self) -> None:
    ...
    def test_calendar_entry_index(self) -> None:
    ...
    def test_calendar_entry_show(self) -> None:
    ...
    def test_calendar_entry_update(self) -> None:
