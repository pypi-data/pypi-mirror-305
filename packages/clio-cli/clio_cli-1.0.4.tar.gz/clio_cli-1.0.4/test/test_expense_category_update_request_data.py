...
from openapi_client.models.expense_category_update_request_data import ExpenseCategoryUpdateRequestData  # noqa: E501

class TestExpenseCategoryUpdateRequestData(unittest.TestCase):
    """ExpenseCategoryUpdateRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExpenseCategoryUpdateRequestData:
        """Test ExpenseCategoryUpdateRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExpenseCategoryUpdateRequestData`
        """
        model = ExpenseCategoryUpdateRequestData()  # noqa: E501
        if include_optional:
            return ExpenseCategoryUpdateRequestData(
    ...
    def testExpenseCategoryUpdateRequestData(self):
        """Test ExpenseCategoryUpdateRequestData"""
