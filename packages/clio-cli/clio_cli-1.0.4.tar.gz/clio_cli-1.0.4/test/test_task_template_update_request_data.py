...
from openapi_client.models.task_template_update_request_data import TaskTemplateUpdateRequestData  # noqa: E501

class TestTaskTemplateUpdateRequestData(unittest.TestCase):
    """TaskTemplateUpdateRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TaskTemplateUpdateRequestData:
        """Test TaskTemplateUpdateRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TaskTemplateUpdateRequestData`
        """
        model = TaskTemplateUpdateRequestData()  # noqa: E501
        if include_optional:
            return TaskTemplateUpdateRequestData(
                cascading = True,
                cascading_offset = 56,
    ...
    def testTaskTemplateUpdateRequestData(self):
        """Test TaskTemplateUpdateRequestData"""
