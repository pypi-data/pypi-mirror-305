...
from openapi_client.models.calendar_entry_event_type_update_request_data import CalendarEntryEventTypeUpdateRequestData  # noqa: E501

class TestCalendarEntryEventTypeUpdateRequestData(unittest.TestCase):
    """CalendarEntryEventTypeUpdateRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CalendarEntryEventTypeUpdateRequestData:
        """Test CalendarEntryEventTypeUpdateRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CalendarEntryEventTypeUpdateRequestData`
        """
        model = CalendarEntryEventTypeUpdateRequestData()  # noqa: E501
        if include_optional:
            return CalendarEntryEventTypeUpdateRequestData(
                color = '#367B9C',
                name = ''
            )
        else:
    ...
    def testCalendarEntryEventTypeUpdateRequestData(self):
        """Test CalendarEntryEventTypeUpdateRequestData"""
