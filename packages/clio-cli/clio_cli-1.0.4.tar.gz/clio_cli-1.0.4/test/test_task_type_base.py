...
from openapi_client.models.task_type_base import TaskTypeBase  # noqa: E501

class TestTaskTypeBase(unittest.TestCase):
    """TaskTypeBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TaskTypeBase:
        """Test TaskTypeBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TaskTypeBase`
        """
        model = TaskTypeBase()  # noqa: E501
        if include_optional:
            return TaskTypeBase(
                id = 56,
                etag = '',
