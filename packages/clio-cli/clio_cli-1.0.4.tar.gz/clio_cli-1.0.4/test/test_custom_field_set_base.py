...
from openapi_client.models.custom_field_set_base import CustomFieldSetBase  # noqa: E501

class TestCustomFieldSetBase(unittest.TestCase):
    """CustomFieldSetBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CustomFieldSetBase:
        """Test CustomFieldSetBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CustomFieldSetBase`
        """
        model = CustomFieldSetBase()  # noqa: E501
        if include_optional:
            return CustomFieldSetBase(
                id = 56,
                etag = '',
                name = '',
                parent_type = 'Contact',
    ...
    def testCustomFieldSetBase(self):
        """Test CustomFieldSetBase"""
