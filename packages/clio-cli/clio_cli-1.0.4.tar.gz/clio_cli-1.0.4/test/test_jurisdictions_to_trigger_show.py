...
from openapi_client.models.jurisdictions_to_trigger_show import JurisdictionsToTriggerShow  # noqa: E501

class TestJurisdictionsToTriggerShow(unittest.TestCase):
    """JurisdictionsToTriggerShow unit test stubs"""
    ...
    def make_instance(self, include_optional) -> JurisdictionsToTriggerShow:
        """Test JurisdictionsToTriggerShow
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `JurisdictionsToTriggerShow`
        """
        model = JurisdictionsToTriggerShow()  # noqa: E501
        if include_optional:
            return JurisdictionsToTriggerShow(
                data = None
            )
        else:
            return JurisdictionsToTriggerShow(
    ...
    def testJurisdictionsToTriggerShow(self):
        """Test JurisdictionsToTriggerShow"""
