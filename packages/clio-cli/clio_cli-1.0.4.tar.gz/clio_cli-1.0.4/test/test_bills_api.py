...
from openapi_client.api.bills_api import BillsApi  # noqa: E501
...
class TestBillsApi(unittest.TestCase):
    ...
    def test_bill_destroy(self) -> None:
    ...
    def test_bill_preview(self) -> None:
    ...
    def test_bill_update(self) -> None:
