...
from openapi_client.models.bill_theme_base import BillThemeBase  # noqa: E501

class TestBillThemeBase(unittest.TestCase):
    """BillThemeBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BillThemeBase:
        """Test BillThemeBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BillThemeBase`
        """
        model = BillThemeBase()  # noqa: E501
        if include_optional:
            return BillThemeBase(
                id = 56,
                etag = '',
