...
from openapi_client.api.clio_payments_payments_api import ClioPaymentsPaymentsApi  # noqa: E501


class TestClioPaymentsPaymentsApi(unittest.TestCase):
    """ClioPaymentsPaymentsApi unit test stubs"""

    def setUp(self) -> None:
        self.api = ClioPaymentsPaymentsApi()

    def tearDown(self) -> None:
        pass

    def test_clio_payments_payment_index(self) -> None:
    ...
    def test_clio_payments_payment_show(self) -> None:
