...
from openapi_client.models.comment_create_request_data_item import CommentCreateRequestDataItem  # noqa: E501

class TestCommentCreateRequestDataItem(unittest.TestCase):
    """CommentCreateRequestDataItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CommentCreateRequestDataItem:
        """Test CommentCreateRequestDataItem
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CommentCreateRequestDataItem`
        """
        model = CommentCreateRequestDataItem()  # noqa: E501
        if include_optional:
            return CommentCreateRequestDataItem(
                id = 56
            )
        else:
            return CommentCreateRequestDataItem(
    ...
    def testCommentCreateRequestDataItem(self):
        """Test CommentCreateRequestDataItem"""
