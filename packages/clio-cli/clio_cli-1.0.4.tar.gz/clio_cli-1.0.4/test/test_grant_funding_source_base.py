...
from openapi_client.models.grant_funding_source_base import GrantFundingSourceBase  # noqa: E501

class TestGrantFundingSourceBase(unittest.TestCase):
    """GrantFundingSourceBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GrantFundingSourceBase:
        """Test GrantFundingSourceBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GrantFundingSourceBase`
        """
        model = GrantFundingSourceBase()  # noqa: E501
        if include_optional:
            return GrantFundingSourceBase(
                id = 56,
                etag = '',
                name = '',
    ...
    def testGrantFundingSourceBase(self):
        """Test GrantFundingSourceBase"""
