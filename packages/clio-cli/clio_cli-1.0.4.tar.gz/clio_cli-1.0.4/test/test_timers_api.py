...
from openapi_client.api.timers_api import TimersApi  # noqa: E501


class TestTimersApi(unittest.TestCase):
    """TimersApi unit test stubs"""
    ...
    def test_timer_create(self) -> None:
    ...
    def test_timer_destroy(self) -> None:
