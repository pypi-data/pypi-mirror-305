...
from openapi_client.models.matter_docket_create_request import MatterDocketCreateRequest  # noqa: E501

class TestMatterDocketCreateRequest(unittest.TestCase):
    """MatterDocketCreateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MatterDocketCreateRequest:
        """Test MatterDocketCreateRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MatterDocketCreateRequest`
        """
        model = MatterDocketCreateRequest()  # noqa: E501
        if include_optional:
            return MatterDocketCreateRequest(
                data = openapi_client.models.matter_docket_create_request_data.MatterDocket_create_request_data(
                    jurisdiction = openapi_client.models.matter_docket_create_request_data_jurisdiction.MatterDocket_create_request_data_jurisdiction(
                        id = 56, ), 
                    name = '', 
                    start_date = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(), 
                    start_time = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    trigger = openapi_client.models.matter_docket_create_request_data_trigger.MatterDocket_create_request_data_trigger(
                        id = 56, ), )
            )
        else:
            return MatterDocketCreateRequest(
    ...
    def testMatterDocketCreateRequest(self):
        """Test MatterDocketCreateRequest"""
