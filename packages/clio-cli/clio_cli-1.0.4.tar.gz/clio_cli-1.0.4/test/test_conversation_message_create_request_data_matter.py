...
from openapi_client.models.conversation_message_create_request_data_matter import ConversationMessageCreateRequestDataMatter  # noqa: E501

class TestConversationMessageCreateRequestDataMatter(unittest.TestCase):
    """ConversationMessageCreateRequestDataMatter unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConversationMessageCreateRequestDataMatter:
        """Test ConversationMessageCreateRequestDataMatter
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConversationMessageCreateRequestDataMatter`
        """
        model = ConversationMessageCreateRequestDataMatter()  # noqa: E501
        if include_optional:
            return ConversationMessageCreateRequestDataMatter(
                id = 56
            )
        else:
            return ConversationMessageCreateRequestDataMatter(
    ...
    def testConversationMessageCreateRequestDataMatter(self):
        """Test ConversationMessageCreateRequestDataMatter"""
