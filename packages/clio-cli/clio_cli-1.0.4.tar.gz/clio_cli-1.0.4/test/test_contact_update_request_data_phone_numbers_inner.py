...
from openapi_client.models.contact_update_request_data_phone_numbers_inner import ContactUpdateRequestDataPhoneNumbersInner  # noqa: E501

class TestContactUpdateRequestDataPhoneNumbersInner(unittest.TestCase):
    """ContactUpdateRequestDataPhoneNumbersInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ContactUpdateRequestDataPhoneNumbersInner:
        """Test ContactUpdateRequestDataPhoneNumbersInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ContactUpdateRequestDataPhoneNumbersInner`
        """
        model = ContactUpdateRequestDataPhoneNumbersInner()  # noqa: E501
        if include_optional:
            return ContactUpdateRequestDataPhoneNumbersInner(
                name = 'Other',
                number = '',
                default_number = True,
                id = 56,
    ...
    def testContactUpdateRequestDataPhoneNumbersInner(self):
        """Test ContactUpdateRequestDataPhoneNumbersInner"""
