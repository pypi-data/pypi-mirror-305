...
from openapi_client.models.report_show import ReportShow  # noqa: E501

class TestReportShow(unittest.TestCase):
    """ReportShow unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReportShow:
        """Test ReportShow
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReportShow`
        """
        model = ReportShow()  # noqa: E501
        if include_optional:
            return ReportShow(
                data = None
            )
