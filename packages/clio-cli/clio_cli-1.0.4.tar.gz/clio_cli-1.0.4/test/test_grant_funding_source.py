...
from openapi_client.models.grant_funding_source import GrantFundingSource  # noqa: E501

class TestGrantFundingSource(unittest.TestCase):
    """GrantFundingSource unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GrantFundingSource:
        """Test GrantFundingSource
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GrantFundingSource`
        """
        model = GrantFundingSource()  # noqa: E501
        if include_optional:
            return GrantFundingSource(
                id = 56,
                etag = '',
                name = '',
                ...
                grants = [
                    openapi_client.models.grant_base.Grant_base(
                        id = 56, 
                        etag = '', 
                        name = '', 
                        funding_code = '', 
    ...
    def testGrantFundingSource(self):
        """Test GrantFundingSource"""
