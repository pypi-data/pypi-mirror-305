...
from openapi_client.models.custom_action_show import CustomActionShow  # noqa: E501

class TestCustomActionShow(unittest.TestCase):
    """CustomActionShow unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CustomActionShow:
        """Test CustomActionShow
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CustomActionShow`
        """
        model = CustomActionShow()  # noqa: E501
        if include_optional:
            return CustomActionShow(
                data = None
            )
        else:
            return CustomActionShow(
