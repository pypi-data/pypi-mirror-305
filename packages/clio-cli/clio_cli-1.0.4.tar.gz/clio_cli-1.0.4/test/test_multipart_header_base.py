...
from openapi_client.models.multipart_header_base import MultipartHeaderBase  # noqa: E501

class TestMultipartHeaderBase(unittest.TestCase):
    """MultipartHeaderBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MultipartHeaderBase:
        """Test MultipartHeaderBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MultipartHeaderBase`
        """
        model = MultipartHeaderBase()  # noqa: E501
        if include_optional:
            return MultipartHeaderBase(
                name = '',
                value = ''
            )
        else:
    ...
    def testMultipartHeaderBase(self):
        """Test MultipartHeaderBase"""
