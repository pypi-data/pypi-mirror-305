...
from openapi_client.models.calendar_visibility_base import CalendarVisibilityBase  # noqa: E501

class TestCalendarVisibilityBase(unittest.TestCase):
    """CalendarVisibilityBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CalendarVisibilityBase:
        """Test CalendarVisibilityBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CalendarVisibilityBase`
        """
        model = CalendarVisibilityBase()  # noqa: E501
        if include_optional:
            return CalendarVisibilityBase(
                id = 56,
                etag = '',
                color = '#658CDA',
                light_color = '#5DA5C7',
    ...
    def testCalendarVisibilityBase(self):
        """Test CalendarVisibilityBase"""
