...
from openapi_client.models.line_item_update_request import LineItemUpdateRequest  # noqa: E501

class TestLineItemUpdateRequest(unittest.TestCase):
    """LineItemUpdateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LineItemUpdateRequest:
        """Test LineItemUpdateRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LineItemUpdateRequest`
        """
        model = LineItemUpdateRequest()  # noqa: E501
        if include_optional:
            return LineItemUpdateRequest(
                data = openapi_client.models.line_item_update_request_data.LineItem_update_request_data(
                    activity = openapi_client.models.line_item_update_request_data_activity.LineItem_update_request_data_activity(
                        id = 56, ), 
                    bill = openapi_client.models.line_item_update_request_data_bill.LineItem_update_request_data_bill(
                        id = 56, ), 
                    date = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(), 
                    description = '', 
                    discount = openapi_client.models.line_item_update_request_data_discount.LineItem_update_request_data_discount(
                        rate = 1.337, 
                        type = True, ), 
                    group_ordering = 56, 
                    kind = 'Expense', 
                    matter = openapi_client.models.line_item_update_request_data_matter.LineItem_update_request_data_matter(
                        id = 56, ), 
                    note = '', 
                    price = 1.337, 
                    quantity = 1.337, 
    ...
    def testLineItemUpdateRequest(self):
        """Test LineItemUpdateRequest"""
