...
from openapi_client.models.reminder_list import ReminderList  # noqa: E501

class TestReminderList(unittest.TestCase):
    """ReminderList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReminderList:
        """Test ReminderList
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReminderList`
        """
        model = ReminderList()  # noqa: E501
        if include_optional:
            return ReminderList(
                data = [
                    null
