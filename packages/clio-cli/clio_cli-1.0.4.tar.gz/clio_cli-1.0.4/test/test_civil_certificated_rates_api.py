...
from openapi_client.api.civil_certificated_rates_api import CivilCertificatedRatesApi  # noqa: E501


class TestCivilCertificatedRatesApi(unittest.TestCase):
    """CivilCertificatedRatesApi unit test stubs"""

    def setUp(self) -> None:
        self.api = CivilCertificatedRatesApi()

    def tearDown(self) -> None:
        pass

    def test_lauk_civil_certificated_rate_index(self) -> None:
