...
from openapi_client.models.bill_theme import BillTheme  # noqa: E501

class TestBillTheme(unittest.TestCase):
    """BillTheme unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BillTheme:
        """Test BillTheme
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BillTheme`
        """
        model = BillTheme()  # noqa: E501
        if include_optional:
            return BillTheme(
                id = 56,
                etag = '',
