...
from openapi_client.models.calendar_entry_create_request_data_conference_meeting import CalendarEntryCreateRequestDataConferenceMeeting  # noqa: E501

class TestCalendarEntryCreateRequestDataConferenceMeeting(unittest.TestCase):
    """CalendarEntryCreateRequestDataConferenceMeeting unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CalendarEntryCreateRequestDataConferenceMeeting:
        """Test CalendarEntryCreateRequestDataConferenceMeeting
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CalendarEntryCreateRequestDataConferenceMeeting`
        """
        model = CalendarEntryCreateRequestDataConferenceMeeting()  # noqa: E501
        if include_optional:
            return CalendarEntryCreateRequestDataConferenceMeeting(
                type = 'zoom'
            )
        else:
            return CalendarEntryCreateRequestDataConferenceMeeting(
    ...
    def testCalendarEntryCreateRequestDataConferenceMeeting(self):
        """Test CalendarEntryCreateRequestDataConferenceMeeting"""
