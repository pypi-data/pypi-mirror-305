...
from openapi_client.models.matter_create_request_data_relationships_inner_contact import MatterCreateRequestDataRelationshipsInnerContact  # noqa: E501

class TestMatterCreateRequestDataRelationshipsInnerContact(unittest.TestCase):
    """MatterCreateRequestDataRelationshipsInnerContact unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MatterCreateRequestDataRelationshipsInnerContact:
        """Test MatterCreateRequestDataRelationshipsInnerContact
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MatterCreateRequestDataRelationshipsInnerContact`
        """
        model = MatterCreateRequestDataRelationshipsInnerContact()  # noqa: E501
        if include_optional:
            return MatterCreateRequestDataRelationshipsInnerContact(
                id = 56
            )
        else:
            return MatterCreateRequestDataRelationshipsInnerContact(
    ...
    def testMatterCreateRequestDataRelationshipsInnerContact(self):
        """Test MatterCreateRequestDataRelationshipsInnerContact"""
