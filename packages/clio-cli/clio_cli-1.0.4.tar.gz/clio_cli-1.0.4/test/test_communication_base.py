...
from openapi_client.models.communication_base import CommunicationBase  # noqa: E501

class TestCommunicationBase(unittest.TestCase):
    """CommunicationBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CommunicationBase:
        """Test CommunicationBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CommunicationBase`
        """
        model = CommunicationBase()  # noqa: E501
        if include_optional:
    ...
    def testCommunicationBase(self):
        """Test CommunicationBase"""
