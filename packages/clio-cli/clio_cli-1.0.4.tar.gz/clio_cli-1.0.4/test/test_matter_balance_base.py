...
from openapi_client.models.matter_balance_base import MatterBalanceBase  # noqa: E501

class TestMatterBalanceBase(unittest.TestCase):
    """MatterBalanceBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MatterBalanceBase:
        """Test MatterBalanceBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MatterBalanceBase`
        """
        model = MatterBalanceBase()  # noqa: E501
        if include_optional:
            return MatterBalanceBase(
                id = 56,
                amount = 1.337
            )
        else:
    ...
    def testMatterBalanceBase(self):
        """Test MatterBalanceBase"""
