...
from openapi_client.models.document_template_update_request import DocumentTemplateUpdateRequest  # noqa: E501

class TestDocumentTemplateUpdateRequest(unittest.TestCase):
    """DocumentTemplateUpdateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentTemplateUpdateRequest:
        """Test DocumentTemplateUpdateRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentTemplateUpdateRequest`
        """
        model = DocumentTemplateUpdateRequest()  # noqa: E501
        if include_optional:
            return DocumentTemplateUpdateRequest(
                data = openapi_client.models.document_template_update_request_data.DocumentTemplate_update_request_data(
    ...
    def testDocumentTemplateUpdateRequest(self):
        """Test DocumentTemplateUpdateRequest"""
