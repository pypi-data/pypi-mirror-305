...
from openapi_client.models.bill_update_request_data_bill_theme import BillUpdateRequestDataBillTheme  # noqa: E501

class TestBillUpdateRequestDataBillTheme(unittest.TestCase):
    """BillUpdateRequestDataBillTheme unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BillUpdateRequestDataBillTheme:
        """Test BillUpdateRequestDataBillTheme
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BillUpdateRequestDataBillTheme`
        """
        model = BillUpdateRequestDataBillTheme()  # noqa: E501
        if include_optional:
            return BillUpdateRequestDataBillTheme(
                id = 56
            )
        else:
            return BillUpdateRequestDataBillTheme(
    ...
    def testBillUpdateRequestDataBillTheme(self):
        """Test BillUpdateRequestDataBillTheme"""
