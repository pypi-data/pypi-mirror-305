...
from openapi_client.models.document_template_show import DocumentTemplateShow  # noqa: E501

class TestDocumentTemplateShow(unittest.TestCase):
    """DocumentTemplateShow unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentTemplateShow:
        """Test DocumentTemplateShow
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentTemplateShow`
        """
        model = DocumentTemplateShow()  # noqa: E501
        if include_optional:
            return DocumentTemplateShow(
                data = None
            )
        else:
            return DocumentTemplateShow(
    ...
    def testDocumentTemplateShow(self):
        """Test DocumentTemplateShow"""
