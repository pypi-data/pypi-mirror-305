...
from openapi_client.models.document_create_request import DocumentCreateRequest  # noqa: E501
...
class TestDocumentCreateRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DocumentCreateRequest:
        ...
        """
        model = DocumentCreateRequest()  # noqa: E501
        if include_optional:
            return DocumentCreateRequest(
                data = openapi_client.models.document_create_request_data.Document_create_request_data(
                    communication_id = 56, 
                    content_type = '', 
