...
from openapi_client.models.related_contacts_base import RelatedContactsBase  # noqa: E501

class TestRelatedContactsBase(unittest.TestCase):
    """RelatedContactsBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RelatedContactsBase:
        """Test RelatedContactsBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RelatedContactsBase`
        """
        model = RelatedContactsBase()  # noqa: E501
        if include_optional:
            return RelatedContactsBase(
                id = 56,
                contact_id = 56,
                name = '',
                first_name = '',
    ...
    def testRelatedContactsBase(self):
        """Test RelatedContactsBase"""
