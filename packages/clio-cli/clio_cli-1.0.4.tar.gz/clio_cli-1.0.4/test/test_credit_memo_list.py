...
from openapi_client.models.credit_memo_list import CreditMemoList  # noqa: E501

class TestCreditMemoList(unittest.TestCase):
    """CreditMemoList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreditMemoList:
        """Test CreditMemoList
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreditMemoList`
        """
        model = CreditMemoList()  # noqa: E501
        if include_optional:
