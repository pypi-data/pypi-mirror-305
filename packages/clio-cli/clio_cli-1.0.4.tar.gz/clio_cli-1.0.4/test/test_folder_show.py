...
from openapi_client.models.folder_show import FolderShow  # noqa: E501

class TestFolderShow(unittest.TestCase):
    """FolderShow unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FolderShow:
        """Test FolderShow
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FolderShow`
        """
        model = FolderShow()  # noqa: E501
        if include_optional:
            return FolderShow(
                data = None
            )
