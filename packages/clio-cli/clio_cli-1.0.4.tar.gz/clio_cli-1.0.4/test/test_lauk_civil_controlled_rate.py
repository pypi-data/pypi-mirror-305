...
from openapi_client.models.lauk_civil_controlled_rate import LaukCivilControlledRate  # noqa: E501

class TestLaukCivilControlledRate(unittest.TestCase):
    """LaukCivilControlledRate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LaukCivilControlledRate:
        """Test LaukCivilControlledRate
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LaukCivilControlledRate`
        """
        model = LaukCivilControlledRate()  # noqa: E501
        if include_optional:
            return LaukCivilControlledRate(
                id = 56,
                activity = '',
                activity_type = '',
                category_of_law = '',
    ...
    def testLaukCivilControlledRate(self):
        """Test LaukCivilControlledRate"""
