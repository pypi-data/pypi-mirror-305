...
from openapi_client.models.job_title_base import JobTitleBase  # noqa: E501

class TestJobTitleBase(unittest.TestCase):
    """JobTitleBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> JobTitleBase:
        """Test JobTitleBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `JobTitleBase`
        """
        model = JobTitleBase()  # noqa: E501
        if include_optional:
            return JobTitleBase(
                id = 56,
                etag = '',
