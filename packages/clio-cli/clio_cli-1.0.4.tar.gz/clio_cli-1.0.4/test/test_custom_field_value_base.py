...
from openapi_client.models.custom_field_value_base import CustomFieldValueBase  # noqa: E501

class TestCustomFieldValueBase(unittest.TestCase):
    """CustomFieldValueBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CustomFieldValueBase:
        """Test CustomFieldValueBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CustomFieldValueBase`
        """
        model = CustomFieldValueBase()  # noqa: E501
        if include_optional:
            return CustomFieldValueBase(
                id = '',
                etag = '',
                field_name = '',
    ...
    def testCustomFieldValueBase(self):
        """Test CustomFieldValueBase"""
