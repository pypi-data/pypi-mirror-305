...
from openapi_client.models.task_create_request_data import TaskCreateRequestData  # noqa: E501

class TestTaskCreateRequestData(unittest.TestCase):
    """TaskCreateRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TaskCreateRequestData:
        """Test TaskCreateRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TaskCreateRequestData`
        """
        model = TaskCreateRequestData()  # noqa: E501
        if include_optional:
            return TaskCreateRequestData(
                assignee = openapi_client.models.task_create_request_data_assignee.Task_create_request_data_assignee(
                    id = 56, 
                    type = 'User', ),
                cascading = True,
                cascading_offset = 56,
                ...
                matter = openapi_client.models.task_create_request_data_matter.Task_create_request_data_matter(
                    id = 56, ),
                name = '',
                ...
                task_type = openapi_client.models.task_create_request_data_task_type.Task_create_request_data_task_type(
                    id = 56, ),
                time_estimated = 56
            )
        else:
    ...
    def testTaskCreateRequestData(self):
        """Test TaskCreateRequestData"""
