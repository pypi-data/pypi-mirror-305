...
from openapi_client.models.custom_field_set_list import CustomFieldSetList  # noqa: E501

class TestCustomFieldSetList(unittest.TestCase):
    """CustomFieldSetList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CustomFieldSetList:
        """Test CustomFieldSetList
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CustomFieldSetList`
        """
        model = CustomFieldSetList()  # noqa: E501
        if include_optional:
            return CustomFieldSetList(
                data = [
                    null
                    ]
            )
    ...
    def testCustomFieldSetList(self):
        """Test CustomFieldSetList"""
