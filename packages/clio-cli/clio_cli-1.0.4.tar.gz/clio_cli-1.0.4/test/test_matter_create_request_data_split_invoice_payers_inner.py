...
from openapi_client.models.matter_create_request_data_split_invoice_payers_inner import MatterCreateRequestDataSplitInvoicePayersInner  # noqa: E501

class TestMatterCreateRequestDataSplitInvoicePayersInner(unittest.TestCase):
    """MatterCreateRequestDataSplitInvoicePayersInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MatterCreateRequestDataSplitInvoicePayersInner:
        """Test MatterCreateRequestDataSplitInvoicePayersInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MatterCreateRequestDataSplitInvoicePayersInner`
        """
        model = MatterCreateRequestDataSplitInvoicePayersInner()  # noqa: E501
        if include_optional:
            return MatterCreateRequestDataSplitInvoicePayersInner(
                contact_id = 56,
    ...
    def testMatterCreateRequestDataSplitInvoicePayersInner(self):
        """Test MatterCreateRequestDataSplitInvoicePayersInner"""
