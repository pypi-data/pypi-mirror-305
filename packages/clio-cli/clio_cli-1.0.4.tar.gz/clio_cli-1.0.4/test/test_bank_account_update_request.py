...
from openapi_client.models.bank_account_update_request import BankAccountUpdateRequest  # noqa: E501

class TestBankAccountUpdateRequest(unittest.TestCase):
    """BankAccountUpdateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BankAccountUpdateRequest:
        """Test BankAccountUpdateRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BankAccountUpdateRequest`
        """
        model = BankAccountUpdateRequest()  # noqa: E501
        if include_optional:
            return BankAccountUpdateRequest(
                data = openapi_client.models.bank_account_update_request_data.BankAccount_update_request_data(
                    account_number = '', 
    ...
    def testBankAccountUpdateRequest(self):
        """Test BankAccountUpdateRequest"""
