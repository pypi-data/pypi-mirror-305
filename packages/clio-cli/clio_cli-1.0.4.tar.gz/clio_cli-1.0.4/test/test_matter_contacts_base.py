...
from openapi_client.models.matter_contacts_base import MatterContactsBase  # noqa: E501

class TestMatterContactsBase(unittest.TestCase):
    """MatterContactsBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MatterContactsBase:
        """Test MatterContactsBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MatterContactsBase`
        """
        model = MatterContactsBase()  # noqa: E501
        if include_optional:
            return MatterContactsBase(
    ...
    def testMatterContactsBase(self):
        """Test MatterContactsBase"""
