...
from openapi_client.models.damage_base import DamageBase  # noqa: E501

class TestDamageBase(unittest.TestCase):
    """DamageBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DamageBase:
        """Test DamageBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DamageBase`
        """
        model = DamageBase()  # noqa: E501
        if include_optional:
            return DamageBase(
                id = 56,
                amount = 1.337,
