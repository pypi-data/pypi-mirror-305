...
from openapi_client.models.activity_description_create_request_data_rate import ActivityDescriptionCreateRequestDataRate  # noqa: E501

class TestActivityDescriptionCreateRequestDataRate(unittest.TestCase):
    """ActivityDescriptionCreateRequestDataRate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ActivityDescriptionCreateRequestDataRate:
        """Test ActivityDescriptionCreateRequestDataRate
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ActivityDescriptionCreateRequestDataRate`
        """
        model = ActivityDescriptionCreateRequestDataRate()  # noqa: E501
        if include_optional:
            return ActivityDescriptionCreateRequestDataRate(
                amount = 1.337,
    ...
    def testActivityDescriptionCreateRequestDataRate(self):
        """Test ActivityDescriptionCreateRequestDataRate"""
