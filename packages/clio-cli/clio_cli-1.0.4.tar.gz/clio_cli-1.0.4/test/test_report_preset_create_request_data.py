...
from openapi_client.models.report_preset_create_request_data import ReportPresetCreateRequestData  # noqa: E501

class TestReportPresetCreateRequestData(unittest.TestCase):
    """ReportPresetCreateRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReportPresetCreateRequestData:
        """Test ReportPresetCreateRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReportPresetCreateRequestData`
        """
        model = ReportPresetCreateRequestData()  # noqa: E501
        if include_optional:
            return ReportPresetCreateRequestData(
                format = 'csv',
    ...
    def testReportPresetCreateRequestData(self):
        """Test ReportPresetCreateRequestData"""
