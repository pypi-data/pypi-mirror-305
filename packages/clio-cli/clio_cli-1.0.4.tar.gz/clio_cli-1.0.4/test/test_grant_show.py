...
from openapi_client.models.grant_show import GrantShow  # noqa: E501

class TestGrantShow(unittest.TestCase):
    """GrantShow unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GrantShow:
        """Test GrantShow
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GrantShow`
        """
        model = GrantShow()  # noqa: E501
        if include_optional:
            return GrantShow(
                data = None
            )
