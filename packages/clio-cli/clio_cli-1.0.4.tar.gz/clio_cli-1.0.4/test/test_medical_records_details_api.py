...
from openapi_client.api.medical_records_details_api import MedicalRecordsDetailsApi  # noqa: E501


class TestMedicalRecordsDetailsApi(unittest.TestCase):
    """MedicalRecordsDetailsApi unit test stubs"""

    def setUp(self) -> None:
        self.api = MedicalRecordsDetailsApi()

    def tearDown(self) -> None:
        pass

    def test_medical_records_request_create(self) -> None:
    ...
    def test_medical_records_request_destroy(self) -> None:
    ...
    def test_medical_records_request_index(self) -> None:
    ...
    def test_medical_records_request_show(self) -> None:
    ...
    def test_medical_records_request_update(self) -> None:
