...
from openapi_client.models.document_create_request_data_multiparts_inner import DocumentCreateRequestDataMultipartsInner  # noqa: E501

class TestDocumentCreateRequestDataMultipartsInner(unittest.TestCase):
    """DocumentCreateRequestDataMultipartsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentCreateRequestDataMultipartsInner:
        """Test DocumentCreateRequestDataMultipartsInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentCreateRequestDataMultipartsInner`
        """
        model = DocumentCreateRequestDataMultipartsInner()  # noqa: E501
        if include_optional:
            return DocumentCreateRequestDataMultipartsInner(
                part_number = 56,
                content_length = '',
                content_md5 = ''
            )
    ...
    def testDocumentCreateRequestDataMultipartsInner(self):
        """Test DocumentCreateRequestDataMultipartsInner"""
