...
from openapi_client.models.contact_update_request_data_custom_field_values_inner import ContactUpdateRequestDataCustomFieldValuesInner  # noqa: E501

class TestContactUpdateRequestDataCustomFieldValuesInner(unittest.TestCase):
    """ContactUpdateRequestDataCustomFieldValuesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ContactUpdateRequestDataCustomFieldValuesInner:
        """Test ContactUpdateRequestDataCustomFieldValuesInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ContactUpdateRequestDataCustomFieldValuesInner`
        """
        model = ContactUpdateRequestDataCustomFieldValuesInner()  # noqa: E501
        if include_optional:
            return ContactUpdateRequestDataCustomFieldValuesInner(
                value = '',
    ...
    def testContactUpdateRequestDataCustomFieldValuesInner(self):
        """Test ContactUpdateRequestDataCustomFieldValuesInner"""
