...
from openapi_client.models.folder_update_request_data_external_properties_inner import FolderUpdateRequestDataExternalPropertiesInner  # noqa: E501

class TestFolderUpdateRequestDataExternalPropertiesInner(unittest.TestCase):
    """FolderUpdateRequestDataExternalPropertiesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FolderUpdateRequestDataExternalPropertiesInner:
        """Test FolderUpdateRequestDataExternalPropertiesInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FolderUpdateRequestDataExternalPropertiesInner`
        """
        model = FolderUpdateRequestDataExternalPropertiesInner()  # noqa: E501
        if include_optional:
            return FolderUpdateRequestDataExternalPropertiesInner(
                id = 56,
                name = '',
                value = '',
                destroy = True
    ...
    def testFolderUpdateRequestDataExternalPropertiesInner(self):
        """Test FolderUpdateRequestDataExternalPropertiesInner"""
