...
from openapi_client.models.activity_base import ActivityBase  # noqa: E501

class TestActivityBase(unittest.TestCase):
    """ActivityBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ActivityBase:
        """Test ActivityBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ActivityBase`
        """
        model = ActivityBase()  # noqa: E501
        if include_optional:
            return ActivityBase(
                id = 56,
                etag = '',
