...
from openapi_client.models.legal_aid_uk_contact_base import LegalAidUkContactBase  # noqa: E501

class TestLegalAidUkContactBase(unittest.TestCase):
    """LegalAidUkContactBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LegalAidUkContactBase:
        """Test LegalAidUkContactBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LegalAidUkContactBase`
        """
        model = LegalAidUkContactBase()  # noqa: E501
        if include_optional:
            return LegalAidUkContactBase(
                id = 56,
                disability = 56,
                disability_code = '',
                ethnicity = 56,
    ...
    def testLegalAidUkContactBase(self):
        """Test LegalAidUkContactBase"""
