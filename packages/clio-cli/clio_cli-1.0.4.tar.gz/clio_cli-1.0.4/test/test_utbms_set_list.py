...
from openapi_client.models.utbms_set_list import UtbmsSetList  # noqa: E501

class TestUtbmsSetList(unittest.TestCase):
    """UtbmsSetList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UtbmsSetList:
        """Test UtbmsSetList
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UtbmsSetList`
        """
        model = UtbmsSetList()  # noqa: E501
        if include_optional:
            return UtbmsSetList(
                data = [
                    null
