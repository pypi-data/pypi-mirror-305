...
from openapi_client.models.calendar_entry_create_request_data import CalendarEntryCreateRequestData  # noqa: E501

class TestCalendarEntryCreateRequestData(unittest.TestCase):
    """CalendarEntryCreateRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CalendarEntryCreateRequestData:
        """Test CalendarEntryCreateRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CalendarEntryCreateRequestData`
        """
        model = CalendarEntryCreateRequestData()  # noqa: E501
        if include_optional:
            return CalendarEntryCreateRequestData(
                deleted = 'single',
                all_day = True,
                attendees = [
    ...
    def testCalendarEntryCreateRequestData(self):
        """Test CalendarEntryCreateRequestData"""
