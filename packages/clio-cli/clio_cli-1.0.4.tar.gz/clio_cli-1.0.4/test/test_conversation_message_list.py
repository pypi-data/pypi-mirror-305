...
from openapi_client.models.conversation_message_list import ConversationMessageList  # noqa: E501

class TestConversationMessageList(unittest.TestCase):
    """ConversationMessageList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConversationMessageList:
        """Test ConversationMessageList
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConversationMessageList`
        """
        model = ConversationMessageList()  # noqa: E501
        if include_optional:
    ...
    def testConversationMessageList(self):
        """Test ConversationMessageList"""
