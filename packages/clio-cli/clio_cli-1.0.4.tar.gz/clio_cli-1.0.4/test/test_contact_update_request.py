...
from openapi_client.models.contact_update_request import ContactUpdateRequest  # noqa: E501

class TestContactUpdateRequest(unittest.TestCase):
    """ContactUpdateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ContactUpdateRequest:
        """Test ContactUpdateRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ContactUpdateRequest`
        """
        model = ContactUpdateRequest()  # noqa: E501
        if include_optional:
            return ContactUpdateRequest(
                data = openapi_client.models.contact_update_request_data.Contact_update_request_data(
                    addresses = [
                        openapi_client.models.contact_update_request_data_addresses_inner.Contact_update_request_data_addresses_inner(
                            name = 'Other', 
                            street = '', 
                            city = '', 
                            province = '', 
                    ...
                    custom_field_set_associations = [
                        openapi_client.models.contact_update_request_data_custom_field_set_associations_inner.Contact_update_request_data_custom_field_set_associations_inner(
                            id = 56, 
                            display_order = 56, 
                    ...
                    custom_field_values = [
                        openapi_client.models.contact_update_request_data_custom_field_values_inner.Contact_update_request_data_custom_field_values_inner(
                            value = '', 
                    ...
                    email_addresses = [
                        openapi_client.models.contact_update_request_data_email_addresses_inner.Contact_update_request_data_email_addresses_inner(
                            id = 56, 
                            name = 'Other', 
                            address = '', 
                            default_email = True, 
                    ...
                    first_name = '', 
                    instant_messengers = [
                        openapi_client.models.contact_update_request_data_instant_messengers_inner.Contact_update_request_data_instant_messengers_inner(
                            name = 'Other', 
                            address = '', 
                            id = 56, 
                            _destroy = True, )
                    ...
                    name = '', 
                    phone_numbers = [
                        openapi_client.models.contact_update_request_data_phone_numbers_inner.Contact_update_request_data_phone_numbers_inner(
                            name = 'Other', 
                            number = '', 
                            default_number = True, 
                            id = 56, 
                    ...
                    type = 'Person', 
                    web_sites = [
                        openapi_client.models.contact_update_request_data_web_sites_inner.Contact_update_request_data_web_sites_inner(
                            name = 'Other', 
                            address = '', 
                            id = 56, 
    ...
    def testContactUpdateRequest(self):
        """Test ContactUpdateRequest"""
