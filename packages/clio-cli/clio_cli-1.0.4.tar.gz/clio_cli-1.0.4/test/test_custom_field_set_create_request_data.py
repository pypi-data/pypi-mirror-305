...
from openapi_client.models.custom_field_set_create_request_data import CustomFieldSetCreateRequestData  # noqa: E501

class TestCustomFieldSetCreateRequestData(unittest.TestCase):
    """CustomFieldSetCreateRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CustomFieldSetCreateRequestData:
        """Test CustomFieldSetCreateRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CustomFieldSetCreateRequestData`
        """
        model = CustomFieldSetCreateRequestData()  # noqa: E501
        if include_optional:
            return CustomFieldSetCreateRequestData(
                displayed = True,
                name = '',
                parent_type = 'Contact'
            )
    ...
    def testCustomFieldSetCreateRequestData(self):
        """Test CustomFieldSetCreateRequestData"""
