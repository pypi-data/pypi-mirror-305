...
from openapi_client.models.grant_funding_source_create_request import GrantFundingSourceCreateRequest  # noqa: E501

class TestGrantFundingSourceCreateRequest(unittest.TestCase):
    """GrantFundingSourceCreateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GrantFundingSourceCreateRequest:
        """Test GrantFundingSourceCreateRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GrantFundingSourceCreateRequest`
        """
        model = GrantFundingSourceCreateRequest()  # noqa: E501
        if include_optional:
            return GrantFundingSourceCreateRequest(
                data = openapi_client.models.grant_funding_source_create_request_data.GrantFundingSource_create_request_data(
                    name = '', )
            )
        else:
            return GrantFundingSourceCreateRequest(
    ...
    def testGrantFundingSourceCreateRequest(self):
        """Test GrantFundingSourceCreateRequest"""
