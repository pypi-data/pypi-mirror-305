...
from openapi_client.models.contact_update_request_data_web_sites_inner import ContactUpdateRequestDataWebSitesInner  # noqa: E501

class TestContactUpdateRequestDataWebSitesInner(unittest.TestCase):
    """ContactUpdateRequestDataWebSitesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ContactUpdateRequestDataWebSitesInner:
        """Test ContactUpdateRequestDataWebSitesInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ContactUpdateRequestDataWebSitesInner`
        """
        model = ContactUpdateRequestDataWebSitesInner()  # noqa: E501
        if include_optional:
            return ContactUpdateRequestDataWebSitesInner(
                name = 'Other',
                address = '',
                id = 56,
    ...
    def testContactUpdateRequestDataWebSitesInner(self):
        """Test ContactUpdateRequestDataWebSitesInner"""
