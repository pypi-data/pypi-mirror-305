...
from openapi_client.models.document_template_create_request_data import DocumentTemplateCreateRequestData  # noqa: E501

class TestDocumentTemplateCreateRequestData(unittest.TestCase):
    """DocumentTemplateCreateRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentTemplateCreateRequestData:
        """Test DocumentTemplateCreateRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentTemplateCreateRequestData`
        """
        model = DocumentTemplateCreateRequestData()  # noqa: E501
        if include_optional:
            return DocumentTemplateCreateRequestData(
    ...
    def testDocumentTemplateCreateRequestData(self):
        """Test DocumentTemplateCreateRequestData"""
