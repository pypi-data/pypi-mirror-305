...
from openapi_client.models.clio_payments_payment_base import ClioPaymentsPaymentBase  # noqa: E501

class TestClioPaymentsPaymentBase(unittest.TestCase):
    """ClioPaymentsPaymentBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ClioPaymentsPaymentBase:
        """Test ClioPaymentsPaymentBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ClioPaymentsPaymentBase`
        """
        model = ClioPaymentsPaymentBase()  # noqa: E501
        if include_optional:
            return ClioPaymentsPaymentBase(
                amount = 1.337,
                confirmation_number = '',
    ...
    def testClioPaymentsPaymentBase(self):
        """Test ClioPaymentsPaymentBase"""
