...
from openapi_client.models.clio_payments_link_create_request_data_destination_contact import ClioPaymentsLinkCreateRequestDataDestinationContact  # noqa: E501

class TestClioPaymentsLinkCreateRequestDataDestinationContact(unittest.TestCase):
    """ClioPaymentsLinkCreateRequestDataDestinationContact unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ClioPaymentsLinkCreateRequestDataDestinationContact:
        """Test ClioPaymentsLinkCreateRequestDataDestinationContact
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ClioPaymentsLinkCreateRequestDataDestinationContact`
        """
        model = ClioPaymentsLinkCreateRequestDataDestinationContact()  # noqa: E501
        if include_optional:
            return ClioPaymentsLinkCreateRequestDataDestinationContact(
                id = 56
            )
        else:
            return ClioPaymentsLinkCreateRequestDataDestinationContact(
    ...
    def testClioPaymentsLinkCreateRequestDataDestinationContact(self):
        """Test ClioPaymentsLinkCreateRequestDataDestinationContact"""
