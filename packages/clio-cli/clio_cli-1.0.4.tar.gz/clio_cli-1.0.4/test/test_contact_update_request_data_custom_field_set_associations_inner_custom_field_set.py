...
from openapi_client.models.contact_update_request_data_custom_field_set_associations_inner_custom_field_set import ContactUpdateRequestDataCustomFieldSetAssociationsInnerCustomFieldSet  # noqa: E501

class TestContactUpdateRequestDataCustomFieldSetAssociationsInnerCustomFieldSet(unittest.TestCase):
    """ContactUpdateRequestDataCustomFieldSetAssociationsInnerCustomFieldSet unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ContactUpdateRequestDataCustomFieldSetAssociationsInnerCustomFieldSet:
        """Test ContactUpdateRequestDataCustomFieldSetAssociationsInnerCustomFieldSet
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ContactUpdateRequestDataCustomFieldSetAssociationsInnerCustomFieldSet`
        """
        model = ContactUpdateRequestDataCustomFieldSetAssociationsInnerCustomFieldSet()  # noqa: E501
        if include_optional:
            return ContactUpdateRequestDataCustomFieldSetAssociationsInnerCustomFieldSet(
                id = 56
            )
        else:
            return ContactUpdateRequestDataCustomFieldSetAssociationsInnerCustomFieldSet(
    ...
    def testContactUpdateRequestDataCustomFieldSetAssociationsInnerCustomFieldSet(self):
        """Test ContactUpdateRequestDataCustomFieldSetAssociationsInnerCustomFieldSet"""
