...
from openapi_client.models.document_copy_request_data import DocumentCopyRequestData  # noqa: E501

class TestDocumentCopyRequestData(unittest.TestCase):
    """DocumentCopyRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentCopyRequestData:
        """Test DocumentCopyRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentCopyRequestData`
        """
        model = DocumentCopyRequestData()  # noqa: E501
        if include_optional:
            return DocumentCopyRequestData(
                communication_id = 56,
    ...
    def testDocumentCopyRequestData(self):
        """Test DocumentCopyRequestData"""
