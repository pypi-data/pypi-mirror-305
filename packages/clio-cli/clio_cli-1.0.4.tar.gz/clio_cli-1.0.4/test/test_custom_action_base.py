...
from openapi_client.models.custom_action_base import CustomActionBase  # noqa: E501

class TestCustomActionBase(unittest.TestCase):
    """CustomActionBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CustomActionBase:
        """Test CustomActionBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CustomActionBase`
        """
        model = CustomActionBase()  # noqa: E501
        if include_optional:
