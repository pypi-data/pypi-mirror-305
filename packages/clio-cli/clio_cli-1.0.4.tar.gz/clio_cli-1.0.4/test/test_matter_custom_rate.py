...
from openapi_client.models.matter_custom_rate import MatterCustomRate  # noqa: E501

class TestMatterCustomRate(unittest.TestCase):
    """MatterCustomRate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MatterCustomRate:
        """Test MatterCustomRate
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MatterCustomRate`
        """
        model = MatterCustomRate()  # noqa: E501
        if include_optional:
            return MatterCustomRate(
                type = 'FlatRate',
                on_invoice = True,
                rates = [
                    null
