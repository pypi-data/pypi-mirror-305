...
from openapi_client.models.conversation_update_request_data import ConversationUpdateRequestData  # noqa: E501

class TestConversationUpdateRequestData(unittest.TestCase):
    """ConversationUpdateRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConversationUpdateRequestData:
        """Test ConversationUpdateRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConversationUpdateRequestData`
        """
        model = ConversationUpdateRequestData()  # noqa: E501
        if include_optional:
            return ConversationUpdateRequestData(
                archived = True,
    ...
    def testConversationUpdateRequestData(self):
        """Test ConversationUpdateRequestData"""
