...
from openapi_client.models.matter_create_request_data_originating_attorney import MatterCreateRequestDataOriginatingAttorney  # noqa: E501

class TestMatterCreateRequestDataOriginatingAttorney(unittest.TestCase):
    """MatterCreateRequestDataOriginatingAttorney unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MatterCreateRequestDataOriginatingAttorney:
        """Test MatterCreateRequestDataOriginatingAttorney
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MatterCreateRequestDataOriginatingAttorney`
        """
        model = MatterCreateRequestDataOriginatingAttorney()  # noqa: E501
        if include_optional:
            return MatterCreateRequestDataOriginatingAttorney(
                id = 56
            )
        else:
            return MatterCreateRequestDataOriginatingAttorney(
    ...
    def testMatterCreateRequestDataOriginatingAttorney(self):
        """Test MatterCreateRequestDataOriginatingAttorney"""
