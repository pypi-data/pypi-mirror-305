...
from openapi_client.models.bill_show import BillShow  # noqa: E501

class TestBillShow(unittest.TestCase):
    """BillShow unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BillShow:
        """Test BillShow
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BillShow`
        """
        model = BillShow()  # noqa: E501
        if include_optional:
            return BillShow(
                data = None
            )
