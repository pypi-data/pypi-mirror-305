...
from openapi_client.models.report_schedule_list import ReportScheduleList  # noqa: E501
...
class TestReportScheduleList(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ReportScheduleList:
        """Test ReportScheduleList
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReportScheduleList`
        """
        model = ReportScheduleList()  # noqa: E501
        if include_optional:
