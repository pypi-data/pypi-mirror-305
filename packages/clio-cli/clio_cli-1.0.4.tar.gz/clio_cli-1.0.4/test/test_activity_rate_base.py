...
from openapi_client.models.activity_rate_base import ActivityRateBase  # noqa: E501

class TestActivityRateBase(unittest.TestCase):
    """ActivityRateBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ActivityRateBase:
        """Test ActivityRateBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ActivityRateBase`
        """
        model = ActivityRateBase()  # noqa: E501
        if include_optional:
            return ActivityRateBase(
                id = 56,
                etag = '',
                rate = 1.337,
                flat_rate = True,
