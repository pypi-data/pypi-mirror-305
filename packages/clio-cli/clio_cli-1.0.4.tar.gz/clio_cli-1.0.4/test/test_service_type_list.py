...
from openapi_client.models.service_type_list import ServiceTypeList  # noqa: E501

class TestServiceTypeList(unittest.TestCase):
    """ServiceTypeList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ServiceTypeList:
        """Test ServiceTypeList
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ServiceTypeList`
        """
        model = ServiceTypeList()  # noqa: E501
        if include_optional:
