...
from openapi_client.models.document_version_list import DocumentVersionList  # noqa: E501

class TestDocumentVersionList(unittest.TestCase):
    """DocumentVersionList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentVersionList:
        """Test DocumentVersionList
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentVersionList`
        """
        model = DocumentVersionList()  # noqa: E501
        if include_optional:
    ...
    def testDocumentVersionList(self):
        """Test DocumentVersionList"""
