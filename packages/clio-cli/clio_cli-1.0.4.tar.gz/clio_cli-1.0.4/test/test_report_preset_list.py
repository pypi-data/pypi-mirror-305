...
from openapi_client.models.report_preset_list import ReportPresetList  # noqa: E501

class TestReportPresetList(unittest.TestCase):
    """ReportPresetList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReportPresetList:
        """Test ReportPresetList
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReportPresetList`
        """
        model = ReportPresetList()  # noqa: E501
        if include_optional:
