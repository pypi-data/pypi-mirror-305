...
from openapi_client.models.matter_stage_list import MatterStageList  # noqa: E501

class TestMatterStageList(unittest.TestCase):
    """MatterStageList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MatterStageList:
        """Test MatterStageList
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MatterStageList`
        """
        model = MatterStageList()  # noqa: E501
        if include_optional:
            return MatterStageList(
                data = [
                    null
                    ]
            )
