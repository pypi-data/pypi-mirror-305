...
from openapi_client.models.trust_line_item_base import TrustLineItemBase  # noqa: E501

class TestTrustLineItemBase(unittest.TestCase):
    """TrustLineItemBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TrustLineItemBase:
        """Test TrustLineItemBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TrustLineItemBase`
        """
        model = TrustLineItemBase()  # noqa: E501
        if include_optional:
            return TrustLineItemBase(
                id = 56,
                etag = '',
    ...
    def testTrustLineItemBase(self):
        """Test TrustLineItemBase"""
