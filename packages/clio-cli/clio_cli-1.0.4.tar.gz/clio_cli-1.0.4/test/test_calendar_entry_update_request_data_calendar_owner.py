...
from openapi_client.models.calendar_entry_update_request_data_calendar_owner import CalendarEntryUpdateRequestDataCalendarOwner  # noqa: E501

class TestCalendarEntryUpdateRequestDataCalendarOwner(unittest.TestCase):
    """CalendarEntryUpdateRequestDataCalendarOwner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CalendarEntryUpdateRequestDataCalendarOwner:
        """Test CalendarEntryUpdateRequestDataCalendarOwner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CalendarEntryUpdateRequestDataCalendarOwner`
        """
        model = CalendarEntryUpdateRequestDataCalendarOwner()  # noqa: E501
        if include_optional:
            return CalendarEntryUpdateRequestDataCalendarOwner(
                id = 56
            )
        else:
            return CalendarEntryUpdateRequestDataCalendarOwner(
    ...
    def testCalendarEntryUpdateRequestDataCalendarOwner(self):
        """Test CalendarEntryUpdateRequestDataCalendarOwner"""
