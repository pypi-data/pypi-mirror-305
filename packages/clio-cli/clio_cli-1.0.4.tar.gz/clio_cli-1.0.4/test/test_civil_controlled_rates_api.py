...
from openapi_client.api.civil_controlled_rates_api import CivilControlledRatesApi  # noqa: E501


class TestCivilControlledRatesApi(unittest.TestCase):
    """CivilControlledRatesApi unit test stubs"""

    def setUp(self) -> None:
        self.api = CivilControlledRatesApi()

    def tearDown(self) -> None:
        pass

    def test_lauk_civil_controlled_rate_index(self) -> None:
