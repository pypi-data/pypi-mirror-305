...
from openapi_client.models.expense_category_create_request import ExpenseCategoryCreateRequest  # noqa: E501

class TestExpenseCategoryCreateRequest(unittest.TestCase):
    """ExpenseCategoryCreateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExpenseCategoryCreateRequest:
        """Test ExpenseCategoryCreateRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExpenseCategoryCreateRequest`
        """
        model = ExpenseCategoryCreateRequest()  # noqa: E501
        if include_optional:
            return ExpenseCategoryCreateRequest(
                data = openapi_client.models.expense_category_create_request_data.ExpenseCategory_create_request_data(
                    entry_type = 'hard_cost', 
                    groups = [
                        openapi_client.models.expense_category_create_request_data_groups_inner.ExpenseCategory_create_request_data_groups_inner(
                            id = 56, 
                            _deleted = True, )
                        ], 
                    name = '', 
                    rate = 1.337, 
                    utbms_code = openapi_client.models.expense_category_create_request_data_utbms_code.ExpenseCategory_create_request_data_utbms_code(
                        id = 56, ), )
            )
        else:
            return ExpenseCategoryCreateRequest(
    ...
    def testExpenseCategoryCreateRequest(self):
        """Test ExpenseCategoryCreateRequest"""
