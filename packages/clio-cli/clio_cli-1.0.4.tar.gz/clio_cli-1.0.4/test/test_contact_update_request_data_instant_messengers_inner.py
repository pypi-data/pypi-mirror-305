...
from openapi_client.models.contact_update_request_data_instant_messengers_inner import ContactUpdateRequestDataInstantMessengersInner  # noqa: E501

class TestContactUpdateRequestDataInstantMessengersInner(unittest.TestCase):
    """ContactUpdateRequestDataInstantMessengersInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ContactUpdateRequestDataInstantMessengersInner:
        """Test ContactUpdateRequestDataInstantMessengersInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ContactUpdateRequestDataInstantMessengersInner`
        """
        model = ContactUpdateRequestDataInstantMessengersInner()  # noqa: E501
        if include_optional:
            return ContactUpdateRequestDataInstantMessengersInner(
                name = 'Other',
                address = '',
                id = 56,
                destroy = True
    ...
    def testContactUpdateRequestDataInstantMessengersInner(self):
        """Test ContactUpdateRequestDataInstantMessengersInner"""
