...
from openapi_client.models.medical_records_request_base import MedicalRecordsRequestBase  # noqa: E501

class TestMedicalRecordsRequestBase(unittest.TestCase):
    """MedicalRecordsRequestBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MedicalRecordsRequestBase:
        """Test MedicalRecordsRequestBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MedicalRecordsRequestBase`
        """
        model = MedicalRecordsRequestBase()  # noqa: E501
        if include_optional:
            return MedicalRecordsRequestBase(
                id = 56,
                etag = '',
    ...
    def testMedicalRecordsRequestBase(self):
        """Test MedicalRecordsRequestBase"""
