...
from openapi_client.models.expense_category_create_request_data_groups_inner import ExpenseCategoryCreateRequestDataGroupsInner  # noqa: E501

class TestExpenseCategoryCreateRequestDataGroupsInner(unittest.TestCase):
    """ExpenseCategoryCreateRequestDataGroupsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExpenseCategoryCreateRequestDataGroupsInner:
        """Test ExpenseCategoryCreateRequestDataGroupsInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExpenseCategoryCreateRequestDataGroupsInner`
        """
        model = ExpenseCategoryCreateRequestDataGroupsInner()  # noqa: E501
        if include_optional:
            return ExpenseCategoryCreateRequestDataGroupsInner(
                id = 56,
                deleted = True
            )
        else:
    ...
    def testExpenseCategoryCreateRequestDataGroupsInner(self):
        """Test ExpenseCategoryCreateRequestDataGroupsInner"""
