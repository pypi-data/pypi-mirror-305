...
from openapi_client.models.trust_request_show import TrustRequestShow  # noqa: E501

class TestTrustRequestShow(unittest.TestCase):
    """TrustRequestShow unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TrustRequestShow:
        """Test TrustRequestShow
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TrustRequestShow`
        """
        model = TrustRequestShow()  # noqa: E501
        if include_optional:
            return TrustRequestShow(
                data = None
            )
        else:
            return TrustRequestShow(
