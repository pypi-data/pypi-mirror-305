...
from openapi_client.models.communication_update_request_data_external_properties_inner import CommunicationUpdateRequestDataExternalPropertiesInner  # noqa: E501

class TestCommunicationUpdateRequestDataExternalPropertiesInner(unittest.TestCase):
    """CommunicationUpdateRequestDataExternalPropertiesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CommunicationUpdateRequestDataExternalPropertiesInner:
        """Test CommunicationUpdateRequestDataExternalPropertiesInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CommunicationUpdateRequestDataExternalPropertiesInner`
        """
        model = CommunicationUpdateRequestDataExternalPropertiesInner()  # noqa: E501
        if include_optional:
            return CommunicationUpdateRequestDataExternalPropertiesInner(
                id = 56,
                name = '',
                value = '',
                destroy = True
    ...
    def testCommunicationUpdateRequestDataExternalPropertiesInner(self):
        """Test CommunicationUpdateRequestDataExternalPropertiesInner"""
