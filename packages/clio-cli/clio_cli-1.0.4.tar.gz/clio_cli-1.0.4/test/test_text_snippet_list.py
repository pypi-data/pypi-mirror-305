...
from openapi_client.models.text_snippet_list import TextSnippetList  # noqa: E501

class TestTextSnippetList(unittest.TestCase):
    """TextSnippetList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TextSnippetList:
        """Test TextSnippetList
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TextSnippetList`
        """
        model = TextSnippetList()  # noqa: E501
        if include_optional:
