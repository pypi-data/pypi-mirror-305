...
from openapi_client.models.utbms_code_list import UtbmsCodeList  # noqa: E501

class TestUtbmsCodeList(unittest.TestCase):
    """UtbmsCodeList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UtbmsCodeList:
        """Test UtbmsCodeList
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UtbmsCodeList`
        """
        model = UtbmsCodeList()  # noqa: E501
        if include_optional:
            return UtbmsCodeList(
                data = [
                    null
                    ]
            )
