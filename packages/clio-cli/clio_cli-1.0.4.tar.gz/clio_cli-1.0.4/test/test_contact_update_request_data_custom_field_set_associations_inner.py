...
from openapi_client.models.contact_update_request_data_custom_field_set_associations_inner import ContactUpdateRequestDataCustomFieldSetAssociationsInner  # noqa: E501

class TestContactUpdateRequestDataCustomFieldSetAssociationsInner(unittest.TestCase):
    """ContactUpdateRequestDataCustomFieldSetAssociationsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ContactUpdateRequestDataCustomFieldSetAssociationsInner:
        """Test ContactUpdateRequestDataCustomFieldSetAssociationsInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ContactUpdateRequestDataCustomFieldSetAssociationsInner`
        """
        model = ContactUpdateRequestDataCustomFieldSetAssociationsInner()  # noqa: E501
        if include_optional:
            return ContactUpdateRequestDataCustomFieldSetAssociationsInner(
                id = 56,
                display_order = 56,
    ...
    def testContactUpdateRequestDataCustomFieldSetAssociationsInner(self):
        """Test ContactUpdateRequestDataCustomFieldSetAssociationsInner"""
