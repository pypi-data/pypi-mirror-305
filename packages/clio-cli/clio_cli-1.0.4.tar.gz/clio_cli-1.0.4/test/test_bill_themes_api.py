...
from openapi_client.api.bill_themes_api import BillThemesApi  # noqa: E501


class TestBillThemesApi(unittest.TestCase):
    """BillThemesApi unit test stubs"""

    def setUp(self) -> None:
        self.api = BillThemesApi()

    def tearDown(self) -> None:
        pass

    def test_bill_theme_index(self) -> None:
    ...
    def test_bill_theme_update(self) -> None:
