...
from openapi_client.models.matter_create_request_data_evergreen_retainer import MatterCreateRequestDataEvergreenRetainer  # noqa: E501

class TestMatterCreateRequestDataEvergreenRetainer(unittest.TestCase):
    """MatterCreateRequestDataEvergreenRetainer unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MatterCreateRequestDataEvergreenRetainer:
        """Test MatterCreateRequestDataEvergreenRetainer
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MatterCreateRequestDataEvergreenRetainer`
        """
        model = MatterCreateRequestDataEvergreenRetainer()  # noqa: E501
        if include_optional:
            return MatterCreateRequestDataEvergreenRetainer(
    ...
    def testMatterCreateRequestDataEvergreenRetainer(self):
        """Test MatterCreateRequestDataEvergreenRetainer"""
