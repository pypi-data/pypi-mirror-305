...
from openapi_client.models.calendar_entry_create_request_data_matter import CalendarEntryCreateRequestDataMatter  # noqa: E501

class TestCalendarEntryCreateRequestDataMatter(unittest.TestCase):
    """CalendarEntryCreateRequestDataMatter unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CalendarEntryCreateRequestDataMatter:
        """Test CalendarEntryCreateRequestDataMatter
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CalendarEntryCreateRequestDataMatter`
        """
        model = CalendarEntryCreateRequestDataMatter()  # noqa: E501
        if include_optional:
            return CalendarEntryCreateRequestDataMatter(
                id = 56
            )
        else:
            return CalendarEntryCreateRequestDataMatter(
    ...
    def testCalendarEntryCreateRequestDataMatter(self):
        """Test CalendarEntryCreateRequestDataMatter"""
