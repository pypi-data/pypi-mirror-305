...
from openapi_client.models.calendar_entry_create_request_data_calendar_entry_event_type import CalendarEntryCreateRequestDataCalendarEntryEventType  # noqa: E501

class TestCalendarEntryCreateRequestDataCalendarEntryEventType(unittest.TestCase):
    """CalendarEntryCreateRequestDataCalendarEntryEventType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CalendarEntryCreateRequestDataCalendarEntryEventType:
        """Test CalendarEntryCreateRequestDataCalendarEntryEventType
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CalendarEntryCreateRequestDataCalendarEntryEventType`
        """
        model = CalendarEntryCreateRequestDataCalendarEntryEventType()  # noqa: E501
        if include_optional:
            return CalendarEntryCreateRequestDataCalendarEntryEventType(
                id = 56
            )
        else:
            return CalendarEntryCreateRequestDataCalendarEntryEventType(
    ...
    def testCalendarEntryCreateRequestDataCalendarEntryEventType(self):
        """Test CalendarEntryCreateRequestDataCalendarEntryEventType"""
