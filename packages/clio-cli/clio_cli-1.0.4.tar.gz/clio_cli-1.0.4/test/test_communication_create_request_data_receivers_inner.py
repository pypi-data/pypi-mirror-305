...
from openapi_client.models.communication_create_request_data_receivers_inner import CommunicationCreateRequestDataReceiversInner  # noqa: E501

class TestCommunicationCreateRequestDataReceiversInner(unittest.TestCase):
    """CommunicationCreateRequestDataReceiversInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CommunicationCreateRequestDataReceiversInner:
        """Test CommunicationCreateRequestDataReceiversInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CommunicationCreateRequestDataReceiversInner`
        """
        model = CommunicationCreateRequestDataReceiversInner()  # noqa: E501
        if include_optional:
            return CommunicationCreateRequestDataReceiversInner(
                deleted = True,
                id = 56,
                type = 'User'
            )
    ...
    def testCommunicationCreateRequestDataReceiversInner(self):
        """Test CommunicationCreateRequestDataReceiversInner"""
