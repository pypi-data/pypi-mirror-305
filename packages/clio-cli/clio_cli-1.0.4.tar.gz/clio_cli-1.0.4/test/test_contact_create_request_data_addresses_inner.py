...
from openapi_client.models.contact_create_request_data_addresses_inner import ContactCreateRequestDataAddressesInner  # noqa: E501

class TestContactCreateRequestDataAddressesInner(unittest.TestCase):
    """ContactCreateRequestDataAddressesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ContactCreateRequestDataAddressesInner:
        """Test ContactCreateRequestDataAddressesInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ContactCreateRequestDataAddressesInner`
        """
        model = ContactCreateRequestDataAddressesInner()  # noqa: E501
        if include_optional:
            return ContactCreateRequestDataAddressesInner(
                name = 'Other',
                street = '',
                city = '',
                province = '',
    ...
    def testContactCreateRequestDataAddressesInner(self):
        """Test ContactCreateRequestDataAddressesInner"""
