...
from openapi_client.models.bank_transfer_show import BankTransferShow  # noqa: E501

class TestBankTransferShow(unittest.TestCase):
    """BankTransferShow unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BankTransferShow:
        """Test BankTransferShow
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BankTransferShow`
        """
        model = BankTransferShow()  # noqa: E501
        if include_optional:
            return BankTransferShow(
                data = None
            )
        else:
            return BankTransferShow(
