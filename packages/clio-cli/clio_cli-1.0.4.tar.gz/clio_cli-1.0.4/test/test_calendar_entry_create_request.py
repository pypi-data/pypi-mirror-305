...
from openapi_client.models.calendar_entry_create_request import CalendarEntryCreateRequest  # noqa: E501

class TestCalendarEntryCreateRequest(unittest.TestCase):
    """CalendarEntryCreateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CalendarEntryCreateRequest:
        """Test CalendarEntryCreateRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CalendarEntryCreateRequest`
        """
        model = CalendarEntryCreateRequest()  # noqa: E501
        if include_optional:
            return CalendarEntryCreateRequest(
                data = openapi_client.models.calendar_entry_create_request_data.CalendarEntry_create_request_data(
                    _deleted = 'single', 
                    all_day = True, 
                    attendees = [
                    ...
                    calendar_entry_event_type = openapi_client.models.calendar_entry_create_request_data_calendar_entry_event_type.CalendarEntry_create_request_data_calendar_entry_event_type(
                        id = 56, ), 
                    calendar_owner = openapi_client.models.calendar_entry_create_request_data_calendar_owner.CalendarEntry_create_request_data_calendar_owner(
                        id = 56, ), 
                    ...
                    external_properties = [
                        openapi_client.models.calendar_entry_create_request_data_external_properties_inner.CalendarEntry_create_request_data_external_properties_inner(
                            name = '', 
                            value = '', )
                        ], 
                    location = '', 
    ...
    def testCalendarEntryCreateRequest(self):
        """Test CalendarEntryCreateRequest"""
