...
from openapi_client.models.medical_bill_base import MedicalBillBase  # noqa: E501

class TestMedicalBillBase(unittest.TestCase):
    """MedicalBillBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MedicalBillBase:
        """Test MedicalBillBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MedicalBillBase`
        """
        model = MedicalBillBase()  # noqa: E501
        if include_optional:
            return MedicalBillBase(
                id = 56,
                adjustment = 1.337,
                amount = 1.337,
