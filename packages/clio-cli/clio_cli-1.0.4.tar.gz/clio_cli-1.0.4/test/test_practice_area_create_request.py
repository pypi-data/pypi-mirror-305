...
from openapi_client.models.practice_area_create_request import PracticeAreaCreateRequest  # noqa: E501

class TestPracticeAreaCreateRequest(unittest.TestCase):
    """PracticeAreaCreateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PracticeAreaCreateRequest:
        """Test PracticeAreaCreateRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PracticeAreaCreateRequest`
        """
        model = PracticeAreaCreateRequest()  # noqa: E501
        if include_optional:
            return PracticeAreaCreateRequest(
                data = openapi_client.models.practice_area_create_request_data.PracticeArea_create_request_data(
    ...
    def testPracticeAreaCreateRequest(self):
        """Test PracticeAreaCreateRequest"""
