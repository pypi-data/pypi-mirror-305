...
from openapi_client.models.contact_update_request_data_addresses_inner import ContactUpdateRequestDataAddressesInner  # noqa: E501

class TestContactUpdateRequestDataAddressesInner(unittest.TestCase):
    """ContactUpdateRequestDataAddressesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ContactUpdateRequestDataAddressesInner:
        """Test ContactUpdateRequestDataAddressesInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ContactUpdateRequestDataAddressesInner`
        """
        model = ContactUpdateRequestDataAddressesInner()  # noqa: E501
        if include_optional:
            return ContactUpdateRequestDataAddressesInner(
                name = 'Other',
                street = '',
                city = '',
                province = '',
    ...
    def testContactUpdateRequestDataAddressesInner(self):
        """Test ContactUpdateRequestDataAddressesInner"""
