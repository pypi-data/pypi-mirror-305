...
from openapi_client.api.clio_payments_links_api import ClioPaymentsLinksApi  # noqa: E501


class TestClioPaymentsLinksApi(unittest.TestCase):
    """ClioPaymentsLinksApi unit test stubs"""

    def setUp(self) -> None:
        self.api = ClioPaymentsLinksApi()

    def tearDown(self) -> None:
        pass

    def test_clio_payments_link_create(self) -> None:
    ...
    def test_clio_payments_link_index(self) -> None:
    ...
    def test_clio_payments_link_show(self) -> None:
    ...
    def test_clio_payments_link_update(self) -> None:
