...
from openapi_client.models.report_preset_update_request import ReportPresetUpdateRequest  # noqa: E501

class TestReportPresetUpdateRequest(unittest.TestCase):
    """ReportPresetUpdateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReportPresetUpdateRequest:
        """Test ReportPresetUpdateRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReportPresetUpdateRequest`
        """
        model = ReportPresetUpdateRequest()  # noqa: E501
        if include_optional:
            return ReportPresetUpdateRequest(
                data = openapi_client.models.report_preset_update_request_data.ReportPreset_update_request_data(
                    format = 'csv', 
    ...
    def testReportPresetUpdateRequest(self):
        """Test ReportPresetUpdateRequest"""
