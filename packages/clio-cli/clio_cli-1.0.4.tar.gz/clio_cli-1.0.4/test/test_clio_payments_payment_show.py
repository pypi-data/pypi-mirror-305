...
from openapi_client.models.clio_payments_payment_show import ClioPaymentsPaymentShow  # noqa: E501

class TestClioPaymentsPaymentShow(unittest.TestCase):
    """ClioPaymentsPaymentShow unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ClioPaymentsPaymentShow:
        """Test ClioPaymentsPaymentShow
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ClioPaymentsPaymentShow`
        """
        model = ClioPaymentsPaymentShow()  # noqa: E501
        if include_optional:
            return ClioPaymentsPaymentShow(
                data = None
            )
        else:
            return ClioPaymentsPaymentShow(
    ...
    def testClioPaymentsPaymentShow(self):
        """Test ClioPaymentsPaymentShow"""
