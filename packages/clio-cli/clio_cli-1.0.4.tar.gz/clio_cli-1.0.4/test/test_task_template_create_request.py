...
from openapi_client.models.task_template_create_request import TaskTemplateCreateRequest  # noqa: E501

class TestTaskTemplateCreateRequest(unittest.TestCase):
    """TaskTemplateCreateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TaskTemplateCreateRequest:
        """Test TaskTemplateCreateRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TaskTemplateCreateRequest`
        """
        model = TaskTemplateCreateRequest()  # noqa: E501
        if include_optional:
            return TaskTemplateCreateRequest(
                data = openapi_client.models.task_template_create_request_data.TaskTemplate_create_request_data(
                    cascading = True, 
                    cascading_offset = 56, 
                    cascading_offset_polarity = 'Before', 
                    cascading_offset_type = 'CalendarDays', 
                    cascading_source = openapi_client.models.task_template_create_request_data_cascading_source.TaskTemplate_create_request_data_cascading_source(
                        id = 56, ), 
                    description = '', 
                    name = '', 
                    priority = 'Normal', 
                    private = True, 
                    reminder_templates = [
                        openapi_client.models.task_template_create_request_data_reminder_templates_inner.TaskTemplate_create_request_data_reminder_templates_inner(
                            duration_value = 56, 
                            duration_unit = '', 
                            notification_type = 'Email', )
                        ], 
                    task_template_list = openapi_client.models.task_template_create_request_data_task_template_list.TaskTemplate_create_request_data_task_template_list(
                        id = 56, ), )
            )
        else:
            return TaskTemplateCreateRequest(
    ...
    def testTaskTemplateCreateRequest(self):
        """Test TaskTemplateCreateRequest"""
