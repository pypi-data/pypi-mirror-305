...
from openapi_client.models.task_template_list_show import TaskTemplateListShow  # noqa: E501

class TestTaskTemplateListShow(unittest.TestCase):
    """TaskTemplateListShow unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TaskTemplateListShow:
        """Test TaskTemplateListShow
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TaskTemplateListShow`
        """
        model = TaskTemplateListShow()  # noqa: E501
        if include_optional:
            return TaskTemplateListShow(
                data = None
            )
        else:
            return TaskTemplateListShow(
    ...
    def testTaskTemplateListShow(self):
        """Test TaskTemplateListShow"""
