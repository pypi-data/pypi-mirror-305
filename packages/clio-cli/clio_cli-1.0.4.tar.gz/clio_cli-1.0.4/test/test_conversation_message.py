...
from openapi_client.models.conversation_message import ConversationMessage  # noqa: E501
...
class TestConversationMessage(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ConversationMessage:
        ...
        """
        model = ConversationMessage()  # noqa: E501
        if include_optional:
            return ConversationMessage(
                ...
                sender = openapi_client.models.unredacted_participant_base.UnredactedParticipant_base(),
                document = openapi_client.models.document_base.Document_base(
                    id = 56, 
                    etag = '', 
                    created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    ...
                    size = 56, 
                    content_type = '', ),
                conversation = openapi_client.models.conversation_base.Conversation_base(
                    id = 56, 
                    etag = '', 
                    archived = True, 
                    read_only = True, 
                    ...
                    updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), ),
                receivers = [
                    openapi_client.models.unredacted_participant_base.UnredactedParticipant_base()
                    ]
            )
        else:
            return ConversationMessage(
