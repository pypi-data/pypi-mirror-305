...
from openapi_client.models.matter_update_request_data_statute_of_limitations_reminders_inner import MatterUpdateRequestDataStatuteOfLimitationsRemindersInner  # noqa: E501

class TestMatterUpdateRequestDataStatuteOfLimitationsRemindersInner(unittest.TestCase):
    """MatterUpdateRequestDataStatuteOfLimitationsRemindersInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MatterUpdateRequestDataStatuteOfLimitationsRemindersInner:
        """Test MatterUpdateRequestDataStatuteOfLimitationsRemindersInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MatterUpdateRequestDataStatuteOfLimitationsRemindersInner`
        """
        model = MatterUpdateRequestDataStatuteOfLimitationsRemindersInner()  # noqa: E501
        if include_optional:
            return MatterUpdateRequestDataStatuteOfLimitationsRemindersInner(
                duration_value = 56,
                duration_unit = '',
    ...
    def testMatterUpdateRequestDataStatuteOfLimitationsRemindersInner(self):
        """Test MatterUpdateRequestDataStatuteOfLimitationsRemindersInner"""
