...
from openapi_client.models.task_template_list import TaskTemplateList  # noqa: E501

class TestTaskTemplateList(unittest.TestCase):
    """TaskTemplateList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TaskTemplateList:
        """Test TaskTemplateList
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TaskTemplateList`
        """
        model = TaskTemplateList()  # noqa: E501
        if include_optional:
