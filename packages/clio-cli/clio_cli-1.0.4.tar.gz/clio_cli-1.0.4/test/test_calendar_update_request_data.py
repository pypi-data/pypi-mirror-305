...
from openapi_client.models.calendar_update_request_data import CalendarUpdateRequestData  # noqa: E501

class TestCalendarUpdateRequestData(unittest.TestCase):
    """CalendarUpdateRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CalendarUpdateRequestData:
        """Test CalendarUpdateRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CalendarUpdateRequestData`
        """
        model = CalendarUpdateRequestData()  # noqa: E501
        if include_optional:
            return CalendarUpdateRequestData(
                color = '#367B9C',
                name = '',
                source = 'web',
                visible = True
    ...
    def testCalendarUpdateRequestData(self):
        """Test CalendarUpdateRequestData"""
