...
from openapi_client.api.expense_categories_api import ExpenseCategoriesApi  # noqa: E501


class TestExpenseCategoriesApi(unittest.TestCase):
    """ExpenseCategoriesApi unit test stubs"""

    def setUp(self) -> None:
        self.api = ExpenseCategoriesApi()

    def tearDown(self) -> None:
        pass

    def test_expense_category_create(self) -> None:
    ...
    def test_expense_category_destroy(self) -> None:
    ...
    def test_expense_category_index(self) -> None:
    ...
    def test_expense_category_show(self) -> None:
    ...
    def test_lauk_expense_category_index(self) -> None:
