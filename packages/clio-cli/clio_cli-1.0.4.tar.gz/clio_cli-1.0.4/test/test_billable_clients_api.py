...
from openapi_client.api.billable_clients_api import BillableClientsApi  # noqa: E501


class TestBillableClientsApi(unittest.TestCase):
    """BillableClientsApi unit test stubs"""

    def setUp(self) -> None:
        self.api = BillableClientsApi()

    def tearDown(self) -> None:
        pass

    def test_billable_client_index(self) -> None:
