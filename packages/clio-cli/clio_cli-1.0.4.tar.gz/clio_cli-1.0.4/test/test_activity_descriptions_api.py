...
from openapi_client.api.activity_descriptions_api import ActivityDescriptionsApi  # noqa: E501


class TestActivityDescriptionsApi(unittest.TestCase):
    """ActivityDescriptionsApi unit test stubs"""

    def setUp(self) -> None:
        self.api = ActivityDescriptionsApi()

    def tearDown(self) -> None:
        pass

    def test_activity_description_create(self) -> None:
    ...
    def test_activity_description_destroy(self) -> None:
    ...
    def test_activity_description_index(self) -> None:
    ...
    def test_activity_description_show(self) -> None:
    ...
    def test_activity_description_update(self) -> None:
