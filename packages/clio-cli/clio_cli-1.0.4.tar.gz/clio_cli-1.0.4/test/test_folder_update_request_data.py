...
from openapi_client.models.folder_update_request_data import FolderUpdateRequestData  # noqa: E501

class TestFolderUpdateRequestData(unittest.TestCase):
    """FolderUpdateRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FolderUpdateRequestData:
        """Test FolderUpdateRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FolderUpdateRequestData`
        """
        model = FolderUpdateRequestData()  # noqa: E501
        if include_optional:
            return FolderUpdateRequestData(
                document_category = openapi_client.models.folder_create_request_data_document_category.Folder_create_request_data_document_category(
                    id = 56, ),
                external_properties = [
                    openapi_client.models.folder_update_request_data_external_properties_inner.Folder_update_request_data_external_properties_inner(
                        id = 56, 
                        name = '', 
                        value = '', 
                        _destroy = True, )
                ...
                name = '',
                parent = openapi_client.models.folder_update_request_data_parent.Folder_update_request_data_parent(
                    id = 56, 
                    type = 'Folder', ),
                restore = True
            )
    ...
    def testFolderUpdateRequestData(self):
        """Test FolderUpdateRequestData"""
