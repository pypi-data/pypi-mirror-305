...
from openapi_client.models.matter_create_request_data_statute_of_limitations import MatterCreateRequestDataStatuteOfLimitations  # noqa: E501

class TestMatterCreateRequestDataStatuteOfLimitations(unittest.TestCase):
    """MatterCreateRequestDataStatuteOfLimitations unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MatterCreateRequestDataStatuteOfLimitations:
        """Test MatterCreateRequestDataStatuteOfLimitations
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MatterCreateRequestDataStatuteOfLimitations`
        """
        model = MatterCreateRequestDataStatuteOfLimitations()  # noqa: E501
        if include_optional:
            return MatterCreateRequestDataStatuteOfLimitations(
                status = 'pending',
    ...
    def testMatterCreateRequestDataStatuteOfLimitations(self):
        """Test MatterCreateRequestDataStatuteOfLimitations"""
