...
from openapi_client.models.polymorphic_custom_rate_base import PolymorphicCustomRateBase  # noqa: E501

class TestPolymorphicCustomRateBase(unittest.TestCase):
    """PolymorphicCustomRateBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolymorphicCustomRateBase:
        """Test PolymorphicCustomRateBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolymorphicCustomRateBase`
        """
        model = PolymorphicCustomRateBase()  # noqa: E501
        if include_optional:
            return PolymorphicCustomRateBase(
                id = 56,
                etag = '',
    ...
    def testPolymorphicCustomRateBase(self):
        """Test PolymorphicCustomRateBase"""
