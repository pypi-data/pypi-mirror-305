...
from openapi_client.models.task_update_request_data import TaskUpdateRequestData  # noqa: E501

class TestTaskUpdateRequestData(unittest.TestCase):
    """TaskUpdateRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TaskUpdateRequestData:
        """Test TaskUpdateRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TaskUpdateRequestData`
        """
        model = TaskUpdateRequestData()  # noqa: E501
        if include_optional:
            return TaskUpdateRequestData(
                assignee = openapi_client.models.task_update_request_data_assignee.Task_update_request_data_assignee(
                    id = 56, 
                    type = 'User', ),
                cascading = True,
                cascading_offset = 56,
    ...
    def testTaskUpdateRequestData(self):
        """Test TaskUpdateRequestData"""
