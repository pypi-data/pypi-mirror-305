...
from openapi_client.models.bill_theme_list import BillThemeList  # noqa: E501

class TestBillThemeList(unittest.TestCase):
    """BillThemeList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BillThemeList:
        """Test BillThemeList
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BillThemeList`
        """
        model = BillThemeList()  # noqa: E501
        if include_optional:
            return BillThemeList(
                data = [
                    null
                    ]
            )
