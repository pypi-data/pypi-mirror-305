...
from openapi_client.models.relationship_create_request import RelationshipCreateRequest  # noqa: E501

class TestRelationshipCreateRequest(unittest.TestCase):
    """RelationshipCreateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RelationshipCreateRequest:
        """Test RelationshipCreateRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RelationshipCreateRequest`
        """
        model = RelationshipCreateRequest()  # noqa: E501
        if include_optional:
            return RelationshipCreateRequest(
                data = openapi_client.models.relationship_create_request_data.Relationship_create_request_data(
                    contact = openapi_client.models.matter_update_request_data_relationships_inner_contact.Matter_update_request_data_relationships_inner_contact(
                        id = 56, ), 
                    description = '', 
                    matter = openapi_client.models.relationship_create_request_data_matter.Relationship_create_request_data_matter(
                        id = 56, ), )
            )
        else:
            return RelationshipCreateRequest(
    ...
    def testRelationshipCreateRequest(self):
        """Test RelationshipCreateRequest"""
