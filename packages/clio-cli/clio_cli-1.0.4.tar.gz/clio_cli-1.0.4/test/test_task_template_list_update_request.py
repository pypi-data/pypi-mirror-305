...
from openapi_client.models.task_template_list_update_request import TaskTemplateListUpdateRequest  # noqa: E501

class TestTaskTemplateListUpdateRequest(unittest.TestCase):
    """TaskTemplateListUpdateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TaskTemplateListUpdateRequest:
        """Test TaskTemplateListUpdateRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TaskTemplateListUpdateRequest`
        """
        model = TaskTemplateListUpdateRequest()  # noqa: E501
        if include_optional:
            return TaskTemplateListUpdateRequest(
                data = openapi_client.models.task_template_list_update_request_data.TaskTemplateList_update_request_data(
                    description = '', 
                    name = '', 
    ...
    def testTaskTemplateListUpdateRequest(self):
        """Test TaskTemplateListUpdateRequest"""
