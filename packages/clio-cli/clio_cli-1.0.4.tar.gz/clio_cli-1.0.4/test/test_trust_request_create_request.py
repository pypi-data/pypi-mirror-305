...
from openapi_client.models.trust_request_create_request import TrustRequestCreateRequest  # noqa: E501

class TestTrustRequestCreateRequest(unittest.TestCase):
    """TrustRequestCreateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TrustRequestCreateRequest:
        """Test TrustRequestCreateRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TrustRequestCreateRequest`
        """
        model = TrustRequestCreateRequest()  # noqa: E501
        if include_optional:
            return TrustRequestCreateRequest(
                data = openapi_client.models.trust_request_create_request_data.TrustRequest_create_request_data(
                    approved = True, 
                    client_id = 56, 
                    due_date = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(), 
                    issue_date = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(), 
                    matter = [
                        openapi_client.models.trust_request_create_request_data_matter_inner.TrustRequest_create_request_data_matter_inner(
                            id = 56, 
                            trust_amount = 56, 
                            note = '', )
                        ], 
    ...
    def testTrustRequestCreateRequest(self):
        """Test TrustRequestCreateRequest"""
