...
from openapi_client.models.contact_create_request_data_phone_numbers_inner import ContactCreateRequestDataPhoneNumbersInner  # noqa: E501

class TestContactCreateRequestDataPhoneNumbersInner(unittest.TestCase):
    """ContactCreateRequestDataPhoneNumbersInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ContactCreateRequestDataPhoneNumbersInner:
        """Test ContactCreateRequestDataPhoneNumbersInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ContactCreateRequestDataPhoneNumbersInner`
        """
        model = ContactCreateRequestDataPhoneNumbersInner()  # noqa: E501
        if include_optional:
            return ContactCreateRequestDataPhoneNumbersInner(
                name = 'Other',
                number = '',
                default_number = True
            )
    ...
    def testContactCreateRequestDataPhoneNumbersInner(self):
        """Test ContactCreateRequestDataPhoneNumbersInner"""
