...
from openapi_client.models.document_version import DocumentVersion  # noqa: E501
...
class TestDocumentVersion(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DocumentVersion:
        ...
        """
        model = DocumentVersion()  # noqa: E501
        if include_optional:
            return DocumentVersion(
                ...
                creator = openapi_client.models.clio_creator_base.ClioCreator_base(
                    ...
                    updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), ),
                put_headers = [
                    openapi_client.models.multipart_header_base.MultipartHeader_base(
                        name = '', 
                        value = '', )
                    ],
                multiparts = [
