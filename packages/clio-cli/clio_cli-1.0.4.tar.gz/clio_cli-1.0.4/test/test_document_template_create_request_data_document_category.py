...
from openapi_client.models.document_template_create_request_data_document_category import DocumentTemplateCreateRequestDataDocumentCategory  # noqa: E501

class TestDocumentTemplateCreateRequestDataDocumentCategory(unittest.TestCase):
    """DocumentTemplateCreateRequestDataDocumentCategory unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentTemplateCreateRequestDataDocumentCategory:
        """Test DocumentTemplateCreateRequestDataDocumentCategory
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentTemplateCreateRequestDataDocumentCategory`
        """
        model = DocumentTemplateCreateRequestDataDocumentCategory()  # noqa: E501
        if include_optional:
            return DocumentTemplateCreateRequestDataDocumentCategory(
                id = 56
            )
        else:
            return DocumentTemplateCreateRequestDataDocumentCategory(
    ...
    def testDocumentTemplateCreateRequestDataDocumentCategory(self):
        """Test DocumentTemplateCreateRequestDataDocumentCategory"""
