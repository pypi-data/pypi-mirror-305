...
from openapi_client.api.interest_charges_api import InterestChargesApi  # noqa: E501


class TestInterestChargesApi(unittest.TestCase):
    """InterestChargesApi unit test stubs"""

    def setUp(self) -> None:
        self.api = InterestChargesApi()

    def tearDown(self) -> None:
        pass

    def test_interest_charge_destroy(self) -> None:
    ...
    def test_interest_charge_index(self) -> None:
