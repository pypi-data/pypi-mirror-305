...
from openapi_client.models.note_update_request import NoteUpdateRequest  # noqa: E501

class TestNoteUpdateRequest(unittest.TestCase):
    """NoteUpdateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NoteUpdateRequest:
        """Test NoteUpdateRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NoteUpdateRequest`
        """
        model = NoteUpdateRequest()  # noqa: E501
        if include_optional:
            return NoteUpdateRequest(
                data = openapi_client.models.note_update_request_data.Note_update_request_data(
                    date = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(), 
                    detail = '', 
                    notification_event_subscribers = [
                        openapi_client.models.note_update_request_data_notification_event_subscribers_inner.Note_update_request_data_notification_event_subscribers_inner(
                            user_id = '', 
                            id = 56, 
                            _destroy = True, )
                        ], 
    ...
    def testNoteUpdateRequest(self):
        """Test NoteUpdateRequest"""
