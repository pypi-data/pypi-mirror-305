...
from openapi_client.models.activity_create_request_data_activity_description import ActivityCreateRequestDataActivityDescription  # noqa: E501

class TestActivityCreateRequestDataActivityDescription(unittest.TestCase):
    """ActivityCreateRequestDataActivityDescription unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ActivityCreateRequestDataActivityDescription:
        """Test ActivityCreateRequestDataActivityDescription
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ActivityCreateRequestDataActivityDescription`
        """
        model = ActivityCreateRequestDataActivityDescription()  # noqa: E501
        if include_optional:
            return ActivityCreateRequestDataActivityDescription(
                id = 56,
                utbms_task_id = 56,
    ...
    def testActivityCreateRequestDataActivityDescription(self):
        """Test ActivityCreateRequestDataActivityDescription"""
