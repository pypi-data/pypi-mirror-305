...
from openapi_client.models.activity_description_base import ActivityDescriptionBase  # noqa: E501

class TestActivityDescriptionBase(unittest.TestCase):
    """ActivityDescriptionBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ActivityDescriptionBase:
        """Test ActivityDescriptionBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ActivityDescriptionBase`
        """
        model = ActivityDescriptionBase()  # noqa: E501
        if include_optional:
            return ActivityDescriptionBase(
                id = 56,
                etag = '',
                name = '',
    ...
    def testActivityDescriptionBase(self):
        """Test ActivityDescriptionBase"""
