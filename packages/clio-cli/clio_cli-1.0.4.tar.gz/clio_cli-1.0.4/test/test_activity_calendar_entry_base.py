...
from openapi_client.models.activity_calendar_entry_base import ActivityCalendarEntryBase  # noqa: E501

class TestActivityCalendarEntryBase(unittest.TestCase):
    """ActivityCalendarEntryBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ActivityCalendarEntryBase:
        """Test ActivityCalendarEntryBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ActivityCalendarEntryBase`
        """
        model = ActivityCalendarEntryBase()  # noqa: E501
        if include_optional:
            return ActivityCalendarEntryBase(
                id = '',
                etag = '',
    ...
    def testActivityCalendarEntryBase(self):
        """Test ActivityCalendarEntryBase"""
