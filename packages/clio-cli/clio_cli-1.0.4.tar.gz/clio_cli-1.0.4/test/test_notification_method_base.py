...
from openapi_client.models.notification_method_base import NotificationMethodBase  # noqa: E501

class TestNotificationMethodBase(unittest.TestCase):
    """NotificationMethodBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NotificationMethodBase:
        """Test NotificationMethodBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NotificationMethodBase`
        """
        model = NotificationMethodBase()  # noqa: E501
        if include_optional:
            return NotificationMethodBase(
                id = 56,
                etag = '',
                type = 'Email',
                email_address = '',
    ...
    def testNotificationMethodBase(self):
        """Test NotificationMethodBase"""
