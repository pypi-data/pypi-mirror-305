...
from openapi_client.models.bill_list import BillList  # noqa: E501

class TestBillList(unittest.TestCase):
    """BillList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BillList:
        """Test BillList
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BillList`
        """
        model = BillList()  # noqa: E501
        if include_optional:
            return BillList(
                data = [
                    null
