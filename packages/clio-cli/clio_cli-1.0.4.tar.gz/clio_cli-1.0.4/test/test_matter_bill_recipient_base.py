...
from openapi_client.models.matter_bill_recipient_base import MatterBillRecipientBase  # noqa: E501

class TestMatterBillRecipientBase(unittest.TestCase):
    """MatterBillRecipientBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MatterBillRecipientBase:
        """Test MatterBillRecipientBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MatterBillRecipientBase`
        """
        model = MatterBillRecipientBase()  # noqa: E501
        if include_optional:
            return MatterBillRecipientBase(
    ...
    def testMatterBillRecipientBase(self):
        """Test MatterBillRecipientBase"""
