...
from openapi_client.models.matter_stage_base import MatterStageBase  # noqa: E501

class TestMatterStageBase(unittest.TestCase):
    """MatterStageBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MatterStageBase:
        """Test MatterStageBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MatterStageBase`
        """
        model = MatterStageBase()  # noqa: E501
        if include_optional:
            return MatterStageBase(
                id = 56,
                etag = '',
                practice_area_id = '',
                name = '',
