...
from openapi_client.api.jurisdictions_to_triggers_api import JurisdictionsToTriggersApi  # noqa: E501


class TestJurisdictionsToTriggersApi(unittest.TestCase):
    """JurisdictionsToTriggersApi unit test stubs"""

    def setUp(self) -> None:
        self.api = JurisdictionsToTriggersApi()

    def tearDown(self) -> None:
        pass

    def test_jurisdictions_to_trigger_index(self) -> None:
    ...
    def test_jurisdictions_to_trigger_show(self) -> None:
