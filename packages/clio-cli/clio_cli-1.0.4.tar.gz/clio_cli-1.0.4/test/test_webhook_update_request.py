...
from openapi_client.models.webhook_update_request import WebhookUpdateRequest  # noqa: E501
    ...
    def make_instance(self, include_optional) -> WebhookUpdateRequest:
        ...
        if include_optional:
            return WebhookUpdateRequest(
                data = openapi_client.models.webhook_update_request_data.Webhook_update_request_data(
                    events = [
                        'created'
                        ], 
