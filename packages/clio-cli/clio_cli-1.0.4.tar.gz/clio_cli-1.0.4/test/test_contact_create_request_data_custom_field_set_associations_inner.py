...
from openapi_client.models.contact_create_request_data_custom_field_set_associations_inner import ContactCreateRequestDataCustomFieldSetAssociationsInner  # noqa: E501

class TestContactCreateRequestDataCustomFieldSetAssociationsInner(unittest.TestCase):
    """ContactCreateRequestDataCustomFieldSetAssociationsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ContactCreateRequestDataCustomFieldSetAssociationsInner:
        """Test ContactCreateRequestDataCustomFieldSetAssociationsInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ContactCreateRequestDataCustomFieldSetAssociationsInner`
        """
        model = ContactCreateRequestDataCustomFieldSetAssociationsInner()  # noqa: E501
        if include_optional:
            return ContactCreateRequestDataCustomFieldSetAssociationsInner(
                display_order = 56,
    ...
    def testContactCreateRequestDataCustomFieldSetAssociationsInner(self):
        """Test ContactCreateRequestDataCustomFieldSetAssociationsInner"""
