...
from openapi_client.models.folder_create_request_data_document_category import FolderCreateRequestDataDocumentCategory  # noqa: E501

class TestFolderCreateRequestDataDocumentCategory(unittest.TestCase):
    """FolderCreateRequestDataDocumentCategory unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FolderCreateRequestDataDocumentCategory:
        """Test FolderCreateRequestDataDocumentCategory
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FolderCreateRequestDataDocumentCategory`
        """
        model = FolderCreateRequestDataDocumentCategory()  # noqa: E501
        if include_optional:
            return FolderCreateRequestDataDocumentCategory(
                id = 56
            )
        else:
            return FolderCreateRequestDataDocumentCategory(
    ...
    def testFolderCreateRequestDataDocumentCategory(self):
        """Test FolderCreateRequestDataDocumentCategory"""
