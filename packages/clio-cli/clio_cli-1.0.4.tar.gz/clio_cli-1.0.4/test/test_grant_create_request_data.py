...
from openapi_client.models.grant_create_request_data import GrantCreateRequestData  # noqa: E501

class TestGrantCreateRequestData(unittest.TestCase):
    """GrantCreateRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GrantCreateRequestData:
        """Test GrantCreateRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GrantCreateRequestData`
        """
        model = GrantCreateRequestData()  # noqa: E501
        if include_optional:
            return GrantCreateRequestData(
                name = ''
            )
        else:
            return GrantCreateRequestData(
    ...
    def testGrantCreateRequestData(self):
        """Test GrantCreateRequestData"""
