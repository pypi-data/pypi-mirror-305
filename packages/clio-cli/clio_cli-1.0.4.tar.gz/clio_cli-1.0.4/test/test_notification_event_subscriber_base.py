...
from openapi_client.models.notification_event_subscriber_base import NotificationEventSubscriberBase  # noqa: E501

class TestNotificationEventSubscriberBase(unittest.TestCase):
    """NotificationEventSubscriberBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NotificationEventSubscriberBase:
        """Test NotificationEventSubscriberBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NotificationEventSubscriberBase`
        """
        model = NotificationEventSubscriberBase()  # noqa: E501
        if include_optional:
            return NotificationEventSubscriberBase(
                id = 56,
                etag = '',
                user_id = 56,
                name = '',
    ...
    def testNotificationEventSubscriberBase(self):
        """Test NotificationEventSubscriberBase"""
