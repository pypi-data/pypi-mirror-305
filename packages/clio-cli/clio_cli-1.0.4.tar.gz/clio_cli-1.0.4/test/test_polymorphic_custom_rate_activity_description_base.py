...
from openapi_client.models.polymorphic_custom_rate_activity_description_base import PolymorphicCustomRateActivityDescriptionBase  # noqa: E501

class TestPolymorphicCustomRateActivityDescriptionBase(unittest.TestCase):
    """PolymorphicCustomRateActivityDescriptionBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolymorphicCustomRateActivityDescriptionBase:
        """Test PolymorphicCustomRateActivityDescriptionBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolymorphicCustomRateActivityDescriptionBase`
        """
        model = PolymorphicCustomRateActivityDescriptionBase()  # noqa: E501
        if include_optional:
            return PolymorphicCustomRateActivityDescriptionBase(
                id = 56,
                etag = '',
                name = ''
            )
    ...
    def testPolymorphicCustomRateActivityDescriptionBase(self):
        """Test PolymorphicCustomRateActivityDescriptionBase"""
