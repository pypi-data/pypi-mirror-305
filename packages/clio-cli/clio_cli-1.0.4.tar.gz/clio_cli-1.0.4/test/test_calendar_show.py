...
from openapi_client.models.calendar_show import CalendarShow  # noqa: E501

class TestCalendarShow(unittest.TestCase):
    """CalendarShow unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CalendarShow:
        """Test CalendarShow
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CalendarShow`
        """
        model = CalendarShow()  # noqa: E501
        if include_optional:
            return CalendarShow(
                data = None
            )
