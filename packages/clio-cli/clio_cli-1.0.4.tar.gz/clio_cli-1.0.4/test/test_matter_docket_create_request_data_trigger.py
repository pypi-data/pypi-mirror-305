...
from openapi_client.models.matter_docket_create_request_data_trigger import MatterDocketCreateRequestDataTrigger  # noqa: E501

class TestMatterDocketCreateRequestDataTrigger(unittest.TestCase):
    """MatterDocketCreateRequestDataTrigger unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MatterDocketCreateRequestDataTrigger:
        """Test MatterDocketCreateRequestDataTrigger
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MatterDocketCreateRequestDataTrigger`
        """
        model = MatterDocketCreateRequestDataTrigger()  # noqa: E501
        if include_optional:
            return MatterDocketCreateRequestDataTrigger(
                id = 56
            )
        else:
            return MatterDocketCreateRequestDataTrigger(
    ...
    def testMatterDocketCreateRequestDataTrigger(self):
        """Test MatterDocketCreateRequestDataTrigger"""
