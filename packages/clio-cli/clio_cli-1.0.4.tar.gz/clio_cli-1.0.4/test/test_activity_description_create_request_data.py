...
from openapi_client.models.activity_description_create_request_data import ActivityDescriptionCreateRequestData  # noqa: E501

class TestActivityDescriptionCreateRequestData(unittest.TestCase):
    """ActivityDescriptionCreateRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ActivityDescriptionCreateRequestData:
        """Test ActivityDescriptionCreateRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ActivityDescriptionCreateRequestData`
        """
        model = ActivityDescriptionCreateRequestData()  # noqa: E501
        if include_optional:
            return ActivityDescriptionCreateRequestData(
                default = True,
                groups = [
    ...
    def testActivityDescriptionCreateRequestData(self):
        """Test ActivityDescriptionCreateRequestData"""
