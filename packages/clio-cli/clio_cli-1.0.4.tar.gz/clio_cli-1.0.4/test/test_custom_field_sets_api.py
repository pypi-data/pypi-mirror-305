...
from openapi_client.api.custom_field_sets_api import CustomFieldSetsApi  # noqa: E501


class TestCustomFieldSetsApi(unittest.TestCase):
    """CustomFieldSetsApi unit test stubs"""

    def setUp(self) -> None:
        self.api = CustomFieldSetsApi()

    def tearDown(self) -> None:
        pass

    def test_custom_field_set_create(self) -> None:
    ...
    def test_custom_field_set_destroy(self) -> None:
    ...
    def test_custom_field_set_index(self) -> None:
    ...
    def test_custom_field_set_show(self) -> None:
    ...
    def test_custom_field_set_update(self) -> None:
