...
from openapi_client.models.related_contacts import RelatedContacts  # noqa: E501

class TestRelatedContacts(unittest.TestCase):
    """RelatedContacts unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RelatedContacts:
        """Test RelatedContacts
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RelatedContacts`
        """
        model = RelatedContacts()  # noqa: E501
        if include_optional:
