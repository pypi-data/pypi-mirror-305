...
from openapi_client.models.matter_list import MatterList  # noqa: E501

class TestMatterList(unittest.TestCase):
    """MatterList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MatterList:
        """Test MatterList
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MatterList`
        """
        model = MatterList()  # noqa: E501
        if include_optional:
            return MatterList(
                data = [
                    null
