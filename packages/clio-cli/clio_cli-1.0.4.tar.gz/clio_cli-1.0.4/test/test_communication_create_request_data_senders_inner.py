...
from openapi_client.models.communication_create_request_data_senders_inner import CommunicationCreateRequestDataSendersInner  # noqa: E501

class TestCommunicationCreateRequestDataSendersInner(unittest.TestCase):
    """CommunicationCreateRequestDataSendersInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CommunicationCreateRequestDataSendersInner:
        """Test CommunicationCreateRequestDataSendersInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CommunicationCreateRequestDataSendersInner`
        """
        model = CommunicationCreateRequestDataSendersInner()  # noqa: E501
        if include_optional:
            return CommunicationCreateRequestDataSendersInner(
                deleted = True,
                id = 56,
                type = 'User'
            )
    ...
    def testCommunicationCreateRequestDataSendersInner(self):
        """Test CommunicationCreateRequestDataSendersInner"""
