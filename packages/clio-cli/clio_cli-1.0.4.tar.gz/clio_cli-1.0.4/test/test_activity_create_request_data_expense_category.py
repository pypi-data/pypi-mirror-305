...
from openapi_client.models.activity_create_request_data_expense_category import ActivityCreateRequestDataExpenseCategory  # noqa: E501

class TestActivityCreateRequestDataExpenseCategory(unittest.TestCase):
    """ActivityCreateRequestDataExpenseCategory unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ActivityCreateRequestDataExpenseCategory:
        """Test ActivityCreateRequestDataExpenseCategory
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ActivityCreateRequestDataExpenseCategory`
        """
        model = ActivityCreateRequestDataExpenseCategory()  # noqa: E501
        if include_optional:
            return ActivityCreateRequestDataExpenseCategory(
                id = 56
            )
        else:
            return ActivityCreateRequestDataExpenseCategory(
    ...
    def testActivityCreateRequestDataExpenseCategory(self):
        """Test ActivityCreateRequestDataExpenseCategory"""
