...
from openapi_client.models.log_entry_base import LogEntryBase  # noqa: E501

class TestLogEntryBase(unittest.TestCase):
    """LogEntryBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LogEntryBase:
        """Test LogEntryBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LogEntryBase`
        """
        model = LogEntryBase()  # noqa: E501
        if include_optional:
            return LogEntryBase(
                id = 56,
                etag = '',
