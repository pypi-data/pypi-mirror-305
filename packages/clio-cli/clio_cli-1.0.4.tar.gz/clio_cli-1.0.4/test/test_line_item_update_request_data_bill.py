...
from openapi_client.models.line_item_update_request_data_bill import LineItemUpdateRequestDataBill  # noqa: E501

class TestLineItemUpdateRequestDataBill(unittest.TestCase):
    """LineItemUpdateRequestDataBill unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LineItemUpdateRequestDataBill:
        """Test LineItemUpdateRequestDataBill
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LineItemUpdateRequestDataBill`
        """
        model = LineItemUpdateRequestDataBill()  # noqa: E501
        if include_optional:
            return LineItemUpdateRequestDataBill(
                id = 56
            )
        else:
            return LineItemUpdateRequestDataBill(
    ...
    def testLineItemUpdateRequestDataBill(self):
        """Test LineItemUpdateRequestDataBill"""
