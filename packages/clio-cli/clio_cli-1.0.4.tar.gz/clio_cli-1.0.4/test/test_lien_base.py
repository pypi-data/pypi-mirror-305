...
from openapi_client.models.lien_base import LienBase  # noqa: E501

class TestLienBase(unittest.TestCase):
    """LienBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LienBase:
        """Test LienBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LienBase`
        """
        model = LienBase()  # noqa: E501
        if include_optional:
            return LienBase(
                id = 56,
                amount = 1.337,
