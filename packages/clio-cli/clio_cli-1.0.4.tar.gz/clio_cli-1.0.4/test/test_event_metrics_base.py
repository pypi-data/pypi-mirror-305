...
from openapi_client.models.event_metrics_base import EventMetricsBase  # noqa: E501

class TestEventMetricsBase(unittest.TestCase):
    """EventMetricsBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EventMetricsBase:
        """Test EventMetricsBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EventMetricsBase`
        """
        model = EventMetricsBase()  # noqa: E501
        if include_optional:
            return EventMetricsBase(
                unread_mobile_events = 56,
                unread_web_events = 56,
                unread_secure_messages = 56,
                unread_client_portal_messages = 56,
                unread_text_messages = 56
            )
        else:
            return EventMetricsBase(
        )
