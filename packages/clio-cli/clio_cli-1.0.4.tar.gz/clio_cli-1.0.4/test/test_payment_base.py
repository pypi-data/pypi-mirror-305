...
from openapi_client.models.payment_base import PaymentBase  # noqa: E501

class TestPaymentBase(unittest.TestCase):
    """PaymentBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaymentBase:
        """Test PaymentBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaymentBase`
        """
        model = PaymentBase()  # noqa: E501
        if include_optional:
            return PaymentBase(
                id = 56,
                etag = '',
