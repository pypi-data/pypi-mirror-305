...
from openapi_client.api.event_metrics_api import EventMetricsApi  # noqa: E501


class TestEventMetricsApi(unittest.TestCase):
    """EventMetricsApi unit test stubs"""

    def setUp(self) -> None:
        self.api = EventMetricsApi()

    def tearDown(self) -> None:
        pass

    def test_event_metrics_index(self) -> None:
