...
from openapi_client.api.custom_actions_api import CustomActionsApi  # noqa: E501


class TestCustomActionsApi(unittest.TestCase):
    """CustomActionsApi unit test stubs"""

    def setUp(self) -> None:
        self.api = CustomActionsApi()

    def tearDown(self) -> None:
        pass

    def test_custom_action_create(self) -> None:
    ...
    def test_custom_action_destroy(self) -> None:
    ...
    def test_custom_action_index(self) -> None:
    ...
    def test_custom_action_show(self) -> None:
    ...
    def test_custom_action_update(self) -> None:
