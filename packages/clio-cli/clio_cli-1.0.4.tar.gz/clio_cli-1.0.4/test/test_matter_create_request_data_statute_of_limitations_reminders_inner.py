...
from openapi_client.models.matter_create_request_data_statute_of_limitations_reminders_inner import MatterCreateRequestDataStatuteOfLimitationsRemindersInner  # noqa: E501

class TestMatterCreateRequestDataStatuteOfLimitationsRemindersInner(unittest.TestCase):
    """MatterCreateRequestDataStatuteOfLimitationsRemindersInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MatterCreateRequestDataStatuteOfLimitationsRemindersInner:
        """Test MatterCreateRequestDataStatuteOfLimitationsRemindersInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MatterCreateRequestDataStatuteOfLimitationsRemindersInner`
        """
        model = MatterCreateRequestDataStatuteOfLimitationsRemindersInner()  # noqa: E501
        if include_optional:
            return MatterCreateRequestDataStatuteOfLimitationsRemindersInner(
                duration_value = 56,
                duration_unit = '',
    ...
    def testMatterCreateRequestDataStatuteOfLimitationsRemindersInner(self):
        """Test MatterCreateRequestDataStatuteOfLimitationsRemindersInner"""
