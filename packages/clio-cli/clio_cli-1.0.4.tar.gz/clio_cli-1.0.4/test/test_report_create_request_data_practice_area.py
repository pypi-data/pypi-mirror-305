...
from openapi_client.models.report_create_request_data_practice_area import ReportCreateRequestDataPracticeArea  # noqa: E501

class TestReportCreateRequestDataPracticeArea(unittest.TestCase):
    """ReportCreateRequestDataPracticeArea unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReportCreateRequestDataPracticeArea:
        """Test ReportCreateRequestDataPracticeArea
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReportCreateRequestDataPracticeArea`
        """
        model = ReportCreateRequestDataPracticeArea()  # noqa: E501
        if include_optional:
            return ReportCreateRequestDataPracticeArea(
                id = 56
            )
        else:
            return ReportCreateRequestDataPracticeArea(
    ...
    def testReportCreateRequestDataPracticeArea(self):
        """Test ReportCreateRequestDataPracticeArea"""
