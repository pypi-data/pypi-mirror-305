...
from openapi_client.models.task_create_request_data_task_type import TaskCreateRequestDataTaskType  # noqa: E501

class TestTaskCreateRequestDataTaskType(unittest.TestCase):
    """TaskCreateRequestDataTaskType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TaskCreateRequestDataTaskType:
        """Test TaskCreateRequestDataTaskType
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TaskCreateRequestDataTaskType`
        """
        model = TaskCreateRequestDataTaskType()  # noqa: E501
        if include_optional:
            return TaskCreateRequestDataTaskType(
                id = 56
            )
        else:
            return TaskCreateRequestDataTaskType(
    ...
    def testTaskCreateRequestDataTaskType(self):
        """Test TaskCreateRequestDataTaskType"""
