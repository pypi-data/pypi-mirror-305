...
from openapi_client.api.medical_bills_api import MedicalBillsApi  # noqa: E501


class TestMedicalBillsApi(unittest.TestCase):
    """MedicalBillsApi unit test stubs"""

    def setUp(self) -> None:
        self.api = MedicalBillsApi()

    def tearDown(self) -> None:
        pass

    def test_medical_bill_destroy(self) -> None:
    ...
    def test_medical_bill_update(self) -> None:
