...
from openapi_client.models.calendar_update_request import CalendarUpdateRequest  # noqa: E501

class TestCalendarUpdateRequest(unittest.TestCase):
    """CalendarUpdateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CalendarUpdateRequest:
        """Test CalendarUpdateRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CalendarUpdateRequest`
        """
        model = CalendarUpdateRequest()  # noqa: E501
        if include_optional:
            return CalendarUpdateRequest(
                data = openapi_client.models.calendar_update_request_data.Calendar_update_request_data(
                    color = '#367B9C', 
                    name = '', 
                    source = 'web', 
                    visible = True, )
    ...
    def testCalendarUpdateRequest(self):
        """Test CalendarUpdateRequest"""
