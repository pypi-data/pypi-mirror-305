...
from openapi_client.models.conversation_message_base import ConversationMessageBase  # noqa: E501

class TestConversationMessageBase(unittest.TestCase):
    """ConversationMessageBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConversationMessageBase:
        """Test ConversationMessageBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConversationMessageBase`
        """
        model = ConversationMessageBase()  # noqa: E501
        if include_optional:
            return ConversationMessageBase(
                id = 56,
                etag = '',
                var_date = '',
                body = '',
    ...
    def testConversationMessageBase(self):
        """Test ConversationMessageBase"""
