...
from openapi_client.models.custom_field_matter_selection_base import CustomFieldMatterSelectionBase  # noqa: E501

class TestCustomFieldMatterSelectionBase(unittest.TestCase):
    """CustomFieldMatterSelectionBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CustomFieldMatterSelectionBase:
        """Test CustomFieldMatterSelectionBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CustomFieldMatterSelectionBase`
        """
        model = CustomFieldMatterSelectionBase()  # noqa: E501
        if include_optional:
            return CustomFieldMatterSelectionBase(
                id = 56,
                display_number = ''
            )
        else:
    ...
    def testCustomFieldMatterSelectionBase(self):
        """Test CustomFieldMatterSelectionBase"""
