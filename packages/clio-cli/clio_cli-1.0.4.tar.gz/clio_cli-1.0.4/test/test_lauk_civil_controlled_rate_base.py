...
from openapi_client.models.lauk_civil_controlled_rate_base import LaukCivilControlledRateBase  # noqa: E501

class TestLaukCivilControlledRateBase(unittest.TestCase):
    """LaukCivilControlledRateBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LaukCivilControlledRateBase:
        """Test LaukCivilControlledRateBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LaukCivilControlledRateBase`
        """
        model = LaukCivilControlledRateBase()  # noqa: E501
        if include_optional:
            return LaukCivilControlledRateBase(
                id = 56,
                activity = '',
                activity_type = '',
                category_of_law = '',
    ...
    def testLaukCivilControlledRateBase(self):
        """Test LaukCivilControlledRateBase"""
