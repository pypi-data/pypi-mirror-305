...
from openapi_client.models.event_metrics import EventMetrics  # noqa: E501

class TestEventMetrics(unittest.TestCase):
    """EventMetrics unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EventMetrics:
        """Test EventMetrics
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EventMetrics`
        """
        model = EventMetrics()  # noqa: E501
        if include_optional:
            return EventMetrics(
