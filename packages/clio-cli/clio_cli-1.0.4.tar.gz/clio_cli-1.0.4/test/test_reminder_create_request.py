...
from openapi_client.models.reminder_create_request import ReminderCreateRequest  # noqa: E501

class TestReminderCreateRequest(unittest.TestCase):
    """ReminderCreateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReminderCreateRequest:
        """Test ReminderCreateRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReminderCreateRequest`
        """
        model = ReminderCreateRequest()  # noqa: E501
        if include_optional:
            return ReminderCreateRequest(
                data = openapi_client.models.reminder_create_request_data.Reminder_create_request_data(
                    duration_unit = 'weeks', 
                    duration_value = 56, 
    ...
    def testReminderCreateRequest(self):
        """Test ReminderCreateRequest"""
