...
from openapi_client.models.trust_request_base import TrustRequestBase  # noqa: E501

class TestTrustRequestBase(unittest.TestCase):
    """TrustRequestBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TrustRequestBase:
        """Test TrustRequestBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TrustRequestBase`
        """
        model = TrustRequestBase()  # noqa: E501
        if include_optional:
            return TrustRequestBase(
                id = 56,
                etag = '',
