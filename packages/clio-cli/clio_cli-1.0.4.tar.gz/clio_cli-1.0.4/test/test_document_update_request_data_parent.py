...
from openapi_client.models.document_update_request_data_parent import DocumentUpdateRequestDataParent  # noqa: E501

class TestDocumentUpdateRequestDataParent(unittest.TestCase):
    """DocumentUpdateRequestDataParent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentUpdateRequestDataParent:
        """Test DocumentUpdateRequestDataParent
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentUpdateRequestDataParent`
        """
        model = DocumentUpdateRequestDataParent()  # noqa: E501
        if include_optional:
            return DocumentUpdateRequestDataParent(
                id = 56,
                type = 'Document'
            )
        else:
    ...
    def testDocumentUpdateRequestDataParent(self):
        """Test DocumentUpdateRequestDataParent"""
