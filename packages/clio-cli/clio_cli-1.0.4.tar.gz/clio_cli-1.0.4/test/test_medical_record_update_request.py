...
from openapi_client.models.medical_record_update_request import MedicalRecordUpdateRequest  # noqa: E501

class TestMedicalRecordUpdateRequest(unittest.TestCase):
    """MedicalRecordUpdateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MedicalRecordUpdateRequest:
        """Test MedicalRecordUpdateRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MedicalRecordUpdateRequest`
        """
        model = MedicalRecordUpdateRequest()  # noqa: E501
        if include_optional:
            return MedicalRecordUpdateRequest(
                data = openapi_client.models.medical_record_update_request_data.MedicalRecord_update_request_data(
    ...
    def testMedicalRecordUpdateRequest(self):
        """Test MedicalRecordUpdateRequest"""
