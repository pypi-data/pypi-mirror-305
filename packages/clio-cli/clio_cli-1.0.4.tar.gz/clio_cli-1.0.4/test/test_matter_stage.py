...
from openapi_client.models.matter_stage import MatterStage  # noqa: E501

class TestMatterStage(unittest.TestCase):
    """MatterStage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MatterStage:
        """Test MatterStage
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MatterStage`
        """
        model = MatterStage()  # noqa: E501
        if include_optional:
            return MatterStage(
                id = 56,
                etag = '',
