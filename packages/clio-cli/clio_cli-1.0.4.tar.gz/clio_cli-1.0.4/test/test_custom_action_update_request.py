...
from openapi_client.models.custom_action_update_request import CustomActionUpdateRequest  # noqa: E501

class TestCustomActionUpdateRequest(unittest.TestCase):
    """CustomActionUpdateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CustomActionUpdateRequest:
        """Test CustomActionUpdateRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CustomActionUpdateRequest`
        """
        model = CustomActionUpdateRequest()  # noqa: E501
        if include_optional:
            return CustomActionUpdateRequest(
                data = openapi_client.models.custom_action_update_request_data.CustomAction_update_request_data(
                    label = '', 
                    target_url = '', 
    ...
    def testCustomActionUpdateRequest(self):
        """Test CustomActionUpdateRequest"""
