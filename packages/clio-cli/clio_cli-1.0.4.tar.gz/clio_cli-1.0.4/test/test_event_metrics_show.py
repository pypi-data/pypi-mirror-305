...
from openapi_client.models.event_metrics_show import EventMetricsShow  # noqa: E501

class TestEventMetricsShow(unittest.TestCase):
    """EventMetricsShow unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EventMetricsShow:
        """Test EventMetricsShow
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EventMetricsShow`
        """
        model = EventMetricsShow()  # noqa: E501
        if include_optional:
            return EventMetricsShow(
                data = None
            )
        else:
            return EventMetricsShow(
