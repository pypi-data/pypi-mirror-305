...
from openapi_client.models.calendar_entry_create_request_data_external_properties_inner import CalendarEntryCreateRequestDataExternalPropertiesInner  # noqa: E501

class TestCalendarEntryCreateRequestDataExternalPropertiesInner(unittest.TestCase):
    """CalendarEntryCreateRequestDataExternalPropertiesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CalendarEntryCreateRequestDataExternalPropertiesInner:
        """Test CalendarEntryCreateRequestDataExternalPropertiesInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CalendarEntryCreateRequestDataExternalPropertiesInner`
        """
        model = CalendarEntryCreateRequestDataExternalPropertiesInner()  # noqa: E501
        if include_optional:
            return CalendarEntryCreateRequestDataExternalPropertiesInner(
                name = '',
                value = ''
            )
        else:
    ...
    def testCalendarEntryCreateRequestDataExternalPropertiesInner(self):
        """Test CalendarEntryCreateRequestDataExternalPropertiesInner"""
