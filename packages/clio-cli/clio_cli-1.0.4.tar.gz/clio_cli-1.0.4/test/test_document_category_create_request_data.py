...
from openapi_client.models.document_category_create_request_data import DocumentCategoryCreateRequestData  # noqa: E501

class TestDocumentCategoryCreateRequestData(unittest.TestCase):
    """DocumentCategoryCreateRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentCategoryCreateRequestData:
        """Test DocumentCategoryCreateRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentCategoryCreateRequestData`
        """
        model = DocumentCategoryCreateRequestData()  # noqa: E501
        if include_optional:
            return DocumentCategoryCreateRequestData(
                name = ''
            )
        else:
            return DocumentCategoryCreateRequestData(
    ...
    def testDocumentCategoryCreateRequestData(self):
        """Test DocumentCategoryCreateRequestData"""
