...
from openapi_client.models.calendar_entry_update_request import CalendarEntryUpdateRequest  # noqa: E501

class TestCalendarEntryUpdateRequest(unittest.TestCase):
    """CalendarEntryUpdateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CalendarEntryUpdateRequest:
        """Test CalendarEntryUpdateRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CalendarEntryUpdateRequest`
        """
        model = CalendarEntryUpdateRequest()  # noqa: E501
        if include_optional:
            return CalendarEntryUpdateRequest(
                data = openapi_client.models.calendar_entry_update_request_data.CalendarEntry_update_request_data(
                    _deleted = 'single', 
                    all_day = True, 
                    attendees = [
                        openapi_client.models.calendar_entry_create_request_data_attendees_inner.CalendarEntry_create_request_data_attendees_inner(
                            id = 56, 
                            type = '', 
                            _destroy = True, )
                        ], 
                    calendar_entry_event_type = openapi_client.models.calendar_entry_create_request_data_calendar_entry_event_type.CalendarEntry_create_request_data_calendar_entry_event_type(
                        id = 56, ), 
                    calendar_owner = openapi_client.models.calendar_entry_update_request_data_calendar_owner.CalendarEntry_update_request_data_calendar_owner(
                        id = 56, ), 
                    conference_meeting = openapi_client.models.calendar_entry_create_request_data_conference_meeting.CalendarEntry_create_request_data_conference_meeting(
                        type = 'zoom', ), 
                    description = '', 
                    end_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    external_properties = [
                        openapi_client.models.calendar_entry_update_request_data_external_properties_inner.CalendarEntry_update_request_data_external_properties_inner(
                            id = 56, 
                            name = '', 
                            value = '', 
                            _destroy = True, )
                    ...
                    location = '', 
                    matter = openapi_client.models.calendar_entry_create_request_data_matter.CalendarEntry_create_request_data_matter(
                        id = 56, ), 
                    recurrence_rule = '', 
    ...
    def testCalendarEntryUpdateRequest(self):
        """Test CalendarEntryUpdateRequest"""
