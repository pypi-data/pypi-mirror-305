...
from openapi_client.models.my_event_show import MyEventShow  # noqa: E501

class TestMyEventShow(unittest.TestCase):
    """MyEventShow unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MyEventShow:
        """Test MyEventShow
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MyEventShow`
        """
        model = MyEventShow()  # noqa: E501
        if include_optional:
            return MyEventShow(
                data = None
            )
