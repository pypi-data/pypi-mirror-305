...
from openapi_client.models.client_portal_base import ClientPortalBase  # noqa: E501

class TestClientPortalBase(unittest.TestCase):
    """ClientPortalBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ClientPortalBase:
        """Test ClientPortalBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ClientPortalBase`
        """
        model = ClientPortalBase()  # noqa: E501
        if include_optional:
