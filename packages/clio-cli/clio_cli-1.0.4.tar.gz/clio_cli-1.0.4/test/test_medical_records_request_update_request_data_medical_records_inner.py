...
from openapi_client.models.medical_records_request_update_request_data_medical_records_inner import MedicalRecordsRequestUpdateRequestDataMedicalRecordsInner  # noqa: E501

class TestMedicalRecordsRequestUpdateRequestDataMedicalRecordsInner(unittest.TestCase):
    """MedicalRecordsRequestUpdateRequestDataMedicalRecordsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MedicalRecordsRequestUpdateRequestDataMedicalRecordsInner:
        """Test MedicalRecordsRequestUpdateRequestDataMedicalRecordsInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MedicalRecordsRequestUpdateRequestDataMedicalRecordsInner`
        """
        model = MedicalRecordsRequestUpdateRequestDataMedicalRecordsInner()  # noqa: E501
        if include_optional:
            return MedicalRecordsRequestUpdateRequestDataMedicalRecordsInner(
                document_id = 56,
    ...
    def testMedicalRecordsRequestUpdateRequestDataMedicalRecordsInner(self):
        """Test MedicalRecordsRequestUpdateRequestDataMedicalRecordsInner"""
