...
from openapi_client.models.task_template_list_list import TaskTemplateListList  # noqa: E501

class TestTaskTemplateListList(unittest.TestCase):
    """TaskTemplateListList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TaskTemplateListList:
        """Test TaskTemplateListList
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TaskTemplateListList`
        """
        model = TaskTemplateListList()  # noqa: E501
        if include_optional:
            return TaskTemplateListList(
                data = [
                    null
                    ]
            )
    ...
    def testTaskTemplateListList(self):
        """Test TaskTemplateListList"""
