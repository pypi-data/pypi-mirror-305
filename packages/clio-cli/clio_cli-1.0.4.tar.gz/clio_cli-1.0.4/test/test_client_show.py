...
from openapi_client.models.client_show import ClientShow  # noqa: E501

class TestClientShow(unittest.TestCase):
    """ClientShow unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ClientShow:
        """Test ClientShow
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ClientShow`
        """
        model = ClientShow()  # noqa: E501
        if include_optional:
            return ClientShow(
                data = None
            )
