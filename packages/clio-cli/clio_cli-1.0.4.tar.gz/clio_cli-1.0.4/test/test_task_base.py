...
from openapi_client.models.task_base import TaskBase  # noqa: E501
...
class TestTaskBase(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TaskBase:
        """Test TaskBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TaskBase`
        """
