...
from openapi_client.models.custom_action_create_request_data import CustomActionCreateRequestData  # noqa: E501

class TestCustomActionCreateRequestData(unittest.TestCase):
    """CustomActionCreateRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CustomActionCreateRequestData:
        """Test CustomActionCreateRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CustomActionCreateRequestData`
        """
        model = CustomActionCreateRequestData()  # noqa: E501
        if include_optional:
            return CustomActionCreateRequestData(
                label = '',
                target_url = '',
    ...
    def testCustomActionCreateRequestData(self):
        """Test CustomActionCreateRequestData"""
