...
from openapi_client.models.activity_create_request_data import ActivityCreateRequestData  # noqa: E501

class TestActivityCreateRequestData(unittest.TestCase):
    """ActivityCreateRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ActivityCreateRequestData:
        """Test ActivityCreateRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ActivityCreateRequestData`
        """
        model = ActivityCreateRequestData()  # noqa: E501
        if include_optional:
            return ActivityCreateRequestData(
                activity_description = openapi_client.models.activity_create_request_data_activity_description.Activity_create_request_data_activity_description(
                    id = 56, 
                    utbms_task_id = 56, 
                    utbms_activity_id = 56, ),
                calendar_entry = openapi_client.models.activity_create_request_data_calendar_entry.Activity_create_request_data_calendar_entry(
                    id = 56, ),
                client_portal = openapi_client.models.activity_create_request_data_client_portal.Activity_create_request_data_client_portal(
                    id = 56, ),
                communication = openapi_client.models.activity_create_request_data_communication.Activity_create_request_data_communication(
                    id = 56, ),
                contact_note = openapi_client.models.activity_create_request_data_contact_note.Activity_create_request_data_contact_note(
                    id = 56, ),
                var_date = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(),
                expense_category = openapi_client.models.activity_create_request_data_expense_category.Activity_create_request_data_expense_category(
                    id = 56, ),
                matter = openapi_client.models.activity_create_request_data_matter.Activity_create_request_data_matter(
                    id = 56, ),
                matter_note = openapi_client.models.activity_create_request_data_contact_note.Activity_create_request_data_contact_note(
                    id = 56, ),
                no_charge = True,
                non_billable = True,
                note = '',
                ...
                reference = '',
                start_timer = True,
                task = openapi_client.models.activity_create_request_data_task.Activity_create_request_data_task(
                    id = 56, ),
                tax_setting = 'no_tax',
                text_message_conversation = openapi_client.models.activity_create_request_data_text_message_conversation.Activity_create_request_data_text_message_conversation(
                    id = 56, ),
                type = 'TimeEntry',
                user = openapi_client.models.activity_create_request_data_user.Activity_create_request_data_user(
                    id = 56, ),
                utbms_expense = openapi_client.models.activity_create_request_data_utbms_expense.Activity_create_request_data_utbms_expense(
                    id = 56, ),
                vendor = openapi_client.models.activity_create_request_data_vendor.Activity_create_request_data_vendor(
                    id = 56, )
            )
        else:
            return ActivityCreateRequestData(
    ...
    def testActivityCreateRequestData(self):
        """Test ActivityCreateRequestData"""
