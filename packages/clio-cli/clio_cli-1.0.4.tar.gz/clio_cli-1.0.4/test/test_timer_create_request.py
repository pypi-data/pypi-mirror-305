...
from openapi_client.models.timer_create_request import TimerCreateRequest  # noqa: E501

class TestTimerCreateRequest(unittest.TestCase):
    """TimerCreateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TimerCreateRequest:
        """Test TimerCreateRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TimerCreateRequest`
        """
        model = TimerCreateRequest()  # noqa: E501
        if include_optional:
            return TimerCreateRequest(
                data = openapi_client.models.timer_create_request_data.Timer_create_request_data(
                    activity = openapi_client.models.timer_create_request_data_activity.Timer_create_request_data_activity(
                        id = 56, ), )
            )
        else:
            return TimerCreateRequest(
    ...
    def testTimerCreateRequest(self):
        """Test TimerCreateRequest"""
