...
from openapi_client.models.activity_description_create_request import ActivityDescriptionCreateRequest  # noqa: E501

class TestActivityDescriptionCreateRequest(unittest.TestCase):
    """ActivityDescriptionCreateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ActivityDescriptionCreateRequest:
        """Test ActivityDescriptionCreateRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ActivityDescriptionCreateRequest`
        """
        model = ActivityDescriptionCreateRequest()  # noqa: E501
        if include_optional:
            return ActivityDescriptionCreateRequest(
                data = openapi_client.models.activity_description_create_request_data.ActivityDescription_create_request_data(
                    default = True, 
                    groups = [
                        openapi_client.models.activity_description_create_request_data_groups_inner.ActivityDescription_create_request_data_groups_inner(
                            id = 56, )
                        ], 
                    name = '', 
    ...
    def testActivityDescriptionCreateRequest(self):
        """Test ActivityDescriptionCreateRequest"""
