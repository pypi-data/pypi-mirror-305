...
from openapi_client.api.service_types_api import ServiceTypesApi  # noqa: E501
...
class TestServiceTypesApi(unittest.TestCase):
    ...
    def setUp(self) -> None:
        self.api = ServiceTypesApi()

    def tearDown(self) -> None:
        pass

    def test_service_type_index(self) -> None:
    ...
    def test_service_type_show(self) -> None:
