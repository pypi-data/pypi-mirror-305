...
from openapi_client.models.matter_docket_list import MatterDocketList  # noqa: E501

class TestMatterDocketList(unittest.TestCase):
    """MatterDocketList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MatterDocketList:
        """Test MatterDocketList
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MatterDocketList`
        """
        model = MatterDocketList()  # noqa: E501
        if include_optional:
            return MatterDocketList(
                data = [
                    null
                    ]
            )
