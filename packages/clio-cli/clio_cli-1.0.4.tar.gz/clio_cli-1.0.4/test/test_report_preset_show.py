...
from openapi_client.models.report_preset_show import ReportPresetShow  # noqa: E501

class TestReportPresetShow(unittest.TestCase):
    """ReportPresetShow unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReportPresetShow:
        """Test ReportPresetShow
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReportPresetShow`
        """
        model = ReportPresetShow()  # noqa: E501
        if include_optional:
            return ReportPresetShow(
                data = None
            )
        else:
            return ReportPresetShow(
