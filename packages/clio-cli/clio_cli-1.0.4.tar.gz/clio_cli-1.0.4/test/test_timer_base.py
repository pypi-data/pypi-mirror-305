...
from openapi_client.models.timer_base import TimerBase  # noqa: E501

class TestTimerBase(unittest.TestCase):
    """TimerBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TimerBase:
        """Test TimerBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TimerBase`
        """
        model = TimerBase()  # noqa: E501
        if include_optional:
            return TimerBase(
                id = 56,
                etag = '',
