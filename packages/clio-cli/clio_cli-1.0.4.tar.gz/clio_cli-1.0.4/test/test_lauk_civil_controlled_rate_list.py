...
from openapi_client.models.lauk_civil_controlled_rate_list import LaukCivilControlledRateList  # noqa: E501

class TestLaukCivilControlledRateList(unittest.TestCase):
    """LaukCivilControlledRateList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LaukCivilControlledRateList:
        """Test LaukCivilControlledRateList
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LaukCivilControlledRateList`
        """
        model = LaukCivilControlledRateList()  # noqa: E501
        if include_optional:
            return LaukCivilControlledRateList(
                data = [
                    null
                    ]
            )
    ...
    def testLaukCivilControlledRateList(self):
        """Test LaukCivilControlledRateList"""
