...
from openapi_client.api.matter_dockets_api import MatterDocketsApi  # noqa: E501


class TestMatterDocketsApi(unittest.TestCase):
    """MatterDocketsApi unit test stubs"""

    def setUp(self) -> None:
        self.api = MatterDocketsApi()

    def tearDown(self) -> None:
        pass

    def test_matter_docket_create(self) -> None:
    ...
    def test_matter_docket_destroy(self) -> None:
    ...
    def test_matter_docket_index(self) -> None:
    ...
    def test_matter_docket_preview(self) -> None:
    ...
    def test_matter_docket_show(self) -> None:
