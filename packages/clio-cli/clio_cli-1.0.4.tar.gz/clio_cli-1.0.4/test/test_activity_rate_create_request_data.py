...
from openapi_client.models.activity_rate_create_request_data import ActivityRateCreateRequestData  # noqa: E501

class TestActivityRateCreateRequestData(unittest.TestCase):
    """ActivityRateCreateRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ActivityRateCreateRequestData:
        """Test ActivityRateCreateRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ActivityRateCreateRequestData`
        """
        model = ActivityRateCreateRequestData()  # noqa: E501
        if include_optional:
            return ActivityRateCreateRequestData(
    ...
    def testActivityRateCreateRequestData(self):
        """Test ActivityRateCreateRequestData"""
