...
from openapi_client.models.task_template_show import TaskTemplateShow  # noqa: E501

class TestTaskTemplateShow(unittest.TestCase):
    """TaskTemplateShow unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TaskTemplateShow:
        """Test TaskTemplateShow
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TaskTemplateShow`
        """
        model = TaskTemplateShow()  # noqa: E501
        if include_optional:
            return TaskTemplateShow(
                data = None
            )
        else:
            return TaskTemplateShow(
