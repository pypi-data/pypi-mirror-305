...
from openapi_client.models.document_category_show import DocumentCategoryShow  # noqa: E501

class TestDocumentCategoryShow(unittest.TestCase):
    """DocumentCategoryShow unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentCategoryShow:
        """Test DocumentCategoryShow
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentCategoryShow`
        """
        model = DocumentCategoryShow()  # noqa: E501
        if include_optional:
            return DocumentCategoryShow(
                data = None
            )
        else:
            return DocumentCategoryShow(
    ...
    def testDocumentCategoryShow(self):
        """Test DocumentCategoryShow"""
