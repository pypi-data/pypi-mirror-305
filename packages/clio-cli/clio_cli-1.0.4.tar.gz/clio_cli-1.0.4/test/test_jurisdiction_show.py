...
from openapi_client.models.jurisdiction_show import JurisdictionShow  # noqa: E501

class TestJurisdictionShow(unittest.TestCase):
    """JurisdictionShow unit test stubs"""
    ...
    def make_instance(self, include_optional) -> JurisdictionShow:
        """Test JurisdictionShow
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `JurisdictionShow`
        """
        model = JurisdictionShow()  # noqa: E501
        if include_optional:
            return JurisdictionShow(
                data = None
            )
        else:
            return JurisdictionShow(
