...
from openapi_client.models.task_template_create_request_data_cascading_source import TaskTemplateCreateRequestDataCascadingSource  # noqa: E501

class TestTaskTemplateCreateRequestDataCascadingSource(unittest.TestCase):
    """TaskTemplateCreateRequestDataCascadingSource unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TaskTemplateCreateRequestDataCascadingSource:
        """Test TaskTemplateCreateRequestDataCascadingSource
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TaskTemplateCreateRequestDataCascadingSource`
        """
        model = TaskTemplateCreateRequestDataCascadingSource()  # noqa: E501
        if include_optional:
            return TaskTemplateCreateRequestDataCascadingSource(
                id = 56
            )
        else:
            return TaskTemplateCreateRequestDataCascadingSource(
    ...
    def testTaskTemplateCreateRequestDataCascadingSource(self):
        """Test TaskTemplateCreateRequestDataCascadingSource"""
