...
from openapi_client.models.expense_category_list import ExpenseCategoryList  # noqa: E501

class TestExpenseCategoryList(unittest.TestCase):
    """ExpenseCategoryList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExpenseCategoryList:
        """Test ExpenseCategoryList
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExpenseCategoryList`
        """
        model = ExpenseCategoryList()  # noqa: E501
        if include_optional:
    ...
    def testExpenseCategoryList(self):
        """Test ExpenseCategoryList"""
