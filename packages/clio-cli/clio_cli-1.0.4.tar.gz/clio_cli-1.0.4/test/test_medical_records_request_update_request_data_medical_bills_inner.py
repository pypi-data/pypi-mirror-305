...
from openapi_client.models.medical_records_request_update_request_data_medical_bills_inner import MedicalRecordsRequestUpdateRequestDataMedicalBillsInner  # noqa: E501

class TestMedicalRecordsRequestUpdateRequestDataMedicalBillsInner(unittest.TestCase):
    """MedicalRecordsRequestUpdateRequestDataMedicalBillsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MedicalRecordsRequestUpdateRequestDataMedicalBillsInner:
        """Test MedicalRecordsRequestUpdateRequestDataMedicalBillsInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MedicalRecordsRequestUpdateRequestDataMedicalBillsInner`
        """
        model = MedicalRecordsRequestUpdateRequestDataMedicalBillsInner()  # noqa: E501
        if include_optional:
            return MedicalRecordsRequestUpdateRequestDataMedicalBillsInner(
                adjustment = 1.337,
                amount = 1.337,
                balance = 1.337,
    ...
    def testMedicalRecordsRequestUpdateRequestDataMedicalBillsInner(self):
        """Test MedicalRecordsRequestUpdateRequestDataMedicalBillsInner"""
