...
from openapi_client.models.document_create_request_data_external_properties_inner import DocumentCreateRequestDataExternalPropertiesInner  # noqa: E501

class TestDocumentCreateRequestDataExternalPropertiesInner(unittest.TestCase):
    """DocumentCreateRequestDataExternalPropertiesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentCreateRequestDataExternalPropertiesInner:
        """Test DocumentCreateRequestDataExternalPropertiesInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentCreateRequestDataExternalPropertiesInner`
        """
        model = DocumentCreateRequestDataExternalPropertiesInner()  # noqa: E501
        if include_optional:
            return DocumentCreateRequestDataExternalPropertiesInner(
                name = '',
                value = ''
            )
        else:
    ...
    def testDocumentCreateRequestDataExternalPropertiesInner(self):
        """Test DocumentCreateRequestDataExternalPropertiesInner"""
