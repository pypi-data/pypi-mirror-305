...
from openapi_client.models.grant_base import GrantBase  # noqa: E501

class TestGrantBase(unittest.TestCase):
    """GrantBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GrantBase:
        """Test GrantBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GrantBase`
        """
        model = GrantBase()  # noqa: E501
        if include_optional:
            return GrantBase(
                id = 56,
                etag = '',
