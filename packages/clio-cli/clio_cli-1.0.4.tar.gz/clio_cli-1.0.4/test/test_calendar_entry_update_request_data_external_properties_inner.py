...
from openapi_client.models.calendar_entry_update_request_data_external_properties_inner import CalendarEntryUpdateRequestDataExternalPropertiesInner  # noqa: E501

class TestCalendarEntryUpdateRequestDataExternalPropertiesInner(unittest.TestCase):
    """CalendarEntryUpdateRequestDataExternalPropertiesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CalendarEntryUpdateRequestDataExternalPropertiesInner:
        """Test CalendarEntryUpdateRequestDataExternalPropertiesInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CalendarEntryUpdateRequestDataExternalPropertiesInner`
        """
        model = CalendarEntryUpdateRequestDataExternalPropertiesInner()  # noqa: E501
        if include_optional:
            return CalendarEntryUpdateRequestDataExternalPropertiesInner(
                id = 56,
                name = '',
                value = '',
                destroy = True
    ...
    def testCalendarEntryUpdateRequestDataExternalPropertiesInner(self):
        """Test CalendarEntryUpdateRequestDataExternalPropertiesInner"""
