    ...
    def make_instance(self, include_optional) -> Activity:
        ...
        if include_optional:
            return Activity(
                ...
                no_charge = True,
                tax_setting = 'no_tax',
                activity_description = openapi_client.models.activity_description_base.ActivityDescription_base(
                    id = 56, 
                    etag = '', 
                    name = '', 
                    ...
                    category_type = '', ),
                expense_category = openapi_client.models.expense_category_base.ExpenseCategory_base(
                    id = 56, 
                    etag = '', 
                    name = '', 
                    rate = 56, 
                ...
                communication = openapi_client.models.communication_base.Communication_base(
                    id = 56, 
                    etag = '', 
                    subject = '', 
                    body = '', 
                ...
                client_portal = openapi_client.models.client_portal_base.ClientPortal_base(
                    id = 56, 
                    etag = '', 
                    created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                ...
                matter_note = openapi_client.models.note_base.Note_base(
                    id = 56, 
                    etag = '', 
                    type = 'Matter', 
                    subject = '', 
                    ...
                    updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    time_entries_count = 56, ),
                contact_note = openapi_client.models.note_base.Note_base(
                    id = 56, 
                    etag = '', 
                    type = 'Matter', 
                    subject = '', 
                    ...
                    updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    time_entries_count = 56, ),
                subject = openapi_client.models.polymorphic_object_base.PolymorphicObject_base(
                    id = 56, 
                    type = 'Task', 
                    identifier = '', 
                    secondary_identifier = '', 
                    tertiary_identifier = '', ),
                timer = openapi_client.models.timer_base.Timer_base(
                    id = 56, 
                    etag = '', 
                ...
                user = openapi_client.models.user_base.User_base(
                    ...
                    time_zone = '', 
                    updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), ),
                utbms_expense = openapi_client.models.utbms_code_base.UtbmsCode_base(
                    id = 56, 
                    etag = '', 
                    name = '', 
                    code = '', 
                    ...
                    created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), ),
                vendor = openapi_client.models.contact_base.Contact_base(
                    id = 56, 
                    etag = '', 
                    name = '', 
                    first_name = '', 
                    ...
                    sales_tax_number = '', ),
                calendar_entry = openapi_client.models.activity_calendar_entry_base.Activity_CalendarEntry_base(
                    id = '', 
                    etag = '', 
                    calendar_owner_id = 56, ),
                task = openapi_client.models.activity_task_base.Activity_Task_base(
                    id = 56, 
                    etag = '', ),
                text_message_conversation = openapi_client.models.activity_text_message_conversation_base.Activity_TextMessageConversation_base(
                    id = 56, 
                    etag = '', ),
                document_version = openapi_client.models.document_version_base.DocumentVersion_base(
                    id = 56, 
                    document_id = 56, 
                    etag = '', 
                    uuid = '', 
                    ...
                    put_url = '', 
                    fully_uploaded = True, ),
                legal_aid_uk_activity = openapi_client.models.legal_aid_uk_activity_base.LegalAidUkActivity_base(
