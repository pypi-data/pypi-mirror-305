...
from openapi_client.models.conversation_message_create_request_data_receivers_inner import ConversationMessageCreateRequestDataReceiversInner  # noqa: E501

class TestConversationMessageCreateRequestDataReceiversInner(unittest.TestCase):
    """ConversationMessageCreateRequestDataReceiversInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConversationMessageCreateRequestDataReceiversInner:
        """Test ConversationMessageCreateRequestDataReceiversInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConversationMessageCreateRequestDataReceiversInner`
        """
        model = ConversationMessageCreateRequestDataReceiversInner()  # noqa: E501
        if include_optional:
            return ConversationMessageCreateRequestDataReceiversInner(
                id = 56,
                type = 'Contact'
            )
        else:
    ...
    def testConversationMessageCreateRequestDataReceiversInner(self):
        """Test ConversationMessageCreateRequestDataReceiversInner"""
