...
from openapi_client.models.line_item_update_request_data_activity import LineItemUpdateRequestDataActivity  # noqa: E501

class TestLineItemUpdateRequestDataActivity(unittest.TestCase):
    """LineItemUpdateRequestDataActivity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LineItemUpdateRequestDataActivity:
        """Test LineItemUpdateRequestDataActivity
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LineItemUpdateRequestDataActivity`
        """
        model = LineItemUpdateRequestDataActivity()  # noqa: E501
        if include_optional:
            return LineItemUpdateRequestDataActivity(
                id = 56
            )
        else:
            return LineItemUpdateRequestDataActivity(
    ...
    def testLineItemUpdateRequestDataActivity(self):
        """Test LineItemUpdateRequestDataActivity"""
