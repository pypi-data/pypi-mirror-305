...
from openapi_client.models.communication import Communication  # noqa: E501
    ...
    def make_instance(self, include_optional) -> Communication:
        ...
        if include_optional:
            return Communication(
                ...
                communication_eml_file = openapi_client.models.communication_eml_file_base.CommunicationEmlFile_base(
                    id = 56, ),
                senders = [
                    null
                    ],
                ...
                notification_event_subscribers = [
                    openapi_client.models.notification_event_subscriber_base.NotificationEventSubscriber_base(
                        id = 56, 
                        etag = '', 
                        user_id = 56, 
                        name = '', 
