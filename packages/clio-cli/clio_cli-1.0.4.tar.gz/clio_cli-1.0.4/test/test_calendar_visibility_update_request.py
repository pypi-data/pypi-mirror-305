...
from openapi_client.models.calendar_visibility_update_request import CalendarVisibilityUpdateRequest  # noqa: E501

class TestCalendarVisibilityUpdateRequest(unittest.TestCase):
    """CalendarVisibilityUpdateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CalendarVisibilityUpdateRequest:
        """Test CalendarVisibilityUpdateRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CalendarVisibilityUpdateRequest`
        """
        model = CalendarVisibilityUpdateRequest()  # noqa: E501
        if include_optional:
            return CalendarVisibilityUpdateRequest(
                data = openapi_client.models.calendar_visibility_update_request_data.CalendarVisibility_update_request_data(
                    color = '#367B9C', 
                    visible = '', )
            )
        else:
    ...
    def testCalendarVisibilityUpdateRequest(self):
        """Test CalendarVisibilityUpdateRequest"""
