...
from openapi_client.api.document_archives_api import DocumentArchivesApi  # noqa: E501


class TestDocumentArchivesApi(unittest.TestCase):
    """DocumentArchivesApi unit test stubs"""

    def setUp(self) -> None:
        self.api = DocumentArchivesApi()

    def tearDown(self) -> None:
        pass

    def test_document_archive_create(self) -> None:
    ...
    def test_document_archive_download(self) -> None:
    ...
    def test_document_archive_show(self) -> None:
