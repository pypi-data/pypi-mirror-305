...
from openapi_client.models.contact_update_request_data_email_addresses_inner import ContactUpdateRequestDataEmailAddressesInner  # noqa: E501

class TestContactUpdateRequestDataEmailAddressesInner(unittest.TestCase):
    """ContactUpdateRequestDataEmailAddressesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ContactUpdateRequestDataEmailAddressesInner:
        """Test ContactUpdateRequestDataEmailAddressesInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ContactUpdateRequestDataEmailAddressesInner`
        """
        model = ContactUpdateRequestDataEmailAddressesInner()  # noqa: E501
        if include_optional:
            return ContactUpdateRequestDataEmailAddressesInner(
                id = 56,
                name = 'Other',
                address = '',
                default_email = True,
    ...
    def testContactUpdateRequestDataEmailAddressesInner(self):
        """Test ContactUpdateRequestDataEmailAddressesInner"""
