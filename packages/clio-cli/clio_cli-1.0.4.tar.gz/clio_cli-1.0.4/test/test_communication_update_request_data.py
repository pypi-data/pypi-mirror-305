...
from openapi_client.models.communication_update_request_data import CommunicationUpdateRequestData  # noqa: E501

class TestCommunicationUpdateRequestData(unittest.TestCase):
    """CommunicationUpdateRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CommunicationUpdateRequestData:
        """Test CommunicationUpdateRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CommunicationUpdateRequestData`
        """
        model = CommunicationUpdateRequestData()  # noqa: E501
        if include_optional:
            return CommunicationUpdateRequestData(
                body = '',
                var_date = '',
                external_properties = [
    ...
    def testCommunicationUpdateRequestData(self):
        """Test CommunicationUpdateRequestData"""
