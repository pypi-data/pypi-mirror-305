...
from openapi_client.models.group_create_request_data import GroupCreateRequestData  # noqa: E501

class TestGroupCreateRequestData(unittest.TestCase):
    """GroupCreateRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GroupCreateRequestData:
        """Test GroupCreateRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GroupCreateRequestData`
        """
        model = GroupCreateRequestData()  # noqa: E501
        if include_optional:
            return GroupCreateRequestData(
                name = ''
            )
        else:
            return GroupCreateRequestData(
    ...
    def testGroupCreateRequestData(self):
        """Test GroupCreateRequestData"""
