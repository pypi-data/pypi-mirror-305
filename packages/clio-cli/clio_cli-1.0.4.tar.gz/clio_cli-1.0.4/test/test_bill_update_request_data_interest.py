...
from openapi_client.models.bill_update_request_data_interest import BillUpdateRequestDataInterest  # noqa: E501

class TestBillUpdateRequestDataInterest(unittest.TestCase):
    """BillUpdateRequestDataInterest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BillUpdateRequestDataInterest:
        """Test BillUpdateRequestDataInterest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BillUpdateRequestDataInterest`
        """
        model = BillUpdateRequestDataInterest()  # noqa: E501
        if include_optional:
            return BillUpdateRequestDataInterest(
                rate = 1.337,
                type = 'simple',
                period = 56
            )
    ...
    def testBillUpdateRequestDataInterest(self):
        """Test BillUpdateRequestDataInterest"""
