...
from openapi_client.models.text_snippet_create_request_data import TextSnippetCreateRequestData  # noqa: E501

class TestTextSnippetCreateRequestData(unittest.TestCase):
    """TextSnippetCreateRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TextSnippetCreateRequestData:
        """Test TextSnippetCreateRequestData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TextSnippetCreateRequestData`
        """
        model = TextSnippetCreateRequestData()  # noqa: E501
        if include_optional:
            return TextSnippetCreateRequestData(
                phrase = '',
                snippet = '',
                whole_word = True
            )
    ...
    def testTextSnippetCreateRequestData(self):
        """Test TextSnippetCreateRequestData"""
