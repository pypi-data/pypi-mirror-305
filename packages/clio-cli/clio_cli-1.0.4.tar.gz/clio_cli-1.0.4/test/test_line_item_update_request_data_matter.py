...
from openapi_client.models.line_item_update_request_data_matter import LineItemUpdateRequestDataMatter  # noqa: E501

class TestLineItemUpdateRequestDataMatter(unittest.TestCase):
    """LineItemUpdateRequestDataMatter unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LineItemUpdateRequestDataMatter:
        """Test LineItemUpdateRequestDataMatter
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LineItemUpdateRequestDataMatter`
        """
        model = LineItemUpdateRequestDataMatter()  # noqa: E501
        if include_optional:
            return LineItemUpdateRequestDataMatter(
                id = 56
            )
        else:
            return LineItemUpdateRequestDataMatter(
    ...
    def testLineItemUpdateRequestDataMatter(self):
        """Test LineItemUpdateRequestDataMatter"""
