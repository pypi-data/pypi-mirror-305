...
from openapi_client.models.practice_area import PracticeArea  # noqa: E501

class TestPracticeArea(unittest.TestCase):
    """PracticeArea unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PracticeArea:
        """Test PracticeArea
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PracticeArea`
        """
        model = PracticeArea()  # noqa: E501
        if include_optional:
            return PracticeArea(
                id = 56,
                etag = '',
