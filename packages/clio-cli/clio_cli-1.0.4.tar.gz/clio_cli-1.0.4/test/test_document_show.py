...
from openapi_client.models.document_show import DocumentShow  # noqa: E501

class TestDocumentShow(unittest.TestCase):
    """DocumentShow unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentShow:
        """Test DocumentShow
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentShow`
        """
        model = DocumentShow()  # noqa: E501
        if include_optional:
            return DocumentShow(
                data = None
            )
