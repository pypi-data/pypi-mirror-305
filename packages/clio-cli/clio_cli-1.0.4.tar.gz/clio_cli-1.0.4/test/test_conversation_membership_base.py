...
from openapi_client.models.conversation_membership_base import ConversationMembershipBase  # noqa: E501

class TestConversationMembershipBase(unittest.TestCase):
    """ConversationMembershipBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConversationMembershipBase:
        """Test ConversationMembershipBase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConversationMembershipBase`
        """
        model = ConversationMembershipBase()  # noqa: E501
        if include_optional:
            return ConversationMembershipBase(
                id = 56,
                etag = '',
                read = True,
                archived = True,
    ...
    def testConversationMembershipBase(self):
        """Test ConversationMembershipBase"""
