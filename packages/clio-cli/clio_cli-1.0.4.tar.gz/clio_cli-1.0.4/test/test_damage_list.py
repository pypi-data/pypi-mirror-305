...
from openapi_client.models.damage_list import DamageList  # noqa: E501

class TestDamageList(unittest.TestCase):
    """DamageList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DamageList:
        """Test DamageList
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DamageList`
        """
        model = DamageList()  # noqa: E501
        if include_optional:
            return DamageList(
                data = [
                    null
