...
class ActivityCreateRequestDataUtbmsExpense(BaseModel):
    """
    ActivityCreateRequestDataUtbmsExpense
    """
    id: Optional[StrictInt] = Field(default=None, description="The unique identifier for a single UtbmsExpense associated with the Activity. The keyword `null` is not valid for this field.")
    __properties = ["id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ActivityCreateRequestDataUtbmsExpense:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ActivityCreateRequestDataUtbmsExpense:
        """Create an instance of ActivityCreateRequestDataUtbmsExpense from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ActivityCreateRequestDataUtbmsExpense.parse_obj(obj)

        _obj = ActivityCreateRequestDataUtbmsExpense.parse_obj({
            "id": obj.get("id")
        })
        return _obj
