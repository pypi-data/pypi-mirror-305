...
class MatterCreateRequestDataTaskTemplateListInstancesInnerTaskTemplateList(BaseModel):
    """
    MatterCreateRequestDataTaskTemplateListInstancesInnerTaskTemplateList
    """
    id: StrictInt = Field(default=..., description="The unique identifier for a single TaskTemplateList associated with the TaskTemplateListInstance. The keyword `null` is not valid for this field.")
    __properties = ["id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MatterCreateRequestDataTaskTemplateListInstancesInnerTaskTemplateList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MatterCreateRequestDataTaskTemplateListInstancesInnerTaskTemplateList:
        """Create an instance of MatterCreateRequestDataTaskTemplateListInstancesInnerTaskTemplateList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MatterCreateRequestDataTaskTemplateListInstancesInnerTaskTemplateList.parse_obj(obj)

        _obj = MatterCreateRequestDataTaskTemplateListInstancesInnerTaskTemplateList.parse_obj({
            "id": obj.get("id")
        })
        return _obj
