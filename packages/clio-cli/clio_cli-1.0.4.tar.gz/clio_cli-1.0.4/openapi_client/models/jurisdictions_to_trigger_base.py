...
class JurisdictionsToTriggerBase(BaseModel):
    ...
    """
    id: Optional[StrictInt] = Field(default=None, description="Unique identifier for the *JurisdictionsToTrigger*")
    etag: Optional[StrictStr] = Field(default=None, description="ETag for the *JurisdictionsToTrigger*")
    system_id: Optional[StrictInt] = Field(default=None, description="Server id")
    description: Optional[StrictStr] = Field(default=None, description="A detailed description of the *JurisdictionsToTrigger*")
    do_not_recalculate: Optional[StrictBool] = Field(default=None, description="Whether the associated dates should not be recalculated")
    is_served: Optional[StrictBool] = Field(default=None, description="Whether the user must select a Date Offset (Service Type)")
    is_requirements_required: Optional[StrictBool] = Field(default=None, description="Whether the trigger has requirements")
    created_at: Optional[datetime] = Field(default=None, description="The time the *JurisdictionsToTrigger* was created (as a ISO-8601 timestamp)")
    updated_at: Optional[datetime] = Field(default=None, description="The time the *JurisdictionsToTrigger* was last updated (as a ISO-8601 timestamp)")
    __properties = ["id", "etag", "system_id", "description", "do_not_recalculate", "is_served", "is_requirements_required", "created_at", "updated_at"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> JurisdictionsToTriggerBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> JurisdictionsToTriggerBase:
        """Create an instance of JurisdictionsToTriggerBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return JurisdictionsToTriggerBase.parse_obj(obj)

        _obj = JurisdictionsToTriggerBase.parse_obj({
            "id": obj.get("id"),
            "etag": obj.get("etag"),
            "system_id": obj.get("system_id"),
            "description": obj.get("description"),
            "do_not_recalculate": obj.get("do_not_recalculate"),
            "is_served": obj.get("is_served"),
            "is_requirements_required": obj.get("is_requirements_required"),
