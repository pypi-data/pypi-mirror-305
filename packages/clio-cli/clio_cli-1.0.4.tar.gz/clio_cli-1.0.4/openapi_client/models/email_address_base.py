...
class EmailAddressBase(BaseModel):
    ...
    EmailAddressBase
    """
    id: Optional[StrictInt] = Field(default=None, description="Unique identifier for the *EmailAddress*")
    etag: Optional[StrictStr] = Field(default=None, description="ETag for the *EmailAddress*")
    address: Optional[StrictStr] = Field(default=None, description="The address of the *EmailAddress*")
    name: Optional[StrictStr] = Field(default=None, description="A descriptive name for the *EmailAddress. Common values include `Home`, `Work`, and `Other`, as these are the only selectable options within Clio Manage, but other values may be returned for this field.")
    primary: Optional[StrictBool] = Field(default=None, description="Whether it is the default for this contact")
    created_at: Optional[datetime] = Field(default=None, description="The time the *EmailAddress* was created (as a ISO-8601 timestamp)")
    updated_at: Optional[datetime] = Field(default=None, description="The time the *EmailAddress* was last updated (as a ISO-8601 timestamp)")
    __properties = ["id", "etag", "address", "name", "primary", "created_at", "updated_at"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EmailAddressBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EmailAddressBase:
        """Create an instance of EmailAddressBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EmailAddressBase.parse_obj(obj)

        _obj = EmailAddressBase.parse_obj({
            "id": obj.get("id"),
            "etag": obj.get("etag"),
