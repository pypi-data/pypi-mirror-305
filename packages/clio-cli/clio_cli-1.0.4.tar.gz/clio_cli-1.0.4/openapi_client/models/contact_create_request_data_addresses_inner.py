...
class ContactCreateRequestDataAddressesInner(BaseModel):
    """
    ...
    __properties = ["name", "street", "city", "province", "postal_code", "country"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ContactCreateRequestDataAddressesInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ContactCreateRequestDataAddressesInner:
        """Create an instance of ContactCreateRequestDataAddressesInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ContactCreateRequestDataAddressesInner.parse_obj(obj)

        _obj = ContactCreateRequestDataAddressesInner.parse_obj({
