...
class CalendarEntryEventType(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CalendarEntryEventType:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CalendarEntryEventType:
        """Create an instance of CalendarEntryEventType from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CalendarEntryEventType.parse_obj(obj)

        _obj = CalendarEntryEventType.parse_obj({
            "id": obj.get("id"),
            "etag": obj.get("etag"),
