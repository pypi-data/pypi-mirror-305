...
class GroupCreateRequestData(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GroupCreateRequestData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GroupCreateRequestData:
        """Create an instance of GroupCreateRequestData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GroupCreateRequestData.parse_obj(obj)

        _obj = GroupCreateRequestData.parse_obj({
            "name": obj.get("name")
        })
        return _obj
