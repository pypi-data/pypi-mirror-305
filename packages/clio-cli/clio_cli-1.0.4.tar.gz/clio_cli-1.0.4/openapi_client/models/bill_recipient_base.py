...
class BillRecipientBase(BaseModel):
    ...
    __properties = ["created_at", "etag", "id", "on_all_matters", "updated_at"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BillRecipientBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BillRecipientBase:
        """Create an instance of BillRecipientBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BillRecipientBase.parse_obj(obj)

        _obj = BillRecipientBase.parse_obj({
