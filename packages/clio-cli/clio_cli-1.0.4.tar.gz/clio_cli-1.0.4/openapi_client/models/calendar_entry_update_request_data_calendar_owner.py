...
class CalendarEntryUpdateRequestDataCalendarOwner(BaseModel):
    """
    CalendarEntryUpdateRequestDataCalendarOwner
    """
    id: Optional[StrictInt] = Field(default=None, description="The unique identifier for a single Calendar associated with the CalendarEntry. The keyword `null` is not valid for this field.")
    __properties = ["id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CalendarEntryUpdateRequestDataCalendarOwner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CalendarEntryUpdateRequestDataCalendarOwner:
        """Create an instance of CalendarEntryUpdateRequestDataCalendarOwner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CalendarEntryUpdateRequestDataCalendarOwner.parse_obj(obj)

        _obj = CalendarEntryUpdateRequestDataCalendarOwner.parse_obj({
            "id": obj.get("id")
        })
        return _obj
