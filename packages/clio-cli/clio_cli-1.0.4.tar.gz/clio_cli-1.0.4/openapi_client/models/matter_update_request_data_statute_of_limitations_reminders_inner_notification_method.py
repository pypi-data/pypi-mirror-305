...
class MatterUpdateRequestDataStatuteOfLimitationsRemindersInnerNotificationMethod(BaseModel):
    """
    MatterUpdateRequestDataStatuteOfLimitationsRemindersInnerNotificationMethod
    """
    id: Optional[StrictInt] = Field(default=None, description="The unique identifier for a single NotificationMethod associated with the Reminder. The keyword `null` is not valid for this field.")
    __properties = ["id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MatterUpdateRequestDataStatuteOfLimitationsRemindersInnerNotificationMethod:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MatterUpdateRequestDataStatuteOfLimitationsRemindersInnerNotificationMethod:
        """Create an instance of MatterUpdateRequestDataStatuteOfLimitationsRemindersInnerNotificationMethod from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MatterUpdateRequestDataStatuteOfLimitationsRemindersInnerNotificationMethod.parse_obj(obj)

        _obj = MatterUpdateRequestDataStatuteOfLimitationsRemindersInnerNotificationMethod.parse_obj({
            "id": obj.get("id")
        })
        return _obj
