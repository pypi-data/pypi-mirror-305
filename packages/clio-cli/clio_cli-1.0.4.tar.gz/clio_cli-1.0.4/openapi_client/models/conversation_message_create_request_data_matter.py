...
class ConversationMessageCreateRequestDataMatter(BaseModel):
    """
    ConversationMessageCreateRequestDataMatter
    """
    id: Optional[StrictInt] = Field(default=None, description="The unique identifier for a single Matter associated with the ConversationMessage. The keyword `null` is not valid for this field.")
    __properties = ["id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ConversationMessageCreateRequestDataMatter:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ConversationMessageCreateRequestDataMatter:
        """Create an instance of ConversationMessageCreateRequestDataMatter from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ConversationMessageCreateRequestDataMatter.parse_obj(obj)

        _obj = ConversationMessageCreateRequestDataMatter.parse_obj({
            "id": obj.get("id")
        })
        return _obj
