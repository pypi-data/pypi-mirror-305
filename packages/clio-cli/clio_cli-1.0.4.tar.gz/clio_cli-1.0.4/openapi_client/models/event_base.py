...
class EventBase(BaseModel):
    ...
    EventBase
    """
    id: Optional[StrictInt] = Field(default=None, description="Unique identifier for the *Event*")
    etag: Optional[StrictStr] = Field(default=None, description="ETag for the *Event*")
    message: Optional[StrictStr] = Field(default=None, description="Concise headline message describing the event")
    icon: Optional[StrictStr] = Field(default=None, description="Font Awesome icon to display (without the fa- prefix)")
    title: Optional[StrictStr] = Field(default=None, description="The title or subject of the event (e.g. Matter Number, Document Title)")
    title_url: Optional[StrictStr] = Field(default=None, description="Target URL that will be opened if the user clicks on the event title")
    description: Optional[StrictStr] = Field(default=None, description="Description or additional information about the event (e.g. Matter Description)")
    description_url: Optional[StrictStr] = Field(default=None, description="Target URL that will be opened if the user clicks on the event description")
    primary_detail: Optional[StrictStr] = Field(default=None, description="Optional additional information about the event (e.g. Matter Client, Document Author)")
    primary_detail_url: Optional[StrictStr] = Field(default=None, description="Target URL that will be opened if the user clicks on the primary detail")
    secondary_detail: Optional[StrictStr] = Field(default=None, description="Optional additional information about the event (e.g. Matter Status, Document Size)")
    secondary_detail_url: Optional[StrictStr] = Field(default=None, description="Target URL that will be opened if the user clicks on the secondary detail")
    occurred_at: Optional[datetime] = Field(default=None, description="When the event occurred")
    mobile_icon: Optional[StrictStr] = Field(default=None, description="Icon to be displayed in the mobile app")
    subject_type: Optional[StrictStr] = Field(default=None, description="The type of subject that triggered the notification (e.g. Matter, Document)")
    subject_id: Optional[StrictInt] = Field(default=None, description="Id of the subject that triggered the notification")
    __properties = ["id", "etag", "message", "icon", "title", "title_url", "description", "description_url", "primary_detail", "primary_detail_url", "secondary_detail", "secondary_detail_url", "occurred_at", "mobile_icon", "subject_type", "subject_id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EventBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EventBase:
        """Create an instance of EventBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EventBase.parse_obj(obj)

        _obj = EventBase.parse_obj({
            "id": obj.get("id"),
            "etag": obj.get("etag"),
            ...
            "primary_detail": obj.get("primary_detail"),
            "primary_detail_url": obj.get("primary_detail_url"),
            "secondary_detail": obj.get("secondary_detail"),
            "secondary_detail_url": obj.get("secondary_detail_url"),
            "occurred_at": obj.get("occurred_at"),
            "mobile_icon": obj.get("mobile_icon"),
