...
class MatterUpdateRequestDataCustomRateRatesInnerUser(BaseModel):
    """
    MatterUpdateRequestDataCustomRateRatesInnerUser
    """
    id: Optional[StrictInt] = Field(default=None, description="The unique identifier for a single User associated with the Rate. The keyword `null` is not valid for this field.")
    __properties = ["id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MatterUpdateRequestDataCustomRateRatesInnerUser:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MatterUpdateRequestDataCustomRateRatesInnerUser:
        """Create an instance of MatterUpdateRequestDataCustomRateRatesInnerUser from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MatterUpdateRequestDataCustomRateRatesInnerUser.parse_obj(obj)

        _obj = MatterUpdateRequestDataCustomRateRatesInnerUser.parse_obj({
            "id": obj.get("id")
        })
        return _obj
