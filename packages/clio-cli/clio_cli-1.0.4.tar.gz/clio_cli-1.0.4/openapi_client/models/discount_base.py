...
class DiscountBase(BaseModel):
    ...
    __properties = ["rate", "type", "note", "early_payment_rate", "early_payment_period"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DiscountBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DiscountBase:
        """Create an instance of DiscountBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DiscountBase.parse_obj(obj)

        _obj = DiscountBase.parse_obj({
            "rate": obj.get("rate"),
            "type": obj.get("type"),
            "note": obj.get("note"),
            "early_payment_rate": obj.get("early_payment_rate"),
            "early_payment_period": obj.get("early_payment_period")
        })
        return _obj
