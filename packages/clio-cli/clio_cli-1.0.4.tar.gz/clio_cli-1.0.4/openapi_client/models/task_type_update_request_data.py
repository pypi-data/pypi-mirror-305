...
class TaskTypeUpdateRequestData(BaseModel):
    """
    TaskTypeUpdateRequestData
    """
    deleted_at: Optional[date] = Field(default=None, description="Date the TaskType was disabled. (Expects an ISO-8601 timestamp).")
    name: Optional[StrictStr] = Field(default=None, description="Name of the TaskType.")
    __properties = ["deleted_at", "name"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TaskTypeUpdateRequestData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TaskTypeUpdateRequestData:
        """Create an instance of TaskTypeUpdateRequestData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TaskTypeUpdateRequestData.parse_obj(obj)

        _obj = TaskTypeUpdateRequestData.parse_obj({
