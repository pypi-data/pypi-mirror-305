...
class ActivityCreateRequestDataMatter(BaseModel):
    """
    ActivityCreateRequestDataMatter
    """
    id: Optional[StrictInt] = Field(default=None, description="The unique identifier for a single Matter associated with the Activity. The keyword `null` is not valid for this field.")
    __properties = ["id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ActivityCreateRequestDataMatter:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ActivityCreateRequestDataMatter:
        """Create an instance of ActivityCreateRequestDataMatter from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ActivityCreateRequestDataMatter.parse_obj(obj)

        _obj = ActivityCreateRequestDataMatter.parse_obj({
            "id": obj.get("id")
        })
        return _obj
