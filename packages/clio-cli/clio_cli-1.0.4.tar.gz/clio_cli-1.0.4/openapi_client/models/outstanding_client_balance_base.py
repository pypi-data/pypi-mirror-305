...
class OutstandingClientBalanceBase(BaseModel):
    ...
    __properties = ["associated_matter_ids", "etag", "id", "last_payment_date", "last_shared_date", "newest_issued_bill_due_date", "pending_payments_total", "reminders_enabled", "total_outstanding_balance", "created_at", "updated_at"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OutstandingClientBalanceBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OutstandingClientBalanceBase:
        """Create an instance of OutstandingClientBalanceBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OutstandingClientBalanceBase.parse_obj(obj)

        _obj = OutstandingClientBalanceBase.parse_obj({
