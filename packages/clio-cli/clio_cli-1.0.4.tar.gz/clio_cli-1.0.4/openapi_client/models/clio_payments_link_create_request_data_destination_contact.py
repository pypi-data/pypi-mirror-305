...
class ClioPaymentsLinkCreateRequestDataDestinationContact(BaseModel):
    """
    ClioPaymentsLinkCreateRequestDataDestinationContact
    """
    id: Optional[StrictInt] = Field(default=None, description="Only applicable for a direct payment. The contact that the payment will be associated with. If not defined, and the payment is collecting an unallocated balance, then the payment can be associated with a contact manually within Manage after it has been made.")
    __properties = ["id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ClioPaymentsLinkCreateRequestDataDestinationContact:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ClioPaymentsLinkCreateRequestDataDestinationContact:
        """Create an instance of ClioPaymentsLinkCreateRequestDataDestinationContact from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ClioPaymentsLinkCreateRequestDataDestinationContact.parse_obj(obj)

        _obj = ClioPaymentsLinkCreateRequestDataDestinationContact.parse_obj({
            "id": obj.get("id")
        })
        return _obj
