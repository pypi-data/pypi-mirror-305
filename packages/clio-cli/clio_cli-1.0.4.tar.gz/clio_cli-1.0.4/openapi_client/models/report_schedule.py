...
class ReportSchedule(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ReportSchedule:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ReportSchedule:
        """Create an instance of ReportSchedule from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ReportSchedule.parse_obj(obj)

        _obj = ReportSchedule.parse_obj({
            "id": obj.get("id"),
            "etag": obj.get("etag"),
