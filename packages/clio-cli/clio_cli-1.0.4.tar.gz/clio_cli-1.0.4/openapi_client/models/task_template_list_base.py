...
class TaskTemplateListBase(BaseModel):
    ...
    """
    created_at: Optional[datetime] = Field(default=None, description="The time the *TaskTemplateList* was created (as a ISO-8601 timestamp)")
    description: Optional[StrictStr] = Field(default=None, description="A detailed description of the *TaskTemplateList*")
    id: Optional[StrictInt] = Field(default=None, description="Unique identifier for the *TaskTemplateList*")
    etag: Optional[StrictStr] = Field(default=None, description="ETag for the *TaskTemplateList*")
    name: Optional[StrictStr] = Field(default=None, description="The name of the *TaskTemplateList*")
    templates_count: Optional[StrictInt] = Field(default=None, description="How many task templates exist as an association to the *TaskTemplateList*")
    updated_at: Optional[datetime] = Field(default=None, description="The time the *TaskTemplateList* was last updated (as a ISO-8601 timestamp)")
    __properties = ["created_at", "description", "id", "etag", "name", "templates_count", "updated_at"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TaskTemplateListBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TaskTemplateListBase:
        """Create an instance of TaskTemplateListBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TaskTemplateListBase.parse_obj(obj)

        _obj = TaskTemplateListBase.parse_obj({
            "created_at": obj.get("created_at"),
            "description": obj.get("description"),
            "id": obj.get("id"),
            "etag": obj.get("etag"),
            "name": obj.get("name"),
            "templates_count": obj.get("templates_count"),
