...
class DocumentVersionBase(BaseModel):
    ...
    __properties = ["id", "document_id", "etag", "uuid", "created_at", "updated_at", "filename", "size", "version_number", "content_type", "received_at", "put_url", "fully_uploaded"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DocumentVersionBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DocumentVersionBase:
        """Create an instance of DocumentVersionBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DocumentVersionBase.parse_obj(obj)

        _obj = DocumentVersionBase.parse_obj({
            "id": obj.get("id"),
