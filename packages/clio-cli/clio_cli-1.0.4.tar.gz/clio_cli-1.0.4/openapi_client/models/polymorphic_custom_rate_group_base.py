...
class PolymorphicCustomRateGroupBase(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PolymorphicCustomRateGroupBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PolymorphicCustomRateGroupBase:
        """Create an instance of PolymorphicCustomRateGroupBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PolymorphicCustomRateGroupBase.parse_obj(obj)

        _obj = PolymorphicCustomRateGroupBase.parse_obj({
            "etag": obj.get("etag"),
            "id": obj.get("id"),
            "name": obj.get("name")
        })
