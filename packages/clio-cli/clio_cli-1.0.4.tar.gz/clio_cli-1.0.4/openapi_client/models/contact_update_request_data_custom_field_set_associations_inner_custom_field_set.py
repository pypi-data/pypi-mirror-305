...
class ContactUpdateRequestDataCustomFieldSetAssociationsInnerCustomFieldSet(BaseModel):
    """
    ContactUpdateRequestDataCustomFieldSetAssociationsInnerCustomFieldSet
    """
    id: Optional[StrictInt] = Field(default=None, description="The unique identifier for a single CustomFieldSet associated with the CustomFieldSetAssociation. The keyword `null` is not valid for this field.")
    __properties = ["id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ContactUpdateRequestDataCustomFieldSetAssociationsInnerCustomFieldSet:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ContactUpdateRequestDataCustomFieldSetAssociationsInnerCustomFieldSet:
        """Create an instance of ContactUpdateRequestDataCustomFieldSetAssociationsInnerCustomFieldSet from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ContactUpdateRequestDataCustomFieldSetAssociationsInnerCustomFieldSet.parse_obj(obj)

        _obj = ContactUpdateRequestDataCustomFieldSetAssociationsInnerCustomFieldSet.parse_obj({
            "id": obj.get("id")
        })
        return _obj
