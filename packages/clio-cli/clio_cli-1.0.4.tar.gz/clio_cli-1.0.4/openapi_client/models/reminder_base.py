...
class ReminderBase(BaseModel):
    ...
    __properties = ["id", "etag", "duration", "next_delivery_at", "state", "created_at", "updated_at"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ReminderBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ReminderBase:
        """Create an instance of ReminderBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ReminderBase.parse_obj(obj)

        _obj = ReminderBase.parse_obj({
            "id": obj.get("id"),
            "etag": obj.get("etag"),
