...
class ActivityTextMessageConversationBase(BaseModel):
    ...
    """
    id: Optional[StrictInt] = Field(default=None, description="Unique identifier for the *TextMessageConversation*")
    etag: Optional[StrictStr] = Field(default=None, description="ETag for the *TextMessageConversation*")
    __properties = ["id", "etag"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ActivityTextMessageConversationBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ActivityTextMessageConversationBase:
        """Create an instance of ActivityTextMessageConversationBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ActivityTextMessageConversationBase.parse_obj(obj)

        _obj = ActivityTextMessageConversationBase.parse_obj({
            "id": obj.get("id"),
            "etag": obj.get("etag")
        })
        return _obj
