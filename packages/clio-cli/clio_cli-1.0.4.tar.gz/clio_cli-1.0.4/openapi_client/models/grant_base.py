...
class GrantBase(BaseModel):
    ...
    __properties = ["id", "etag", "name", "funding_code", "funding_code_and_name", "funding_source_name", "created_at", "updated_at", "balance"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GrantBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GrantBase:
        """Create an instance of GrantBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GrantBase.parse_obj(obj)

        _obj = GrantBase.parse_obj({
            "id": obj.get("id"),
            "etag": obj.get("etag"),
            "name": obj.get("name"),
