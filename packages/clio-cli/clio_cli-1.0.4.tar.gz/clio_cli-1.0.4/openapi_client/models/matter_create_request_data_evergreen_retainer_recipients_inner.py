...
class MatterCreateRequestDataEvergreenRetainerRecipientsInner(BaseModel):
    """
    MatterCreateRequestDataEvergreenRetainerRecipientsInner
    """
    id: Optional[StrictInt] = Field(default=None, description="the `id` of a User who will receive the trust balance notification.")
    destroy: Optional[StrictBool] = Field(default=None, alias="_destroy", description="Used to remove an existing User as a recipient of the trust balance notification.")
    __properties = ["id", "_destroy"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MatterCreateRequestDataEvergreenRetainerRecipientsInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MatterCreateRequestDataEvergreenRetainerRecipientsInner:
        """Create an instance of MatterCreateRequestDataEvergreenRetainerRecipientsInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MatterCreateRequestDataEvergreenRetainerRecipientsInner.parse_obj(obj)

        _obj = MatterCreateRequestDataEvergreenRetainerRecipientsInner.parse_obj({
            "id": obj.get("id"),
