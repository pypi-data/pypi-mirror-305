...
class InstantMessengerBase(BaseModel):
    ...
    """
    id: Optional[StrictInt] = Field(default=None, description="Unique identifier for the *InstantMessenger*")
    etag: Optional[StrictStr] = Field(default=None, description="ETag for the *InstantMessenger*")
    address: Optional[StrictStr] = Field(default=None, description="The address of the *InstantMessenger*")
    name: Optional[StrictStr] = Field(default=None, description="The type of *InstantMessenger* it is")
    created_at: Optional[datetime] = Field(default=None, description="The time the *InstantMessenger* was created (as a ISO-8601 timestamp)")
    updated_at: Optional[datetime] = Field(default=None, description="The time the *InstantMessenger* was last updated (as a ISO-8601 timestamp)")
    __properties = ["id", "etag", "address", "name", "created_at", "updated_at"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InstantMessengerBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InstantMessengerBase:
        """Create an instance of InstantMessengerBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return InstantMessengerBase.parse_obj(obj)

        _obj = InstantMessengerBase.parse_obj({
            "id": obj.get("id"),
            "etag": obj.get("etag"),
