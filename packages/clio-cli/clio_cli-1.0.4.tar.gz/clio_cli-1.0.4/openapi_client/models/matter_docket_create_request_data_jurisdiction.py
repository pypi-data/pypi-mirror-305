...
class MatterDocketCreateRequestDataJurisdiction(BaseModel):
    """
    MatterDocketCreateRequestDataJurisdiction
    """
    id: StrictInt = Field(default=..., description="The unique identifier for a single Jurisdiction associated with the MatterDocket. The keyword `null` is not valid for this field.")
    __properties = ["id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MatterDocketCreateRequestDataJurisdiction:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MatterDocketCreateRequestDataJurisdiction:
        """Create an instance of MatterDocketCreateRequestDataJurisdiction from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MatterDocketCreateRequestDataJurisdiction.parse_obj(obj)

        _obj = MatterDocketCreateRequestDataJurisdiction.parse_obj({
            "id": obj.get("id")
        })
        return _obj
