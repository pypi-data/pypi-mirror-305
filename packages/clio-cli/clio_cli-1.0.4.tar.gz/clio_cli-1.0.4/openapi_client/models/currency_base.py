...
class CurrencyBase(BaseModel):
    ...
    CurrencyBase
    """
    id: Optional[StrictInt] = Field(default=None, description="Unique identifier for the *Currency*")
    etag: Optional[StrictStr] = Field(default=None, description="ETag for the *Currency*")
    code: Optional[StrictStr] = Field(default=None, description="ISO 4217 code for the *Currency*")
    sign: Optional[StrictStr] = Field(default=None, description="Symbol used to denote monetary values using this *Currency*")
    created_at: Optional[datetime] = Field(default=None, description="The time the *Currency* was created (as a ISO-8601 timestamp)")
    updated_at: Optional[datetime] = Field(default=None, description="The time the *Currency* was last updated (as a ISO-8601 timestamp)")
    __properties = ["id", "etag", "code", "sign", "created_at", "updated_at"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CurrencyBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CurrencyBase:
        """Create an instance of CurrencyBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CurrencyBase.parse_obj(obj)

        _obj = CurrencyBase.parse_obj({
            "id": obj.get("id"),
            "etag": obj.get("etag"),
            "code": obj.get("code"),
            "sign": obj.get("sign"),
