...
class LineItemUpdateRequestDataMatter(BaseModel):
    """
    LineItemUpdateRequestDataMatter
    """
    id: Optional[StrictInt] = Field(default=None, description="The unique identifier for a single Matter associated with the LineItem. The keyword `null` is not valid for this field.")
    __properties = ["id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LineItemUpdateRequestDataMatter:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LineItemUpdateRequestDataMatter:
        """Create an instance of LineItemUpdateRequestDataMatter from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LineItemUpdateRequestDataMatter.parse_obj(obj)

        _obj = LineItemUpdateRequestDataMatter.parse_obj({
            "id": obj.get("id")
        })
        return _obj
