...
class GroupBase(BaseModel):
    ...
    __properties = ["client_connect_user", "etag", "id", "name", "type", "updated_at"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GroupBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GroupBase:
        """Create an instance of GroupBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GroupBase.parse_obj(obj)

        _obj = GroupBase.parse_obj({
