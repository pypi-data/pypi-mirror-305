...
class DocumentAutomationCreateRequestDataMatter(BaseModel):
    """
    DocumentAutomationCreateRequestDataMatter
    """
    id: StrictInt = Field(default=..., description="The unique identifier for a single Matter associated with the DocumentAutomation. The keyword `null` is not valid for this field.")
    __properties = ["id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DocumentAutomationCreateRequestDataMatter:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DocumentAutomationCreateRequestDataMatter:
        """Create an instance of DocumentAutomationCreateRequestDataMatter from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DocumentAutomationCreateRequestDataMatter.parse_obj(obj)

        _obj = DocumentAutomationCreateRequestDataMatter.parse_obj({
            "id": obj.get("id")
        })
        return _obj
