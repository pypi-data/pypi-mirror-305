...
class BillingSettingBase(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BillingSettingBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BillingSettingBase:
        """Create an instance of BillingSettingBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BillingSettingBase.parse_obj(obj)

        _obj = BillingSettingBase.parse_obj({
            "id": obj.get("id"),
            "etag": obj.get("etag"),
