...
class ItemBase(BaseModel):
    ...
    __properties = ["id", "etag", "created_at", "updated_at", "deleted_at", "type", "locked", "name"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ItemBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ItemBase:
        """Create an instance of ItemBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ItemBase.parse_obj(obj)

        _obj = ItemBase.parse_obj({
            "id": obj.get("id"),
            "etag": obj.get("etag"),
