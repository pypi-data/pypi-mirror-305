...
class TextSnippetUpdateRequestData(BaseModel):
    """
    TextSnippetUpdateRequestData
    """
    phrase: Optional[StrictStr] = Field(default=None, description="The phrase expanded to from a TextSnippet.")
    snippet: Optional[StrictStr] = Field(default=None, description="The abbreviation that expands to a phrase.")
    whole_word: Optional[StrictBool] = Field(default=None, description="Whether or not the TextSnippet requires a space after to trigger the expansion.")
    __properties = ["phrase", "snippet", "whole_word"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TextSnippetUpdateRequestData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TextSnippetUpdateRequestData:
        """Create an instance of TextSnippetUpdateRequestData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TextSnippetUpdateRequestData.parse_obj(obj)

        _obj = TextSnippetUpdateRequestData.parse_obj({
