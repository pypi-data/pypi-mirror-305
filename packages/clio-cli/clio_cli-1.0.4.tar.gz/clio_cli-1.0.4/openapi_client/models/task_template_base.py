...
class TaskTemplateBase(BaseModel):
    ...
    __properties = ["id", "etag", "name", "description", "priority", "private", "created_at", "updated_at"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TaskTemplateBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TaskTemplateBase:
        """Create an instance of TaskTemplateBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TaskTemplateBase.parse_obj(obj)

        _obj = TaskTemplateBase.parse_obj({
            "id": obj.get("id"),
            "etag": obj.get("etag"),
            "name": obj.get("name"),
