...
class LaukCivilCertificatedRate(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LaukCivilCertificatedRate:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LaukCivilCertificatedRate:
        """Create an instance of LaukCivilCertificatedRate from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LaukCivilCertificatedRate.parse_obj(obj)

        _obj = LaukCivilCertificatedRate.parse_obj({
            "id": obj.get("id"),
