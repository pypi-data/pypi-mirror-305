...
class RelationshipBase(BaseModel):
    ...
    __properties = ["id", "etag", "description", "created_at", "updated_at"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RelationshipBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RelationshipBase:
        """Create an instance of RelationshipBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RelationshipBase.parse_obj(obj)

        _obj = RelationshipBase.parse_obj({
            "id": obj.get("id"),
            "etag": obj.get("etag"),
