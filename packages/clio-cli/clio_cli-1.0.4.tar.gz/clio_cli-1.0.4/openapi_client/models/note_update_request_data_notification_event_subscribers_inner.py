...
class NoteUpdateRequestDataNotificationEventSubscribersInner(BaseModel):
    """
    NoteUpdateRequestDataNotificationEventSubscribersInner
    """
    user_id: Optional[StrictStr] = Field(default=None, description="The unique identifier for a User to be added as a notification event subscriber to the Note.")
    id: Optional[StrictInt] = Field(default=None, description="Unique id of this Note.")
    destroy: Optional[StrictBool] = Field(default=None, alias="_destroy", description="Whether or not the notification event subscriber should be deleted.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NoteUpdateRequestDataNotificationEventSubscribersInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NoteUpdateRequestDataNotificationEventSubscribersInner:
        """Create an instance of NoteUpdateRequestDataNotificationEventSubscribersInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NoteUpdateRequestDataNotificationEventSubscribersInner.parse_obj(obj)

        _obj = NoteUpdateRequestDataNotificationEventSubscribersInner.parse_obj({
