...
class MatterCreateRequestDataClient(BaseModel):
    """
    MatterCreateRequestDataClient
    """
    id: StrictInt = Field(default=..., description="The unique identifier for a single Contact associated with the Matter. The keyword `null` is not valid for this field.")
    __properties = ["id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MatterCreateRequestDataClient:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MatterCreateRequestDataClient:
        """Create an instance of MatterCreateRequestDataClient from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MatterCreateRequestDataClient.parse_obj(obj)

        _obj = MatterCreateRequestDataClient.parse_obj({
            "id": obj.get("id")
        })
        return _obj
