...
class ExpenseCategoryCreateRequestDataGroupsInner(BaseModel):
    """
    ExpenseCategoryCreateRequestDataGroupsInner
    """
    id: Optional[StrictInt] = Field(default=None, description="The unique identifier for a single Group associated with the ExpenseCategory. The keyword `null` is not valid for this field.")
    deleted: Optional[StrictBool] = Field(default=None, alias="_deleted", description="A flag to determine if this Group should lose access to this ExpenseCategory.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ExpenseCategoryCreateRequestDataGroupsInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ExpenseCategoryCreateRequestDataGroupsInner:
        """Create an instance of ExpenseCategoryCreateRequestDataGroupsInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ExpenseCategoryCreateRequestDataGroupsInner.parse_obj(obj)

        _obj = ExpenseCategoryCreateRequestDataGroupsInner.parse_obj({
            "id": obj.get("id"),
