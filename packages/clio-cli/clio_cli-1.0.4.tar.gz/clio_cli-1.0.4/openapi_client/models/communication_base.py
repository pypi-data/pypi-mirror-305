...
class CommunicationBase(BaseModel):
    ...
    __properties = ["id", "etag", "subject", "body", "type", "date", "time_entries_count", "created_at", "updated_at", "received_at"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CommunicationBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CommunicationBase:
        """Create an instance of CommunicationBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CommunicationBase.parse_obj(obj)

        _obj = CommunicationBase.parse_obj({
            "id": obj.get("id"),
            "etag": obj.get("etag"),
