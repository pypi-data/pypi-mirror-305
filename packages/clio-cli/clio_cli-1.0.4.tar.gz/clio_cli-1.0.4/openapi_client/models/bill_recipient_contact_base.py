...
class BillRecipientContactBase(BaseModel):
    ...
    __properties = ["id", "name", "first_name", "middle_name", "last_name", "type", "primary_email_address"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BillRecipientContactBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BillRecipientContactBase:
        """Create an instance of BillRecipientContactBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BillRecipientContactBase.parse_obj(obj)

        _obj = BillRecipientContactBase.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
