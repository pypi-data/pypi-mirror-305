...
class CustomActionUpdateRequestData(BaseModel):
    """
    ...
    __properties = ["label", "target_url", "ui_reference"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CustomActionUpdateRequestData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CustomActionUpdateRequestData:
        """Create an instance of CustomActionUpdateRequestData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CustomActionUpdateRequestData.parse_obj(obj)

        _obj = CustomActionUpdateRequestData.parse_obj({
            "label": obj.get("label"),
