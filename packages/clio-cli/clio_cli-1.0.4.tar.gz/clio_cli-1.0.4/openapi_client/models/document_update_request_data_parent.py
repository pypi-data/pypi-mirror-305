...
class DocumentUpdateRequestDataParent(BaseModel):
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in ('Document', 'Folder', 'Contact', 'Matter'):
            raise ValueError("must be one of enum values ('Document', 'Folder', 'Contact', 'Matter')")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DocumentUpdateRequestDataParent:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DocumentUpdateRequestDataParent:
        """Create an instance of DocumentUpdateRequestDataParent from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DocumentUpdateRequestDataParent.parse_obj(obj)

        _obj = DocumentUpdateRequestDataParent.parse_obj({
            "id": obj.get("id"),
            "type": obj.get("type")
        })
        return _obj
