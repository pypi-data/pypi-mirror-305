...
class ContactCreateRequestDataCoCounselRate(BaseModel):
    """
    ContactCreateRequestDataCoCounselRate
    """
    rate: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Billing rate if the Contact is a co-counsel.  Note: this value can only be provided during PATCH requests. It cannot be provided at the time a Contact is created (i.e. POST requests). ")
    __properties = ["rate"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ContactCreateRequestDataCoCounselRate:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ContactCreateRequestDataCoCounselRate:
        """Create an instance of ContactCreateRequestDataCoCounselRate from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ContactCreateRequestDataCoCounselRate.parse_obj(obj)

        _obj = ContactCreateRequestDataCoCounselRate.parse_obj({
            "rate": obj.get("rate")
        })
        return _obj
