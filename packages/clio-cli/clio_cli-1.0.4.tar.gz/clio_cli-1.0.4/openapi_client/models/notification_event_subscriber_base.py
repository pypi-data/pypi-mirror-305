...
class NotificationEventSubscriberBase(BaseModel):
    ...
    """
    id: Optional[StrictInt] = Field(default=None, description="Unique identifier for the *NotificationEventSubscriber*")
    etag: Optional[StrictStr] = Field(default=None, description="ETag for the *NotificationEventSubscriber*")
    user_id: Optional[StrictInt] = Field(default=None, description="The unique identifier for a User added as a notification event subscriber to the NotificationEventSubscriber")
    name: Optional[StrictStr] = Field(default=None, description="The User name added as a notification event subscriber to the NotificationEventSubscriber")
    created_at: Optional[datetime] = Field(default=None, description="The time the *NotificationEventSubscriber* was created (as a ISO-8601 timestamp)")
    updated_at: Optional[datetime] = Field(default=None, description="The time the *NotificationEventSubscriber* was last updated (as a ISO-8601 timestamp)")
    __properties = ["id", "etag", "user_id", "name", "created_at", "updated_at"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NotificationEventSubscriberBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NotificationEventSubscriberBase:
        """Create an instance of NotificationEventSubscriberBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NotificationEventSubscriberBase.parse_obj(obj)

        _obj = NotificationEventSubscriberBase.parse_obj({
            "id": obj.get("id"),
            "etag": obj.get("etag"),
