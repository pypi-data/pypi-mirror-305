...
class ActivityCreateRequestDataCommunication(BaseModel):
    """
    ActivityCreateRequestDataCommunication
    """
    id: Optional[StrictInt] = Field(default=None, description="The unique identifier for a single Communication associated with the Activity. The keyword `null` is not valid for this field.")
    __properties = ["id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ActivityCreateRequestDataCommunication:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ActivityCreateRequestDataCommunication:
        """Create an instance of ActivityCreateRequestDataCommunication from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ActivityCreateRequestDataCommunication.parse_obj(obj)

        _obj = ActivityCreateRequestDataCommunication.parse_obj({
            "id": obj.get("id")
        })
        return _obj
