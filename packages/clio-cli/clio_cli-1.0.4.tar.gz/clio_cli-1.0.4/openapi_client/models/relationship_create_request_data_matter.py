...
class RelationshipCreateRequestDataMatter(BaseModel):
    """
    RelationshipCreateRequestDataMatter
    """
    id: Optional[StrictInt] = Field(default=None, description="The unique identifier for a single Matter associated with the Relationship. The keyword `null` is not valid for this field.")
    __properties = ["id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RelationshipCreateRequestDataMatter:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RelationshipCreateRequestDataMatter:
        """Create an instance of RelationshipCreateRequestDataMatter from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RelationshipCreateRequestDataMatter.parse_obj(obj)

        _obj = RelationshipCreateRequestDataMatter.parse_obj({
            "id": obj.get("id")
        })
        return _obj
