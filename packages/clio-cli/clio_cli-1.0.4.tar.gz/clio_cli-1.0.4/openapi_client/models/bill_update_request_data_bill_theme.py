...
class BillUpdateRequestDataBillTheme(BaseModel):
    """
    BillUpdateRequestDataBillTheme
    """
    id: Optional[StrictInt] = Field(default=None, description="The unique identifier of the bill theme applied to the Bill.")
    __properties = ["id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BillUpdateRequestDataBillTheme:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BillUpdateRequestDataBillTheme:
        """Create an instance of BillUpdateRequestDataBillTheme from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BillUpdateRequestDataBillTheme.parse_obj(obj)

        _obj = BillUpdateRequestDataBillTheme.parse_obj({
            "id": obj.get("id")
        })
        return _obj
