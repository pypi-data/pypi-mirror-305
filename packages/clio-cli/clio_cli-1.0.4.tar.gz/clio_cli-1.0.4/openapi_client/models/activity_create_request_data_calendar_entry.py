...
class ActivityCreateRequestDataCalendarEntry(BaseModel):
    """
    ActivityCreateRequestDataCalendarEntry
    """
    id: Optional[StrictInt] = Field(default=None, description="The unique identifier for a single CalendarEntry associated with the Activity. The keyword `null` is not valid for this field.")
    __properties = ["id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ActivityCreateRequestDataCalendarEntry:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ActivityCreateRequestDataCalendarEntry:
        """Create an instance of ActivityCreateRequestDataCalendarEntry from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ActivityCreateRequestDataCalendarEntry.parse_obj(obj)

        _obj = ActivityCreateRequestDataCalendarEntry.parse_obj({
            "id": obj.get("id")
        })
        return _obj
