...
class MatterUpdateRequestDataClient(BaseModel):
    """
    MatterUpdateRequestDataClient
    """
    id: Optional[StrictInt] = Field(default=None, description="The unique identifier for a single Contact associated with the Matter. The keyword `null` is not valid for this field.")
    __properties = ["id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MatterUpdateRequestDataClient:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MatterUpdateRequestDataClient:
        """Create an instance of MatterUpdateRequestDataClient from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MatterUpdateRequestDataClient.parse_obj(obj)

        _obj = MatterUpdateRequestDataClient.parse_obj({
            "id": obj.get("id")
        })
        return _obj
