...
class NoteCreateRequestDataNotificationEventSubscribersInner(BaseModel):
    """
    NoteCreateRequestDataNotificationEventSubscribersInner
    """
    user_id: StrictStr = Field(default=..., description="The unique identifier for a User to be added as a notification event subscriber to the Note.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NoteCreateRequestDataNotificationEventSubscribersInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NoteCreateRequestDataNotificationEventSubscribersInner:
        """Create an instance of NoteCreateRequestDataNotificationEventSubscribersInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NoteCreateRequestDataNotificationEventSubscribersInner.parse_obj(obj)

        _obj = NoteCreateRequestDataNotificationEventSubscribersInner.parse_obj({
