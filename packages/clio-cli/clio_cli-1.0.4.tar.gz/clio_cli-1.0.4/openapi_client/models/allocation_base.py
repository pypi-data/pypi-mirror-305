...
class AllocationBase(BaseModel):
    ...
    __properties = ["id", "etag", "date", "amount", "interest", "voided_at", "created_at", "updated_at", "description", "has_online_payment", "destroyable", "payment_type"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AllocationBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AllocationBase:
        """Create an instance of AllocationBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AllocationBase.parse_obj(obj)

        _obj = AllocationBase.parse_obj({
            "id": obj.get("id"),
            "etag": obj.get("etag"),
