...
class CalendarEntryCreateRequestDataCalendarEntryEventType(BaseModel):
    """
    CalendarEntryCreateRequestDataCalendarEntryEventType
    """
    id: Optional[StrictInt] = Field(default=None, description="The unique identifier for a single CalendarEntryEventType associated with the CalendarEntry. Use the keyword `null` to specify no association.")
    __properties = ["id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CalendarEntryCreateRequestDataCalendarEntryEventType:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CalendarEntryCreateRequestDataCalendarEntryEventType:
        """Create an instance of CalendarEntryCreateRequestDataCalendarEntryEventType from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CalendarEntryCreateRequestDataCalendarEntryEventType.parse_obj(obj)

        _obj = CalendarEntryCreateRequestDataCalendarEntryEventType.parse_obj({
            "id": obj.get("id")
        })
        return _obj
