...
class ContingencyFeeBase(BaseModel):
    ...
    ContingencyFeeBase
    """
    id: Optional[StrictInt] = Field(default=None, description="Unique identifier for the *ContingencyFee*")
    etag: Optional[StrictStr] = Field(default=None, description="ETag for the *ContingencyFee*")
    created_at: Optional[datetime] = Field(default=None, description="The time the *ContingencyFee* was created (as a ISO-8601 timestamp)")
    updated_at: Optional[datetime] = Field(default=None, description="The time the *ContingencyFee* was last updated (as a ISO-8601 timestamp)")
    show_contingency_award: Optional[StrictBool] = Field(default=None, description="Whether the *ContingencyFee* is posted or on a bill")
    __properties = ["id", "etag", "created_at", "updated_at", "show_contingency_award"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ContingencyFeeBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ContingencyFeeBase:
        """Create an instance of ContingencyFeeBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ContingencyFeeBase.parse_obj(obj)

        _obj = ContingencyFeeBase.parse_obj({
            "id": obj.get("id"),
            "etag": obj.get("etag"),
            "created_at": obj.get("created_at"),
            "updated_at": obj.get("updated_at"),
            "show_contingency_award": obj.get("show_contingency_award")
        })
        return _obj
