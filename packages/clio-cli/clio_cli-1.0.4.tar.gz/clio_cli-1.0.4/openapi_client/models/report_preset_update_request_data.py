...
class ReportPresetUpdateRequestData(BaseModel):
    """
    ReportPresetUpdateRequestData
    """
    format: Optional[StrictStr] = Field(default=None, description="What format the report will be generated in.")
    kind: Optional[StrictStr] = Field(default=None, description="What kind of report will be generated.")
    name: Optional[StrictStr] = Field(default=None, description="Name of the ReportPreset.")
    options: Optional[StrictStr] = Field(default=None, description="What the report generation parameters are. See [Creating a Report Preset](#section/Creating-a-Report-Preset) for a sample request.")
    __properties = ["format", "kind", "name", "options"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ReportPresetUpdateRequestData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ReportPresetUpdateRequestData:
        """Create an instance of ReportPresetUpdateRequestData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ReportPresetUpdateRequestData.parse_obj(obj)

        _obj = ReportPresetUpdateRequestData.parse_obj({
