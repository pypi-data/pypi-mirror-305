...
class TrustRequestBase(BaseModel):
    ...
    TrustRequestBase
    """
    id: Optional[StrictInt] = Field(default=None, description="Unique identifier for the *TrustRequest*")
    etag: Optional[StrictStr] = Field(default=None, description="ETag for the *TrustRequest*")
    created_at: Optional[datetime] = Field(default=None, description="The time the *TrustRequest* was created (as a ISO-8601 timestamp)")
    updated_at: Optional[datetime] = Field(default=None, description="The time the *TrustRequest* was last updated (as a ISO-8601 timestamp)")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TrustRequestBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TrustRequestBase:
        """Create an instance of TrustRequestBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TrustRequestBase.parse_obj(obj)

        _obj = TrustRequestBase.parse_obj({
            "id": obj.get("id"),
            "etag": obj.get("etag"),
