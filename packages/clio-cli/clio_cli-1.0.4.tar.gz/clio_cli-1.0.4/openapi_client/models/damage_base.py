...
class DamageBase(BaseModel):
    ...
    __properties = ["id", "amount", "damage_type", "description", "etag", "created_at", "updated_at"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DamageBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DamageBase:
        """Create an instance of DamageBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DamageBase.parse_obj(obj)

        _obj = DamageBase.parse_obj({
            "id": obj.get("id"),
