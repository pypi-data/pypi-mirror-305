...
class LineItemUpdateRequestDataActivity(BaseModel):
    """
    LineItemUpdateRequestDataActivity
    """
    id: Optional[StrictInt] = Field(default=None, description="The unique identifier for a single Activity associated with the LineItem. The keyword `null` is not valid for this field.")
    __properties = ["id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LineItemUpdateRequestDataActivity:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LineItemUpdateRequestDataActivity:
        """Create an instance of LineItemUpdateRequestDataActivity from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LineItemUpdateRequestDataActivity.parse_obj(obj)

        _obj = LineItemUpdateRequestDataActivity.parse_obj({
            "id": obj.get("id")
        })
        return _obj
