...
class ConversationMessageBase(BaseModel):
    ...
    __properties = ["id", "etag", "date", "body", "created_at", "updated_at"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ConversationMessageBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ConversationMessageBase:
        """Create an instance of ConversationMessageBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ConversationMessageBase.parse_obj(obj)

        _obj = ConversationMessageBase.parse_obj({
            "id": obj.get("id"),
            "etag": obj.get("etag"),
