...
class ActivityCreateRequestDataActivityDescription(BaseModel):
    """
    ...
    __properties = ["id", "utbms_task_id", "utbms_activity_id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ActivityCreateRequestDataActivityDescription:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ActivityCreateRequestDataActivityDescription:
        """Create an instance of ActivityCreateRequestDataActivityDescription from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ActivityCreateRequestDataActivityDescription.parse_obj(obj)

        _obj = ActivityCreateRequestDataActivityDescription.parse_obj({
            "id": obj.get("id"),
