...
class CommunicationEmlFileBase(BaseModel):
    ...
    """
    id: Optional[StrictInt] = Field(default=None, description="Unique identifier for the *CommunicationEmlFile*")
    __properties = ["id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CommunicationEmlFileBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CommunicationEmlFileBase:
        """Create an instance of CommunicationEmlFileBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CommunicationEmlFileBase.parse_obj(obj)

        _obj = CommunicationEmlFileBase.parse_obj({
            "id": obj.get("id")
        })
        return _obj
