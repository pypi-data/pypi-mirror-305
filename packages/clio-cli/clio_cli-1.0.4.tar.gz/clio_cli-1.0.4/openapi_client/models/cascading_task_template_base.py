...
class CascadingTaskTemplateBase(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CascadingTaskTemplateBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CascadingTaskTemplateBase:
        """Create an instance of CascadingTaskTemplateBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CascadingTaskTemplateBase.parse_obj(obj)

        _obj = CascadingTaskTemplateBase.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name")
        })
        return _obj
