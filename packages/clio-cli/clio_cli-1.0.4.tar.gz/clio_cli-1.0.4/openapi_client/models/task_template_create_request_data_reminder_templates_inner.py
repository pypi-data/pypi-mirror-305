...
class TaskTemplateCreateRequestDataReminderTemplatesInner(BaseModel):
    """
    ...
    notification_type: StrictStr = Field(default=..., description="Notification method.")
    __properties = ["duration_value", "duration_unit", "notification_type"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TaskTemplateCreateRequestDataReminderTemplatesInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TaskTemplateCreateRequestDataReminderTemplatesInner:
        """Create an instance of TaskTemplateCreateRequestDataReminderTemplatesInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TaskTemplateCreateRequestDataReminderTemplatesInner.parse_obj(obj)

        _obj = TaskTemplateCreateRequestDataReminderTemplatesInner.parse_obj({
