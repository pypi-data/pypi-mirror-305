...
class CustomActionCreateRequestData(BaseModel):
    """
    CustomActionCreateRequestData
    """
    label: StrictStr = Field(default=..., description="Text label to be displayed on the custom link.")
    target_url: StrictStr = Field(default=..., description="Target URL which will be opened in a new tab when the user clicks the custom link.")
    ui_reference: StrictStr = Field(default=..., description="UI reference location within Clio where the link will be displayed.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CustomActionCreateRequestData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CustomActionCreateRequestData:
        """Create an instance of CustomActionCreateRequestData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CustomActionCreateRequestData.parse_obj(obj)

        _obj = CustomActionCreateRequestData.parse_obj({
            "label": obj.get("label"),
