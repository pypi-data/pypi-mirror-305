...
class JurisdictionBase(BaseModel):
    ...
    __properties = ["id", "etag", "created_at", "updated_at", "system_id", "description", "default", "display_timezone", "valid_subscription", "is_local_timezone"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> JurisdictionBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> JurisdictionBase:
        """Create an instance of JurisdictionBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return JurisdictionBase.parse_obj(obj)

        _obj = JurisdictionBase.parse_obj({
            "id": obj.get("id"),
            "etag": obj.get("etag"),
