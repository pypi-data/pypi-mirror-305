...
class ContactUpdateRequestDataCustomFieldValuesInnerCustomField(BaseModel):
    """
    ContactUpdateRequestDataCustomFieldValuesInnerCustomField
    """
    id: Optional[StrictInt] = Field(default=None, description="The unique identifier for a single CustomField associated with the CustomFieldValue. The keyword `null` is not valid for this field.")
    __properties = ["id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ContactUpdateRequestDataCustomFieldValuesInnerCustomField:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ContactUpdateRequestDataCustomFieldValuesInnerCustomField:
        """Create an instance of ContactUpdateRequestDataCustomFieldValuesInnerCustomField from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ContactUpdateRequestDataCustomFieldValuesInnerCustomField.parse_obj(obj)

        _obj = ContactUpdateRequestDataCustomFieldValuesInnerCustomField.parse_obj({
            "id": obj.get("id")
        })
        return _obj
