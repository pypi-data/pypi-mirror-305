...
class ReportPresetCreateRequestData(BaseModel):
    """
    ...
    name: StrictStr = Field(default=..., description="Name of the ReportPreset.")
    options: StrictStr = Field(default=..., description="What the report generation parameters are. See [Creating a Report Preset](#section/Creating-a-Report-Preset) for a sample request.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ReportPresetCreateRequestData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ReportPresetCreateRequestData:
        """Create an instance of ReportPresetCreateRequestData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ReportPresetCreateRequestData.parse_obj(obj)

        _obj = ReportPresetCreateRequestData.parse_obj({
