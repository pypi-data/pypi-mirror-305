...
class TrustRequestCreateRequestDataMatterInner(BaseModel):
    """
    TrustRequestCreateRequestDataMatterInner
    """
    id: Optional[StrictInt] = Field(default=None, description="The matter id associated to the TrustRequest")
    trust_amount: Optional[StrictInt] = Field(default=None, description="The matter level TrustRequest's amount")
    note: Optional[StrictStr] = Field(default=None, description="The client level TrustRequest note")
    __properties = ["id", "trust_amount", "note"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TrustRequestCreateRequestDataMatterInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TrustRequestCreateRequestDataMatterInner:
        """Create an instance of TrustRequestCreateRequestDataMatterInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TrustRequestCreateRequestDataMatterInner.parse_obj(obj)

        _obj = TrustRequestCreateRequestDataMatterInner.parse_obj({
            "id": obj.get("id"),
