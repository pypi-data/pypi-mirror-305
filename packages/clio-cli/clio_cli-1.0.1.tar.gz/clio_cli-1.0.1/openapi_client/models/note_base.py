...
class NoteBase(BaseModel):
    ...
    __properties = ["id", "etag", "type", "subject", "detail", "date", "created_at", "updated_at", "time_entries_count"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NoteBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NoteBase:
        """Create an instance of NoteBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NoteBase.parse_obj(obj)

        _obj = NoteBase.parse_obj({
            "id": obj.get("id"),
            "etag": obj.get("etag"),
            "type": obj.get("type"),
