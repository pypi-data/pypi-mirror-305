...
class CommunicationUpdateRequestDataNotificationEventSubscribersInner(BaseModel):
    """
    CommunicationUpdateRequestDataNotificationEventSubscribersInner
    """
    user_id: Optional[StrictStr] = Field(default=None, description="The unique identifier for a User to be added as a notification event subscriber to the Phone Log Communication. Note: Only applicable to Phone Log Communications, invalid for other communication types.")
    id: Optional[StrictInt] = Field(default=None, description="Unique id of this Communication. Note: Only applicable to Phone Log Communications, invalid for other communication types.")
    destroy: Optional[StrictBool] = Field(default=None, alias="_destroy", description="Whether or not the notification event subscriber should be deleted. Note: Only applicable to Phone Log Communications, invalid for other communication types.")
    __properties = ["user_id", "id", "_destroy"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CommunicationUpdateRequestDataNotificationEventSubscribersInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CommunicationUpdateRequestDataNotificationEventSubscribersInner:
        """Create an instance of CommunicationUpdateRequestDataNotificationEventSubscribersInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CommunicationUpdateRequestDataNotificationEventSubscribersInner.parse_obj(obj)

        _obj = CommunicationUpdateRequestDataNotificationEventSubscribersInner.parse_obj({
