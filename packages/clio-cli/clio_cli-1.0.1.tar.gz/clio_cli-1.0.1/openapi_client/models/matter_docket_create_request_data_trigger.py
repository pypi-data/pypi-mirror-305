...
class MatterDocketCreateRequestDataTrigger(BaseModel):
    """
    MatterDocketCreateRequestDataTrigger
    """
    id: StrictInt = Field(default=..., description="The unique identifier for a single Trigger associated with the MatterDocket. The keyword `null` is not valid for this field.")
    __properties = ["id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MatterDocketCreateRequestDataTrigger:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MatterDocketCreateRequestDataTrigger:
        """Create an instance of MatterDocketCreateRequestDataTrigger from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MatterDocketCreateRequestDataTrigger.parse_obj(obj)

        _obj = MatterDocketCreateRequestDataTrigger.parse_obj({
            "id": obj.get("id")
        })
        return _obj
