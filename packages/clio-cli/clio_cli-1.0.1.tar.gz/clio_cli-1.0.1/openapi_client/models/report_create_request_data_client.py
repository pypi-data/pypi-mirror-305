...
class ReportCreateRequestDataClient(BaseModel):
    """
    ReportCreateRequestDataClient
    """
    id: Optional[StrictInt] = Field(default=None, description="The unique identifier for a single Contact associated with the Report. The keyword `null` is not valid for this field.")
    __properties = ["id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ReportCreateRequestDataClient:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ReportCreateRequestDataClient:
        """Create an instance of ReportCreateRequestDataClient from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ReportCreateRequestDataClient.parse_obj(obj)

        _obj = ReportCreateRequestDataClient.parse_obj({
            "id": obj.get("id")
        })
        return _obj
