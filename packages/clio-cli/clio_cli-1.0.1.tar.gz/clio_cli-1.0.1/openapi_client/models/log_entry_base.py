...
class LogEntryBase(BaseModel):
    ...
    __properties = ["id", "etag", "type", "accessed_at", "created_at", "updated_at"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LogEntryBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LogEntryBase:
        """Create an instance of LogEntryBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LogEntryBase.parse_obj(obj)

        _obj = LogEntryBase.parse_obj({
            "id": obj.get("id"),
            "etag": obj.get("etag"),
            "type": obj.get("type"),
