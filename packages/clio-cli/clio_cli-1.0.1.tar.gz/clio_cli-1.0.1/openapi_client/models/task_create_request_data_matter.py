...
class TaskCreateRequestDataMatter(BaseModel):
    """
    TaskCreateRequestDataMatter
    """
    id: Optional[StrictInt] = Field(default=None, description="The unique identifier for a single Matter associated with the Task. The keyword `null` is not valid for this field.")
    __properties = ["id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TaskCreateRequestDataMatter:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TaskCreateRequestDataMatter:
        """Create an instance of TaskCreateRequestDataMatter from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TaskCreateRequestDataMatter.parse_obj(obj)

        _obj = TaskCreateRequestDataMatter.parse_obj({
            "id": obj.get("id")
        })
        return _obj
