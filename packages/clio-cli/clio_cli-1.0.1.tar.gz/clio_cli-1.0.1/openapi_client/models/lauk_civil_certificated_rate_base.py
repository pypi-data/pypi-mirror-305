...
class LaukCivilCertificatedRateBase(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LaukCivilCertificatedRateBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LaukCivilCertificatedRateBase:
        """Create an instance of LaukCivilCertificatedRateBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LaukCivilCertificatedRateBase.parse_obj(obj)

        _obj = LaukCivilCertificatedRateBase.parse_obj({
            "id": obj.get("id"),
            "activity": obj.get("activity"),
            "activity_sub_category": obj.get("activity_sub_category"),
            "activity_type": obj.get("activity_type"),
            "attended_several_hearings_for_multiple_clients": obj.get("attended_several_hearings_for_multiple_clients"),
            ...
            "exceptional_warning": obj.get("exceptional_warning"),
            "etag": obj.get("etag"),
            "fee": obj.get("fee"),
