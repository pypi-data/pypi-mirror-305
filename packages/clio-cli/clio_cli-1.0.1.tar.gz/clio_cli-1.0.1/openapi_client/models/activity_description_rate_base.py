...
class ActivityDescriptionRateBase(BaseModel):
    ...
    __properties = ["amount", "non_billable_amount", "type", "hierarchy"]
    ...
    def hierarchy_validate_enum(cls, value):
        ...
        if value not in ('Default', 'Activity', 'Matter', 'Client'):
            raise ValueError("must be one of enum values ('Default', 'Activity', 'Matter', 'Client')")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ActivityDescriptionRateBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ActivityDescriptionRateBase:
        """Create an instance of ActivityDescriptionRateBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ActivityDescriptionRateBase.parse_obj(obj)

        _obj = ActivityDescriptionRateBase.parse_obj({
