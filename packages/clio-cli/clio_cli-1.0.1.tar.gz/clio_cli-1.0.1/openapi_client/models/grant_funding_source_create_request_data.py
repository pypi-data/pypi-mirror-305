...
class GrantFundingSourceCreateRequestData(BaseModel):
    """
    GrantFundingSourceCreateRequestData
    """
    name: Optional[StrictStr] = Field(default=None, description="Name of the GrantFundingSource.")
    __properties = ["name"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GrantFundingSourceCreateRequestData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GrantFundingSourceCreateRequestData:
        """Create an instance of GrantFundingSourceCreateRequestData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GrantFundingSourceCreateRequestData.parse_obj(obj)

        _obj = GrantFundingSourceCreateRequestData.parse_obj({
            "name": obj.get("name")
        })
        return _obj
