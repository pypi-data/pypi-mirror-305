...
class TaskBase(BaseModel):
    ...
    __properties = ["id", "etag", "name", "status", "description", "priority", "due_at", "permission", "completed_at", "notify_completion", "statute_of_limitations", "time_estimated", "created_at", "updated_at", "time_entries_count"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TaskBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TaskBase:
        """Create an instance of TaskBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TaskBase.parse_obj(obj)

        _obj = TaskBase.parse_obj({
            "id": obj.get("id"),
            "etag": obj.get("etag"),
            "name": obj.get("name"),
