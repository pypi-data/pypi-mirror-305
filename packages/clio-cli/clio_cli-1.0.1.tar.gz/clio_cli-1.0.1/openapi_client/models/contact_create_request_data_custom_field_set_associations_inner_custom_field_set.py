...
class ContactCreateRequestDataCustomFieldSetAssociationsInnerCustomFieldSet(BaseModel):
    """
    ContactCreateRequestDataCustomFieldSetAssociationsInnerCustomFieldSet
    """
    id: StrictInt = Field(default=..., description="The unique identifier for a single CustomFieldSet associated with the CustomFieldSetAssociation. The keyword `null` is not valid for this field.")
    __properties = ["id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ContactCreateRequestDataCustomFieldSetAssociationsInnerCustomFieldSet:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ContactCreateRequestDataCustomFieldSetAssociationsInnerCustomFieldSet:
        """Create an instance of ContactCreateRequestDataCustomFieldSetAssociationsInnerCustomFieldSet from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ContactCreateRequestDataCustomFieldSetAssociationsInnerCustomFieldSet.parse_obj(obj)

        _obj = ContactCreateRequestDataCustomFieldSetAssociationsInnerCustomFieldSet.parse_obj({
            "id": obj.get("id")
        })
        return _obj
