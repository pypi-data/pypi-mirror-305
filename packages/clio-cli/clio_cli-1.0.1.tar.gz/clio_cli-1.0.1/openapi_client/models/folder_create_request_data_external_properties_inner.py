...
class FolderCreateRequestDataExternalPropertiesInner(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FolderCreateRequestDataExternalPropertiesInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FolderCreateRequestDataExternalPropertiesInner:
        """Create an instance of FolderCreateRequestDataExternalPropertiesInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FolderCreateRequestDataExternalPropertiesInner.parse_obj(obj)

        _obj = FolderCreateRequestDataExternalPropertiesInner.parse_obj({
            "name": obj.get("name"),
            "value": obj.get("value")
        })
        return _obj
