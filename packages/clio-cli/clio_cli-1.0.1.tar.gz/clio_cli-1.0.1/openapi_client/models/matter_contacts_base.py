...
class MatterContactsBase(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MatterContactsBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MatterContactsBase:
        """Create an instance of MatterContactsBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MatterContactsBase.parse_obj(obj)

        _obj = MatterContactsBase.parse_obj({
