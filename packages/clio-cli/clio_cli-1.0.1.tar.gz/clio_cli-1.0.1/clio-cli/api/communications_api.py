...
class CommunicationsApi:
    ...
    @validate_arguments
    def communication_create(self, x_api_version : Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None, fields : Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None, communication_create_request : Annotated[Optional[CommunicationCreateRequest], Field(description="Request Body for Communications")] = None, **kwargs) -> CommunicationShow:  # noqa: E501
        """Create a new Communication  # noqa: E501

        Outlines the parameters and data fields used when creating a new Communication  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.communication_create(x_api_version, fields, communication_create_request, async_req=True)
        >>> result = thread.get()
        ...
        :type fields: str
        :param communication_create_request: Request Body for Communications
        :type communication_create_request: CommunicationCreateRequest
        ...
        :rtype: CommunicationShow
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the communication_create_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.communication_create_with_http_info(x_api_version, fields, communication_create_request, **kwargs)  # noqa: E501

    @validate_arguments
    def communication_create_with_http_info(self, x_api_version : Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None, fields : Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None, communication_create_request : Annotated[Optional[CommunicationCreateRequest], Field(description="Request Body for Communications")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Create a new Communication  # noqa: E501
        ...
        >>> thread = api.communication_create_with_http_info(x_api_version, fields, communication_create_request, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(CommunicationShow, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method communication_create" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _body_params = None
        if _params['communication_create_request'] is not None:
            _body_params = _params['communication_create_request']
    ...
    @validate_arguments
    def communication_destroy(self, id : Annotated[StrictInt, Field(..., description="The unique identifier for the Communication.")], x_api_version : Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None, **kwargs) -> None:  # noqa: E501
        """Delete a single Communication  # noqa: E501

        Outlines the parameters, optional and required, used when deleting the record for a single Communication  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.communication_destroy(id, x_api_version, async_req=True)
        >>> result = thread.get()

        :param id: The unique identifier for the Communication. (required)
        :type id: int
        :param x_api_version: The [API minor version](#section/Minor-Versions). Default: latest version.
        :type x_api_version: str
        :param async_req: Whether to execute the request asynchronously.
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the communication_destroy_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.communication_destroy_with_http_info(id, x_api_version, **kwargs)  # noqa: E501

    @validate_arguments
    def communication_destroy_with_http_info(self, id : Annotated[StrictInt, Field(..., description="The unique identifier for the Communication.")], x_api_version : Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Delete a single Communication  # noqa: E501
        ...
        >>> thread = api.communication_destroy_with_http_info(id, x_api_version, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method communication_destroy" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    @validate_arguments
    def communication_index(self, x_api_version : Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None, contact_id : Annotated[Optional[StrictInt], Field(description="The unique identifier for a single Contact. The keyword `null` is not valid for this field. The list will be filtered to include only the Communication records with the matching property.")] = None, created_since : Annotated[Optional[datetime], Field(description="Filter Communication records to those having the `created_at` field after a specific time. (Expects an ISO-8601 timestamp).")] = None, var_date : Annotated[Optional[date], Field(description="Filter Communication records to those that occur on the specified date (Expects an ISO-8601 date).")] = None, external_property_name : Annotated[Optional[StrictStr], Field(description="Filter records to only those with the given external property(s) name set.  e.g. `?external_property_name=Name` ")] = None, external_property_value : Annotated[Optional[StrictStr], Field(description="Filter records to only those with the given external property(s) value set. Requires external property name as well.  e.g. `?external_property_name=Name&external_property_value=Value` ")] = None, fields : Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None, having_time_entries : Annotated[Optional[StrictBool], Field(description="Filter Communication records to those that do or do not have time entries.")] = None, ids : Annotated[Optional[StrictInt], Field(description="Filter Communication records to those having the specified unique identifiers.")] = None, limit : Annotated[Optional[StrictInt], Field(description="A limit on the number of Communication records to be returned. Limit can range between 1 and 200. Default: `200`.")] = None, matter_id : Annotated[Optional[StrictInt], Field(description="The unique identifier for a single Matter. Use the keyword `null` to match those without a Communication. The list will be filtered to include only the Communication records with the matching property.")] = None, order : Annotated[Optional[StrictStr], Field(description="Orders the Communication records by the given field. Default: `date(asc)`.")] = None, page_token : Annotated[Optional[StrictStr], Field(description="A token specifying which page to return.")] = None, query : Annotated[Optional[StrictStr], Field(description="Wildcard search for `body` or `subject` matching a given string.")] = None, received_at : Annotated[Optional[datetime], Field(description="Filter Communication records to those that occur on the specified date (Expects an ISO-8601 date-time).")] = None, received_before : Annotated[Optional[datetime], Field(description="Filter Communication records to those whose `date` is on or before the date provided (Expects an ISO-8601 date).")] = None, received_since : Annotated[Optional[datetime], Field(description="Filter Communication records to those whose `date` is on or after the date provided (Expects an ISO-8601 date).")] = None, type : Annotated[Optional[StrictStr], Field(description="Filter Communication records to those of the specified type.")] = None, updated_since : Annotated[Optional[datetime], Field(description="Filter Communication records to those having the `updated_at` field after a specific time. (Expects an ISO-8601 timestamp).")] = None, user_id : Annotated[Optional[StrictInt], Field(description="The unique identifier for a single User. The keyword `null` is not valid for this field. The list will be filtered to include only the Communication records with the matching property.")] = None, **kwargs) -> CommunicationList:  # noqa: E501
        """Return the data for all Communications  # noqa: E501

        Outlines the parameters, optional and required, used when requesting the data for all Communications  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.communication_index(x_api_version, contact_id, created_since, var_date, external_property_name, external_property_value, fields, having_time_entries, ids, limit, matter_id, order, page_token, query, received_at, received_before, received_since, type, updated_since, user_id, async_req=True)
        >>> result = thread.get()
        ...
        :param var_date: Filter Communication records to those that occur on the specified date (Expects an ISO-8601 date).
        :type var_date: date
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: CommunicationList
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the communication_index_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.communication_index_with_http_info(x_api_version, contact_id, created_since, var_date, external_property_name, external_property_value, fields, having_time_entries, ids, limit, matter_id, order, page_token, query, received_at, received_before, received_since, type, updated_since, user_id, **kwargs)  # noqa: E501

    @validate_arguments
    def communication_index_with_http_info(self, x_api_version : Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None, contact_id : Annotated[Optional[StrictInt], Field(description="The unique identifier for a single Contact. The keyword `null` is not valid for this field. The list will be filtered to include only the Communication records with the matching property.")] = None, created_since : Annotated[Optional[datetime], Field(description="Filter Communication records to those having the `created_at` field after a specific time. (Expects an ISO-8601 timestamp).")] = None, var_date : Annotated[Optional[date], Field(description="Filter Communication records to those that occur on the specified date (Expects an ISO-8601 date).")] = None, external_property_name : Annotated[Optional[StrictStr], Field(description="Filter records to only those with the given external property(s) name set.  e.g. `?external_property_name=Name` ")] = None, external_property_value : Annotated[Optional[StrictStr], Field(description="Filter records to only those with the given external property(s) value set. Requires external property name as well.  e.g. `?external_property_name=Name&external_property_value=Value` ")] = None, fields : Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None, having_time_entries : Annotated[Optional[StrictBool], Field(description="Filter Communication records to those that do or do not have time entries.")] = None, ids : Annotated[Optional[StrictInt], Field(description="Filter Communication records to those having the specified unique identifiers.")] = None, limit : Annotated[Optional[StrictInt], Field(description="A limit on the number of Communication records to be returned. Limit can range between 1 and 200. Default: `200`.")] = None, matter_id : Annotated[Optional[StrictInt], Field(description="The unique identifier for a single Matter. Use the keyword `null` to match those without a Communication. The list will be filtered to include only the Communication records with the matching property.")] = None, order : Annotated[Optional[StrictStr], Field(description="Orders the Communication records by the given field. Default: `date(asc)`.")] = None, page_token : Annotated[Optional[StrictStr], Field(description="A token specifying which page to return.")] = None, query : Annotated[Optional[StrictStr], Field(description="Wildcard search for `body` or `subject` matching a given string.")] = None, received_at : Annotated[Optional[datetime], Field(description="Filter Communication records to those that occur on the specified date (Expects an ISO-8601 date-time).")] = None, received_before : Annotated[Optional[datetime], Field(description="Filter Communication records to those whose `date` is on or before the date provided (Expects an ISO-8601 date).")] = None, received_since : Annotated[Optional[datetime], Field(description="Filter Communication records to those whose `date` is on or after the date provided (Expects an ISO-8601 date).")] = None, type : Annotated[Optional[StrictStr], Field(description="Filter Communication records to those of the specified type.")] = None, updated_since : Annotated[Optional[datetime], Field(description="Filter Communication records to those having the `updated_at` field after a specific time. (Expects an ISO-8601 timestamp).")] = None, user_id : Annotated[Optional[StrictInt], Field(description="The unique identifier for a single User. The keyword `null` is not valid for this field. The list will be filtered to include only the Communication records with the matching property.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Return the data for all Communications  # noqa: E501
        ...
        >>> thread = api.communication_index_with_http_info(x_api_version, contact_id, created_since, var_date, external_property_name, external_property_value, fields, having_time_entries, ids, limit, matter_id, order, page_token, query, received_at, received_before, received_since, type, updated_since, user_id, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(CommunicationList, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method communication_index" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        if _params.get('having_time_entries') is not None:  # noqa: E501
            _query_params.append(('having_time_entries', _params['having_time_entries']))
        ...
        if _params.get('received_at') is not None:  # noqa: E501
            if isinstance(_params['received_at'], datetime):
                _query_params.append(('received_at', _params['received_at'].strftime(self.api_client.configuration.datetime_format)))
            else:
                _query_params.append(('received_at', _params['received_at']))

        if _params.get('received_before') is not None:  # noqa: E501
            if isinstance(_params['received_before'], datetime):
                _query_params.append(('received_before', _params['received_before'].strftime(self.api_client.configuration.datetime_format)))
            else:
                _query_params.append(('received_before', _params['received_before']))

        if _params.get('received_since') is not None:  # noqa: E501
            if isinstance(_params['received_since'], datetime):
                _query_params.append(('received_since', _params['received_since'].strftime(self.api_client.configuration.datetime_format)))
            else:
                _query_params.append(('received_since', _params['received_since']))
    ...
    def communication_show(self, id : Annotated[StrictInt, Field(..., description="The unique identifier for the Communication.")], if_modified_since : Annotated[Optional[date], Field(description="The server will send the requested resource with a 200 status, but only if it has been modified after the given date. (Expects an RFC 2822 timestamp).")] = None, if_none_match : Annotated[Optional[StrictStr], Field(description="The server will send the requested resource with a 200 status, but only if the existing resource's [ETag](#section/ETags) doesn't match any of the values listed.")] = None, x_api_version : Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None, fields : Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None, **kwargs) -> CommunicationShow:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the communication_show_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.communication_show_with_http_info(id, if_modified_since, if_none_match, x_api_version, fields, **kwargs)  # noqa: E501

    @validate_arguments
    def communication_show_with_http_info(self, id : Annotated[StrictInt, Field(..., description="The unique identifier for the Communication.")], if_modified_since : Annotated[Optional[date], Field(description="The server will send the requested resource with a 200 status, but only if it has been modified after the given date. (Expects an RFC 2822 timestamp).")] = None, if_none_match : Annotated[Optional[StrictStr], Field(description="The server will send the requested resource with a 200 status, but only if the existing resource's [ETag](#section/ETags) doesn't match any of the values listed.")] = None, x_api_version : Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None, fields : Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Return the data for a single Communication  # noqa: E501
        ...
        >>> thread = api.communication_show_with_http_info(id, if_modified_since, if_none_match, x_api_version, fields, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method communication_show" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    @validate_arguments
    def communication_update(self, id : Annotated[StrictInt, Field(..., description="The unique identifier for the Communication.")], if_match : Annotated[Optional[StrictStr], Field(description="The server will update the requested resource and send back a 200 status, but only if value in the header matches the existing resource's [ETag](#section/ETags).")] = None, x_api_version : Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None, fields : Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None, communication_update_request : Annotated[Optional[CommunicationUpdateRequest], Field(description="Request Body for Communications")] = None, **kwargs) -> CommunicationShow:  # noqa: E501
        """Update a single Communication  # noqa: E501

        Outlines the parameters and data fields used when updating a single Communication  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.communication_update(id, if_match, x_api_version, fields, communication_update_request, async_req=True)
        >>> result = thread.get()
        ...
        :param fields: The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).
        :type fields: str
        :param communication_update_request: Request Body for Communications
        :type communication_update_request: CommunicationUpdateRequest
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: timeout setting for this request.
               If one number provided, it will be total request
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the communication_update_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.communication_update_with_http_info(id, if_match, x_api_version, fields, communication_update_request, **kwargs)  # noqa: E501

    @validate_arguments
    def communication_update_with_http_info(self, id : Annotated[StrictInt, Field(..., description="The unique identifier for the Communication.")], if_match : Annotated[Optional[StrictStr], Field(description="The server will update the requested resource and send back a 200 status, but only if value in the header matches the existing resource's [ETag](#section/ETags).")] = None, x_api_version : Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None, fields : Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None, communication_update_request : Annotated[Optional[CommunicationUpdateRequest], Field(description="Request Body for Communications")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Update a single Communication  # noqa: E501
        ...
        >>> thread = api.communication_update_with_http_info(id, if_match, x_api_version, fields, communication_update_request, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method communication_update" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        # process the body parameter
        _body_params = None
        if _params['communication_update_request'] is not None:
            _body_params = _params['communication_update_request']
