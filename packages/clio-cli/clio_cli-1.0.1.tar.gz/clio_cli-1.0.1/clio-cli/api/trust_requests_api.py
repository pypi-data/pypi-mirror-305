...
class TrustRequestsApi:
    ...
    @validate_arguments
    def trust_request_create(self, x_api_version : Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None, fields : Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None, trust_request_create_request : Annotated[Optional[TrustRequestCreateRequest], Field(description="Request Body for Trust Requests")] = None, **kwargs) -> TrustRequestShow:  # noqa: E501
        """Create a new TrustRequest  # noqa: E501

        Outlines the parameters and data fields used when creating a new TrustRequest  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.trust_request_create(x_api_version, fields, trust_request_create_request, async_req=True)
        >>> result = thread.get()
        ...
        :type fields: str
        :param trust_request_create_request: Request Body for Trust Requests
        :type trust_request_create_request: TrustRequestCreateRequest
        ...
        :rtype: TrustRequestShow
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the trust_request_create_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.trust_request_create_with_http_info(x_api_version, fields, trust_request_create_request, **kwargs)  # noqa: E501

    @validate_arguments
    def trust_request_create_with_http_info(self, x_api_version : Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None, fields : Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None, trust_request_create_request : Annotated[Optional[TrustRequestCreateRequest], Field(description="Request Body for Trust Requests")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Create a new TrustRequest  # noqa: E501
        ...
        >>> thread = api.trust_request_create_with_http_info(x_api_version, fields, trust_request_create_request, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(TrustRequestShow, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method trust_request_create" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _body_params = None
        if _params['trust_request_create_request'] is not None:
            _body_params = _params['trust_request_create_request']
