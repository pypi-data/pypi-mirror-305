...
class ConversationMessagesApi:
    ...
    @validate_arguments
    def conversation_message_create(self, x_api_version : Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None, fields : Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None, conversation_message_create_request : Annotated[Optional[ConversationMessageCreateRequest], Field(description="Request Body for Conversation Messages")] = None, **kwargs) -> ConversationMessageShow:  # noqa: E501
        """Create a new ConversationMessage  # noqa: E501

        Outlines the parameters and data fields used when creating a new ConversationMessage  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.conversation_message_create(x_api_version, fields, conversation_message_create_request, async_req=True)
        >>> result = thread.get()
        ...
        :type fields: str
        :param conversation_message_create_request: Request Body for Conversation Messages
        :type conversation_message_create_request: ConversationMessageCreateRequest
        ...
        :rtype: ConversationMessageShow
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the conversation_message_create_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.conversation_message_create_with_http_info(x_api_version, fields, conversation_message_create_request, **kwargs)  # noqa: E501

    @validate_arguments
    def conversation_message_create_with_http_info(self, x_api_version : Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None, fields : Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None, conversation_message_create_request : Annotated[Optional[ConversationMessageCreateRequest], Field(description="Request Body for Conversation Messages")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Create a new ConversationMessage  # noqa: E501
        ...
        >>> thread = api.conversation_message_create_with_http_info(x_api_version, fields, conversation_message_create_request, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(ConversationMessageShow, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        _all_params = [
            'x_api_version',
            'fields',
            'conversation_message_create_request'
        ]
        _all_params.extend(
            [
                'async_req',
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method conversation_message_create" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _body_params = None
        if _params['conversation_message_create_request'] is not None:
            _body_params = _params['conversation_message_create_request']
        ...
        return self.api_client.call_api(
            '/conversation_messages.json', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def conversation_message_index(self, conversation_id : Annotated[StrictInt, Field(..., description="The unique identifier for a single Conversation. Use the keyword `null` to match those without a ConversationMessage. The list will be filtered to include only the ConversationMessage records with the matching property.")], x_api_version : Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None, created_since : Annotated[Optional[datetime], Field(description="Filter ConversationMessage records to those having the `created_at` field on the related Conversation after a specific time. (Expects an ISO-8601 timestamp).")] = None, fields : Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None, ids : Annotated[Optional[StrictInt], Field(description="Filter ConversationMessage records to those having the specified unique identifiers.")] = None, limit : Annotated[Optional[StrictInt], Field(description="A limit on the number of ConversationMessage records to be returned. Limit can range between 1 and 200. Default: `200`.")] = None, order : Annotated[Optional[StrictStr], Field(description="Orders the ConversationMessage records by the given field. Default: `id(asc)`.")] = None, page_token : Annotated[Optional[StrictStr], Field(description="A token specifying which page to return.")] = None, query : Annotated[Optional[StrictStr], Field(description="Wildcard search for `body` matching a given string.")] = None, updated_since : Annotated[Optional[datetime], Field(description="Filter ConversationMessage records to those having the `updated_at` field on the related Conversation after a specific time. (Expects an ISO-8601 timestamp).")] = None, **kwargs) -> ConversationMessageList:  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: ConversationMessageList
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the conversation_message_index_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.conversation_message_index_with_http_info(conversation_id, x_api_version, created_since, fields, ids, limit, order, page_token, query, updated_since, **kwargs)  # noqa: E501

    @validate_arguments
    def conversation_message_index_with_http_info(self, conversation_id : Annotated[StrictInt, Field(..., description="The unique identifier for a single Conversation. Use the keyword `null` to match those without a ConversationMessage. The list will be filtered to include only the ConversationMessage records with the matching property.")], x_api_version : Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None, created_since : Annotated[Optional[datetime], Field(description="Filter ConversationMessage records to those having the `created_at` field on the related Conversation after a specific time. (Expects an ISO-8601 timestamp).")] = None, fields : Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None, ids : Annotated[Optional[StrictInt], Field(description="Filter ConversationMessage records to those having the specified unique identifiers.")] = None, limit : Annotated[Optional[StrictInt], Field(description="A limit on the number of ConversationMessage records to be returned. Limit can range between 1 and 200. Default: `200`.")] = None, order : Annotated[Optional[StrictStr], Field(description="Orders the ConversationMessage records by the given field. Default: `id(asc)`.")] = None, page_token : Annotated[Optional[StrictStr], Field(description="A token specifying which page to return.")] = None, query : Annotated[Optional[StrictStr], Field(description="Wildcard search for `body` matching a given string.")] = None, updated_since : Annotated[Optional[datetime], Field(description="Filter ConversationMessage records to those having the `updated_at` field on the related Conversation after a specific time. (Expects an ISO-8601 timestamp).")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Return the data for all ConversationMessages  # noqa: E501
        ...
        >>> thread = api.conversation_message_index_with_http_info(conversation_id, x_api_version, created_since, fields, ids, limit, order, page_token, query, updated_since, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(ConversationMessageList, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method conversation_message_index" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        # process the query parameters
        _query_params = []
        if _params.get('conversation_id') is not None:  # noqa: E501
            _query_params.append(('conversation_id', _params['conversation_id']))
        ...
        return self.api_client.call_api(
            '/conversation_messages.json', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def conversation_message_show(self, id : Annotated[StrictInt, Field(..., description="The unique identifier for the ConversationMessage.")], if_modified_since : Annotated[Optional[date], Field(description="The server will send the requested resource with a 200 status, but only if it has been modified after the given date. (Expects an RFC 2822 timestamp).")] = None, if_none_match : Annotated[Optional[StrictStr], Field(description="The server will send the requested resource with a 200 status, but only if the existing resource's [ETag](#section/ETags) doesn't match any of the values listed.")] = None, x_api_version : Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None, fields : Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None, **kwargs) -> ConversationMessageShow:  # noqa: E501
        """Return the data for a single ConversationMessage  # noqa: E501

        Outlines the parameters, optional and required, used when requesting the data for a single ConversationMessage  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.conversation_message_show(id, if_modified_since, if_none_match, x_api_version, fields, async_req=True)
        >>> result = thread.get()

        :param id: The unique identifier for the ConversationMessage. (required)
        :type id: int
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the conversation_message_show_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.conversation_message_show_with_http_info(id, if_modified_since, if_none_match, x_api_version, fields, **kwargs)  # noqa: E501

    @validate_arguments
    def conversation_message_show_with_http_info(self, id : Annotated[StrictInt, Field(..., description="The unique identifier for the ConversationMessage.")], if_modified_since : Annotated[Optional[date], Field(description="The server will send the requested resource with a 200 status, but only if it has been modified after the given date. (Expects an RFC 2822 timestamp).")] = None, if_none_match : Annotated[Optional[StrictStr], Field(description="The server will send the requested resource with a 200 status, but only if the existing resource's [ETag](#section/ETags) doesn't match any of the values listed.")] = None, x_api_version : Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None, fields : Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Return the data for a single ConversationMessage  # noqa: E501
        ...
        >>> thread = api.conversation_message_show_with_http_info(id, if_modified_since, if_none_match, x_api_version, fields, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method conversation_message_show" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/conversation_messages/{id}.json', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
