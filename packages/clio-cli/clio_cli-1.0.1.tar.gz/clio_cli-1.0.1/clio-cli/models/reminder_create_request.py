...
class ReminderCreateRequest(BaseModel):
    ...
    """
    data: ReminderCreateRequestData = Field(...)
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ReminderCreateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ReminderCreateRequest:
        """Create an instance of ReminderCreateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ReminderCreateRequest.parse_obj(obj)

        _obj = ReminderCreateRequest.parse_obj({
            "data": ReminderCreateRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
