...
class CustomActionCreateRequest(BaseModel):
    """
    CustomActionCreateRequest
    """
    data: CustomActionCreateRequestData = Field(...)
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CustomActionCreateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CustomActionCreateRequest:
        """Create an instance of CustomActionCreateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CustomActionCreateRequest.parse_obj(obj)

        _obj = CustomActionCreateRequest.parse_obj({
            "data": CustomActionCreateRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
