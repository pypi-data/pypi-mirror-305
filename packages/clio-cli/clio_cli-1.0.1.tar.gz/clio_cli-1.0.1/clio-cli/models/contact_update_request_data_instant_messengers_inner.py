...
class ContactUpdateRequestDataInstantMessengersInner(BaseModel):
    """
    ContactUpdateRequestDataInstantMessengersInner
    """
    name: Optional[StrictStr] = Field(default='Other', description="Name of the InstantMessenger.")
    address: Optional[StrictStr] = Field(default=None, description="Address of the InstantMessenger.")
    id: Optional[StrictInt] = Field(default=None, description="The unique identifier for a single InstantMessenger associated with the Contact. The keyword `null` is not valid for this field.")
    destroy: Optional[StrictBool] = Field(default=None, alias="_destroy", description="The destroy flag. If the flag is set to `true` and the unique identifier of the associated InstantMessenger is present, the InstantMessenger is deleted from the Contact.")
    __properties = ["name", "address", "id", "_destroy"]
    ...
    def name_validate_enum(cls, value):
        ...
        if value not in ('Work', 'Personal', 'Other'):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ContactUpdateRequestDataInstantMessengersInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ContactUpdateRequestDataInstantMessengersInner:
        """Create an instance of ContactUpdateRequestDataInstantMessengersInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ContactUpdateRequestDataInstantMessengersInner.parse_obj(obj)

        _obj = ContactUpdateRequestDataInstantMessengersInner.parse_obj({
