...
class MedicalBillUpdateRequestData(BaseModel):
    ...
    payers: Optional[conlist(MedicalBillUpdateRequestDataPayersInner)] = None
    __properties = ["adjustment", "amount", "balance", "bill_date", "bill_received_date", "mark_balance_as_lien", "name", "payers"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MedicalBillUpdateRequestData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MedicalBillUpdateRequestData:
        """Create an instance of MedicalBillUpdateRequestData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MedicalBillUpdateRequestData.parse_obj(obj)

        _obj = MedicalBillUpdateRequestData.parse_obj({
            ...
            "name": obj.get("name"),
            "payers": [MedicalBillUpdateRequestDataPayersInner.from_dict(_item) for _item in obj.get("payers")] if obj.get("payers") is not None else None
        })
        return _obj
