...
class CustomFieldSetCreateRequest(BaseModel):
    """
    CustomFieldSetCreateRequest
    """
    data: CustomFieldSetCreateRequestData = Field(...)
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CustomFieldSetCreateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CustomFieldSetCreateRequest:
        """Create an instance of CustomFieldSetCreateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CustomFieldSetCreateRequest.parse_obj(obj)

        _obj = CustomFieldSetCreateRequest.parse_obj({
            "data": CustomFieldSetCreateRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
