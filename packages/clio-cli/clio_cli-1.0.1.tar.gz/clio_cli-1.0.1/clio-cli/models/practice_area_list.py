...
class PracticeAreaList(BaseModel):
    ...
    PracticeAreaList
    """
    data: conlist(PracticeArea) = Field(default=..., description="PracticeArea List Response")
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PracticeAreaList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PracticeAreaList:
        """Create an instance of PracticeAreaList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PracticeAreaList.parse_obj(obj)

        _obj = PracticeAreaList.parse_obj({
            "data": [PracticeArea.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
