...
class FolderUpdateRequest(BaseModel):
    ...
    FolderUpdateRequest
    """
    data: FolderUpdateRequestData = Field(...)
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FolderUpdateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FolderUpdateRequest:
        """Create an instance of FolderUpdateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FolderUpdateRequest.parse_obj(obj)

        _obj = FolderUpdateRequest.parse_obj({
            "data": FolderUpdateRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
