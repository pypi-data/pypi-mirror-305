...
class CustomActionUpdateRequest(BaseModel):
    """
    CustomActionUpdateRequest
    """
    data: CustomActionUpdateRequestData = Field(...)
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CustomActionUpdateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CustomActionUpdateRequest:
        """Create an instance of CustomActionUpdateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CustomActionUpdateRequest.parse_obj(obj)

        _obj = CustomActionUpdateRequest.parse_obj({
            "data": CustomActionUpdateRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
