...
class ContactUpdateRequestDataCustomFieldSetAssociationsInner(BaseModel):
    ...
    destroy: Optional[StrictBool] = Field(default=None, alias="_destroy", description="The destroy flag. If the flag is set to `true` and the unique identifier of the associated CustomFieldSetAssociation is present, the CustomFieldSetAssociation is deleted from the Contact.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ContactUpdateRequestDataCustomFieldSetAssociationsInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ContactUpdateRequestDataCustomFieldSetAssociationsInner:
        """Create an instance of ContactUpdateRequestDataCustomFieldSetAssociationsInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ContactUpdateRequestDataCustomFieldSetAssociationsInner.parse_obj(obj)

        _obj = ContactUpdateRequestDataCustomFieldSetAssociationsInner.parse_obj({
            "id": obj.get("id"),
