...
class LineItemShow(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LineItemShow:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LineItemShow:
        """Create an instance of LineItemShow from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LineItemShow.parse_obj(obj)

        _obj = LineItemShow.parse_obj({
            "data": LineItem.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
