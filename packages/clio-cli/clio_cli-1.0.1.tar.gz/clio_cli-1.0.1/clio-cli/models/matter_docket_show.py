...
class MatterDocketShow(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MatterDocketShow:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MatterDocketShow:
        """Create an instance of MatterDocketShow from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MatterDocketShow.parse_obj(obj)

        _obj = MatterDocketShow.parse_obj({
            "data": MatterDocket.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
