...
class ClioPaymentsLinkShow(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ClioPaymentsLinkShow:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ClioPaymentsLinkShow:
        """Create an instance of ClioPaymentsLinkShow from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ClioPaymentsLinkShow.parse_obj(obj)

        _obj = ClioPaymentsLinkShow.parse_obj({
            "data": ClioPaymentsLink.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
