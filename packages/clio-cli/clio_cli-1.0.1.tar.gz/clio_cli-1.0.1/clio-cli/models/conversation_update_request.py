...
class ConversationUpdateRequest(BaseModel):
    ...
    """
    data: ConversationUpdateRequestData = Field(...)
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ConversationUpdateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ConversationUpdateRequest:
        """Create an instance of ConversationUpdateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ConversationUpdateRequest.parse_obj(obj)

        _obj = ConversationUpdateRequest.parse_obj({
            "data": ConversationUpdateRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
