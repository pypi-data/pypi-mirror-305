...
class RelationshipShow(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RelationshipShow:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RelationshipShow:
        """Create an instance of RelationshipShow from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RelationshipShow.parse_obj(obj)

        _obj = RelationshipShow.parse_obj({
            "data": Relationship.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
