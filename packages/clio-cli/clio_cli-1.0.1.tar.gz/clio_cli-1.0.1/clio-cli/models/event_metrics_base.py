...
class EventMetricsBase(BaseModel):
    ...
    EventMetricsBase
    """
    unread_mobile_events: Optional[StrictInt] = Field(default=None, description="The number of unread mobile event notifications for the current user")
    unread_web_events: Optional[StrictInt] = Field(default=None, description="The number of unread web event notifications for the current user")
    unread_secure_messages: Optional[StrictInt] = Field(default=None, description="The number of unread secure messages for the current user")
    unread_client_portal_messages: Optional[StrictInt] = Field(default=None, description="The number of unread client portal messages for the current user")
    unread_text_messages: Optional[StrictInt] = Field(default=None, description="The number of unread text messages for the current user")
    __properties = ["unread_mobile_events", "unread_web_events", "unread_secure_messages", "unread_client_portal_messages", "unread_text_messages"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EventMetricsBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EventMetricsBase:
        """Create an instance of EventMetricsBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EventMetricsBase.parse_obj(obj)

        _obj = EventMetricsBase.parse_obj({
            "unread_mobile_events": obj.get("unread_mobile_events"),
            "unread_web_events": obj.get("unread_web_events"),
            "unread_secure_messages": obj.get("unread_secure_messages"),
            "unread_client_portal_messages": obj.get("unread_client_portal_messages"),
            "unread_text_messages": obj.get("unread_text_messages")
        })
        return _obj
