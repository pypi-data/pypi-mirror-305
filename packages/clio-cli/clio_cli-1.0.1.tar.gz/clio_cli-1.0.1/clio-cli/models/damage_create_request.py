...
class DamageCreateRequest(BaseModel):
    ...
    DamageCreateRequest
    """
    data: DamageCreateRequestData = Field(...)
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DamageCreateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DamageCreateRequest:
        """Create an instance of DamageCreateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DamageCreateRequest.parse_obj(obj)

        _obj = DamageCreateRequest.parse_obj({
            "data": DamageCreateRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
