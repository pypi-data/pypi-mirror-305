...
class ConversationShow(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ConversationShow:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ConversationShow:
        """Create an instance of ConversationShow from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ConversationShow.parse_obj(obj)

        _obj = ConversationShow.parse_obj({
            "data": Conversation.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
