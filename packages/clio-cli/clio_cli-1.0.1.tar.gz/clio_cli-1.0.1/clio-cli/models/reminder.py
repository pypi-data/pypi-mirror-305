...
class Reminder(BaseModel):
    ...
    __properties = ["id", "etag", "duration", "next_delivery_at", "state", "created_at", "updated_at", "notification_method", "subject"]
    ...
    def state_validate_enum(cls, value):
        ...
        if value not in ('initializing', 'scheduling', 'rescheduling', 'scheduled', 'attempting_delivery', 'delivery_failed', 'delivered', 'delivery_skipped', 'invalid_user'):
            raise ValueError("must be one of enum values ('initializing', 'scheduling', 'rescheduling', 'scheduled', 'attempting_delivery', 'delivery_failed', 'delivered', 'delivery_skipped', 'invalid_user')")
        return value
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Reminder:
        """Create an instance of Reminder from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return Reminder.parse_obj(obj)

        _obj = Reminder.parse_obj({
            "id": obj.get("id"),
            "etag": obj.get("etag"),
            "duration": obj.get("duration"),
            "next_delivery_at": obj.get("next_delivery_at"),
            "state": obj.get("state"),
            "created_at": obj.get("created_at"),
            "updated_at": obj.get("updated_at"),
            "notification_method": NotificationMethodBase.from_dict(obj.get("notification_method")) if obj.get("notification_method") is not None else None,
