...
class ExpenseCategoryUpdateRequestData(BaseModel):
    ...
    groups: Optional[conlist(ExpenseCategoryCreateRequestDataGroupsInner)] = None
    name: Optional[StrictStr] = Field(default=None, description="Name of the Expense Category.")
    ...
    __properties = ["entry_type", "groups", "name", "rate", "utbms_code"]
    ...
    def entry_type_validate_enum(cls, value):
        ...
        if value not in ('hard_cost', 'soft_cost', 'unassociated'):
            raise ValueError("must be one of enum values ('hard_cost', 'soft_cost', 'unassociated')")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ExpenseCategoryUpdateRequestData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ExpenseCategoryUpdateRequestData:
        """Create an instance of ExpenseCategoryUpdateRequestData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ExpenseCategoryUpdateRequestData.parse_obj(obj)

        _obj = ExpenseCategoryUpdateRequestData.parse_obj({
            "entry_type": obj.get("entry_type"),
            "groups": [ExpenseCategoryCreateRequestDataGroupsInner.from_dict(_item) for _item in obj.get("groups")] if obj.get("groups") is not None else None,
            "name": obj.get("name"),
            "rate": obj.get("rate"),
            "utbms_code": ExpenseCategoryCreateRequestDataUtbmsCode.from_dict(obj.get("utbms_code")) if obj.get("utbms_code") is not None else None
        })
        return _obj
