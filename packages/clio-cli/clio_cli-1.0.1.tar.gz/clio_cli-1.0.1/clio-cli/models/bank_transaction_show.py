...
class BankTransactionShow(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BankTransactionShow:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BankTransactionShow:
        """Create an instance of BankTransactionShow from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BankTransactionShow.parse_obj(obj)

        _obj = BankTransactionShow.parse_obj({
            "data": BankTransaction.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
