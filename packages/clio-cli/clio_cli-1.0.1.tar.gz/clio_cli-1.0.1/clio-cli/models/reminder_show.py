...
class ReminderShow(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ReminderShow:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ReminderShow:
        """Create an instance of ReminderShow from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ReminderShow.parse_obj(obj)

        _obj = ReminderShow.parse_obj({
            "data": Reminder.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
