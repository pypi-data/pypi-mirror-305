...
class DocumentAutomationCreateRequest(BaseModel):
    """
    DocumentAutomationCreateRequest
    """
    data: DocumentAutomationCreateRequestData = Field(...)
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DocumentAutomationCreateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DocumentAutomationCreateRequest:
        """Create an instance of DocumentAutomationCreateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DocumentAutomationCreateRequest.parse_obj(obj)

        _obj = DocumentAutomationCreateRequest.parse_obj({
            "data": DocumentAutomationCreateRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
