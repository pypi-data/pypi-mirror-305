...
class ReminderUpdateRequest(BaseModel):
    ...
    """
    data: ReminderUpdateRequestData = Field(...)
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ReminderUpdateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ReminderUpdateRequest:
        """Create an instance of ReminderUpdateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ReminderUpdateRequest.parse_obj(obj)

        _obj = ReminderUpdateRequest.parse_obj({
            "data": ReminderUpdateRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
