...
class ActivityDescriptionCreateRequest(BaseModel):
    """
    ActivityDescriptionCreateRequest
    """
    data: ActivityDescriptionCreateRequestData = Field(...)
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ActivityDescriptionCreateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ActivityDescriptionCreateRequest:
        """Create an instance of ActivityDescriptionCreateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ActivityDescriptionCreateRequest.parse_obj(obj)

        _obj = ActivityDescriptionCreateRequest.parse_obj({
            "data": ActivityDescriptionCreateRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
