...
class BankTransactionList(BaseModel):
    ...
    BankTransactionList
    """
    data: conlist(BankTransaction) = Field(default=..., description="BankTransaction List Response")
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BankTransactionList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BankTransactionList:
        """Create an instance of BankTransactionList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BankTransactionList.parse_obj(obj)

        _obj = BankTransactionList.parse_obj({
            "data": [BankTransaction.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
