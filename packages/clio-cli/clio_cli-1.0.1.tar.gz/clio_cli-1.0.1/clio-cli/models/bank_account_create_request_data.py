...
class BankAccountCreateRequestData(BaseModel):
    """
    ...
    currency: StrictStr = Field(default=..., description="Currency the BankAccount is in.")
    ...
    type: StrictStr = Field(default=..., description="Type of BankAccount.")
    __properties = ["account_number", "balance", "controlled_account", "currency", "default_account", "domicile_branch", "general_ledger_number", "holder", "institution", "name", "swift", "transit_number", "type"]

    @validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('Operating', 'Trust'):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BankAccountCreateRequestData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BankAccountCreateRequestData:
        """Create an instance of BankAccountCreateRequestData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BankAccountCreateRequestData.parse_obj(obj)

        _obj = BankAccountCreateRequestData.parse_obj({
