...
class DocumentCategoryBase(BaseModel):
    ...
    """
    id: Optional[StrictInt] = Field(default=None, description="Unique identifier for the *DocumentCategory*")
    etag: Optional[StrictStr] = Field(default=None, description="ETag for the *DocumentCategory*")
    name: Optional[StrictStr] = Field(default=None, description="The name of the *DocumentCategory*")
    created_at: Optional[datetime] = Field(default=None, description="The time the *DocumentCategory* was created (as a ISO-8601 timestamp)")
    updated_at: Optional[datetime] = Field(default=None, description="The time the *DocumentCategory* was last updated (as a ISO-8601 timestamp)")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DocumentCategoryBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DocumentCategoryBase:
        """Create an instance of DocumentCategoryBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DocumentCategoryBase.parse_obj(obj)

        _obj = DocumentCategoryBase.parse_obj({
            "id": obj.get("id"),
            "etag": obj.get("etag"),
            "name": obj.get("name"),
