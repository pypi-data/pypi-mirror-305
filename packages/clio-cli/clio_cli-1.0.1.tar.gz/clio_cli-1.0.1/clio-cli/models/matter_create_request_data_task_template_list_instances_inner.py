...
class MatterCreateRequestDataTaskTemplateListInstancesInner(BaseModel):
    ...
    """
    task_template_list: MatterCreateRequestDataTaskTemplateListInstancesInnerTaskTemplateList = Field(...)
    ...
    __properties = ["task_template_list", "assignee_id", "notify_assignees", "due_at"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MatterCreateRequestDataTaskTemplateListInstancesInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MatterCreateRequestDataTaskTemplateListInstancesInner:
        """Create an instance of MatterCreateRequestDataTaskTemplateListInstancesInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MatterCreateRequestDataTaskTemplateListInstancesInner.parse_obj(obj)

        _obj = MatterCreateRequestDataTaskTemplateListInstancesInner.parse_obj({
            "task_template_list": MatterCreateRequestDataTaskTemplateListInstancesInnerTaskTemplateList.from_dict(obj.get("task_template_list")) if obj.get("task_template_list") is not None else None,
