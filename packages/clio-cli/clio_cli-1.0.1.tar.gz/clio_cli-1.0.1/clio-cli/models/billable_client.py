...
class BillableClient(BaseModel):
    ...
    BillableClient
    """
    id: Optional[StrictInt] = Field(default=None, description="Unique identifier for the *BillableClient*")
    unbilled_hours: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The unbilled hours of  the client")
    unbilled_amount: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The unbilled amount of the client")
    amount_in_trust: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The trust amount available for the client")
    name: Optional[StrictStr] = Field(default=None, description="The name of the Client")
    billable_matters_count: Optional[StrictInt] = Field(default=None, description="The total number of billable matters the client has")
    billable_matters: Optional[conlist(BillableMatterBase)] = Field(default=None, description="BillableMatter")
    __properties = ["id", "unbilled_hours", "unbilled_amount", "amount_in_trust", "name", "billable_matters_count", "billable_matters"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BillableClient:
    ...
    def to_dict(self):
        ...
        _dict = self.dict(by_alias=True,
                          ...
                          exclude_none=True)
        # override the default output from pydantic by calling `to_dict()` of each item in billable_matters (list)
        _items = []
        if self.billable_matters:
            for _item in self.billable_matters:
                if _item:
                    _items.append(_item.to_dict())
            _dict['billable_matters'] = _items
        return _dict

    @classmethod
    def from_dict(cls, obj: dict) -> BillableClient:
        """Create an instance of BillableClient from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BillableClient.parse_obj(obj)

        _obj = BillableClient.parse_obj({
            "id": obj.get("id"),
            "unbilled_hours": obj.get("unbilled_hours"),
            "unbilled_amount": obj.get("unbilled_amount"),
            "amount_in_trust": obj.get("amount_in_trust"),
            "name": obj.get("name"),
            "billable_matters_count": obj.get("billable_matters_count"),
            "billable_matters": [BillableMatterBase.from_dict(_item) for _item in obj.get("billable_matters")] if obj.get("billable_matters") is not None else None
        })
        return _obj
