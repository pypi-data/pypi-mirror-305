...
class LaukCriminalControlledRateList(BaseModel):
    ...
    """
    data: conlist(LaukCriminalControlledRate) = Field(default=..., description="LaukCriminalControlledRate List Response")
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LaukCriminalControlledRateList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LaukCriminalControlledRateList:
        """Create an instance of LaukCriminalControlledRateList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LaukCriminalControlledRateList.parse_obj(obj)

        _obj = LaukCriminalControlledRateList.parse_obj({
            "data": [LaukCriminalControlledRate.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
