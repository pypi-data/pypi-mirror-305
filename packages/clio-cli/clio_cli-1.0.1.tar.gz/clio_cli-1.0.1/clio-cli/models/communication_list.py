...
class CommunicationList(BaseModel):
    ...
    CommunicationList
    """
    data: conlist(Communication) = Field(default=..., description="Communication List Response")
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CommunicationList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CommunicationList:
        """Create an instance of CommunicationList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CommunicationList.parse_obj(obj)

        _obj = CommunicationList.parse_obj({
            "data": [Communication.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
