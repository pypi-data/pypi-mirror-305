...
class Payment(BaseModel):
    ...
    Payment
    """
    id: Optional[StrictInt] = Field(default=None, description="Unique identifier for the *Payment*")
    etag: Optional[StrictStr] = Field(default=None, description="ETag for the *Payment*")
    description: Optional[StrictStr] = Field(default=None, description="A detailed description of the *Payment*")
    reference: Optional[StrictStr] = Field(default=None, description="A reference for the payment")
    amount: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Total amount paid. The default is 0.00.")
    var_date: Optional[date] = Field(default=None, alias="date", description="The date the *Payment* was recorded (as a ISO-8601 date)")
    source_fund_type: Optional[StrictStr] = Field(default=None, description="The fund type for *Payment* source")
    voided_at: Optional[datetime] = Field(default=None, description="Time the *Payment* was voided (as a ISO-8601 timestamp)")
    created_at: Optional[datetime] = Field(default=None, description="The time the *Payment* was created (as a ISO-8601 timestamp)")
    updated_at: Optional[datetime] = Field(default=None, description="The time the *Payment* was last updated (as a ISO-8601 timestamp)")
    ...
    __properties = ["id", "etag", "description", "reference", "amount", "date", "source_fund_type", "voided_at", "created_at", "updated_at", "contact", "user", "source_bank_account", "destination_bank_account", "allocations"]

    @validator('source_fund_type')
    def source_fund_type_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value

        if value not in ('Client', 'Matter'):
            raise ValueError("must be one of enum values ('Client', 'Matter')")
        return value
    ...
    def from_dict(cls, obj: dict) -> Payment:
        ...
        _obj = Payment.parse_obj({
            ...
            "source_fund_type": obj.get("source_fund_type"),
