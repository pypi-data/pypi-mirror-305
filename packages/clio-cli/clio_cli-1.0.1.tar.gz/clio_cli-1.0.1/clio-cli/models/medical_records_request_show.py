...
class MedicalRecordsRequestShow(BaseModel):
    ...
    """
    data: MedicalRecordsRequest = Field(...)
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MedicalRecordsRequestShow:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MedicalRecordsRequestShow:
        """Create an instance of MedicalRecordsRequestShow from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MedicalRecordsRequestShow.parse_obj(obj)

        _obj = MedicalRecordsRequestShow.parse_obj({
            "data": MedicalRecordsRequest.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
