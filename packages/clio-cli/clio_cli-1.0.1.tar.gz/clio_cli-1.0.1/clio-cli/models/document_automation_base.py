...
class DocumentAutomationBase(BaseModel):
    ...
    __properties = ["id", "etag", "state", "export_formats", "filename", "created_at", "updated_at"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DocumentAutomationBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DocumentAutomationBase:
        """Create an instance of DocumentAutomationBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DocumentAutomationBase.parse_obj(obj)

        _obj = DocumentAutomationBase.parse_obj({
            "id": obj.get("id"),
            "etag": obj.get("etag"),
            "state": obj.get("state"),
