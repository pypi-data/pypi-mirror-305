...
class DocumentTemplateCreateRequest(BaseModel):
    ...
    """
    data: DocumentTemplateCreateRequestData = Field(...)
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DocumentTemplateCreateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DocumentTemplateCreateRequest:
        """Create an instance of DocumentTemplateCreateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DocumentTemplateCreateRequest.parse_obj(obj)

        _obj = DocumentTemplateCreateRequest.parse_obj({
            "data": DocumentTemplateCreateRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
