...
class CalendarShow(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CalendarShow:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CalendarShow:
        """Create an instance of CalendarShow from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CalendarShow.parse_obj(obj)

        _obj = CalendarShow.parse_obj({
            "data": Calendar.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
