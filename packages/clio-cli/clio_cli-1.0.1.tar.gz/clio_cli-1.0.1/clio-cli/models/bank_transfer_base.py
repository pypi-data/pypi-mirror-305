...
class BankTransferBase(BaseModel):
    ...
    __properties = ["id", "etag", "amount", "date", "description", "primary_authorizer", "secondary_authorizer", "created_at", "updated_at"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BankTransferBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BankTransferBase:
        """Create an instance of BankTransferBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BankTransferBase.parse_obj(obj)

        _obj = BankTransferBase.parse_obj({
            "id": obj.get("id"),
            "etag": obj.get("etag"),
