...
class TrustLineItemShow(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TrustLineItemShow:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TrustLineItemShow:
        """Create an instance of TrustLineItemShow from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TrustLineItemShow.parse_obj(obj)

        _obj = TrustLineItemShow.parse_obj({
            "data": TrustLineItem.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
