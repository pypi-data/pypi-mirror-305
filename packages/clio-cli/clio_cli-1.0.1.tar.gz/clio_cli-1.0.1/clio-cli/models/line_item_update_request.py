...
class LineItemUpdateRequest(BaseModel):
    ...
    """
    data: LineItemUpdateRequestData = Field(...)
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LineItemUpdateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LineItemUpdateRequest:
        """Create an instance of LineItemUpdateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LineItemUpdateRequest.parse_obj(obj)

        _obj = LineItemUpdateRequest.parse_obj({
            "data": LineItemUpdateRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
