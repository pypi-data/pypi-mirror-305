...
class JurisdictionsToTriggerShow(BaseModel):
    ...
    """
    data: JurisdictionsToTrigger = Field(...)
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> JurisdictionsToTriggerShow:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> JurisdictionsToTriggerShow:
        """Create an instance of JurisdictionsToTriggerShow from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return JurisdictionsToTriggerShow.parse_obj(obj)

        _obj = JurisdictionsToTriggerShow.parse_obj({
            "data": JurisdictionsToTrigger.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
