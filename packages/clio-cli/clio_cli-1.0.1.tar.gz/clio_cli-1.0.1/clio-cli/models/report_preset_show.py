...
class ReportPresetShow(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ReportPresetShow:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ReportPresetShow:
        """Create an instance of ReportPresetShow from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ReportPresetShow.parse_obj(obj)

        _obj = ReportPresetShow.parse_obj({
            "data": ReportPreset.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
