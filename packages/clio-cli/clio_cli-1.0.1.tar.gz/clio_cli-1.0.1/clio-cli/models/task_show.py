...
class TaskShow(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TaskShow:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TaskShow:
        """Create an instance of TaskShow from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TaskShow.parse_obj(obj)

        _obj = TaskShow.parse_obj({
            "data": Task.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
