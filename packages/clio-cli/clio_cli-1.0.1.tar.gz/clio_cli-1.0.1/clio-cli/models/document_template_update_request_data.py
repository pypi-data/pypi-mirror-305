...
class DocumentTemplateUpdateRequestData(BaseModel):
    """
    DocumentTemplateUpdateRequestData
    """
    document_category: Optional[DocumentTemplateCreateRequestDataDocumentCategory] = None
    file: Optional[StrictStr] = Field(default=None, description="A file that contains the DocumentTemplate. The file can be uploaded through a form as application/x-www-form-urlencoded or multipart/form-data request. Alternatively, the file can be converted to a BASE64-encoded string and serialized to JSON. ")
    ...
    __properties = ["document_category", "file", "filename"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DocumentTemplateUpdateRequestData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DocumentTemplateUpdateRequestData:
        """Create an instance of DocumentTemplateUpdateRequestData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DocumentTemplateUpdateRequestData.parse_obj(obj)

        _obj = DocumentTemplateUpdateRequestData.parse_obj({
            "document_category": DocumentTemplateCreateRequestDataDocumentCategory.from_dict(obj.get("document_category")) if obj.get("document_category") is not None else None,
            "file": obj.get("file"),
