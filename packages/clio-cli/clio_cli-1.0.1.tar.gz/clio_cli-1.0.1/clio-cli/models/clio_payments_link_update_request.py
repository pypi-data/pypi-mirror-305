...
class ClioPaymentsLinkUpdateRequest(BaseModel):
    """
    ClioPaymentsLinkUpdateRequest
    """
    data: ClioPaymentsLinkUpdateRequestData = Field(...)
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ClioPaymentsLinkUpdateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ClioPaymentsLinkUpdateRequest:
        """Create an instance of ClioPaymentsLinkUpdateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ClioPaymentsLinkUpdateRequest.parse_obj(obj)

        _obj = ClioPaymentsLinkUpdateRequest.parse_obj({
            "data": ClioPaymentsLinkUpdateRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
