...
class TimerCreateRequest(BaseModel):
    ...
    TimerCreateRequest
    """
    data: TimerCreateRequestData = Field(...)
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TimerCreateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TimerCreateRequest:
        """Create an instance of TimerCreateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TimerCreateRequest.parse_obj(obj)

        _obj = TimerCreateRequest.parse_obj({
            "data": TimerCreateRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
