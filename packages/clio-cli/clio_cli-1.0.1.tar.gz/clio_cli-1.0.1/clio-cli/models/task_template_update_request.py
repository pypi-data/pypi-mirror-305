...
class TaskTemplateUpdateRequest(BaseModel):
    ...
    """
    data: TaskTemplateUpdateRequestData = Field(...)
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TaskTemplateUpdateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TaskTemplateUpdateRequest:
        """Create an instance of TaskTemplateUpdateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TaskTemplateUpdateRequest.parse_obj(obj)

        _obj = TaskTemplateUpdateRequest.parse_obj({
            "data": TaskTemplateUpdateRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
