...
class CalendarList(BaseModel):
    ...
    CalendarList
    """
    data: conlist(Calendar) = Field(default=..., description="Calendar List Response")
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CalendarList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CalendarList:
        """Create an instance of CalendarList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CalendarList.parse_obj(obj)

        _obj = CalendarList.parse_obj({
            "data": [Calendar.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
