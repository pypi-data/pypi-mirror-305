...
class GrantFundingSourceBase(BaseModel):
    ...
    __properties = ["id", "etag", "name", "created_at", "updated_at"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GrantFundingSourceBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GrantFundingSourceBase:
        """Create an instance of GrantFundingSourceBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GrantFundingSourceBase.parse_obj(obj)

        _obj = GrantFundingSourceBase.parse_obj({
            "id": obj.get("id"),
            "etag": obj.get("etag"),
            "name": obj.get("name"),
