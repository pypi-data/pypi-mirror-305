...
class DamageUpdateRequestData(BaseModel):
    """
    ...
    __properties = ["amount", "damage_type", "description"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DamageUpdateRequestData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DamageUpdateRequestData:
        """Create an instance of DamageUpdateRequestData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DamageUpdateRequestData.parse_obj(obj)

        _obj = DamageUpdateRequestData.parse_obj({
