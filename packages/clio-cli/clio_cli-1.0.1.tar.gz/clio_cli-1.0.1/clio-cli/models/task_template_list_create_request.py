...
class TaskTemplateListCreateRequest(BaseModel):
    """
    TaskTemplateListCreateRequest
    """
    data: TaskTemplateListCreateRequestData = Field(...)
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TaskTemplateListCreateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TaskTemplateListCreateRequest:
        """Create an instance of TaskTemplateListCreateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TaskTemplateListCreateRequest.parse_obj(obj)

        _obj = TaskTemplateListCreateRequest.parse_obj({
            "data": TaskTemplateListCreateRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
