...
class MatterUpdateRequestDataEvergreenRetainer(BaseModel):
    ...
    destroy: Optional[StrictBool] = Field(default=None, alias="_destroy", description="If this flag is set to `true`, the trust balance notification will be deleted from the Matter.")
    recipients: Optional[conlist(MatterCreateRequestDataEvergreenRetainerRecipientsInner)] = None
    __properties = ["minimum_threshold", "_destroy", "recipients"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MatterUpdateRequestDataEvergreenRetainer:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MatterUpdateRequestDataEvergreenRetainer:
        """Create an instance of MatterUpdateRequestDataEvergreenRetainer from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MatterUpdateRequestDataEvergreenRetainer.parse_obj(obj)

        _obj = MatterUpdateRequestDataEvergreenRetainer.parse_obj({
            "minimum_threshold": obj.get("minimum_threshold"),
            "destroy": obj.get("_destroy"),
            "recipients": [MatterCreateRequestDataEvergreenRetainerRecipientsInner.from_dict(_item) for _item in obj.get("recipients")] if obj.get("recipients") is not None else None
        })
        return _obj
