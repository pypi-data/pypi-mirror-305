...
class Group(BaseModel):
    ...
    Group
    """
    client_connect_user: Optional[StrictBool] = Field(default=None, description="Whether or not the Group is a UserGroup for a Clio Connect User")
    etag: Optional[StrictStr] = Field(default=None, description="ETag for the *Group*")
    id: Optional[StrictInt] = Field(default=None, description="Unique identifier for the *Group*")
    ...
    updated_at: Optional[datetime] = Field(default=None, description="The time the *Group* was last updated (as a ISO-8601 timestamp)")
    users: Optional[conlist(UserBase)] = Field(default=None, description="User")
    __properties = ["client_connect_user", "etag", "id", "name", "type", "updated_at", "users"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in ('UserGroup', 'AdhocGroup', 'AccountGroup', 'TeamGroup'):
            raise ValueError("must be one of enum values ('UserGroup', 'AdhocGroup', 'AccountGroup', 'TeamGroup')")
        return value
    ...
    def from_dict(cls, obj: dict) -> Group:
        ...
        _obj = Group.parse_obj({
            "client_connect_user": obj.get("client_connect_user"),
            "etag": obj.get("etag"),
            "id": obj.get("id"),
            "name": obj.get("name"),
            "type": obj.get("type"),
            "updated_at": obj.get("updated_at"),
            "users": [UserBase.from_dict(_item) for _item in obj.get("users")] if obj.get("users") is not None else None
        })
        return _obj
