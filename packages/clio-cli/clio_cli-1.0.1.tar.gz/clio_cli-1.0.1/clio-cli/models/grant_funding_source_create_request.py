...
class GrantFundingSourceCreateRequest(BaseModel):
    """
    GrantFundingSourceCreateRequest
    """
    data: GrantFundingSourceCreateRequestData = Field(...)
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GrantFundingSourceCreateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GrantFundingSourceCreateRequest:
        """Create an instance of GrantFundingSourceCreateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GrantFundingSourceCreateRequest.parse_obj(obj)

        _obj = GrantFundingSourceCreateRequest.parse_obj({
            "data": GrantFundingSourceCreateRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
