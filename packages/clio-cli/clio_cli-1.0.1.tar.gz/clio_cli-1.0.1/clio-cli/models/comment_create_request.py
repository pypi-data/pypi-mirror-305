...
class CommentCreateRequest(BaseModel):
    ...
    """
    data: CommentCreateRequestData = Field(...)
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CommentCreateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CommentCreateRequest:
        """Create an instance of CommentCreateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CommentCreateRequest.parse_obj(obj)

        _obj = CommentCreateRequest.parse_obj({
            "data": CommentCreateRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
