...
class ContactList(BaseModel):
    ...
    ContactList
    """
    data: conlist(Contact) = Field(default=..., description="Contact List Response")
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ContactList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ContactList:
        """Create an instance of ContactList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ContactList.parse_obj(obj)

        _obj = ContactList.parse_obj({
            "data": [Contact.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
