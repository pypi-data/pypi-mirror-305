...
class MatterBillRecipient(BaseModel):
    ...
    MatterBillRecipient
    """
    created_at: Optional[datetime] = Field(default=None, description="The time the *MatterBillRecipient* was created (as a ISO-8601 timestamp)")
    etag: Optional[StrictStr] = Field(default=None, description="ETag for the *MatterBillRecipient*")
    id: Optional[StrictInt] = Field(default=None, description="Unique identifier for the *MatterBillRecipient*")
    updated_at: Optional[datetime] = Field(default=None, description="The time the *MatterBillRecipient* was last updated (as a ISO-8601 timestamp)")
    recipient: Optional[ContactBase] = None
    __properties = ["created_at", "etag", "id", "updated_at", "recipient"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MatterBillRecipient:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MatterBillRecipient:
        """Create an instance of MatterBillRecipient from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MatterBillRecipient.parse_obj(obj)

        _obj = MatterBillRecipient.parse_obj({
            "created_at": obj.get("created_at"),
            "etag": obj.get("etag"),
            "id": obj.get("id"),
            "updated_at": obj.get("updated_at"),
            "recipient": ContactBase.from_dict(obj.get("recipient")) if obj.get("recipient") is not None else None
        })
        return _obj
