...
class BankAccountBase(BaseModel):
    ...
    __properties = ["account_number", "balance", "bank_transactions_count", "clio_payment_page_link", "clio_payment_page_qr_code", "clio_payments_enabled", "controlled_account", "created_at", "currency", "default_account", "domicile_branch", "etag", "general_ledger_number", "holder", "id", "institution", "name", "swift", "transit_number", "type", "updated_at"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BankAccountBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BankAccountBase:
        """Create an instance of BankAccountBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BankAccountBase.parse_obj(obj)

        _obj = BankAccountBase.parse_obj({
