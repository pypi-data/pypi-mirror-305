...
class LaukCivilControlledRateList(BaseModel):
    ...
    """
    data: conlist(LaukCivilControlledRate) = Field(default=..., description="LaukCivilControlledRate List Response")
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LaukCivilControlledRateList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LaukCivilControlledRateList:
        """Create an instance of LaukCivilControlledRateList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LaukCivilControlledRateList.parse_obj(obj)

        _obj = LaukCivilControlledRateList.parse_obj({
            "data": [LaukCivilControlledRate.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
