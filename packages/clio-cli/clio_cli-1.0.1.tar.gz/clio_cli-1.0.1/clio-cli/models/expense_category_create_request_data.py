...
class ExpenseCategoryCreateRequestData(BaseModel):
    ...
    name: StrictStr = Field(default=..., description="Name of the Expense Category.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ExpenseCategoryCreateRequestData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ExpenseCategoryCreateRequestData:
        """Create an instance of ExpenseCategoryCreateRequestData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ExpenseCategoryCreateRequestData.parse_obj(obj)

        _obj = ExpenseCategoryCreateRequestData.parse_obj({
