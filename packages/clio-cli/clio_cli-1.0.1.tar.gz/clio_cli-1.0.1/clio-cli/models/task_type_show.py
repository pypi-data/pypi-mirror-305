...
class TaskTypeShow(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TaskTypeShow:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TaskTypeShow:
        """Create an instance of TaskTypeShow from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TaskTypeShow.parse_obj(obj)

        _obj = TaskTypeShow.parse_obj({
            "data": TaskType.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
