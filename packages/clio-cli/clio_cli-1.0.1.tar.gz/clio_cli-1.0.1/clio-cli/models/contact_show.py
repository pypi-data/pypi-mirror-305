...
class ContactShow(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ContactShow:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ContactShow:
        """Create an instance of ContactShow from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ContactShow.parse_obj(obj)

        _obj = ContactShow.parse_obj({
            "data": Contact.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
