...
class FolderList(BaseModel):
    ...
    FolderList
    """
    data: conlist(Folder) = Field(default=..., description="Folder List Response")
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FolderList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FolderList:
        """Create an instance of FolderList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FolderList.parse_obj(obj)

        _obj = FolderList.parse_obj({
            "data": [Folder.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
