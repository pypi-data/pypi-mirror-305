...
class DocumentAutomationList(BaseModel):
    ...
    """
    data: conlist(DocumentAutomation) = Field(default=..., description="DocumentAutomation List Response")
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DocumentAutomationList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DocumentAutomationList:
        """Create an instance of DocumentAutomationList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DocumentAutomationList.parse_obj(obj)

        _obj = DocumentAutomationList.parse_obj({
            "data": [DocumentAutomation.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
