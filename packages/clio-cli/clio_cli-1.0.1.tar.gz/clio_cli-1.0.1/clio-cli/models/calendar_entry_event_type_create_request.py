...
class CalendarEntryEventTypeCreateRequest(BaseModel):
    """
    CalendarEntryEventTypeCreateRequest
    """
    data: CalendarEntryEventTypeCreateRequestData = Field(...)
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CalendarEntryEventTypeCreateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CalendarEntryEventTypeCreateRequest:
        """Create an instance of CalendarEntryEventTypeCreateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CalendarEntryEventTypeCreateRequest.parse_obj(obj)

        _obj = CalendarEntryEventTypeCreateRequest.parse_obj({
            "data": CalendarEntryEventTypeCreateRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
