...
class ReportList(BaseModel):
    ...
    ReportList
    """
    data: conlist(Report) = Field(default=..., description="Report List Response")
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ReportList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ReportList:
        """Create an instance of ReportList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ReportList.parse_obj(obj)

        _obj = ReportList.parse_obj({
            "data": [Report.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
