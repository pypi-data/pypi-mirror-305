...
class DocumentUpdateRequest(BaseModel):
    ...
    """
    data: DocumentUpdateRequestData = Field(...)
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DocumentUpdateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DocumentUpdateRequest:
        """Create an instance of DocumentUpdateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DocumentUpdateRequest.parse_obj(obj)

        _obj = DocumentUpdateRequest.parse_obj({
            "data": DocumentUpdateRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
