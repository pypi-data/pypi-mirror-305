...
class ClioPaymentsPayment(BaseModel):
    ...
    allocations: Optional[conlist(AllocationBase)] = Field(default=None, description="Allocation")
    bills: Optional[conlist(BillBase)] = Field(default=None, description="Bill")
    matters: Optional[conlist(MatterBase)] = Field(default=None, description="Matter")
    __properties = ["amount", "confirmation_number", "created_at", "currency", "deposit_as_revenue", "description", "email_address", "id", "state", "updated_at", "bank_transaction", "clio_payments_link", "contact", "destination_account", "user", "allocations", "bills", "matters"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ClioPaymentsPayment:
    ...
    def to_dict(self):
        ...
        if self.bank_transaction:
            _dict['bank_transaction'] = self.bank_transaction.to_dict()
        # override the default output from pydantic by calling `to_dict()` of clio_payments_link
        if self.clio_payments_link:
            _dict['clio_payments_link'] = self.clio_payments_link.to_dict()
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in bills (list)
        _items = []
        if self.bills:
            for _item in self.bills:
                if _item:
                    _items.append(_item.to_dict())
            _dict['bills'] = _items
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ClioPaymentsPayment:
        """Create an instance of ClioPaymentsPayment from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ClioPaymentsPayment.parse_obj(obj)

        _obj = ClioPaymentsPayment.parse_obj({
            ...
            "bank_transaction": BankTransactionBase.from_dict(obj.get("bank_transaction")) if obj.get("bank_transaction") is not None else None,
            "clio_payments_link": ClioPaymentsLinkBase.from_dict(obj.get("clio_payments_link")) if obj.get("clio_payments_link") is not None else None,
            "contact": ContactBase.from_dict(obj.get("contact")) if obj.get("contact") is not None else None,
            "destination_account": BankAccountBase.from_dict(obj.get("destination_account")) if obj.get("destination_account") is not None else None,
            "user": UserBase.from_dict(obj.get("user")) if obj.get("user") is not None else None,
            "allocations": [AllocationBase.from_dict(_item) for _item in obj.get("allocations")] if obj.get("allocations") is not None else None,
            "bills": [BillBase.from_dict(_item) for _item in obj.get("bills")] if obj.get("bills") is not None else None,
            "matters": [MatterBase.from_dict(_item) for _item in obj.get("matters")] if obj.get("matters") is not None else None
        })
        return _obj
