...
class MedicalBillBase(BaseModel):
    ...
    __properties = ["id", "adjustment", "amount", "bill_date", "bill_received_date", "damage_type", "document_id", "etag", "name", "created_at", "updated_at"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MedicalBillBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MedicalBillBase:
        """Create an instance of MedicalBillBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MedicalBillBase.parse_obj(obj)

        _obj = MedicalBillBase.parse_obj({
            "id": obj.get("id"),
