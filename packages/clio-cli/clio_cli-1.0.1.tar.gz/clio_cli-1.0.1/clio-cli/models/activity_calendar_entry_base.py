...
class ActivityCalendarEntryBase(BaseModel):
    ...
    __properties = ["id", "etag", "calendar_owner_id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ActivityCalendarEntryBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ActivityCalendarEntryBase:
        """Create an instance of ActivityCalendarEntryBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ActivityCalendarEntryBase.parse_obj(obj)

        _obj = ActivityCalendarEntryBase.parse_obj({
            "id": obj.get("id"),
            "etag": obj.get("etag"),
