...
class CalendarEntryUpdateRequestDataExternalPropertiesInner(BaseModel):
    """
    CalendarEntryUpdateRequestDataExternalPropertiesInner
    """
    id: Optional[StrictInt] = Field(default=None, description="The unique identifier for a single ExternalProperty associated with the CalendarEntry. The keyword `null` is not valid for this field.")
    name: Optional[StrictStr] = Field(default=None, description="The ExternalProperty name. Note: **there is a limit of 5 external_properties per CalendarEntry**")
    value: Optional[StrictStr] = Field(default=None, description="The ExternalProperty value.")
    destroy: Optional[StrictBool] = Field(default=None, alias="_destroy", description="The destroy flag. If the flag is set to `true` and the unique identifier of the associated ExternalProperty is present, the ExternalProperty is deleted from the CalendarEntry.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CalendarEntryUpdateRequestDataExternalPropertiesInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CalendarEntryUpdateRequestDataExternalPropertiesInner:
        """Create an instance of CalendarEntryUpdateRequestDataExternalPropertiesInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CalendarEntryUpdateRequestDataExternalPropertiesInner.parse_obj(obj)

        _obj = CalendarEntryUpdateRequestDataExternalPropertiesInner.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "value": obj.get("value"),
