...
class DocumentCategoryUpdateRequest(BaseModel):
    ...
    """
    data: DocumentCategoryUpdateRequestData = Field(...)
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DocumentCategoryUpdateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DocumentCategoryUpdateRequest:
        """Create an instance of DocumentCategoryUpdateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DocumentCategoryUpdateRequest.parse_obj(obj)

        _obj = DocumentCategoryUpdateRequest.parse_obj({
            "data": DocumentCategoryUpdateRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
