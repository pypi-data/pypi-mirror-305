...
class MatterStageList(BaseModel):
    ...
    MatterStageList
    """
    data: conlist(MatterStage) = Field(default=..., description="MatterStage List Response")
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MatterStageList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MatterStageList:
        """Create an instance of MatterStageList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MatterStageList.parse_obj(obj)

        _obj = MatterStageList.parse_obj({
            "data": [MatterStage.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
