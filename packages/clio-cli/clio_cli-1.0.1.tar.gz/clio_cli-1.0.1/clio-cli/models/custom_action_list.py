...
class CustomActionList(BaseModel):
    ...
    CustomActionList
    """
    data: conlist(CustomAction) = Field(default=..., description="CustomAction List Response")
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CustomActionList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CustomActionList:
        """Create an instance of CustomActionList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CustomActionList.parse_obj(obj)

        _obj = CustomActionList.parse_obj({
            "data": [CustomAction.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
