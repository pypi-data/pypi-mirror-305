...
class AllocationList(BaseModel):
    ...
    AllocationList
    """
    data: conlist(Allocation) = Field(default=..., description="Allocation List Response")
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AllocationList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AllocationList:
        """Create an instance of AllocationList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AllocationList.parse_obj(obj)

        _obj = AllocationList.parse_obj({
            "data": [Allocation.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
