...
class CalendarEntryEventTypeUpdateRequestData(BaseModel):
    """
    CalendarEntryEventTypeUpdateRequestData
    """
    color: Optional[StrictStr] = Field(default=None, description="The color assigned to the CalendarEntryEventType")
    name: Optional[StrictStr] = Field(default=None, description="The name of the CalendarEntryEventType")
    __properties = ["color", "name"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CalendarEntryEventTypeUpdateRequestData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CalendarEntryEventTypeUpdateRequestData:
        """Create an instance of CalendarEntryEventTypeUpdateRequestData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CalendarEntryEventTypeUpdateRequestData.parse_obj(obj)

        _obj = CalendarEntryEventTypeUpdateRequestData.parse_obj({
            "color": obj.get("color"),
            "name": obj.get("name")
        })
        return _obj
