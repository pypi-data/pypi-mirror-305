...
class WebhookBase(BaseModel):
    ...
    __properties = ["id", "etag", "url", "fields", "shared_secret", "model", "status", "events", "expires_at", "created_at", "updated_at"]
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in ('pending', 'enabled', 'suspended'):
            raise ValueError("must be one of enum values ('pending', 'enabled', 'suspended')")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WebhookBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WebhookBase:
        """Create an instance of WebhookBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WebhookBase.parse_obj(obj)

        _obj = WebhookBase.parse_obj({
            "id": obj.get("id"),
            "etag": obj.get("etag"),
            "url": obj.get("url"),
