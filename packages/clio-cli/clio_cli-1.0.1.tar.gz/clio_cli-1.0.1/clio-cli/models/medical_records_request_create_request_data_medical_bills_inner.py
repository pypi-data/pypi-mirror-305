...
class MedicalRecordsRequestCreateRequestDataMedicalBillsInner(BaseModel):
    """
    MedicalRecordsRequestCreateRequestDataMedicalBillsInner
    """
    adjustment: Union[StrictFloat, StrictInt] = Field(default=..., description="Adjustment for Medical Bill.")
    amount: Union[StrictFloat, StrictInt] = Field(default=..., description="Amount for Medical Bill.")
    balance: Union[StrictFloat, StrictInt] = Field(default=..., description="Balance for Medical Bill.")
    ...
    name: StrictStr = Field(default=..., description="Name for Medical Bill.")
    mark_balance_as_lien: StrictBool = Field(default=..., description="Setting the balance of the Medical Bill as a lien.")
    payers: Optional[conlist(MedicalRecordsRequestCreateRequestDataMedicalBillsInnerPayersInner)] = None
    __properties = ["adjustment", "amount", "balance", "bill_date", "bill_received_date", "document_id", "name", "mark_balance_as_lien", "payers"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MedicalRecordsRequestCreateRequestDataMedicalBillsInner:
    ...
    def to_dict(self):
        ...
        _dict = self.dict(by_alias=True,
                          ...
                          exclude_none=True)
        # override the default output from pydantic by calling `to_dict()` of each item in payers (list)
        _items = []
        if self.payers:
            for _item in self.payers:
                if _item:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MedicalRecordsRequestCreateRequestDataMedicalBillsInner:
        """Create an instance of MedicalRecordsRequestCreateRequestDataMedicalBillsInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MedicalRecordsRequestCreateRequestDataMedicalBillsInner.parse_obj(obj)

        _obj = MedicalRecordsRequestCreateRequestDataMedicalBillsInner.parse_obj({
            "adjustment": obj.get("adjustment"),
            "amount": obj.get("amount"),
            "balance": obj.get("balance"),
            "bill_date": obj.get("bill_date"),
            "bill_received_date": obj.get("bill_received_date"),
            "document_id": obj.get("document_id"),
            "name": obj.get("name"),
            "mark_balance_as_lien": obj.get("mark_balance_as_lien"),
            "payers": [MedicalRecordsRequestCreateRequestDataMedicalBillsInnerPayersInner.from_dict(_item) for _item in obj.get("payers")] if obj.get("payers") is not None else None
        })
        return _obj
