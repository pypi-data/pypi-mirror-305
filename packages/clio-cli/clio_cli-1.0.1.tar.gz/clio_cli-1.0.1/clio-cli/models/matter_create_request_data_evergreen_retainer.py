...
class MatterCreateRequestDataEvergreenRetainer(BaseModel):
    ...
    __properties = ["minimum_threshold", "recipients"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MatterCreateRequestDataEvergreenRetainer:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MatterCreateRequestDataEvergreenRetainer:
        """Create an instance of MatterCreateRequestDataEvergreenRetainer from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MatterCreateRequestDataEvergreenRetainer.parse_obj(obj)

        _obj = MatterCreateRequestDataEvergreenRetainer.parse_obj({
