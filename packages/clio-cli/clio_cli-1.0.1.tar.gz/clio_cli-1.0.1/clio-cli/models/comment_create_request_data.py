...
class CommentCreateRequestData(BaseModel):
    ...
    """
    item: CommentCreateRequestDataItem = Field(...)
    message: StrictStr = Field(default=..., description="The content of the Comment.")
    __properties = ["item", "message"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CommentCreateRequestData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CommentCreateRequestData:
        """Create an instance of CommentCreateRequestData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CommentCreateRequestData.parse_obj(obj)

        _obj = CommentCreateRequestData.parse_obj({
            "item": CommentCreateRequestDataItem.from_dict(obj.get("item")) if obj.get("item") is not None else None,
