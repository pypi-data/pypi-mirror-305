...
class CalendarVisibilityList(BaseModel):
    ...
    """
    data: conlist(CalendarVisibility) = Field(default=..., description="CalendarVisibility List Response")
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CalendarVisibilityList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CalendarVisibilityList:
        """Create an instance of CalendarVisibilityList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CalendarVisibilityList.parse_obj(obj)

        _obj = CalendarVisibilityList.parse_obj({
            "data": [CalendarVisibility.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
