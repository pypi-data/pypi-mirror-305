...
class DocumentUpdateRequestData(BaseModel):
    ...
    external_properties: Optional[conlist(DocumentCopyRequestDataExternalPropertiesInner)] = None
    ...
    multiparts: Optional[conlist(DocumentUpdateRequestDataMultipartsInner)] = None
    ...
    __properties = ["communication_id", "copy_version", "document_category", "external_properties", "fully_uploaded", "multiparts", "name", "parent", "received_at", "restore", "uuid"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DocumentUpdateRequestData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DocumentUpdateRequestData:
        """Create an instance of DocumentUpdateRequestData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DocumentUpdateRequestData.parse_obj(obj)

        _obj = DocumentUpdateRequestData.parse_obj({
            "communication_id": obj.get("communication_id"),
            "copy_version": obj.get("copy_version"),
            ...
            "external_properties": [DocumentCopyRequestDataExternalPropertiesInner.from_dict(_item) for _item in obj.get("external_properties")] if obj.get("external_properties") is not None else None,
            "fully_uploaded": obj.get("fully_uploaded"),
            "multiparts": [DocumentUpdateRequestDataMultipartsInner.from_dict(_item) for _item in obj.get("multiparts")] if obj.get("multiparts") is not None else None,
            "name": obj.get("name"),
            "parent": DocumentUpdateRequestDataParent.from_dict(obj.get("parent")) if obj.get("parent") is not None else None,
