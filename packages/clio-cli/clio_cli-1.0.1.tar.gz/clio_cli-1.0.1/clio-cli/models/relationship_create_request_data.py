...
class RelationshipCreateRequestData(BaseModel):
    """
    ...
    matter: Optional[RelationshipCreateRequestDataMatter] = None
    __properties = ["contact", "description", "matter"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RelationshipCreateRequestData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RelationshipCreateRequestData:
        """Create an instance of RelationshipCreateRequestData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RelationshipCreateRequestData.parse_obj(obj)

        _obj = RelationshipCreateRequestData.parse_obj({
            ...
            "matter": RelationshipCreateRequestDataMatter.from_dict(obj.get("matter")) if obj.get("matter") is not None else None
        })
        return _obj
