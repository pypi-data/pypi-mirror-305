...
class EventMetricsShow(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EventMetricsShow:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EventMetricsShow:
        """Create an instance of EventMetricsShow from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EventMetricsShow.parse_obj(obj)

        _obj = EventMetricsShow.parse_obj({
            "data": EventMetrics.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
