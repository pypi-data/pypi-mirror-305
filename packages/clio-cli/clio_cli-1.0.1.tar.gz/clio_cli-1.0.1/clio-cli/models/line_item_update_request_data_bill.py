...
class LineItemUpdateRequestDataBill(BaseModel):
    """
    LineItemUpdateRequestDataBill
    """
    id: Optional[StrictInt] = Field(default=None, description="The unique identifier for a single Bill associated with the LineItem. The keyword `null` is not valid for this field.")
    __properties = ["id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LineItemUpdateRequestDataBill:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LineItemUpdateRequestDataBill:
        """Create an instance of LineItemUpdateRequestDataBill from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LineItemUpdateRequestDataBill.parse_obj(obj)

        _obj = LineItemUpdateRequestDataBill.parse_obj({
            "id": obj.get("id")
        })
        return _obj
