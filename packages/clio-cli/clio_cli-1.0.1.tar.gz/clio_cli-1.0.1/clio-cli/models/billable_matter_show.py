...
class BillableMatterShow(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BillableMatterShow:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BillableMatterShow:
        """Create an instance of BillableMatterShow from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BillableMatterShow.parse_obj(obj)

        _obj = BillableMatterShow.parse_obj({
            "data": BillableMatter.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
