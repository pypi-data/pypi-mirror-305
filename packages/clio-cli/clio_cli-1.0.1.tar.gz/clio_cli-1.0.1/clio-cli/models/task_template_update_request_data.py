...
class TaskTemplateUpdateRequestData(BaseModel):
    ...
    reminder_templates: Optional[conlist(TaskTemplateUpdateRequestDataReminderTemplatesInner)] = None
    __properties = ["cascading", "cascading_offset", "cascading_offset_polarity", "cascading_offset_type", "cascading_source", "description", "name", "priority", "private", "reminder_templates"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TaskTemplateUpdateRequestData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TaskTemplateUpdateRequestData:
        """Create an instance of TaskTemplateUpdateRequestData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TaskTemplateUpdateRequestData.parse_obj(obj)

        _obj = TaskTemplateUpdateRequestData.parse_obj({
            ...
            "reminder_templates": [TaskTemplateUpdateRequestDataReminderTemplatesInner.from_dict(_item) for _item in obj.get("reminder_templates")] if obj.get("reminder_templates") is not None else None
        })
        return _obj
