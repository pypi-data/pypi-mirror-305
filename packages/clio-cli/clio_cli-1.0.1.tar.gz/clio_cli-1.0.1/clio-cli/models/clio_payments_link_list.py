...
class ClioPaymentsLinkList(BaseModel):
    ...
    """
    data: conlist(ClioPaymentsLink) = Field(default=..., description="ClioPaymentsLink List Response")
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ClioPaymentsLinkList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ClioPaymentsLinkList:
        """Create an instance of ClioPaymentsLinkList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ClioPaymentsLinkList.parse_obj(obj)

        _obj = ClioPaymentsLinkList.parse_obj({
            "data": [ClioPaymentsLink.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
