...
class ReminderList(BaseModel):
    ...
    ReminderList
    """
    data: conlist(Reminder) = Field(default=..., description="Reminder List Response")
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ReminderList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ReminderList:
        """Create an instance of ReminderList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ReminderList.parse_obj(obj)

        _obj = ReminderList.parse_obj({
            "data": [Reminder.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
