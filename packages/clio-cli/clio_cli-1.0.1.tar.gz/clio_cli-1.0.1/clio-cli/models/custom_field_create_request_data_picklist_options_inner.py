...
class CustomFieldCreateRequestDataPicklistOptionsInner(BaseModel):
    """
    CustomFieldCreateRequestDataPicklistOptionsInner
    """
    id: Optional[StrictInt] = Field(default=None, description="The unique identifier for a single PicklistOption associated with the CustomField. The keyword `null` is not valid for this field. Not required for creating new PicklistOptions, but required for updating or deleting existing ones.")
    option: Optional[StrictStr] = Field(default=None, description="The option value.")
    deleted: Optional[StrictBool] = Field(default=None, alias="_deleted", description="Whether or not the PicklistOption should be deleted.")
    __properties = ["id", "option", "_deleted"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CustomFieldCreateRequestDataPicklistOptionsInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CustomFieldCreateRequestDataPicklistOptionsInner:
        """Create an instance of CustomFieldCreateRequestDataPicklistOptionsInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CustomFieldCreateRequestDataPicklistOptionsInner.parse_obj(obj)

        _obj = CustomFieldCreateRequestDataPicklistOptionsInner.parse_obj({
            "id": obj.get("id"),
