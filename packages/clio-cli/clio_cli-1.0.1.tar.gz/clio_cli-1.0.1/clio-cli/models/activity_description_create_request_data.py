...
class ActivityDescriptionCreateRequestData(BaseModel):
    ...
    groups: Optional[conlist(ActivityDescriptionCreateRequestDataGroupsInner)] = None
    name: StrictStr = Field(default=..., description="A detailed description of the ActivityDescription.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ActivityDescriptionCreateRequestData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ActivityDescriptionCreateRequestData:
        """Create an instance of ActivityDescriptionCreateRequestData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ActivityDescriptionCreateRequestData.parse_obj(obj)

        _obj = ActivityDescriptionCreateRequestData.parse_obj({
            "default": obj.get("default"),
            "groups": [ActivityDescriptionCreateRequestDataGroupsInner.from_dict(_item) for _item in obj.get("groups")] if obj.get("groups") is not None else None,
            "name": obj.get("name"),
