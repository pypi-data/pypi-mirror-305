...
class ConferenceMeetingBase(BaseModel):
    ...
    """
    conference_id: Optional[StrictInt] = Field(default=None, description="Third-party provider unique meeting ID")
    conference_password: Optional[StrictStr] = Field(default=None, description="Third-party provider meeting password")
    created_at: Optional[datetime] = Field(default=None, description="The time the *ConferenceMeeting* was created (as a ISO-8601 timestamp)")
    etag: Optional[StrictStr] = Field(default=None, description="ETag for the *ConferenceMeeting*")
    id: Optional[StrictInt] = Field(default=None, description="Unique identifier for the *ConferenceMeeting*")
    join_url: Optional[StrictStr] = Field(default=None, description="URL for participants to join the video conference")
    type: Optional[StrictStr] = Field(default=None, description="The type of video conference")
    source_id: Optional[StrictInt] = Field(default=None, description="The external ID of the video conference meeting")
    updated_at: Optional[datetime] = Field(default=None, description="The time the *ConferenceMeeting* was last updated (as a ISO-8601 timestamp)")
    __properties = ["conference_id", "conference_password", "created_at", "etag", "id", "join_url", "type", "source_id", "updated_at"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ConferenceMeetingBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ConferenceMeetingBase:
        """Create an instance of ConferenceMeetingBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ConferenceMeetingBase.parse_obj(obj)

        _obj = ConferenceMeetingBase.parse_obj({
            "conference_id": obj.get("conference_id"),
            "conference_password": obj.get("conference_password"),
