...
class ExpenseCategoryUpdateRequest(BaseModel):
    ...
    """
    data: ExpenseCategoryUpdateRequestData = Field(...)
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ExpenseCategoryUpdateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ExpenseCategoryUpdateRequest:
        """Create an instance of ExpenseCategoryUpdateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ExpenseCategoryUpdateRequest.parse_obj(obj)

        _obj = ExpenseCategoryUpdateRequest.parse_obj({
            "data": ExpenseCategoryUpdateRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
