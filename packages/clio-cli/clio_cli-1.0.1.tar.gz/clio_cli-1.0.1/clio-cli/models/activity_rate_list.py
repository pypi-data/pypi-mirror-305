...
class ActivityRateList(BaseModel):
    ...
    ActivityRateList
    """
    data: conlist(ActivityRate) = Field(default=..., description="ActivityRate List Response")
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ActivityRateList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ActivityRateList:
        """Create an instance of ActivityRateList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ActivityRateList.parse_obj(obj)

        _obj = ActivityRateList.parse_obj({
            "data": [ActivityRate.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
