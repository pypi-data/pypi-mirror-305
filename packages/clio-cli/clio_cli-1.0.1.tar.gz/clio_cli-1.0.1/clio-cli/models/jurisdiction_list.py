...
class JurisdictionList(BaseModel):
    ...
    JurisdictionList
    """
    data: conlist(Jurisdiction) = Field(default=..., description="Jurisdiction List Response")
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> JurisdictionList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> JurisdictionList:
        """Create an instance of JurisdictionList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return JurisdictionList.parse_obj(obj)

        _obj = JurisdictionList.parse_obj({
            "data": [Jurisdiction.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
