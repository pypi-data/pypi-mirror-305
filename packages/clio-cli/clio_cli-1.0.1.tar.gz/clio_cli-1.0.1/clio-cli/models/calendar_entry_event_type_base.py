...
class CalendarEntryEventTypeBase(BaseModel):
    ...
    """
    id: Optional[StrictInt] = Field(default=None, description="Unique identifier for the *CalendarEntryEventType*")
    etag: Optional[StrictStr] = Field(default=None, description="ETag for the *CalendarEntryEventType*")
    created_at: Optional[datetime] = Field(default=None, description="The time the *CalendarEntryEventType* was created (as a ISO-8601 timestamp)")
    updated_at: Optional[datetime] = Field(default=None, description="The time the *CalendarEntryEventType* was last updated (as a ISO-8601 timestamp)")
    color: Optional[StrictStr] = Field(default=None, description="The color describing the *CalendarEntryEventType*")
    name: Optional[StrictStr] = Field(default=None, description="The name for the *CalendarEntryEventType*")
    __properties = ["id", "etag", "created_at", "updated_at", "color", "name"]
    ...
    def color_validate_enum(cls, value):
        ...
        if value not in ('#367B9C', '#FFA5A4', '#83D17F', '#FFAC7B', '#8E3F64', '#C75300', '#009CEC', '#62D6B1', '#9EEDCB', '#F9A2C4', '#616161', '#BBDA81', '#DFD3F8', '#D6C4A5', '#FFD478', '#6AC9DE', '#EABBB0', '#BFC2E1', '#DADADA', '#CDE2F5'):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CalendarEntryEventTypeBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CalendarEntryEventTypeBase:
        """Create an instance of CalendarEntryEventTypeBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CalendarEntryEventTypeBase.parse_obj(obj)

        _obj = CalendarEntryEventTypeBase.parse_obj({
            "id": obj.get("id"),
            "etag": obj.get("etag"),
