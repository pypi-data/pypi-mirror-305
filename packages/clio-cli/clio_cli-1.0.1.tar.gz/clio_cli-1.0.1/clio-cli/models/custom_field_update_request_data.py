...
class CustomFieldUpdateRequestData(BaseModel):
    """
    ...
    name: Optional[StrictStr] = Field(default=None, description="CustomField name.")
    ...
    __properties = ["display_order", "displayed", "name", "picklist_options", "required"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CustomFieldUpdateRequestData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CustomFieldUpdateRequestData:
        """Create an instance of CustomFieldUpdateRequestData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CustomFieldUpdateRequestData.parse_obj(obj)

        _obj = CustomFieldUpdateRequestData.parse_obj({
