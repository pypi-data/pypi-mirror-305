...
class UtbmsCodeShow(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UtbmsCodeShow:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UtbmsCodeShow:
        """Create an instance of UtbmsCodeShow from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UtbmsCodeShow.parse_obj(obj)

        _obj = UtbmsCodeShow.parse_obj({
            "data": UtbmsCode.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
