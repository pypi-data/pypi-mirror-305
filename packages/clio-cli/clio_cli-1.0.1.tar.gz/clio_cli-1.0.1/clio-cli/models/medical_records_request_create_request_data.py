...
class MedicalRecordsRequestCreateRequestData(BaseModel):
    ...
    bills_status: StrictStr = Field(default=..., description="Current status for the Medical Bills.")
    description: Optional[StrictStr] = Field(default=None, description="Detailed description of the Medical Records Detail.")
    in_treatment: StrictBool = Field(default=..., description="True or false value to record if the treatment has been completed.")
    matter_id: StrictInt = Field(default=..., description="The ID of the matter that the Medical Records Detail belongs to.")
    medical_bills: Optional[conlist(MedicalRecordsRequestCreateRequestDataMedicalBillsInner)] = None
    medical_provider_id: StrictInt = Field(default=..., description="The unique identifier for a single Medical Provider associated with this Medical Records Detail.")
    medical_records: Optional[conlist(MedicalRecordsRequestCreateRequestDataMedicalRecordsInner)] = None
    ...
    records_status: StrictStr = Field(default=..., description="Current status for the Medical Records.")
    ...
    __properties = ["bills_follow_up_date", "bills_request_date", "bills_status", "description", "in_treatment", "matter_id", "medical_bills", "medical_provider_id", "medical_records", "records_follow_up_date", "records_request_date", "records_status", "treatment_end_date", "treatment_start_date"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MedicalRecordsRequestCreateRequestData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MedicalRecordsRequestCreateRequestData:
        """Create an instance of MedicalRecordsRequestCreateRequestData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MedicalRecordsRequestCreateRequestData.parse_obj(obj)

        _obj = MedicalRecordsRequestCreateRequestData.parse_obj({
            ...
            "medical_bills": [MedicalRecordsRequestCreateRequestDataMedicalBillsInner.from_dict(_item) for _item in obj.get("medical_bills")] if obj.get("medical_bills") is not None else None,
            "medical_provider_id": obj.get("medical_provider_id"),
            "medical_records": [MedicalRecordsRequestCreateRequestDataMedicalRecordsInner.from_dict(_item) for _item in obj.get("medical_records")] if obj.get("medical_records") is not None else None,
