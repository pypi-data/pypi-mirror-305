...
class DocumentCreateRequestDataExternalPropertiesInner(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DocumentCreateRequestDataExternalPropertiesInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DocumentCreateRequestDataExternalPropertiesInner:
        """Create an instance of DocumentCreateRequestDataExternalPropertiesInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DocumentCreateRequestDataExternalPropertiesInner.parse_obj(obj)

        _obj = DocumentCreateRequestDataExternalPropertiesInner.parse_obj({
            "name": obj.get("name"),
            "value": obj.get("value")
        })
        return _obj
