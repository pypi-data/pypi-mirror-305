...
class GrantFundingSource(BaseModel):
    ...
    GrantFundingSource
    """
    id: Optional[StrictInt] = Field(default=None, description="Unique identifier for the *GrantFundingSource*")
    etag: Optional[StrictStr] = Field(default=None, description="ETag for the *GrantFundingSource*")
    name: Optional[StrictStr] = Field(default=None, description="The name of the *GrantFundingSource*")
    created_at: Optional[datetime] = Field(default=None, description="The time the *GrantFundingSource* was created (as a ISO-8601 timestamp)")
    updated_at: Optional[datetime] = Field(default=None, description="The time the *GrantFundingSource* was last updated (as a ISO-8601 timestamp)")
    grants: Optional[conlist(GrantBase)] = Field(default=None, description="Grant")
    __properties = ["id", "etag", "name", "created_at", "updated_at", "grants"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GrantFundingSource:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GrantFundingSource:
        """Create an instance of GrantFundingSource from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GrantFundingSource.parse_obj(obj)

        _obj = GrantFundingSource.parse_obj({
            "id": obj.get("id"),
            "etag": obj.get("etag"),
            "name": obj.get("name"),
            "created_at": obj.get("created_at"),
            "updated_at": obj.get("updated_at"),
            "grants": [GrantBase.from_dict(_item) for _item in obj.get("grants")] if obj.get("grants") is not None else None
        })
        return _obj
