...
class TaskTemplateListCopyRequestDataPracticeArea(BaseModel):
    """
    TaskTemplateListCopyRequestDataPracticeArea
    """
    id: Optional[StrictInt] = Field(default=None, description="The unique identifier for the practice area of the TaskTemplateList copy.")
    __properties = ["id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TaskTemplateListCopyRequestDataPracticeArea:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TaskTemplateListCopyRequestDataPracticeArea:
        """Create an instance of TaskTemplateListCopyRequestDataPracticeArea from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TaskTemplateListCopyRequestDataPracticeArea.parse_obj(obj)

        _obj = TaskTemplateListCopyRequestDataPracticeArea.parse_obj({
            "id": obj.get("id")
        })
        return _obj
