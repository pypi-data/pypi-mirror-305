...
class ReportPresetCreateRequest(BaseModel):
    ...
    """
    data: ReportPresetCreateRequestData = Field(...)
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ReportPresetCreateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ReportPresetCreateRequest:
        """Create an instance of ReportPresetCreateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ReportPresetCreateRequest.parse_obj(obj)

        _obj = ReportPresetCreateRequest.parse_obj({
            "data": ReportPresetCreateRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
