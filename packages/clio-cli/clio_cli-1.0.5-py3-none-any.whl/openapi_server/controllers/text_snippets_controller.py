...
async def text_snippet_create(request: web.Request, x_api_version=None, fields=None, body=None) -> web.Response:
    ...
    :type fields: str
    :param body: Request Body for Text Snippets
    :type body: dict | bytes

    """
    body = TextSnippetCreateRequest.from_dict(body)
    return web.Response(status=200)


async def text_snippet_destroy(request: web.Request, id, x_api_version=None) -> web.Response:
    ...
    :param id: The unique identifier for the TextSnippet.
    :type id: int
    :param x_api_version: The [API minor version](#section/Minor-Versions). Default: latest version.
    :type x_api_version: str
...
async def text_snippet_index(request: web.Request, x_api_version=None, created_since=None, fields=None, ids=None, limit=None, order=None, page_token=None, query=None, updated_since=None) -> web.Response:
    ...
    :param x_api_version: The [API minor version](#section/Minor-Versions). Default: latest version.
    :type x_api_version: str
    :param created_since: Filter TextSnippet records to those having the &#x60;created_at&#x60; field after a specific time. (Expects an ISO-8601 timestamp).
    :type created_since: str
    :param fields: The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).
    :type fields: str
    :param ids: Filter TextSnippet records to those having the specified unique identifiers.
    :type ids: int
    :param limit: A limit on the number of TextSnippet records to be returned. Limit can range between 1 and 200. Default: &#x60;200&#x60;.
    :type limit: int
    :param order: Orders the TextSnippet records by the given field. Default: &#x60;id(asc)&#x60;.
    :type order: str
    :param page_token: A token specifying which page to return.
    :type page_token: str
    :param query: Wildcard search for &#x60;snippet&#x60; or &#x60;phrase&#x60; matching a given string.
    :type query: str
    :param updated_since: Filter TextSnippet records to those having the &#x60;updated_at&#x60; field after a specific time. (Expects an ISO-8601 timestamp).
...
async def text_snippet_show(request: web.Request, id, if_modified_since=None, if_none_match=None, x_api_version=None, fields=None) -> web.Response:
...
async def text_snippet_update(request: web.Request, id, if_match=None, x_api_version=None, fields=None, body=None) -> web.Response:
    ...
    """
    body = TextSnippetUpdateRequest.from_dict(body)
    return web.Response(status=200)
