...
async def billing_setting_show(request: web.Request, if_modified_since=None, if_none_match=None, x_api_version=None, duration=None, fields=None) -> web.Response:
    ...
    :param duration: Duration string for time rounding, conforming to the Chronic date parser. For example: &#39;3h&#39; or &#39;2:15&#39;.
    :type duration: str
