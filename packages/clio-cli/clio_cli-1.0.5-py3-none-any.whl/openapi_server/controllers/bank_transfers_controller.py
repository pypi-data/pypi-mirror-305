...
async def bank_transfer_show(request: web.Request, id, if_modified_since=None, if_none_match=None, x_api_version=None, fields=None) -> web.Response:
    ...
    :param id: The unique identifier for the BankTransfer.
    :type id: int
