...
class EventMetrics(Model):
    ...
    def __init__(self, unread_mobile_events: int=None, unread_web_events: int=None, unread_secure_messages: int=None, unread_client_portal_messages: int=None, unread_text_messages: int=None):
        """EventMetrics - a model defined in OpenAPI

        :param unread_mobile_events: The unread_mobile_events of this EventMetrics.
        :param unread_web_events: The unread_web_events of this EventMetrics.
        :param unread_secure_messages: The unread_secure_messages of this EventMetrics.
        :param unread_client_portal_messages: The unread_client_portal_messages of this EventMetrics.
        :param unread_text_messages: The unread_text_messages of this EventMetrics.
        """
        self.openapi_types = {
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'EventMetrics':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The EventMetrics of this EventMetrics.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def unread_mobile_events(self):
        """Gets the unread_mobile_events of this EventMetrics.

        The number of unread mobile event notifications for the current user

        :return: The unread_mobile_events of this EventMetrics.
        :rtype: int
        """
    ...
    def unread_mobile_events(self, unread_mobile_events):
        """Sets the unread_mobile_events of this EventMetrics.
    ...
    def unread_web_events(self):
        """Gets the unread_web_events of this EventMetrics.

        The number of unread web event notifications for the current user

        :return: The unread_web_events of this EventMetrics.
        :rtype: int
        """
    ...
    def unread_web_events(self, unread_web_events):
        """Sets the unread_web_events of this EventMetrics.
    ...
    def unread_secure_messages(self):
        """Gets the unread_secure_messages of this EventMetrics.

        The number of unread secure messages for the current user

        :return: The unread_secure_messages of this EventMetrics.
        :rtype: int
        """
    ...
    def unread_secure_messages(self, unread_secure_messages):
        """Sets the unread_secure_messages of this EventMetrics.
    ...
    def unread_client_portal_messages(self):
        """Gets the unread_client_portal_messages of this EventMetrics.

        The number of unread client portal messages for the current user

        :return: The unread_client_portal_messages of this EventMetrics.
        :rtype: int
        """
    ...
    def unread_client_portal_messages(self, unread_client_portal_messages):
        """Sets the unread_client_portal_messages of this EventMetrics.
    ...
    def unread_text_messages(self):
        """Gets the unread_text_messages of this EventMetrics.

        The number of unread text messages for the current user

        :return: The unread_text_messages of this EventMetrics.
        :rtype: int
        """
    ...
    def unread_text_messages(self, unread_text_messages):
        """Sets the unread_text_messages of this EventMetrics.
