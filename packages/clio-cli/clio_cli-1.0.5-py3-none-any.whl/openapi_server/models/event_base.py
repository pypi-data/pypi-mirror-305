...
class EventBase(Model):
    ...
    def __init__(self, id: int=None, etag: str=None, message: str=None, icon: str=None, title: str=None, title_url: str=None, description: str=None, description_url: str=None, primary_detail: str=None, primary_detail_url: str=None, secondary_detail: str=None, secondary_detail_url: str=None, occurred_at: datetime=None, mobile_icon: str=None, subject_type: str=None, subject_id: int=None):
        ...
        :param etag: The etag of this EventBase.
        :param message: The message of this EventBase.
        :param icon: The icon of this EventBase.
        :param title: The title of this EventBase.
        :param title_url: The title_url of this EventBase.
        :param description: The description of this EventBase.
        :param description_url: The description_url of this EventBase.
        :param primary_detail: The primary_detail of this EventBase.
        :param primary_detail_url: The primary_detail_url of this EventBase.
        :param secondary_detail: The secondary_detail of this EventBase.
        :param secondary_detail_url: The secondary_detail_url of this EventBase.
        :param occurred_at: The occurred_at of this EventBase.
        :param mobile_icon: The mobile_icon of this EventBase.
        :param subject_type: The subject_type of this EventBase.
        :param subject_id: The subject_id of this EventBase.
        """
        self.openapi_types = {
            'id': int,
            'etag': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'EventBase':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The Event_base of this EventBase.
        """
    ...
    @property
    def etag(self):
        """Gets the etag of this EventBase.

        ETag for the *Event*

        :return: The etag of this EventBase.
        :rtype: str
        """
        return self._etag
    ...
    @etag.setter
    def etag(self, etag):
        """Sets the etag of this EventBase.
    ...
    @property
    def icon(self):
        """Gets the icon of this EventBase.

        Font Awesome icon to display (without the fa- prefix)

        :return: The icon of this EventBase.
        :rtype: str
        """
        return self._icon
    ...
    @icon.setter
    def icon(self, icon):
        """Sets the icon of this EventBase.
    ...
    @property
    def title(self):
        """Gets the title of this EventBase.

        The title or subject of the event (e.g. Matter Number, Document Title)

        :return: The title of this EventBase.
        :rtype: str
        """
        return self._title
    ...
    def title(self, title):
        """Sets the title of this EventBase.
    ...
    @property
    def title_url(self):
        """Gets the title_url of this EventBase.

        Target URL that will be opened if the user clicks on the event title

        :return: The title_url of this EventBase.
        :rtype: str
        """
    ...
    def title_url(self, title_url):
        """Sets the title_url of this EventBase.
    ...
    def description(self):
        """Gets the description of this EventBase.

        Description or additional information about the event (e.g. Matter Description)

        :return: The description of this EventBase.
        :rtype: str
        """
    ...
    def description_url(self):
        """Gets the description_url of this EventBase.

        Target URL that will be opened if the user clicks on the event description

        :return: The description_url of this EventBase.
        :rtype: str
        """
    ...
    def description_url(self, description_url):
        """Sets the description_url of this EventBase.
    ...
    def primary_detail(self):
        """Gets the primary_detail of this EventBase.

        Optional additional information about the event (e.g. Matter Client, Document Author)

        :return: The primary_detail of this EventBase.
        :rtype: str
        """
    ...
    def primary_detail(self, primary_detail):
        """Sets the primary_detail of this EventBase.
    ...
    def primary_detail_url(self):
        """Gets the primary_detail_url of this EventBase.

        Target URL that will be opened if the user clicks on the primary detail

        :return: The primary_detail_url of this EventBase.
        :rtype: str
        """
    ...
    def primary_detail_url(self, primary_detail_url):
        """Sets the primary_detail_url of this EventBase.
    ...
    def secondary_detail(self):
        """Gets the secondary_detail of this EventBase.

        Optional additional information about the event (e.g. Matter Status, Document Size)

        :return: The secondary_detail of this EventBase.
        :rtype: str
        """
    ...
    def secondary_detail(self, secondary_detail):
        """Sets the secondary_detail of this EventBase.
    ...
    def secondary_detail_url(self):
        """Gets the secondary_detail_url of this EventBase.

        Target URL that will be opened if the user clicks on the secondary detail

        :return: The secondary_detail_url of this EventBase.
        :rtype: str
        """
    ...
    def secondary_detail_url(self, secondary_detail_url):
        """Sets the secondary_detail_url of this EventBase.
    ...
    def occurred_at(self):
        """Gets the occurred_at of this EventBase.

        When the event occurred

        :return: The occurred_at of this EventBase.
        :rtype: datetime
        """
    ...
    def occurred_at(self, occurred_at):
        """Sets the occurred_at of this EventBase.
    ...
    def mobile_icon(self):
        """Gets the mobile_icon of this EventBase.

        Icon to be displayed in the mobile app

        :return: The mobile_icon of this EventBase.
        :rtype: str
        """
    ...
    def mobile_icon(self, mobile_icon):
        """Sets the mobile_icon of this EventBase.
    ...
    def subject_type(self):
        """Gets the subject_type of this EventBase.

        The type of subject that triggered the notification (e.g. Matter, Document)

        :return: The subject_type of this EventBase.
        :rtype: str
        """
    ...
    def subject_type(self, subject_type):
        """Sets the subject_type of this EventBase.
    ...
    @property
    def subject_id(self):
        """Gets the subject_id of this EventBase.

        Id of the subject that triggered the notification

        :return: The subject_id of this EventBase.
        :rtype: int
        """
    ...
    def subject_id(self, subject_id):
        """Sets the subject_id of this EventBase.
