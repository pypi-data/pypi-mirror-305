...
class PracticeArea(Model):
    ...
    def __init__(self, id: int=None, etag: str=None, created_at: datetime=None, updated_at: datetime=None, name: str=None, category: str=None, code: str=None):
        """PracticeArea - a model defined in OpenAPI

        :param id: The id of this PracticeArea.
        :param etag: The etag of this PracticeArea.
        :param created_at: The created_at of this PracticeArea.
        :param updated_at: The updated_at of this PracticeArea.
        :param name: The name of this PracticeArea.
        :param category: The category of this PracticeArea.
        :param code: The code of this PracticeArea.
        """
        self.openapi_types = {
            'id': int,
            'etag': str,
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'PracticeArea':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The PracticeArea of this PracticeArea.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def id(self):
        """Gets the id of this PracticeArea.

        Unique identifier for the *PracticeArea*

        :return: The id of this PracticeArea.
        :rtype: int
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this PracticeArea.
    ...
    @property
    def etag(self):
        """Gets the etag of this PracticeArea.

        ETag for the *PracticeArea*

        :return: The etag of this PracticeArea.
        :rtype: str
        """
        return self._etag
    ...
    @etag.setter
    def etag(self, etag):
        """Sets the etag of this PracticeArea.
    ...
    @property
    def created_at(self):
        """Gets the created_at of this PracticeArea.

        The time the *PracticeArea* was created (as a ISO-8601 timestamp)

        :return: The created_at of this PracticeArea.
        :rtype: datetime
        """
    ...
    def created_at(self, created_at):
        """Sets the created_at of this PracticeArea.
    ...
    @property
    def updated_at(self):
        """Gets the updated_at of this PracticeArea.

        The time the *PracticeArea* was last updated (as a ISO-8601 timestamp)

        :return: The updated_at of this PracticeArea.
        :rtype: datetime
        """
    ...
    def updated_at(self, updated_at):
        """Sets the updated_at of this PracticeArea.
    ...
    @property
    def name(self):
        """Gets the name of this PracticeArea.

        The name of the *PracticeArea*

        :return: The name of this PracticeArea.
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this PracticeArea.
    ...
    @property
    def category(self):
        """Gets the category of this PracticeArea.

        The practice area category associated with the *PracticeArea* 

        :return: The category of this PracticeArea.
        :rtype: str
        """
    ...
    def category(self, category):
        """Sets the category of this PracticeArea.
    ...
    @property
    def code(self):
        """Gets the code of this PracticeArea.

        The code of the *PracticeArea*

        :return: The code of this PracticeArea.
        :rtype: str
        """
        return self._code
    ...
    @code.setter
    def code(self, code):
        """Sets the code of this PracticeArea.
