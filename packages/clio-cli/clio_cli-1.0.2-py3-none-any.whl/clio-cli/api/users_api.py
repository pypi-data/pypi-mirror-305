...
class UsersApi:
    ...
    @validate_arguments
    def user_index(self, x_api_version : Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None, created_since : Annotated[Optional[datetime], Field(description="Filter User records to those having the `created_at` field after a specific time. (Expects an ISO-8601 timestamp).")] = None, enabled : Annotated[Optional[StrictBool], Field(description="Filter User records to those that are enabled or disabled.")] = None, fields : Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None, ids : Annotated[Optional[StrictInt], Field(description="Filter User records to those having the specified unique identifiers.")] = None, include_co_counsel : Annotated[Optional[StrictBool], Field(description="Filter User to include co-counsel users")] = None, limit : Annotated[Optional[StrictInt], Field(description="A limit on the number of User records to be returned. Limit can range between 1 and 2000. Default: `2000`.")] = None, name : Annotated[Optional[StrictStr], Field(description="Filter User records to those with the given name.")] = None, order : Annotated[Optional[StrictStr], Field(description="Orders the User records by the given field. Default: `id(asc)`.")] = None, page_token : Annotated[Optional[StrictStr], Field(description="A token specifying which page to return.")] = None, pending_setup : Annotated[Optional[StrictBool], Field(description="Filter User records based on whether or not they are still being setup.")] = None, role : Annotated[Optional[StrictStr], Field(description="Filter User records to those with a specific role.")] = None, subscription_type : Annotated[Optional[StrictStr], Field(description="Filter User records to those with a specific subscription type.")] = None, updated_since : Annotated[Optional[datetime], Field(description="Filter User records to those having the `updated_at` field after a specific time. (Expects an ISO-8601 timestamp).")] = None, **kwargs) -> UserList:  # noqa: E501
        """Return the data for all Users  # noqa: E501

        Outlines the parameters, optional and required, used when requesting the data for all Users  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.user_index(x_api_version, created_since, enabled, fields, ids, include_co_counsel, limit, name, order, page_token, pending_setup, role, subscription_type, updated_since, async_req=True)
        >>> result = thread.get()
        ...
        if '_preload_content' in kwargs:
            message = "Error! Please call the user_index_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.user_index_with_http_info(x_api_version, created_since, enabled, fields, ids, include_co_counsel, limit, name, order, page_token, pending_setup, role, subscription_type, updated_since, **kwargs)  # noqa: E501

    @validate_arguments
    def user_index_with_http_info(self, x_api_version : Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None, created_since : Annotated[Optional[datetime], Field(description="Filter User records to those having the `created_at` field after a specific time. (Expects an ISO-8601 timestamp).")] = None, enabled : Annotated[Optional[StrictBool], Field(description="Filter User records to those that are enabled or disabled.")] = None, fields : Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None, ids : Annotated[Optional[StrictInt], Field(description="Filter User records to those having the specified unique identifiers.")] = None, include_co_counsel : Annotated[Optional[StrictBool], Field(description="Filter User to include co-counsel users")] = None, limit : Annotated[Optional[StrictInt], Field(description="A limit on the number of User records to be returned. Limit can range between 1 and 2000. Default: `2000`.")] = None, name : Annotated[Optional[StrictStr], Field(description="Filter User records to those with the given name.")] = None, order : Annotated[Optional[StrictStr], Field(description="Orders the User records by the given field. Default: `id(asc)`.")] = None, page_token : Annotated[Optional[StrictStr], Field(description="A token specifying which page to return.")] = None, pending_setup : Annotated[Optional[StrictBool], Field(description="Filter User records based on whether or not they are still being setup.")] = None, role : Annotated[Optional[StrictStr], Field(description="Filter User records to those with a specific role.")] = None, subscription_type : Annotated[Optional[StrictStr], Field(description="Filter User records to those with a specific subscription type.")] = None, updated_since : Annotated[Optional[datetime], Field(description="Filter User records to those having the `updated_at` field after a specific time. (Expects an ISO-8601 timestamp).")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Return the data for all Users  # noqa: E501
        ...
        >>> thread = api.user_index_with_http_info(x_api_version, created_since, enabled, fields, ids, include_co_counsel, limit, name, order, page_token, pending_setup, role, subscription_type, updated_since, async_req=True)
        >>> result = thread.get()
        ...
        if _params.get('include_co_counsel') is not None:  # noqa: E501
            _query_params.append(('include_co_counsel', _params['include_co_counsel']))
        ...
        if _params.get('pending_setup') is not None:  # noqa: E501
            _query_params.append(('pending_setup', _params['pending_setup']))

        if _params.get('role') is not None:  # noqa: E501
            _query_params.append(('role', _params['role']))

        if _params.get('subscription_type') is not None:  # noqa: E501
            _query_params.append(('subscription_type', _params['subscription_type']))
    ...
    def user_show(self, id : Annotated[StrictInt, Field(..., description="The unique identifier for the User.")], if_modified_since : Annotated[Optional[date], Field(description="The server will send the requested resource with a 200 status, but only if it has been modified after the given date. (Expects an RFC 2822 timestamp).")] = None, if_none_match : Annotated[Optional[StrictStr], Field(description="The server will send the requested resource with a 200 status, but only if the existing resource's [ETag](#section/ETags) doesn't match any of the values listed.")] = None, x_api_version : Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None, fields : Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None, **kwargs) -> UserShow:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the user_show_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.user_show_with_http_info(id, if_modified_since, if_none_match, x_api_version, fields, **kwargs)  # noqa: E501
    ...
    def user_show_with_http_info(self, id : Annotated[StrictInt, Field(..., description="The unique identifier for the User.")], if_modified_since : Annotated[Optional[date], Field(description="The server will send the requested resource with a 200 status, but only if it has been modified after the given date. (Expects an RFC 2822 timestamp).")] = None, if_none_match : Annotated[Optional[StrictStr], Field(description="The server will send the requested resource with a 200 status, but only if the existing resource's [ETag](#section/ETags) doesn't match any of the values listed.")] = None, x_api_version : Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None, fields : Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        >>> thread = api.user_show_with_http_info(id, if_modified_since, if_none_match, x_api_version, fields, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(UserShow, status_code(int), headers(HTTPHeaderDict))
        """
    ...
    @validate_arguments
    def user_who_am_i(self, if_modified_since : Annotated[Optional[date], Field(description="The server will send the requested resource with a 200 status, but only if it has been modified after the given date. (Expects an RFC 2822 timestamp).")] = None, if_none_match : Annotated[Optional[StrictStr], Field(description="The server will send the requested resource with a 200 status, but only if the existing resource's [ETag](#section/ETags) doesn't match any of the values listed.")] = None, x_api_version : Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None, fields : Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None, **kwargs) -> UserShow:  # noqa: E501
        """Return the data for the current User  # noqa: E501

        Outlines the parameters, optional and required, used when requesting the data for a single User  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.user_who_am_i(if_modified_since, if_none_match, x_api_version, fields, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the user_who_am_i_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.user_who_am_i_with_http_info(if_modified_since, if_none_match, x_api_version, fields, **kwargs)  # noqa: E501

    @validate_arguments
    def user_who_am_i_with_http_info(self, if_modified_since : Annotated[Optional[date], Field(description="The server will send the requested resource with a 200 status, but only if it has been modified after the given date. (Expects an RFC 2822 timestamp).")] = None, if_none_match : Annotated[Optional[StrictStr], Field(description="The server will send the requested resource with a 200 status, but only if the existing resource's [ETag](#section/ETags) doesn't match any of the values listed.")] = None, x_api_version : Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None, fields : Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Return the data for the current User  # noqa: E501
        ...
        >>> thread = api.user_who_am_i_with_http_info(if_modified_since, if_none_match, x_api_version, fields, async_req=True)
        >>> result = thread.get()
