...
class ContactsApi:
    ...
    @validate_arguments
    def contact_create(self, x_api_version : Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None, custom_field_ids : Annotated[Optional[StrictInt], Field(description="Filter Contact's custom_field_values to only include values for the given custom field unique identifiers.")] = None, fields : Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None, contact_create_request : Annotated[Optional[ContactCreateRequest], Field(description="Request Body for Contacts")] = None, **kwargs) -> ContactShow:  # noqa: E501
        """Create a new Contact  # noqa: E501

        Outlines the parameters and data fields used when creating a new Contact  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.contact_create(x_api_version, custom_field_ids, fields, contact_create_request, async_req=True)
        >>> result = thread.get()
        ...
        if '_preload_content' in kwargs:
            message = "Error! Please call the contact_create_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.contact_create_with_http_info(x_api_version, custom_field_ids, fields, contact_create_request, **kwargs)  # noqa: E501

    @validate_arguments
    def contact_create_with_http_info(self, x_api_version : Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None, custom_field_ids : Annotated[Optional[StrictInt], Field(description="Filter Contact's custom_field_values to only include values for the given custom field unique identifiers.")] = None, fields : Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None, contact_create_request : Annotated[Optional[ContactCreateRequest], Field(description="Request Body for Contacts")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Create a new Contact  # noqa: E501
        ...
        >>> thread = api.contact_create_with_http_info(x_api_version, custom_field_ids, fields, contact_create_request, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(ContactShow, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        _body_params = None
        if _params['contact_create_request'] is not None:
            _body_params = _params['contact_create_request']
    ...
    @validate_arguments
    def contact_destroy(self, id : Annotated[StrictInt, Field(..., description="The unique identifier for the Contact.")], x_api_version : Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None, **kwargs) -> None:  # noqa: E501
        """Delete a single Contact  # noqa: E501

        Outlines the parameters, optional and required, used when deleting the record for a single Contact  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.contact_destroy(id, x_api_version, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the contact_destroy_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.contact_destroy_with_http_info(id, x_api_version, **kwargs)  # noqa: E501

    @validate_arguments
    def contact_destroy_with_http_info(self, id : Annotated[StrictInt, Field(..., description="The unique identifier for the Contact.")], x_api_version : Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Delete a single Contact  # noqa: E501
        ...
        >>> thread = api.contact_destroy_with_http_info(id, x_api_version, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method contact_destroy" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    @validate_arguments
    def contact_index(self, x_api_version : Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None, client_only : Annotated[Optional[StrictBool], Field(description="Filter Contact records to those that are clients.")] = None, clio_connect_only : Annotated[Optional[StrictBool], Field(description="Filter Contact records to those that are Clio Connect users.")] = None, created_since : Annotated[Optional[datetime], Field(description="Filter Contact records to those having the `created_at` field after a specific time. (Expects an ISO-8601 timestamp).")] = None, custom_field_ids : Annotated[Optional[StrictInt], Field(description="Filter Contact's custom_field_values to only include values for the given custom field unique identifiers.")] = None, custom_field_values : Annotated[Optional[StrictStr], Field(description="Filter records to only those with the given custom field(s) set. The value is compared using the operator provided, or, if the value type only supports one operator, the supported operator is used. In the latter case, no check for operator is performed on the input string. The key for the custom field value filter is the custom_field.id. e.g. `custom_field_values[12345]` If an operator is used for a type that does not support it, an `400 Bad Request` is returned.  *Supported operators:* * `checkbox`, `contact`, `matter`, `picklist` : `=`  e.g. `?custom_field_values[1]=42`  * `currency`, `date`, `time`, `numeric` : `=`, `<`, `>`, `<=`, `>=`  e.g. `?custom_field_values[1]=>=105.4`  * `email`, `text_area`, `text_line`, `url` : `=`  e.g. `?custom_field_values[1]=url_encoded`  *Multiple conditions for the same custom field:*  If you want to use more than one operator to filter a custom field, you can do so by passing in an array of values. e.g. `?custom_field_values[1]=[<=50, >=45]` ")] = None, email_only : Annotated[Optional[StrictBool], Field(description="Filter Contact records to those that have email addresses.")] = None, exclude_ids : Annotated[Optional[StrictInt], Field(description="Filter Contact records to those who are not included in the given list of unique identifiers.")] = None, fields : Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None, ids : Annotated[Optional[StrictInt], Field(description="Filter Contact records to those having the specified unique identifiers.")] = None, initial : Annotated[Optional[StrictStr], Field(description="Filter Contact records to those where the last name or company name start with the given initial.")] = None, limit : Annotated[Optional[StrictInt], Field(description="A limit on the number of Contact records to be returned. Limit can range between 1 and 200. Default: `200`.")] = None, order : Annotated[Optional[StrictStr], Field(description="Orders the Contact records by the given field. Default: `id(asc)`.")] = None, page_token : Annotated[Optional[StrictStr], Field(description="A token specifying which page to return.")] = None, query : Annotated[Optional[StrictStr], Field(description="Wildcard search for name, title, email address, address, phone number, web site, instant messenger address, custom fields, related matter name, or company name matching a given string. ")] = None, shared_resource_id : Annotated[Optional[StrictInt], Field(description="Filter Contact records to those that currently have access to a given shared resource.")] = None, type : Annotated[Optional[StrictStr], Field(description="Filter Contact records to those that match the given type.")] = None, updated_since : Annotated[Optional[datetime], Field(description="Filter Contact records to those having the `updated_at` field after a specific time. (Expects an ISO-8601 timestamp).")] = None, **kwargs) -> ContactList:  # noqa: E501
        """Return the data for all Contacts  # noqa: E501

        Outlines the parameters, optional and required, used when requesting the data for all Contacts  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.contact_index(x_api_version, client_only, clio_connect_only, created_since, custom_field_ids, custom_field_values, email_only, exclude_ids, fields, ids, initial, limit, order, page_token, query, shared_resource_id, type, updated_since, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the contact_index_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.contact_index_with_http_info(x_api_version, client_only, clio_connect_only, created_since, custom_field_ids, custom_field_values, email_only, exclude_ids, fields, ids, initial, limit, order, page_token, query, shared_resource_id, type, updated_since, **kwargs)  # noqa: E501

    @validate_arguments
    def contact_index_with_http_info(self, x_api_version : Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None, client_only : Annotated[Optional[StrictBool], Field(description="Filter Contact records to those that are clients.")] = None, clio_connect_only : Annotated[Optional[StrictBool], Field(description="Filter Contact records to those that are Clio Connect users.")] = None, created_since : Annotated[Optional[datetime], Field(description="Filter Contact records to those having the `created_at` field after a specific time. (Expects an ISO-8601 timestamp).")] = None, custom_field_ids : Annotated[Optional[StrictInt], Field(description="Filter Contact's custom_field_values to only include values for the given custom field unique identifiers.")] = None, custom_field_values : Annotated[Optional[StrictStr], Field(description="Filter records to only those with the given custom field(s) set. The value is compared using the operator provided, or, if the value type only supports one operator, the supported operator is used. In the latter case, no check for operator is performed on the input string. The key for the custom field value filter is the custom_field.id. e.g. `custom_field_values[12345]` If an operator is used for a type that does not support it, an `400 Bad Request` is returned.  *Supported operators:* * `checkbox`, `contact`, `matter`, `picklist` : `=`  e.g. `?custom_field_values[1]=42`  * `currency`, `date`, `time`, `numeric` : `=`, `<`, `>`, `<=`, `>=`  e.g. `?custom_field_values[1]=>=105.4`  * `email`, `text_area`, `text_line`, `url` : `=`  e.g. `?custom_field_values[1]=url_encoded`  *Multiple conditions for the same custom field:*  If you want to use more than one operator to filter a custom field, you can do so by passing in an array of values. e.g. `?custom_field_values[1]=[<=50, >=45]` ")] = None, email_only : Annotated[Optional[StrictBool], Field(description="Filter Contact records to those that have email addresses.")] = None, exclude_ids : Annotated[Optional[StrictInt], Field(description="Filter Contact records to those who are not included in the given list of unique identifiers.")] = None, fields : Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None, ids : Annotated[Optional[StrictInt], Field(description="Filter Contact records to those having the specified unique identifiers.")] = None, initial : Annotated[Optional[StrictStr], Field(description="Filter Contact records to those where the last name or company name start with the given initial.")] = None, limit : Annotated[Optional[StrictInt], Field(description="A limit on the number of Contact records to be returned. Limit can range between 1 and 200. Default: `200`.")] = None, order : Annotated[Optional[StrictStr], Field(description="Orders the Contact records by the given field. Default: `id(asc)`.")] = None, page_token : Annotated[Optional[StrictStr], Field(description="A token specifying which page to return.")] = None, query : Annotated[Optional[StrictStr], Field(description="Wildcard search for name, title, email address, address, phone number, web site, instant messenger address, custom fields, related matter name, or company name matching a given string. ")] = None, shared_resource_id : Annotated[Optional[StrictInt], Field(description="Filter Contact records to those that currently have access to a given shared resource.")] = None, type : Annotated[Optional[StrictStr], Field(description="Filter Contact records to those that match the given type.")] = None, updated_since : Annotated[Optional[datetime], Field(description="Filter Contact records to those having the `updated_at` field after a specific time. (Expects an ISO-8601 timestamp).")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Return the data for all Contacts  # noqa: E501
        ...
        >>> thread = api.contact_index_with_http_info(x_api_version, client_only, clio_connect_only, created_since, custom_field_ids, custom_field_values, email_only, exclude_ids, fields, ids, initial, limit, order, page_token, query, shared_resource_id, type, updated_since, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(ContactList, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        # process the query parameters
        _query_params = []
        if _params.get('client_only') is not None:  # noqa: E501
            _query_params.append(('client_only', _params['client_only']))

        if _params.get('clio_connect_only') is not None:  # noqa: E501
            _query_params.append(('clio_connect_only', _params['clio_connect_only']))
        ...
        if _params.get('email_only') is not None:  # noqa: E501
            _query_params.append(('email_only', _params['email_only']))

        if _params.get('exclude_ids') is not None:  # noqa: E501
            _query_params.append(('exclude_ids[]', _params['exclude_ids']))
        ...
        if _params.get('initial') is not None:  # noqa: E501
            _query_params.append(('initial', _params['initial']))
        ...
        if _params.get('shared_resource_id') is not None:  # noqa: E501
            _query_params.append(('shared_resource_id', _params['shared_resource_id']))
    ...
    def contact_show(self, id : Annotated[StrictInt, Field(..., description="The unique identifier for the Contact.")], if_modified_since : Annotated[Optional[date], Field(description="The server will send the requested resource with a 200 status, but only if it has been modified after the given date. (Expects an RFC 2822 timestamp).")] = None, if_none_match : Annotated[Optional[StrictStr], Field(description="The server will send the requested resource with a 200 status, but only if the existing resource's [ETag](#section/ETags) doesn't match any of the values listed.")] = None, x_api_version : Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None, custom_field_ids : Annotated[Optional[StrictInt], Field(description="Filter Contact's custom_field_values to only include values for the given custom field unique identifiers.")] = None, fields : Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None, **kwargs) -> ContactShow:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the contact_show_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.contact_show_with_http_info(id, if_modified_since, if_none_match, x_api_version, custom_field_ids, fields, **kwargs)  # noqa: E501

    @validate_arguments
    def contact_show_with_http_info(self, id : Annotated[StrictInt, Field(..., description="The unique identifier for the Contact.")], if_modified_since : Annotated[Optional[date], Field(description="The server will send the requested resource with a 200 status, but only if it has been modified after the given date. (Expects an RFC 2822 timestamp).")] = None, if_none_match : Annotated[Optional[StrictStr], Field(description="The server will send the requested resource with a 200 status, but only if the existing resource's [ETag](#section/ETags) doesn't match any of the values listed.")] = None, x_api_version : Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None, custom_field_ids : Annotated[Optional[StrictInt], Field(description="Filter Contact's custom_field_values to only include values for the given custom field unique identifiers.")] = None, fields : Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Return the data for a single Contact  # noqa: E501
        ...
        >>> thread = api.contact_show_with_http_info(id, if_modified_since, if_none_match, x_api_version, custom_field_ids, fields, async_req=True)
        >>> result = thread.get()
    ...
    @validate_arguments
    def contact_update(self, id : Annotated[StrictInt, Field(..., description="The unique identifier for the Contact.")], if_match : Annotated[Optional[StrictStr], Field(description="The server will update the requested resource and send back a 200 status, but only if value in the header matches the existing resource's [ETag](#section/ETags).")] = None, x_api_version : Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None, custom_field_ids : Annotated[Optional[StrictInt], Field(description="Filter Contact's custom_field_values to only include values for the given custom field unique identifiers.")] = None, fields : Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None, contact_update_request : Annotated[Optional[ContactUpdateRequest], Field(description="Request Body for Contacts")] = None, **kwargs) -> ContactShow:  # noqa: E501
        """Update a single Contact  # noqa: E501

        Outlines the parameters and data fields used when updating a single Contact  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.contact_update(id, if_match, x_api_version, custom_field_ids, fields, contact_update_request, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the contact_update_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.contact_update_with_http_info(id, if_match, x_api_version, custom_field_ids, fields, contact_update_request, **kwargs)  # noqa: E501

    @validate_arguments
    def contact_update_with_http_info(self, id : Annotated[StrictInt, Field(..., description="The unique identifier for the Contact.")], if_match : Annotated[Optional[StrictStr], Field(description="The server will update the requested resource and send back a 200 status, but only if value in the header matches the existing resource's [ETag](#section/ETags).")] = None, x_api_version : Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None, custom_field_ids : Annotated[Optional[StrictInt], Field(description="Filter Contact's custom_field_values to only include values for the given custom field unique identifiers.")] = None, fields : Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None, contact_update_request : Annotated[Optional[ContactUpdateRequest], Field(description="Request Body for Contacts")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Update a single Contact  # noqa: E501
        ...
        >>> thread = api.contact_update_with_http_info(id, if_match, x_api_version, custom_field_ids, fields, contact_update_request, async_req=True)
        >>> result = thread.get()
        ...
        # process the body parameter
        _body_params = None
        if _params['contact_update_request'] is not None:
            _body_params = _params['contact_update_request']
