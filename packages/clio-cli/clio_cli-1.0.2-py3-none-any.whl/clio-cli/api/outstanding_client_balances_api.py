...
class OutstandingClientBalancesApi:
    ...
    @validate_arguments
    def outstanding_client_balance_index(self, x_api_version : Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None, contact_id : Annotated[Optional[StrictInt], Field(description="The unique identifier for a single Contact. Use the keyword `null` to match those without a OutstandingClientBalance. The list will be filtered to include only the OutstandingClientBalance records with the matching property.")] = None, fields : Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None, last_paid_end_date : Annotated[Optional[date], Field(description="Filter OutstandingClientBalance records for those whose bills have been paid before the specified date")] = None, last_paid_start_date : Annotated[Optional[date], Field(description="Filter OutstandingClientBalance records for those whose bills have been paid after the specified date")] = None, limit : Annotated[Optional[StrictInt], Field(description="A limit on the number of OutstandingClientBalance records to be returned. Limit can range between 1 and 200. Default: `200`.")] = None, newest_bill_due_end_date : Annotated[Optional[date], Field(description="Filter OutstandingClientBalance records for the contact's newest bill due date before the specified date")] = None, newest_bill_due_start_date : Annotated[Optional[date], Field(description="Filter OutstandingClientBalance records for the contact's newest bill due date after the specified date")] = None, originating_attorney_id : Annotated[Optional[StrictInt], Field(description="Filters OutstandingClientBalance records to those with matters that have a matching originating attorney.")] = None, page_token : Annotated[Optional[StrictStr], Field(description="A token specifying which page to return.")] = None, responsible_attorney_id : Annotated[Optional[StrictInt], Field(description="Filter OutstandingClientBalance records to those with matters that have a matching responsible attorney")] = None, **kwargs) -> OutstandingClientBalanceList:  # noqa: E501
        """Return the data for all OutstandingClientBalances  # noqa: E501

        Outlines the parameters, optional and required, used when requesting the data for all OutstandingClientBalances  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.outstanding_client_balance_index(x_api_version, contact_id, fields, last_paid_end_date, last_paid_start_date, limit, newest_bill_due_end_date, newest_bill_due_start_date, originating_attorney_id, page_token, responsible_attorney_id, async_req=True)
        >>> result = thread.get()
        ...
        :type last_paid_start_date: date
        ...
        :type newest_bill_due_end_date: date
        ...
        :type newest_bill_due_start_date: date
        ...
        :rtype: OutstandingClientBalanceList
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the outstanding_client_balance_index_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.outstanding_client_balance_index_with_http_info(x_api_version, contact_id, fields, last_paid_end_date, last_paid_start_date, limit, newest_bill_due_end_date, newest_bill_due_start_date, originating_attorney_id, page_token, responsible_attorney_id, **kwargs)  # noqa: E501

    @validate_arguments
    def outstanding_client_balance_index_with_http_info(self, x_api_version : Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None, contact_id : Annotated[Optional[StrictInt], Field(description="The unique identifier for a single Contact. Use the keyword `null` to match those without a OutstandingClientBalance. The list will be filtered to include only the OutstandingClientBalance records with the matching property.")] = None, fields : Annotated[Optional[StrictStr], Field(description="The fields to be returned. See response samples for what fields are available. For more information see the [fields section](#section/Fields).")] = None, last_paid_end_date : Annotated[Optional[date], Field(description="Filter OutstandingClientBalance records for those whose bills have been paid before the specified date")] = None, last_paid_start_date : Annotated[Optional[date], Field(description="Filter OutstandingClientBalance records for those whose bills have been paid after the specified date")] = None, limit : Annotated[Optional[StrictInt], Field(description="A limit on the number of OutstandingClientBalance records to be returned. Limit can range between 1 and 200. Default: `200`.")] = None, newest_bill_due_end_date : Annotated[Optional[date], Field(description="Filter OutstandingClientBalance records for the contact's newest bill due date before the specified date")] = None, newest_bill_due_start_date : Annotated[Optional[date], Field(description="Filter OutstandingClientBalance records for the contact's newest bill due date after the specified date")] = None, originating_attorney_id : Annotated[Optional[StrictInt], Field(description="Filters OutstandingClientBalance records to those with matters that have a matching originating attorney.")] = None, page_token : Annotated[Optional[StrictStr], Field(description="A token specifying which page to return.")] = None, responsible_attorney_id : Annotated[Optional[StrictInt], Field(description="Filter OutstandingClientBalance records to those with matters that have a matching responsible attorney")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Return the data for all OutstandingClientBalances  # noqa: E501
        ...
        >>> thread = api.outstanding_client_balance_index_with_http_info(x_api_version, contact_id, fields, last_paid_end_date, last_paid_start_date, limit, newest_bill_due_end_date, newest_bill_due_start_date, originating_attorney_id, page_token, responsible_attorney_id, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(OutstandingClientBalanceList, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method outstanding_client_balance_index" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        if _params.get('last_paid_end_date') is not None:  # noqa: E501
            if isinstance(_params['last_paid_end_date'], date):
                _query_params.append(('last_paid_end_date', _params['last_paid_end_date'].strftime(self.api_client.configuration.date_format)))
            else:
                _query_params.append(('last_paid_end_date', _params['last_paid_end_date']))

        if _params.get('last_paid_start_date') is not None:  # noqa: E501
            if isinstance(_params['last_paid_start_date'], date):
                _query_params.append(('last_paid_start_date', _params['last_paid_start_date'].strftime(self.api_client.configuration.date_format)))
            else:
                _query_params.append(('last_paid_start_date', _params['last_paid_start_date']))

        if _params.get('limit') is not None:  # noqa: E501
            _query_params.append(('limit', _params['limit']))

        if _params.get('newest_bill_due_end_date') is not None:  # noqa: E501
            if isinstance(_params['newest_bill_due_end_date'], date):
                _query_params.append(('newest_bill_due_end_date', _params['newest_bill_due_end_date'].strftime(self.api_client.configuration.date_format)))
            else:
                _query_params.append(('newest_bill_due_end_date', _params['newest_bill_due_end_date']))

        if _params.get('newest_bill_due_start_date') is not None:  # noqa: E501
            if isinstance(_params['newest_bill_due_start_date'], date):
                _query_params.append(('newest_bill_due_start_date', _params['newest_bill_due_start_date'].strftime(self.api_client.configuration.date_format)))
            else:
                _query_params.append(('newest_bill_due_start_date', _params['newest_bill_due_start_date']))
        ...
        _response_types_map = {
            '200': "OutstandingClientBalanceList",
            '400': "Error",
            '401': "Error",
            '403': "Error",
            '429': "Error",
        ...
        return self.api_client.call_api(
            '/outstanding_client_balances.json', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
