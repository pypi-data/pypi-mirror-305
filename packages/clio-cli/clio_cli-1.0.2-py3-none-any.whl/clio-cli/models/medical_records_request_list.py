...
class MedicalRecordsRequestList(BaseModel):
    ...
    """
    data: conlist(MedicalRecordsRequest) = Field(default=..., description="MedicalRecordsRequest List Response")
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MedicalRecordsRequestList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MedicalRecordsRequestList:
        """Create an instance of MedicalRecordsRequestList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MedicalRecordsRequestList.parse_obj(obj)

        _obj = MedicalRecordsRequestList.parse_obj({
            "data": [MedicalRecordsRequest.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
