...
class MedicalRecordsRequestCreateRequestDataMedicalRecordsInner(BaseModel):
    """
    MedicalRecordsRequestCreateRequestDataMedicalRecordsInner
    """
    document_id: StrictInt = Field(default=..., description="The unique identifier for a single MedicalRecord associated with the MedicalRecordsRequest. The keyword `null` is not valid for this field.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MedicalRecordsRequestCreateRequestDataMedicalRecordsInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MedicalRecordsRequestCreateRequestDataMedicalRecordsInner:
        """Create an instance of MedicalRecordsRequestCreateRequestDataMedicalRecordsInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MedicalRecordsRequestCreateRequestDataMedicalRecordsInner.parse_obj(obj)

        _obj = MedicalRecordsRequestCreateRequestDataMedicalRecordsInner.parse_obj({
