...
class RelatedContactsBase(BaseModel):
    ...
    __properties = ["id", "contact_id", "name", "first_name", "middle_name", "last_name", "type", "created_at", "updated_at", "prefix", "title", "initials", "is_matter_client", "primary_email_address", "primary_phone_number", "client_connect_user_id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RelatedContactsBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RelatedContactsBase:
        """Create an instance of RelatedContactsBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RelatedContactsBase.parse_obj(obj)

        _obj = RelatedContactsBase.parse_obj({
            "id": obj.get("id"),
