...
class MatterContactsList(BaseModel):
    ...
    MatterContactsList
    """
    data: conlist(MatterContacts) = Field(default=..., description="MatterContacts List Response")
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MatterContactsList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MatterContactsList:
        """Create an instance of MatterContactsList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MatterContactsList.parse_obj(obj)

        _obj = MatterContactsList.parse_obj({
            "data": [MatterContacts.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
