...
class LineItemList(BaseModel):
    ...
    LineItemList
    """
    data: conlist(LineItem) = Field(default=..., description="LineItem List Response")
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LineItemList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LineItemList:
        """Create an instance of LineItemList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LineItemList.parse_obj(obj)

        _obj = LineItemList.parse_obj({
            "data": [LineItem.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
