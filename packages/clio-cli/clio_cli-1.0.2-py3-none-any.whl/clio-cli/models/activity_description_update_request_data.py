...
class ActivityDescriptionUpdateRequestData(BaseModel):
    ...
    groups: Optional[conlist(ActivityDescriptionUpdateRequestDataGroupsInner)] = None
    name: Optional[StrictStr] = Field(default=None, description="A detailed description of the ActivityDescription.")
    ...
    __properties = ["default", "groups", "name", "rate", "visible_to_co_counsel"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ActivityDescriptionUpdateRequestData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ActivityDescriptionUpdateRequestData:
        """Create an instance of ActivityDescriptionUpdateRequestData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ActivityDescriptionUpdateRequestData.parse_obj(obj)

        _obj = ActivityDescriptionUpdateRequestData.parse_obj({
            "default": obj.get("default"),
            "groups": [ActivityDescriptionUpdateRequestDataGroupsInner.from_dict(_item) for _item in obj.get("groups")] if obj.get("groups") is not None else None,
            "name": obj.get("name"),
            "rate": ActivityDescriptionCreateRequestDataRate.from_dict(obj.get("rate")) if obj.get("rate") is not None else None,
