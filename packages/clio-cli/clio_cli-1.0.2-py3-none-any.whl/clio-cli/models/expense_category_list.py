...
class ExpenseCategoryList(BaseModel):
    ...
    ExpenseCategoryList
    """
    data: conlist(ExpenseCategory) = Field(default=..., description="ExpenseCategory List Response")
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ExpenseCategoryList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ExpenseCategoryList:
        """Create an instance of ExpenseCategoryList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ExpenseCategoryList.parse_obj(obj)

        _obj = ExpenseCategoryList.parse_obj({
            "data": [ExpenseCategory.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
