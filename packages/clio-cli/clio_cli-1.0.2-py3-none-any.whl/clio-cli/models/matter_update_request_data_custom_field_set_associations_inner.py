...
class MatterUpdateRequestDataCustomFieldSetAssociationsInner(BaseModel):
    """
    MatterUpdateRequestDataCustomFieldSetAssociationsInner
    """
    id: Optional[StrictInt] = Field(default=None, description="The unique identifier for a single CustomFieldSetAssociation associated with the Matter. The keyword `null` is not valid for this field.")
    display_order: Optional[StrictInt] = Field(default=None, description="The order to display the CustomFieldSet in a Matter. If not specified, it is added as the last CustomFieldSet of the Matter.")
    custom_field_set: Optional[ContactUpdateRequestDataCustomFieldSetAssociationsInnerCustomFieldSet] = None
    destroy: Optional[StrictBool] = Field(default=None, alias="_destroy", description="The destroy flag. If the flag is set to `true` and the unique identifier of the associated CustomFieldSetAssociation is present, the CustomFieldSetAssociation is deleted from the Matter.")
    __properties = ["id", "display_order", "custom_field_set", "_destroy"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MatterUpdateRequestDataCustomFieldSetAssociationsInner:
    ...
    def to_dict(self):
        ...
        _dict = self.dict(by_alias=True,
                          ...
                          exclude_none=True)
        # override the default output from pydantic by calling `to_dict()` of custom_field_set
        if self.custom_field_set:
            _dict['custom_field_set'] = self.custom_field_set.to_dict()
        return _dict

    @classmethod
    def from_dict(cls, obj: dict) -> MatterUpdateRequestDataCustomFieldSetAssociationsInner:
        """Create an instance of MatterUpdateRequestDataCustomFieldSetAssociationsInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MatterUpdateRequestDataCustomFieldSetAssociationsInner.parse_obj(obj)

        _obj = MatterUpdateRequestDataCustomFieldSetAssociationsInner.parse_obj({
            "id": obj.get("id"),
            "display_order": obj.get("display_order"),
            "custom_field_set": ContactUpdateRequestDataCustomFieldSetAssociationsInnerCustomFieldSet.from_dict(obj.get("custom_field_set")) if obj.get("custom_field_set") is not None else None,
