...
class TaskCreateRequest(BaseModel):
    ...
    TaskCreateRequest
    """
    data: TaskCreateRequestData = Field(...)
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TaskCreateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TaskCreateRequest:
        """Create an instance of TaskCreateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TaskCreateRequest.parse_obj(obj)

        _obj = TaskCreateRequest.parse_obj({
            "data": TaskCreateRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
