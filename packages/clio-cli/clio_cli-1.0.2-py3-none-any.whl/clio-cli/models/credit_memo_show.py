...
class CreditMemoShow(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreditMemoShow:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreditMemoShow:
        """Create an instance of CreditMemoShow from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreditMemoShow.parse_obj(obj)

        _obj = CreditMemoShow.parse_obj({
            "data": CreditMemo.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
