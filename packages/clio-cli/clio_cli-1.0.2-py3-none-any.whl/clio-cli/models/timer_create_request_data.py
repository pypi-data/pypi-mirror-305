...
class TimerCreateRequestData(BaseModel):
    """
    TimerCreateRequestData
    """
    activity: TimerCreateRequestDataActivity = Field(...)
    __properties = ["activity"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TimerCreateRequestData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TimerCreateRequestData:
        """Create an instance of TimerCreateRequestData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TimerCreateRequestData.parse_obj(obj)

        _obj = TimerCreateRequestData.parse_obj({
            "activity": TimerCreateRequestDataActivity.from_dict(obj.get("activity")) if obj.get("activity") is not None else None
        })
        return _obj
