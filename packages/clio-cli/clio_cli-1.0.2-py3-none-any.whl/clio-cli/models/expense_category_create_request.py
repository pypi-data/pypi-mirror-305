...
class ExpenseCategoryCreateRequest(BaseModel):
    ...
    """
    data: ExpenseCategoryCreateRequestData = Field(...)
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ExpenseCategoryCreateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ExpenseCategoryCreateRequest:
        """Create an instance of ExpenseCategoryCreateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ExpenseCategoryCreateRequest.parse_obj(obj)

        _obj = ExpenseCategoryCreateRequest.parse_obj({
            "data": ExpenseCategoryCreateRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
