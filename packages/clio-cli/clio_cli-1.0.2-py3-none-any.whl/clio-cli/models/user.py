...
class User(BaseModel):
    ...
    roles: Optional[conlist(StrictStr)] = Field(default=None, description="An array of roles assigned to this *User*")
    ...
    def subscription_type_validate_enum(cls, value):
        ...
        if value not in ('Attorney', 'NonAttorney'):
    ...
    def from_dict(cls, obj: dict) -> User:
        ...
        _obj = User.parse_obj({
            ...
            "default_activity_description": ActivityDescriptionBase.from_dict(obj.get("default_activity_description")) if obj.get("default_activity_description") is not None else None,
            ...
            "account": AccountBase.from_dict(obj.get("account")) if obj.get("account") is not None else None,
            ...
            "job_title": JobTitleBase.from_dict(obj.get("job_title")) if obj.get("job_title") is not None else None,
