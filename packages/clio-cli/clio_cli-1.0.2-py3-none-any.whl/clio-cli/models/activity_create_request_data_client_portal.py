...
class ActivityCreateRequestDataClientPortal(BaseModel):
    """
    ActivityCreateRequestDataClientPortal
    """
    id: Optional[StrictInt] = Field(default=None, description="The unique identifier for a single ClientPortal associated with the Activity. The keyword `null` is not valid for this field.")
    __properties = ["id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ActivityCreateRequestDataClientPortal:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ActivityCreateRequestDataClientPortal:
        """Create an instance of ActivityCreateRequestDataClientPortal from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ActivityCreateRequestDataClientPortal.parse_obj(obj)

        _obj = ActivityCreateRequestDataClientPortal.parse_obj({
            "id": obj.get("id")
        })
        return _obj
