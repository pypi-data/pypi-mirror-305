...
class ClioPaymentsPaymentShow(BaseModel):
    ...
    """
    data: ClioPaymentsPayment = Field(...)
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ClioPaymentsPaymentShow:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ClioPaymentsPaymentShow:
        """Create an instance of ClioPaymentsPaymentShow from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ClioPaymentsPaymentShow.parse_obj(obj)

        _obj = ClioPaymentsPaymentShow.parse_obj({
            "data": ClioPaymentsPayment.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
