...
class TaskTemplateListUpdateRequestData(BaseModel):
    """
    TaskTemplateListUpdateRequestData
    """
    description: Optional[StrictStr] = Field(default=None, description="Description of the TaskTemplateList.")
    name: Optional[StrictStr] = Field(default=None, description="Name of the TaskTemplateList.")
    practice_area: Optional[TaskTemplateListCreateRequestDataPracticeArea] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TaskTemplateListUpdateRequestData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TaskTemplateListUpdateRequestData:
        """Create an instance of TaskTemplateListUpdateRequestData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TaskTemplateListUpdateRequestData.parse_obj(obj)

        _obj = TaskTemplateListUpdateRequestData.parse_obj({
            "description": obj.get("description"),
            "name": obj.get("name"),
            "practice_area": TaskTemplateListCreateRequestDataPracticeArea.from_dict(obj.get("practice_area")) if obj.get("practice_area") is not None else None
        })
        return _obj
