...
class CalendarEntryCreateRequestDataMatter(BaseModel):
    """
    CalendarEntryCreateRequestDataMatter
    """
    id: Optional[StrictInt] = Field(default=None, description="The unique identifier for a single Matter associated with the CalendarEntry. Use the keyword `null` to specify no association.")
    __properties = ["id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CalendarEntryCreateRequestDataMatter:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CalendarEntryCreateRequestDataMatter:
        """Create an instance of CalendarEntryCreateRequestDataMatter from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CalendarEntryCreateRequestDataMatter.parse_obj(obj)

        _obj = CalendarEntryCreateRequestDataMatter.parse_obj({
            "id": obj.get("id")
        })
        return _obj
