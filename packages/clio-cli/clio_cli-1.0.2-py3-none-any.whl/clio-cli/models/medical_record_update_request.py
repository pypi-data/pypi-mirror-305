...
class MedicalRecordUpdateRequest(BaseModel):
    ...
    """
    data: MedicalRecordUpdateRequestData = Field(...)
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MedicalRecordUpdateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MedicalRecordUpdateRequest:
        """Create an instance of MedicalRecordUpdateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MedicalRecordUpdateRequest.parse_obj(obj)

        _obj = MedicalRecordUpdateRequest.parse_obj({
            "data": MedicalRecordUpdateRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
