...
class MatterDocketList(BaseModel):
    ...
    MatterDocketList
    """
    data: conlist(MatterDocket) = Field(default=..., description="MatterDocket List Response")
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MatterDocketList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MatterDocketList:
        """Create an instance of MatterDocketList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MatterDocketList.parse_obj(obj)

        _obj = MatterDocketList.parse_obj({
            "data": [MatterDocket.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
