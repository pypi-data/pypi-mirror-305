...
class MedicalRecordsRequestCreateRequest(BaseModel):
    """
    MedicalRecordsRequestCreateRequest
    """
    data: MedicalRecordsRequestCreateRequestData = Field(...)
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MedicalRecordsRequestCreateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MedicalRecordsRequestCreateRequest:
        """Create an instance of MedicalRecordsRequestCreateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MedicalRecordsRequestCreateRequest.parse_obj(obj)

        _obj = MedicalRecordsRequestCreateRequest.parse_obj({
            "data": MedicalRecordsRequestCreateRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
