...
class PolymorphicObjectBase(BaseModel):
    ...
    """
    id: Optional[StrictInt] = Field(default=None, description="Unique identifier for the *PolymorphicObject*")
    type: Optional[StrictStr] = Field(default=None, description="The type of the *PolymorphicObject*")
    identifier: Optional[StrictStr] = Field(default=None, description="A string to identify the *PolymorphicObject*")
    secondary_identifier: Optional[StrictStr] = Field(default=None, description="A secondary string to identify the *PolymorphicObject*")
    tertiary_identifier: Optional[StrictStr] = Field(default=None, description="A tertiary string to identify the *PolymorphicObject*")
    __properties = ["id", "type", "identifier", "secondary_identifier", "tertiary_identifier"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in ('Task', 'CalendarEntry', 'MatterNote', 'ContactNote', 'Matter', 'Contact', 'User', 'CreditMemo', 'Payment'):
            raise ValueError("must be one of enum values ('Task', 'CalendarEntry', 'MatterNote', 'ContactNote', 'Matter', 'Contact', 'User', 'CreditMemo', 'Payment')")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PolymorphicObjectBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PolymorphicObjectBase:
        """Create an instance of PolymorphicObjectBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PolymorphicObjectBase.parse_obj(obj)

        _obj = PolymorphicObjectBase.parse_obj({
            "id": obj.get("id"),
            "type": obj.get("type"),
            "identifier": obj.get("identifier"),
            "secondary_identifier": obj.get("secondary_identifier"),
            "tertiary_identifier": obj.get("tertiary_identifier")
        })
        return _obj
