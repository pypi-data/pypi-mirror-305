...
class MatterShow(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MatterShow:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MatterShow:
        """Create an instance of MatterShow from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MatterShow.parse_obj(obj)

        _obj = MatterShow.parse_obj({
            "data": Matter.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
