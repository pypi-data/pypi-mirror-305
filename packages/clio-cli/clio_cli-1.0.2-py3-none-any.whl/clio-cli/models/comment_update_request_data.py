...
class CommentUpdateRequestData(BaseModel):
    ...
    """
    item: Optional[CommentUpdateRequestDataItem] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CommentUpdateRequestData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CommentUpdateRequestData:
        """Create an instance of CommentUpdateRequestData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CommentUpdateRequestData.parse_obj(obj)

        _obj = CommentUpdateRequestData.parse_obj({
            "item": CommentUpdateRequestDataItem.from_dict(obj.get("item")) if obj.get("item") is not None else None,
