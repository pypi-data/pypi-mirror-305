...
class MatterCreateRequest(BaseModel):
    ...
    MatterCreateRequest
    """
    data: MatterCreateRequestData = Field(...)
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MatterCreateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MatterCreateRequest:
        """Create an instance of MatterCreateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MatterCreateRequest.parse_obj(obj)

        _obj = MatterCreateRequest.parse_obj({
            "data": MatterCreateRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
