...
class MedicalBillUpdateRequest(BaseModel):
    ...
    """
    data: MedicalBillUpdateRequestData = Field(...)
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MedicalBillUpdateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MedicalBillUpdateRequest:
        """Create an instance of MedicalBillUpdateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MedicalBillUpdateRequest.parse_obj(obj)

        _obj = MedicalBillUpdateRequest.parse_obj({
            "data": MedicalBillUpdateRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
