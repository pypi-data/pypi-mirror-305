...
class ActivityList(BaseModel):
    ...
    ActivityList
    """
    data: conlist(Activity) = Field(default=..., description="Activity List Response")
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ActivityList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ActivityList:
        """Create an instance of ActivityList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ActivityList.parse_obj(obj)

        _obj = ActivityList.parse_obj({
            "data": [Activity.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
