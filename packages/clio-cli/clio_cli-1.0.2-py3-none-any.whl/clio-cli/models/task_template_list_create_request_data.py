...
class TaskTemplateListCreateRequestData(BaseModel):
    """
    TaskTemplateListCreateRequestData
    """
    description: StrictStr = Field(default=..., description="Description of the TaskTemplateList.")
    name: StrictStr = Field(default=..., description="Name of the TaskTemplateList.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TaskTemplateListCreateRequestData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TaskTemplateListCreateRequestData:
        """Create an instance of TaskTemplateListCreateRequestData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TaskTemplateListCreateRequestData.parse_obj(obj)

        _obj = TaskTemplateListCreateRequestData.parse_obj({
