...
class CommunicationCreateRequestDataReceiversInner(BaseModel):
    """
    CommunicationCreateRequestDataReceiversInner
    """
    deleted: Optional[StrictBool] = Field(default=None, alias="_deleted", description="Whether or not the receivers should be deleted.")
    id: Optional[StrictInt] = Field(default=None, description="Unique ids for the receivers of this Communication.")
    type: Optional[StrictStr] = Field(default=None, description="Types of the receivers of this Communication.")
    __properties = ["_deleted", "id", "type"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in ('User', 'Contact'):
            raise ValueError("must be one of enum values ('User', 'Contact')")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CommunicationCreateRequestDataReceiversInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CommunicationCreateRequestDataReceiversInner:
        """Create an instance of CommunicationCreateRequestDataReceiversInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CommunicationCreateRequestDataReceiversInner.parse_obj(obj)

        _obj = CommunicationCreateRequestDataReceiversInner.parse_obj({
