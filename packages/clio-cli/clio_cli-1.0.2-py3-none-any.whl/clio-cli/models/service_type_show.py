...
class ServiceTypeShow(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ServiceTypeShow:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ServiceTypeShow:
        """Create an instance of ServiceTypeShow from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ServiceTypeShow.parse_obj(obj)

        _obj = ServiceTypeShow.parse_obj({
            "data": ServiceType.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
