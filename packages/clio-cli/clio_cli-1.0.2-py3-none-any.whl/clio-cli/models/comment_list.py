...
class CommentList(BaseModel):
    ...
    CommentList
    """
    data: conlist(Comment) = Field(default=..., description="Comment List Response")
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CommentList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CommentList:
        """Create an instance of CommentList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CommentList.parse_obj(obj)

        _obj = CommentList.parse_obj({
            "data": [Comment.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
