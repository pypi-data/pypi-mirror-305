...
class AllocationShow(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AllocationShow:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AllocationShow:
        """Create an instance of AllocationShow from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AllocationShow.parse_obj(obj)

        _obj = AllocationShow.parse_obj({
            "data": Allocation.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
