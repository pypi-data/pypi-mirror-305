...
class TrustRequestCreateRequest(BaseModel):
    """
    TrustRequestCreateRequest
    """
    data: TrustRequestCreateRequestData = Field(...)
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TrustRequestCreateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TrustRequestCreateRequest:
        """Create an instance of TrustRequestCreateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TrustRequestCreateRequest.parse_obj(obj)

        _obj = TrustRequestCreateRequest.parse_obj({
            "data": TrustRequestCreateRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
