...
class LaukExpenseCategoryList(BaseModel):
    ...
    """
    data: conlist(LaukExpenseCategory) = Field(default=..., description="LaukExpenseCategory List Response")
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LaukExpenseCategoryList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LaukExpenseCategoryList:
        """Create an instance of LaukExpenseCategoryList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LaukExpenseCategoryList.parse_obj(obj)

        _obj = LaukExpenseCategoryList.parse_obj({
            "data": [LaukExpenseCategory.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
