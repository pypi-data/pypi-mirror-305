...
class CreditMemo(BaseModel):
    ...
    var_date: Optional[date] = Field(default=None, alias="date", description="Date the *CreditMemo* was recorded (as a ISO-8601 date)")
    ...
    __properties = ["id", "etag", "date", "amount", "description", "discount", "voided_at", "created_at", "updated_at", "user", "contact", "allocations"]
