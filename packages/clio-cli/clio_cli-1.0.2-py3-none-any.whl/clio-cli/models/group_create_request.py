...
class GroupCreateRequest(BaseModel):
    ...
    GroupCreateRequest
    """
    data: GroupCreateRequestData = Field(...)
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GroupCreateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GroupCreateRequest:
        """Create an instance of GroupCreateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GroupCreateRequest.parse_obj(obj)

        _obj = GroupCreateRequest.parse_obj({
            "data": GroupCreateRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
