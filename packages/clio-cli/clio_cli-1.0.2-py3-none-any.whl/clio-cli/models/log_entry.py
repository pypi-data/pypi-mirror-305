...
class LogEntry(BaseModel):
    ...
    LogEntry
    """
    id: Optional[StrictInt] = Field(default=None, description="Unique identifier for the *LogEntry*")
    etag: Optional[StrictStr] = Field(default=None, description="ETag for the *LogEntry*")
    type: Optional[StrictStr] = Field(default=None, description="The type of the *LogEntry*")
    accessed_at: Optional[datetime] = Field(default=None, description="The time the item was last accessed (as a ISO-8601 timestamp)")
    created_at: Optional[datetime] = Field(default=None, description="The time the *LogEntry* was created (as a ISO-8601 timestamp)")
    updated_at: Optional[datetime] = Field(default=None, description="The time the *LogEntry* was last updated (as a ISO-8601 timestamp)")
    item: Optional[PolymorphicObjectBase] = None
    user: Optional[UserBase] = None
    __properties = ["id", "etag", "type", "accessed_at", "created_at", "updated_at", "item", "user"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in ('MatterLogEntry', 'ContactLogEntry'):
            raise ValueError("must be one of enum values ('MatterLogEntry', 'ContactLogEntry')")
        return value
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LogEntry:
        """Create an instance of LogEntry from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LogEntry.parse_obj(obj)

        _obj = LogEntry.parse_obj({
            "id": obj.get("id"),
            "etag": obj.get("etag"),
            "type": obj.get("type"),
            ...
            "item": PolymorphicObjectBase.from_dict(obj.get("item")) if obj.get("item") is not None else None,
