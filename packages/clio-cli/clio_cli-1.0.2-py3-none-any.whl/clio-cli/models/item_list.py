...
class ItemList(BaseModel):
    ...
    ItemList
    """
    data: conlist(Item) = Field(default=..., description="Item List Response")
    __properties = ["data"]
    ...
    def from_dict(cls, obj: dict) -> ItemList:
        ...
        _obj = ItemList.parse_obj({
            "data": [Item.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
