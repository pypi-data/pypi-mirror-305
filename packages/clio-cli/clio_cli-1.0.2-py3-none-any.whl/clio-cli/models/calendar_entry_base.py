...
class CalendarEntryBase(BaseModel):
    ...
    __properties = ["id", "etag", "summary", "description", "location", "start_at", "end_at", "all_day", "recurrence_rule", "parent_calendar_entry_id", "court_rule", "created_at", "updated_at", "permission", "calendar_owner_id", "start_at_time_zone", "time_entries_count"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CalendarEntryBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CalendarEntryBase:
        """Create an instance of CalendarEntryBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CalendarEntryBase.parse_obj(obj)

        _obj = CalendarEntryBase.parse_obj({
            "id": obj.get("id"),
            "etag": obj.get("etag"),
