...
class TaskTemplateListShow(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TaskTemplateListShow:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TaskTemplateListShow:
        """Create an instance of TaskTemplateListShow from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TaskTemplateListShow.parse_obj(obj)

        _obj = TaskTemplateListShow.parse_obj({
            "data": TaskTemplateList.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
