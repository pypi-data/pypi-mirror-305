...
class DocumentTemplateShow(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DocumentTemplateShow:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DocumentTemplateShow:
        """Create an instance of DocumentTemplateShow from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DocumentTemplateShow.parse_obj(obj)

        _obj = DocumentTemplateShow.parse_obj({
            "data": DocumentTemplate.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
