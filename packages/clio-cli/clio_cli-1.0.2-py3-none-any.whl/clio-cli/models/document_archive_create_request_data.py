...
class DocumentArchiveCreateRequestData(BaseModel):
    """
    DocumentArchiveCreateRequestData
    """
    items: conlist(DocumentArchiveCreateRequestDataItemsInner) = Field(...)
    __properties = ["items"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DocumentArchiveCreateRequestData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DocumentArchiveCreateRequestData:
        """Create an instance of DocumentArchiveCreateRequestData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DocumentArchiveCreateRequestData.parse_obj(obj)

        _obj = DocumentArchiveCreateRequestData.parse_obj({
            "items": [DocumentArchiveCreateRequestDataItemsInner.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
