...
class CurrencyList(BaseModel):
    ...
    CurrencyList
    """
    data: conlist(Currency) = Field(default=..., description="Currency List Response")
    __properties = ["data"]
    ...
    def from_dict(cls, obj: dict) -> CurrencyList:
        ...
        _obj = CurrencyList.parse_obj({
            "data": [Currency.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
