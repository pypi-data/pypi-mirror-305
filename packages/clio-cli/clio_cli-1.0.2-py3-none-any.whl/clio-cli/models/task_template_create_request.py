...
class TaskTemplateCreateRequest(BaseModel):
    ...
    """
    data: TaskTemplateCreateRequestData = Field(...)
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TaskTemplateCreateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TaskTemplateCreateRequest:
        """Create an instance of TaskTemplateCreateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TaskTemplateCreateRequest.parse_obj(obj)

        _obj = TaskTemplateCreateRequest.parse_obj({
            "data": TaskTemplateCreateRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
