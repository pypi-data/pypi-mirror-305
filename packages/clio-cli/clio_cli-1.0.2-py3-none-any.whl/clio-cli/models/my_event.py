...
class MyEvent(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MyEvent:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MyEvent:
        """Create an instance of MyEvent from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MyEvent.parse_obj(obj)

        _obj = MyEvent.parse_obj({
            "event": EventBase.from_dict(obj.get("event")) if obj.get("event") is not None else None
        })
        return _obj
