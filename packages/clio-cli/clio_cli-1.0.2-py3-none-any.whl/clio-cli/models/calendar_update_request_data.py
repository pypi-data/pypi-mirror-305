...
class CalendarUpdateRequestData(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CalendarUpdateRequestData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CalendarUpdateRequestData:
        """Create an instance of CalendarUpdateRequestData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CalendarUpdateRequestData.parse_obj(obj)

        _obj = CalendarUpdateRequestData.parse_obj({
            "color": obj.get("color"),
            "name": obj.get("name"),
