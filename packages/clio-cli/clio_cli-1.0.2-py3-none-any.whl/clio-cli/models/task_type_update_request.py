...
class TaskTypeUpdateRequest(BaseModel):
    ...
    """
    data: TaskTypeUpdateRequestData = Field(...)
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TaskTypeUpdateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TaskTypeUpdateRequest:
        """Create an instance of TaskTypeUpdateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TaskTypeUpdateRequest.parse_obj(obj)

        _obj = TaskTypeUpdateRequest.parse_obj({
            "data": TaskTypeUpdateRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
