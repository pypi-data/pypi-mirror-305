...
class Task(BaseModel):
    ...
    __properties = ["id", "etag", "name", "status", "description", "priority", "due_at", "permission", "completed_at", "notify_completion", "statute_of_limitations", "time_estimated", "created_at", "updated_at", "time_entries_count", "time_entries", "task_type", "assigner", "matter", "assignee", "reminders"]
    ...
    def from_dict(cls, obj: dict) -> Task:
        ...
        _obj = Task.parse_obj({
            ...
            "assigner": UserBase.from_dict(obj.get("assigner")) if obj.get("assigner") is not None else None,
            "matter": MatterBase.from_dict(obj.get("matter")) if obj.get("matter") is not None else None,
            "assignee": Participant.from_dict(obj.get("assignee")) if obj.get("assignee") is not None else None,
