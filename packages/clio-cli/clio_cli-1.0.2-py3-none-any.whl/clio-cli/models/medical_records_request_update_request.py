...
class MedicalRecordsRequestUpdateRequest(BaseModel):
    """
    MedicalRecordsRequestUpdateRequest
    """
    data: MedicalRecordsRequestUpdateRequestData = Field(...)
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MedicalRecordsRequestUpdateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MedicalRecordsRequestUpdateRequest:
        """Create an instance of MedicalRecordsRequestUpdateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MedicalRecordsRequestUpdateRequest.parse_obj(obj)

        _obj = MedicalRecordsRequestUpdateRequest.parse_obj({
            "data": MedicalRecordsRequestUpdateRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
