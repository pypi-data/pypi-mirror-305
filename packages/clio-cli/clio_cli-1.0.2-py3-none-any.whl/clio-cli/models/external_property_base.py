...
class ExternalPropertyBase(BaseModel):
    ...
    """
    id: Optional[StrictInt] = Field(default=None, description="Unique identifier for the *ExternalProperty*")
    etag: Optional[StrictStr] = Field(default=None, description="ETag for the *ExternalProperty*")
    name: Optional[StrictStr] = Field(default=None, description="The name of the *ExternalProperty*")
    value: Optional[StrictStr] = Field(default=None, description="The value of the *ExternalProperty*")
    created_at: Optional[datetime] = Field(default=None, description="The time the *ExternalProperty* was created (as a ISO-8601 timestamp)")
    updated_at: Optional[datetime] = Field(default=None, description="The time the *ExternalProperty* was last updated (as a ISO-8601 timestamp)")
    __properties = ["id", "etag", "name", "value", "created_at", "updated_at"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ExternalPropertyBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ExternalPropertyBase:
        """Create an instance of ExternalPropertyBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ExternalPropertyBase.parse_obj(obj)

        _obj = ExternalPropertyBase.parse_obj({
            "id": obj.get("id"),
            "etag": obj.get("etag"),
            "name": obj.get("name"),
            "value": obj.get("value"),
