...
class DocumentCopyRequest(BaseModel):
    ...
    DocumentCopyRequest
    """
    data: DocumentCopyRequestData = Field(...)
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DocumentCopyRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DocumentCopyRequest:
        """Create an instance of DocumentCopyRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DocumentCopyRequest.parse_obj(obj)

        _obj = DocumentCopyRequest.parse_obj({
            "data": DocumentCopyRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
