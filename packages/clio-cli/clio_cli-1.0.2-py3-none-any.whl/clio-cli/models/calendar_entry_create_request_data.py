...
class CalendarEntryCreateRequestData(BaseModel):
    ...
    calendar_owner: CalendarEntryCreateRequestDataCalendarOwner = Field(...)
    ...
    end_at: datetime = Field(default=..., description="The time the CalendarEntry ends (Expects an ISO-8601 timestamp).")
    external_properties: Optional[conlist(CalendarEntryCreateRequestDataExternalPropertiesInner)] = None
    ...
    start_at: datetime = Field(default=..., description="The time the CalendarEntry starts (Expects an ISO-8601 timestamp).")
    summary: StrictStr = Field(default=..., description="A short summary of the CalendarEntry.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CalendarEntryCreateRequestData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CalendarEntryCreateRequestData:
        """Create an instance of CalendarEntryCreateRequestData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CalendarEntryCreateRequestData.parse_obj(obj)

        _obj = CalendarEntryCreateRequestData.parse_obj({
            ...
            "calendar_owner": CalendarEntryCreateRequestDataCalendarOwner.from_dict(obj.get("calendar_owner")) if obj.get("calendar_owner") is not None else None,
            ...
            "external_properties": [CalendarEntryCreateRequestDataExternalPropertiesInner.from_dict(_item) for _item in obj.get("external_properties")] if obj.get("external_properties") is not None else None,
