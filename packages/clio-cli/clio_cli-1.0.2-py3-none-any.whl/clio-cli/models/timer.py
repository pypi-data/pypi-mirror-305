...
class Timer(BaseModel):
    ...
    Timer
    """
    id: Optional[StrictInt] = Field(default=None, description="Unique identifier for the *Timer*")
    etag: Optional[StrictStr] = Field(default=None, description="ETag for the *Timer*")
    start_time: Optional[datetime] = Field(default=None, description="The time the *Timer* was started (as ISO-8601 timestamp)")
    elapsed_time: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="How much time has elapsed, in hours, since the timer was started")
    created_at: Optional[datetime] = Field(default=None, description="The time the *Timer* was created (as a ISO-8601 timestamp)")
    updated_at: Optional[datetime] = Field(default=None, description="The time the *Timer* was last updated (as a ISO-8601 timestamp)")
    activity: Optional[ActivityBase] = None
    __properties = ["id", "etag", "start_time", "elapsed_time", "created_at", "updated_at", "activity"]
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Timer:
        """Create an instance of Timer from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return Timer.parse_obj(obj)

        _obj = Timer.parse_obj({
            "id": obj.get("id"),
            "etag": obj.get("etag"),
