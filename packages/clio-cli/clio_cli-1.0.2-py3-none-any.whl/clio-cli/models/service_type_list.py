...
class ServiceTypeList(BaseModel):
    ...
    ServiceTypeList
    """
    data: conlist(ServiceType) = Field(default=..., description="ServiceType List Response")
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ServiceTypeList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ServiceTypeList:
        """Create an instance of ServiceTypeList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ServiceTypeList.parse_obj(obj)

        _obj = ServiceTypeList.parse_obj({
            "data": [ServiceType.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
