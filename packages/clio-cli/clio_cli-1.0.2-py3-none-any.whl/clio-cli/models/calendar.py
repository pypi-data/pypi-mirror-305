...
class Calendar(BaseModel):
    ...
    __properties = ["id", "etag", "color", "light_color", "court_rules_default_calendar", "name", "permission", "type", "visible", "created_at", "updated_at", "source", "creator"]
    ...
    def from_dict(cls, obj: dict) -> Calendar:
        ...
        _obj = Calendar.parse_obj({
            ...
            "creator": UserBase.from_dict(obj.get("creator")) if obj.get("creator") is not None else None
        })
        return _obj
