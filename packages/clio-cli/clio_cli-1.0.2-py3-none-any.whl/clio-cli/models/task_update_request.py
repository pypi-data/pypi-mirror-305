...
class TaskUpdateRequest(BaseModel):
    ...
    TaskUpdateRequest
    """
    data: TaskUpdateRequestData = Field(...)
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TaskUpdateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TaskUpdateRequest:
        """Create an instance of TaskUpdateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TaskUpdateRequest.parse_obj(obj)

        _obj = TaskUpdateRequest.parse_obj({
            "data": TaskUpdateRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
