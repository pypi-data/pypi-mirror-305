...
class TaskTemplateListInstaceBase(BaseModel):
    ...
    """
    id: Optional[StrictInt] = Field(default=None, description="Unique identifier for the *TaskTemplateListInstace*")
    etag: Optional[StrictStr] = Field(default=None, description="ETag for the *TaskTemplateListInstace*")
    created_at: Optional[datetime] = Field(default=None, description="The time the *TaskTemplateListInstace* was created (as a ISO-8601 timestamp)")
    updated_at: Optional[datetime] = Field(default=None, description="The time the *TaskTemplateListInstace* was last updated (as a ISO-8601 timestamp)")
    __properties = ["id", "etag", "created_at", "updated_at"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TaskTemplateListInstaceBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TaskTemplateListInstaceBase:
        """Create an instance of TaskTemplateListInstaceBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TaskTemplateListInstaceBase.parse_obj(obj)

        _obj = TaskTemplateListInstaceBase.parse_obj({
            "id": obj.get("id"),
            "etag": obj.get("etag"),
