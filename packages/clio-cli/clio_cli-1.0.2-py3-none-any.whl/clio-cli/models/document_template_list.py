...
class DocumentTemplateList(BaseModel):
    ...
    """
    data: conlist(DocumentTemplate) = Field(default=..., description="DocumentTemplate List Response")
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DocumentTemplateList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DocumentTemplateList:
        """Create an instance of DocumentTemplateList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DocumentTemplateList.parse_obj(obj)

        _obj = DocumentTemplateList.parse_obj({
            "data": [DocumentTemplate.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
