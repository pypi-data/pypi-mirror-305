...
class ConversationList(BaseModel):
    ...
    ConversationList
    """
    data: conlist(Conversation) = Field(default=..., description="Conversation List Response")
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ConversationList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ConversationList:
        """Create an instance of ConversationList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ConversationList.parse_obj(obj)

        _obj = ConversationList.parse_obj({
            "data": [Conversation.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
