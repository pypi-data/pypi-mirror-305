...
class Relationship(BaseModel):
    ...
    Relationship
    """
    id: Optional[StrictInt] = Field(default=None, description="Unique identifier for the *Relationship*")
    etag: Optional[StrictStr] = Field(default=None, description="ETag for the *Relationship*")
    description: Optional[StrictStr] = Field(default=None, description="A detailed description of the *Relationship*")
    created_at: Optional[datetime] = Field(default=None, description="The time the *Relationship* was created (as a ISO-8601 timestamp)")
    updated_at: Optional[datetime] = Field(default=None, description="The time the *Relationship* was last updated (as a ISO-8601 timestamp)")
    matter: Optional[MatterBase] = None
    contact: Optional[ContactBase] = None
    __properties = ["id", "etag", "description", "created_at", "updated_at", "matter", "contact"]
