...
class ActivityDescriptionShow(BaseModel):
    ...
    """
    data: ActivityDescription = Field(...)
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ActivityDescriptionShow:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ActivityDescriptionShow:
        """Create an instance of ActivityDescriptionShow from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ActivityDescriptionShow.parse_obj(obj)

        _obj = ActivityDescriptionShow.parse_obj({
            "data": ActivityDescription.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
