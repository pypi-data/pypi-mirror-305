...
class TextSnippetShow(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TextSnippetShow:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TextSnippetShow:
        """Create an instance of TextSnippetShow from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TextSnippetShow.parse_obj(obj)

        _obj = TextSnippetShow.parse_obj({
            "data": TextSnippet.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
