...
class CalendarEntryCreateRequestDataAttendeesInner(BaseModel):
    """
    CalendarEntryCreateRequestDataAttendeesInner
    """
    id: Optional[StrictInt] = Field(default=None, description="The unique identifier for a single Attendee associated with the CalendarEntry. The keyword `null` is not valid for this field. Not required for creating new Attendee, but required for updating or deleting existing ones.")
    type: Optional[StrictStr] = Field(default=None, description="The type of attendee (Calendar, Contact)")
    destroy: Optional[StrictBool] = Field(default=None, alias="_destroy", description="Flag to delete a specific attendee.")
    __properties = ["id", "type", "_destroy"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CalendarEntryCreateRequestDataAttendeesInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CalendarEntryCreateRequestDataAttendeesInner:
        """Create an instance of CalendarEntryCreateRequestDataAttendeesInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CalendarEntryCreateRequestDataAttendeesInner.parse_obj(obj)

        _obj = CalendarEntryCreateRequestDataAttendeesInner.parse_obj({
            "id": obj.get("id"),
            "type": obj.get("type"),
