...
class MultipartBase(BaseModel):
    ...
    __properties = ["part_number", "put_url"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MultipartBase:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MultipartBase:
        """Create an instance of MultipartBase from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MultipartBase.parse_obj(obj)

        _obj = MultipartBase.parse_obj({
