...
class CommunicationUpdateRequest(BaseModel):
    ...
    """
    data: CommunicationUpdateRequestData = Field(...)
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CommunicationUpdateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CommunicationUpdateRequest:
        """Create an instance of CommunicationUpdateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CommunicationUpdateRequest.parse_obj(obj)

        _obj = CommunicationUpdateRequest.parse_obj({
            "data": CommunicationUpdateRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
