...
class GrantFundingSourceShow(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GrantFundingSourceShow:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GrantFundingSourceShow:
        """Create an instance of GrantFundingSourceShow from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GrantFundingSourceShow.parse_obj(obj)

        _obj = GrantFundingSourceShow.parse_obj({
            "data": GrantFundingSource.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
