...
class ActivityShow(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ActivityShow:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ActivityShow:
        """Create an instance of ActivityShow from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ActivityShow.parse_obj(obj)

        _obj = ActivityShow.parse_obj({
            "data": Activity.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
