...
class TaskTemplate(BaseModel):
    ...
    reminder_templates: Optional[conlist(ReminderTemplateBase)] = Field(default=None, description="ReminderTemplate")
    __properties = ["id", "etag", "name", "description", "priority", "private", "created_at", "updated_at", "cascading_source", "assignee", "task_template_list", "task_type", "template_creator", "reminder_templates"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TaskTemplate:
    ...
    def to_dict(self):
        ...
        # override the default output from pydantic by calling `to_dict()` of template_creator
        if self.template_creator:
            _dict['template_creator'] = self.template_creator.to_dict()
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TaskTemplate:
        """Create an instance of TaskTemplate from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TaskTemplate.parse_obj(obj)

        _obj = TaskTemplate.parse_obj({
            "id": obj.get("id"),
            "etag": obj.get("etag"),
            "name": obj.get("name"),
            ...
            "cascading_source": CascadingTaskTemplateBase.from_dict(obj.get("cascading_source")) if obj.get("cascading_source") is not None else None,
            "assignee": UserBase.from_dict(obj.get("assignee")) if obj.get("assignee") is not None else None,
            "task_template_list": TaskTemplateListBase.from_dict(obj.get("task_template_list")) if obj.get("task_template_list") is not None else None,
            "task_type": TaskTypeBase.from_dict(obj.get("task_type")) if obj.get("task_type") is not None else None,
            "template_creator": UserBase.from_dict(obj.get("template_creator")) if obj.get("template_creator") is not None else None,
            "reminder_templates": [ReminderTemplateBase.from_dict(_item) for _item in obj.get("reminder_templates")] if obj.get("reminder_templates") is not None else None
        })
        return _obj
