...
class DocumentCategoryShow(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DocumentCategoryShow:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DocumentCategoryShow:
        """Create an instance of DocumentCategoryShow from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DocumentCategoryShow.parse_obj(obj)

        _obj = DocumentCategoryShow.parse_obj({
            "data": DocumentCategory.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
