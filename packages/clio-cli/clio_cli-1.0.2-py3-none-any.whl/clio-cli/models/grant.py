...
class Grant(BaseModel):
    ...
    __properties = ["id", "etag", "name", "funding_code", "funding_code_and_name", "funding_source_name", "created_at", "updated_at", "balance", "grant_funding_source"]
    ...
    def to_dict(self):
        ...
        _dict = self.dict(by_alias=True,
                          ...
                          exclude_none=True)
        # override the default output from pydantic by calling `to_dict()` of grant_funding_source
        if self.grant_funding_source:
            _dict['grant_funding_source'] = self.grant_funding_source.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: dict) -> Grant:
        ...
        _obj = Grant.parse_obj({
            ...
            "etag": obj.get("etag"),
            "name": obj.get("name"),
            "funding_code": obj.get("funding_code"),
            "funding_code_and_name": obj.get("funding_code_and_name"),
            "funding_source_name": obj.get("funding_source_name"),
            "created_at": obj.get("created_at"),
            "updated_at": obj.get("updated_at"),
            "balance": obj.get("balance"),
            "grant_funding_source": GrantFundingSourceBase.from_dict(obj.get("grant_funding_source")) if obj.get("grant_funding_source") is not None else None
        })
        return _obj
