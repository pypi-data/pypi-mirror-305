...
class TaskTemplateListUpdateRequest(BaseModel):
    """
    TaskTemplateListUpdateRequest
    """
    data: TaskTemplateListUpdateRequestData = Field(...)
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TaskTemplateListUpdateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TaskTemplateListUpdateRequest:
        """Create an instance of TaskTemplateListUpdateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TaskTemplateListUpdateRequest.parse_obj(obj)

        _obj = TaskTemplateListUpdateRequest.parse_obj({
            "data": TaskTemplateListUpdateRequestData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
