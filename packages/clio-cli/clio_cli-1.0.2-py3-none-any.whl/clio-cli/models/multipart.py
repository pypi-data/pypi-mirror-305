...
class Multipart(BaseModel):
    ...
    Multipart
    """
    part_number: Optional[StrictInt] = Field(default=None, description="Unique identifier of a part which defines its position within the document being uploaded.")
    put_url: Optional[StrictStr] = Field(default=None, description="A signed URL for uploading the file part. It expires in 10 minutes.")
    put_headers: Optional[conlist(MultipartHeaderBase)] = Field(default=None, description="MultipartHeader")
    __properties = ["part_number", "put_url", "put_headers"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Multipart:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Multipart:
        """Create an instance of Multipart from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return Multipart.parse_obj(obj)

        _obj = Multipart.parse_obj({
