...
from mango_ui import MangoWindow, MangoLeftMenu, MangoTitleBar, MangoCredits, MangoGrips
from mango_ui.init import *
from mango_ui.models.models import MenusModel, AppConfig
from mango_ui.pages.window.pages_window import PagesWindow
...
class UIWindow(QMainWindow):
    def __init__(self, style: AppConfig, menus: MenusModel, page_dict, l=None, ):
        ...
        self.load_pages.set_page('component')
