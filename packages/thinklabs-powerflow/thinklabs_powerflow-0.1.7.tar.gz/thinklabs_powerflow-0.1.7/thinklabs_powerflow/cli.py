...
def process_files(p_file, q_file):
    ...
    try:
        ...
        p_df = pd.read_csv(p_file, delimiter=',', engine='python')
        print("P file head:\n", p_df.head())
        ...
        p_file_processed = os.path.join("data", "PNET.csv")
    ...
    try:
        ...
        q_df = pd.read_csv(q_file, delimiter=',', engine='python')
        print("Q file head:\n", q_df.head())
        ...
        q_file_processed = os.path.join("data", "QNET.csv")
