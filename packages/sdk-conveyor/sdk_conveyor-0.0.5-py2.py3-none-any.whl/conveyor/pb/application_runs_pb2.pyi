...
class NodeState(_message.Message):
    __slots__ = ("node_name", "node_id", "cloud_node_id", "instance_type", "cloud_instance_type", "instance_lifecycle", "phase", "created", "finished", "tenant_id", "failure_reason", "architecture", "cluster_id", "region", "availability_zone", "compute_type", "cloud", "node_type")
