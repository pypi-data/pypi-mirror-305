...
class AnsibleGitRemote(object):
    ...
    def __init__(self, username=None, client_cert=None, name=None, connect_timeout=None, pulp_labels=None, password=None, client_key=None, sock_read_timeout=None, download_concurrency=None, headers=None, proxy_password=None, url=None, proxy_username=None, ca_cert=None, rate_limit=None, max_retries=None, sock_connect_timeout=None, proxy_url=None, total_timeout=None, tls_validation=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
