...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, hidden_fields=None, client_cert=None, name=None, connect_timeout=None, pulp_labels=None, sock_read_timeout=None, download_concurrency=None, headers=None, url=None, ca_cert=None, rate_limit=None, max_retries=None, sock_connect_timeout=None, proxy_url=None, total_timeout=None, pulp_last_updated=None, pulp_created=None, tls_validation=None, pulp_href=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
