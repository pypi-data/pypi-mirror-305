...
class AnsibleGitRemote(object):
    ...
    def __init__(self, username=None, headers=None, proxy_username=None, client_cert=None, url=None, password=None, max_retries=None, ca_cert=None, client_key=None, connect_timeout=None, name=None, download_concurrency=None, pulp_labels=None, proxy_password=None, sock_read_timeout=None, proxy_url=None, tls_validation=None, sock_connect_timeout=None, rate_limit=None, total_timeout=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
