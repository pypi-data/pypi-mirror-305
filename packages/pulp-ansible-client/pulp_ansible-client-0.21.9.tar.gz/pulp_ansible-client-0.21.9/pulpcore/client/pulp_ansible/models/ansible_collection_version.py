...
class AnsibleCollectionVersion(object):
    ...
    def __init__(self, artifact=None, file=None, upload=None, repository=None, expected_name=None, expected_namespace=None, expected_version=None, local_vars_configuration=None):  # noqa: E501
