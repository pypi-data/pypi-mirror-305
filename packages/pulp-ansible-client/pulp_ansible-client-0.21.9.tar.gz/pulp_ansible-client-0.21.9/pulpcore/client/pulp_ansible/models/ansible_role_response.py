...
class AnsibleRoleResponse(object):
    ...
    def __init__(self, artifact=None, pulp_last_updated=None, pulp_created=None, pulp_href=None, version=None, name=None, namespace=None, local_vars_configuration=None):  # noqa: E501
