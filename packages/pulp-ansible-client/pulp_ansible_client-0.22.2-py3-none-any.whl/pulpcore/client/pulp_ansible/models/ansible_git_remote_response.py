...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, pulp_created=None, proxy_url=None, total_timeout=None, prn=None, connect_timeout=None, sock_connect_timeout=None, pulp_last_updated=None, url=None, max_retries=None, download_concurrency=None, headers=None, name=None, rate_limit=None, pulp_labels=None, ca_cert=None, hidden_fields=None, client_cert=None, tls_validation=None, sock_read_timeout=None, pulp_href=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
