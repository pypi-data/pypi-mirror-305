...
class AnsibleCollectionVersion(object):
    ...
    def __init__(self, file=None, repository=None, artifact=None, upload=None, file_url=None, expected_name=None, expected_namespace=None, expected_version=None, local_vars_configuration=None):  # noqa: E501
