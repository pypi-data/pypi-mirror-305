...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, name=None, tls_validation=None, connect_timeout=None, hidden_fields=None, max_retries=None, url=None, pulp_created=None, pulp_last_updated=None, download_concurrency=None, rate_limit=None, total_timeout=None, client_cert=None, sock_connect_timeout=None, proxy_url=None, pulp_href=None, pulp_labels=None, ca_cert=None, sock_read_timeout=None, headers=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
