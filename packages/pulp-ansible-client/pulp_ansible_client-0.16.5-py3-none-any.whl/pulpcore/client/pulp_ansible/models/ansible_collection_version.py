...
class AnsibleCollectionVersion(object):
    ...
    def __init__(self, upload=None, repository=None, file=None, artifact=None, expected_name=None, expected_namespace=None, expected_version=None, local_vars_configuration=None):  # noqa: E501
