...
class AnsibleGitRemote(object):
    ...
    def __init__(self, name=None, tls_validation=None, connect_timeout=None, max_retries=None, proxy_password=None, username=None, url=None, client_key=None, download_concurrency=None, proxy_username=None, rate_limit=None, total_timeout=None, client_cert=None, sock_connect_timeout=None, proxy_url=None, pulp_labels=None, ca_cert=None, sock_read_timeout=None, password=None, headers=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
