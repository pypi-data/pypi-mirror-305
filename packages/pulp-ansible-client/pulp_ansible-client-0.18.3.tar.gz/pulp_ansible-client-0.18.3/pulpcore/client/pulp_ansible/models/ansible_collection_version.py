...
class AnsibleCollectionVersion(object):
    ...
    def __init__(self, artifact=None, upload=None, repository=None, file=None, expected_name=None, expected_namespace=None, expected_version=None, local_vars_configuration=None):  # noqa: E501
