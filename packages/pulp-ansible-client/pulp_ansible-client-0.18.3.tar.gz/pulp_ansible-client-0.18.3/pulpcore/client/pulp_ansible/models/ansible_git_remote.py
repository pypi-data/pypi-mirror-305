...
class AnsibleGitRemote(object):
    ...
    def __init__(self, name=None, sock_read_timeout=None, rate_limit=None, client_key=None, total_timeout=None, ca_cert=None, proxy_password=None, proxy_username=None, max_retries=None, tls_validation=None, proxy_url=None, download_concurrency=None, pulp_labels=None, connect_timeout=None, headers=None, client_cert=None, username=None, sock_connect_timeout=None, password=None, url=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
