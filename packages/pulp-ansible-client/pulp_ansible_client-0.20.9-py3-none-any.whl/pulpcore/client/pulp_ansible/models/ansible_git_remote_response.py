...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, pulp_created=None, pulp_href=None, sock_read_timeout=None, total_timeout=None, pulp_labels=None, connect_timeout=None, max_retries=None, proxy_url=None, pulp_last_updated=None, client_cert=None, name=None, tls_validation=None, rate_limit=None, headers=None, ca_cert=None, sock_connect_timeout=None, hidden_fields=None, url=None, download_concurrency=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
