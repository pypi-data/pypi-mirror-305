...
class PatchedansibleGitRemote(object):
    ...
    def __init__(self, sock_read_timeout=None, total_timeout=None, pulp_labels=None, connect_timeout=None, max_retries=None, proxy_url=None, client_cert=None, name=None, tls_validation=None, rate_limit=None, headers=None, proxy_password=None, ca_cert=None, sock_connect_timeout=None, password=None, url=None, download_concurrency=None, client_key=None, username=None, proxy_username=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
