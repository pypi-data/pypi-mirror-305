...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, headers=None, client_cert=None, url=None, max_retries=None, ca_cert=None, hidden_fields=None, connect_timeout=None, pulp_created=None, name=None, download_concurrency=None, pulp_last_updated=None, pulp_href=None, pulp_labels=None, sock_read_timeout=None, proxy_url=None, tls_validation=None, sock_connect_timeout=None, rate_limit=None, total_timeout=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
