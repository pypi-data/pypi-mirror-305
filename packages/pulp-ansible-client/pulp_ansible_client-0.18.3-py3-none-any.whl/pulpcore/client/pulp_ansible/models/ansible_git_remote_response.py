...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, name=None, sock_read_timeout=None, pulp_created=None, pulp_href=None, rate_limit=None, total_timeout=None, ca_cert=None, max_retries=None, tls_validation=None, proxy_url=None, download_concurrency=None, pulp_labels=None, connect_timeout=None, hidden_fields=None, headers=None, client_cert=None, sock_connect_timeout=None, pulp_last_updated=None, url=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
