...
class AnsibleGitRemote(object):
    ...
    def __init__(self, password=None, proxy_url=None, total_timeout=None, connect_timeout=None, sock_connect_timeout=None, proxy_username=None, url=None, username=None, max_retries=None, download_concurrency=None, headers=None, name=None, proxy_password=None, rate_limit=None, pulp_labels=None, ca_cert=None, client_cert=None, tls_validation=None, sock_read_timeout=None, client_key=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
