...
class Dataset(ModelBase):
    ...
    @staticmethod
    def parse_from_internal_model(internal_dataset: InternalDataset) -> "Dataset":
        return Dataset(
            id=internal_dataset.id,
            name=internal_dataset.name,
            filename=internal_dataset.filename,
            storage_uri=internal_dataset.storage_uri,
            version=internal_dataset.version,
            num_versions=internal_dataset.num_versions,
            created_at=internal_dataset.created_at,
            creator_id=internal_dataset.creator_id,
            project_id=internal_dataset.project_id,
            cloud_id=internal_dataset.cloud_id,
            description=internal_dataset.description,
        )
