...
class ResourceQuota(object):
    ...
    def __init__(self, name=None, cloud_id=None, project_id=None, user_id=None, quota=None, notification_channel=None, id=None, is_enabled=True, created_at=None, deleted_at=None, creator=None, cloud=None, local_vars_configuration=None):  # noqa: E501
