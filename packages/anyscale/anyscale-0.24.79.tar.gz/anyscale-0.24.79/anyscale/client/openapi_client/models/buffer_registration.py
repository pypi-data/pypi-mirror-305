...
class BufferRegistration(object):
    ...
    def __init__(self, aws=None, gcp=None, provisioned=None, sagemaker=None, k8s=None, provider=None, cloud_id=None, buffer_id=None, local_vars_configuration=None):  # noqa: E501
