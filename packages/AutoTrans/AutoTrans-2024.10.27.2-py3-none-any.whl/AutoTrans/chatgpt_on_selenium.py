        ...
        if os_type == "Windows":
            ...
            try:
                registry_key = winreg.OpenKey(winreg.HKEY_LOCAL_MACHINE, 
                                              ...
                                              0, winreg.KEY_READ)
                chrome_path, _ = winreg.QueryValueEx(registry_key, "")
            ...
            self.chrome_path = '/usr/bin/google-chrome'  # Linux路径
            self.control_key = Keys.CONTROL
        elif os_type == "Darwin":
            self.chrome_path = '/Applications/Google Chrome.app/Contents/MacOS/Google Chrome'  # macOS路径
