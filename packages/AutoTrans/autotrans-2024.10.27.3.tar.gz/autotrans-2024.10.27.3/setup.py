...
setup(
    ...
    install_requires = ['fastapi', 'deepl', 'selenium', 'nltk', 'pyperclip', 'uvicorn', 'webdriver_manager'],

    packages=find_packages(
        exclude=['chrome-testing', '__pycache__', '.git', 'AutoTrans.egg-info'] 
    ),
