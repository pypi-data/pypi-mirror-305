class Constants:
    ...
    JQL_FEATURE_DATAENG_20241028 = "issuetype = Feature AND (project in ('DEDATIOCIB','DEDATIOCI2','DEDATIOCI1','DEDRRR','DEDRRDT', " \
                          "'DEDRRA','DEDRRCM','DEDFANPYDT','DEDFBASESI','DEDFMISYS','DEDFMODELO','DEDFRORC','DEDFTRANSV','DEDATIOENG', " \
    ...
    JQL_FEATURE_DATAENG = "issuetype = Feature AND project in ('DEDATIOCIB','DEDATIOCI2','DEDATIOCI1'," \
