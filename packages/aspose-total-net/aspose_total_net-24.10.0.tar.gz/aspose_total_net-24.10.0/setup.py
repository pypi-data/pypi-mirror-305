...
REQUIRES = ["aspose-3d==24.9.0",
            "aspose-barcode-for-python-via-net==24.10",
            "aspose-cad==24.10",
            "aspose-cells-python==24.10.0",
            "aspose-diagram-python==24.10",
            "Aspose.Email-for-Python-via-NET==24.10",
            "aspose-finance==24.10",
            "aspose-html-net==24.10.0",
            "aspose-imaging-python-net==24.9.0",
            "aspose-ocr-python-net==24.10.0",
            "aspose-page==24.9.0",
            "aspose-pdf==24.9.0",
            "aspose-psd==24.9.0",
            "Aspose.Slides==24.10.0",
            "aspose-svg-net==24.10.0",
