...
# [Aspose.BarCode for Python via Java](https://releases.aspose.com/barcode/python-java/) (24.10.1)
...
```python
pip install aspose-barcode-for-python-via-java==24.10.1
```

# [Aspose.Cells for Python via Java](https://releases.aspose.com/cells/python-java/) (24.10.0)
...
```python
pip install aspose-cells==24.10.0
```

# [Aspose.Diagram for Python via Java](https://releases.aspose.com/diagram/python-java/) (24.10.0)
...
```python
pip install aspose-diagram==24.10.0
```
