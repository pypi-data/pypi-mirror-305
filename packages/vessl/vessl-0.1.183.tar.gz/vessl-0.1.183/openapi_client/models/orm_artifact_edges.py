...
class OrmArtifactEdges(object):
    ...
    def __init__(self, child_artifacts=None, created_by=None, locator=None, models=None, organization=None, origin_volume=None, parent_artifact=None, run_exec=None, workload=None, local_vars_configuration=None):  # noqa: E501
