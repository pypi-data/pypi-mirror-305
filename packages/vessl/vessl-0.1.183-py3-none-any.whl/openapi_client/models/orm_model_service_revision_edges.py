...
class OrmModelServiceRevisionEdges(object):
    ...
    def __init__(self, access_token=None, created_by=None, kernel_image=None, model=None, model_service=None, pod_count_history=None, workload=None, local_vars_configuration=None):  # noqa: E501
