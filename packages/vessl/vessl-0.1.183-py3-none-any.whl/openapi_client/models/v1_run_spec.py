...
class V1RunSpec(object):
    ...
    def __init__(self, command=None, env_vars=None, interactive=None, ports=None, resource_spec=None, service_account_name=None, start_command=None, termination_protection=None, volume_claim_mounts=None, volume_v2_mounts=None, local_vars_configuration=None):  # noqa: E501
