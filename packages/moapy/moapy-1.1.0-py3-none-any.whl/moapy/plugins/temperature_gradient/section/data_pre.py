...
class SlabSection(MBaseModel):
    shape: SlabSectionShape = dataclass_field(default=SlabSectionShape())
    material: SectionMaterial = dataclass_field(default=SectionMaterial())
...
class SteelBoxGirderSection(MBaseModel):
    shape: SteelBoxGirderSectionShape = dataclass_field(
...
class SteelIGirderSection(MBaseModel):
    shape: SteelIGirderSectionShape = dataclass_field(
...
class SteelTubSection(MBaseModel):
    shape: SteelTubSectionShape = dataclass_field(default=SteelTubSectionShape())
    material: SectionMaterial = dataclass_field(default=SectionMaterial())
...
class CompositeBoxGirderSection(CompositeSection):
    girder_section: SteelBoxGirderSection = dataclass_field(
        default=SteelBoxGirderSection()
    )
    slab_section: SlabSection = dataclass_field(default=SlabSection())
...
class CompositeIGirderSection(CompositeSection):
    girder_section: SteelIGirderSection = dataclass_field(default=SteelIGirderSection())
    slab_section: SlabSection = dataclass_field(default=SlabSection())
...
class CompositeTubSection(CompositeSection):
    girder_section: SteelTubSection = dataclass_field(default=SteelTubSection())
    slab_section: SlabSection = dataclass_field(default=SlabSection())
...
class PSC1CellSection(MBaseModel):
    shape: PSC1CellSectionShape = dataclass_field(default=PSC1CellSectionShape())
    material: SectionMaterial = dataclass_field(default=SectionMaterial())
...
class PSC2CellSection(MBaseModel):
    shape: PSC2CellSectionShape = dataclass_field(default=PSC2CellSectionShape())
    material: SectionMaterial = dataclass_field(default=SectionMaterial())
...
class PSC_ISection(MBaseModel):
    shape: PSC_ISectionShape = dataclass_field(default=PSC_ISectionShape())
    material: SectionMaterial = dataclass_field(default=SectionMaterial())
...
class PSC_TSection(MBaseModel):
    shape: PSC_TSectionShape = dataclass_field(default=PSC_TSectionShape())
    material: SectionMaterial = dataclass_field(default=SectionMaterial())
