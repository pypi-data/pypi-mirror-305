...
class UnSurfacedTypeInput(MBaseModel):
    ...
    surfacing_type: Literal["unsurfaced"] = Field(
        default="unsurfaced", description="Surfacing Type"
    )


class WaterProofedTypeInput(MBaseModel):
    model_config = ConfigDict(title="Waterproofed")
    surfacing_type: Literal["waterproofed"] = Field(
        default="waterproofed", description="Surfacing Type"
    )


class SurfacedTypeInput(MBaseModel):
    model_config = ConfigDict(title="Surfaced")
    surfacing_type: Literal["surfacing"] = Field(
        default="surfacing", description="Surfacing Type"
    )
