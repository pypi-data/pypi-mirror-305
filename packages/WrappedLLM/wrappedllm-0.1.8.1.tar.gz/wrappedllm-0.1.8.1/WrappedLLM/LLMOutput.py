...
class Output:
    ...
    def GPT(
        ...
        image: Optional[Union[str, os.PathLike]] = None
    ):
        """
        ...
        token_usage = TokenUsage(
            ...
            non_cached_tokens=response.usage.prompt_tokens - response.usage.prompt_tokens_details.get('cached_tokens', 0) if hasattr(response.usage, 'prompt_tokens_details') else None,
            reasoning_tokens=response.usage.completion_tokens_details.get('reasoning_tokens') if hasattr(response.usage, 'completion_tokens_details') else None
        )
