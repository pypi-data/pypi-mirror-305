...
class AdminTest(LucteriosTest):
    ...
    def test_default_configuration(self):
        ...
        self.calljson('/CORE/paramEdit', {'params': 'microbusiness-sellaccount;microbusiness-serviceaccount'}, False)
        ...
        self.calljson('/CORE/paramSave', {'params': 'microbusiness-sellaccount;microbusiness-serviceaccount', 'microbusiness-sellaccount': '701', 'microbusiness-serviceaccount': '706'}, False)
