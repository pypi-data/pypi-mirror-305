...
from virtualitics_sdk.elements import CustomEvent as CustomEvent, DataSource as DataSource, XAIDashboard as XAIDashboard
...
class StoreInterface:
    '''
    The StoreInterface class is the main interface to storing and retrieving meta data.
    ...
    **EXAMPLE:**
    ...
    def update_page(self, page: Page):
        ...
        """
    def save_output(self, data: pd.DataFrame | pd.Series | dict | int | float | BytesIO, name: str):
    ...
    def save_asset(self, asset: Asset, overwrite: bool = False, asset_id: str | None = None):
        """
    ...
    def db_to_pandas(self, query: str, conn_name: str, connection_owner: str | None = None, **kwargs):
        ...
        **NOTICE: As of version 1.23.0 this function is depreciated**
        ...
        """
    def pandas_to_db(self, _df: pd.DataFrame, table: str, conn_name: str, connection_owner: str | None = None, if_exists: str = 'fail', **kwargs):
        """
        **NOTICE: As of version 1.23.0 this function is depreciated**
