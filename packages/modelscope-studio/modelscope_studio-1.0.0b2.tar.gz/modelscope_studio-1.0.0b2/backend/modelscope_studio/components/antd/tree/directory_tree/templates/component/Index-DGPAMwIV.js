...
function je(e, t) {
  if (A(e))
    return !1;
  var n = typeof e;
  return n == "number" || n == "symbol" || n == "boolean" || e == null || we(e) ? !0 : Ur.test(e) || !Nr.test(e) || t != null && e in Object(t);
}
...
var Dt = typeof exports == "object" && exports && !exports.nodeType && exports, et = Dt && typeof module == "object" && module && !module.nodeType && module, Uo = et && et.exports === Dt, tt = Uo ? S.Buffer : void 0, nt = tt ? tt.allocUnsafe : void 0;
function Go(e, t) {
  if (t)
    return e.slice();
...
var ye = U(S, "DataView"), me = U(S, "Promise"), ve = U(S, "Set"), ot = "[object Map]", Xo = "[object Object]", it = "[object Promise]", at = "[object Set]", st = "[object WeakMap]", ut = "[object DataView]", Zo = N(ye), Wo = N(W), Jo = N(me), Qo = N(ve), Vo = N(he), O = D;
(ye && O(new ye(new ArrayBuffer(1))) != ut || W && O(new W()) != ot || me && O(me.resolve()) != it || ve && O(new ve()) != at || he && O(new he()) != st) && (O = function(e) {
  var t = D(e), n = t == Xo ? e.constructor : void 0, r = n ? N(n) : "";
  if (r)
    switch (r) {
      case Zo:
        return ut;
...
function te(e, t, n, r, i, o) {
  ...
  if (p) {
    ...
    if (f == Ht || f == Bt || g && !i) {
      if (a = l || g ? {} : Si(e), !s)
        return l ? Yo(e, No(a, e)) : Ho(e, Do(a, e));
    } else {
      if (!h[f])
        return i ? e : {};
      a = $i(e, f, s);
  ...
  if (_)
    return _;
  o.set(e, a), Mi(e) ? e.forEach(function(b) {
    a.add(te(b, t, n, b, e, o));
  }) : ji(e) && e.forEach(function(b, v) {
    a.set(v, te(b, t, n, v, e, o));
  });
  var m = u ? l ? Kt : be : l ? Ee : V, c = p ? void 0 : m(e);
  return Kn(c || e, function(b, v) {
    c && (v = b, b = e[v]), Ct(a, v, te(b, t, n, v, e, o));
  }), a;
}
...
var _a = 1, ha = 2, ba = "[object Boolean]", ya = "[object Date]", ma = "[object Error]", va = "[object Map]", Ta = "[object Number]", wa = "[object RegExp]", Pa = "[object Set]", Oa = "[object String]", Aa = "[object Symbol]", $a = "[object ArrayBuffer]", Sa = "[object DataView]", gt = P ? P.prototype : void 0, de = gt ? gt.valueOf : void 0;
...
function Na(e, t, n, r) {
  ...
  for (; ++i < o; ) {
    ...
    if (a[2]) {
      ...
      var p = new $(), f;
      if (!(f === void 0 ? De(u, l, La | Da, r, p) : f))
        return !1;
    }
  }
  return !0;
...
function ms(e, t, n) {
  ...
  const o = Ne(ys), a = ((p = G(o)) == null ? void 0 : p.as_item) || e.as_item, s = o ? a ? G(o)[a] : G(o) : {}, l = (f, g) => f ? cs({
    ...f,
    ...g || {}
  }, t) : void 0, u = j({
    ...e,
...
function Qs(e, t, n) {
  ...
  let i = mt(t, r), o, a, s, l, u, {
    $$slots: p = {},
    $$scope: f
  } = t;
  const g = ls(() => import("./tree-C2_dw4N3.js"));
  let {
    gradio: _
  } = t, {
    props: m = {}
  ...
  Y(e, Ke, (d) => n(2, l = d)), Y(e, Be, (d) => n(3, u = d));
  const nn = bs();
  return e.$$set = (d) => {
    t = Te(Te({}, t), Rs(d)), n(23, i = mt(t, r)), "gradio" in d && n(11, _ = d.gradio), "props" in d && n(12, m = d.props), "_internal" in d && n(13, b = d._internal), "as_item" in d && n(14, v = d.as_item), "visible" in d && n(15, w = d.visible), "elem_id" in d && n(16, R = d.elem_id), "elem_classes" in d && n(17, C = d.elem_classes), "elem_style" in d && n(18, E = d.elem_style), "$$scope" in d && n(21, f = d.$$scope);
  }, e.$$.update = () => {
    e.$$.dirty & /*props*/
    4096 && c.update((d) => ({
      ...d,
  ...
  }, [a, s, l, u, g, c, Ue, Ge, Ke, Be, nn, _, m, b, v, w, R, C, E, o, p, f];
}
class eu extends Es {
  constructor(t) {
