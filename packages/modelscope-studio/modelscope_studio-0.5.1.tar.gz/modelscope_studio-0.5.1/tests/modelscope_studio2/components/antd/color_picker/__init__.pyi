...
from ....utils.dev import AntdDataLayoutComponent, resolve_frontend_dir
from .preset import AntdColorPickerPreset

class ColorData(GradioModel):
    hex: str
    rgb: str
    hsb: str


class ColorPickerData(GradioRootModel):
    root: Union[ColorData, str]

from gradio.events import Dependency

# as inputs, outputs
class AntdColorPicker(AntdDataLayoutComponent):
    """
    """
