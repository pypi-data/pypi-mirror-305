...
class Silencer(Datagram, Generic[T]):
    ...
    def is_valid(self, target: Modulation | FociSTM | GainSTM) -> bool: ...
    def _datagram_ptr(self, _: Geometry) -> DatagramPtr: ...
    def with_target(self, target: SilencerTarget) -> Silencer[T]: ...
    def with_timeout(self, timeout: timedelta | None) -> DatagramWithTimeout[Silencer[T]]: ...
    def with_parallel_threshold(self, threshold: int | None) -> DatagramWithParallelThreshold[Silencer[T]]: ...
    @staticmethod
