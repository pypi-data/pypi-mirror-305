...
class Group(Gain, Generic[K]):
    ...
    def with_cache(self, ) -> Cache[Group[K]]: ...
    def with_timeout(self, timeout: timedelta | None) -> DatagramWithTimeout[Group[K]]: ...
    def with_parallel_threshold(self, threshold: int | None) -> DatagramWithParallelThreshold[Group[K]]: ...
    def with_segment(self, segment: Segment, transition_mode: TransitionModeWrap | None) -> DatagramWithSegment[Group[K]]: ...
