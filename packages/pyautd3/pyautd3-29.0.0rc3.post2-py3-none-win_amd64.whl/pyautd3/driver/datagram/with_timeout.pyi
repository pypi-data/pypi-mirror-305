...
class DatagramWithTimeout(Datagram, Generic[D]):
    ...
    def __init__(self, datagram: D, timeout: timedelta | None) -> None: ...
    def _datagram_ptr(self, g: Geometry) -> DatagramPtr: ...
    def with_parallel_threshold(self, threshold: int | None) -> DatagramWithParallelThreshold[DatagramWithTimeout[D]]: ...
