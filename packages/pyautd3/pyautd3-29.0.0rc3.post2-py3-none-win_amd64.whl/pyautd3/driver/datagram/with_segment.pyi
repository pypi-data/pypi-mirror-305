...
class DatagramWithSegment(Datagram, Generic[DS]):
    ...
    def with_timeout(self, timeout: timedelta | None) -> DatagramWithTimeout[DatagramWithSegment[DS]]: ...
    def with_parallel_threshold(self, threshold: int | None) -> DatagramWithParallelThreshold[DatagramWithSegment[DS]]: ...
