...
class Cache(Gain, Generic[G]):
    ...
    def with_timeout(self, timeout: timedelta | None) -> DatagramWithTimeout[Cache[G]]: ...
    def with_parallel_threshold(self, threshold: int | None) -> DatagramWithParallelThreshold[Cache[G]]: ...
    def with_segment(self, segment: Segment, transition_mode: TransitionModeWrap | None) -> DatagramWithSegment[Cache[G]]: ...
