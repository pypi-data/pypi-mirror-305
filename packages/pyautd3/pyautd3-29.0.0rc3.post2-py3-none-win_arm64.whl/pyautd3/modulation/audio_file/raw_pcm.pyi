...
class RawPCM(Modulation):
    ...
    def with_cache(self, ) -> Cache[RawPCM]: ...
    def with_fir(self, iterable: Iterable[float]) -> Fir[RawPCM]: ...
    def with_radiation_pressure(self, ) -> RadiationPressure[RawPCM]: ...
    ...
    def with_segment(self, segment: Segment, transition_mode: TransitionModeWrap | None) -> DatagramWithSegment[RawPCM]: ...
    @staticmethod
