...
class Csv(Modulation):
    ...
    def with_cache(self, ) -> Cache[Csv]: ...
    def with_fir(self, iterable: Iterable[float]) -> Fir[Csv]: ...
    def with_radiation_pressure(self, ) -> RadiationPressure[Csv]: ...
    def with_timeout(self, timeout: timedelta | None) -> DatagramWithTimeout[Csv]: ...
    def with_parallel_threshold(self, threshold: int | None) -> DatagramWithParallelThreshold[Csv]: ...
    def with_segment(self, segment: Segment, transition_mode: TransitionModeWrap | None) -> DatagramWithSegment[Csv]: ...
    @staticmethod
