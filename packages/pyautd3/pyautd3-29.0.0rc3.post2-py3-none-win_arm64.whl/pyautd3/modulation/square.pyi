...
class Square(ModulationWithSamplingConfig):
    ...
    def with_cache(self, ) -> Cache[Square]: ...
    def with_fir(self, iterable: Iterable[float]) -> Fir[Square]: ...
    def with_radiation_pressure(self, ) -> RadiationPressure[Square]: ...
    ...
    def with_segment(self, segment: Segment, transition_mode: TransitionModeWrap | None) -> DatagramWithSegment[Square]: ...
    @classmethod
