...
class Naive(HoloWithBackend[Naive]):
    ...
    def with_cache(self, ) -> Cache[Naive]: ...
    def with_timeout(self, timeout: timedelta | None) -> DatagramWithTimeout[Naive]: ...
    def with_parallel_threshold(self, threshold: int | None) -> DatagramWithParallelThreshold[Naive]: ...
    def with_segment(self, segment: Segment, transition_mode: TransitionModeWrap | None) -> DatagramWithSegment[Naive]: ...
