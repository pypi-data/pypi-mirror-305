...
def streamlit_luckysheet(name="",height=0, file=None, file_type=None, showtoolbarConfig={
        ...
        "print": False,
        "exportXlsx": False,
      },export_json=False,export_excel=True, key="", default=0):
    component_value = _component_func(name=name,height=height, file=file, file_type=file_type, showtoolbarConfig=showtoolbarConfig, export_json=export_json,export_excel=export_excel , key=key, default=default)
