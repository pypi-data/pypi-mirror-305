...
import pytest
import mindtorch.torchvision.datasets.utils as utils
from mindtorch.torchvision.datasets.folder import make_dataset
from mindtorch.torchvision.datasets.utils import _COMPRESSED_FILE_OPENERS
