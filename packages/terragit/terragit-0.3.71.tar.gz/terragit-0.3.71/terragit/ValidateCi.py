...
class Validate:
    ...
    def terragit_notify(self, message):
        ...
        gitlab_token = "fffffffff"
        headers = {"PRIVATE-TOKEN": gitlab_token, "Content-Type": "application/json"}
        url = f"https://gitlab.fff.fffff/api/v4/projects/{project_id}/merge_requests/?state=merged&per_page=30&page=1"
        ...
        for request in list_mr:
            ...
            url_votes = f"https://gitlab.ffff.ffffff/api/v4/projects/{project_id}/merge_requests/{request['iid']}/award_emoji"
