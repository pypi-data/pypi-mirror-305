...
def set_spark_conf_with_defaults(
    ...
    if kafka_topic is not None and kafka_broker_url is not None:
        # Uncomment when using pyspark
        # spark_conf["spark.pyspark.python"] = "./test_5.pyz"
        # spark_conf["spark.submit.pyFiles"] = "hdfs://ltx1-holdem/user/jdhiman/test_5/test_5.pyz"
