...
namespace RVO {
	...
	public:
		...
		/**
		 * \brief      Whether to use preferred velocity correction.
		 * \param      correction   A boolean value representing whether to enable 
		 *			   preferred velocity correction
		 */
	...
	private:
		...
		float timeStep_;
		bool prefVelocityCorrection = false;
