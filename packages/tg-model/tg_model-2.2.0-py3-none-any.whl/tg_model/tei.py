    ...
    def as_dict(self):
        if self._as_dict is None:
            self._as_dict = {
                ...
                "basic_classifications": self.config.basic_classifications(),
                "gnd_subjects": self.config.gnd_subjects(),
                "edition": {
