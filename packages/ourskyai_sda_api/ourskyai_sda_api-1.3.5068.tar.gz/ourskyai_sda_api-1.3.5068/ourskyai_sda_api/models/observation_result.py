...
class ObservationResult(BaseModel):
    ...
    __properties = ["imageId", "astrometricOffsets", "imageUrl", "jpgUrl", "ra", "dec", "correctedRa", "correctedDec", "boundingBox", "timestamp", "timingAccuracy", "apparentMagnitude", "solarPhaseAngle", "distanceFromPrediction", "features"]
