...
def edit_raster(raster, output, crs=None, resample=None, resample_method='bilinear', clip=None, nodata=None, match=None, match_transform=None):
    """
    ...
    with rio.open(raster) as src:
        ...
        if match:
            ...
            with MemoryFile() as memfile2:
                with memfile1.open() as src:
                    dst_match = memfile2.open(**target_profile)
