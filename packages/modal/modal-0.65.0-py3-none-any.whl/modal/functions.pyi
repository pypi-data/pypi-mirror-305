...
class _Function(typing.Generic[P, ReturnType, OriginalReturnType], modal.object._Object):
    ...
    class __map_spec(typing_extensions.Protocol):
        def __call__(
            self, *iterables, kwargs={}, order_outputs: bool = True, return_exceptions: bool = False
        ) -> modal._utils.async_utils.AsyncOrSyncIterable: ...
        def aio(
            self,
            *iterables: typing.Union[typing.Iterable[typing.Any], typing.AsyncIterable[typing.Any]],
            kwargs={},
