...
from src.cmd.clean_jobs_cmd import clean_jobs_command_func
...
@ftbx.command(name="cleanJobs")
def clean_jobs_cmd(
    object_name_or_id: Annotated[str, typer.Argument()] = None,
    from_: Annotated[str, typer.Option("--from")] = "default",
):
    """
    Delete jobs' folder who are either completed, or cancelled.
    """
    clean_jobs_command_func(
        object_name_or_id=object_name_or_id,
        from_=from_,
    )
