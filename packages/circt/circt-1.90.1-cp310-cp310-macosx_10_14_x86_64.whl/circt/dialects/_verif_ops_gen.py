...
def contract(results_, inputs, *, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(ContractOp(results_=results_, inputs=inputs, loc=loc, ip=ip))
...
def formal(sym_name, *, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(FormalOp(sym_name=sym_name, loc=loc, ip=ip))
