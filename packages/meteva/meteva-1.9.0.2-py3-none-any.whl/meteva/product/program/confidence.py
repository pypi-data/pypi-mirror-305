...
def plot_confidence(result_tdt ,B = 1000 ,c = 0.95
                    ...
                    ,height = 6,
                    dpi=300 ,legend_col = 2 ,legend_loc =  "upper center" ,wspace = None ,hspace = None,save_path = None,show = False):
...
def score_Confidence(sta_ob_and_fos0,method,s = None,B = 1000 ,c = 0.95
                    ,ncol = 1 ,title_list = None ,vmax = None ,vmin = None ,vmax_delta = None,
                    sparsify_xticks = 1, sup_fontsize = 12 ,xlabel ="时效(单位:hour)" ,ylabel = "Score" ,
                    ylabel_delta = "Score Delta" ,width = 10
                    ,height = 6,
    ...
    plot_confidence(result_tdt,B = B,c = c,ncol = ncol ,title_list=title_list,vmax = vmax,vmin = vmin,vmax_delta=vmax_delta,
                    ...
                    dpi = dpi,legend_col = legend_col,legend_loc=legend_loc,wspace=wspace,hspace=hspace,save_path=save_path,show=show)
