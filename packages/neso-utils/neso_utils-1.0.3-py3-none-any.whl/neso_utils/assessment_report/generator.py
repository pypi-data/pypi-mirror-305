...
class AssessmentReport:
    ...
    def _handler(self):
        ...
        while True:
            ...
            elif metrics_collected and (len(messages_in) == self.report_data[-1][self.target_topic]['messages_in_per_second']):
                break
    ...
    def _extract_metrics(self) -> Dict:
        ...
        for topic in self.topics:
            ...
            queries_lst = [
                JMXQuery(kafka_metrics[key](topic)) for key in kafka_metrics
            ]
        ...
        sample = {}
        if self.sparql_secret:
            sample = {'sparql_sample': run_sparql_query(self.sparql_secret)}
