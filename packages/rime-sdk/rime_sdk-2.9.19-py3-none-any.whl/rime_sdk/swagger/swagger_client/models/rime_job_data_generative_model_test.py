...
class RimeJobDataGenerativeModelTest(object):
    ...
    attribute_map = {
        ...
        'name': 'name',
        'url': 'url',
        'model_output_is_secret': 'modelOutputIsSecret'
    }

    def __init__(self, workspace_id=None, progress=None, name=None, url=None, model_output_is_secret=None):  # noqa: E501
        """RimeJobDataGenerativeModelTest - a model defined in Swagger"""  # noqa: E501
        self._workspace_id = None
        self._progress = None
        self._name = None
        self._url = None
        self._model_output_is_secret = None
        ...
        if url is not None:
            self.url = url
        if model_output_is_secret is not None:
            self.model_output_is_secret = model_output_is_secret
    ...
    @property
    def model_output_is_secret(self):
        """Gets the model_output_is_secret of this RimeJobDataGenerativeModelTest.  # noqa: E501


        :return: The model_output_is_secret of this RimeJobDataGenerativeModelTest.  # noqa: E501
        :rtype: bool
        """
        return self._model_output_is_secret

    @model_output_is_secret.setter
    def model_output_is_secret(self, model_output_is_secret):
        """Sets the model_output_is_secret of this RimeJobDataGenerativeModelTest.


        :param model_output_is_secret: The model_output_is_secret of this RimeJobDataGenerativeModelTest.  # noqa: E501
        :type: bool
        """

        self._model_output_is_secret = model_output_is_secret
