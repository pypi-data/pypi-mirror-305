...
SUBDOMAIN = {
    "172.16.3.215": [
        ftp_172_16_3_215,
        ftp_192_168_50_113.update({
            "path_replace": [ "/mcn/videos/", "/mcn/" ]
        }),
        ftp_183_6_90_205.update({
            "path_replace": [ "/mcn/videos/", "/mcn/" ]
        })
    ],
    "192.168.50.113": [
        ftp_172_16_3_215.update({
            "path_replace": [ "/mcn/", "/mcn/videos/" ]
        }),
        ftp_192_168_50_113,
        ftp_183_6_90_205,
    ],
                ...
                for host_item in SUBDOMAIN[host]:
                    try:
                        ...
                        if len(replace_path) > 0:
                            remote_filepath = remote_filepath.replace(replace_path[0], replace_path[1])
