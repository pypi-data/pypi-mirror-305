...
class TextGenerator:
    ...
    def loadQuble(self):
        ...
        self.model_index["quble"] = GPT2LMHeadModel.from_pretrained("Blexus/Quble_test_model_v1_INSTRUCT_v2")  # Replace with actual model name
        self.tokenizer = GPT2Tokenizer.from_pretrained("Blexus/Quble_test_model_v1_INSTRUCT_v2")  # Replace with actual model name
