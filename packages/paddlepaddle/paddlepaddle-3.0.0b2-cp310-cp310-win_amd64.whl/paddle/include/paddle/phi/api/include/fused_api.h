...
PADDLE_API Tensor fused_moe(const Tensor& x, const Tensor& gate_weight, const Tensor& ffn1_weight, const paddle::optional<Tensor>& ffn1_scale, const paddle::optional<Tensor>& ffn1_bias, const Tensor& ffn2_weight, const paddle::optional<Tensor>& ffn2_scale, const paddle::optional<Tensor>& ffn2_bias, const std::string& quant_method = "None", int moe_topk = 2, bool norm_topk_prob = true);
