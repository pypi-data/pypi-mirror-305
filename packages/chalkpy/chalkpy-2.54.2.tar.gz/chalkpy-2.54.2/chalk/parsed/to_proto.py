        ...
        if isinstance(v, UnderscoreRoot):
            ...
            return expr_pb.LogicalExprNode(
                call=expr_pb.ExprCall(
                    ...
                    args=[
                        cls.convert_underscore(v._chalk__body),  # pyright: ignore[reportPrivateUsage]
                        cls.convert_underscore(v._chalk__endpoint),  # pyright: ignore[reportPrivateUsage]
                        cls.convert_underscore(v._chalk__content_type),  # pyright: ignore[reportPrivateUsage]
                        cls.convert_underscore(v._chalk__target_model),  # pyright: ignore[reportPrivateUsage]
                        cls.convert_underscore(v._chalk__target_variant),  # pyright: ignore[reportPrivateUsage]
                        cls.convert_underscore(
                        ...
                        cls.convert_underscore(v._chalk__aws_region_override),  # pyright: ignore[reportPrivateUsage]
                        cls.convert_underscore(
