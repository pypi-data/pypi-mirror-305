...
from ....types.entities import person_retrieve_params
from ....types.entities.person_retrieve_response import PersonRetrieveResponse
...
class PeopleResource(SyncAPIResource):
    ...
    def retrieve(
        ...
        *,
        ...
        return self._get(
            f"/data/entities/people/{entity_id}",
...
class PeopleResourceWithRawResponse:
    ...
    def cards(self) -> CardsResourceWithRawResponse:
        return CardsResourceWithRawResponse(self._people.cards)
...
class AsyncPeopleResourceWithRawResponse:
    ...
    def cards(self) -> AsyncCardsResourceWithRawResponse:
        return AsyncCardsResourceWithRawResponse(self._people.cards)
...
class PeopleResourceWithStreamingResponse:
    ...
    def cards(self) -> CardsResourceWithStreamingResponse:
        return CardsResourceWithStreamingResponse(self._people.cards)
...
class AsyncPeopleResourceWithStreamingResponse:
    ...
    def cards(self) -> AsyncCardsResourceWithStreamingResponse:
        return AsyncCardsResourceWithStreamingResponse(self._people.cards)
