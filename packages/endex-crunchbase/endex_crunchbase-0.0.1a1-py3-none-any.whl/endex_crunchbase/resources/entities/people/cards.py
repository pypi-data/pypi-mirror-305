...
from ....types.entities.people import card_retrieve_params
from ....types.entities.people.card_retrieve_response import CardRetrieveResponse
...
class CardsResource(SyncAPIResource):
    ...
    def retrieve(
        ...
        *,
        ...
        """
        The following cards are available: [degrees, event_appearances, fields,
        ...
        return self._get(
            f"/data/entities/people/{entity_id}/cards/{card_id}",
