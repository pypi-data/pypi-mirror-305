...
from ....types.entities.partnership_announcements import card_retrieve_params
from ....types.entities.partnership_announcements.card_retrieve_response import CardRetrieveResponse
...
class CardsResource(SyncAPIResource):
    ...
    def retrieve(
        ...
        *,
        ...
        return self._get(
            f"/data/entities/partnership_announcements/{entity_id}/cards/{card_id}",
