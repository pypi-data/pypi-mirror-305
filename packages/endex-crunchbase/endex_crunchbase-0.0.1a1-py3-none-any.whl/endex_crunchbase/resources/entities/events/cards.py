...
from ....types.entities.events import card_retrieve_params
from ....types.entities.events.card_retrieve_response import CardRetrieveResponse
...
class CardsResource(SyncAPIResource):
    ...
    def retrieve(
        ...
        *,
        ...
        """
        The following cards are available: [address, appearances, contestants,
        ...
        return self._get(
            f"/data/entities/events/{entity_id}/cards/{card_id}",
