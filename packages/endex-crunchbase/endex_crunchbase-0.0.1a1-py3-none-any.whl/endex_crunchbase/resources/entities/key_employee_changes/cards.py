...
from ....types.entities.key_employee_changes import card_retrieve_params
from ....types.entities.key_employee_changes.card_retrieve_response import CardRetrieveResponse
...
class CardsResource(SyncAPIResource):
    ...
    def retrieve(
        ...
        *,
        ...
        return self._get(
            f"/data/entities/key_employee_changes/{entity_id}/cards/{card_id}",
