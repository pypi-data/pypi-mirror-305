...
from ....types.entities import key_employee_change_retrieve_params
from ....types.entities.key_employee_change_retrieve_response import KeyEmployeeChangeRetrieveResponse
...
class KeyEmployeeChangesResource(SyncAPIResource):
    ...
    def retrieve(
        ...
        *,
        ...
        return self._get(
            f"/data/entities/key_employee_changes/{entity_id}",
            options=make_request_options(
                ...
                query=maybe_transform(
                    ...
                    key_employee_change_retrieve_params.KeyEmployeeChangeRetrieveParams,
                ),
            ),
            cast_to=KeyEmployeeChangeRetrieveResponse,
        )
...
class KeyEmployeeChangesResourceWithRawResponse:
    def __init__(self, key_employee_changes: KeyEmployeeChangesResource) -> None:
        ...
        self.retrieve = to_raw_response_wrapper(
            key_employee_changes.retrieve,
        )

    @cached_property
    def cards(self) -> CardsResourceWithRawResponse:
        return CardsResourceWithRawResponse(self._key_employee_changes.cards)
...
class AsyncKeyEmployeeChangesResourceWithRawResponse:
    ...
    def cards(self) -> AsyncCardsResourceWithRawResponse:
        return AsyncCardsResourceWithRawResponse(self._key_employee_changes.cards)
...
class KeyEmployeeChangesResourceWithStreamingResponse:
    ...
    def cards(self) -> CardsResourceWithStreamingResponse:
        return CardsResourceWithStreamingResponse(self._key_employee_changes.cards)
...
class AsyncKeyEmployeeChangesResourceWithStreamingResponse:
    ...
    def cards(self) -> AsyncCardsResourceWithStreamingResponse:
        return AsyncCardsResourceWithStreamingResponse(self._key_employee_changes.cards)
