...
from ....types.entities.funding_rounds import card_retrieve_params
from ....types.entities.funding_rounds.card_retrieve_response import CardRetrieveResponse
...
class CardsResource(SyncAPIResource):
    ...
    def retrieve(
        ...
        *,
        ...
        """
        The following cards are available: [fields, investments, investors,
        ...
        return self._get(
            f"/data/entities/funding_rounds/{entity_id}/cards/{card_id}",
