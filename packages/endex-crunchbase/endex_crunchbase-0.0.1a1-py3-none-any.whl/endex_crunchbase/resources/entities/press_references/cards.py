...
from ....types.entities.press_references import card_retrieve_params
from ....types.entities.press_references.card_retrieve_response import CardRetrieveResponse
...
class CardsResource(SyncAPIResource):
    ...
    def retrieve(
        ...
        *,
        ...
        return self._get(
            f"/data/entities/press_references/{entity_id}/cards/{card_id}",
