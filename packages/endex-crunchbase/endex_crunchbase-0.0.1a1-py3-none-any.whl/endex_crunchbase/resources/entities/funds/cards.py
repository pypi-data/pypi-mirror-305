...
from ....types.entities.funds import card_retrieve_params
from ....types.entities.funds.card_retrieve_response import CardRetrieveResponse
...
class CardsResource(SyncAPIResource):
    ...
    def retrieve(
        ...
        *,
        ...
        """
        The following cards are available: [fields, investors, owner, press_references]
        ...
        return self._get(
            f"/data/entities/funds/{entity_id}/cards/{card_id}",
