...
from ....types.entities.investor_insights import card_retrieve_params
from ....types.entities.investor_insights.card_retrieve_response import CardRetrieveResponse
...
class CardsResource(SyncAPIResource):
    ...
    def retrieve(
        ...
        *,
        ...
        return self._get(
            f"/data/entities/investor_insights/{entity_id}/cards/{card_id}",
