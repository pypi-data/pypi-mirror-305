...
from ....types.entities.organizations import card_retrieve_params
from ....types.entities.organizations.card_retrieve_response import CardRetrieveResponse
...
class CardsResource(SyncAPIResource):
    ...
    def retrieve(
        ...
        *,
        ...
        """
        The following cards are available: [acquiree_acquisitions,
        ...
        return self._get(
            f"/data/entities/organizations/{entity_id}/cards/{card_id}",
