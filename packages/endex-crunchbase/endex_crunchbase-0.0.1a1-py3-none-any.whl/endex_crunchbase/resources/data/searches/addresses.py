...
from ....types.data.searches import address_create_params
from ....types.data.searches.address_create_response import AddressCreateResponse
...
class AddressesResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        field_ids: List[str],
        query: Iterable[address_create_params.Query],
        after_id: str | NotGiven = NOT_GIVEN,
        before_id: str | NotGiven = NOT_GIVEN,
        limit: int | NotGiven = NOT_GIVEN,
        order: Iterable[address_create_params.Order] | NotGiven = NOT_GIVEN,
