...
from ....types.data.searches import person_create_params
from ....types.data.searches.person_create_response import PersonCreateResponse
...
class PeopleResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        field_ids: List[str],
        query: Iterable[person_create_params.Query],
        after_id: str | NotGiven = NOT_GIVEN,
        before_id: str | NotGiven = NOT_GIVEN,
        limit: int | NotGiven = NOT_GIVEN,
        order: Iterable[person_create_params.Order] | NotGiven = NOT_GIVEN,
