...
from ....types.data.searches import event_appearance_create_params
from ....types.data.searches.event_appearance_create_response import EventAppearanceCreateResponse
...
class EventAppearancesResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        field_ids: List[str],
        query: Iterable[event_appearance_create_params.Query],
        after_id: str | NotGiven = NOT_GIVEN,
        before_id: str | NotGiven = NOT_GIVEN,
        limit: int | NotGiven = NOT_GIVEN,
        order: Iterable[event_appearance_create_params.Order] | NotGiven = NOT_GIVEN,
        ...
        return self._post(
            ...
            body=maybe_transform(
                ...
                event_appearance_create_params.EventAppearanceCreateParams,
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=EventAppearanceCreateResponse,
        )
