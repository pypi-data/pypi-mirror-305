...
from ....types.data.searches import event_create_params
from ....types.data.searches.event_create_response import EventCreateResponse
...
class EventsResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        field_ids: List[str],
        query: Iterable[event_create_params.Query],
        after_id: str | NotGiven = NOT_GIVEN,
        before_id: str | NotGiven = NOT_GIVEN,
        limit: int | NotGiven = NOT_GIVEN,
        order: Iterable[event_create_params.Order] | NotGiven = NOT_GIVEN,
