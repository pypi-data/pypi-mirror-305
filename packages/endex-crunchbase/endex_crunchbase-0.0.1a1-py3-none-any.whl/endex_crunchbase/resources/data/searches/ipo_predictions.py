...
from ....types.data.searches import ipo_prediction_create_params
from ....types.data.searches.ipo_prediction_create_response import IpoPredictionCreateResponse
...
class IpoPredictionsResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        field_ids: List[str],
        query: Iterable[ipo_prediction_create_params.Query],
        after_id: str | NotGiven = NOT_GIVEN,
        before_id: str | NotGiven = NOT_GIVEN,
        limit: int | NotGiven = NOT_GIVEN,
        order: Iterable[ipo_prediction_create_params.Order] | NotGiven = NOT_GIVEN,
        ...
        return self._post(
            ...
            body=maybe_transform(
                ...
                ipo_prediction_create_params.IpoPredictionCreateParams,
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=IpoPredictionCreateResponse,
        )
