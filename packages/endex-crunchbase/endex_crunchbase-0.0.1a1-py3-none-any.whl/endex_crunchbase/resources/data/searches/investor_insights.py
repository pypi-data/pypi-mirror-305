...
from ....types.data.searches import investor_insight_create_params
from ....types.data.searches.investor_insight_create_response import InvestorInsightCreateResponse
...
class InvestorInsightsResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        field_ids: List[str],
        query: Iterable[investor_insight_create_params.Query],
        after_id: str | NotGiven = NOT_GIVEN,
        before_id: str | NotGiven = NOT_GIVEN,
        limit: int | NotGiven = NOT_GIVEN,
        order: Iterable[investor_insight_create_params.Order] | NotGiven = NOT_GIVEN,
        ...
        return self._post(
            ...
            body=maybe_transform(
                ...
                investor_insight_create_params.InvestorInsightCreateParams,
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=InvestorInsightCreateResponse,
        )
