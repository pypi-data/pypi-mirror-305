...
from ....types.data.searches import organization_create_params
from ....types.data.searches.organization_create_response import OrganizationCreateResponse
...
class OrganizationsResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        field_ids: List[str],
        query: Iterable[organization_create_params.Query],
        after_id: str | NotGiven = NOT_GIVEN,
        before_id: str | NotGiven = NOT_GIVEN,
        limit: int | NotGiven = NOT_GIVEN,
        order: Iterable[organization_create_params.Order] | NotGiven = NOT_GIVEN,
