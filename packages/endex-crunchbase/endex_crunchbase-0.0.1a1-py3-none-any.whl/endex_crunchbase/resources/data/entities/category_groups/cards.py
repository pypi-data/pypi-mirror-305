...
from .....types.data.entities.category_groups import card_retrieve_params
from .....types.data.entities.category_groups.card_retrieve_response import CardRetrieveResponse
...
class CardsResource(SyncAPIResource):
    ...
    def retrieve(
        ...
        *,
        ...
        return self._get(
            f"/data/entities/category_groups/{entity_id}/cards/{card_id}",
