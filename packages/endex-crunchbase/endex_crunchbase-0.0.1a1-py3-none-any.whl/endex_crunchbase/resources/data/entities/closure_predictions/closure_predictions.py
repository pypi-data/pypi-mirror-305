...
from .....types.data.entities import closure_prediction_retrieve_params
from .....types.data.entities.closure_prediction_retrieve_response import ClosurePredictionRetrieveResponse
...
class ClosurePredictionsResource(SyncAPIResource):
    ...
    def retrieve(
        ...
        *,
    ...
    ) -> ClosurePredictionRetrieveResponse:
        """
        Lookup a ClosurePrediction

        Args:
          card_ids: Cards to include on the resulting entity - array of card_id strings in JSON
              encoded as string Card Ids for ClosurePrediction: [fields]
        ...
        return self._get(
            f"/data/entities/closure_predictions/{entity_id}",
            options=make_request_options(
                ...
                query=maybe_transform(
                    ...
                    closure_prediction_retrieve_params.ClosurePredictionRetrieveParams,
                ),
            ),
            cast_to=ClosurePredictionRetrieveResponse,
        )
...
class ClosurePredictionsResourceWithRawResponse:
    def __init__(self, closure_predictions: ClosurePredictionsResource) -> None:
        ...
        self.retrieve = to_raw_response_wrapper(
            closure_predictions.retrieve,
        )

    @cached_property
    def cards(self) -> CardsResourceWithRawResponse:
        return CardsResourceWithRawResponse(self._closure_predictions.cards)
...
class AsyncClosurePredictionsResourceWithRawResponse:
    ...
    def cards(self) -> AsyncCardsResourceWithRawResponse:
        return AsyncCardsResourceWithRawResponse(self._closure_predictions.cards)
...
class ClosurePredictionsResourceWithStreamingResponse:
    ...
    def cards(self) -> CardsResourceWithStreamingResponse:
        return CardsResourceWithStreamingResponse(self._closure_predictions.cards)
...
class AsyncClosurePredictionsResourceWithStreamingResponse:
    ...
    def cards(self) -> AsyncCardsResourceWithStreamingResponse:
        return AsyncCardsResourceWithStreamingResponse(self._closure_predictions.cards)
