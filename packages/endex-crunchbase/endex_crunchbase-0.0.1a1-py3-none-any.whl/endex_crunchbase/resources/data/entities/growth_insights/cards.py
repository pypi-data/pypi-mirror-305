...
from .....types.data.entities.growth_insights import card_retrieve_params
from .....types.data.entities.growth_insights.card_retrieve_response import CardRetrieveResponse
...
class CardsResource(SyncAPIResource):
    ...
    def retrieve(
        ...
        *,
        ...
        return self._get(
            f"/data/entities/growth_insights/{entity_id}/cards/{card_id}",
