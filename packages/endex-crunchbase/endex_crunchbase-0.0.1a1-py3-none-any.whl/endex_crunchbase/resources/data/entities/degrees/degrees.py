...
from .....types.data.entities import degree_retrieve_params
from .....types.data.entities.degree_retrieve_response import DegreeRetrieveResponse
        ...
        *,
        ...
        Args:
          card_ids: Cards to include on the resulting entity - array of card_id strings in JSON
              encoded as string Card Ids for Degree: [fields, organization, person]
        ...
        return self._get(
            f"/data/entities/degrees/{entity_id}",
            options=make_request_options(
                ...
                query=maybe_transform(
                    ...
                    degree_retrieve_params.DegreeRetrieveParams,
                ),
            ),
            cast_to=DegreeRetrieveResponse,
        )
...
class DegreesResourceWithRawResponse:
    ...
    def cards(self) -> CardsResourceWithRawResponse:
        return CardsResourceWithRawResponse(self._degrees.cards)
...
class AsyncDegreesResourceWithRawResponse:
    ...
    def cards(self) -> AsyncCardsResourceWithRawResponse:
        return AsyncCardsResourceWithRawResponse(self._degrees.cards)
...
class DegreesResourceWithStreamingResponse:
    ...
    def cards(self) -> CardsResourceWithStreamingResponse:
        return CardsResourceWithStreamingResponse(self._degrees.cards)
...
class AsyncDegreesResourceWithStreamingResponse:
    ...
    def cards(self) -> AsyncCardsResourceWithStreamingResponse:
        return AsyncCardsResourceWithStreamingResponse(self._degrees.cards)
