...
__all__ = [
    ...
    "CardsFieldsEventIdentifier",
    "CardsFieldsEventLocationIdentifier",
    "CardsFieldsParticipantIdentifier",
    "CardsParticipant",
    "CardsParticipantIdentifier",
    "CardsParticipantCategory",
    "CardsParticipantCategoryGroup",
    "CardsParticipantClosedOn",
    "CardsParticipantDelistedOn",
    "CardsParticipantDiversitySpotlight",
    "CardsParticipantEquityFundingTotal",
    "CardsParticipantExitedOn",
    "CardsParticipantFacebook",
    "CardsParticipantFoundedOn",
    "CardsParticipantFounderIdentifier",
    "CardsParticipantFundingTotal",
    "CardsParticipantInvestorIdentifier",
    "CardsParticipantLastEquityFundingTotal",
    "CardsParticipantLastFundingTotal",
    "CardsParticipantLinkedin",
    "CardsParticipantLocationGroupIdentifier",
    "CardsParticipantLocationIdentifier",
    "CardsParticipantPrimaryOrganization",
    "CardsParticipantStockSymbol",
    "CardsParticipantTwitter",
    "CardsParticipantWebsite",
    "Properties",
    "PropertiesIdentifier",
    "PropertiesEventIdentifier",
    "PropertiesEventLocationIdentifier",
    "PropertiesParticipantIdentifier",
]
...
class CardsFieldsEventIdentifier(BaseModel):
    entity_def_id: str
...
class CardsFieldsEventLocationIdentifier(BaseModel):
    entity_def_id: str
    """What type of entity this be"""
...
class CardsFieldsParticipantIdentifier(BaseModel):
    entity_def_id: str
...
class CardsFields(BaseModel):
    ...
    event_identifier: Optional[CardsFieldsEventIdentifier] = None
    """
    Every entity in the system has a unique identifier that contains all necessary
    properties to represent it.
    """

    event_location_identifiers: Optional[List[CardsFieldsEventLocationIdentifier]] = None
    """Location of the Event (e.g. Japan, San Francisco, Europe, Asia)"""
    ...
    participant_identifier: Optional[CardsFieldsParticipantIdentifier] = None
    """
    Every entity in the system has a unique identifier that contains all necessary
    properties to represent it.
    """
...
class CardsParticipantIdentifier(BaseModel):
    entity_def_id: str
...
class CardsParticipantCategory(BaseModel):
    entity_def_id: str
...
class CardsParticipantCategoryGroup(BaseModel):
    entity_def_id: str
...
class CardsParticipantClosedOn(BaseModel):
    precision: str

    value: Optional[date] = None


class CardsParticipantDelistedOn(BaseModel):
    precision: str

    value: Optional[date] = None


class CardsParticipantDiversitySpotlight(BaseModel):
    entity_def_id: str
...
class CardsParticipantEquityFundingTotal(BaseModel):
    currency: Literal[
        "AED",
        "AFN",
        "ALL",
...
class CardsParticipantExitedOn(BaseModel):
    precision: str

    value: Optional[date] = None


class CardsParticipantFacebook(BaseModel):
    label: Optional[str] = None

    value: Optional[str] = None


class CardsParticipantFoundedOn(BaseModel):
    precision: str

    value: Optional[date] = None


class CardsParticipantFounderIdentifier(BaseModel):
    entity_def_id: str
...
class CardsParticipantFundingTotal(BaseModel):
    currency: Literal[
        "AED",
        "AFN",
        "ALL",
...
class CardsParticipantInvestorIdentifier(BaseModel):
    entity_def_id: str
...
class CardsParticipantLastEquityFundingTotal(BaseModel):
    currency: Literal[
        "AED",
        "AFN",
        "ALL",
...
class CardsParticipantLastFundingTotal(BaseModel):
    currency: Literal[
        "AED",
        "AFN",
        "ALL",
...
class CardsParticipantLinkedin(BaseModel):
    label: Optional[str] = None

    value: Optional[str] = None


class CardsParticipantLocationGroupIdentifier(BaseModel):
    entity_def_id: str
    """What type of entity this be"""
...
class CardsParticipantLocationIdentifier(BaseModel):
    entity_def_id: str
    """What type of entity this be"""
...
class CardsParticipantPrimaryOrganization(BaseModel):
    entity_def_id: str
...
class CardsParticipantStockSymbol(BaseModel):
    entity_def_id: str
...
class CardsParticipantTwitter(BaseModel):
    label: Optional[str] = None

    value: Optional[str] = None


class CardsParticipantWebsite(BaseModel):
    label: Optional[str] = None

    value: Optional[str] = None


class CardsParticipant(BaseModel):
    identifier: CardsParticipantIdentifier
    """
    Every entity in the system has a unique identifier that contains all necessary
    properties to represent it.
    """
    ...
    categories: Optional[List[CardsParticipantCategory]] = None
    """Descriptive keyword for an Organization (e.g.

    SaaS, Android, Cloud Computing, Medical Device)
    """

    category_groups: Optional[List[CardsParticipantCategoryGroup]] = None
    """Superset of Industries (e.g. Software, Mobile, Health Care)"""

    closed_on: Optional[CardsParticipantClosedOn] = None
    ...
    delisted_on: Optional[CardsParticipantDelistedOn] = None
    """A field that will contain date information up to a certain level of precision.
    ...
    diversity_spotlights: Optional[List[CardsParticipantDiversitySpotlight]] = None
    """
    ...
    equity_funding_total: Optional[CardsParticipantEquityFundingTotal] = None
    """A field that will contain date information up to a certain level of precision.

    E.g. month, day, etc.
    """

    exited_on: Optional[CardsParticipantExitedOn] = None
    """A field that will contain date information up to a certain level of precision.

    E.g. month, day, etc.
    """

    facebook: Optional[CardsParticipantFacebook] = None
    """An object representing both the url and some labeling text for that url"""
    ...
    founded_on: Optional[CardsParticipantFoundedOn] = None
    """A field that will contain date information up to a certain level of precision.

    E.g. month, day, etc.
    """

    founder_identifiers: Optional[List[CardsParticipantFounderIdentifier]] = None
    ...
    funding_total: Optional[CardsParticipantFundingTotal] = None
    """A field that will contain date information up to a certain level of precision.
    ...
    investor_identifiers: Optional[List[CardsParticipantInvestorIdentifier]] = None
    """
    ...
    last_equity_funding_total: Optional[CardsParticipantLastEquityFundingTotal] = None
    """A field that will contain date information up to a certain level of precision.
    ...
    last_funding_total: Optional[CardsParticipantLastFundingTotal] = None
    """A field that will contain date information up to a certain level of precision.
    ...
    linkedin: Optional[CardsParticipantLinkedin] = None
    """An object representing both the url and some labeling text for that url"""

    location_group_identifiers: Optional[List[CardsParticipantLocationGroupIdentifier]] = None
    """Where the principal is located (e.g. San Francisco Bay Area, Silicon Valley)"""

    location_identifiers: Optional[List[CardsParticipantLocationIdentifier]] = None
    ...
    primary_organization: Optional[CardsParticipantPrimaryOrganization] = None
    """
    Every entity in the system has a unique identifier that contains all necessary
    properties to represent it.
    """
    ...
    stock_symbol: Optional[CardsParticipantStockSymbol] = None
    """
    Every entity in the system has a unique identifier that contains all necessary
    properties to represent it.
    """

    twitter: Optional[CardsParticipantTwitter] = None
    """An object representing both the url and some labeling text for that url"""
    ...
    website: Optional[CardsParticipantWebsite] = None
    """An object representing both the url and some labeling text for that url"""
...
class Cards(BaseModel):
    ...
    participant: Optional[List[CardsParticipant]] = None
...
class PropertiesEventIdentifier(BaseModel):
    entity_def_id: str
...
class PropertiesEventLocationIdentifier(BaseModel):
    entity_def_id: str
    """What type of entity this be"""
...
class PropertiesParticipantIdentifier(BaseModel):
    entity_def_id: str
...
class Properties(BaseModel):
    ...
    event_identifier: Optional[PropertiesEventIdentifier] = None
    """
    Every entity in the system has a unique identifier that contains all necessary
    properties to represent it.
    """

    event_location_identifiers: Optional[List[PropertiesEventLocationIdentifier]] = None
    """Location of the Event (e.g. Japan, San Francisco, Europe, Asia)"""
    ...
    participant_identifier: Optional[PropertiesParticipantIdentifier] = None
    """
    Every entity in the system has a unique identifier that contains all necessary
    properties to represent it.
    """
...
class EventAppearanceRetrieveResponse(BaseModel):
