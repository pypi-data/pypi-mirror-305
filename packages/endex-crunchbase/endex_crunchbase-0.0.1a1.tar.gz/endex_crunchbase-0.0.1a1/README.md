# Endex Crunchbase Python API library
...
While you can provide a `cb_user_key` keyword argument,
...
You can enable logging by setting the environment variable `ENDEX_CRUNCHBASE_LOG` to `debug`.
