...
class TestCategoryGroups:
    ...
    def test_method_retrieve(self, client: EndexCrunchbase) -> None:
        category_group = client.data.entities.category_groups.retrieve(
            entity_id="entity_id",
        )
        assert_matches_type(CategoryGroupRetrieveResponse, category_group, path=["response"])
    ...
    def test_raw_response_retrieve(self, client: EndexCrunchbase) -> None:
        response = client.data.entities.category_groups.with_raw_response.retrieve(
            entity_id="entity_id",
        )

        assert response.is_closed is True
        assert response.http_request.headers.get("X-Stainless-Lang") == "python"
        category_group = response.parse()
        assert_matches_type(CategoryGroupRetrieveResponse, category_group, path=["response"])

    @parametrize
    def test_streaming_response_retrieve(self, client: EndexCrunchbase) -> None:
        with client.data.entities.category_groups.with_streaming_response.retrieve(
            entity_id="entity_id",
        ) as response:
    ...
    def test_path_params_retrieve(self, client: EndexCrunchbase) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `entity_id` but received ''"):
            client.data.entities.category_groups.with_raw_response.retrieve(
                entity_id="",
            )
...
class TestAsyncCategoryGroups:
    ...
    async def test_method_retrieve(self, async_client: AsyncEndexCrunchbase) -> None:
        category_group = await async_client.data.entities.category_groups.retrieve(
            entity_id="entity_id",
        )
        assert_matches_type(CategoryGroupRetrieveResponse, category_group, path=["response"])
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncEndexCrunchbase) -> None:
        response = await async_client.data.entities.category_groups.with_raw_response.retrieve(
            entity_id="entity_id",
        )

        assert response.is_closed is True
        assert response.http_request.headers.get("X-Stainless-Lang") == "python"
        category_group = await response.parse()
        assert_matches_type(CategoryGroupRetrieveResponse, category_group, path=["response"])

    @parametrize
    async def test_streaming_response_retrieve(self, async_client: AsyncEndexCrunchbase) -> None:
        async with async_client.data.entities.category_groups.with_streaming_response.retrieve(
            entity_id="entity_id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_retrieve(self, async_client: AsyncEndexCrunchbase) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `entity_id` but received ''"):
            await async_client.data.entities.category_groups.with_raw_response.retrieve(
                entity_id="",
            )
