...
class TestCategoryGroups:
    ...
    def test_method_create(self, client: EndexCrunchbase) -> None:
        category_group = client.data.searches.category_groups.create(
        ...
        assert_matches_type(CategoryGroupCreateResponse, category_group, path=["response"])
    ...
    def test_raw_response_create(self, client: EndexCrunchbase) -> None:
        response = client.data.searches.category_groups.with_raw_response.create(
            field_ids=["string", "string", "string"],
            query=[
                {
                    "field_id": "field_id",
    ...
    def test_streaming_response_create(self, client: EndexCrunchbase) -> None:
        with client.data.searches.category_groups.with_streaming_response.create(
            field_ids=["string", "string", "string"],
            query=[
                {
                    "field_id": "field_id",
...
class TestAsyncCategoryGroups:
    ...
    async def test_method_create(self, async_client: AsyncEndexCrunchbase) -> None:
        category_group = await async_client.data.searches.category_groups.create(
            field_ids=["string", "string", "string"],
            query=[
                {
                    "field_id": "field_id",
    ...
    async def test_raw_response_create(self, async_client: AsyncEndexCrunchbase) -> None:
        response = await async_client.data.searches.category_groups.with_raw_response.create(
            field_ids=["string", "string", "string"],
            query=[
                {
                    "field_id": "field_id",
    ...
    async def test_streaming_response_create(self, async_client: AsyncEndexCrunchbase) -> None:
        async with async_client.data.searches.category_groups.with_streaming_response.create(
            field_ids=["string", "string", "string"],
            query=[
                {
                    "field_id": "field_id",
