...
class TestKeyEmployeeChanges:
    ...
    def test_method_create(self, client: EndexCrunchbase) -> None:
        key_employee_change = client.data.searches.key_employee_changes.create(
        ...
        assert_matches_type(KeyEmployeeChangeCreateResponse, key_employee_change, path=["response"])
    ...
    def test_raw_response_create(self, client: EndexCrunchbase) -> None:
        response = client.data.searches.key_employee_changes.with_raw_response.create(
            field_ids=["string", "string", "string"],
            query=[
                {
                    "field_id": "field_id",
    ...
    def test_streaming_response_create(self, client: EndexCrunchbase) -> None:
        with client.data.searches.key_employee_changes.with_streaming_response.create(
            field_ids=["string", "string", "string"],
            query=[
                {
                    "field_id": "field_id",
...
class TestAsyncKeyEmployeeChanges:
    ...
    async def test_method_create(self, async_client: AsyncEndexCrunchbase) -> None:
        key_employee_change = await async_client.data.searches.key_employee_changes.create(
            field_ids=["string", "string", "string"],
            query=[
                {
                    "field_id": "field_id",
    ...
    async def test_raw_response_create(self, async_client: AsyncEndexCrunchbase) -> None:
        response = await async_client.data.searches.key_employee_changes.with_raw_response.create(
            field_ids=["string", "string", "string"],
            query=[
                {
                    "field_id": "field_id",
    ...
    async def test_streaming_response_create(self, async_client: AsyncEndexCrunchbase) -> None:
        async with async_client.data.searches.key_employee_changes.with_streaming_response.create(
            field_ids=["string", "string", "string"],
            query=[
                {
                    "field_id": "field_id",
