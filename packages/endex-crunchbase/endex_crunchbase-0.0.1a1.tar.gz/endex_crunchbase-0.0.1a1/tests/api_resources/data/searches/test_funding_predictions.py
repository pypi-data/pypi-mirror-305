...
class TestFundingPredictions:
    ...
    def test_method_create(self, client: EndexCrunchbase) -> None:
        funding_prediction = client.data.searches.funding_predictions.create(
        ...
        assert_matches_type(FundingPredictionCreateResponse, funding_prediction, path=["response"])
    ...
    def test_raw_response_create(self, client: EndexCrunchbase) -> None:
        response = client.data.searches.funding_predictions.with_raw_response.create(
            field_ids=["string", "string", "string"],
            query=[
                {
                    "field_id": "field_id",
    ...
    def test_streaming_response_create(self, client: EndexCrunchbase) -> None:
        with client.data.searches.funding_predictions.with_streaming_response.create(
            field_ids=["string", "string", "string"],
            query=[
                {
                    "field_id": "field_id",
...
class TestAsyncFundingPredictions:
    ...
    async def test_method_create(self, async_client: AsyncEndexCrunchbase) -> None:
        funding_prediction = await async_client.data.searches.funding_predictions.create(
            field_ids=["string", "string", "string"],
            query=[
                {
                    "field_id": "field_id",
    ...
    async def test_raw_response_create(self, async_client: AsyncEndexCrunchbase) -> None:
        response = await async_client.data.searches.funding_predictions.with_raw_response.create(
            field_ids=["string", "string", "string"],
            query=[
                {
                    "field_id": "field_id",
    ...
    async def test_streaming_response_create(self, async_client: AsyncEndexCrunchbase) -> None:
        async with async_client.data.searches.funding_predictions.with_streaming_response.create(
            field_ids=["string", "string", "string"],
            query=[
                {
                    "field_id": "field_id",
