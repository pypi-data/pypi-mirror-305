...
class TestIpos:
    ...
    def test_method_create(self, client: EndexCrunchbase) -> None:
        ipo = client.data.searches.ipos.create(
        ...
        assert_matches_type(IpoCreateResponse, ipo, path=["response"])
    ...
    def test_raw_response_create(self, client: EndexCrunchbase) -> None:
        response = client.data.searches.ipos.with_raw_response.create(
            field_ids=["string", "string", "string"],
            query=[
                {
                    "field_id": "field_id",
    ...
    def test_streaming_response_create(self, client: EndexCrunchbase) -> None:
        with client.data.searches.ipos.with_streaming_response.create(
            field_ids=["string", "string", "string"],
            query=[
                {
                    "field_id": "field_id",
...
class TestAsyncIpos:
    ...
    async def test_method_create(self, async_client: AsyncEndexCrunchbase) -> None:
        ipo = await async_client.data.searches.ipos.create(
            field_ids=["string", "string", "string"],
            query=[
                {
                    "field_id": "field_id",
    ...
    async def test_raw_response_create(self, async_client: AsyncEndexCrunchbase) -> None:
        response = await async_client.data.searches.ipos.with_raw_response.create(
            field_ids=["string", "string", "string"],
            query=[
                {
                    "field_id": "field_id",
    ...
    async def test_streaming_response_create(self, async_client: AsyncEndexCrunchbase) -> None:
        async with async_client.data.searches.ipos.with_streaming_response.create(
            field_ids=["string", "string", "string"],
            query=[
                {
                    "field_id": "field_id",
