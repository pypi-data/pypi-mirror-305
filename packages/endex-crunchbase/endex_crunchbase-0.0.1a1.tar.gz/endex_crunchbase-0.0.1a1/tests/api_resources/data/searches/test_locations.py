...
class TestLocations:
    ...
    def test_method_create(self, client: EndexCrunchbase) -> None:
        location = client.data.searches.locations.create(
    ...
    def test_raw_response_create(self, client: EndexCrunchbase) -> None:
        response = client.data.searches.locations.with_raw_response.create(
            field_ids=["string", "string", "string"],
            query=[
                {
                    "field_id": "field_id",
    ...
    def test_streaming_response_create(self, client: EndexCrunchbase) -> None:
        with client.data.searches.locations.with_streaming_response.create(
            field_ids=["string", "string", "string"],
            query=[
                {
                    "field_id": "field_id",
...
class TestAsyncLocations:
    ...
    async def test_method_create(self, async_client: AsyncEndexCrunchbase) -> None:
        location = await async_client.data.searches.locations.create(
            field_ids=["string", "string", "string"],
            query=[
                {
                    "field_id": "field_id",
    ...
    async def test_raw_response_create(self, async_client: AsyncEndexCrunchbase) -> None:
        response = await async_client.data.searches.locations.with_raw_response.create(
            field_ids=["string", "string", "string"],
            query=[
                {
                    "field_id": "field_id",
    ...
    async def test_streaming_response_create(self, async_client: AsyncEndexCrunchbase) -> None:
        async with async_client.data.searches.locations.with_streaming_response.create(
            field_ids=["string", "string", "string"],
            query=[
                {
                    "field_id": "field_id",
