...
class TestInvestorInsights:
    ...
    def test_method_create(self, client: EndexCrunchbase) -> None:
        investor_insight = client.data.searches.investor_insights.create(
        ...
        assert_matches_type(InvestorInsightCreateResponse, investor_insight, path=["response"])
    ...
    def test_raw_response_create(self, client: EndexCrunchbase) -> None:
        response = client.data.searches.investor_insights.with_raw_response.create(
            field_ids=["string", "string", "string"],
            query=[
                {
                    "field_id": "field_id",
    ...
    def test_streaming_response_create(self, client: EndexCrunchbase) -> None:
        with client.data.searches.investor_insights.with_streaming_response.create(
            field_ids=["string", "string", "string"],
            query=[
                {
                    "field_id": "field_id",
...
class TestAsyncInvestorInsights:
    ...
    async def test_method_create(self, async_client: AsyncEndexCrunchbase) -> None:
        investor_insight = await async_client.data.searches.investor_insights.create(
            field_ids=["string", "string", "string"],
            query=[
                {
                    "field_id": "field_id",
    ...
    async def test_raw_response_create(self, async_client: AsyncEndexCrunchbase) -> None:
        response = await async_client.data.searches.investor_insights.with_raw_response.create(
            field_ids=["string", "string", "string"],
            query=[
                {
                    "field_id": "field_id",
    ...
    async def test_streaming_response_create(self, async_client: AsyncEndexCrunchbase) -> None:
        async with async_client.data.searches.investor_insights.with_streaming_response.create(
            field_ids=["string", "string", "string"],
            query=[
                {
                    "field_id": "field_id",
