...
class TestKeyEmployeeChanges:
    parametrize = pytest.mark.parametrize("client", [False, True], indirect=True, ids=["loose", "strict"])

    @parametrize
    def test_method_retrieve(self, client: EndexCrunchbase) -> None:
        key_employee_change = client.entities.key_employee_changes.retrieve(
            entity_id="entity_id",
        )
        assert_matches_type(KeyEmployeeChangeRetrieveResponse, key_employee_change, path=["response"])
    ...
    def test_raw_response_retrieve(self, client: EndexCrunchbase) -> None:
        response = client.entities.key_employee_changes.with_raw_response.retrieve(
            entity_id="entity_id",
        )

        assert response.is_closed is True
        assert response.http_request.headers.get("X-Stainless-Lang") == "python"
        key_employee_change = response.parse()
        assert_matches_type(KeyEmployeeChangeRetrieveResponse, key_employee_change, path=["response"])

    @parametrize
    def test_streaming_response_retrieve(self, client: EndexCrunchbase) -> None:
        with client.entities.key_employee_changes.with_streaming_response.retrieve(
            entity_id="entity_id",
        ) as response:
    ...
    def test_path_params_retrieve(self, client: EndexCrunchbase) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `entity_id` but received ''"):
            client.entities.key_employee_changes.with_raw_response.retrieve(
                entity_id="",
            )


class TestAsyncKeyEmployeeChanges:
    parametrize = pytest.mark.parametrize("async_client", [False, True], indirect=True, ids=["loose", "strict"])

    @parametrize
    async def test_method_retrieve(self, async_client: AsyncEndexCrunchbase) -> None:
        key_employee_change = await async_client.entities.key_employee_changes.retrieve(
            entity_id="entity_id",
        )
        assert_matches_type(KeyEmployeeChangeRetrieveResponse, key_employee_change, path=["response"])
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncEndexCrunchbase) -> None:
        response = await async_client.entities.key_employee_changes.with_raw_response.retrieve(
            entity_id="entity_id",
        )

        assert response.is_closed is True
        assert response.http_request.headers.get("X-Stainless-Lang") == "python"
        key_employee_change = await response.parse()
        assert_matches_type(KeyEmployeeChangeRetrieveResponse, key_employee_change, path=["response"])

    @parametrize
    async def test_streaming_response_retrieve(self, async_client: AsyncEndexCrunchbase) -> None:
        async with async_client.entities.key_employee_changes.with_streaming_response.retrieve(
            entity_id="entity_id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_retrieve(self, async_client: AsyncEndexCrunchbase) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `entity_id` but received ''"):
            await async_client.entities.key_employee_changes.with_raw_response.retrieve(
                entity_id="",
            )
