...
class TestProducts:
    ...
    def test_method_retrieve(self, client: EndexCrunchbase) -> None:
        product = client.entities.products.retrieve(
            entity_id="entity_id",
        )
    ...
    def test_raw_response_retrieve(self, client: EndexCrunchbase) -> None:
        response = client.entities.products.with_raw_response.retrieve(
            entity_id="entity_id",
        )
    ...
    def test_streaming_response_retrieve(self, client: EndexCrunchbase) -> None:
        with client.entities.products.with_streaming_response.retrieve(
            entity_id="entity_id",
        ) as response:
    ...
    def test_path_params_retrieve(self, client: EndexCrunchbase) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `entity_id` but received ''"):
            client.entities.products.with_raw_response.retrieve(
                entity_id="",
            )
...
class TestAsyncProducts:
    ...
    async def test_method_retrieve(self, async_client: AsyncEndexCrunchbase) -> None:
        product = await async_client.entities.products.retrieve(
            entity_id="entity_id",
        )
        assert_matches_type(ProductRetrieveResponse, product, path=["response"])
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncEndexCrunchbase) -> None:
        response = await async_client.entities.products.with_raw_response.retrieve(
            entity_id="entity_id",
        )
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncEndexCrunchbase) -> None:
        async with async_client.entities.products.with_streaming_response.retrieve(
            entity_id="entity_id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_retrieve(self, async_client: AsyncEndexCrunchbase) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `entity_id` but received ''"):
            await async_client.entities.products.with_raw_response.retrieve(
                entity_id="",
            )
