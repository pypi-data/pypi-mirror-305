...
class TestIpoPredictions:
    parametrize = pytest.mark.parametrize("client", [False, True], indirect=True, ids=["loose", "strict"])

    @parametrize
    def test_method_retrieve(self, client: EndexCrunchbase) -> None:
        ipo_prediction = client.entities.ipo_predictions.retrieve(
            entity_id="entity_id",
        )
        assert_matches_type(IpoPredictionRetrieveResponse, ipo_prediction, path=["response"])
    ...
    def test_raw_response_retrieve(self, client: EndexCrunchbase) -> None:
        response = client.entities.ipo_predictions.with_raw_response.retrieve(
            entity_id="entity_id",
        )

        assert response.is_closed is True
        assert response.http_request.headers.get("X-Stainless-Lang") == "python"
        ipo_prediction = response.parse()
        assert_matches_type(IpoPredictionRetrieveResponse, ipo_prediction, path=["response"])

    @parametrize
    def test_streaming_response_retrieve(self, client: EndexCrunchbase) -> None:
        with client.entities.ipo_predictions.with_streaming_response.retrieve(
            entity_id="entity_id",
        ) as response:
    ...
    def test_path_params_retrieve(self, client: EndexCrunchbase) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `entity_id` but received ''"):
            client.entities.ipo_predictions.with_raw_response.retrieve(
                entity_id="",
            )


class TestAsyncIpoPredictions:
    parametrize = pytest.mark.parametrize("async_client", [False, True], indirect=True, ids=["loose", "strict"])

    @parametrize
    async def test_method_retrieve(self, async_client: AsyncEndexCrunchbase) -> None:
        ipo_prediction = await async_client.entities.ipo_predictions.retrieve(
            entity_id="entity_id",
        )
        assert_matches_type(IpoPredictionRetrieveResponse, ipo_prediction, path=["response"])
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncEndexCrunchbase) -> None:
        response = await async_client.entities.ipo_predictions.with_raw_response.retrieve(
            entity_id="entity_id",
        )

        assert response.is_closed is True
        assert response.http_request.headers.get("X-Stainless-Lang") == "python"
        ipo_prediction = await response.parse()
        assert_matches_type(IpoPredictionRetrieveResponse, ipo_prediction, path=["response"])

    @parametrize
    async def test_streaming_response_retrieve(self, async_client: AsyncEndexCrunchbase) -> None:
        async with async_client.entities.ipo_predictions.with_streaming_response.retrieve(
            entity_id="entity_id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_retrieve(self, async_client: AsyncEndexCrunchbase) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `entity_id` but received ''"):
            await async_client.entities.ipo_predictions.with_raw_response.retrieve(
                entity_id="",
            )
