...
class CardsFieldsOwneeIdentifier(BaseModel):
    entity_def_id: str
...
class CardsFields(BaseModel):
    ...
    ownee_identifier: Optional[CardsFieldsOwneeIdentifier] = None
    """
    Every entity in the system has a unique identifier that contains all necessary
    properties to represent it.
    """
...
class Cards(BaseModel):
    child_organization: Optional[List[CardsChildOrganization]] = None
...
class PropertiesOwneeIdentifier(BaseModel):
    entity_def_id: str
...
class Properties(BaseModel):
    ...
    ownee_identifier: Optional[PropertiesOwneeIdentifier] = None
    """
    Every entity in the system has a unique identifier that contains all necessary
    properties to represent it.
    """
...
class OwnershipRetrieveResponse(BaseModel):
