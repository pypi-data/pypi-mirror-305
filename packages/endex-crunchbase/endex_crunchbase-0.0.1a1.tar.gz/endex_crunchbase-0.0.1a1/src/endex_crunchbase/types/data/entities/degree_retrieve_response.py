...
__all__ = [
    "DegreeRetrieveResponse",
    "Cards",
    "CardsFields",
    "CardsFieldsIdentifier",
    "CardsFieldsCompletedOn",
    "CardsFieldsPersonIdentifier",
    "CardsFieldsSchoolIdentifier",
    ...
    "CardsPerson",
    "CardsPersonIdentifier",
    "CardsPersonFacebook",
    "CardsPersonLinkedin",
    "CardsPersonLocationGroupIdentifier",
    "CardsPersonLocationIdentifier",
    "CardsPersonPrimaryOrganization",
    "CardsPersonTwitter",
    "CardsPersonWebsite",
    "Properties",
    "PropertiesIdentifier",
    "PropertiesCompletedOn",
    "PropertiesPersonIdentifier",
    "PropertiesSchoolIdentifier",
    "PropertiesStartedOn",
]
...
class CardsFieldsPersonIdentifier(BaseModel):
    entity_def_id: str
...
class CardsFieldsSchoolIdentifier(BaseModel):
    entity_def_id: str
...
class CardsFields(BaseModel):
    ...
    person_identifier: Optional[CardsFieldsPersonIdentifier] = None
    """
    Every entity in the system has a unique identifier that contains all necessary
    properties to represent it.
    """

    school_identifier: Optional[CardsFieldsSchoolIdentifier] = None
    """
    Every entity in the system has a unique identifier that contains all necessary
    properties to represent it.
    """
...
class CardsPersonIdentifier(BaseModel):
    entity_def_id: str
...
class CardsPersonFacebook(BaseModel):
    label: Optional[str] = None

    value: Optional[str] = None


class CardsPersonLinkedin(BaseModel):
    label: Optional[str] = None

    value: Optional[str] = None


class CardsPersonLocationGroupIdentifier(BaseModel):
    entity_def_id: str
    """What type of entity this be"""
...
class CardsPersonLocationIdentifier(BaseModel):
    entity_def_id: str
    """What type of entity this be"""
...
class CardsPersonPrimaryOrganization(BaseModel):
    entity_def_id: str
...
class CardsPersonTwitter(BaseModel):
    label: Optional[str] = None

    value: Optional[str] = None


class CardsPersonWebsite(BaseModel):
    label: Optional[str] = None

    value: Optional[str] = None


class CardsPerson(BaseModel):
    identifier: CardsPersonIdentifier
    """
    Every entity in the system has a unique identifier that contains all necessary
    properties to represent it.
    """
    ...
    facebook: Optional[CardsPersonFacebook] = None
    """An object representing both the url and some labeling text for that url"""
    ...
    linkedin: Optional[CardsPersonLinkedin] = None
    """An object representing both the url and some labeling text for that url"""

    location_group_identifiers: Optional[List[CardsPersonLocationGroupIdentifier]] = None
    """Where the person is located (e.g. San Francisco Bay Area, Silicon Valley)"""

    location_identifiers: Optional[List[CardsPersonLocationIdentifier]] = None
    ...
    primary_organization: Optional[CardsPersonPrimaryOrganization] = None
    """
    Every entity in the system has a unique identifier that contains all necessary
    properties to represent it.
    """
    ...
    twitter: Optional[CardsPersonTwitter] = None
    """An object representing both the url and some labeling text for that url"""
    ...
    website: Optional[CardsPersonWebsite] = None
    """An object representing both the url and some labeling text for that url"""
...
class Cards(BaseModel):
    ...
    person: Optional[List[CardsPerson]] = None
...
class PropertiesPersonIdentifier(BaseModel):
    entity_def_id: str
...
class PropertiesSchoolIdentifier(BaseModel):
    entity_def_id: str
...
class Properties(BaseModel):
    ...
    person_identifier: Optional[PropertiesPersonIdentifier] = None
    """
    Every entity in the system has a unique identifier that contains all necessary
    properties to represent it.
    """

    school_identifier: Optional[PropertiesSchoolIdentifier] = None
    """
    Every entity in the system has a unique identifier that contains all necessary
    properties to represent it.
    """
...
class DegreeRetrieveResponse(BaseModel):
