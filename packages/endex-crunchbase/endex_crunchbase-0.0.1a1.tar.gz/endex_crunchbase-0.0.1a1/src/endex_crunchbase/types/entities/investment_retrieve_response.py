...
__all__ = [
    "InvestmentRetrieveResponse",
    "Cards",
    "CardsFields",
    "CardsFieldsIdentifier",
    "CardsFieldsFundingRoundIdentifier",
    "CardsFieldsFundingRoundMoneyRaised",
    "CardsFieldsInvestorIdentifier",
    "CardsFieldsMoneyInvested",
    "CardsFieldsOrganizationDiversitySpotlight",
    "CardsFieldsOrganizationIdentifier",
    "CardsFieldsPartnerIdentifier",
    "CardsFundingRound",
    "CardsFundingRoundIdentifier",
    "CardsFundingRoundClosedOn",
    "CardsFundingRoundFundedOrganizationCategory",
    "CardsFundingRoundFundedOrganizationDiversitySpotlight",
    "CardsFundingRoundFundedOrganizationFundingTotal",
    "CardsFundingRoundFundedOrganizationIdentifier",
    "CardsFundingRoundFundedOrganizationLocation",
    "CardsFundingRoundInvestorIdentifier",
    "CardsFundingRoundLeadInvestorIdentifier",
    "CardsFundingRoundMoneyRaised",
    "CardsFundingRoundPostMoneyValuation",
    "CardsFundingRoundPreMoneyValuation",
    "CardsFundingRoundTargetMoneyRaised",
    "CardsInvestor",
    ...
    "PropertiesFundingRoundIdentifier",
    "PropertiesFundingRoundMoneyRaised",
    "PropertiesInvestorIdentifier",
    "PropertiesMoneyInvested",
    "PropertiesOrganizationDiversitySpotlight",
    "PropertiesOrganizationIdentifier",
    "PropertiesPartnerIdentifier",
]
...
class CardsFieldsFundingRoundIdentifier(BaseModel):
    entity_def_id: str
...
class CardsFieldsFundingRoundMoneyRaised(BaseModel):
    currency: Literal[
        "AED",
        "AFN",
        "ALL",
...
class CardsFieldsMoneyInvested(BaseModel):
    currency: Literal[
        "AED",
        "AFN",
        "ALL",
...
class CardsFieldsOrganizationDiversitySpotlight(BaseModel):
    entity_def_id: str
...
class CardsFieldsPartnerIdentifier(BaseModel):
    entity_def_id: str
...
class CardsFields(BaseModel):
    ...
    funding_round_identifier: Optional[CardsFieldsFundingRoundIdentifier] = None
    """
    Every entity in the system has a unique identifier that contains all necessary
    properties to represent it.
    """
    ...
    funding_round_money_raised: Optional[CardsFieldsFundingRoundMoneyRaised] = None
    """A field that will contain date information up to a certain level of precision.

    E.g. month, day, etc.
    """

    investor_identifier: Optional[CardsFieldsInvestorIdentifier] = None
    """
    Every entity in the system has a unique identifier that contains all necessary
    properties to represent it.
    """
    ...
    money_invested: Optional[CardsFieldsMoneyInvested] = None
    """A field that will contain date information up to a certain level of precision.
    ...
    organization_diversity_spotlights: Optional[List[CardsFieldsOrganizationDiversitySpotlight]] = None
    """
    ...
    partner_identifiers: Optional[List[CardsFieldsPartnerIdentifier]] = None
...
class CardsFundingRoundIdentifier(BaseModel):
    entity_def_id: str
...
class CardsFundingRoundClosedOn(BaseModel):
    precision: str

    value: Optional[date] = None


class CardsFundingRoundFundedOrganizationCategory(BaseModel):
    entity_def_id: str
...
class CardsFundingRoundFundedOrganizationDiversitySpotlight(BaseModel):
    entity_def_id: str
...
class CardsFundingRoundFundedOrganizationFundingTotal(BaseModel):
    currency: Literal[
        "AED",
        "AFN",
        "ALL",
...
class CardsFundingRoundFundedOrganizationIdentifier(BaseModel):
    entity_def_id: str
...
class CardsFundingRoundFundedOrganizationLocation(BaseModel):
    entity_def_id: str
...
class CardsFundingRoundInvestorIdentifier(BaseModel):
    entity_def_id: str
...
class CardsFundingRoundLeadInvestorIdentifier(BaseModel):
    entity_def_id: str
...
class CardsFundingRoundMoneyRaised(BaseModel):
    currency: Literal[
        "AED",
        "AFN",
        "ALL",
...
class CardsFundingRoundPostMoneyValuation(BaseModel):
    currency: Literal[
        "AED",
        "AFN",
        "ALL",
...
class CardsFundingRoundPreMoneyValuation(BaseModel):
    currency: Literal[
        "AED",
        "AFN",
        "ALL",
...
class CardsFundingRoundTargetMoneyRaised(BaseModel):
    currency: Literal[
        "AED",
        "AFN",
        "ALL",
...
class CardsFundingRound(BaseModel):
    identifier: CardsFundingRoundIdentifier
    """
    Every entity in the system has a unique identifier that contains all necessary
    properties to represent it.
    """
    ...
    closed_on: Optional[CardsFundingRoundClosedOn] = None
    """A field that will contain date information up to a certain level of precision.
    ...
    funded_organization_categories: Optional[List[CardsFundingRoundFundedOrganizationCategory]] = None
    ...
    funded_organization_diversity_spotlights: Optional[List[CardsFundingRoundFundedOrganizationDiversitySpotlight]] = (
        None
    )
    """
    Types of diversity represented in an organization, specifically of those who are
    ...
    funded_organization_funding_total: Optional[CardsFundingRoundFundedOrganizationFundingTotal] = None
    """A field that will contain date information up to a certain level of precision.

    E.g. month, day, etc.
    """

    funded_organization_identifier: Optional[CardsFundingRoundFundedOrganizationIdentifier] = None
    """
    Every entity in the system has a unique identifier that contains all necessary
    properties to represent it.
    """

    funded_organization_location: Optional[List[CardsFundingRoundFundedOrganizationLocation]] = None
    ...
    investor_identifiers: Optional[List[CardsFundingRoundInvestorIdentifier]] = None
    ...
    lead_investor_identifiers: Optional[List[CardsFundingRoundLeadInvestorIdentifier]] = None
    """Name of the investor who led the investment in the funding round"""

    money_raised: Optional[CardsFundingRoundMoneyRaised] = None
    """A field that will contain date information up to a certain level of precision.
    ...
    post_money_valuation: Optional[CardsFundingRoundPostMoneyValuation] = None
    """A field that will contain date information up to a certain level of precision.

    E.g. month, day, etc.
    """

    pre_money_valuation: Optional[CardsFundingRoundPreMoneyValuation] = None
    """A field that will contain date information up to a certain level of precision.
    ...
    target_money_raised: Optional[CardsFundingRoundTargetMoneyRaised] = None
    """A field that will contain date information up to a certain level of precision.
...
class Cards(BaseModel):
    ...
    funding_round: Optional[List[CardsFundingRound]] = None

    investor: Optional[List[CardsInvestor]] = None

    organization: Optional[List[CardsOrganization]] = None

    partner: Optional[List[CardsPartner]] = None
...
class PropertiesFundingRoundIdentifier(BaseModel):
    entity_def_id: str
...
class PropertiesFundingRoundMoneyRaised(BaseModel):
    currency: Literal[
        "AED",
        "AFN",
        "ALL",
...
class PropertiesMoneyInvested(BaseModel):
    currency: Literal[
        "AED",
        "AFN",
        "ALL",
...
class PropertiesOrganizationDiversitySpotlight(BaseModel):
    entity_def_id: str
...
class PropertiesPartnerIdentifier(BaseModel):
    entity_def_id: str
...
class Properties(BaseModel):
    ...
    funding_round_identifier: Optional[PropertiesFundingRoundIdentifier] = None
    """
    Every entity in the system has a unique identifier that contains all necessary
    properties to represent it.
    """
    ...
    funding_round_money_raised: Optional[PropertiesFundingRoundMoneyRaised] = None
    """A field that will contain date information up to a certain level of precision.

    E.g. month, day, etc.
    """

    investor_identifier: Optional[PropertiesInvestorIdentifier] = None
    """
    Every entity in the system has a unique identifier that contains all necessary
    properties to represent it.
    """
    ...
    money_invested: Optional[PropertiesMoneyInvested] = None
    """A field that will contain date information up to a certain level of precision.
    ...
    organization_diversity_spotlights: Optional[List[PropertiesOrganizationDiversitySpotlight]] = None
    """
    Types of diversity represented in an organization, specifically of those who are
    founding members, currently the CEO, or have check-writing abilities in an
    investment firm. This feature is in beta and may change with future updates.
    ...
    partner_identifiers: Optional[List[PropertiesPartnerIdentifier]] = None
    """Name of the individual who led a funding round for his/her firm"""
...
class InvestmentRetrieveResponse(BaseModel):
