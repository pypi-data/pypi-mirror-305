...
class CardsFieldsAmountRaised(BaseModel):
    currency: Literal[
        "AED",
        "AFN",
        "ALL",
...
class CardsFieldsSharePrice(BaseModel):
    currency: Literal[
        "AED",
        "AFN",
        "ALL",
...
class CardsFields(BaseModel):
    ...
    amount_raised: Optional[CardsFieldsAmountRaised] = None
    ...
    share_price: Optional[CardsFieldsSharePrice] = None
...
class PropertiesAmountRaised(BaseModel):
    currency: Literal[
        "AED",
        "AFN",
        "ALL",
...
class PropertiesSharePrice(BaseModel):
    currency: Literal[
        "AED",
        "AFN",
        "ALL",
...
class Properties(BaseModel):
    ...
    amount_raised: Optional[PropertiesAmountRaised] = None
    """A field that will contain date information up to a certain level of precision.
    ...
    share_price: Optional[PropertiesSharePrice] = None
    """A field containing decimal data that represents some amount of money"""
...
class IpoRetrieveResponse(BaseModel):
