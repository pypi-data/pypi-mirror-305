...
from ....types.entities.addresses import card_retrieve_params
from ....types.entities.addresses.card_retrieve_response import CardRetrieveResponse
...
class CardsResource(SyncAPIResource):
    ...
    def retrieve(
        ...
        *,
        ...
        """
        The following cards are available: [event, fields, organization]
        ...
        return self._get(
            f"/data/entities/addresses/{entity_id}/cards/{card_id}",
