...
from ....types.entities.event_appearances import card_retrieve_params
from ....types.entities.event_appearances.card_retrieve_response import CardRetrieveResponse
...
class CardsResource(SyncAPIResource):
    ...
    def retrieve(
        ...
        *,
        ...
        """
        The following cards are available: [event, fields, participant]
        ...
        return self._get(
            f"/data/entities/event_appearances/{entity_id}/cards/{card_id}",
