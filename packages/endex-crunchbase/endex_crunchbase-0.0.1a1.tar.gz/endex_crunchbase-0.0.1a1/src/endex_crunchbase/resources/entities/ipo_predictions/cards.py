...
from ....types.entities.ipo_predictions import card_retrieve_params
from ....types.entities.ipo_predictions.card_retrieve_response import CardRetrieveResponse
...
class CardsResource(SyncAPIResource):
    ...
    def retrieve(
        ...
        *,
        ...
        return self._get(
            f"/data/entities/ipo_predictions/{entity_id}/cards/{card_id}",
