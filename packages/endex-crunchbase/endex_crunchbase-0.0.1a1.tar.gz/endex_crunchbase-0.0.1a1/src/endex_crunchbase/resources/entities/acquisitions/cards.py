...
from ....types.entities.acquisitions import card_retrieve_params
from ....types.entities.acquisitions.card_retrieve_response import CardRetrieveResponse
...
class CardsResource(SyncAPIResource):
    ...
    def retrieve(
        ...
        *,
        ...
        """
        The following cards are available: [acquiree_organization,
        ...
        return self._get(
            f"/data/entities/acquisitions/{entity_id}/cards/{card_id}",
