...
from ....types.entities.ipos import card_retrieve_params
from ....types.entities.ipos.card_retrieve_response import CardRetrieveResponse
...
class CardsResource(SyncAPIResource):
    ...
    def retrieve(
        ...
        *,
        ...
        """
        The following cards are available: [fields, organization, press_references]
        ...
        return self._get(
            f"/data/entities/ipos/{entity_id}/cards/{card_id}",
