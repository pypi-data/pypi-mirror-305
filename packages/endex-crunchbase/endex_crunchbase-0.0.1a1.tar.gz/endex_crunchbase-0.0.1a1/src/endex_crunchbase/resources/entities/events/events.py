...
from ....types.entities import event_retrieve_params
from ....types.entities.event_retrieve_response import EventRetrieveResponse
        ...
        *,
        ...
        Args:
          card_ids: Cards to include on the resulting entity - array of card_id strings in JSON
              encoded as string Card Ids for Event: [address, appearances, contestants,
              exhibitors, fields, organizers, press_references, speakers, sponsors]
        ...
        return self._get(
            f"/data/entities/events/{entity_id}",
...
class EventsResourceWithRawResponse:
    ...
    def cards(self) -> CardsResourceWithRawResponse:
        return CardsResourceWithRawResponse(self._events.cards)
...
class AsyncEventsResourceWithRawResponse:
    ...
    def cards(self) -> AsyncCardsResourceWithRawResponse:
        return AsyncCardsResourceWithRawResponse(self._events.cards)
...
class EventsResourceWithStreamingResponse:
    ...
    def cards(self) -> CardsResourceWithStreamingResponse:
        return CardsResourceWithStreamingResponse(self._events.cards)
...
class AsyncEventsResourceWithStreamingResponse:
    ...
    def cards(self) -> AsyncCardsResourceWithStreamingResponse:
        return AsyncCardsResourceWithStreamingResponse(self._events.cards)
