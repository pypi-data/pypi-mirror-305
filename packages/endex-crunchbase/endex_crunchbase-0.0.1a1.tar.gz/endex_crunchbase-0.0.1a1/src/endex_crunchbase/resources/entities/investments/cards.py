...
from ....types.entities.investments import card_retrieve_params
from ....types.entities.investments.card_retrieve_response import CardRetrieveResponse
...
class CardsResource(SyncAPIResource):
    ...
    def retrieve(
        ...
        *,
        ...
        """
        The following cards are available: [fields, funding_round, investor,
        ...
        return self._get(
            f"/data/entities/investments/{entity_id}/cards/{card_id}",
