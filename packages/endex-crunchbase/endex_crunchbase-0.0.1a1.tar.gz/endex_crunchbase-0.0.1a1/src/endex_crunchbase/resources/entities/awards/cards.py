...
from ....types.entities.awards import card_retrieve_params
from ....types.entities.awards.card_retrieve_response import CardRetrieveResponse
...
class CardsResource(SyncAPIResource):
    ...
    def retrieve(
        ...
        *,
        ...
        return self._get(
            f"/data/entities/awards/{entity_id}/cards/{card_id}",
