...
from ....types.entities import investment_retrieve_params
from ....types.entities.investment_retrieve_response import InvestmentRetrieveResponse
...
class InvestmentsResource(SyncAPIResource):
    ...
    def retrieve(
        ...
        *,
        ...
        return self._get(
            f"/data/entities/investments/{entity_id}",
            options=make_request_options(
                ...
                query=maybe_transform(
                    ...
                    investment_retrieve_params.InvestmentRetrieveParams,
                ),
            ),
            cast_to=InvestmentRetrieveResponse,
        )
...
class InvestmentsResourceWithRawResponse:
    ...
    def cards(self) -> CardsResourceWithRawResponse:
        return CardsResourceWithRawResponse(self._investments.cards)
...
class AsyncInvestmentsResourceWithRawResponse:
    ...
    def cards(self) -> AsyncCardsResourceWithRawResponse:
        return AsyncCardsResourceWithRawResponse(self._investments.cards)
...
class InvestmentsResourceWithStreamingResponse:
    ...
    def cards(self) -> CardsResourceWithStreamingResponse:
        return CardsResourceWithStreamingResponse(self._investments.cards)
...
class AsyncInvestmentsResourceWithStreamingResponse:
    ...
    def cards(self) -> AsyncCardsResourceWithStreamingResponse:
        return AsyncCardsResourceWithStreamingResponse(self._investments.cards)
