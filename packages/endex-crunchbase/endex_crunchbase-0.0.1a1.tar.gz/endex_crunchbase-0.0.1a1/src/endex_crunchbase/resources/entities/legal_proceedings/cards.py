...
from ....types.entities.legal_proceedings import card_retrieve_params
from ....types.entities.legal_proceedings.card_retrieve_response import CardRetrieveResponse
...
class CardsResource(SyncAPIResource):
    ...
    def retrieve(
        ...
        *,
        ...
        return self._get(
            f"/data/entities/legal_proceedings/{entity_id}/cards/{card_id}",
