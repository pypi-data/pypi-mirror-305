...
from .....types.data.entities.funding_predictions import card_retrieve_params
from .....types.data.entities.funding_predictions.card_retrieve_response import CardRetrieveResponse
...
class CardsResource(SyncAPIResource):
    ...
    def retrieve(
        ...
        *,
        ...
        return self._get(
            f"/data/entities/funding_predictions/{entity_id}/cards/{card_id}",
