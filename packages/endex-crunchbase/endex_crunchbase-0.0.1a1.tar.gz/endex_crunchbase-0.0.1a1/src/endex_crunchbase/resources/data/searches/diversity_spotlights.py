...
from ....types.data.searches import diversity_spotlight_create_params
from ....types.data.searches.diversity_spotlight_create_response import DiversitySpotlightCreateResponse
...
class DiversitySpotlightsResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        field_ids: List[str],
        query: Iterable[diversity_spotlight_create_params.Query],
        after_id: str | NotGiven = NOT_GIVEN,
        before_id: str | NotGiven = NOT_GIVEN,
        limit: int | NotGiven = NOT_GIVEN,
        order: Iterable[diversity_spotlight_create_params.Order] | NotGiven = NOT_GIVEN,
    ...
    ) -> DiversitySpotlightCreateResponse:
        """
        ...
        return self._post(
            ...
            body=maybe_transform(
                ...
                diversity_spotlight_create_params.DiversitySpotlightCreateParams,
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=DiversitySpotlightCreateResponse,
        )
