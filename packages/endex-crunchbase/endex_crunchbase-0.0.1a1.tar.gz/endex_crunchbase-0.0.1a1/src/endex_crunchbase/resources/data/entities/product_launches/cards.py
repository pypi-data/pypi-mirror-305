...
from .....types.data.entities.product_launches import card_retrieve_params
from .....types.data.entities.product_launches.card_retrieve_response import CardRetrieveResponse
...
class CardsResource(SyncAPIResource):
    ...
    def retrieve(
        ...
        *,
        ...
        return self._get(
            f"/data/entities/product_launches/{entity_id}/cards/{card_id}",
