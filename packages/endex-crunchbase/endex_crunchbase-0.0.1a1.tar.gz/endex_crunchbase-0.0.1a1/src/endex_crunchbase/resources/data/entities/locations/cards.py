...
from .....types.data.entities.locations import card_retrieve_params
from .....types.data.entities.locations.card_retrieve_response import CardRetrieveResponse
...
class CardsResource(SyncAPIResource):
    ...
    def retrieve(
        ...
        *,
        ...
        return self._get(
            f"/data/entities/locations/{entity_id}/cards/{card_id}",
