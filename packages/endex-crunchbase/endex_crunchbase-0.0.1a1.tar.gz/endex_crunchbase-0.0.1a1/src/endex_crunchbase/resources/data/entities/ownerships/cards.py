...
from .....types.data.entities.ownerships import card_retrieve_params
from .....types.data.entities.ownerships.card_retrieve_response import CardRetrieveResponse
...
class CardsResource(SyncAPIResource):
    ...
    def retrieve(
        ...
        *,
        ...
        """
        The following cards are available: [child_organization, fields,
        ...
        return self._get(
            f"/data/entities/ownerships/{entity_id}/cards/{card_id}",
