...
from ....types.data.searches import location_create_params
from ....types.data.searches.location_create_response import LocationCreateResponse
...
class LocationsResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        field_ids: List[str],
        query: Iterable[location_create_params.Query],
        after_id: str | NotGiven = NOT_GIVEN,
        before_id: str | NotGiven = NOT_GIVEN,
        limit: int | NotGiven = NOT_GIVEN,
        order: Iterable[location_create_params.Order] | NotGiven = NOT_GIVEN,
        ...
        return self._post(
            ...
            cast_to=LocationCreateResponse,
        )
