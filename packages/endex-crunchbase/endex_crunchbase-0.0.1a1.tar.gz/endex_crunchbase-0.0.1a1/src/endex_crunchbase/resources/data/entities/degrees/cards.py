...
from .....types.data.entities.degrees import card_retrieve_params
from .....types.data.entities.degrees.card_retrieve_response import CardRetrieveResponse
...
class CardsResource(SyncAPIResource):
    ...
    def retrieve(
        ...
        *,
        ...
        """
        The following cards are available: [fields, organization, person]
        ...
        return self._get(
            f"/data/entities/degrees/{entity_id}/cards/{card_id}",
