...
from .....types.data.entities import ownership_retrieve_params
from .....types.data.entities.ownership_retrieve_response import OwnershipRetrieveResponse
        ...
        *,
        ...
        Args:
          card_ids: Cards to include on the resulting entity - array of card_id strings in JSON
              encoded as string Card Ids for Ownership: [child_organization, fields,
              parent_organization, press_references]
        ...
        return self._get(
            f"/data/entities/ownerships/{entity_id}",
            options=make_request_options(
                ...
                query=maybe_transform(
                    ...
                    ownership_retrieve_params.OwnershipRetrieveParams,
                ),
            ),
            cast_to=OwnershipRetrieveResponse,
        )
...
class OwnershipsResourceWithRawResponse:
    ...
    def cards(self) -> CardsResourceWithRawResponse:
        return CardsResourceWithRawResponse(self._ownerships.cards)
...
class AsyncOwnershipsResourceWithRawResponse:
    ...
    def cards(self) -> AsyncCardsResourceWithRawResponse:
        return AsyncCardsResourceWithRawResponse(self._ownerships.cards)
...
class OwnershipsResourceWithStreamingResponse:
    ...
    def cards(self) -> CardsResourceWithStreamingResponse:
        return CardsResourceWithStreamingResponse(self._ownerships.cards)
...
class AsyncOwnershipsResourceWithStreamingResponse:
    ...
    def cards(self) -> AsyncCardsResourceWithStreamingResponse:
        return AsyncCardsResourceWithStreamingResponse(self._ownerships.cards)
