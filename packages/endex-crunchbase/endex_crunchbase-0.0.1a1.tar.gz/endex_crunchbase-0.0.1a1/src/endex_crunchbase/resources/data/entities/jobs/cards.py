...
from .....types.data.entities.jobs import card_retrieve_params
from .....types.data.entities.jobs.card_retrieve_response import CardRetrieveResponse
...
class CardsResource(SyncAPIResource):
    ...
    def retrieve(
        ...
        *,
        ...
        return self._get(
            f"/data/entities/jobs/{entity_id}/cards/{card_id}",
