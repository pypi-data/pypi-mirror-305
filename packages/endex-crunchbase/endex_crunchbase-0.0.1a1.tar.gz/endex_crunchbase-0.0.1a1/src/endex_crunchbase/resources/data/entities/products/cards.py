...
from .....types.data.entities.products import card_retrieve_params
from .....types.data.entities.products.card_retrieve_response import CardRetrieveResponse
...
class CardsResource(SyncAPIResource):
    ...
    def retrieve(
        ...
        *,
        ...
        return self._get(
            f"/data/entities/products/{entity_id}/cards/{card_id}",
