...
NAME_TO_IMAGES = {
    BaseTrain.name():
        [
            Image(kind=Accelerator.NVIDIA,
                  name="iregistry.baidu-int.com/windmill-public/train/paddlepaddle:20241024_1729756173622")
        ],
    BaseEval.name():
        [
            Image(kind=Accelerator.NVIDIA,
    ...
    TransformEval.name():
        [
            Image(kind=Accelerator.NVIDIA,
                  name="iregistry.baidu-int.com/windmill-public/inference/nvidia:20241024_1729750491006"),
            Image(kind=Accelerator.KUNLUN,
                  name="iregistry.baidu-int.com/windmill-public/inference/kunlun:20241024_1729750491103")
        ],
    Package.name():
        [
            Image(kind=Accelerator.NVIDIA,
