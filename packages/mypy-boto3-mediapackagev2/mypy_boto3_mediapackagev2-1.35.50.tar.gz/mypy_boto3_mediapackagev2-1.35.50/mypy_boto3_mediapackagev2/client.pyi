...
class Mediapackagev2Client(BaseClient):
    ...
    def cancel_harvest_job(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/mediapackagev2.html#Mediapackagev2.Client.cancel_harvest_job)
    ...
    def create_harvest_job(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/mediapackagev2.html#Mediapackagev2.Client.create_harvest_job)
    ...
    def get_harvest_job(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/mediapackagev2.html#Mediapackagev2.Client.get_harvest_job)
    ...
    def list_harvest_jobs(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/mediapackagev2.html#Mediapackagev2.Client.list_harvest_jobs)
    ...
    def get_waiter(self, waiter_name: Literal["harvest_job_finished"]) -> HarvestJobFinishedWaiter:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/mediapackagev2.html#Mediapackagev2.Client.get_waiter)
