...
class DatasetCache:
    ...
    def save(self, datasets):
        ...
        print(f"process-{os.getpid()}, time: {datetime.now()}, save datasets: {len(datasets)}, {self._get_short_info()}")
    ...
    def _load_existing_datasets(self, dataset_path):
        ...
        print(f"process-{os.getpid()}, time: {datetime.now()}, load datasets: {len(all_datasets)}, {self._get_short_info()}")
        return all_datasets
