...
def update_property_descriptor(
    ...
    :param bool createIfMissing: If true\, create this property if not already defined.
    ...
    if hidden is not None:
        body.update({"hidden": hidden})
    # Only send createIfMissing if the argument was provided, don't send null values
    if createIfMissing is not None:
        body.update({"createIfMissing": createIfMissing})
