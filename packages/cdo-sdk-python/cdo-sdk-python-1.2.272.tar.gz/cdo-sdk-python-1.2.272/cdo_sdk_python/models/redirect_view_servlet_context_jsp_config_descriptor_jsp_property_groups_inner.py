...
class RedirectViewServletContextJspConfigDescriptorJspPropertyGroupsInner(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["buffer", "elIgnored", "pageEncoding", "isXml", "includePreludes", "includeCodas", "scriptingInvalid", "deferredSyntaxAllowedAsLiteral", "trimDirectiveWhitespaces", "errorOnUndeclaredNamespace", "urlPatterns", "defaultContentType"]
