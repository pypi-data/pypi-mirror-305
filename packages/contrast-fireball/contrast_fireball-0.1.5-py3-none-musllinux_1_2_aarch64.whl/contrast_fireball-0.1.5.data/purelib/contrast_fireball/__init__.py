...
# str allows us to easily serialize this with `json.dumps`.
class AssessEventType(str, enum.Enum):
    METHOD = "METHOD"
...
# We'd like StrEnum here, but it's only available in python 3.11. Inheriting from
# str allows us to easily serialize this with `json.dumps`.
class AssessTaintRangeTag(str, enum.Enum):
...
# We'd like StrEnum here, but it's only available in python 3.11. Inheriting from
# str allows us to easily serialize this with `json.dumps`.
class SignatureExpressionType(str, enum.Enum):
...
# We'd like StrEnum here, but it's only available in python 3.11. Inheriting from
# str allows us to easily serialize this with `json.dumps`.
class AssessEventAction(str, enum.Enum):
    CREATION = "CREATION"
    A2O = "A2O"
    A2P = "A2P"
    A2A = "A2A"
