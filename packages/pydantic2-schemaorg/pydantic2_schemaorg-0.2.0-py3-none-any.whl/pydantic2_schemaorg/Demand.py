...
class Demand(Intangible):
    ...
    itemOffered: Optional[Union[List[Union['Service', 'Event', 'CreativeWork', 'Trip', 'MenuItem', 'Product', 'AggregateOffer', str]], 'Service', 'Event', 'CreativeWork', 'Trip', 'MenuItem', 'Product', 'AggregateOffer', str]] = Field(
        default=None,
