...
if TYPE_CHECKING:
    ...
    from pydantic2_schemaorg.MonetaryAmountDistribution import MonetaryAmountDistribution
    ...
    from pydantic2_schemaorg.OccupationalExperienceRequirements import OccupationalExperienceRequirements
