...
class Grant(Intangible):
    ...
    fundedItem: Optional[Union[List[Union['Event', 'CreativeWork', 'BioChemEntity', 'Person', 'MedicalEntity', 'Product', 'Organization', str]], 'Event', 'CreativeWork', 'BioChemEntity', 'Person', 'MedicalEntity', 'Product', 'Organization', str]] = Field(
        default=None,
