...
class QuantitativeValue(StructuredValue):
    ...
    valueReference: Optional[Union[List[Union[str, 'Text', 'QualitativeValue', 'PropertyValue', 'Enumeration', 'QuantitativeValue', 'DefinedTerm', 'StructuredValue', 'MeasurementTypeEnumeration']], str, 'Text', 'QualitativeValue', 'PropertyValue', 'Enumeration', 'QuantitativeValue', 'DefinedTerm', 'StructuredValue', 'MeasurementTypeEnumeration']] = Field(
        default=None,
