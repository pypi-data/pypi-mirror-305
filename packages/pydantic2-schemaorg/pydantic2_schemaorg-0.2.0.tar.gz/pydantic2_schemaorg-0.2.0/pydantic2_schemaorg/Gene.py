...
class Gene(BioChemEntity):
    ...
    expressedIn: Optional[Union[List[Union['AnatomicalSystem', 'AnatomicalStructure', 'DefinedTerm', 'BioChemEntity', str]], 'AnatomicalSystem', 'AnatomicalStructure', 'DefinedTerm', 'BioChemEntity', str]] = Field(
        default=None,
