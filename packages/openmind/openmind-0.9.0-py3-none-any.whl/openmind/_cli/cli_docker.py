...
class CLIDocker:
    ...
    def get_model_path(args, cache_dir) -> str:
        ...
        if model_name_or_path in SUPPORTED_TASK_PATCH_DICT:
            model_commit_id = SUPPORTED_TASK_PATCH_DICT[model_name_or_path]["model"]["pt"][1]
            model_name_or_path = SUPPORTED_TASK_PATCH_DICT[model_name_or_path]["model"]["pt"][0]
