...
if is_transformers_available():
    ...
    patch_list = [("HF_MODULES_CACHE", hub.OM_DATASETS_CACHE)]
    _apply_patches(patch_list, transformers)
    _apply_patches(patch_list, transformers.utils)
    _apply_patches(patch_list, transformers.utils.hub)
