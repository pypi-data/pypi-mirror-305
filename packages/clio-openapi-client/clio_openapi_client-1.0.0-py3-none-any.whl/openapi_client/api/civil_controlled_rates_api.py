...
class CivilControlledRatesApi:
    ...
    @validate_call
    def lauk_civil_controlled_rate_index(
        self,
        ...
        limit: Annotated[Optional[StrictInt], Field(description="A limit on the number of LaukCivilControlledRate records to be returned. Limit can range between 1 and 200. Default: `200`.")] = None,
        ...
        _param = self._lauk_civil_controlled_rate_index_serialize(
    ...
    @validate_call
    def lauk_civil_controlled_rate_index_with_http_info(
        self,
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        activity: Annotated[Optional[StrictStr], Field(description="Filter by activity.")] = None,
        category_of_law: Annotated[Optional[StrictStr], Field(description="Filter by category of law.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[LaukCivilControlledRateList]:
        """List Civil Controlled Rates
    ...
    @validate_call
    def lauk_civil_controlled_rate_index_without_preload_content(
        self,
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        activity: Annotated[Optional[StrictStr], Field(description="Filter by activity.")] = None,
        category_of_law: Annotated[Optional[StrictStr], Field(description="Filter by category of law.")] = None,
    ...
    def _lauk_civil_controlled_rate_index_serialize(
        self,
        x_api_version,
        activity,
        category_of_law,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/lauk_civil_controlled_rates.json',
