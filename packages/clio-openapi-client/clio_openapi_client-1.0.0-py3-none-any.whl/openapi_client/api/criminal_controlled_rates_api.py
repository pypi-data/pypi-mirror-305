...
class CriminalControlledRatesApi:
    ...
    def lauk_criminal_controlled_rate_index(
        ...
        counsel: Annotated[Optional[StrictStr], Field(description="Filter by counsel.")] = None,
        ...
        limit: Annotated[Optional[StrictInt], Field(description="A limit on the number of LaukCriminalControlledRate records to be returned. Limit can range between 1 and 200. Default: `200`.")] = None,
        ...
        solicitor_type: Annotated[Optional[StrictStr], Field(description="Filter by solicitor type.")] = None,
        ...
        _param = self._lauk_criminal_controlled_rate_index_serialize(
    ...
    def lauk_criminal_controlled_rate_index_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[LaukCriminalControlledRateList]:
        """List Criminal Controlled Rates
    ...
    @validate_call
    def lauk_criminal_controlled_rate_index_without_preload_content(
        self,
        x_api_version: Annotated[Optional[StrictStr], Field(description="The [API minor version](#section/Minor-Versions). Default: latest version.")] = None,
        activity: Annotated[Optional[StrictStr], Field(description="Filter by activity.")] = None,
        category_of_law: Annotated[Optional[StrictStr], Field(description="Filter by category of law.")] = None,
    ...
    def _lauk_criminal_controlled_rate_index_serialize(
        self,
        x_api_version,
        activity,
        category_of_law,
        ...
        if counsel is not None:
            ...
            _query_params.append(('counsel', counsel))
        ...
        if solicitor_type is not None:
            
            _query_params.append(('solicitor_type', solicitor_type))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/lauk_criminal_controlled_rates.json',
