...
class ActivityDescriptionUpdateRequestData(BaseModel):
    ...
    groups: Optional[List[ActivityDescriptionUpdateRequestDataGroupsInner]] = None
    ...
    __properties: ClassVar[List[str]] = ["default", "groups", "name", "rate", "visible_to_co_counsel"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "groups": [ActivityDescriptionUpdateRequestDataGroupsInner.from_dict(_item) for _item in obj["groups"]] if obj.get("groups") is not None else None,
            "name": obj.get("name"),
            "rate": ActivityDescriptionCreateRequestDataRate.from_dict(obj["rate"]) if obj.get("rate") is not None else None,
