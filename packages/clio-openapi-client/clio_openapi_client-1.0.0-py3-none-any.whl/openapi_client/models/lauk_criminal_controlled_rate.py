...
class LaukCriminalControlledRate(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "activity", "activity_type", "category_of_law", "counsel", "court", "created_at", "etag", "exceptional", "fee", "fee_scheme", "post_sept_22_exceptional", "post_sept_22_fee", "key", "rate_type", "region", "solicitor_type", "updated_at"]
