...
class ContactUpdateRequestData(BaseModel):
    ...
    """ # noqa: E501
    addresses: Optional[List[ContactUpdateRequestDataAddressesInner]] = None
    ...
    custom_field_set_associations: Optional[List[ContactUpdateRequestDataCustomFieldSetAssociationsInner]] = None
    custom_field_values: Optional[List[ContactUpdateRequestDataCustomFieldValuesInner]] = None
    date_of_birth: Optional[date] = Field(default=None, description="Date of birth of the Contact.")
    email_addresses: Optional[List[ContactUpdateRequestDataEmailAddressesInner]] = None
    first_name: Optional[StrictStr] = Field(default=None, description="First name of the Contact.")
    instant_messengers: Optional[List[ContactUpdateRequestDataInstantMessengersInner]] = None
    ...
    phone_numbers: Optional[List[ContactUpdateRequestDataPhoneNumbersInner]] = None
    ...
    web_sites: Optional[List[ContactUpdateRequestDataWebSitesInner]] = None
    __properties: ClassVar[List[str]] = ["addresses", "avatar", "clio_connect_email", "co_counsel_rate", "company", "custom_field_set_associations", "custom_field_values", "date_of_birth", "email_addresses", "first_name", "instant_messengers", "last_name", "ledes_client_id", "middle_name", "name", "phone_numbers", "prefix", "sales_tax_number", "title", "type", "web_sites"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "addresses": [ContactUpdateRequestDataAddressesInner.from_dict(_item) for _item in obj["addresses"]] if obj.get("addresses") is not None else None,
            ...
            "custom_field_set_associations": [ContactUpdateRequestDataCustomFieldSetAssociationsInner.from_dict(_item) for _item in obj["custom_field_set_associations"]] if obj.get("custom_field_set_associations") is not None else None,
            "custom_field_values": [ContactUpdateRequestDataCustomFieldValuesInner.from_dict(_item) for _item in obj["custom_field_values"]] if obj.get("custom_field_values") is not None else None,
            "date_of_birth": obj.get("date_of_birth"),
            "email_addresses": [ContactUpdateRequestDataEmailAddressesInner.from_dict(_item) for _item in obj["email_addresses"]] if obj.get("email_addresses") is not None else None,
            "first_name": obj.get("first_name"),
            "instant_messengers": [ContactUpdateRequestDataInstantMessengersInner.from_dict(_item) for _item in obj["instant_messengers"]] if obj.get("instant_messengers") is not None else None,
            "last_name": obj.get("last_name"),
            "ledes_client_id": obj.get("ledes_client_id"),
            "middle_name": obj.get("middle_name"),
            "name": obj.get("name"),
            "phone_numbers": [ContactUpdateRequestDataPhoneNumbersInner.from_dict(_item) for _item in obj["phone_numbers"]] if obj.get("phone_numbers") is not None else None,
            "prefix": obj.get("prefix"),
            "sales_tax_number": obj.get("sales_tax_number"),
            "title": obj.get("title"),
            "type": obj.get("type"),
            "web_sites": [ContactUpdateRequestDataWebSitesInner.from_dict(_item) for _item in obj["web_sites"]] if obj.get("web_sites") is not None else None
        })
        return _obj
