...
class ExpenseCategoryUpdateRequestData(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["entry_type", "groups", "name", "rate", "utbms_code"]
    ...
    def entry_type_validate_enum(cls, value):
        ...
        if value not in set(['hard_cost', 'soft_cost', 'unassociated']):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "groups": [ExpenseCategoryCreateRequestDataGroupsInner.from_dict(_item) for _item in obj["groups"]] if obj.get("groups") is not None else None,
            "name": obj.get("name"),
            "rate": obj.get("rate"),
            "utbms_code": ExpenseCategoryCreateRequestDataUtbmsCode.from_dict(obj["utbms_code"]) if obj.get("utbms_code") is not None else None
        })
        return _obj
