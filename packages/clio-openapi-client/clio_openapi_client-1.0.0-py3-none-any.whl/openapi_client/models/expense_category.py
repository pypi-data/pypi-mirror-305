...
class ExpenseCategory(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "etag", "name", "rate", "entry_type", "created_at", "updated_at", "xero_expense_code", "accessible_to_user", "tax_setting", "groups", "utbms_code"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "utbms_code": UtbmsCodeBase.from_dict(obj["utbms_code"]) if obj.get("utbms_code") is not None else None
        })
        return _obj
