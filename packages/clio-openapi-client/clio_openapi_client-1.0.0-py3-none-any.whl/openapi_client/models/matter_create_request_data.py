...
class MatterCreateRequestData(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "client": MatterCreateRequestDataClient.from_dict(obj["client"]) if obj.get("client") is not None else None,
            "client_reference": obj.get("client_reference"),
            "close_date": obj.get("close_date"),
            "custom_field_set_associations": [MatterCreateRequestDataCustomFieldSetAssociationsInner.from_dict(_item) for _item in obj["custom_field_set_associations"]] if obj.get("custom_field_set_associations") is not None else None,
            ...
            "custom_rate": MatterCreateRequestDataCustomRate.from_dict(obj["custom_rate"]) if obj.get("custom_rate") is not None else None,
            "description": obj.get("description"),
            "display_number": obj.get("display_number"),
            "evergreen_retainer": MatterCreateRequestDataEvergreenRetainer.from_dict(obj["evergreen_retainer"]) if obj.get("evergreen_retainer") is not None else None,
            ...
            "relationships": [MatterCreateRequestDataRelationshipsInner.from_dict(_item) for _item in obj["relationships"]] if obj.get("relationships") is not None else None,
            ...
            "split_invoice_payers": [MatterCreateRequestDataSplitInvoicePayersInner.from_dict(_item) for _item in obj["split_invoice_payers"]] if obj.get("split_invoice_payers") is not None else None,
            "status": obj.get("status"),
            "statute_of_limitations": MatterCreateRequestDataStatuteOfLimitations.from_dict(obj["statute_of_limitations"]) if obj.get("statute_of_limitations") is not None else None,
            "task_template_list_instances": [MatterCreateRequestDataTaskTemplateListInstancesInner.from_dict(_item) for _item in obj["task_template_list_instances"]] if obj.get("task_template_list_instances") is not None else None
        })
        return _obj
