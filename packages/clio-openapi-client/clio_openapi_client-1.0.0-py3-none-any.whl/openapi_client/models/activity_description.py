...
class ActivityDescription(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "etag", "name", "visible_to_co_counsel", "created_at", "updated_at", "default", "type", "utbms_activity_id", "utbms_task_name", "utbms_task_id", "xero_service_code", "accessible_to_user", "category_type", "groups", "rate", "utbms_task", "utbms_activity"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "rate": ActivityDescriptionRateBase.from_dict(obj["rate"]) if obj.get("rate") is not None else None,
            "utbms_task": UtbmsCodeBase.from_dict(obj["utbms_task"]) if obj.get("utbms_task") is not None else None,
            "utbms_activity": UtbmsCodeBase.from_dict(obj["utbms_activity"]) if obj.get("utbms_activity") is not None else None
        })
        return _obj
