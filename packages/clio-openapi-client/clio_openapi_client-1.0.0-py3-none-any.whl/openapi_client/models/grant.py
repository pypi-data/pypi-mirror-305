...
class Grant(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "etag", "name", "funding_code", "funding_code_and_name", "funding_source_name", "created_at", "updated_at", "balance", "grant_funding_source"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "grant_funding_source": GrantFundingSourceBase.from_dict(obj["grant_funding_source"]) if obj.get("grant_funding_source") is not None else None
        })
        return _obj
