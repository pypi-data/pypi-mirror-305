...
class Table(TableDDL):
    ...
    def parse_table_comment_complete(self):
        ...
        if len(self.comment_complete) == 0:
            ...
            deprecated = self.comment_complete.get("deprecated", "")
            if deprecated != "":
                self.comment_complete["deprecated"] = deprecated
    ...
    def table_comment_to_sql(self):
        ...
        if len(self.comment_complete) > 0:
            list_of_comments = [f"{self.atlan_keywords[key]} {TableUtils.format_comment_content(self.comment_complete[key])}" for key in self.atlan_keywords]
...
class BronzeTable(Table):
    ...
    def __init__(self,                  
                 ...
                 fields={},
                 tbl_properties={}):
        super().__init__(self.layer, table_name, schema, yml, anonimized_fields, partition_fields, fields, tbl_properties)        
