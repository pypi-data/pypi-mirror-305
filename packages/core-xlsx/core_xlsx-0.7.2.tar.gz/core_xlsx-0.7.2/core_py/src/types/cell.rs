...
use core_rs::{datatype::CellRawValue, types::cell::XLSXSheetCell};
    ...
    ($obj:expr, $($attr:ident),+) => {
        {
            ...
            WrapperXLSXSheetCell(Arc::new(Mutex::new(cell)))
        }
    };
}
...
impl From<&Bound<'_, PyAny>> for WrapperXLSXSheetCell {
