...
async def start(project_path):
    try:
        ...
        while True:
            ...
            logger.info("### Agent is confused due to lack of context. Please select `Dependency', `Code Logic`, or `Exit` to help me better assist you: ")

            user_prompt_json1 = input()
            user_prompt1, _, _, _, _ = parse_payload(repo.get_repo_path(), user_prompt_json1)
