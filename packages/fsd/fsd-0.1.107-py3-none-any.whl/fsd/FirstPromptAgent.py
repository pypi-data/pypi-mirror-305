...
class FirstPromptAgent:
    ...
    def _create_messages(self, user_prompt):
        ...
        system_content = (
            ...
            "3. Ambiguous: Use this if you think the request might be actionable (2) but you're not entirely sure.\n"
            ...
            "If you're certain it's not '2', choose '1'. Only choose '3' if it's likely to be '2' but you're not entirely sure.\n"
