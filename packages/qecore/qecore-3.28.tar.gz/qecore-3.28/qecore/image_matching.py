...
class Matcher:
    ...
    def __init__(self, context) -> None:
        ...
        if run_verbose("which gnome-screenshot")[1] == 0:
    ...
    def capture_image(self, screen_path=None) -> None:
        ...
        LOGGING.debug(f"Image matching remove older image: '{remove_screen}'")
        ...
        if capture_image[0].startswith("file:"):
            ...
            LOGGING.debug(f"Image matching copy captured image: '{copy_screen}'")
        LOGGING.debug(f"Image matching initial screen capture result: '{capture_image}'")
