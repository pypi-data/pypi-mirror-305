...
class UsersApi(object):
    ...
    @auto_fill
    @validate_arguments
    def get_user(self, id : Annotated[constr(strict=True, max_length=50, min_length=5), Field(..., description="Filter by user's system generated identifiers.")], **kwargs) -> User:  # noqa: E501
    ...
    @auto_fill
    @validate_arguments
    def get_user_by_token(self, x_user_token : Annotated[StrictStr, Field(..., description="Unique system generated JWT session token for specific user.")], **kwargs) -> User:  # noqa: E501
    ...
    @auto_fill
    @validate_arguments
    def get_user_challenge(self, x_user_token : Annotated[StrictStr, Field(..., description="Unique system generated JWT session token for specific user.")], id : Annotated[StrictStr, Field(..., description="ExtChallenge id to query")], **kwargs) -> ChallengeResponse:  # noqa: E501
