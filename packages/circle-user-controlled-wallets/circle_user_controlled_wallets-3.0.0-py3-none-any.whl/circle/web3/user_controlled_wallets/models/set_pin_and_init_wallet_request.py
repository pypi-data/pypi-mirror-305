...
class SetPinAndInitWalletRequest(BaseModel):
    ...
    metadata: Optional[conlist(MetadataField)] = Field(None, description="List of metadata fields to associate with the corresponding wallet.")
    ...
    def from_dict(cls, obj: dict) -> SetPinAndInitWalletRequest:
        ...
        _obj = SetPinAndInitWalletRequest.parse_obj({
            ...
            "metadata": [MetadataField.from_dict(_item) for _item in obj.get("metadata")] if obj.get("metadata") is not None else None
        })
        return _obj
