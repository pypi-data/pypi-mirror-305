...
class TransactionsApi(object):
    ...
    @auto_fill
    @validate_arguments
    def create_user_transaction_contract_execution_challenge(self, x_user_token : Annotated[StrictStr, Field(..., description="Unique system generated JWT session token for specific user.")], contract_execution_txn_pin_code_request : Annotated[ContractExecutionTxnPinCodeRequest, Field(..., description="Create transaction for end user request")], **kwargs) -> CreateContractExecutionTransactionForEndUserResponse:  # noqa: E501
