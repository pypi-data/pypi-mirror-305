...
RE_MAP={
    ...
    "disclosure_of_invention": [
        re.compile(r"Disclosure of Invention|发明内容|SUMMARY OF (?:THE INVENTION|INVENTION)|BRIEF SUMMARY OF THE PRESENT APPLICATION|BRIEF DESCRIPTION OF THE INVENTION", re.IGNORECASE)
    ],
    "drawings": [
