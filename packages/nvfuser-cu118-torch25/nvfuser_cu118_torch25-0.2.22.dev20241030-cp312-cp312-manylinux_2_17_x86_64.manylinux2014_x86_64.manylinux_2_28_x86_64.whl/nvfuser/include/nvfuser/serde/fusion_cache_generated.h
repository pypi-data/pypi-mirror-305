...
enum class RecordType : int32_t {
  ...
  Ternary_TV = 22,
  Ternary_VAL = 23,
  Ternary_TV_TV_VAL = 24,
  Ternary_TV_VAL_TV = 25,
  Ternary_VAL_TV_TV = 26,
  Ternary_VAL_VAL_TV = 27,
  Ternary_TV_VAL_VAL = 28,
  Ternary_VAL_TV_VAL = 29,
  Ternary_Alpha_TV = 30,
  Ternary_Alpha_VAL = 31,
  Ternary_Alpha_TV_TV_VAL = 32,
  Ternary_Alpha_TV_VAL_TV = 33,
  Ternary_Alpha_VAL_TV_TV = 34,
  Ternary_Alpha_VAL_VAL_TV = 35,
  Ternary_Alpha_TV_VAL_VAL = 36,
  Ternary_Alpha_VAL_TV_VAL = 37,
  NormalDistOp = 38,
  OutputTv = 39,
  OutputVal = 40,
  PadOp = 41,
