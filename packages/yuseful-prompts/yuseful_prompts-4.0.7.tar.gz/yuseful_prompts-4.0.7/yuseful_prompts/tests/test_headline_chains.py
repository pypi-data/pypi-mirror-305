...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            {
                "headline_text": (
                    "Is META Stock About to Announce a Stock Split? If 2023 was the Year of Artificial Intelligence, will 2024 be remembered as the Year of the Stock Split? Although they are not at record levels, stock splits are rebounding tremendously. According to a September Wall Street Horizons report,"
                ),
            },
            {
                "category": "corporate-strategy",
...
def test_classify_headline_with_predefined_category(headline_input, expected):
    res = classify_headline_with_predefined_category(
