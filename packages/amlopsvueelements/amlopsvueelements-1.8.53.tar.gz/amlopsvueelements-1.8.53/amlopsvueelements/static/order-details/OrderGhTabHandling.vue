      ...
      <div v-if="true" class="handling-step-content">
        <div class="handling-step-content-header-sub flex">
          ...
          >
            ...
            <div class="handling-step-content-header-sub-el flex w-6/12 justify-start el-border">
              Quantity
            </div>
          </div>
        ...
        >
          ...
          >
            ...
            <div class="handling-step-content-element-el flex justify-start items-center w-6/12">
              {{ service.quantity ? 'X ' + service.quantity : 'X --' }}
            </div>
          </div>
          <div
          ...
          >
            ...
            >
              <CheckboxField v-model="service.arrival" class="mb-0 mr-1"></CheckboxField>
            </div>
            <div class="handling-step-content-element-el flex justify-center items-center w-full">
              <CheckboxField v-model="service.departure" class="mb-0 mr-1"></CheckboxField>
            </div>
            <div
        ...
        >
          ...
          >
            <div
              class="handling-step-content-element-el-name flex justify-center items-center w-full"
            >
              <CheckboxField v-model="newService.arrival" class="mb-0 mr-1"></CheckboxField>
            </div>
            <div class="handling-step-content-element-el flex justify-center items-center w-full">
              <CheckboxField v-model="newService.departure" class="mb-0 mr-1"></CheckboxField>
            </div>
            <div
