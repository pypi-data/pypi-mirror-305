...
from datarobot._experimental.models.enums import AggregationType
from datarobot._experimental.models.genai.insights_configuration import InsightsConfiguration
