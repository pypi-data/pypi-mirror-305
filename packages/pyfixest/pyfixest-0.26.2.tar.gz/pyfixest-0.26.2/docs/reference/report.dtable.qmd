...
`report.dtable(df, vars, stats=['count', 'mean', 'std'], bycol=None, byrow=None, type='gt', labels={}, stats_labels={}, digits=2, notes='', counts_row_below=False, hide_stats=False, **kwargs)`
