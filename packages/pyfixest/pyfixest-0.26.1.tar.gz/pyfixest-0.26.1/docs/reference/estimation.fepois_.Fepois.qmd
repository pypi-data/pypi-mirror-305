...
`estimation.fepois_.Fepois(self, FixestFormula, data, ssc_dict, drop_singletons, drop_intercept, weights, weights_type, collin_tol, fixef_tol, lookup_demeaned_data, tol, maxiter, solver='np.linalg.solve', store_data=True, copy_data=True, lean=False)`
...
`estimation.fepois_.Fepois.predict(newdata=None, atol=1e-06, btol=1e-06, type='link')`
