...
`estimation.Fepois(self, FixestFormula, data, ssc_dict, drop_singletons, drop_intercept, weights, weights_type, collin_tol, fixef_tol, lookup_demeaned_data, tol, maxiter, solver='np.linalg.solve', store_data=True, copy_data=True, lean=False)`
...
| Name | Description |
| --- | --- |
| [get_fit](#pyfixest.estimation.Fepois.get_fit) | Fit a Poisson Regression Model via Iterated Weighted Least Squares (IWLS). |
| [predict](#pyfixest.estimation.Fepois.predict) | Return predicted values from regression model. |
| [prepare_model_matrix](#pyfixest.estimation.Fepois.prepare_model_matrix) | Prepare model inputs for estimation. |
| [resid](#pyfixest.estimation.Fepois.resid) | Return residuals from regression model. |
| [to_array](#pyfixest.estimation.Fepois.to_array) | Turn estimation DataFrames to np arrays. |

### get_fit { #pyfixest.estimation.Fepois.get_fit }
...
### predict { #pyfixest.estimation.Fepois.predict }
...
### prepare_model_matrix { #pyfixest.estimation.Fepois.prepare_model_matrix }

`estimation.Fepois.prepare_model_matrix()`

Prepare model inputs for estimation.

### resid { #pyfixest.estimation.Fepois.resid }
...
### to_array { #pyfixest.estimation.Fepois.to_array }
