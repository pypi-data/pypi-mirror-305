...
`estimation.Feols(self, FixestFormula, data, ssc_dict, drop_singletons, drop_intercept, weights, weights_type, collin_tol, fixef_tol, lookup_demeaned_data, solver='np.linalg.solve', store_data=True, copy_data=True, lean=False)`
...
| Name | Description |
| --- | --- |
| [add_fixest_multi_context](#pyfixest.estimation.Feols.add_fixest_multi_context) | Enrich Feols object. |
| [ccv](#pyfixest.estimation.Feols.ccv) | Compute the Causal Cluster Variance following Abadie et al (QJE 2023). |
| [coef](#pyfixest.estimation.Feols.coef) | Fitted model coefficents. |
| [confint](#pyfixest.estimation.Feols.confint) | Fitted model confidence intervals. |
| [demean](#pyfixest.estimation.Feols.demean) | Demean the dependent variable and covariates by the fixed effect(s). |
| [drop_multicol_vars](#pyfixest.estimation.Feols.drop_multicol_vars) | Detect and drop multicollinear variables. |
| [fixef](#pyfixest.estimation.Feols.fixef) | Compute the coefficients of (swept out) fixed effects for a regression model. |
| [get_fit](#pyfixest.estimation.Feols.get_fit) | Fit an OLS model. |
| [get_inference](#pyfixest.estimation.Feols.get_inference) | Compute standard errors, t-statistics, and p-values for the regression model. |
| [get_performance](#pyfixest.estimation.Feols.get_performance) | Get Goodness-of-Fit measures. |
| [plot_ritest](#pyfixest.estimation.Feols.plot_ritest) | Plot the distribution of the Randomization Inference Statistics. |
| [predict](#pyfixest.estimation.Feols.predict) | Predict values of the model on new data. |
| [prepare_model_matrix](#pyfixest.estimation.Feols.prepare_model_matrix) | Prepare model matrices for estimation. |
| [pvalue](#pyfixest.estimation.Feols.pvalue) | Fitted model p-values. |
| [resid](#pyfixest.estimation.Feols.resid) | Fitted model residuals. |
| [ritest](#pyfixest.estimation.Feols.ritest) | Conduct Randomization Inference (RI) test against a null hypothesis of |
| [se](#pyfixest.estimation.Feols.se) | Fitted model standard errors. |
| [solve_ols](#pyfixest.estimation.Feols.solve_ols) | Solve the ordinary least squares problem using the specified solver. |
| [tidy](#pyfixest.estimation.Feols.tidy) | Tidy model outputs. |
| [to_array](#pyfixest.estimation.Feols.to_array) | Convert estimation data frames to np arrays. |
| [tstat](#pyfixest.estimation.Feols.tstat) | Fitted model t-statistics. |
| [update](#pyfixest.estimation.Feols.update) | Update coefficients for new observations using Sherman-Morrison formula. |
| [vcov](#pyfixest.estimation.Feols.vcov) | Compute covariance matrices for an estimated regression model. |
| [wald_test](#pyfixest.estimation.Feols.wald_test) | Conduct Wald test. |
| [wildboottest](#pyfixest.estimation.Feols.wildboottest) | Run a wild cluster bootstrap based on an object of type "Feols". |
| [wls_transform](#pyfixest.estimation.Feols.wls_transform) | Transform model matrices for WLS Estimation. |

### add_fixest_multi_context { #pyfixest.estimation.Feols.add_fixest_multi_context }
...
### ccv { #pyfixest.estimation.Feols.ccv }
...
### coef { #pyfixest.estimation.Feols.coef }
...
### confint { #pyfixest.estimation.Feols.confint }
...
### get_fit { #pyfixest.estimation.Feols.get_fit }
...
### get_inference { #pyfixest.estimation.Feols.get_inference }
...
### get_performance { #pyfixest.estimation.Feols.get_performance }
...
### plot_ritest { #pyfixest.estimation.Feols.plot_ritest }
...
### predict { #pyfixest.estimation.Feols.predict }
...
### prepare_model_matrix { #pyfixest.estimation.Feols.prepare_model_matrix }

`estimation.Feols.prepare_model_matrix()`

Prepare model matrices for estimation.

### pvalue { #pyfixest.estimation.Feols.pvalue }
...
### resid { #pyfixest.estimation.Feols.resid }
...
### ritest { #pyfixest.estimation.Feols.ritest }
...
### se { #pyfixest.estimation.Feols.se }
...
### solve_ols { #pyfixest.estimation.Feols.solve_ols }
...
### tidy { #pyfixest.estimation.Feols.tidy }
...
### to_array { #pyfixest.estimation.Feols.to_array }

`estimation.Feols.to_array()`

Convert estimation data frames to np arrays.

### tstat { #pyfixest.estimation.Feols.tstat }
...
### update { #pyfixest.estimation.Feols.update }
...
### vcov { #pyfixest.estimation.Feols.vcov }
...
### wald_test { #pyfixest.estimation.Feols.wald_test }
...
### wildboottest { #pyfixest.estimation.Feols.wildboottest }
...
### wls_transform { #pyfixest.estimation.Feols.wls_transform }

`estimation.Feols.wls_transform()`
