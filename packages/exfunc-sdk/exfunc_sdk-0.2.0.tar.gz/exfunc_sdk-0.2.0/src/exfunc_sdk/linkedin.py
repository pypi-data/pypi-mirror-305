...
class Linkedin(BaseSDK):
    def enrich_company(
        ...
        *,
        request: Union[
            models.EnrichCompanyRequestBody, models.EnrichCompanyRequestBodyTypedDict
        ],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
    ) -> models.EnrichCompanyResponseBody:
        r"""Enrich LinkedIn company info

        Enrich LinkedIn company info from a LinkedIn company url
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, models.EnrichCompanyRequestBody)
        request = cast(models.EnrichCompanyRequestBody, request)

        req = self.build_request(
            method="POST",
            path="/linkedin/enrich-company",
            base_url=base_url,
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                request, False, False, "json", models.EnrichCompanyRequestBody
            ),
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, models.EnrichCompanyResponseBody)
    ...
    def enrich_job_posting(
        ...
        *,
        request: Union[
            models.EnrichJobPostingRequestBody,
            models.EnrichJobPostingRequestBodyTypedDict,
        ],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
    ) -> models.EnrichJobPostingResponseBody:
        r"""Enrich LinkedIn job posting info

        Enrich LinkedIn job posting info from a LinkedIn job posting url
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, models.EnrichJobPostingRequestBody)
        request = cast(models.EnrichJobPostingRequestBody, request)

        req = self.build_request(
            method="POST",
            path="/linkedin/enrich-job-posting",
            base_url=base_url,
            url_variables=url_variables,
            request=request,
            request_body_required=True,
            ...
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(
                request, False, False, "json", models.EnrichJobPostingRequestBody
            ),
            timeout_ms=timeout_ms,
        )
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                operation_id="enrich-job-posting",
                oauth2_scopes=[],
                security_source=get_security_from_env(
                    self.sdk_configuration.security, models.Security
                ),
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(
                http_res.text, models.EnrichJobPostingResponseBody
            )
        if utils.match_response(http_res, "400", "application/json"):
            data = utils.unmarshal_json(http_res.text, models.UserErrorData)
            raise models.UserError(data=data)
    ...
    async def enrich_job_posting_async(
        self,
        *,
        request: Union[
            models.EnrichJobPostingRequestBody,
    ...
    def enrich_person(
        ...
        *,
        request: Union[
            models.EnrichPersonRequestBody, models.EnrichPersonRequestBodyTypedDict
        ],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
    ) -> models.EnrichPersonResponseBody:
        r"""Enrich LinkedIn person profile info

        Enrich LinkedIn person profile info from a LinkedIn person profile url
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, models.EnrichPersonRequestBody)
        request = cast(models.EnrichPersonRequestBody, request)

        req = self.build_request(
            method="POST",
            path="/linkedin/enrich-person",
            base_url=base_url,
            url_variables=url_variables,
            request=request,
            request_body_required=True,
            ...
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(
                request, False, False, "json", models.EnrichPersonRequestBody
            ),
            timeout_ms=timeout_ms,
        )
        ...
        data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, models.EnrichPersonResponseBody)
        if utils.match_response(http_res, "400", "application/json"):
            data = utils.unmarshal_json(http_res.text, models.UserErrorData)
            raise models.UserError(data=data)
        if utils.match_response(http_res, "500", "application/json"):
