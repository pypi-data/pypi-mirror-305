...
class Google(BaseSDK):
    ...
    def get_product_details(
        ...
        *,
        request: Union[
            models.GetProductDetailsRequestBody,
            models.GetProductDetailsRequestBodyTypedDict,
        ],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
    ) -> models.GetProductDetailsResponseBody:
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, models.GetProductDetailsRequestBody)
        request = cast(models.GetProductDetailsRequestBody, request)

        req = self.build_request(
            method="POST",
            path="/google/get-product-details",
            base_url=base_url,
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                request, False, False, "json", models.GetProductDetailsRequestBody
            ),
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                operation_id="get-product-details",
                oauth2_scopes=[],
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(
                http_res.text, models.GetProductDetailsResponseBody
            )
