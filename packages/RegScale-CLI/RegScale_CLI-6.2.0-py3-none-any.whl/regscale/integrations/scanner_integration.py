...
class ScannerIntegration(ABC):
    ...
    def create_or_update_issue_from_finding(
        ...
        if ScannerVariables.issueCreation.lower() != "perasset":
            ...
            for existing_issue in existing_issues:
                if (existing_issue.status != regscale_models.IssueStatus.Closed) or ScannerVariables.ingestClosedIssues:
            ...
            if issue:
                ...
                issue.dateCompleted = None if issue_status == regscale_models.IssueStatus.Open else issue.dateCompleted
    ...
    def close_outdated_vulnerabilities(self, current_vulnerabilities: Dict[int, Set[int]]) -> None:
        ...
        # filter by tool
        tool_vulns = self._filter_vulns_open_by_other_tools(all_vulns=all_vulnerabilities)
