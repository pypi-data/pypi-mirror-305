...
from regscale.integrations.commercial.wiz.WizDataMixin import WizMixin
from regscale.models.regscale_models.sbom import Sbom
from regscale.integrations.commercial.wiz.constants import SBOM_QUERY, SBOM_FILE_PATH
...
class WizSbomIntegration(WizMixin):
    ...
    def __init__(
        ...
        self.filter_by_override = filter_by_override
