...
class WorkMailClient(BaseClient):
    ...
    def create_identity_center_application(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/workmail.html#WorkMail.Client.create_identity_center_application)
    ...
    def delete_identity_center_application(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/workmail.html#WorkMail.Client.delete_identity_center_application)
    ...
    def delete_identity_provider_configuration(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/workmail.html#WorkMail.Client.delete_identity_provider_configuration)
    ...
    def delete_personal_access_token(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/workmail.html#WorkMail.Client.delete_personal_access_token)
    ...
    def describe_identity_provider_configuration(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/workmail.html#WorkMail.Client.describe_identity_provider_configuration)
    ...
    def get_personal_access_token_metadata(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/workmail.html#WorkMail.Client.get_personal_access_token_metadata)
    ...
    def list_personal_access_tokens(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/workmail.html#WorkMail.Client.list_personal_access_tokens)
    ...
    def put_identity_provider_configuration(
        ...
        authentication requests for mailbox
        users.

        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/workmail.html#WorkMail.Client.put_identity_provider_configuration)
