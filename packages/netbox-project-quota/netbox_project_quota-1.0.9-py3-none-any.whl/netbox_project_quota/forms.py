...
class ProjectForm(NetBoxModelForm):
    ...
    fieldsets = (
        FieldSet('name', 'project_id', 'project_owner', 'status',"quota_template","description","tags", name=('General')),
    )
    # fieldsets = (
    #     (
    #         'General',
...
class QuotaTemplateForm(NetBoxModelForm):
    ...
    fieldsets = (
        FieldSet('template_name', 'instances_quota', 'vcpus_quota', 'ram_quota',"ipaddr_quota","device_quota","tags", name=('General')),
    )
    # fieldsets = (
    #     (
    #         'General',
