...
#            # Example: result_pos.append(results[midx])
#            # Example: error_pos.append(errors[midx])
#            # Example: result_total_pos.append(results_total[midx])
#            # Example: error_total_pos.append(errors_total[midx])
#            
#    # Save or process the results as needed
#    # Example: np.savetxt(output_file, result_pos)
#    conf = ConfigParser()
#    conf.read(pos_config)
#    file_info = conf.sections()
#    df = pd.read_csv(conf[file_info[0]]['pos_file'])
