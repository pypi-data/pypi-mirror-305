...
parser.add_argument("--restyle-subs", "-restyle", action="store_true", help="Restyle subtitles to the cabin preset")
parser.add_argument("--fix-tagging", "-ft", action="store_true", help="Attempt to automatically fix tagging issues")

parser.add_argument(
    "--sub-languages", "-sl", action="append", type=str, default=[], help="Languages to apply tpp and/or restyling to. Defaults to ['de', 'en']"
)
