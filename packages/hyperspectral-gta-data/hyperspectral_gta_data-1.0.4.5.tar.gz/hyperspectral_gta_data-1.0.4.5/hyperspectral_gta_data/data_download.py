...
image_dict = {
            ...
            'Detection_Test_Cooke_City_RIT': ['Detection_Test_Cooke_City_RIT', '1JzVk8cyq8KBcShKFOF2Cw6Wr1l8f6sK8', 'spectral_images', 'Detection_Test_Cooke_City_RIT/self_test_refl'],
...
lib_dict = {
            ...
            'RIT_Target_Detection_Cooke_City': ['RIT_Target_Detection_Cooke_City', '1ekB8TGOuumTIz_gQ3CAeAZrDjgscIbkr', 'spectral_libraries', 'RIT_Target_Detection_Cooke_City/Cooke_City_Targets.sli']
}
...
def get_data_dir():    
    ...
    if os.path.isfile(fname_config):
        ...
        set_data_dir('C:/spectral_data')
        config.read(fname_config)
        print('')
        print('No data directory was found in the config file.')
        print(f'The data directory has been set to {fname_config}.')
