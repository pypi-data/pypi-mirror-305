...
forge_context_var: ContextVar[tuple[IO, Union[ActionContext, PageContext]]] = (
...
class Forge:
    ...
    async def _create_socket_connection(self, instance_id: UUID):
        ...
        async def on_close(code: int, reason: str):
            ...
            self._log.error(f"Lost connection to Forge (code {code}). Reason: {reason}")
        ...
        async def start_transaction(inputs: StartTransactionInputs) -> None:
            ...
            async def handle_action():
                try:
                    ...
                    forge_context_token = forge_context_var.set((client.io, action_ctx))
                ...
                for _ in range(MAX_PAGE_RETRIES):
                    ...
                    try:
                        ...
                        if serialized_page is not None:
                            self._pending_page_layouts[inputs.page_key] = (
                                serialized_page
                            )
                        await self._send(
                            "SEND_PAGE",
            ...
            async def handle_page():
                ...
                try:
                    ...
                    if len(params) == 0:
                        ...
                        raise ForgeError("handler accepts invalid number of arguments")
