...
T = TypeVar("T", bound="DisableSmsMfaFormParams")
...
class DisableSmsMfaFormParams:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        disable_sms_mfa_form_params = cls(
            client_id=client_id,
            username=username,
            email=email,
        ...
        disable_sms_mfa_form_params.additional_properties = d
        return disable_sms_mfa_form_params
