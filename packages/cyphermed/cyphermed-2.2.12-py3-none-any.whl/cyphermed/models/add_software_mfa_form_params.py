...
T = TypeVar("T", bound="AddSoftwareMfaFormParams")


@_attrs_define
class AddSoftwareMfaFormParams:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        add_software_mfa_form_params = cls(
            client_id=client_id,
            mfa_code=mfa_code,
            username=username,
            email=email,
        ...
        add_software_mfa_form_params.additional_properties = d
        return add_software_mfa_form_params
