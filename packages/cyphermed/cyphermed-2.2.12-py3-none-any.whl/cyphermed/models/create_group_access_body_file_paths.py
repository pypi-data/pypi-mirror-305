...
T = TypeVar("T", bound="CreateGroupAccessBodyFilePaths")
...
class CreateGroupAccessBodyFilePaths:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        create_group_access_body_file_paths = cls()
        ...
        create_group_access_body_file_paths.additional_properties = additional_properties
        return create_group_access_body_file_paths
