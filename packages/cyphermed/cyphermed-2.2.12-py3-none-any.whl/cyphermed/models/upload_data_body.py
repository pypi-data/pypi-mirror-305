...
if TYPE_CHECKING:
    from ..models.upload_data_body_value_type_0 import UploadDataBodyValueType0
...
class UploadDataBody:
    ...
    Attributes:
        value (Union['UploadDataBodyValueType0', str]): Data value to store at this path
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if isinstance(self.value, UploadDataBodyValueType0):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_value(data: object) -> Union["UploadDataBodyValueType0", str]:
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                value_type_0 = UploadDataBodyValueType0.from_dict(data)

                return value_type_0
            except:  # noqa: E722
                pass
            return cast(Union["UploadDataBodyValueType0", str], data)
