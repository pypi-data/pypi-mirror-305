...
if TYPE_CHECKING:
    from ..models.upload_data_job_value_type_0 import UploadDataJobValueType0


T = TypeVar("T", bound="UploadDataJob")
...
class UploadDataJob:
    ...
    Attributes:
        value (Union['UploadDataJobValueType0', str]): Data value to store at this path
        paths (List[str]): Paths to create
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if isinstance(self.value, UploadDataJobValueType0):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_value(data: object) -> Union["UploadDataJobValueType0", str]:
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                value_type_0 = UploadDataJobValueType0.from_dict(data)

                return value_type_0
            except:  # noqa: E722
                pass
            return cast(Union["UploadDataJobValueType0", str], data)
        ...
        upload_data_job.additional_properties = d
        return upload_data_job
