...
if TYPE_CHECKING:
    from ..models.account_project_access_schema import AccountProjectAccessSchema


T = TypeVar("T", bound="AccountProjectAccessList")
...
class AccountProjectAccessList:
    ...
    Attributes:
        project_access (Union[Unset, List['AccountProjectAccessSchema']]):
        project_ids (Union[Unset, List[str]]):
        page_count (Union[Unset, int]):
        object_count (Union[Unset, int]):
    """

    project_access: Union[Unset, List["AccountProjectAccessSchema"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for project_access_item_data in _project_access or []:
            project_access_item = AccountProjectAccessSchema.from_dict(project_access_item_data)
        ...
        account_project_access_list = cls(
        ...
        account_project_access_list.additional_properties = d
        return account_project_access_list
