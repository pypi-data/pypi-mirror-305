...
if TYPE_CHECKING:
    ...
    from ..models.patch_group_access_body_data_paths import (
        PatchGroupAccessBodyDataPaths,
    )
    from ..models.patch_group_access_body_file_paths import (
        PatchGroupAccessBodyFilePaths,
    )


T = TypeVar("T", bound="PatchGroupAccessBody")
...
class PatchGroupAccessBody:
    ...
    Attributes:
        ...
        data_paths (Union[Unset, PatchGroupAccessBodyDataPaths]): Dictionary of accessible data paths and their CRUD
            permissions
        file_paths (Union[Unset, PatchGroupAccessBodyFilePaths]): Dictionary of accessible file paths and their CRUD
            permissions
        is_active (Union[Unset, bool]): If false, all group access operations are disabled
    """
    ...
    data_paths: Union[Unset, "PatchGroupAccessBodyDataPaths"] = UNSET
    file_paths: Union[Unset, "PatchGroupAccessBodyFilePaths"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        data_paths: Union[Unset, PatchGroupAccessBodyDataPaths]
        if isinstance(_data_paths, Unset):
            data_paths = UNSET
        else:
            data_paths = PatchGroupAccessBodyDataPaths.from_dict(_data_paths)

        _file_paths = d.pop("file_paths", UNSET)
        file_paths: Union[Unset, PatchGroupAccessBodyFilePaths]
        if isinstance(_file_paths, Unset):
            file_paths = UNSET
        else:
            file_paths = PatchGroupAccessBodyFilePaths.from_dict(_file_paths)

        is_active = d.pop("is_active", UNSET)

        patch_group_access_body = cls(
        ...
        patch_group_access_body.additional_properties = d
        return patch_group_access_body
