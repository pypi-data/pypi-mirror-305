...
T = TypeVar("T", bound="CreateGroupAccessBodyDataPaths")
...
class CreateGroupAccessBodyDataPaths:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        create_group_access_body_data_paths = cls()
        ...
        create_group_access_body_data_paths.additional_properties = additional_properties
        return create_group_access_body_data_paths
