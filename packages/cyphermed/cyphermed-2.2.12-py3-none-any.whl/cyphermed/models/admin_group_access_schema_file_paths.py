...
T = TypeVar("T", bound="AdminGroupAccessSchemaFilePaths")
...
class AdminGroupAccessSchemaFilePaths:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        admin_group_access_schema_file_paths = cls()
        ...
        admin_group_access_schema_file_paths.additional_properties = additional_properties
        return admin_group_access_schema_file_paths
