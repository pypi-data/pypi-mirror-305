...
if TYPE_CHECKING:
    from ..models.admin_account_group_access_schema_data_paths import (
        AdminAccountGroupAccessSchemaDataPaths,
    )
    from ..models.admin_account_group_access_schema_file_paths import (
        AdminAccountGroupAccessSchemaFilePaths,
    )
    from ..models.crud_permissions import CRUDPermissions


T = TypeVar("T", bound="AdminAccountGroupAccessSchema")


@_attrs_define
class AdminAccountGroupAccessSchema:
    """Admin group access schema plus some info about the group
    ...
    Attributes:
        ...
        data_paths (AdminAccountGroupAccessSchemaDataPaths): Dictionary of accessible data paths
        file_paths (AdminAccountGroupAccessSchemaFilePaths): Dictionary of accessible file paths
    ...
    is_active: bool
    data_paths: "AdminAccountGroupAccessSchemaDataPaths"
    file_paths: "AdminAccountGroupAccessSchemaFilePaths"
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        data_paths = AdminAccountGroupAccessSchemaDataPaths.from_dict(d.pop("data_paths"))

        file_paths = AdminAccountGroupAccessSchemaFilePaths.from_dict(d.pop("file_paths"))
        ...
        group_description = d.pop("group_description", UNSET)

        admin_account_group_access_schema = cls(
            is_delete_protected=is_delete_protected,
            created_date=created_date,
            can_read=can_read,
            can_update=can_update,
        ...
        admin_account_group_access_schema.additional_properties = d
        return admin_account_group_access_schema
