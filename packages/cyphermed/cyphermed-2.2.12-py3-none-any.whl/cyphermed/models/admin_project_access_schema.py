...
T = TypeVar("T", bound="AdminProjectAccessSchema")
...
class AdminProjectAccessSchema:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        admin_project_access_schema = cls(
            is_delete_protected=is_delete_protected,
            created_date=created_date,
            can_read=can_read,
            can_update=can_update,
        ...
        admin_project_access_schema.additional_properties = d
        return admin_project_access_schema
