...
T = TypeVar("T", bound="OrgAccessSchema")
...
class OrgAccessSchema:
    ...
    Attributes:
        ...
        org_id (str): ID of the organization that has access
        ...
        project_permissions (CRUDPermissions): Collection of CRUD permissions
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        project_permissions = CRUDPermissions.from_dict(d.pop("project_permissions"))
        ...
        org_access_schema.additional_properties = d
        return org_access_schema
