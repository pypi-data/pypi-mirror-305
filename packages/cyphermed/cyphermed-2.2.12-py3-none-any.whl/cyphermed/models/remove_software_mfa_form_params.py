...
T = TypeVar("T", bound="RemoveSoftwareMfaFormParams")


@_attrs_define
class RemoveSoftwareMfaFormParams:
    """
    Attributes:
        ...
        recovery_code (Union[Unset, str]): Software MFA recovery code
    """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        remove_software_mfa_form_params = cls(
            client_id=client_id,
            username=username,
            email=email,
        ...
        remove_software_mfa_form_params.additional_properties = d
        return remove_software_mfa_form_params
