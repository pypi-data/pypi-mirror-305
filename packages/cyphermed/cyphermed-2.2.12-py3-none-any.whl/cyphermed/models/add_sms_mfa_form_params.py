...
T = TypeVar("T", bound="AddSmsMfaFormParams")


@_attrs_define
class AddSmsMfaFormParams:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        add_sms_mfa_form_params.additional_properties = d
        return add_sms_mfa_form_params
