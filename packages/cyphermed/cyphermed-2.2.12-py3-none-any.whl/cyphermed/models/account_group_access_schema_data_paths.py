...
T = TypeVar("T", bound="AccountGroupAccessSchemaDataPaths")
...
class AccountGroupAccessSchemaDataPaths:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        account_group_access_schema_data_paths = cls()
        ...
        account_group_access_schema_data_paths.additional_properties = additional_properties
        return account_group_access_schema_data_paths
