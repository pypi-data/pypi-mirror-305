...
if TYPE_CHECKING:
    from ..models.patch_data_job_value_type_0 import PatchDataJobValueType0


T = TypeVar("T", bound="PatchDataJob")
...
class PatchDataJob:
    ...
    Attributes:
        paths (List[str]): Paths to update
        ...
        value (Union['PatchDataJobValueType0', Unset, str]): Data value to store at this path
    """
    ...
    value: Union["PatchDataJobValueType0", Unset, str] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if isinstance(self.value, Unset):
            value = UNSET
        elif isinstance(self.value, PatchDataJobValueType0):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_value(data: object) -> Union["PatchDataJobValueType0", Unset, str]:
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                value_type_0 = PatchDataJobValueType0.from_dict(data)

                return value_type_0
            except:  # noqa: E722
                pass
            return cast(Union["PatchDataJobValueType0", Unset, str], data)
        ...
        patch_data_job.additional_properties = d
        return patch_data_job
