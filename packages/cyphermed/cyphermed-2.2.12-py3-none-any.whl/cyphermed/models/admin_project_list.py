...
T = TypeVar("T", bound="AdminProjectList")
...
class AdminProjectList:
    ...
    Attributes:
        projects (Union[Unset, List['AdminProjectSchema']]):
        page_count (Union[Unset, int]):
        object_count (Union[Unset, int]):
    """

    projects: Union[Unset, List["AdminProjectSchema"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for projects_item_data in _projects or []:
            projects_item = AdminProjectSchema.from_dict(projects_item_data)
        ...
        admin_project_list = cls(
            projects=projects,
            page_count=page_count,
            object_count=object_count,
        )

        admin_project_list.additional_properties = d
