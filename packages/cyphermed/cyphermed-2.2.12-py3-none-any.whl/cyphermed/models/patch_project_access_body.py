...
T = TypeVar("T", bound="PatchProjectAccessBody")
...
class PatchProjectAccessBody:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        patch_project_access_body.additional_properties = d
        return patch_project_access_body
