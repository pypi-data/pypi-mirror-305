...
T = TypeVar("T", bound="CreateEmailTemplateBody")
...
class CreateEmailTemplateBody:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        create_email_template_body = cls(
            name=name,
            subject=subject,
            body_txt=body_txt,
            body_html=body_html,
        ...
        create_email_template_body.additional_properties = d
        return create_email_template_body
