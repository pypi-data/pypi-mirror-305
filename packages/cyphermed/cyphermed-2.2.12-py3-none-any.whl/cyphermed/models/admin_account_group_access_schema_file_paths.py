...
T = TypeVar("T", bound="AdminAccountGroupAccessSchemaFilePaths")


@_attrs_define
class AdminAccountGroupAccessSchemaFilePaths:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        admin_account_group_access_schema_file_paths = cls()
        ...
        admin_account_group_access_schema_file_paths.additional_properties = additional_properties
        return admin_account_group_access_schema_file_paths
