...
if TYPE_CHECKING:
    from ..models.admin_user_schema import AdminUserSchema


T = TypeVar("T", bound="AdminUserList")
...
class AdminUserList:
    """
    Attributes:
        users (Union[Unset, List['AdminUserSchema']]):
        page_count (Union[Unset, int]):
        object_count (Union[Unset, int]):
    """

    users: Union[Unset, List["AdminUserSchema"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for users_item_data in _users or []:
            users_item = AdminUserSchema.from_dict(users_item_data)
        ...
        admin_user_list.additional_properties = d
