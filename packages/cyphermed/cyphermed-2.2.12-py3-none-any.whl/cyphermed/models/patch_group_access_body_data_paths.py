...
T = TypeVar("T", bound="PatchGroupAccessBodyDataPaths")
...
class PatchGroupAccessBodyDataPaths:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        patch_group_access_body_data_paths = cls()
        ...
        patch_group_access_body_data_paths.additional_properties = additional_properties
        return patch_group_access_body_data_paths
