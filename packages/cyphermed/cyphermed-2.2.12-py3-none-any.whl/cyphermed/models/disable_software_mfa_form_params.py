...
T = TypeVar("T", bound="DisableSoftwareMfaFormParams")
...
class DisableSoftwareMfaFormParams:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        disable_software_mfa_form_params = cls(
            client_id=client_id,
            username=username,
            email=email,
        ...
        disable_software_mfa_form_params.additional_properties = d
        return disable_software_mfa_form_params
