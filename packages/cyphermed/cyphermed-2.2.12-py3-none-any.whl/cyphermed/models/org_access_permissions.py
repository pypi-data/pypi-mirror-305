...
T = TypeVar("T", bound="OrgAccessPermissions")
...
class OrgAccessPermissions:
    ...
    Attributes:
        ...
        project_permissions (Union[Unset, CRUDPermissions]): Collection of CRUD permissions
    """
    ...
    project_permissions: Union[Unset, "CRUDPermissions"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        project_permissions: Union[Unset, CRUDPermissions]
        if isinstance(_project_permissions, Unset):
            project_permissions = UNSET
        else:
            project_permissions = CRUDPermissions.from_dict(_project_permissions)

        org_access_permissions = cls(
        ...
        org_access_permissions.additional_properties = d
        return org_access_permissions
