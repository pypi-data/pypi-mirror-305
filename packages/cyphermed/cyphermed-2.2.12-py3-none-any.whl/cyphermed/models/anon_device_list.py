...
T = TypeVar("T", bound="AnonDeviceList")
...
class AnonDeviceList:
    ...
    Attributes:
        devices (Union[Unset, List['AnonAccountSchema']]):
        page_count (Union[Unset, int]):
        object_count (Union[Unset, int]):
    """

    devices: Union[Unset, List["AnonAccountSchema"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for devices_item_data in _devices or []:
            devices_item = AnonAccountSchema.from_dict(devices_item_data)
        ...
        anon_device_list = cls(
            devices=devices,
            page_count=page_count,
            object_count=object_count,
        )

        anon_device_list.additional_properties = d
        return anon_device_list
