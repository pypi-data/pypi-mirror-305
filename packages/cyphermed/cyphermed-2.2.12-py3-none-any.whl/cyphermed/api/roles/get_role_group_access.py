...
from ...models.role_group_access_list import RoleGroupAccessList
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/v2/roles/{role_id}/access/groups",
        "params": params,
    }
...
) -> Optional[RoleGroupAccessList]:
    if response.status_code == HTTPStatus.OK:
        response_200 = RoleGroupAccessList.from_dict(response.json())
