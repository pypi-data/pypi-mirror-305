...
from ...models.role_project_access_list import RoleProjectAccessList
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/v2/roles/{role_id}/access/projects",
        "params": params,
    }
...
) -> Optional[RoleProjectAccessList]:
    if response.status_code == HTTPStatus.OK:
        response_200 = RoleProjectAccessList.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[RoleProjectAccessList]:
    return Response(
