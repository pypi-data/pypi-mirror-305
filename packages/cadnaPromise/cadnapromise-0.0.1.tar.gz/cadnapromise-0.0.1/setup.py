...
setup_args = {'name':'cadnaPromise',
		...
		'packages':{"cadnaPromise", "cadnaPromise.cadna", "cadnaPromise.extra"},
		'package_data':{"cadnaPromise": ["cadna/*", 
									"cadna/admin/*",
									"cadna/doc/*",
									"cadna/m4/*",
									"cadna/srcC/*", 
									...
									"extra/srcC_mpi/*",
									"extra/srcFortran/*",
									"extra/srcFortran_mpi/*"]},
		'tests_require':['pytest', 'pytest-cov'],
		'setup_requires':['colorlog', 'colorama', 'docopt', 'pyyaml', 'tqdm', 
