...
setup(
    ...
    url=confkcw['url'],
    packages =  b,
    install_requires = ['kcweb==6.2','pyOpenSSL==23.2.0','chardet==4.0.0','apscheduler==3.6.3','pillow>=10.0.0','oss2>=2.12.1','websocket-client==1.3.1','cryptography==41.0.7'], #第三方包
    package_data = {
