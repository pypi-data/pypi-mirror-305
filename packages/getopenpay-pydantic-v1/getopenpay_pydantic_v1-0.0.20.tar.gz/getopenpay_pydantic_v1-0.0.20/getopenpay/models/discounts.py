...
class Discounts(BaseModel):
  ...
  if TYPE_CHECKING:
    actual_instance: Union[InvoiceDiscountOptions, str]
  else:
    actual_instance: Any
  any_of_schemas: List[str] = Field(DISCOUNTS_ANY_OF_SCHEMAS, const=True)
  ...
  @classmethod
  def from_dict(cls, obj: dict) -> Discounts:
    return cls.from_json(json.dumps(obj))

  @classmethod
  def from_json(cls, json_str: str) -> Discounts:
