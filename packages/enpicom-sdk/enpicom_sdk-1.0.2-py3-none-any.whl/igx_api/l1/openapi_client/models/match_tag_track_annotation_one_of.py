...
class MatchTagTrackAnnotationOneOf(BaseModel):
    """
    MatchTagTrackAnnotationOneOf
    """ # noqa: E501
    type: StrictStr
    annotation_id: StrictStr
    __properties: ClassVar[List[str]] = ["type", "annotation_id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MatchTagTrackAnnotationOneOf from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MatchTagTrackAnnotationOneOf from a dict"""
        if obj is None:
            return None
