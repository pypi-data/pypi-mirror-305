...
class GetTrackTemplates200ResponseTemplatesInner(BaseModel):
    """
    GetTrackTemplates200ResponseTemplatesInner
    """ # noqa: E501
    created_at: datetime
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetTrackTemplates200ResponseTemplatesInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetTrackTemplates200ResponseTemplatesInner from a dict"""
        if obj is None:
            return None
