...
class TrackTemplateFoldChangeAnnotationInputs(BaseModel):
    """
    TrackTemplateFoldChangeAnnotationInputs
    """ # noqa: E501
    ...
    to: Optional[StrictStr] = Field(default=None, description="The name of a Track set operation. Has to be unique within a template.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TrackTemplateFoldChangeAnnotationInputs from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TrackTemplateFoldChangeAnnotationInputs from a dict"""
        if obj is None:
            return None
