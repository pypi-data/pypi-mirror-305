...
class TrackTemplateDifferenceOperationInputs(BaseModel):
    """
    TrackTemplateDifferenceOperationInputs
    """ # noqa: E501
    remove: Optional[StrictStr] = Field(default=None, description="The name of a Track set operation. Has to be unique within a template.")
    var_from: Optional[StrictStr] = Field(default=None, description="The name of a Track set operation. Has to be unique within a template.", alias="from")
    __properties: ClassVar[List[str]] = ["remove", "from"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TrackTemplateDifferenceOperationInputs from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TrackTemplateDifferenceOperationInputs from a dict"""
        if obj is None:
            return None
