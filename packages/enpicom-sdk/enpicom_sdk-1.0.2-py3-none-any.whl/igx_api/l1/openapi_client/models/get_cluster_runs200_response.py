...
class GetClusterRuns200Response(BaseModel):
    """
    GetClusterRuns200Response
    """ # noqa: E501
    clusters: List[ExistingClusterRun]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetClusterRuns200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetClusterRuns200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "clusters": [ExistingClusterRun.from_dict(_item) for _item in obj["clusters"]] if obj.get("clusters") is not None else None
        })
        return _obj
