...
MATCHTAGRULE_ONE_OF_SCHEMAS = ["Contains", "EndsWith", "Equals", "GreaterThan", "IsBlank", "LessThan", "NotContains", "NotEquals", "NotIsBlank", "StartsWith"]
...
class MatchTagRule(BaseModel):
    ...
    actual_instance: Optional[Union[Contains, EndsWith, Equals, GreaterThan, IsBlank, LessThan, NotContains, NotEquals, NotIsBlank, StartsWith]] = None
    one_of_schemas: Set[str] = { "Contains", "EndsWith", "Equals", "GreaterThan", "IsBlank", "LessThan", "NotContains", "NotEquals", "NotIsBlank", "StartsWith" }
    ...
    def actual_instance_must_validate_oneof(cls, v):
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when setting `actual_instance` in MatchTagRule with oneOf schemas: Contains, EndsWith, Equals, GreaterThan, IsBlank, LessThan, NotContains, NotEquals, NotIsBlank, StartsWith. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when setting `actual_instance` in MatchTagRule with oneOf schemas: Contains, EndsWith, Equals, GreaterThan, IsBlank, LessThan, NotContains, NotEquals, NotIsBlank, StartsWith. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when deserializing the JSON string into MatchTagRule with oneOf schemas: Contains, EndsWith, Equals, GreaterThan, IsBlank, LessThan, NotContains, NotEquals, NotIsBlank, StartsWith. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when deserializing the JSON string into MatchTagRule with oneOf schemas: Contains, EndsWith, Equals, GreaterThan, IsBlank, LessThan, NotContains, NotEquals, NotIsBlank, StartsWith. Details: " + ", ".join(error_messages))
        else:
            return instance
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], Contains, EndsWith, Equals, GreaterThan, IsBlank, LessThan, NotContains, NotEquals, NotIsBlank, StartsWith]]:
