...
class GetTrackRun200Response(BaseModel):
    """
    GetTrackRun200Response
    """ # noqa: E501
    run: ExistingTrackRun
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetTrackRun200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetTrackRun200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "run": ExistingTrackRun.from_dict(obj["run"]) if obj.get("run") is not None else None
        })
        return _obj
