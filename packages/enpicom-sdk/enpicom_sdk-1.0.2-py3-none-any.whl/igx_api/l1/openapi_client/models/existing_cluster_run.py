...
class ExistingClusterRun(BaseModel):
    """
    ...
    sequence_features: Annotated[List[StrictInt], Field(min_length=1)] = Field(description="Tag ids of sequence features to cluster on")
    optional_restrictions: Optional[ClusterOptionalRestrictions] = None
    ...
    __properties: ClassVar[List[str]] = ["name", "collection_ids", "identities", "sequence_features", "optional_restrictions", "additional_options", "created_at", "id", "receptor"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ExistingClusterRun from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of optional_restrictions
        if self.optional_restrictions:
            _dict['optional_restrictions'] = self.optional_restrictions.to_dict()
        ...
        # set to None if optional_restrictions (nullable) is None
        # and model_fields_set contains the field
        if self.optional_restrictions is None and "optional_restrictions" in self.model_fields_set:
            _dict['optional_restrictions'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ExistingClusterRun from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "optional_restrictions": ClusterOptionalRestrictions.from_dict(obj["optional_restrictions"]) if obj.get("optional_restrictions") is not None else None,
