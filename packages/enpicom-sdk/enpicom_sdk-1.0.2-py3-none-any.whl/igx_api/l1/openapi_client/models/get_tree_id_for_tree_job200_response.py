...
class GetTreeIdForTreeJob200Response(BaseModel):
    """
    GetTreeIdForTreeJob200Response
    """ # noqa: E501
    tree_id: StrictInt
    __properties: ClassVar[List[str]] = ["tree_id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetTreeIdForTreeJob200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetTreeIdForTreeJob200Response from a dict"""
        if obj is None:
            return None
