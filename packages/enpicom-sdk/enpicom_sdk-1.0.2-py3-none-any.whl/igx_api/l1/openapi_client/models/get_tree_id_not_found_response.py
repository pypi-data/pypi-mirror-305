...
class GetTreeIdNotFoundResponse(BaseModel):
    """
    GetTreeIdNotFoundResponse
    """ # noqa: E501
    result: StrictStr
    message: StrictStr
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetTreeIdNotFoundResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetTreeIdNotFoundResponse from a dict"""
        if obj is None:
            return None
