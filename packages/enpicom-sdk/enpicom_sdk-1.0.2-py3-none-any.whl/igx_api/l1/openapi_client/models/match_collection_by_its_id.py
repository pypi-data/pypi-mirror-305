...
class MatchCollectionByItsID(BaseModel):
    """
    MatchCollectionByItsID
    """ # noqa: E501
    type: StrictStr
    value: StrictInt = Field(description="The identifier of a clone collection.")
    __properties: ClassVar[List[str]] = ["type", "value"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['collection_id']):
            raise ValueError("must be one of enum values ('collection_id')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MatchCollectionByItsID from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MatchCollectionByItsID from a dict"""
        if obj is None:
            return None
