...
class GetTrackRuns200Response(BaseModel):
    """
    GetTrackRuns200Response
    """ # noqa: E501
    runs: List[ExistingTrackRun]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetTrackRuns200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetTrackRuns200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "runs": [ExistingTrackRun.from_dict(_item) for _item in obj["runs"]] if obj.get("runs") is not None else None
        })
        return _obj
