...
class ExistingTrackRunOperationsInner(BaseModel):
    """
    ExistingTrackRunOperationsInner
    """ # noqa: E501
    name: StrictStr
    type: StrictStr
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['union', 'intersection', 'difference']):
            raise ValueError("must be one of enum values ('union', 'intersection', 'difference')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ExistingTrackRunOperationsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ExistingTrackRunOperationsInner from a dict"""
        if obj is None:
            return None
