...
class Filter(FromRawModel[openapi_client.GetFilterSuccessResponse]):
    ...
    def _build(cls, raw: openapi_client.GetFilterSuccessResponse) -> "Filter":
        ...
        return cls(
            ...
            name=raw.name,
            shared=raw.shared,
            condition=ValidationHelper.model_validate(dict(condition=raw.condition.to_dict())).condition,
        )
...
igx_api.l2.types.import_metadata_templated and the metadata import api igx_api.l2.client.api.collection_api.CollectionApi.add_metadata.
"""
