...
from igx_api.l2.tags import FileTags
...
class FederatedCredentials(FromRawModel[openapi_client.models.UploadFile200ResponseCredentials]):
    ...
    @classmethod
    def _build(cls, raw: openapi_client.models.UploadFile200ResponseCredentials) -> "FederatedCredentials":
        return cls(
