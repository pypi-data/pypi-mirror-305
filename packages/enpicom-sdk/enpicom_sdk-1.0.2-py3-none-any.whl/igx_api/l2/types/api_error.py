...
def _get_error_message(error: BaseException | None) -> str:
    ...
    elif hasattr(error, "data") and hasattr(error.data, "message"):
        return cast(str, error.data.message)
    ...
    elif hasattr(error, "data") and hasattr(error.data, "actual_instance") and hasattr(error.data.actual_instance, "message"):
        return cast(str, error.data.actual_instance.message)
    else:
