...
class CollectionTags:
    ...
    **Data type**: `igx_api.l2.types.tag.TagDataType.INTEGER`
    
    **Access type**: `igx_api.l2.types.tag.TagAccessType.MUTABLE`
    """
    AlignmentStringency = TagId(2002)
    """
    **Display name**: Alignment Stringency

    **Data type**: `igx_api.l2.types.tag.TagDataType.TEXT`
    
    **Access type**: `igx_api.l2.types.tag.TagAccessType.IMMUTABLE`
    """
    ...
    **Data type**: `igx_api.l2.types.tag.TagDataType.BOOLEAN`
    ...
    **Data type**: `igx_api.l2.types.tag.TagDataType.DECIMAL`
    ...
    **Access type**: `igx_api.l2.types.tag.TagAccessType.MUTABLE_NON_DELETABLE`
    """
...
class CloneTags:
    ...
    **Data type**: `igx_api.l2.types.tag.TagDataType.AMINO_ACID_SEQUENCE`
    ...
    **Data type**: `igx_api.l2.types.tag.TagDataType.NUCLEOTIDE_SEQUENCE`
    ...
    **Data type**: `igx_api.l2.types.tag.TagDataType.QUALITY_SEQUENCE`
...
class CloneContextualTags:
    pass
    GermlineHammingDistance = TagId(8001)
    """
    **Display name**: Germline Hamming Distance
