...
class TrackApi:
    ...
    def get_template(self, track_template_id: TrackTemplateId) -> ExistingTrackTemplate:
        ...
        Returns:
            igx_api.l2.types.track.ExistingTrackTemplate: A Track template matching the provided ID.
        ...
        with ApiErrorContext():
            data = track_api_instance.get_track_template(int(track_template_id))

        return ExistingTrackTemplate.from_raw(data.template)
    ...
    def delete_template(self, track_template_id: TrackTemplateId) -> None:
        ...
        with ApiErrorContext():
            track_api_instance.delete_track_template(int(track_template_id))
    ...
    def create_template(
        ...
        Returns:
            igx_api.l2.types.track.ExistingTrackTemplate: A newly created Track template.
        ...
        payload = openapi_client.TrackTemplate(name=name, operations=[transform_operation(op) for op in operations])
    ...
    def start(
        ...
        Args:
            name (str):
                Track run name.
            track_template_id (igx_api.l2.types.track.TrackTemplateId):
                Track template ID.
