...
# %% ../nbs/00_core.ipynb 4
# Need the researchit_program_project_creation for a few functions, this can be considered a static var
...
PACKAGE_NAME: str = (
    "researchit_program_project_creation"  # Make sure to adjust this to your package name
)
DEV_MODE: bool = (
