...
from briton.schema import (
    create_completion,
    create_completion_chunks,
    get_prompt,
    update_raw_model_input,
...
class Model:
    def __init__(self, **kwargs):
        ...
        self._batch_scheduler_policy = truss_trtllm_build_config.batch_scheduler_policy
    ...
    def load(self):
        ...
        load_briton(
            ...
            batch_scheduler_policy=self._batch_scheduler_policy.value,
        )
        self._loaded = True
