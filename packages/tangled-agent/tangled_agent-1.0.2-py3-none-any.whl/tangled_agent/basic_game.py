...
def play_remote_game(game_id: str, host: str, player: GameAgentBase, force_new_credentials: bool = False): 
    """
    ...
    GamePlayerBase.start_game(RemoteGamePlayer, player, game_id, host, force_new_credentials=force_new_credentials)
