...
extras_require = {
    'openai': ['openai>=1.53.0'],          # Optional dependency for OpenAI support
    'anthropic': ['anthropic>=0.36.1'],    # Optional dependency for Anthropic support
    'full': ['openai>=1.53.0', 'anthropic>=0.36.1']  # Combined extras for both
}

# Main setup configuration
setup(
    name="fiscus",  # Package name as it will appear on PyPI or in package managers
    version="0.1.0a1",  # Version of the package (alpha release here)
