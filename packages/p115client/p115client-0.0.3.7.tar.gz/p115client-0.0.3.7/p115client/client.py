...
class P115Client:
    ...
    def fs_video_m3u8(
        ...
        **request_kwargs, 
        ...
        1. 需要破解 data 参数具体如何生成（公钥应该是 256 位的）
    ...
    def offline_add_torrent(
        ...
        **request_kwargs, 
        ...
        """
        api = "https://lixian.115.com/lixianssp/?ac=add_task_bt"
        payload["ac"] = "add_task_bt"
    ...
    def offline_add_url(
        ...
        **request_kwargs, 
        ...
        :payload:
            ...
            - wp_path_id: int | str = <default> 💡 保存到目录的 id
        """
        api = "https://lixian.115.com/lixianssp/?ac=add_task_url"
        if isinstance(payload, str):
            payload = {"url": payload}
        payload["ac"] = "add_task_url"
        payload["app_ver"] = "99.99.99.99"
        def parse(resp, content: bytes) -> dict:
            json = json_loads(content)
            if data := json.get("data"):
    ...
    def offline_add_urls(
        ...
        **request_kwargs, 
        ...
        :payload:
            ...
            - wp_path_id: int | str = <default> 💡 保存到目录的 id
        """
        api = "https://lixian.115.com/lixianssp/?ac=add_task_urls"
        if not isinstance(payload, dict):
    ...
    def offline_remove(
        ...
        **request_kwargs, 
        ...
        """
        api = "https://lixian.115.com/lixianssp/?ac=task_del"
        if isinstance(payload, str):
