...
def load(
    *,
    ...
    <lseg_analytics.instruments.fx_forwards.fx_forward.FxForward at 0x7f10c08f14d0>

    Load by name and space.

    >>> load(name="EURCHF", space="MYSPACE")
    <lseg_analytics.instruments.fx_forwards.fx_forward.FxForward at 0x7f10c0fe6550>
    ...
    if not result:
        ...
        raise ResourceNotFound("FxForward", f"name={name} space={space}")
