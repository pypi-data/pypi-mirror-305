...
if sys.version_info >= (3, 8):
    ...
    from typing_extensions import (
        Literal,  # type: ignore  # pylint: disable=ungrouped-imports
    )
...
class When(_model_base.Model):
    ...
    position_type: Literal[None] = rest_discriminator(name="positionType")
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        ...
        self.position_type: Literal[None] = None
...
class AbsolutePositionWhen(When, discriminator="AbsolutePositionWhen"):
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        super().__init__(*args, **kwargs)
        self.position_type: Literal[PositionType.ABSOLUTE_POSITION_WHEN] = PositionType.ABSOLUTE_POSITION_WHEN
...
class Date(_model_base.Model):
    ...
    __mapping__: Dict[str, _model_base.Model] = {}
    date_type: Literal[None] = rest_discriminator(name="dateType")
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        super().__init__(*args, **kwargs)
        self.date_type: Literal[None] = None
...
class AdjustableDate(Date, discriminator="AdjustableDate"):
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        super().__init__(*args, **kwargs)
        self.date_type: Literal[DateType.ADJUSTABLE_DATE] = DateType.ADJUSTABLE_DATE
        if self.calendars is None:
            self.calendars = list()
...
class BuildInDirectFromDepositsRequest(_model_base.Model):
    """An object used to build a curve definition from deposit instruments when there is an indirect
    quotation for the currency pair of the curve.
    ...
    cross_currency : ~analyticsapi.models.CrossCurrencyInput
        A string to define the currency pair of the curve. Required.
    reference_currency : ~analyticsapi.models.CurrencyInput
        ...
        of the curve.
    additional_tenor_types : list[str or ~analyticsapi.models.TenorType]
        An array of tenor types that can be used for instruments in addition to
        the standard tenor.
    sources : ~analyticsapi.models.IndirectSourcesDeposits
        An object that defines the sources containing the market data for the
        instruments used to create the curve definition.
    """
    ...
    additional_tenor_types: Optional[List[Union[str, "_models.TenorType"]]] = rest_field(name="additionalTenorTypes")
    """An array of tenor types that can be used for instruments in addition to the standard tenor."""
    sources: Optional["_models.IndirectSourcesDeposits"] = rest_field()
    """An object that defines the sources containing the market data for the instruments used to
     create the curve definition."""
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        super().__init__(*args, **kwargs)
        if self.additional_tenor_types is None:
            self.additional_tenor_types = list()


class BuildInDirectFromFxForwardsRequest(_model_base.Model):
    """An object used to build a curve definition from FX forward instruments when there is an
    indirect quotation for the currency pair of the curve.
    ...
    additional_tenor_types : list[str or ~analyticsapi.models.TenorType]
        An array of tenor types that can be used for instruments in addition to
        the standard tenor.
    sources : ~analyticsapi.models.IndirectSourcesSwaps
        An object that defines the sources containing the market data for the
        instruments used to create the curve definition.
    """
    ...
    additional_tenor_types: Optional[List[Union[str, "_models.TenorType"]]] = rest_field(name="additionalTenorTypes")
    """An array of tenor types that can be used for instruments in addition to the standard tenor."""
    sources: Optional["_models.IndirectSourcesSwaps"] = rest_field()
    """An object that defines the sources containing the market data for the instruments used to
     create the curve definition."""
...
class ComputeDatesRequest(_model_base.Model):
    """An object to calculate dates adding periods to a given date.
    ...
    ----------
    tenors : list[str]
        Tenors to be added to startDate to calculate the resulted dates (e.g.,
        1M, 1Y). Required.
    start_date : ~datetime.date
        The start date of the calculation. The value is expressed in ISO 8601
        format: YYYY-MM-DD (e.g., 2023-01-01).
    date_moving_convention : str or ~analyticsapi.models.DateMovingConvention
        The method to adjust dates to working days. Known values are:
        "ModifiedFollowing", "NextBusinessDay", "PreviousBusinessDay",
        "NoMoving", "EveryThirdWednesday", and "BbswModifiedFollowing".
    """

    tenors: List[str] = rest_field()
    """Tenors to be added to startDate to calculate the resulted dates (e.g., 1M, 1Y). Required."""
    start_date: Optional[datetime.date] = rest_field(name="startDate")
    """The start date of the calculation. The value is expressed in ISO 8601 format: YYYY-MM-DD (e.g.,
     2023-01-01)."""
    date_moving_convention: Optional[Union[str, "_models.DateMovingConvention"]] = rest_field(
        name="dateMovingConvention"
    )
    """The method to adjust dates to working days. Known values are: \"ModifiedFollowing\",
     \"NextBusinessDay\", \"PreviousBusinessDay\", \"NoMoving\", \"EveryThirdWednesday\", and
     \"BbswModifiedFollowing\"."""
...
class ComputeDatesRequestCollection(_model_base.Model):
    """An object to calculate dates using one or many calendars.
    ...
    date_moving_convention : str or ~analyticsapi.models.DateMovingConvention
        ...
        "NoMoving", "EveryThirdWednesday", and "BbswModifiedFollowing".
    calendars : list[~analyticsapi.models.CalendarRelatedResource]
        An array of calendar reference strings for which the calculation should
        be done. Each string being composed of the space and name of a
        calendar. For example 'LSEG.UKG' is the string referencing the 'UKG'
        calendar stored in the 'LSEG' space. Required.
    """
    ...
    """The method to adjust dates to working days. Known values are: \"ModifiedFollowing\",
     \"NextBusinessDay\", \"PreviousBusinessDay\", \"NoMoving\", \"EveryThirdWednesday\", and
     \"BbswModifiedFollowing\"."""
    calendars: List["_models.CalendarRelatedResource"] = rest_field()
    """An array of calendar reference strings for which the calculation should be done. Each string
     being composed of the
     space and name of a calendar. For example 'LSEG.UKG' is the string referencing the 'UKG'
     calendar stored in the 'LSEG' space. Required."""
...
class CountPeriodsRequest(_model_base.Model):
    """parameters for count periods which including startDate, endDate etc.
    ...
    ----------
    start_date : ~datetime.date
        start date for counting periods. Required.
    end_date : ~datetime.date
        end date for counting periods. Required.
    day_count_basis : str or ~analyticsapi.models.DayCountBasis
        The day count basis convention used to calculate the period between two
        dates.
        ...
        "Dcb_Actual_365P", "Dcb_ActualLeapDay_365", "Dcb_ActualLeapDay_360", "Dcb_Actual_36525",
        "Dcb_Actual_365_CanadianConvention", and "Dcb_Constant".
    period_type : str or ~analyticsapi.models.PeriodType
        The method of the period calculation. Known values are: "WorkingDay",
        "NonWorkingDay", "Day", "Week", "Month", "Quarter", and "Year".
    """
    ...
    """end date for counting periods. Required."""
    day_count_basis: Optional[Union[str, "_models.DayCountBasis"]] = rest_field(name="dayCountBasis")
    """The day count basis convention used to calculate the period between two dates.
     ...
     \"Dcb_Constant\"."""
    period_type: Optional[Union[str, "_models.PeriodType"]] = rest_field(name="periodType")
    """The method of the period calculation. Known values are: \"WorkingDay\", \"NonWorkingDay\",
...
class CountPeriodsRequestCollection(_model_base.Model):
    """An object to calculate the period of time between two dates using one or many calendars.
    ...
    calendars : list[~analyticsapi.models.CalendarRelatedResource]
        ...
        be done. Each string being composed of the space and name of a
        calendar. For example 'LSEG.UKG' is the string referencing the 'UKG'
        calendar stored in the 'LSEG' space.
    """
...
class CrossCurrencySwapConstituent(FxForwardCurveConstituent, discriminator="CrossCurrencySwap"):
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        super().__init__(*args, **kwargs)
        self.type: Literal[FxForwardCurveConstituentType.CROSS_CURRENCY_SWAP] = (
            FxForwardCurveConstituentType.CROSS_CURRENCY_SWAP
        )
...
class FxForwardCurveConstituentValues(_model_base.Model):
    ...
    ----------
    type : str or ~analyticsapi.models.FxForwardCurveConstituentType
        Required. Known values are: "FxSpot", "FxForward", "CrossCurrencySwap",
        and "Deposit".
    definition : ~analyticsapi.models.FxConstituentDefinition
        The definition of the constituent.  Optional: provide either a
        definition or a quote.
    ...
    __mapping__: Dict[str, _model_base.Model] = {}
    type: Literal[None] = rest_discriminator(name="type")
    """Required. Known values are: \"FxSpot\", \"FxForward\", \"CrossCurrencySwap\", and \"Deposit\"."""
    definition: Optional["_models.FxConstituentDefinition"] = rest_field()
    """The definition of the constituent.  Optional: provide either a definition or a quote."""
...
class DepositConstituentFx(FxForwardCurveConstituent, discriminator="Deposit"):
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        super().__init__(*args, **kwargs)
        self.type: Literal[FxForwardCurveConstituentType.DEPOSIT] = FxForwardCurveConstituentType.DEPOSIT
...
class Duration(_model_base.Model):
    ...
    __mapping__: Dict[str, _model_base.Model] = {}
    duration_type: Literal[None] = rest_discriminator(name="durationType")
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        if len(args) == 1 and not isinstance(args[0], dict):
            ...
            args = tuple()
        super().__init__(*args, **kwargs)
        self.duration_type: Literal[None] = None
...
class FullDayDuration(Duration, discriminator="FullDayDuration"):
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        super().__init__(*args, **kwargs)
        self.duration_type: Literal[DurationType.FULL_DAY_DURATION] = DurationType.FULL_DAY_DURATION
...
class FxForwardAnalyticsPricing(_model_base.Model):
    """Object defining output of Fx Forward pricing analysis.
...
class FxForwardAnalyticsValuation(_model_base.Model):
    """Object defining output of Fx Forward valuation analysis.
...
class FxForwardAsCollectionItem(_model_base.Model):
    """An object describing the basic properties of an FX forward.
...
class FxForwardConstituent(FxForwardCurveConstituent, discriminator="FxForward"):
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        super().__init__(*args, **kwargs)
        self.type: Literal[FxForwardCurveConstituentType.FX_FORWARD] = FxForwardCurveConstituentType.FX_FORWARD
...
class FxForwardCurveCalculateOnTheFlyRequest(_model_base.Model):
...
class FxForwardCurveCalculateRequest(_model_base.Model):
...
class FxForwardOnTheFlyPriceRequest(_model_base.Model):
...
class FxForwardOnTheFlyValuationRequest(_model_base.Model):
...
class FxForwardPriceRequest(_model_base.Model):
...
class FxForwardValuationRequest(_model_base.Model):
...
class FxSpotConstituent(FxForwardCurveConstituent, discriminator="FxSpot"):
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        super().__init__(*args, **kwargs)
        self.type: Literal[FxForwardCurveConstituentType.FX_SPOT] = FxForwardCurveConstituentType.FX_SPOT
...
class FxSpotOnTheFlyPriceRequest(_model_base.Model):
...
class FxSpotOnTheFlyValuationRequest(_model_base.Model):
...
class FxSpotPriceRequest(_model_base.Model):
    """FxSpotPriceRequest.
...
class FxSpotValuationRequest(_model_base.Model):
...
class GenerateDateScheduleRequest(_model_base.Model):
    """GenerateDateSchedule Parameters which contains frequency, startDate, endDate etc.

    All required parameters must be populated in order to send to server.

    Attributes
    ----------
    frequency : str or ~analyticsapi.models.Frequency
        The frequency of dates in the schedule which should be generated.
        Required. Known values are: "Daily", "Weekly", "BiWeekly", and
        "Monthly".
    start_date : ~datetime.date
        The start date of the calculation. The value is expressed in ISO 8601
        format: YYYY-MM-DD (e.g., 2023-01-01).
    ...
    end_date : ~datetime.date
        The end date of the calculation. The value is expressed in ISO 8601
    ...
    calendar_day_of_month : int
        The number of the day of the month. Required if frequency is Monthly;
        do not use otherwise. The minimum value is 1. The maximum value is 31.
    count : int
        The number is used to define a list of dates counting from the start
        date (or today's date if the start day is not set) to the end date.
    ...
    day_of_week : str or ~analyticsapi.models.WeekDay
        The day of the week. Required if frequency is Daily; do not use
        otherwise. Known values are: "Monday", "Tuesday", "Wednesday",
        "Thursday", "Friday", "Saturday", and "Sunday".
    """

    frequency: Union[str, "_models.Frequency"] = rest_field()
    """The frequency of dates in the schedule which should be generated. Required. Known values are:
    ...
    """The start date of the calculation. The value is expressed in ISO 8601 format: YYYY-MM-DD (e.g.,
     ...
     Required if endDate is in the past."""
    end_date: Optional[datetime.date] = rest_field(name="endDate")
    """The end date of the calculation. The value is expressed in ISO 8601 format: YYYY-MM-DD (e.g.,
     2024-01-01).
     
     If startDate is not specified, endDate is used to define the list of dates from today's date to
     the end date.
     The end date must be greater or equal to the start date.
     Required if count is not specified. Only one of endDate and count can be set at a time."""
    calendar_day_of_month: Optional[int] = rest_field(name="calendarDayOfMonth")
    """The number of the day of the month. Required if frequency is Monthly; do not use otherwise. The
     minimum value is 1. The maximum value is 31."""
    count: Optional[int] = rest_field()
    """The number is used to define a list of dates counting from the start date (or today's date if
     the start day is not set) to the end date.
     
     It should not have a negative value.
     Required if endDate is not specified. Only one of endDate and count can be set at a time."""
    day_of_week: Optional[Union[str, "_models.WeekDay"]] = rest_field(name="dayOfWeek")
    """The day of the week. Required if frequency is Daily; do not use otherwise. Known values are:
...
class GenerateDateScheduleRequestCollection(_model_base.Model):
    """GenerateDateSchedule Parameters which contains frequency, startDate, endDate etc.
...
class GenerateHolidaysRequest(_model_base.Model):
    """An object to generate holidays between two dates.
...
class GenerateHolidaysRequestCollection(_model_base.Model):
    """An object to generate holidays between two dates using one or many calendars.
...
class HalfDayDuration(Duration, discriminator="HalfDayDuration"):
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        super().__init__(*args, **kwargs)
        self.duration_type: Literal[DurationType.HALF_DAY_DURATION] = DurationType.HALF_DAY_DURATION
...
class RescheduleDescription(_model_base.Model):
    ...
    __mapping__: Dict[str, _model_base.Model] = {}
    reschedule_type: Literal[None] = rest_discriminator(name="rescheduleType")
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        if len(args) == 1 and not isinstance(args[0], dict):
            ...
            args = tuple()
        super().__init__(*args, **kwargs)
        self.reschedule_type: Literal[None] = None
...
class LagDaysRescheduleDescription(RescheduleDescription, discriminator="LagDaysRescheduleDescription"):
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        super().__init__(*args, **kwargs)
        self.reschedule_type: Literal[RescheduleType.LAG_DAYS_RESCHEDULE_DESCRIPTION] = (
            RescheduleType.LAG_DAYS_RESCHEDULE_DESCRIPTION
        )
...
class QuoteOutput(_model_base.Model):
    ...
    definition : ~analyticsapi.models.QuoteOutputDefinition
        An object that defines the attributes for getting the instrument quote.
        Required.
    values : ~analyticsapi.models.BidAskValues
        An object that contains the bid and ask quotes for the instrument.
    """
    ...
    """An object that defines the attributes for getting the instrument quote. Required."""
    values: Optional["_models.BidAskValues"] = rest_field()
    """An object that contains the bid and ask quotes for the instrument."""
    ...
    def __init__(
        ...
        *,
        ...
        values: Optional["_models.BidAskValues"] = None,
    ): ...
...
class RelativeAdjustableDate(Date, discriminator="RelativeAdjustableDate"):
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        super().__init__(*args, **kwargs)
        self.date_type: Literal[DateType.RELATIVE_ADJUSTABLE_DATE] = DateType.RELATIVE_ADJUSTABLE_DATE
        if self.calendars is None:
            self.calendars = list()
...
class RelativePositionWhen(When, discriminator="RelativePositionWhen"):
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        super().__init__(*args, **kwargs)
        self.position_type: Literal[PositionType.RELATIVE_POSITION_WHEN] = PositionType.RELATIVE_POSITION_WHEN
...
class RelativeRescheduleDescription(RescheduleDescription, discriminator="RelativeRescheduleDescription"):
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        super().__init__(*args, **kwargs)
        self.reschedule_type: Literal[RescheduleType.RELATIVE_RESCHEDULE_DESCRIPTION] = (
            RescheduleType.RELATIVE_RESCHEDULE_DESCRIPTION
        )
...
class RelativeToRulePositionWhen(When, discriminator="RelativeToRulePositionWhen"):
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        super().__init__(*args, **kwargs)
        self.position_type: Literal[PositionType.RELATIVE_TO_RULE_POSITION_WHEN] = (
            PositionType.RELATIVE_TO_RULE_POSITION_WHEN
        )
...
class RestDays(_model_base.Model):
    ...
    rest_days : list[str or ~analyticsapi.models.WeekDay]
        Days of the week that are set as rest days. Required.
    validity_period : ~analyticsapi.models.ValidityPeriod
