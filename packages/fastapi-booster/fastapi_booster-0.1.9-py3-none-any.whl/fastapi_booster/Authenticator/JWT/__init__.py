...
class JWTAuthenticator(Module):
    ...
    def __init__(
        ...
        self._login_url = os.getenv("JWT_LOGIN_URL", "login")
        self.oauth2_scheme = OAuth2PasswordBearer(self._login_url)
        ...
        async def logout(token: Annotated[str, Depends(self.oauth2_scheme)]):
            """
