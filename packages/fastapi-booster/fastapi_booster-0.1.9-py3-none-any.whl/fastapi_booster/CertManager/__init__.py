...
from fastapi_booster.Authenticator.HTTPBasic import HTTPBasicAuthenticator
from fastapi_booster.Authenticator.OAuth import OAuthAuthenticator
...
class CertManager(Module):
    ...
    def __init__(self, auth: JWTAuthenticator | OAuthAuthenticator | HTTPBasicAuthenticator):
