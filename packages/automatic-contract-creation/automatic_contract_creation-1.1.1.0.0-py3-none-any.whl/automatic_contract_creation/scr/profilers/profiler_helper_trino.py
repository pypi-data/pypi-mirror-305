...
class ProfilerHelperTrino(DataContextProvider,Profiler):
    ...
    def get_orig_type(self)-> str:
        ...
        """
        return self.dtypes[
            self.dtypes['column_name']==self.business_dt.replace('day(', '').replace(')', '')
    ...
    def get_group_dt(self)-> dict:
        ...
        if self.orig_type == 'date' or 'day(' in self.business_dt:
            group_dict['query_dt']= f"""{self.business_dt.replace('day', 'date')}"""
