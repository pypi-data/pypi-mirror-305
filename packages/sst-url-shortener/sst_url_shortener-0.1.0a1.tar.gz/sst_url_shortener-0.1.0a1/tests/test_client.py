...
from sst_url_shortener import SstURLShortener, AsyncSstURLShortener, APIResponseValidationError
from sst_url_shortener._types import Omit
from sst_url_shortener._models import BaseModel, FinalRequestOptions
from sst_url_shortener._constants import RAW_RESPONSE_HEADER
from sst_url_shortener._exceptions import APIStatusError, APITimeoutError, APIResponseValidationError
from sst_url_shortener._base_client import (
    DEFAULT_TIMEOUT,
...
def _get_open_connections(client: SstURLShortener | AsyncSstURLShortener) -> int:
...
class TestSstURLShortener:
    client = SstURLShortener(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=True)
            ...
            for frame in diff.traceback:
                if any(
                    ...
                    for fragment in [
                        ...
                        "sst_url_shortener/_legacy_response.py",
                        "sst_url_shortener/_response.py",
                        # pydantic.BaseModel.model_dump || pydantic.BaseModel.dict leak memory for some reason.
                        "sst_url_shortener/_compat.py",
    ...
    def test_multipart_repeating_array(self, client: SstURLShortener) -> None:
        request = client._build_request(
    ...
    def test_base_url_env(self) -> None:
        with update_env(SST_URL_SHORTENER_BASE_URL="http://localhost:5000/from/env"):
            client = SstURLShortener(bearer_token=bearer_token, _strict_response_validation=True)
    ...
    def test_base_url_trailing_slash(self, client: SstURLShortener) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: SstURLShortener) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: SstURLShortener) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = SstURLShortener(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            strict_client.get("/foo", cast_to=Model)

        client = SstURLShortener(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=False)
    ...
    @mock.patch("sst_url_shortener._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter) -> None:
        respx_mock.post("/urls/create").mock(side_effect=httpx.TimeoutException("Test timeout error"))

        with pytest.raises(APITimeoutError):
            self.client.post(
                "/urls/create",
                body=cast(object, dict(original_url="REPLACE_ME")),
    ...
    def test_retrying_status_errors_doesnt_leak(self, respx_mock: MockRouter) -> None:
        respx_mock.post("/urls/create").mock(return_value=httpx.Response(500))
    ...
    def test_retries_taken(
        ...
        respx_mock.post("/urls/create").mock(side_effect=retry_handler)

        response = client.urls.with_raw_response.create(original_url="https://example.com")
    ...
    def test_omit_retry_count_header(
        self, client: SstURLShortener, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = client.with_options(max_retries=4)
        ...
        response = client.urls.with_raw_response.create(
            original_url="https://example.com", extra_headers={"x-stainless-retry-count": Omit()}
        )
    ...
    def test_overwrite_retry_count_header(
        ...
        response = client.urls.with_raw_response.create(
            original_url="https://example.com", extra_headers={"x-stainless-retry-count": "42"}
        )

        assert response.http_request.headers.get("x-stainless-retry-count") == "42"


class TestAsyncSstURLShortener:
    client = AsyncSstURLShortener(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=True)
    ...
    def test_multipart_repeating_array(self, async_client: AsyncSstURLShortener) -> None:
    ...
    def test_base_url_env(self) -> None:
        with update_env(SST_URL_SHORTENER_BASE_URL="http://localhost:5000/from/env"):
            client = AsyncSstURLShortener(bearer_token=bearer_token, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"
    ...
    def test_base_url_trailing_slash(self, client: AsyncSstURLShortener) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncSstURLShortener) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncSstURLShortener) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = AsyncSstURLShortener(
        ...
        client = AsyncSstURLShortener(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=False)
    ...
    async def test_retries_taken(
        self,
        async_client: AsyncSstURLShortener,
        failures_before_success: int,
        failure_mode: Literal["status", "exception"],
        respx_mock: MockRouter,
    ) -> None:
        ...
        response = await client.urls.with_raw_response.create(original_url="https://example.com")
    ...
    async def test_omit_retry_count_header(
        self, async_client: AsyncSstURLShortener, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = async_client.with_options(max_retries=4)
        ...
        response = await client.urls.with_raw_response.create(
            original_url="https://example.com", extra_headers={"x-stainless-retry-count": Omit()}
        )
