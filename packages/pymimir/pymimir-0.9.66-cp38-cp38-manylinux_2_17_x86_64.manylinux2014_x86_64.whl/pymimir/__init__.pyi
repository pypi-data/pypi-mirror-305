...
class ConditionalEffect:
    def get_derived_negative_condition(self) -> ...:
        ...
    def get_derived_positive_condition(self) -> ...:
        ...
    def get_fluent_negative_condition(self) -> ...:
        ...
    def get_fluent_positive_condition(self) -> ...:
        ...
    def get_simple_effect(self) -> FlatSimpleEffect:
        ...
    def get_static_negative_condition(self) -> ...:
        ...
    def get_static_positive_condition(self) -> ...:
        ...
class ConditionalEffectList:
    ...
    def __delitem__(self, arg0: slice) -> None:
        ...
        """
    @typing.overload
    def __getitem__(self, s: slice) -> ConditionalEffectList:
        """
        Retrieve list elements using a slice object
        """
    @typing.overload
    def __getitem__(self, arg0: int) -> ConditionalEffect:
        ...
    @typing.overload
    def __init__(self) -> None:
        ...
    @typing.overload
    def __init__(self, arg0: ConditionalEffectList) -> None:
        """
        Copy constructor
        """
    @typing.overload
    ...
    def __setitem__(self, arg0: slice, arg1: ConditionalEffectList) -> None:
        ...
        Assign list elements using a slice object
        """
    def append(self, x: ConditionalEffect) -> None:
        """
        Add an item to the end of the list
        """
    def clear(self) -> None:
        ...
        """
    @typing.overload
    def extend(self, L: ConditionalEffectList) -> None:
        """
        Extend the list by appending all the items in the given list
        """
    @typing.overload
    def extend(self, L: typing.Iterable) -> None:
        ...
        Extend the list by appending all the items in the given list
        """
    def insert(self, i: int, x: ConditionalEffect) -> None:
        """
        Insert an item at a given position.
        """
    @typing.overload
    def pop(self) -> ConditionalEffect:
        """
        Remove and return the last item
        """
    @typing.overload
    def pop(self, i: int) -> ConditionalEffect:
        """
        Remove and return the item at index ``i``
        """
...
class FlatSimpleEffect:
    __hash__: typing.ClassVar[None] = None
    def __eq__(self, arg0: FlatSimpleEffect) -> bool:
        ...
    @property
...
class IndexGroupedVector:
    ...
    def __len__(self) -> int:
        ...
class IsomorphismTypeFunction2FWL:
    def __init__(self) -> None:
        ...
class IsomorphismTypeFunction3FWL:
    def __init__(self) -> None:
        ...
class IsomorphismTypeFunction4FWL:
    def __init__(self) -> None:
        ...
...
class VariableList:
    ...
    def remove(self, x: Variable) -> None:
        ...
        Remove the first item from the list whose value is x. It is an error if there is no such item.
        """
def compute_certificate_2fwl(static_vertex_colored_digraph: StaticVertexColoredDigraph, isomorphism_type_function: IsomorphismTypeFunction2FWL) -> Certificate2FWL:
    ...
def compute_certificate_3fwl(static_vertex_colored_digraph: StaticVertexColoredDigraph, isomorphism_type_function: IsomorphismTypeFunction3FWL) -> Certificate3FWL:
    ...
def compute_certificate_4fwl(static_vertex_colored_digraph: StaticVertexColoredDigraph, isomorphism_type_function: IsomorphismTypeFunction4FWL) -> Certificate4FWL:
    ...
