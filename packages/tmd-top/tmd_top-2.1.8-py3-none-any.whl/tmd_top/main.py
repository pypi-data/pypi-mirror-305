...
"""
    ...
    def watch_detailed(self) -> None:
        ...
        try:
            details_dom._cache = {}
            details_switcher_dom._cache = {}
            details_switcher_dom._cache.clear()
            details_dom.clear()
    ...
    def search(self,name,data) -> None:
        ...
        if name == 'listen':
            ...
            outside = [t for t in data[1:] if any(search_string in s for s in t[1:])]
            if outside:
                return outside
            else:
                return data
        elif name == 'detailed':
            detailed = [t for t in data[1:] if any(search_string in s for s in t[1:])]
            if detailed:
                return detailed
            else:
                return data
