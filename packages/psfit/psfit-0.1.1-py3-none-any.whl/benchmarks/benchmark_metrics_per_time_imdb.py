...
import psfit as pf
from psfit.data import Imdb, DataLoader
...
mark_every = 20  # 2 for cpu 20 for gpu
...
def main():
    data_path = "./data/imdb_data.npz"

    dataset = Imdb(filename = data_path, cv = True, cv_size = 0.1)
