...
def perturb(data: pd.DataFrame, variable: str, perturbation_percentage= 0.05):
    """
...
def compute_single_variable_rgr(xtest: pd.DataFrame, yhat: list, model: CatBoostClassifier, variables: list, perturbation_percentage= 0.05):
    """
...
def compute_full_single_rgr(xtest: pd.DataFrame, yhat: list, model: CatBoostClassifier, perturbation_percentage= 0.05):
    """
