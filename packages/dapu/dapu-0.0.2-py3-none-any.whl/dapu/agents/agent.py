...
class AgentGeneric:
    ...
    def apply_files_to_target(self, existing_files: list[str], replacements: list[tuple[str, str]] | None) -> bool:
        """ 
        ...
        Replacements is list of tuple (find -> replace)
        '"""
    ...
    def find_temp_dir_path(self) -> str:
        ...
        target_name = os.path.split(self.context.work_dir)[1]
