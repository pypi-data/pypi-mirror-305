...
from panda_pos_api.models import Entity, OrderTag, Ticket, Product, ProductTag, TicketTag, TicketState
...
class GraphQL:
    ...
    def change_entity_of_terminal_ticket(self, terminal_id: str, entity_type: str, entity_name: str):
        mutation_name = "changeEntityOfTerminalTicket"
        payload = {
            "operationName": "m",
            "query": self.get_graphql_query_str("mutation", mutation_name, {
                "terminalId": terminal_id,
    ...
    def add_entity(self, entity: Entity):
        mutation_name = "addEntity"
        payload = {
            "operationName": "m",
            "query": self.get_graphql_query_str("mutation", mutation_name, entity.dict(), fields=[]),
        }
        res = self.request(f"{self.message_server_url}/api/graphql", method="POST", json=payload)
        return res