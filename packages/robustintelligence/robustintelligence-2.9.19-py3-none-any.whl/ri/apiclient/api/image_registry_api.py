...
class ImageRegistryApi:
    ...
    @validate_call
    def image_registry_list_images(
        self,
        ...
        _param = self._image_registry_list_images_serialize(
            page_token=page_token,
            page_size=page_size,
        )

        _response_types_map: Dict[str, Optional[str]] = {
            '200': "RimeListImagesResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
        )
    ...
    def _image_registry_list_images_serialize(
        self,
        page_token,
        page_size,
    ) -> RequestSerialized:
    ...
    @validate_call
    def image_registry_list_images2(
        self,
        page_token: Optional[str] = None,
        page_size: Optional[str] = None,
        pip_libraries: Optional[List[ListImagesRequestPipLibraryFilter]] = None,
    ) -> RimeListImagesResponse:
        """ListImages
        ...
        :type pip_libraries: List[ListImagesRequestPipLibraryFilter]
        :return: Returns the result object.
        """ # noqa: E501
        ...
        _param = self._image_registry_list_images2_serialize(
            body=body,
        )
    ...
    def _image_registry_list_images2_serialize(
        self,
        body,
    ) -> RequestSerialized:
