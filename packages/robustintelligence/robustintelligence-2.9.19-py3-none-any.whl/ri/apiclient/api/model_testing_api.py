...
class ModelTestingApi:
    ...
    @validate_call
    def model_testing_start_file_scan(
        self,
        ...
        _param = self._model_testing_start_file_scan_serialize(
            body=body,
        )

        _response_types_map: Dict[str, Optional[str]] = {
            '200': "RimeStartFileScanResponse",
        }
    ...
    def _model_testing_start_file_scan_serialize(
        self,
        body,
    ) -> RequestSerialized:
    ...
    @validate_call
    def model_testing_start_file_scan2(
        self,
        project_id: Optional[RimeUUID] = None,
        model_id: Optional[RimeUUID] = None,
        run_time_info: Optional[RuntimeinfoRunTimeInfo] = None,
        ...
        _param = self._model_testing_start_file_scan2_serialize(
            body=body,
        )
    ...
    def _model_testing_start_file_scan2_serialize(
        self,
        body,
    ) -> RequestSerialized:
    ...
    def start_continuous_test(
        ...
        test_run_incremental_config: Optional[TestrunTestRunIncrementalConfig] = None,
        ...
        :type test_run_incremental_config: TestrunTestRunIncrementalConfig
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "RimeStartContinuousTestResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
        )
    ...
    def start_stress_test(
        ...
        test_run_config: Optional[TestrunTestRunConfig] = None,
        agent_id: Optional[RimeUUID] = None,
        experimental_fields: Optional[Dict[str, object]] = None,
        ...
        :type test_run_config: TestrunTestRunConfig
        :param agent_id:
        :type agent_id: RimeUUID
        :param experimental_fields: Fields that enable experimental functionality.  WARNING: these fields are experimental; ie, their functionality may not be reliable or backwards-compatible. Do not use these fields in production.
        :type experimental_fields: Dict[str, object]
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "RimeStartStressTestResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
        )
