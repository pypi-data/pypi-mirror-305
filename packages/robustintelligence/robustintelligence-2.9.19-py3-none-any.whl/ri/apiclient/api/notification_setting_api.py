...
class NotificationSettingApi:
    ...
    def create_notification(
        self,
        object_id: str,
        object_type: Optional[NotificationObjectType] = None,
        emails: Optional[List[str]] = None,
        config: Optional[SchemanotificationConfig] = None,
        webhooks: Optional[List[NotificationWebhookConfig]] = None,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "RimeCreateNotificationResponse",
        }
    ...
    def list_notifications(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "RimeListNotificationsResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
        )
    ...
    def update_notification(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "RimeUpdateNotificationResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
        )
