...
class RimeJobDataGenerativeModelTest(BaseModel):
    ...
    model_output_is_secret: Optional[StrictBool] = Field(default=None, alias="modelOutputIsSecret")
    __properties: ClassVar[List[str]] = ["workspaceId", "progress", "name", "url", "modelOutputIsSecret"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "url": obj.get("url"),
            "modelOutputIsSecret": obj.get("modelOutputIsSecret")
        })
        return _obj
