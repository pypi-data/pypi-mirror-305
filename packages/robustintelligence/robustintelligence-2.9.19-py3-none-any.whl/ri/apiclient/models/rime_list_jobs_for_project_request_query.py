...
class RimeListJobsForProjectRequestQuery(BaseModel):
    ...
    """ # noqa: E501
    selected_statuses: Optional[List[RimeJobStatus]] = Field(default=None, description="Specifies a set of statuses. The query only returns results with a status in the specified set. Specify no statuses to return all results.", alias="selectedStatuses")
