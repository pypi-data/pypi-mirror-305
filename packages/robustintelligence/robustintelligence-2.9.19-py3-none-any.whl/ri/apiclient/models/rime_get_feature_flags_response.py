...
class RimeGetFeatureFlagsResponse(BaseModel):
    """
    GetFeatureFlagsResponse contains the FeatureFlags of a customer.
    """ # noqa: E501
    feature_flags: Optional[RimeFeatureFlags] = Field(default=None, alias="featureFlags")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "featureFlags": RimeFeatureFlags.from_dict(obj["featureFlags"]) if obj.get("featureFlags") is not None else None
        })
        return _obj
