...
class RimeGetFileScanResultResponse(BaseModel):
    ...
    """ # noqa: E501
    file_scan_result: Optional[SchemafilescanningFileScanResult] = Field(default=None, alias="fileScanResult")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "fileScanResult": SchemafilescanningFileScanResult.from_dict(obj["fileScanResult"]) if obj.get("fileScanResult") is not None else None
        })
        return _obj
