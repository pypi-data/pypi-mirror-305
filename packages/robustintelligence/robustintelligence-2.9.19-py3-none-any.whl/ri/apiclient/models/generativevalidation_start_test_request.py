...
class GenerativevalidationStartTestRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["url", "httpHeaders", "endpointPayloadTemplate", "responseJsonPath", "httpAuthIntegrationId", "name", "mutualTlsIntegrationId", "systemPrompt", "awsIntegrationId", "modelId", "body", "agentId"]
