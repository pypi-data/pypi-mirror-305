...
class RimeGetTimeSeriesResponse(BaseModel):
    """
    ...
    long_description_tabs: Optional[List[RimeLongDescriptionTab]] = Field(default=None, description="More detailed information about the time series.", alias="longDescriptionTabs")
    __properties: ClassVar[List[str]] = ["projectId", "timeSeriesName", "yAxisLabel", "threshold", "dataPoints", "descriptionHtml", "longDescriptionTabs"]
