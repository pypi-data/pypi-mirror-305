...
class SchemasecuritydbRepoMetadata(BaseModel):
    """
    ...
    reputation: Optional[SchemasecuritydbRepoMetadataReputation] = None
    license: Optional[SchemasecuritydbRepoMetadataLicense] = None
    author: Optional[StrictStr] = Field(default=None, description="The author of the model repository.")
    __properties: ClassVar[List[str]] = ["versionInfo", "repoLastModifiedTime", "tags", "reputation", "license", "author"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "tags": obj.get("tags"),
            "reputation": SchemasecuritydbRepoMetadataReputation.from_dict(obj["reputation"]) if obj.get("reputation") is not None else None,
            "license": SchemasecuritydbRepoMetadataLicense.from_dict(obj["license"]) if obj.get("license") is not None else None,
