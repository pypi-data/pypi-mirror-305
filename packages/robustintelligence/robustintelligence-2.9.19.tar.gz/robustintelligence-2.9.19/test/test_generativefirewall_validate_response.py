    ...
    def make_instance(self, include_optional) -> GenerativefirewallValidateResponse:
        ...
        if include_optional:
            return GenerativefirewallValidateResponse(
                input_results = {
                    'key' : ri.fwclient.models.generativefirewall_rule_output.generativefirewallRuleOutput(
                        rule_name = '', 
                ...
                metadata = ri.fwclient.models.validate_response_product_metadata.ValidateResponseProductMetadata(
                    vendor_name = '', 
                    product = '', 
                    firewall_instance_id = '', 
                    version = '', ),
                processed_req = ri.fwclient.models.validate_response_processed_request.ValidateResponseProcessedRequest(
                    request_id = '', 
                    user_input_text = '', 
