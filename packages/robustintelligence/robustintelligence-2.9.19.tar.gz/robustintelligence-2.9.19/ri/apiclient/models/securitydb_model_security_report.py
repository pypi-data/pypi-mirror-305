...
class SecuritydbModelSecurityReport(BaseModel):
    """
    ...
    repo_metadata: Optional[SchemasecuritydbRepoMetadata] = Field(default=None, alias="repoMetadata")
    file_scan_result: Optional[SchemasecuritydbFileScanResult] = Field(default=None, alias="fileScanResult")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "repoMetadata": SchemasecuritydbRepoMetadata.from_dict(obj["repoMetadata"]) if obj.get("repoMetadata") is not None else None,
            "fileScanResult": SchemasecuritydbFileScanResult.from_dict(obj["fileScanResult"]) if obj.get("fileScanResult") is not None else None
        })
        return _obj
