...
class SchemasecuritydbFileSecurityReport(BaseModel):
    """
    ...
    dependencies: Optional[List[FileSecurityReportDependency]] = Field(default=None, description="The list of all dependencies in the file.")
    unsafe_dependencies: Optional[List[FileSecurityReportDependency]] = Field(default=None, description="The list of unsafe dependencies.", alias="unsafeDependencies")
    __properties: ClassVar[List[str]] = ["filepath", "size", "sha256", "creationTime", "lastModifiedTime", "dependencies", "unsafeDependencies"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "dependencies": [FileSecurityReportDependency.from_dict(_item) for _item in obj["dependencies"]] if obj.get("dependencies") is not None else None,
            "unsafeDependencies": [FileSecurityReportDependency.from_dict(_item) for _item in obj["unsafeDependencies"]] if obj.get("unsafeDependencies") is not None else None
        })
        return _obj
