...
class RimeListModelSecurityReportsResponse(BaseModel):
    """
    RimeListModelSecurityReportsResponse
    """ # noqa: E501
    model_security_reports: Optional[List[SecuritydbModelSecurityReport]] = Field(default=None, description="The list of security reports for the models.", alias="modelSecurityReports")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "modelSecurityReports": [SecuritydbModelSecurityReport.from_dict(_item) for _item in obj["modelSecurityReports"]] if obj.get("modelSecurityReports") is not None else None,
