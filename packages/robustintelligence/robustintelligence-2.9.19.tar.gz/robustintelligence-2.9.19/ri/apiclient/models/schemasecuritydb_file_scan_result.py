...
class SchemasecuritydbFileScanResult(BaseModel):
    """
    ...
    file_security_reports: Optional[List[SchemasecuritydbFileSecurityReport]] = Field(default=None, description="The security reports for the files that were scanned.", alias="fileSecurityReports")
    ...
    __properties: ClassVar[List[str]] = ["resultUpdateTime", "fileSecurityReports", "scannedFilePaths", "severity"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "fileSecurityReports": [SchemasecuritydbFileSecurityReport.from_dict(_item) for _item in obj["fileSecurityReports"]] if obj.get("fileSecurityReports") is not None else None,
