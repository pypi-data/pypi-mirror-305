...
class GenerativevalidationGetResultsResponse(BaseModel):
    """
    GenerativevalidationGetResultsResponse
    """ # noqa: E501
    results: Optional[List[GenerativevalidationGenerativeTestingResult]] = Field(default=None, description="The list of generative testing results.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results": [GenerativevalidationGenerativeTestingResult.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None,
