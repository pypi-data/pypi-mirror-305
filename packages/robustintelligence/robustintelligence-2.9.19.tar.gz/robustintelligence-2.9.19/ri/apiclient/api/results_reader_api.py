...
class ResultsReaderApi:
    ...
    def get_batch_result(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "TestrunresultGetBatchResultResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
        )
    ...
    def get_category_results(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "TestrunresultGetCategoryResultsResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
        )
    ...
    def get_feature_result(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "TestrunresultGetFeatureResultResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
        )
    ...
    def get_test_config(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "TestrunresultGetTestConfigResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
        )
    ...
    def list_feature_results(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "TestrunresultListFeatureResultsResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
        )
    ...
    def list_monitor_categories(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "TestrunresultListMonitorCategoriesResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
        )
    ...
    def list_summary_tests(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "TestrunresultListSummaryTestsResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
        )
    ...
    def list_test_cases(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "TestrunresultListTestCasesResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
        )
    ...
    def list_validation_categories(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "TestrunresultListValidationCategoriesResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
        )
    ...
    def rename_test_run(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "TestrunresultRenameTestRunResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
        )
    ...
    @validate_call
    def results_reader_list_batch_results(
        self,
        test_run_id: Optional[str] = None,
        page_token: Optional[str] = None,
        page_size: Optional[str] = None,
        ...
        _param = self._results_reader_list_batch_results_serialize(
            test_run_id=test_run_id,
            page_token=page_token,
            page_size=page_size,
            show_display=show_display,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "TestrunresultListBatchResultsResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
        )
    ...
    def _results_reader_list_batch_results_serialize(
        self,
        test_run_id,
        page_token,
        page_size,
