...
class FileUploadApi:
    ...
    def list_uploaded_file_urls(
        ...
        List all blob store URLs for uploaded files.  File uploading is not currently supported in a Cloud deployment. Please use an external data source instead.
