...
class SecurityDBApi:
    ...
    def get_model_security_report(
        ...
        :param repo_id: The ID of the model repository on Hugging Face. (required)
        :type repo_id: str
        :return: Returns the result object.
        """ # noqa: E501


        _param = self._get_model_security_report_serialize(
            repo_id=repo_id,
        )

        _response_types_map: Dict[str, Optional[str]] = {
            '200': "RimeGetModelSecurityReportResponse",
        }
    ...
    def _get_model_security_report_serialize(
        self,
        repo_id,
    ) -> RequestSerialized:
        ...
        if repo_id is not None:
            ...
            _query_params.append(('repoId', repo_id))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1-beta/security-report/model',
    ...
    @validate_call
    def list_model_security_reports(
        self,
        ...
        :param page_token: A token representing one page from the list returned by a ListModelSecurityReports API. The ListModelSecurityReports API returns a page_token when there is more than one page of results.
        :type page_token: str
        ...
        _param = self._list_model_security_reports_serialize(
            page_token=page_token,
            page_size=page_size,
        )

        _response_types_map: Dict[str, Optional[str]] = {
            '200': "RimeListModelSecurityReportsResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
        )
    ...
    def _list_model_security_reports_serialize(
        self,
        page_token,
        page_size,
    ) -> RequestSerialized:
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1-beta/security-report/models',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
