...
class ProjectServiceApi:
    ...
    def activate_schedule_for_project(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ProjectActivateScheduleForProjectResponse",
        }
    ...
    def add_users_to_project(
        ...
        project_id_uuid: str,
        project_id: Optional[object] = None,
        users: Optional[List[RimeUserWithRole]] = None,
    ) -> object:
        """AddUsersToProject
        ...
        :type users: List[RimeUserWithRole]
        :return: Returns the result object.
        """ # noqa: E501
    ...
    def create_project(
        ...
        model_task: Optional[RimeModelTask] = None,
        tags: Optional[List[str]] = None,
        profiling_config: Optional[TestrunProfilingConfig] = None,
        is_published: Optional[bool] = None,
        run_time_info: Optional[RuntimeinfoRunTimeInfo] = None,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ProjectCreateProjectResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
        )
    ...
    def get_project_url(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ProjectGetProjectURLResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
        )
    ...
    def get_workspace_roles_for_project(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ProjectGetWorkspaceRolesForProjectResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
        )
    ...
    def list_projects(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ProjectListProjectsResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
        )
    ...
    def list_users_of_project(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ProjectListUsersOfProjectResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
        )
    ...
    def update_project(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ProjectUpdateProjectResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
        )
    ...
    def update_workspace_roles_for_project(
        ...
        :type role_pairs: List[RimeParentRoleSubjectRolePair]
        :param project_id: Uniquely specifies a Project.
        :type project_id: object
        :return: Returns the result object.
        """ # noqa: E501
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ProjectUpdateWorkspaceRolesForProjectResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
        )
