...
class FileScanningApi:
    ...
    @validate_call
    def file_scanning_delete_file_scan_result(
        self,
        ...
        _param = self._file_scanning_delete_file_scan_result_serialize(
    ...
    def _file_scanning_delete_file_scan_result_serialize(
        self,
        file_scan_id_uuid,
    ) -> RequestSerialized:
    ...
    @validate_call
    def file_scanning_delete_file_scan_result2(
        self,
        file_scan_id_uuid: str,
    ) -> object:
        """DeleteFileScanResult
        ...
        _param = self._file_scanning_delete_file_scan_result2_serialize(
            file_scan_id_uuid=file_scan_id_uuid,
        )
    ...
    def _file_scanning_delete_file_scan_result2_serialize(
        self,
        file_scan_id_uuid,
    ) -> RequestSerialized:
    ...
    @validate_call
    def file_scanning_get_file_scan_result(
        self,
        file_scan_id_uuid: str,
        ...
        _param = self._file_scanning_get_file_scan_result_serialize(
            file_scan_id_uuid=file_scan_id_uuid,
        )

        _response_types_map: Dict[str, Optional[str]] = {
            '200': "RimeGetFileScanResultResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
        )
    ...
    def _file_scanning_get_file_scan_result_serialize(
        self,
        file_scan_id_uuid,
    ) -> RequestSerialized:
    ...
    @validate_call
    def file_scanning_get_file_scan_result2(
        self,
        file_scan_id_uuid: str,
    ) -> RimeGetFileScanResultResponse:
        """GetFileScanResult
        ...
        _param = self._file_scanning_get_file_scan_result2_serialize(
            file_scan_id_uuid=file_scan_id_uuid,
        )
    ...
    def _file_scanning_get_file_scan_result2_serialize(
        self,
        file_scan_id_uuid,
    ) -> RequestSerialized:
    ...
    @validate_call
    def file_scanning_list_file_scan_results(
        self,
        ...
        _param = self._file_scanning_list_file_scan_results_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "RimeListFileScanResultsResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
        )
    ...
    def _file_scanning_list_file_scan_results_serialize(
        self,
    ...
    @validate_call
    def file_scanning_list_file_scan_results2(
        self,
        first_page_query_project_id_uuid: Optional[str] = None,
        first_page_query_model_id_uuid: Optional[str] = None,
        page_token: Optional[str] = None,
        ...
        _param = self._file_scanning_list_file_scan_results2_serialize(
            first_page_query_project_id_uuid=first_page_query_project_id_uuid,
            first_page_query_model_id_uuid=first_page_query_model_id_uuid,
            page_token=page_token,
            page_size=page_size,
    ...
    def _file_scanning_list_file_scan_results2_serialize(
        self,
        first_page_query_project_id_uuid,
        first_page_query_model_id_uuid,
        page_token,
