...
class CustomerManagedKeyServiceApi:
    ...
    def create_customer_managed_key(
        self,
        cmk_config: Optional[CustomermanagedkeyCustomerManagedKeyConfig] = None,
        ...
        :param cmk_config:
        :type cmk_config: CustomermanagedkeyCustomerManagedKeyConfig
        :return: Returns the result object.
        """ # noqa: E501

        body = RimeCreateCustomerManagedKeyRequest(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "RimeCreateCustomerManagedKeyResponse",
        }
    ...
    def get_customer_managed_key(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "RimeGetCustomerManagedKeyResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
        )
