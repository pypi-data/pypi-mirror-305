...
class ModelCardServiceApi:
    ...
    def create_model_card(
        self,
        model_card: Optional[RimeModelCard] = None,
        ...
        :param model_card:
        :type model_card: RimeModelCard
        :param project_id:
        :type project_id: RimeUUID
        :return: Returns the result object.
        """ # noqa: E501

        body = RimeCreateModelCardRequest(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "RimeCreateModelCardResponse",
        }
    ...
    def delete_model_card(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "RimeDeleteModelCardResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
        )
    ...
    def list_model_cards(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "RimeListModelCardsResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
        )
    ...
    @validate_call
    def model_card_service_get_model_card(
        self,
        model_card_id_uuid: str,
        ...
        _param = self._model_card_service_get_model_card_serialize(
            model_card_id_uuid=model_card_id_uuid,
        )

        _response_types_map: Dict[str, Optional[str]] = {
            '200': "RimeGetModelCardResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
        )
    ...
    def _model_card_service_get_model_card_serialize(
        self,
        model_card_id_uuid,
    ) -> RequestSerialized:
    ...
    def update_model_card(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "RimeUpdateModelCardResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
        )
