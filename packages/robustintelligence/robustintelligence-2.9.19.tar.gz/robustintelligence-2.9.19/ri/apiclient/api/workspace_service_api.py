...
class WorkspaceServiceApi:
    ...
    def create_workspace(
        self,
        name: str,
        agent_ids: Optional[List[RimeUUID]] = None,
        default_agent_id: Optional[RimeUUID] = None,
        ...
        :type agent_ids: List[RimeUUID]
        :param default_agent_id:
        :type default_agent_id: RimeUUID
        ...
        body = RimeCreateWorkspaceRequest(
          name=name,
          agent_ids=agent_ids,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "RimeCreateWorkspaceResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
        )
    ...
    def list_project_tags_in_workspace(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "RimeListProjectTagsInWorkspaceResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
        )
    ...
    def list_users_of_workspace(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "RimeListUsersOfWorkspaceResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
        )
    ...
    def list_workspaces(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "RimeListWorkspacesResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
        )
    ...
    def update_workspace(
        ...
        workspace_write_mask: Optional[RimeWorkspaceWriteMask] = None,
    ) -> object:
        """UpdateWorkspace
        ...
        :type workspace_write_mask: RimeWorkspaceWriteMask
        :return: Returns the result object.
        """ # noqa: E501
