...
class DataCollectorApi:
    ...
    def get_datapoints(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "StreamResultOfRimeGetDatapointsResponse",
        }
    ...
    def get_predictions(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "StreamResultOfRimeGetPredictionsResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
        )
    ...
    def register_data_stream(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "RimeRegisterDataStreamResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
        )
    ...
    def store_datapoints(
        ...
        datapoints: Optional[List[DatacollectorDatapointRow]] = None,
        ...
        :type datapoints: List[DatacollectorDatapointRow]
        :return: Returns the result object.
        """ # noqa: E501
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "RimeStoreDatapointsResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
        )
    ...
    def store_predictions(
        ...
        :type predictions: List[RimeStorePredictionsRequestPrediction]
