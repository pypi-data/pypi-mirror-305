...
class GenerativefirewallRawModelPrediction(BaseModel):
    """
    ...
    """ # noqa: E501
    classification_pred: Optional[RawModelPredictionTextClassificationPred] = Field(default=None, alias="classificationPred")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "classificationPred": RawModelPredictionTextClassificationPred.from_dict(obj["classificationPred"]) if obj.get("classificationPred") is not None else None
        })
        return _obj
