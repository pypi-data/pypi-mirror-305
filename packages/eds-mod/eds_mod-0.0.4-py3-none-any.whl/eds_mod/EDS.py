...
def smiles3D(smiles):
    ...
    if mol is not None:
        ...
        return None
def fplot(f,xrange=[-5,5],yrange=[-5,5]):
     """  Takes a Python function, f, and plots it over the xrange default [-5,5] and yrange with same default """
