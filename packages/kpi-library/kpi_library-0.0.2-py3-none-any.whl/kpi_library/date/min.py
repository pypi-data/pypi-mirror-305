...
class DateMinimum(MetricModel):
    """
    This metric returns the minimum value of a time column.
    ...
    [{'dqv_isMeasurementOf': 'date.minimum', 'dqv_computedOn': '', 'rdf_datatype': 'DateTime', 'ddqv_hasParameters': [{\
...
'parameter_name': 'date_format', 'value': 'null'}], 'dqv_value': 'null'}]
    ...
    [{'dqv_isMeasurementOf': 'date.minimum', 'dqv_computedOn': '', 'rdf_datatype': 'Error', 'ddqv_hasParameters': [{\
'parameter_name': 'date_format', 'value': 'null'}], 'dqv_value': 'null'}]
    """
    def __init__(self):
        super(DateMinimum, self).__init__(
            identifier='date.minimum',
            keyword='DateMinimum',
            title='Minimum value',
            definition='Minimum value of time data.',
