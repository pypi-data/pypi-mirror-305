...
class DateHistogram(MetricModel):
    """
...
{'limits': '[2022-03-23 08:00:00, 2022-03-25 00:00:00]', 'frequency': 2}]
    ...
    [{'dqv_isMeasurementOf': 'date.histogram', 'dqv_computedOn': '', 'rdf_datatype': 'List<Map<String,String>>', 'ddqv_\
hasParameters': [{'parameter_name': 'date_format', 'value': '"%Y-%d-%m"'}, {'parameter_name': 'num_bins', 'value': '3\
'}], 'dqv_value': '[{"limits": "[2022-03-20 00:00:00, 2022-03-21 16:00:00)", "frequency": 2}, {"limits": "[2022-03-21 1\
6:00:00, 2022-03-23 08:00:00)", "frequency": 2}, {"limits": "[2022-03-23 08:00:00, 2022-03-25 00:00:00]", "frequency": \
2}]'}]
...
1900-01-01 01:00:20)', 'frequency': 2}, {'limits': '[1900-01-01 01:00:20, 1900-01-01 01:00:30]', 'frequency': 3}]
    ...
    [{'dqv_isMeasurementOf': 'date.histogram', 'dqv_computedOn': '', 'rdf_datatype': 'List<Map<String,String>>', 'ddqv_\
hasParameters': [{'parameter_name': 'date_format', 'value': 'null'}, {'parameter_name': 'num_bins', 'value': '3'}], '\
dqv_value': '[]'}]
    """
    def __init__(self):
        super(DateHistogram, self).__init__(
            identifier='date.histogram',
            keyword='DateHistogram',
            title='Histogram',
    ...
    def run(self, data: pd.Series, **kwargs) -> List[Dict[str, Union[str, int]]]:
        """
