...
class DateMode(MetricModel):
    """
    This metric gets the most frequent element of a time column.
    ...
    [{'dqv_isMeasurementOf': 'date.mode', 'dqv_computedOn': '', 'rdf_datatype': 'DateTime', 'ddqv_hasParameters': [{\
'parameter_name': 'date_format', 'value': '"%Y-%m-%d"'}], 'dqv_value': '2022-03-20 00:00:00'}]
...
'parameter_name': 'date_format', 'value': 'null'}], 'dqv_value': 'null'}]
    ...
    [{'dqv_isMeasurementOf': 'date.mode', 'dqv_computedOn': '', 'rdf_datatype': 'Error', 'ddqv_hasParameters': [{\
'parameter_name': 'date_format', 'value': 'null'}], 'dqv_value': 'null'}]
    """
    def __init__(self):
        super(DateMode, self).__init__(
            identifier='date.mode',
            keyword='DateMode',
            title='Most frequent element',
            definition='Most frequent element of the time data.',
    ...
    def run(self, data: pd.Series, **kwargs) -> Optional[pd.Timestamp]:
        """
        This method returns the most frequent element of the data given as parameter.
        ...
        _: :obj:`pandas.Timestamp`, optional.
            Most frequent element of the data.
        """
        ...
        return distribution.index[distribution.argmax()]
