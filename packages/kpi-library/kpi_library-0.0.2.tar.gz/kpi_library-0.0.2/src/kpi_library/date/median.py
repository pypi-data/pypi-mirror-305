...
class DateMedian(MetricModel):
    """
    This metric computes the median value of a time column.
    ...
    [{'dqv_isMeasurementOf': 'date.median', 'dqv_computedOn': '', 'rdf_datatype': 'DateTime', 'ddqv_hasParameters': [{\
'parameter_name': 'date_format', 'value': '"%Y-%m-%d"'}], 'dqv_value': '2022-03-22 12:00:00'}]
...
'parameter_name': 'date_format', 'value': 'null'}], 'dqv_value': 'null'}]
    ...
    [{'dqv_isMeasurementOf': 'date.median', 'dqv_computedOn': '', 'rdf_datatype': 'Error', 'ddqv_hasParameters': [{\
'parameter_name': 'date_format', 'value': 'null'}], 'dqv_value': 'null'}]
    """
    def __init__(self):
        super(DateMedian, self).__init__(
            identifier='date.median',
            keyword='DateMedian',
            title='Median value',
            definition='Median value of time data.',
    ...
    def run(self, data: pd.Series, **kwargs) -> Optional[pd.Timestamp]:
        """
        This method returns the median value of the data given as parameter.
