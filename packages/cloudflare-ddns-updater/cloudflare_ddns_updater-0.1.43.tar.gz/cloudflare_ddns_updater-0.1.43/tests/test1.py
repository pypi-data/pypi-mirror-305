...
def log_quantity():
    ...
    check_for_config()
    # Configure logging and create log file if it doesn't exist
...
def create_log_file():
    # TODO Why is does it see the log file as created even on first setup?
    #  Maybe because of logging.basicConfig in log_quantity.
    #  Test just this part in a test.py, then test with also with log_quantity
    #  with an without logging.basicConfig
    ...
    if not os.path.exists(LOG_FILE_PATH):
        ...
        try:
            ...
            print(f"Log file is now: {LOG_FILE_PATH}")
            # Secure file
