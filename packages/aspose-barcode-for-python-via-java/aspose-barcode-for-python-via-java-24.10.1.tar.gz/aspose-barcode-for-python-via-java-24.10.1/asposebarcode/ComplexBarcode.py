...
class ComplexBarcodeGenerator(Assist.BaseJavaClass):
    ...
    def save(self, imagePath: str, imageFormat: Generation.BarCodeImageFormat) -> None:
        """!
...
class Address(Assist.BaseJavaClass):
    ...
    def getName(self) -> str:
        ...
        @return:The name.
        """
        return str(self.getJavaClass().getName())
    ...
    def getAddressLine1(self) -> str:
        ...
        """
        return str(self.getJavaClass().getAddressLine1())
    ...
    def getAddressLine2(self) -> str:
        ...
        """
        return str(self.getJavaClass().getAddressLine2())
    ...
    def getStreet(self) -> str:
        ...
        @return:The street.
        """
        return str(self.getJavaClass().getStreet())
    ...
    def getHouseNo(self) -> str:
        ...
        """
        return str(self.getJavaClass().getHouseNo())
    ...
    def getPostalCode(self) -> str:
        ...
        """
        return str(self.getJavaClass().getPostalCode())
    ...
    def getTown(self) -> str:
        ...
        """
        return str(self.getJavaClass().getTown())
    ...
    def getCountryCode(self) -> str:
        ...
        """
        return str(self.getJavaClass().getCountryCode())
    ...
    def equals(self, obj: Address) -> bool:
        """!
        Determines whether the specified object is equal to the current object.
        @return True if the specified object is equal to the current object; otherwise, false.
        @param obj The object to compare with the current object.
        """
        return bool(self.getJavaClass().equals(obj.getJavaClass()))
...
class AlternativeScheme(Assist.BaseJavaClass):
    ...
    def getInstruction(self) -> str:
		...
		"""
        return str(self.getJavaClass().getInstruction())
    ...
    def equals(self, obj: AlternativeScheme) -> bool:
        """!
		Determines whether the specified object is equal to the current object.
		@return True if the specified object is equal to the current object; otherwise, false.
		@param obj The object to compare with the current object.
...
class SwissQRBill(Assist.BaseJavaClass):
    ...
    def getCurrency(self) -> str:
		...
		"""
        return str(self.getJavaClass().getCurrency())
    ...
    def getAccount(self) -> str:
		...
		"""
        return str(self.getJavaClass().getAccount())
    ...
    def getReference(self) -> str:
		...
		"""
        return str(self.getJavaClass().getReference())
    ...
    def getUnstructuredMessage(self) -> str:
        """!
		Gets the additional unstructured message.
		@return:The unstructured message.
		"""
        return str(self.getJavaClass().getUnstructuredMessage())
    ...
    def equals(self, obj: SwissQRBill) -> bool:
        """!
		Determines whether the specified object is equal to the current object.
		@return True if the specified object is equal to the current object; otherwise, false.
		@param obj The object to compare with the current object.
...
class SwissQRCodetext(IComplexCodetext):
    ...
    def getBarcodeType(self) -> Generation.EncodeTypes: #TODO BARCODEPYTHON-573
        """!
        Gets barcode type.
        @return Barcode type.
        """
...
class MailmarkCodetext(IComplexCodetext):
    ...
    def getClass_(self) -> str:
        ...
        """
        return str(self.getJavaClass().getClass_())
    ...
    def getDestinationPostCodePlusDPS(self) -> str:
        ...
        @return:
        """
        return str(self.getJavaClass().getDestinationPostCodePlusDPS())
...
class Mailmark2DCodetext(IComplexCodetext):
    ...
    def getUPUCountryID(self) -> str:
        ...
        @return Country ID
        """
        return str(self.getJavaClass().getUPUCountryID())
    ...
    def getInformationTypeID(self) -> str:
        ...
        """
        return str(self.getJavaClass().getInformationTypeID())
    ...
    def getVersionID(self) -> str:
        ...
        @return Version ID
        """
        return str(self.getJavaClass().getVersionID())
    ...
    def getDestinationPostCodeAndDPS(self) -> str:
        ...
        """
        return str(self.getJavaClass().getDestinationPostCodeAndDPS())
    ...
    def getRTSFlag(self) -> str:
        ...
        @return RTS Flag
        """
        return str(self.getJavaClass().getRTSFlag())
    ...
    def getReturnToSenderPostCode(self) -> str:
        ...
        """
        return str(self.getJavaClass().getReturnToSenderPostCode())
    ...
    def getCustomerContent(self) -> str:
        ...
        """
        return str(self.getJavaClass().getCustomerContent())
...
class MaxiCodeCodetext(IComplexCodetext):
    ...
    \code
      reader = Recognition.BarCodeReader(
          imagePath, None, Recognition.DecodeType.MAXI_CODE)
...
class MaxiCodeStandardCodetext(MaxiCodeCodetext):
    ...
    def getMessage(self) -> str:
        ...
        Gets message.
        """
        return str(self.getJavaClass().getMessage())
    ...
    def equals(self, obj: MaxiCodeStandardCodetext) -> bool:
        """!
...
class MaxiCodeStandartSecondMessage(MaxiCodeSecondMessage):
    ...
    def equals(self, obj: MaxiCodeStandartSecondMessage) -> bool:
        """!
...
class MaxiCodeStructuredCodetext(MaxiCodeCodetext):
    ...
    def equals(self, obj: MaxiCodeStructuredCodetext) -> bool:
        """!
...
class MaxiCodeCodetextMode2(MaxiCodeStructuredCodetext):
    ...
    def getMode(self) -> Optional[Generation.MaxiCodeMode]: #TODO BARCODEPYTHON-574
        """!
        Gets MaxiCode mode.
        @return:  MaxiCode mode
        """
...
class MaxiCodeStructuredSecondMessage(MaxiCodeSecondMessage):
    ...
    def equals(self, obj: MaxiCodeStructuredSecondMessage) -> bool:
        """!
...
class HIBCLICCombinedCodetext(HIBCLICComplexCodetext):
    ...
    def equals(self, obj: HIBCLICCombinedCodetext) -> bool:
        """!
...
class HIBCLICPrimaryDataCodetext(HIBCLICComplexCodetext):
    ...
    def equals(self, obj: HIBCLICPrimaryDataCodetext) -> bool:
        """!
...
class HIBCLICSecondaryAndAdditionalDataCodetext(HIBCLICComplexCodetext):
    ...
    def getLinkCharacter(self) -> str:
        ...
        """
        return chr(self.getJavaClass().getLinkCharacter())
    ...
    def equals(self, obj: HIBCLICSecondaryAndAdditionalDataCodetext) -> bool:
        """!
...
class HIBCPASCodetext(IComplexCodetext):
    ...
    def equals(self, obj: HIBCPASCodetext) -> bool:
        """!
...
class HIBCPASRecord(Assist.BaseJavaClass):
    ...
    def getData(self) -> str:
        ...
        Identifies data.
        """
        return str(self.getJavaClass().getData())
    ...
    def equals(self, obj: HIBCPASRecord) -> bool:
        """!
...
class PrimaryData(Assist.BaseJavaClass):
    ...
    def getLabelerIdentificationCode(self) -> str:
        ...
        """
        return str(self.getJavaClass().getLabelerIdentificationCode())
    ...
    def getProductOrCatalogNumber(self) -> str:
        ...
        """
        return str(self.getJavaClass().getProductOrCatalogNumber())
    ...
    def equals(self, obj: PrimaryData) -> bool:
        """!
...
class SecondaryAndAdditionalData(Assist.BaseJavaClass):
    ...
    def getLotNumber(self) -> str:
        ...
        """
        return str(self.getJavaClass().getLotNumber())
    ...
    def getSerialNumber(self) -> str:
        ...
        """
        return str(self.getJavaClass().getSerialNumber())
    ...
    def equals(self, obj: SecondaryAndAdditionalData) -> bool:
        """!
