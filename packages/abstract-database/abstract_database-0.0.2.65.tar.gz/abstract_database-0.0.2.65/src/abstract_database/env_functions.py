...
def get_table(dbName,tables=None):
...
class envManager(metaclass=SingletonMeta):
    ...
    def add_to_memory(self, dbName, dbType=None, env_path=None, tables_dir=None, insert_list_file=None,insert_list_path=None,tables=None):
        dbType = dbType or self.dbType
