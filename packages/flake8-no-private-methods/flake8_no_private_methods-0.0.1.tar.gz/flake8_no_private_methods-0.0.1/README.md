...
[![Build Status](https://github.com/blablatdinov/flake8-no-private-methods/workflows/test/badge.svg?branch=master&event=push)](https://github.com/blablatdinov/flake8-no-private-methods/actions?query=workflow%3Atest)
[![codecov](https://codecov.io/gh/blablatdinov/flake8-no-private-methods/branch/master/graph/badge.svg)](https://codecov.io/gh/blablatdinov/flake8-no-private-methods)
