...
prompt_dir = Path(__file__).parent / "llm_plugin_generator"
DEFAULT_FEW_SHOT_PROMPT_FILE = prompt_dir / "few_shot_prompt_llm_plugin_all.xml"
MODEL_FEW_SHOT_PROMPT_FILE = prompt_dir / "few_shot_prompt_llm_plugin_model.xml"
UTILITY_FEW_SHOT_PROMPT_FILE = prompt_dir / "few_shot_prompt_llm_plugin_utility.xml"
