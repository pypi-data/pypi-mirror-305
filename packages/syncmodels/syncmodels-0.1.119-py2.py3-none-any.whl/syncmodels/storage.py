...
class WaveStorage(iWaves, iStorage):
    ...
    def __init__(
        ...
        # TODO: load this behaviours from datalake
        self.behavior_templates["centesimal://centesimal/.*MAL\d+"] = (
            ALLOW_DIFFERENT_STRUCTURE + ALLOW_SAME_DATE_DIFFERENT_VALUES
        )
        ...
        try:
            if self._has_change(uri, **data):
                ...
                for exists in existing2:
                    ...
                    same_sort_key = (
                        existing_sort_blueprint == data_sort_blueprint
                    )
                    ...
                    if same_sort_key:
                        ...
                        if same_structure:
                            ...
                            if same_values:
                                ...
                                if (
                                    behavior
                                    & ALLOW_SAME_DATE_DIFFERENT_VALUES
                                ):
                                    log.debug(
                ...
                resuming_info = {
                    k: kw[k] for k in kw.get(REVERSE_SORT_KEY, [])
                }
