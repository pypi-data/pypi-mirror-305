...
class NilanProxyOptima251(NilanProxyBaseModel):
    def __init__(self, device_number:int, slave_device_number:int, slave_device_model:int):
        ...
        self.setpoints = {
            ...
            NilanProxySetpointKey.FILTER_REPLACE_INTERVAL: NilanProxySetpoint(read_address=4, write_address=4, divider=1, min=0, max=6, signed=False),    
            ...
            NilanProxySetpointKey.REHEAT_ENABLE: NilanProxySetpoint(read_address=2, write_address=2, divider=1, min=0, max=1, signed=False),
            NilanProxySetpointKey.TEMP_BYPASS_OPEN_OFFSET: NilanProxySetpoint(read_address=17, write_address=17, divider=10, min=10, max=100, signed=True),
