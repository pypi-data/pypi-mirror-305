...
class NilanProxyOptima270(NilanProxyBaseModel):
    def __init__(self, device_number:int, slave_device_number:int, slave_device_model:int):
        ...
        self.datapoints = {
            NilanProxyDatapointKey.ALARM_BITS: NilanProxyDatapoint(read_address=38, divider=1, signed=False),        
            NilanProxyDatapointKey.BYPASS_ACTIVE: NilanProxyDatapoint(read_address=53, divider=1, signed=False),
            ...
            NilanProxyDatapointKey.TEMP_EXTRACT: NilanProxyDatapoint(read_address=23, divider=10, offset=-300, signed=True),
            ...
            # NilanProxyDatapointKey.REHEAT_PWM: NilanProxyDatapoint(read_address=41, divider=100, signed=False),
            # NilanProxyDatapointKey.REHEAT_PWM: NilanProxyDatapoint(read_address=42, divider=100, signed=False),
        }
        ...
        self.setpoints = {
            ...
            NilanProxySetpointKey.TEMP_BYPASS_OPEN_OFFSET: NilanProxySetpoint(read_address=21, write_address=52, divider=10, min=10, max=100, signed=True),
