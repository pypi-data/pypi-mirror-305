...
class TasksStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ListPendingTasks = channel.unary_unary(
                '/rbt.v1alpha1.Tasks/ListPendingTasks',
                request_serializer=rbt_dot_v1alpha1_dot_tasks__pb2.ListPendingTasksRequest.SerializeToString,
                response_deserializer=rbt_dot_v1alpha1_dot_tasks__pb2.ListPendingTasksResponse.FromString,
                )
...
def add_TasksServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'ListPendingTasks': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=rbt_dot_v1alpha1_dot_tasks__pb2.ListPendingTasksRequest.FromString,
                    response_serializer=rbt_dot_v1alpha1_dot_tasks__pb2.ListPendingTasksResponse.SerializeToString,
            ),
...
class Tasks(object):
    ...
    def ListPendingTasks(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/rbt.v1alpha1.Tasks/ListPendingTasks',
            rbt_dot_v1alpha1_dot_tasks__pb2.ListPendingTasksRequest.SerializeToString,
            rbt_dot_v1alpha1_dot_tasks__pb2.ListPendingTasksResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
