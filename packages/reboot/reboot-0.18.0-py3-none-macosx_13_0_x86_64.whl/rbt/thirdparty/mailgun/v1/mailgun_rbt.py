...
class _MessageStub(reboot.aio.stubs.Stub):
    ...
    __service_name__ = reboot.aio.types.ServiceName('rbt.thirdparty.mailgun.v1.MessageMethods')
    ...
    def __init__(
        ...
        *,
        ...
        self._stub = rbt.thirdparty.mailgun.v1.mailgun_pb2_grpc.MessageMethodsStub(channel)
                ...
                *,
                ...
                if isinstance(__context__, reboot.aio.contexts.TransactionContext):
                    return reboot.aio.tasks.TaskEffect(
                        service_name=reboot.aio.types.ServiceName(
                            'rbt.thirdparty.mailgun.v1.MessageMethods'
                        ),
