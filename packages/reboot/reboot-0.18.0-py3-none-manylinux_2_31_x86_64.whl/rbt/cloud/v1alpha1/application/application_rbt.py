...
class _ApplicationStub(reboot.aio.stubs.Stub):
    ...
    __service_name__ = reboot.aio.types.ServiceName('rbt.cloud.v1alpha1.application.ApplicationMethods')
    ...
    def __init__(
        ...
        *,
        ...
        self._stub = rbt.cloud.v1alpha1.application.application_pb2_grpc.ApplicationMethodsStub(channel)
                ...
                *,
                ...
                if isinstance(__context__, reboot.aio.contexts.TransactionContext):
                    return reboot.aio.tasks.TaskEffect(
                        service_name=reboot.aio.types.ServiceName(
                            'rbt.cloud.v1alpha1.application.ApplicationMethods'
                        ),
