...
class _MemoizeStub(reboot.aio.stubs.Stub):
    ...
    __service_name__ = reboot.aio.types.ServiceName('reboot.memoize.v1.MemoizeMethods')
    ...
    def __init__(
        ...
        *,
        ...
        self._stub = reboot.memoize.v1.memoize_pb2_grpc.MemoizeMethodsStub(channel)
            ...
            async def Reset(
                ...
                if isinstance(__context__, reboot.aio.contexts.TransactionContext):
                    return reboot.aio.tasks.TaskEffect(
                        service_name=reboot.aio.types.ServiceName(
                            'reboot.memoize.v1.MemoizeMethods'
                        ),
