...
class _SortedMapStub(reboot.aio.stubs.Stub):
    ...
    __service_name__ = reboot.aio.types.ServiceName('rbt.std.collections.v1.SortedMapMethods')
    ...
    def __init__(
        ...
        *,
        ...
        self._stub = rbt.std.collections.v1.sorted_map_pb2_grpc.SortedMapMethodsStub(channel)
                ...
                *,
                ...
                if isinstance(__context__, reboot.aio.contexts.TransactionContext):
                    return reboot.aio.tasks.TaskEffect(
                        service_name=reboot.aio.types.ServiceName(
                            'rbt.std.collections.v1.SortedMapMethods'
                        ),
