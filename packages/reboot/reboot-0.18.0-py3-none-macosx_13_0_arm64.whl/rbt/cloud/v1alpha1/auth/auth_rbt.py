...
class _APIKeyStub(reboot.aio.stubs.Stub):
    ...
    __service_name__ = reboot.aio.types.ServiceName('rbt.cloud.v1alpha1.auth.APIKeyMethods')
    ...
    def __init__(
        ...
        *,
        ...
        self._stub = rbt.cloud.v1alpha1.auth.auth_pb2_grpc.APIKeyMethodsStub(channel)
            ...
            async def Revoke(
                ...
                if isinstance(__context__, reboot.aio.contexts.TransactionContext):
                    return reboot.aio.tasks.TaskEffect(
                        service_name=reboot.aio.types.ServiceName(
                            'rbt.cloud.v1alpha1.auth.APIKeyMethods'
                        ),
