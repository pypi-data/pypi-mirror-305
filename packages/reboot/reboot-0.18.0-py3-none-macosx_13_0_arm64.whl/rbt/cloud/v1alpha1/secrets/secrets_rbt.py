...
class _SecretStub(reboot.aio.stubs.Stub):
    ...
    __service_name__ = reboot.aio.types.ServiceName('rbt.cloud.v1alpha1.secrets.SecretMethods')
    ...
    def __init__(
        ...
        *,
        ...
        self._stub = rbt.cloud.v1alpha1.secrets.secrets_pb2_grpc.SecretMethodsStub(channel)
                ...
                *,
                ...
                if isinstance(__context__, reboot.aio.contexts.TransactionContext):
                    return reboot.aio.tasks.TaskEffect(
                        service_name=reboot.aio.types.ServiceName(
                            'rbt.cloud.v1alpha1.secrets.SecretMethods'
                        ),
