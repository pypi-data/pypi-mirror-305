...
# 打包 python setup.py sdist install
...
confkcw['url']='https://intapp.kwebapp.cn/intapp/doc/index/finddoc/1'
...
setup(
    ...
    install_requires = ['kcw==2.2','python-dateutil==2.9.0','pymongo==3.10.0','Mako==1.3.6','six>=1.12.0','websockets==8.1'], #第三方包
    package_data = {
