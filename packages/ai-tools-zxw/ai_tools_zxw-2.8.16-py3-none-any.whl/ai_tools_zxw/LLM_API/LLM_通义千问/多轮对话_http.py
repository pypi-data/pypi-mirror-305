...
class LLM_Model(str, Enum):
    qwen_plus = "qwen-plus"  # 输入：¥0.0008元/千tokens；输出：¥0.0002元/千tokens
...
class ChatToLLM(LLM):
    ...
    def chat(
            self, input_content: str, single_chat=False, model: str = "default",
            temperature: Optional[float] | NOT_GIVEN = NOT_GIVEN) -> str:
        """
        resp["body"] 值示例：
        {
            "id: "xxx",
