...
class AsyncLogger:
    ...
    async def log(self, level: int, msg: Any, context: Optional[Dict[str, Any]] = None, body: Optional[Any] = None) -> None:
        extra = {'context': context, 'body': body} 
        self.logger.log(level, msg, extra=extra)

    async def info(self, msg: Any, context: Optional[Dict[str, Any]] = None, body: Optional[Any] = None) -> None:
        await self.log(logging.INFO, msg, context, body)

    async def error(self, msg: Any, context: Optional[Dict[str, Any]] = None, body: Optional[Any] = None) -> None:
        await self.log(logging.ERROR, msg, context, body)

    async def warning(self, msg: Any, context: Optional[Dict[str, Any]] = None, body: Optional[Any] = None) -> None:
        await self.log(logging.WARNING, msg, context, body)

    async def debug(self, msg: Any, context: Optional[Dict[str, Any]] = None, body: Optional[Any] = None) -> None:
        await self.log(logging.DEBUG, msg, context, body)

    def log_sync(self, level: int, msg: Any, context: Optional[Dict[str, Any]] = None, body: Optional[Any] = None) -> None:
        extra = {'context': context, 'body': body}
        self.logger.log(level, msg, extra=extra)

    def info_sync(self, msg: Any, context: Optional[Dict[str, Any]] = None, body: Optional[Any] = None) -> None:
        self.log_sync(logging.INFO, msg, context, body)

    def error_sync(self, msg: Any, context: Optional[Dict[str, Any]] = None, body: Optional[Any] = None) -> None:
        self.log_sync(logging.ERROR, msg, context, body)

    def warning_sync(self, msg: Any, context: Optional[Dict[str, Any]] = None, body: Optional[Any] = None) -> None:
        self.log_sync(logging.WARNING, msg, context, body)

    def debug_sync(self, msg: Any, context: Optional[Dict[str, Any]] = None, body: Optional[Any] = None) -> None:
        self.log_sync(logging.DEBUG, msg, context, body)
