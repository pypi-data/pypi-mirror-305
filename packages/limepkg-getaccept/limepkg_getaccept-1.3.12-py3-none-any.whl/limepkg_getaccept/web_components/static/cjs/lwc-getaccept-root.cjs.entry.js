...
const Root = class {
    ...
    render() {
        return [
            ...
            })()), index.h("div", { key: 'd3cd2c6dee77432ded9b2d228518a8df4bd553bf', class: "ga-body" }, this.renderLayout()), index.h("div", { key: '92baf0e4e5394361ad2e9c38bbcc80897f6771f3', class: "ga-version" }, index.h("span", { key: '8d00157e0e0a8a42e54a69780a8f8250f5be3e24' }, "Version: 1.3.11")), index.h("limel-button-group", { key: 'f10868e722a00d6a31f410e64966ea8fbd0e28b4', slot: "button" }, index.h("limel-button", { key: 'b28504cdcc8f8db75a5a8b85d246a62f4bc5c5ce', label: "Cancel", onClick: () => {
                    this.isOpen = false;
                } })), index.h("error-message", { key: 'e4ca6f8b2d0e6162fd2768cd7dccd96068c7f7f8', error: this.errorMessage })),
        ];
    }
    checkIsAside() {
