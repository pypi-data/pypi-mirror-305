...
class DataUpcloudZones(
    ...
    def __init__(
        ...
        *,
        ...
        :param filter_type: Filter zones by type. Possible values are "all", "public" and "private". Default is "public". Docs at Terraform Registry: {@link https://registry.terraform.io/providers/upcloudltd/upcloud/5.14.0/docs/data-sources/zones#filter_type DataUpcloudZones#filter_type}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing DataUpcloudZones that should be imported. Refer to the {@link https://registry.terraform.io/providers/upcloudltd/upcloud/5.14.0/docs/data-sources/zones#import import section} in the documentation of this resource for the id to use
