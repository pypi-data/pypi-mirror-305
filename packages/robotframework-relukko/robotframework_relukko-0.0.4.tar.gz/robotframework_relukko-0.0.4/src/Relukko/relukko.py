...
class Relukko:
    ...
    def keep_relukko_alive(self) -> Union[Dict, None]:
        """
        TBD
        """
    ...
    def keep_relukko_alive_for(self, timestr: str) -> Union[Dict, None]:
        """
        Robot Framework's
    ...
    def add_to_current_relukko_expire_at(self) -> Union[Dict, None]:
        """
        TBD
        """
    ...
    def add_to_current_relukko_expire(self, timestr: str) -> Union[Dict, None]:
        """
        Robot Framework's
        [https://robotframework.org/robotframework/latest/RobotFrameworkUserGuide.html#time-format|Time Format]
        """
    ...
    def get_current_relukko(self) -> Union[Dict, None]:
        """
        TBD
        """
    ...
    def get_relukko_expires_at_time(self) -> Union[datetime, None]:
        """
        TBD, should that be casted to datetime?
        """
        if self.lock:
    ...
    def acquire_relukko_for_test(
            self, creator: str=None) -> Union[Dict, None]:
        """
        TBD
        """
        ...
        return self.acquire_relukko(lock_name=lock_name, creator=creator)
