...
class S04(BasePage):
    def __init__(self, parent, controller):
        ...
        choice6 = tk.Radiobutton(master=self.optionframe, text = 'Option 6: Remove Selected TIPLOC (Use with caution) - [REQUIRE: CIF_selection.csv]', value="6", variable=option1)
