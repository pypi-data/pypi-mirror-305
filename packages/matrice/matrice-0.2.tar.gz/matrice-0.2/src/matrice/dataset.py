...
class Dataset:
    ...
    >>> dataset = Dataset(session=session, dataset_id="12345")
    ...
    def get_categories(self, dataset_version):
        ...
        >>> # Sample output
        >>> [
        >>>     {'_id': '671638ef0f4507663b8ca2b7', '_idDataset': '671636dd6cffa65a7510a52b', '_idSuperCategory': '000000000000000000000000', 'datasetVersion': 'v1.0', 'name': 'Window'},
        >>>     {'_id': '671638ef0f4507663b8ca2b6', '_idDataset': '671636dd6cffa65a7510a52b', '_idSuperCategory': '000000000000000000000000', 'datasetVersion': 'v1.0', 'name': 'windows'},
        >>>     ...
        >>> ]
        """
        if self.dataset_id is None:
    ...
    def _list_items_V2(self, dataset_version, page_size = 10, page_number = 0):
        ...
        This function retrieves a paginated list of items for the specified dataset version, allowing
        control over the number of items returned per page and the page number.

        Parameters
        ----------
        dataset_version : str
            The version of the dataset to retrieve items from (e.g., "v2.0").
        ...
        tuple
            A tuple containing:
            - dict: API response with dataset items, including details such as:
            - str or None: Error message if an error occurred, `None` otherwise.
            - str: Status message indicating success or failure.
        ...
        Example
        -------
        >>> items, err, msg = dataset._list_items_V2(dataset_version="v2.0", page_size=10, page_number=0)
        >>> if err:
        >>>     pprint(err)
        >>> else:
        >>>     pprint(items)
