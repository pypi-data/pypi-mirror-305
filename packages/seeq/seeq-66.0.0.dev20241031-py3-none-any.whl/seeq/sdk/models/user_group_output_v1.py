...
class UserGroupOutputV1(object):
    ...
    """
    swagger_types = {
        'capabilities': 'list[CapabilityInheritanceOutput]',
        'created_at': 'str',
        'data_id': 'str',
    ...
    def capabilities(self):
        ...
        Capabilities that the group has been granted, and the group the Capability was inherited from (when applicable)

        :return: The capabilities of this UserGroupOutputV1.
        :rtype: list[CapabilityInheritanceOutput]
        """
    ...
    def capabilities(self, capabilities):
        ...
        :type: list[CapabilityInheritanceOutput]
        """
