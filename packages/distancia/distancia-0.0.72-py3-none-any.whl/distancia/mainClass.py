...
#############################
	...
	def example(self):
		...
		if self.type=='vec_proba':
			self.obj1_example=Vector().generate_vector(4,form='proba')
			self.obj2_example=Vector().generate_vector(4,form='proba')
		if self.type=='vec_nn':
			self.obj1_example=Vector().generate_vector(4,form='bin')
			self.obj2_example=Vector().generate_vector(4,form='proba')
		if self.type=='str':
			self.obj1_example = "martha"
			self.obj2_example = "mbarht"
		if self.type=='vec_str':
			self.obj1_example = Vector().generate_vector(4,form='letter')
			self.obj2_example = Vector().generate_vector(4,form='letter')
		...
		if self.type=='vec_int':
			self.obj1_example=Vector().generate_vector(4,form='int')
			self.obj2_example=Vector().generate_vector(4,form='int')
		if self.type=='vec_bin':
			self.obj1_example=Vector().generate_vector(4,form='bin')
			self.obj2_example=Vector().generate_vector(4,form='bin')
		if self.type=='vec_bool':
			self.obj1_example=Vector().generate_vector(4,form='bool')
			self.obj2_example=Vector().generate_vector(4,form='bool')
		if self.type=='matrix_float':
			self.obj1_example=Matrix().generate_square_matrix(3)
			self.obj2_example=Matrix().generate_square_matrix(3)
		if self.type=='file':
