...
class HashiCorpVaultSecretStore(SecretStoreBase):
    ...
    required_config = ["MIND_CASTLE_VAULT_HOST", "MIND_CASTLE_VAULT_PORT", "MIND_CASTLE_VAULT_TOKEN"]

    def __init__(self):
        self.client = hvac.Client(
            url=f"http://{os.environ.get('MIND_CASTLE_VAULT_HOST')}:{os.environ.get('MIND_CASTLE_VAULT_PORT')}", token=f"{os.environ.get('MIND_CASTLE_VAULT_TOKEN')}"
