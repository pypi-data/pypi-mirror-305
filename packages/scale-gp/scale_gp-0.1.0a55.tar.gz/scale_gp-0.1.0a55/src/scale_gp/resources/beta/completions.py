...
class CompletionsResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        Interact with the LLM model using the specified model.
        ...
        Args:
          ...
          system: The system prompt to use for the chat completion model.

              This is a prompt that is sent to the model at the beginning of the conversation.
              It is used to set the context for the model, and can be used to provide the
              model with additional information about the conversation. For example, you can
              use this to specify the persona of the AI, or to provide the model with
          ...
          top_k: The number of tokens to sample from the model's output.
