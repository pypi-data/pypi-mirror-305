...
__all__ = [
    ...
    "MessageEgpAPIBackendServerAPIModelsEgpModelsUserMessageContentUnionMember1TextUserMessageContentParts",
    ...
    "MessageEgpAPIBackendServerAPIModelsEgpModelsToolMessage",
    "MessageAgentMessage",
...
class MessageEgpAPIBackendServerAPIModelsEgpModelsUserMessageContentUnionMember1TextUserMessageContentParts(
...
class MessageEgpAPIBackendServerAPIModelsEgpModelsToolMessage(TypedDict, total=False):
