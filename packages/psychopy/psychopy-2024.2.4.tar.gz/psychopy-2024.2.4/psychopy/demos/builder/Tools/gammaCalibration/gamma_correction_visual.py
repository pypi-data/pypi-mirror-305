...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/lpzjwp/code/psychopy/git/psychopy/demos/builder/Tools/gammaCorrection/gamma_correction_visual.py',
...
for level, condition in trials:
    ...
    gamma = thisLevel # from staircase
    trials.addData('gamma', gamma)
