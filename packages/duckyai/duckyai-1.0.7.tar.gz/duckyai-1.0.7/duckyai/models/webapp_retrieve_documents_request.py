...
class WebappRetrieveDocumentsRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["index_name", "query", "evaluation_id", "variant_name", "retrieval_strategy", "query_translation_strategy", "query_structuring", "filter", "project_id"]
