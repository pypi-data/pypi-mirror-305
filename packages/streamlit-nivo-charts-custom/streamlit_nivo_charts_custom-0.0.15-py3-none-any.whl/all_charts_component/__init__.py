...
def chart_to_display(
        ...
        customBottomAxis=False,
        customTopAxis=False,
        customLeftAxis=False,
        customRightAxis=False, 
        customAxisTextAnchor="middle",
        customAxisTickLine=False, 
    ...
    component_value = _chart_to_display(
        ...
        customAxisTextAnchor=customAxisTextAnchor,
        customAxisTickLine=customAxisTickLine,
