...
class NATSReceiveEventMessage(ReceiveEventMessage):
    ...
    This class extends ReceiveEventMessage to handle NATS-specific message format
...
class AWSReceiveEventMessage(ReceiveEventMessage):
    """Handler for event messages received from AWS SQS.
    
    This class extends ReceiveEventMessage to handle AWS SQS-specific message format
