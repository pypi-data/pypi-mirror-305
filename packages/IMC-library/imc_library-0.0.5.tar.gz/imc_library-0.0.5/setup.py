...
setup(
    ...
    entry_points={"console_scripts":["convert_mcd_png=IMC_library:convert_mcd_png","visualize_roi=IMC_library:visualize_roi","combine_marker=IMC_library:combine_marker"]},
