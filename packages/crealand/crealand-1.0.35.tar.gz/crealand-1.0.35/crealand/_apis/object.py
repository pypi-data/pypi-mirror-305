...
class Info:
    ...
    @_utils.check_type
    @staticmethod
    def get_spatial_coordinates(coordinate: List[float], axis: Literal['X', 'Y','Z']='X') :
        AXIS = {"X": 0, "Y": 1, "Z": 2}
...
class Camera:
    ...
    # 相机移动
    @classmethod
    def move_to(self, time: Union[int,float], coordinate: List[float], block: bool = False):
        new_time = max(0, time)
        _interface.call_api(
            'unity',
            "unity.camera.moveTo",
    ...
    # 调整FOV
    @classmethod
    def adjust_FOV(self, time: Union[int,float] = 1, fov: Union[int,float] = 80):
        new_time = max(0, time)
    ...
    # 相机跟随
    @classmethod
    def follow_target(self, runtime_id: int, distance: Union[int,float] = 10, is_rotate: bool = True):
        _interface.call_api_async(
            'unity',
    ...
    # 相机 滤镜
    @classmethod
    def filters(self, filter_name: int = _constants.FilterStyle.FOG, state: bool = True):
...
class Motion:
    ...
    @_utils.check_type
    @staticmethod
    def face_towards(runtime_id: Union[int,float], coordinate: List[int] = [0, 0, 1]):
        _interface.call_api(
            'unity',
    ...
    @staticmethod
    def move_forward(
        runtime_id: int, speed: int =1, distance: Union[int,float] =3, block: bool = False
    ):
    ...
    @_utils.check_type
    @staticmethod
    def rotate(runtime_id: int, time: int=1, angle: Union[int,float]=90, block: bool = False):
        new_time = max(time, 0)
        _interface.call_api(
            'unity',
    ...
    @_utils.check_type
    @staticmethod
    def ptz(runtime_id: int, angle: Union[int,float]=90, block: bool = False):
        print(block)
        _interface.call_api(
            'unity',
    ...
    def move_towards_screen_space(
        runtime_id: int, speed: Union[int,float] = 1, direction: List[float] = [0, 0, 1]
    ):
        new_speed = max(1, min(speed, 5))
        _interface.call_api(
            'unity',
    ...
    def rotate_to_direction(
        runtime_id: int, angle: Union[int,float] = 0, direction: List[float] = [0, 0, 1]
    ):
        _interface.call_api(
            'unity',
    ...
    @staticmethod
    def rise(
        runtime_id: int, speed: Union[int,float] = 3, height: Union[int,float] = 10, block: bool = False
    ):
        new_speed = max(1, min(speed, 5))
        _interface.call_api(
            'unity',
    ...
    def get_object_local_position(
        runtime_id: int, coordinate: List[float] = [0, 0, 1], distance: Union[int,float] = 0
    ):
    ...
    @staticmethod
    def move_by_point(
        runtime_id: int, time: Union[int,float] = 1, coordinate: List[float] = [0, 0, 1], block: bool = False
    ):
        new_time = max(time, 0)
        _interface.call_api(
            'unity',
