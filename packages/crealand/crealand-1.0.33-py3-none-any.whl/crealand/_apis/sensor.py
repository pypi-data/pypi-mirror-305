...
class Ultrasonic:
    ...
    @_utils.check_type
    @staticmethod
    def onSensorUltrasonicEvent(sensor: str, compare: str, distance: Union[int,Union[int,float]],cb:Any):
...
class Auditory:
    ...
    @_utils.check_type
    @staticmethod
    def onSensorSoundEvent(compare:str,decibel_value:str,cb:Any):
...
class Temperature:
    ...
    @_utils.check_type
    @staticmethod
    def set_temperature( area_id: int, temp_val: Union[int,float]=0):
...
class Humidity:
    ...
    @_utils.check_type
    @staticmethod
    def set_humidity( area_id: int, humidity_value: Union[int,float]=0):
        humidity_value = int(humidity_value)
        humidity_value= max(0, min(humidity_value, 100))
...
class Gravity:
    ...
    @_utils.check_type
    @staticmethod
    def onSensorGravityEvent(sensor: str, compare: str, gravity_value: int,cb:Any):
    ...
    @_utils.check_type
    @staticmethod
    def set_gravity( runtime_id: str, gravity_value: int=0):
        gravity_value = int(gravity_value)
        gravity_value= max(0, min(gravity_value, 10000))
