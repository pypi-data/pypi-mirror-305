...
def get_table_metadata(table_map, global_scn):
    try:
        ...
        # 获取表数量，用于对数
        count_sql = 'select /*+full(t)*/ count(1) from ' + src_schema + '."' + src_table + '" as of scn ' + table_scn + ' t where ' + src_where
                ...
                for partition in partition_mess['partitions']:
                    ...
                    if len(subpartitions) > 0 and smallest_object == 'subpartition':
                        for subpartition in subpartitions:
                            ...
                            tasks.append((table_map, mess, table_scn, table_metadata))
                    # 分区
                    else:
...
def compare_data_number():
    ...
    def count2(table_map, src_db, dst_db, global_scn):
        ...
        src_sql = 'select  /*+full(t)*/ count(1) from ' + src_schema + '."' + src_table + '" as of scn ' + global_scn + ' t'
