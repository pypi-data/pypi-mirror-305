...
tables = '''
ACCT_FACADE.PPD_REPAY_PLAN_ALL
IMOP_SALESMAN.SM_REALTIME_APPROVAL_RESULT
UPMP_DATA.UPMP_PD_HS_IT_ACTION_SCORE
UCPAYUSR.PC_PUBLIC_PAY_ONLINE
IMOP_ACTIVITY.ACT_GPS_INFO_TZ
IMOP_ACTIVITY.ACT_VOTE_PARTICIPATION
COMMON_SERVICE.PPD_CUST_REPAY_PLAN
ACCT_FACADE.PPD_WITHDRAW_REPAY_PLAN
AFS.AFC_MIDDLE_DERIVE_INDEX
'''
