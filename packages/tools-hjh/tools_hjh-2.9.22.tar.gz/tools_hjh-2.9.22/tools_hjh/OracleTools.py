...
class OracleTools:
    ...
    def get_table_ddl_pg(dba_conn, username, table, forever_number_to_numeric=True):
        ...
        for constraint in metadata['constraints']:
            ...
            if type_ == 'primary_key' and metadata['partition'] == None:
                k_str = k_str + 'alter table ' + username.lower() + '."' + table.lower() + '" add primary key (' + cols.lower() + ')'
                ...
                k_str = k_str + 'alter table ' + username.lower() + '."' + table.lower() + '" add unique (' + cols.lower() + ')'
            elif type_ == 'foreign_key':
                k_str = k_str + 'alter table ' + username.lower() + '."' + table.lower() + '" add foreign key (' + cols.lower() + ') references ' + r_table.lower() + ' (' + r_cols.lower() + ')'
            sql_list.append(k_str)
        return sql_list
