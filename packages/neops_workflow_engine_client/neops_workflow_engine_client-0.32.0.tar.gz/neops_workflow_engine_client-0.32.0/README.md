...
*JobApi* | [**job_controller_poll_job**](docs/JobApi.md#job_controller_poll_job) | **GET** /job | 
*JobApi* | [**job_controller_push_job_result**](docs/JobApi.md#job_controller_push_job_result) | **POST** /job | 
*WorkflowsApi* | [**workflow_controller_create**](docs/WorkflowsApi.md#workflow_controller_create) | **POST** /workflow | 
*WorkflowsApi* | [**workflow_controller_find_all**](docs/WorkflowsApi.md#workflow_controller_find_all) | **GET** /workflow | 
*WorkflowsApi* | [**workflow_controller_find_one**](docs/WorkflowsApi.md#workflow_controller_find_one) | **GET** /workflow/{id} | 
*WorkflowsApi* | [**workflow_controller_remove**](docs/WorkflowsApi.md#workflow_controller_remove) | **DELETE** /workflow/{id} | 
*WorkflowsApi* | [**workflow_controller_update**](docs/WorkflowsApi.md#workflow_controller_update) | **PATCH** /workflow/{id} | 
