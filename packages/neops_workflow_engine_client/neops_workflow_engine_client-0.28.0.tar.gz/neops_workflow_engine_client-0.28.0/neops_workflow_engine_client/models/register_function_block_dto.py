...
class RegisterFunctionBlockDto(BaseModel):
    ...
    fb_type: StrictStr = Field(alias="fbType")
    markdown_help_text: StrictStr = Field(alias="markdownHelpText")
    version: StrictStr
    deprecated: StrictBool
    json_schema: Dict[str, Any] = Field(alias="jsonSchema")
    __properties: ClassVar[List[str]] = ["id", "name", "description", "package", "runOn", "fbType", "markdownHelpText", "version", "deprecated", "jsonSchema"]
