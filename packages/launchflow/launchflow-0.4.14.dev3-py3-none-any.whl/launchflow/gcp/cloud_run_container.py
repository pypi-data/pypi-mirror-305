...
class CloudRunServiceContainer(GCPResource[CloudRunServiceContainerOutputs]):
    ...
    def __init__(
        ...
        **Args:**
        ...
        - `gpu (Optional[int])`: The number of GPUs to allocate to each instance of the service.
        ...
        - `cpu_idle (Optional[bool])`: Whether to allow the CPU to idle when the service is not in use.
        - `startup_cpu_boost (Optional[bool])`: Whether to boost the CPU when the service starts up.
        """
        super().__init__(
            name=name,
        ...
        self.startup_cpu_boost = startup_cpu_boost
    ...
    def inputs(
        ...
        return CloudRunServiceContainerInputs(
            ...
            startup_cpu_boost=self.startup_cpu_boost,
        )
