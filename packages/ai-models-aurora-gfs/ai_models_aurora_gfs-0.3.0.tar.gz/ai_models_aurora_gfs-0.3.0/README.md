...
`ai-models-aurora-gfs` is an extension of the [ai-models-aurora](https://github.com/ecmwf-lab/ai-models-aurora) package, which itself is a plugin to run Nvidia's spherical harmonics tranformer with [ai-models](https://github.com/ecmwf-lab/ai-models).
