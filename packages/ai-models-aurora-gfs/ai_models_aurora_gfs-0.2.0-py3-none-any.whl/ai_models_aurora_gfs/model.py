...
class AuroraModel(Model):
    ...
    def run(self):
        ...
        print(atmos_vars)
#        out = {}
#        out['u'] = {'name':'U component of wind','units':'m s-1','values':np.zeros((self.lead_time // self.hour_steps + 1,13,721,1440))}
#        out['v'] = {'name':'V component of wind','units':'m s-1','values':np.zeros((self.lead_time // self.hour_steps + 1,13,721,1440))}
#        out['z'] = {'name':'Geopotential','units':'m2 s-2','values':np.zeros((self.lead_time // self.hour_steps + 1,13,721,1440))}
#        out['t'] = {'name':'Temperature','units':'K','values':np.zeros((self.lead_time // self.hour_steps + 1,13,721,1440))}
#        out['q'] = {'name':'Specific humidity','units':'kg kg-1','values':np.zeros((self.lead_time // self.hour_steps + 1,13,721,1440))}
#        out['u10'] = {'name':'10 metre U wind component','units':'m s-1','values':np.zeros((self.lead_time // self.hour_steps + 1,721,1440))}
#        out['v10'] = {'name':'10 metre V wind component','units':'m s-1','values':np.zeros((self.lead_time // self.hour_steps + 1,721,1440))}
#        out['msl'] = {'name':'Pressure reduced to MSL','units':'Pa','values':np.zeros((self.lead_time // self.hour_steps + 1,721,1440))}
#        out['t2'] = {'name':'2 metre temperature','units':'K','values':np.zeros((self.lead_time // self.hour_steps + 1,721,1440))}
