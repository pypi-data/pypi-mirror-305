...
class BaseProducer(Stoppable):
    ...
    def __init__(self, cfg: Optional[BaseProducerSettings] = None):
        ...
        self.metadata_storage = MetadataStorage(storage_path)
