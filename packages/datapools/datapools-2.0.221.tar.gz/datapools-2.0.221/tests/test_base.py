...
def test_parse_size():
    assert CrawlerWorker.parse_size("1M") == 10**6
    assert CrawlerWorker.parse_size("1G") == 10**9
    assert CrawlerWorker.parse_size("1K") == 10**3
    assert CrawlerWorker.parse_size("1T") == 10**12
    assert CrawlerWorker.parse_size("1Mi") == 2**20
    assert CrawlerWorker.parse_size("1Gi") == 2**30
    assert CrawlerWorker.parse_size("1Ki") == 2**10
    assert CrawlerWorker.parse_size("1Ti") == 2**40

    assert CrawlerWorker.parse_size("2M") == 2 * 10**6
    assert CrawlerWorker.parse_size("3G") == 3 * 10**9
    assert CrawlerWorker.parse_size("4K") == 4 * 10**3
    assert CrawlerWorker.parse_size("5Mi") == 5 * 2**20
    assert CrawlerWorker.parse_size("6Gi") == 6 * 2**30
    assert CrawlerWorker.parse_size("7Ki") == 7 * 2**10
    assert CrawlerWorker.parse_size("8T") == 8 * 10**12
    assert CrawlerWorker.parse_size("9Ti") == 9 * 2**40

    assert CrawlerWorker.parse_size("1234") == 1234

    try:
        CrawlerWorker.parse_size("blabla")
        CrawlerWorker.parse_size("1X")
        CrawlerWorker.parse_size("1Bi")
