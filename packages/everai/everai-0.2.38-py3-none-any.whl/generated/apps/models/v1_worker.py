...
class V1Worker(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "deviceId", "status", "detailStatus", "createdAt", "deletedAt", "launchAt", "lastServeAt", "successCount", "failedCount", "sessionNumber", "CPUs", "memory", "GPUName", "GPUs", "appId", "appRevision", "replaceWorkerId", "userId", "requestId", "gpuModel", "gpuNum", "stopAt", "devicePublicAddress"]
