...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, base_path=None, base_url=None, pulp_created=None, prn=None, name=None, content_guard=None, pulp_labels=None, pulp_last_updated=None, hidden=False, pulp_href=None, no_content_change_since=None, local_vars_configuration=None):  # noqa: E501
