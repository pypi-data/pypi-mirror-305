"""Use Pulpy instead of SigPy for SLR pulse design."""
...
def pulpy_n_seq(
    ...
    """
    Create a radio-frequency SLR pulse event using the Pulpy library.

    Optionally, design accompanying slice select and slice select rephasing
    ...
    if rfp.ringdown_time > 0:
        t_fill = (
            np.arange(1, round(rfp.ringdown_time / system.rf_raster_time) + 1)
