...
class Model:
    ...
    def add_variable(
        ...
        return Variable(var, self._model)
    ...
    def set_objective(self, expr: Expression, sense: HybridSolverOptSenses = HybridSolverOptSenses.MINIMIZE) -> None:
    ...
    def set_sense(self, sense: HybridSolverOptSenses) -> None:
    ...
    def _write_problem(self, problem_path: str) -> None:
        ...
        self._model.writeProblem(problem_path, verbose=False)
        # Restore stdout
    ...
    def optimize(self) -> HybridSolverStatus:
        ...
        with tempfile.TemporaryDirectory() as tmp_path:
            ...
            try:
                self._write_problem(tmp_problem)
