...
class WorkflowRun(Base):
    ...
    # Relationships
    workflow = relationship("Workflow", back_populates="workflow_run")
...
class WorkflowRunLog(Base):
    ...
    status = Column(String(50), nullable=False)
    # Relationships
    workflow_run = relationship("WorkflowRun", back_populates="workflow_run_log")
