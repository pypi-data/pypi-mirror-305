...
# @Desc    : Duomai Open Serivce Python SDK
# ------------------------------------------------------------------------


from duomai import utils
import copy
import requests
...
class Network:
	@staticmethod
	def post_request(url, data=None, headers=None, cookies=None, ssl=False):
		try:
...
SERV_HOST = "https://open.duomai.com/apis"
...
class Duomai:
	def __init__(self, app_key, app_secret):
		if app_key== "" or app_secret == "":
			raise Exception("Duomai init need valid app_key and app_secret")
	...
	def send_client(self, api_service: str, params: dict):
		...
		self._set_response(Network.post_request(request_url, params, SERV_HEADER))
