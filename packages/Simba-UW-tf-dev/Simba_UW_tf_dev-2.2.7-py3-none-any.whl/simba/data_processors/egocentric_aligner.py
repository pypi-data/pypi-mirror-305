...
if __name__ == "__main__":
    aligner = EgocentricalAligner(config_path=r"D:\troubleshooting\mitra\project_folder\project_config.ini",
                                  rotate_video=True,
                                  anchor_1='tail_base',
                                  anchor_2='nose',
                                  data_dir=r'D:\troubleshooting\mitra\project_folder\csv\outlier_corrected_movement_location',
                                  videos_dir=r'D:\troubleshooting\mitra\project_folder\videos\bg_removed',
                                  save_dir=r"D:\troubleshooting\mitra\project_folder\videos\bg_removed\rotated")
    aligner.run()
